        ...
        48301: (t, e, a) => {
            ...
            let v = /^https:\/\/tips\.yandex\.ru\//,
                ...
                y = (t) => {
                    ...
                    return (0, i.wg)({
                        ...
                        duration: t.duration,
                        version: t.version,
                        artists: (t.artists || []).map((t) => (0, p.as)({ artist: t })),
                        isAvailable: e,
                        disclaimers: a,
                    });
                };
            ...
            let X = i.gK
                    ...
                    .views((t) => ({
                        get isNotFound() {
                            var e;
                            let a = t.isResolved && (null == (e = t.pager) ? void 0 : e.total) === 0,
                    ...
                    .actions((t) => ({
                        ...
                        getData: (0, i.L3)(function* (e) {
                            let { artistId: a, page: r = 0, pageSize: l = 20, sort: o, preloadedAlbums: n } = e,
                                { artistsResource: d, modelActionsLogger: g } = (0, i._$)(t);
                            if (!(t.isLoading && t.pendingPages.has(''.concat(r))) && !t.alreadyRequestedPages.has(''.concat(r))) {
                                'number' == typeof r && t.alreadyRequestedPages.set(''.concat(r), r);
                                try {
                                    var c;
                                    (t.loadingState = N.GuX.PENDING), t.pendingPages.set(''.concat(r), r);
                                    ...
                                    if (!s)
                                        switch (t.variant) {
                                            ...
                                            case T.h.DISCOGRAPHY:
                                                s = yield d.getDiscographyAlbums(e);
                                                break;
                                            default:
                                                s = yield d.getDirectAlbums(e);
                                        }
                                    let g = { page: r, perPage: l, total: s.pager.total };
                                    0 === t.items.length && (t.items = (0, i.wg)(Array.from({ length: g.total }, () => null)));
                                    let m = s.albums.map(u.pp);
                                    (0, N.Iyy)({ items: t.items, mappedRawItems: m, page: r, pageSize: l }),
                                        (t.pager = g),
                                        (t.requests = (null != (c = t.requests) ? c : 0) + 1),
                ...
                C = i.gK
                    .model('ArtistClipsPage', { pagesLoader: (0, E.Ij)(g.kv), errorStatusCode: i.gK.maybeNull(i.gK.number) })
                    .views((t) => ({
                    ...
                    .actions((t) => ({
                        getData: (0, i.L3)(function* (e) {
                            ...
                            if (t.pagesLoader.isPageNeedToLoad(r))
                                try {
                                    t.pagesLoader.setPageState(r, N.GuX.PENDING);
                                    let e = o;
                                    e || (e = yield n.getClips({ artistId: a, page: r, pageSize: l }));
                                    let i = e.items.map((t) => (0, g.SZ)({ clip: t.data.clip, artists: t.data.artists }));
                                    t.pagesLoader.setItems(i, { page: r, pager: e.pager });
                                } catch (e) {
                                    u.error(e),
                                        t.pagesLoader.setItems(null, { responseStatus: N.FlZ.ERROR, page: r }),
                                        e instanceof s.GX &&
                                            (e.statusCode === s.X1.NOT_FOUND || e.statusCode === s.X1.BAD_REQUEST) &&
                                            (t.errorStatusCode = s.X1.NOT_FOUND);
                                }
                ...
                G = i.gK
                    .compose(i.gK.model('ArtistConcertsPage', { errorStatusCode: i.gK.maybeNull(i.gK.number), concerts: i.gK.maybeNull(i.gK.array(S.aR)) }), E.pl, E.XT)
                    .views((t) => ({
                        get isLoading() {
                    ...
                    .actions((t) => ({
                        getData: (0, i.L3)(function* (e) {
                            ...
                            if (t.loadingState !== N.GuX.PENDING)
                                try {
                                    ...
                                    e || (e = (yield l.getConcerts({ artistId: a })).concerts), (t.concerts = (0, i.wg)(e.map(S.oP))), (t.loadingState = N.GuX.RESOLVE);
                                } catch (e) {
                                    o.error(e),
                                        e instanceof s.GX &&
                                            (e.statusCode === s.X1.NOT_FOUND || e.statusCode === s.X1.BAD_REQUEST) &&
                        ...
                        reset() {
                            (t.loadingState = N.GuX.IDLE), (t.errorStatusCode = null), t.destroyItems([t.concerts]);
                        },
                    })),
                L = (t) => (0, i.wg)({ ...(0, u.sK)({ album: t, artists: t.artists }), version: t.version }),
                D = i.gK
                    .compose(
                    ...
                    .views((t) => {
                        let e = {
                            ...
                            get collectionEntitiesData() {
                                var n, u;
                                return null != (u = null == (n = t.collectionTracks) ? void 0 : n.map(m.$b)) ? u : [];
                            },
                            get vibeEntitiesData() {
                                var d, g;
                                return null != (g = null == (d = t.vibeTracks) ? void 0 : d.map(m.$b)) ? g : [];
                            },
                        };
                        return e;
                    })
                    .actions((t) => ({
                            ...
                            if (t.loadingState !== N.GuX.PENDING)
                                try {
                                    ...
                                    e || (e = yield l.getFamiliarYou({ artistId: a, waveTracksLimit: 100, collectionTracksLimit: 100, collectionAlbumsLimit: 20 })),
                                        (t.vibeTracks = (0, i.wg)(null == (u = e.wave) || null == (n = u.tracks) ? void 0 : n.map((t) => (0, m.vU)(t)))),
                                        (t.collectionTracks = (0, i.wg)(null == (g = e.collection) || null == (d = g.tracks) ? void 0 : d.map((t) => (0, m.vU)(t)))),
                                        (t.collectionAlbums = (0, i.wg)(null == (p = e.collection) || null == (c = p.albums) ? void 0 : c.map(L))),
                                        (t.loadingState = N.GuX.RESOLVE);
                                } catch (e) {
                                    o.error(e),
                                        e instanceof s.GX &&
                        ...
                        reset() {
                            (t.loadingState = N.GuX.IDLE), (t.errorStatusCode = null), t.destroyItems([t.vibeTracks, t.collectionTracks]);
                        },
                    }));
            var f = a(25911);
            let K = i.gK.model('ArtistPick', { playlist: f.$o, artists: i.gK.array(p.PK) }),
                A = i.gK
                    .compose(
                        i.gK.model('ArtistSimilarArtistsPage', { errorStatusCode: i.gK.maybeNull(i.gK.number), similarArtists: i.gK.maybeNull(i.gK.array(p.PK)) }),
                        E.pl,
                        E.XT,
                    )
                    .views((t) => ({
                    ...
                    .actions((t) => ({
                        getData: (0, i.L3)(function* (e) {
                            ...
                            try {
                                ...
                                e || (e = yield l.getSimilarArtists({ artistId: a })),
                                    (t.similarArtists = (0, i.wg)(e.similarArtists.map(p.dM))),
                        ...
                        reset() {
                            (t.loadingState = N.GuX.IDLE), (t.errorStatusCode = null), t.destroyItems([t.similarArtists]);
                        },
                    })),
                h = i.gK.model('CommonSubPage', { artistName: i.gK.maybeNull(i.gK.string) }),
                R = i.gK
                    .compose(
                        ...
                        let e = {
                            ...
                            href(t) {
                                ...
                                if (e.hasCollectionEntities) {
                                    let { href: e } = (0, N.uvd)('/artist/:artistId/familiar', { params: { artistId: t }, query: { tab: N.JCK.COLLECTION } });
                                    return e;
                                }
                                if (e.hasVibeEntities) {
                                    let { href: e } = (0, N.uvd)('/artist/:artistId/familiar', { params: { artistId: t }, query: { tab: N.JCK.VIBE } });
                                    return e;
                                }
                                let { href: a } = (0, N.uvd)('/artist/:artistId/familiar', { params: { artistId: t } });
                                return a;
                            },
                        };
                        return e;
                        ...
                        getData: (0, i.L3)(function* (e) {
                            ...
                            if (t.loadingState !== N.GuX.PENDING)
                                try {
                                    ...
                                    s.error(e), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.REJECT);
                                }
                        }),
                        reset() {
                            (t.loadingState = N.GuX.IDLE), (t.vibeTrackCount = 0), (t.collectionTrackCount = 0), (t.collectionAlbumCount = 0);
                        },
                    }));
            var k = a(2865);
            let O = i.gK
                ...
                .actions((t) => ({
                    getTracksIds: (0, i.L3)(function* (e) {
                        ...
                        try {
                            ...
                            s.setUnloadedEntitiesData(e.map((t) => (0, k.li)(t))),
                                (t.ids = (0, i.wg)(e)),
                                t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.RESOLVE);
                        } catch (e) {
                            l.error(e),
                    ...
                    getTracks: (0, i.L3)(function* (e) {
                        ...
                        try {
                            ...
                            t.tracks.merge(e.reduce((t, e) => ((t[e.id] = (0, m.vU)(e)), t), {}));
                        } catch (t) {
                            s.error(t);
                        }
                    }),
                    reset() {
                        ...
                        e.resetUnloadedEntitiesData(), (t.loadingState = N.GuX.IDLE), t.destroyItems([t.tracks, t.ids]);
                    },
                }));
            var P = a(47416);
            let U = i.gK.compose(i.gK.model('OfflineArtistTrackIds', { ids: i.gK.maybeNull(i.gK.array(i.gK.string)) }), E.XT, E.pl).actions((t) => ({
                    getIds: (0, i.L3)(function* (e, a) {
                        ...
                        if (t.loadingState !== N.GuX.PENDING)
                            try {
                                ...
                                (t.ids = (0, i.wg)(r)), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.RESOLVE);
                            } catch (e) {
                                r.error(e), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.REJECT);
                            }
                    }),
                    reset() {
                        (t.loadingState = N.GuX.IDLE), t.destroyItems([t.ids]);
                    },
                })),
                _ = i.gK
                    .compose(i.gK.model('OfflineArtist', { id: i.gK.maybeNull(i.gK.string), meta: i.gK.maybeNull(d.G4), trackIds: U, downloadedTracks: P.b }), E.XT, E.pl)
                    .views((t) => ({
                        get isNotFound() {
                    ...
                    .actions((t) => ({
                        ...
                        getArtist: (0, i.L3)(function* (e, a) {
                            ...
                            if (t.loadingState !== N.GuX.PENDING) {
                                ...
                                try {
                                    ...
                                    r && (t.meta = (0, i.wg)({ artist: (0, p.dM)(r) })), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.RESOLVE);
                                } catch (e) {
                                    r.error(e), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.REJECT);
                                }
                            }
                        ...
                        reset() {
                            (t.id = null), (t.loadingState = N.GuX.IDLE), t.trackIds.reset(), t.downloadedTracks.reset(), t.destroyItems([t.meta]);
                        },
                    })),
                w = i.gK
                    .compose(
                    ...
                    .views((t) => {
                        let e = {
                            ...
                            get selfLink() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId', { params: { artistId: t.id } });
                                return e;
                            },
                            get tracksUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/tracks', { params: { artistId: t.id } });
                                return e;
                            },
                            get concertsUrl() {
                                var a;
                                if ((null == (a = t.meta) ? void 0 : a.artist.id) && t.concerts && t.concerts.length > d.M$) {
                                    let { href: e } = (0, N.uvd)('/artist/:artistId/concerts', { params: { artistId: t.meta.artist.id } });
                                    return e;
                                }
                                return '';
                            },
                            get clipsUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/videos', { params: { artistId: t.id } });
                                return e;
                            },
                            get compilationsUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/compilations', { params: { artistId: t.id } });
                                return e;
                            },
                            get discographyUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/discography', { params: { artistId: t.id } });
                                return e;
                            },
                            get albumsUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/albums', { params: { artistId: t.id } });
                                return e;
                            },
                            get similarArtistsUrl() {
                                if (!t.id) return '';
                                let { href: e } = (0, N.uvd)('/artist/:artistId/similar', { params: { artistId: t.id } });
                                return e;
                            },
                        };
                        return e;
                    ...
                    .actions((t) => ({
                        getData: (0, i.L3)(function* (e) {
                            let { artistId: a, preloadedArtist: o } = e,
                                { slides: n, experiments: g, disclaimer: E } = (0, i.Zn)(t),
                                { artistsResource: v, modelActionsLogger: I } = (0, i._$)(t),
                                T = g.checkExperiment(N.zal.WebNextAgentArtist, 'on');
                            if (((t.id = a), t.loadingState !== N.GuX.PENDING))
                                try {
                                    ...
                                    if ('not-found' === D || (null == f ? void 0 : f.error) === 'not-found') {
                                        (t.errorStatusCode = s.X1.NOT_FOUND), (t.loadingState = N.GuX.REJECT);
                                        return;
                                    }
                                    if (null == (X = f.deprecation) ? void 0 : X.targetArtistId) {
                                        (t.deprecationTargetArtistId = f.deprecation.targetArtistId), (t.loadingState = N.GuX.RESOLVE);
                                        return;
                                    }
                                    (t.commonSubPage.artistName = f.name),
                                        g.checkExperiment(N.zal.WebNextArtistSkeletonHeader, 'on') ||
                                            (t.meta = (0, i.wg)(
                                                ((t, e, a) => {
                                                    var s;
                                                    let l = null == (s = t.extraActions) ? void 0 : s.find((t) => t.type === r.DONATION && b(t.url));
                                                    return (0, i.wg)({
                                                        artist: (0, p.dM)(t),
                                    ...
                                    let J = (null != (C = f.disclaimers) ? C : []).includes(l.M.MODAL),
                                        M = (null != (G = f.disclaimers) ? G : []).includes(l.M.FOREIGN_AGENT),
                                        j = ((0, N.bRW)(null != (L = f.disclaimers) ? L : [], l.M.FOREIGN_AGENT) || [])[0];
                                    if (
                                        (((!f.available && J) || (T && M) || j) &&
                                            (yield E.getDisclaimerData({ entityId: a, entityType: N.nPY.ARTIST, disclaimerId: null == j ? void 0 : j.id })),
                                        O && O.length > 0)
                                    ) {
                                        let e = O[0];
                                        e && A && A.length > 1 && (t.lastRelease = (0, i.wg)((0, u.pp)(e)));
                                    }
                                    U && (t.upcomingAlbum = (0, i.wg)((0, u.lO)(U))),
                                        P && (t.concerts = (0, i.wg)(P.map(S.oP))),
                                        I && I.length > 0 && (t.popularTracks = (0, i.wg)(I.slice(0, d.xx).map((t) => (0, m.vU)(t)))),
                                        k && k.length > 0 && (t.similarArtists = (0, i.wg)(k.slice(0, d.dg).map(p.dM))),
                                        Number(null == A ? void 0 : A.length) > 0 && (t.albums = (0, i.wg)(null == A ? void 0 : A.map(u.pp))),
                                        Number(null == _ ? void 0 : _.length) > 0 && (t.discography = (0, i.wg)(null == _ ? void 0 : _.map(u.pp).slice(0, d.vx))),
                                        Number(null == R ? void 0 : R.length) > 0 && (t.compilations = (0, i.wg)(null == R ? void 0 : R.map(u.pp).slice(0, d.vx))),
                                        h && h.length > 0 && (t.playlists = (0, i.wg)(h.map(c.ZC).slice(0, d.vx))),
                                        w &&
                                            (t.artistPick = ((t) => {
                                                let e = t.artists.map((t) => (0, p.as)({ artist: t }));
                                                return (0, i.wg)({ playlist: (0, c.bk)({ playlist: t.playlist }), artists: e });
                                            })(w)),
                                        F && (t.clips = (0, i.wg)(F.map(y).slice(0, d.eS))),
                                        n.resetArtist(),
                                        t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.RESOLVE);
                                } catch (e) {
                                    I.error(e), e instanceof s.GX && (t.errorStatusCode = e.statusCode), t.loadingState !== N.GuX.IDLE && (t.loadingState = N.GuX.REJECT);
                                }
                        }),
                        getInfo: (0, i.L3)(function* (e) {
                            let { artistId: a } = e,
                                { experiments: r, disclaimer: o } = (0, i.Zn)(t),
                                { artistsResource: n, modelActionsLogger: u } = (0, i._$)(t),
                                g = r.checkExperiment(N.zal.WebNextAgentArtist, 'on');
                            if (((t.id = a), t.infoLoadingState.loadingState !== N.GuX.PENDING))
                                try {
                                    var c, m, S, E, v;
                                    t.infoLoadingState.loadingState = N.GuX.PENDING;
                                    let e = yield n.getInfo({ artistId: a }),
                                        { artist: r, deprecation: s } = e;
                                    if (null == s ? void 0 : s.targetArtistId) {
                                        (t.deprecationTargetArtistId = s.targetArtistId), (t.loadingState = N.GuX.RESOLVE);
                                        return;
                                    }
                                    (t.commonSubPage.artistName = r.name),
                                        (t.meta = (0, i.wg)(
                                            (0, i.wg)({
                                                artist: (0, p.as)({ artist: e.artist, trailer: e.trailer, isComposer: e.artistType === I.o.COMPOSER }),
                                                donationUrl: b(null == (m = e.donation) ? void 0 : m.tipUrl) ? (null == (S = e.donation) ? void 0 : S.tipUrl) : void 0,
                                                lastMonthListeners: null == (E = e.stats) ? void 0 : E.lastMonthListeners,
                                                brandedButton: e.brandedButton ? (0, d.LH)(e.brandedButton) : void 0,
                                                covers:
                                                    null == (v = e.covers)
                                                        ? void 0
                                                        : v.map((t) => {
                                    ...
                                    let { disclaimers: u, available: y } = null != (c = r.contentRestrictions) ? c : {},
                                        T = (null != u ? u : []).includes(l.M.MODAL),
                                        X = (null != u ? u : []).includes(l.M.FOREIGN_AGENT),
                                        C = ((0, N.bRW)(null != u ? u : [], l.M.FOREIGN_AGENT) || [])[0];
                                    ((!y && T) || (g && X) || C) &&
                                        (yield o.getDisclaimerData({ entityId: a, entityType: N.nPY.ARTIST, disclaimerId: null == C ? void 0 : C.id })),
                                        t.infoLoadingState.loadingState !== N.GuX.IDLE && (t.infoLoadingState.loadingState = N.GuX.RESOLVE);
                                } catch (e) {
                                    u.error(e),
                                        e instanceof s.GX && (t.infoErrorStatusCode = e.statusCode),
                                        t.infoLoadingState.loadingState !== N.GuX.IDLE && (t.infoLoadingState.loadingState = N.GuX.REJECT);
                                }
                        }),
                        reset() {
                            (t.loadingState = N.GuX.IDLE),
