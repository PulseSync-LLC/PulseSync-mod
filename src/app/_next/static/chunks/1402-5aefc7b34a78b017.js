...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        11402: (e, t, i) => {
            i.d(t, { dx: () => d, l$: () => R.AlbumPage, MH: () => N, Wh: () => J }), i(13290), i(14866);
            var l,
                n,
                a = i(60754),
                s = i(49574),
            ...
            let L = (e) => (0, a.wg)({ type: S.rU.TEXT, data: null != e ? e : null, loadingState: s.GuX.RESOLVE }),
                ...
                k = a.gK.compose(a.gK.model('RelatedContent', { items: a.gK.maybeNull(a.gK.array(E.N3)) }), r.pl, r.XT).actions((e) => ({
                    reset() {
                        (e.loadingState = s.GuX.IDLE), e.destroyItems([e.items]);
                    },
                })),
                        ...
                        let t = {
                            ...
                            get hasSimilarEntities() {
                                ...
                                return !!(
                                    ...
                                    (null == (E = e.similarEntities.data) ? void 0 : E.items) &&
                            ...
                            get hasLatestGenreAlbums() {
                                ...
                                return !!(
                                    ...
                                    ((null == (b = e.latestGenreAlbums) ? void 0 : b.isNeededToLoad) || (null == (v = e.latestGenreAlbums) ? void 0 : v.isLoading) || i)
                                );
                            },
                        ...
                        let t = {
                                            ...
                                            let c =
                                                    f(u) && u.id === m.id
                                                        ...
                                                        : null == (r = t.albums) || null == (a = r[0]) || null == (n = a.trackPosition)
                                                          ? void 0
                                                          : n.index,
                                                E = null == m ? void 0 : m.positionInContext,
                                                b = f(g) && (null == g ? void 0 : g.position) ? g.position + 1 : c,
                                                v = (0, p.vU)(t, { hasEverFinished: null == m ? void 0 : m.hasEverFinished });
                                            if (v.isRemoved) {
                                                e.items[l] = G({ id: t.id, loadingState: s.GuX.REJECT, positionInContext: E, position: f(g) ? g.position : i });
                                                return;
                                            }
                                            e.items[l] = G({
                                                id: t.id,
                                                ...
                                                positionInContext: E,
                                                data: v,
                                                position: (null == g ? void 0 : g.type) === S.rU.TEXT ? 1 : b,
                            ...
                            getSimilarEntities: (0, a.L3)(function* (t) {
                                ...
                                if (!e.similarEntities.isLoading)
                                    try {
                                        e.similarEntities.loadingState = b.SQ.PENDING;
                                        let l = yield i.getSimilarEntities(t);
                                        (e.similarEntities.data = (0, b.Ds)(l)), (e.similarEntities.loadingState = b.SQ.RESOLVE);
                                    } catch (t) {
                                        l.error(t), (e.similarEntities.loadingState = b.SQ.REJECT);
                                    }
                            }),
                            ...
                            getData: (0, a.L3)(function* (i) {
                                let {
                                    ...
                                    { albumResource: b, modelActionsLogger: A } = (0, a._$)(e);
                                if (((e.id = r), e.loadingState !== s.GuX.PENDING))
                                    try {
                                        ...
                                        let I = d;
                                        if ((I || (I = yield b.getAlbumWithTracksIds({ albumId: r, resumeStream: o })), (null == I ? void 0 : I.error) === 'not-found')) {
                                        ...
                                        E.setUnloadedEntitiesData(I.volumes.flat().map((e) => (0, h.li)(e.id))),
                                            (e.meta = (0, v.pp)(I)),
                            ...
                            reset(t) {
                                ...
                                o.reset(),
                                    ...
                                    (e.similarEntities.loadingState = b.SQ.IDLE),
            ...
            var V = i(33797);
            let w = a.gK.compose(a.gK.model('PromoLandingSocialLinks', { items: a.gK.maybeNull(a.gK.array(V.dP)) }), r.pl, r.XT).actions((e) => ({
                    setItems(t) {
                        e.items = t;
                    },
                    reset() {
                ...
                J = N.props({
                    ...
                    socialLinks: a.gK.optional(w, { loadingState: s.GuX.IDLE }),
                        ...
                        let t = {
                            getArtistConcerts: (0, a.L3)(function* (t) {
                                ...
                                if (!e.concerts.isLoading)
                                    try {
                                        ...
                                        let { concerts: t } = (0, a.Zn)(e),
                                            n = t.concertsLocationForRequest,
                                            r = yield l.getConcerts({ artistId: i, locations: n });
                                        r.concerts && r.concerts.length > 0 ? (e.concerts.items = (0, a.wg)(r.concerts.map(P.oP))) : (e.concerts.items = null),
                            ...
                            getDataByCampaign: (0, a.L3)(function* (i) {
                                ...
                                if ((yield e.promoCampaign.getData({ albumId: l, isActive: o, campaignId: d }), e.promoCampaign.isPromoCampaignActive)) {
                                    var u, m, g, c, E, b, v, A, h, p, S, L, G, I, y, C, f, T, X;
                                    ...
                                    if (
                                        ...
                                        (null == k || null == (E = k.desktop) || null == (c = E.content) ? void 0 : c.includes(D.Cq.ExternalStreamings))
                                    ) {
                                    ...
                                    if (e.promoCampaign.artistId) {
                                        let i =
                                                (null == k || null == (v = k.mobile) || null == (b = v.header) ? void 0 : b.includes(D._7.Donation)) ||
