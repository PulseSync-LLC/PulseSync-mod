    ...
    [7782],
    {
        12119: (e, n, o) => {
            ...
            var i = o(32290),
                ...
                a = o.n(P);
            let c = (0, s.PA)((e) => {
                let { className: n, title: o, description: s, iconVariant: P = 'musicLogo', iconClassName: c, iconSize: _ } = e,
                    { contentRef: g } = (0, m.gKY)(),
                    u = (0, m.ZpR)(m.Zyd.main.href);
                (0, m.LZB)();
                let { handleNavigateToMain: p } = (0, m.D5F)(u);
                return (
                    (0, m.NBO)(!0),
                    !(function () {
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, r.$)(a().root, { [a().root_desktop]: !g }, n),
                        children: [
                            (0, i.jsx)(v.Lh, { withBackwardFallback: '/', className: a().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: a().content,
                                children: [
                                    (0, i.jsx)(d.Icon, { className: (0, r.$)(a().icon, c), variant: P, size: _ }),
                                    (0, i.jsx)(h.Heading, {
                                        className: (0, r.$)(a().title, a().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: o || (0, i.jsx)(t.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, i.jsx)(h.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: s || (0, i.jsx)(t.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, i.jsx)(l.$, {
                                        onClick: p,
                                        className: a().button,
        ...
        43740: (e, n, o) => {
            ...
            let r = () => {
                ...
                return {
                    ...
                    reachGoal: (n, i) => {
                        if (!e) return void o.push((e) => e.reachGoal(n, i));
                        e.reachGoal(n, i);
                    },
                };
            };
        ...
        49555: (e, n, o) => {
            Promise.resolve().then(o.bind(o, 50162)),
                ...
                Promise.resolve().then(o.bind(o, 45514)),
                Promise.resolve().then(o.bind(o, 3069)),
                Promise.resolve().then(o.bind(o, 60637)),
                Promise.resolve().then(o.bind(o, 53737)),
                Promise.resolve().then(o.bind(o, 15112)),
        ...
        60194: (e, n, o) => {
            ...
            let _ = (0, s.PA)((e) => {
                ...
                (0, b.CgZ)(a);
                let { sendRefreshEvent: _ } = (0, b.cYT)(),
                    g = (0, t.useCallback)(() => {
                        _(), (window.location.href = b.Zyd.main.href);
                    }, [_]),
                    { contentRef: u } = (0, b.gKY)();
                return (0, i.jsxs)('div', {
                    ...
                    children: [
                        o &&
                            (0, i.jsx)(P.Lh, {
                                ...
                                className: (0, r.$)(c().navigation, { [c().navigation_desktop]: !u }),
                                withForwardControl: !1,
                            }),
                        (0, i.jsxs)('div', {
                            className: (0, r.$)(c().content, { [c().content_shrink]: !o }),
                            children: [
                                (0, i.jsx)(m.Icon, { className: c().icon, variant: 'attention', size: 'xxl' }),
                                (0, i.jsx)(v.Heading, { className: (0, r.$)(c().title, c().important), variant: 'h3', size: 'xs', children: a }),
                                (0, i.jsxs)(v.Caption, {
