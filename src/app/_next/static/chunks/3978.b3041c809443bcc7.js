    ...
    [3978, 4328, 5219, 9894],
    {
        ...
        13978: (e, t, n) => {
            ...
            let l = () => {
                ...
                return (
                    (0, o.toBoolean)(!1) && !(0, o.toBoolean)(u.env.LOCAL_PROD_BUILD) && (e = 'http://music-backend-music-api-gateway.envoy.localhost:9080'),
                    (0, r.A)((0, c.config)(), {
                        resources: { musicExternalApi: { prefixUrl: e } },
                        player: { overembed: !1, secretKey: (0, a.E)(), externalDomain: 'next.music.yandex.ru', prefixUrl: e },
                        blackbox: {
                            ...((0, o.toBoolean)(u.env.LOCAL_PROD_BUILD) ? { host: 'http://local-music-dev.vla.yp-c.yandex.net/bbm/blackbox' } : {}),
                            enabled: !0,
                        },
                                ...
                                : (0, v.A)(E)
                                  ...
                                  : w
                                    ...
                                    : C
                                      ...
                                      : (P = [])
                            : (0, y.A)(_) || (0, f.A)(_)
                              ? ((P = E), (0, f.A)(E) ? (P = (0, S.A)(E)) : (!(0, b.A)(E) || (0, m.A)(E)) && (P = (0, d.A)(_)))
                              : (O = !1);
                }
