!(function () {
    ...
    var W = n,
                ...
                ? Pt
                    ? function (t, e, r) {
                          if ((kt(t), (e = bt(e)), kt(r), 'function' == typeof t && 'prototype' === e && 'value' in r && Nt in r && !r[Nt])) {
                              var n = Mt(t, e);
                              n && n[Nt] && ((t[e] = r.value), (r = { configurable: Ut in r ? r[Ut] : n[Ut], enumerable: Lt in r ? r[Lt] : n[Lt], writable: !1 }));
                          }
                          return Tt(t, e, r);
                      }
                    : Tt
        ...
        Dt = ut(Ft, 'name'),
        zt = { EXISTS: Dt, PROPER: Dt && 'something' === function () {}.name, CONFIGURABLE: Dt && (!u || (u && Bt(Ft, 'name').configurable)) },
    ...
    var rn = { IteratorPrototype: Fr, BUGGY_SAFARI_ITERATORS: tn },
        ...
        Rn = function (t, e, r, n, o, i, a) {
            ...
            if (
                (y && (u = Qr(y.call(new t()))) !== Object.prototype && u.next && (Qr(u) !== mn && (dn ? dn(u, mn) : T(u[wn]) || ie(u, wn, xn)), an(u, h, !0)),
                gn &&
                    o === En &&
                    d &&
                    d.name !== En &&
                ...
                if (((s = { values: l(En), keys: i ? g : l(Sn), entries: l(On) }), a)) for (c in s) (bn || p || !(c in v)) && ie(v, c, s[c]);
    ...
    var Tn = function (t, e, r) {
        ...
        Wn = function (t) {
            ...
            else for (u = r ? new this() : [], l = (c = Dn(e, p)).next; !(s = f(l, c)).done; v++) (h = i ? Mn(c, o, [s.value, v], !0) : s.value), Cn(u, v, h);
            return (u.length = v), u;
        },
        qn = dt('iterator'),
        Hn = !1;
                ...
                var o = t(function (t, o) {
                    ...
                    s = function (t, e, r) {
                        ...
                        return (
                            s
                                ? (s.value = r)
                                : ((i.last = s = { index: (o = No(e, !0)), key: e, value: r, previous: (n = i.last), next: null, removed: !1 }),
                                  i.first || (i.first = s),
                                  n && (n.next = s),
                                  u ? i.size++ : t.size++,
                                  'F' !== o && (i.index[o] = s)),
            ...
            if (!i || !u || r) {
                var s = /./[o],
                    c = e(o, ''[t], function (t, e, r, n, o) {
                        var a = e.exec;
                        return a === ec || a === hc.exec ? (i && !o ? { done: !0, value: f(s, e, r, n) } : { done: !0, value: f(t, r, e, n) }) : { done: !1 };
                    });
    ...
    if ((bl('asyncDispose'), Mh)) {
        ...
        Lh.enumerable && Lh.configurable && Lh.writable && Ih(Mh, 'asyncDispose', { value: Lh.value, enumerable: !1, configurable: !1, writable: !1 });
    }
    var Uh = Ct.f,
        Nh = Rt.f,
        Ch = i.Symbol;
    if ((bl('dispose'), Ch)) {
        ...
        _h.enumerable && _h.configurable && _h.writable && Uh(Ch, 'dispose', { value: _h.value, enumerable: !1, configurable: !1, writable: !1 });
    }
    bl('metadata');
    var Fh = L('Symbol'),
        Bh = Fh.keyFor,
    ...
    if (
        (Mo(
            Ev,
            {
                ...
                delete: function (t) {
                    for (
                        var e = Wp(this), r = Up(arguments.length, 1), n = e.entries, o = Wr(t), i = r < 2 ? void 0 : arguments[1], a = void 0 === i ? i : Wr(i), s = 0;
                        s < n.length;
                ...
                has: function (t) {
                    for (
                        var e = Wp(this).entries, r = Up(arguments.length, 1), n = Wr(t), o = r < 2 ? void 0 : arguments[1], i = void 0 === o ? o : Wr(o), a = 0;
                        a < e.length;
        ...
        if (
            ...
            (Gp.constructor = Pv), (Pv.prototype = Gp), Ce({ global: !0, constructor: !0, dontCallGetSet: !0, forced: !0 }, { Request: Pv });
        }
    }
        ...
        Gd = function (t) {
            ...
            if ('object' == typeof t) {
                for (
                    ...
                    (o && 0 === t[r]) || (o && (o = !1), n === r ? ((e += r ? ':' : '::'), (o = !0)) : ((e += Od(t[r], 16)), r < 7 && (e += ':')));
                return '[' + e + ']';
            }
            return t;
        },
    ...
    xg.prototype = {
                            ...
                            if (
                                ('..' === (u = Id((u = l))) || '%2e.' === u || '.%2e' === u || '%2e%2e' === u
                                    ...
                                    : rg(l)
                                      ...
                                      : ('file' === s.scheme && !s.path.length && tg(l) && (s.host && (s.host = ''), (l = wd(l, 0) + ':')), Rd(s.path, l)),
                                (l = ''),
        ...
        serialize: function () {
            ...
            return (
                null !== o
                    ? ((c += '//'), t.includesCredentials() && (c += r + (n ? ':' + n : '') + '@'), (c += Gd(o)), null !== i && (c += ':' + i))
                    : 'file' === e && (c += '//'),
    ...
    var Ky,
        ...
        Pm = function (t, e, r) {
            var n, o;
            Sm ? (((n = ym.createEvent('Event')).promise = e), (n.reason = r), n.initEvent(t, !1, !0), i.dispatchEvent(n)) : (n = { promise: e, reason: r }),
                !cm && (o = i['on' + t])
                    ? o(n)
                    : t === Em &&
                      (function (t, e) {
                    ...
                    this.headers.get('content-type') ||
                        ('string' == typeof t
                            ...
                            : this._bodyBlob && this._bodyBlob.type
                              ...
                              : Hm && URLSearchParams.prototype.isPrototypeOf(t) && this.headers.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'));
            }),
            Km &&
                ((this.blob = function () {
                    var t = eb(this);
