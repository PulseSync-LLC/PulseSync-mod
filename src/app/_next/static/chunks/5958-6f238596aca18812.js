    ...
    [5958],
    {
        ...
        51991: (e, t, a) => {
            ...
            let m = (0, r.PA)((e) => {
                    let {
                            className: t,
                            children: a,
                            background: { animationDuration: r, withPersonalColor: u, videoUrl: m, firstFrameVideoUrl: _, bgImageUrl: v, withSound: x },
                            isActive: p,
                            isContentVisible: S,
                            setContentVisible: C,
                    ...
                    (0, n.useEffect)(() => {
                        ...
                        (0, n.useEffect)(() => {
                            var e, t, a;
                            p && !N
                                ? ((null == (e = y.current) ? void 0 : e.readyState) !== 4 && I(),
                                  null == (t = y.current) ||
                                      t
                                          .play()
                                          .then(() => {
                    ...
                    return (0, i.jsxs)('div', {
                        ...
                        style: f,
                        children: [
                            R && (0, i.jsx)(o.Image, { src: (0, s.createAvatarUrl)(v, 800, !0), className: g().firstFrame }),
                            A && (0, i.jsx)(o.Image, { src: _, className: g().firstFrame }),
                            m &&
                                (0, i.jsx)('video', {
                                    className: (0, l.$)(g().media, { [g().media_withPersonalColor]: u }),
                                    ref: y,
                                    src: m,
        ...
        65520: (e, t, a) => {
            ...
            var i,
                ...
                v = a(93134),
                x = a(77868);
            let p = { 6: 84, 7: 84, 8: 68, 9: 68, 10: 56, 11: 56, 12: 48, 13: 48 };
            var S = a(20794),
                C = a.n(S);
            let T = (e) => {
                let { data: t, className: a, valueClassName: i, valueContainerClassName: l, withAutoResize: r, descriptionLineClamp: n } = e,
                    o = (0, d.useRef)(null),
                    { formatNumber: c } = (0, _.A)(),
                    u = (0, d.useCallback)((e) => (e >= 1e4 ? c(e) : String(e)), [c]);
                (0, d.useEffect)(() => {
                    if (o.current) {
                        if (!t.value) return;
                        let e = new m.T(o.current, Number(t.value), { startVal: 1, formattingFn: u });
                        e.error || e.start();
                    }
                }, [t.value, u]);
                let S = (0, d.useMemo)(() => {
                ...
                return (0, s.jsxs)(s.Fragment, {
                    children: [
                        (0, s.jsxs)(v.q, { children: [t.value, ' ', t.valueSuffix, ' ', t.valueDescription] }),
                        (0, s.jsxs)('div', {
                            ...
                            children: [
                                (0, s.jsxs)('div', {
                                    ...
                                    children: [
                                        ...
                                        t.valueSuffix &&
                                            (0, s.jsx)(x.Heading, { variant: 'div', size: 'xxxxl', className: C().value, style: S, children: t.valueSuffix }),
                                    ],
                                }),
                                (0, s.jsx)(x.Heading, { variant: 'div', size: 'xl', weight: 'black', className: C().unit, lineClamp: n, children: t.valueDescription }),
                                t.footer &&
                                    (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: C().footer, children: t.footer }),
                            ],
                        }),
                    ],
                });
            ...
            let N = (e) => {
                let { data: t } = e,
                    ...
                    i = (0, d.useMemo)(() => ({ '--covers-offset-translate': ''.concat((t.covers.length - 1) * 7.5, 'px') }), [t.covers]),
                    l = (0, d.useCallback)((e) => ({ '--cover-offset-translate': '-'.concat(15 * e, 'px') }), []);
                return (0, s.jsxs)('div', {
                    className: h().root,
                    children: [
            ...
            let R = (0, E.PA)((e) => {
                    var t;
                    let { data: a, index: r, variant: n, isOrderVisible: m, hasOnlyArtistItems: v } = e,
                        { formatNumber: p } = (0, _.A)(),
                        S = (0, d.useMemo)(
                            () => ({ '--slide-final-translate-offset': n === o.x.CHART && v ? ''.concat(-8 * r, 'px') : 0, animationDelay: ''.concat(0.5 * r, 's') }),
                            [r, v, n],
                        ),
                        C = (0, d.useMemo)(() => {
                            ...
                            () =>
                                a.titleType === l.NUMBER && 'number' == typeof a.value
                                    ? (0, s.jsx)(T, {
                                          ...
                                          valueContainerClassName: A().statValueContainer,
                                      })
                                    : a.title
                                      ? n === o.x.CHART_ARTIST
                                          ? (0, s.jsx)(x.Heading, {
                        ...
                        h = (0, d.useMemo)(() => {
                            if (C)
                                return (n === o.x.CHART && v) || n === o.x.CHART_FAVORITES
                                    ? (0, s.jsx)(x.Heading, {
                                          variant: 'div',
                                          size: 's',
                                          weight: 'black',
                                          lineClamp: 2,
                                          className: (0, g.$)(A().textVariant, A().subTitle),
                                          children: C,
                                      })
                                    : (0, s.jsx)(x.Caption, {
                                          variant: 'span',
                                          ...
                                          weight: 'medium',
                                          lineClamp: 2,
                                          className: (0, g.$)(A().text, { [A().textVariant]: n === o.x.CHART_ARTIST }),
                                          children: C,
                                      });
                        }, [C, v, n]);
                    return (0, s.jsxs)('li', {
                        ...
                        tabIndex: 0,
                        children: [
                            m && (0, s.jsx)(x.Heading, { variant: 'div', size: 'l', weight: 'black', className: A().order, children: r + 1 }),
                            (0, s.jsx)(c.Paper, {
                                radius: a.coverType === i.CIRCLE ? 'round' : 'xs',
                                className: A().cover,
                                children:
                                    (null == (t = a.cover) ? void 0 : t.uri) &&
                                    (0, s.jsx)(u.BW, { src: a.cover.uri, withAvatarReplace: !0, fit: 'contain', className: A().image, size: 100 }),
                            }),
                            (0, s.jsxs)('div', { className: A().meta, children: [b, h] }),
                        ],
                    });
                }),
                w = (e) => {
                    let { items: t, isOrderVisible: a, variant: l } = e,
                        r = (0, d.useMemo)(() => t.every((e) => e.coverType === i.CIRCLE), [t]),
                        n = (0, d.useMemo)(() => {
                            switch (l) {
                    ...
                    return (0, s.jsx)('ol', {
                        className: (0, g.$)(K().root, K()['root_spacer_'.concat(n)]),
                        tabIndex: -1,
                        children: t.map((e, t) => (0, s.jsx)(R, { data: e, index: t, variant: l, hasOnlyArtistItems: r, isOrderVisible: a }, e.title)),
                    });
                };
            var j = a(2424),
                L = a.n(j);
                    ...
                    children: [
                        (null == (t = a.cover) ? void 0 : t.uri) &&
                            (0, s.jsx)(c.Paper, {
                                radius: 'round',
                                className: L().cover,
                                children: (0, s.jsx)(u.BW, { src: a.cover.uri, withAvatarReplace: !0, fit: 'contain', className: L().image, size: 200 }),
                            }),
                        a.title && (0, s.jsx)(x.Heading, { variant: 'div', size: 'xl', weight: 'bold', className: L().title, lineClamp: 2, children: a.title }),
                        (0, s.jsx)(w, { items: a.items, isOrderVisible: !1, variant: o.x.CHART_ARTIST }),
                    ],
                });
            };
            var O = a(97142),
            ...
            let P = (e) => {
                ...
                return (0, s.jsxs)('div', {
                    ...
                    children: [
                        t.description &&
                            (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: D().text, children: t.description }),
                        (0, s.jsx)(w, { items: t.items, variant: o.x.CHART, isOrderVisible: t.isOrderVisible }),
                    ],
                });
            };
            var X = a(31334),
            ...
            let G = (e) => {
                ...
                return (0, s.jsxs)('div', {
                    ...
                    children: [
                        ...
                        t.description &&
                            (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: H().description, children: t.description }),
                        (0, s.jsx)(w, { items: t.items, isOrderVisible: t.isOrderVisible, variant: o.x.CHART_FAVORITES }),
                    ],
                });
            };
            (r || (r = {})).REWIND = 'REWIND';
            var z = a(88442),
                M = a(52756),
                V = a(79169);
            let B = { src: '/_next/static/media/trailer_animated.aa3fd227.gif' };
            var U = a(54874),
                F = a.n(U);
            let W = (0, E.PA)((e) => {
                var t, a, i;
                let { data: l, withPersonalColor: n } = e,
                    { user: o } = (0, V.Pjs)(),
                    m = l.entityType === r.REWIND || !!(null == (t = l.smallRoundCover) ? void 0 : t.uri),
                    _ = (0, d.useMemo)(() => {
                        ...
                        return {
                            '--cover-background-color': (0, V.eWZ)(o.collectionHue, 0.8, 0.6),
                            '--small-round-cover-background-color': (0, V.eWZ)(o.collectionHue, 1, 0.35),
                        };
                    }, [l.cover.color, null == (a = l.smallRoundCover) ? void 0 : a.color, o.collectionHue, n]),
                    v = (0, d.useMemo)(() => {
                        var e;
                        return l.entityType === r.REWIND
                            ...
                            : (null == (e = l.smallRoundCover) ? void 0 : e.uri)
                              ? (0, s.jsx)(c.Paper, {
                                    radius: 'round',
                                    className: (0, g.$)(F().smallRoundCover, F().smallRoundCover_withShadow),
                                    children: (0, s.jsx)(u.BW, { src: l.smallRoundCover.uri, withAvatarReplace: !0, fit: 'contain', size: 100, className: F().image }),
                                })
                              : void 0;
                    }, [l.entityType, null == (i = l.smallRoundCover) ? void 0 : i.uri]),
                    p = (e, t) => (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: t, lineClamp: 2, children: e }),
                    S = l.align === z.t.BOTTOM;
                return (0, s.jsxs)('div', {
                    className: F().root,
                    style: _,
                    children: [
                        !S && l.description && p(l.description, F().description),
                        (0, s.jsx)(c.Paper, {
                            className: (0, g.$)(F().cover, { [F().cover_small]: S }),
                            children:
                                l.cover.uri &&
                                (0, s.jsx)(u.pU, {
                        ...
                        (0, s.jsxs)('div', {
                            className: (0, g.$)(F().meta, { [F().meta_withCover]: m }),
                            children: [
                                v,
                                l.subtitle && p(l.subtitle, F().subtitle),
                                l.title && (0, s.jsx)(x.Heading, { variant: 'h3', size: 'xl', weight: 'bold', className: F().title, lineClamp: 1, children: l.title }),
                                S && l.description && p(l.description, F().description),
                            ],
                        }),
                    ],
            ...
            let q = (e) => {
                ...
                return (0, s.jsxs)('div', {
                    className: J().root,
                    children: [
                        (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: J().text, children: t.header }),
                        t.stats.map((e) => (0, s.jsx)(T, { data: e, descriptionLineClamp: 2, withAutoResize: !0 }, e.value)),
                        (0, s.jsx)(x.Caption, { variant: 'span', type: 'text', size: 'l', weight: 'medium', className: J().text, children: t.footer }),
                    ],
                });
            };
            !(function (e) {
                ...
                return (0, s.jsxs)('div', {
                    ...
                    children: [
                        (0, s.jsx)(x.Heading, {
                            ...
                            size: a,
                            weight: 'black',
                            className: (0, g.$)(Y().title, Y().text, Y()['title_size_'.concat(a)]),
                            children: t.title,
                        }),
                        (0, s.jsx)(x.Caption, {
                            variant: 'span',
                    ...
                    return (0, s.jsxs)('div', {
                        ...
                        children: [
                            (0, s.jsx)(x.Heading, {
                                ...
                                dangerouslySetInnerHTML: { __html: (0, ee.sanitizeDOM)(t || '') },
                            }),
                            (0, s.jsx)(x.Heading, {
                                variant: 'h3',
                                size: 'xl',
                                weight: 'black',
                                className: ea().text,
                                dangerouslySetInnerHTML: { __html: (0, ee.sanitizeDOM)(a || '') },
                            }),
                            i &&
                                (0, s.jsx)(x.Caption, {
                                    variant: 'span',
                                    ...
                                    weight: 'medium',
                                    className: ea().text,
                                    dangerouslySetInnerHTML: { __html: (0, ee.sanitizeDOM)(i) },
                                }),
                        ],
                    });
                },
            ...
            var er = a(13002),
                en = a.n(er);
            let es = (e) => {
                    let { label: t, description: a, artistsName: i, trackTitle: l, coverUri: r } = e,
                        n = [i, l].filter(Boolean).join(' • ');
                    return (0, s.jsxs)('div', {
                        children: [
                            (0, s.jsx)(x.Heading, { className: (0, g.$)(en().textSecondary, en().itemLabel), variant: 'h3', size: 's', weight: 'black', children: t }),
                            (0, s.jsx)(M.Image, {
                                className: en().cover,
                                src: r,
                                fit: 'cover',
                            ...
                            (0, s.jsx)(x.Caption, {
                                className: (0, g.$)(en().textPrimary, en().itemMeta),
                                variant: 'div',
                                type: 'text',
                                size: 'l',
                                weight: 'medium',
                            ...
                            (0, s.jsx)(x.Heading, { className: (0, g.$)(en().textSecondary, en().header), variant: 'h3', size: 'xl', weight: 'black', children: a }),
                        ],
                    });
                },
                eo = (0, E.PA)((e) => {
                    ...
                    let { data: v } = e,
                        { title: p, subtitle: S, firstItem: C, secondItem: T } = v;
                    return (0, s.jsxs)('div', {
                        className: en().root,
                        children: [
                            (0, s.jsxs)('div', {
                                ...
                                children: [
                                    (0, s.jsx)(x.Heading, {
                                        className: (0, g.$)(en().textPrimary, en().header),
                                        variant: 'h2',
                                        size: 'xxxl',
                                        weight: 'black',
                                        children: p,
                                    }),
                                    (0, s.jsx)(x.Heading, { className: en().textPrimary, variant: 'h3', size: 's', weight: 'black', children: S }),
                                ],
                            }),
                            C &&
                                (0, s.jsx)('div', {
                                    ...
                                    children: (0, s.jsx)(es, {
                                        ...
                                        artistsName: null != (o = null == (t = C.track) ? void 0 : t.artistsName) ? o : null,
                                        trackTitle: null != (d = null == (a = C.track) ? void 0 : a.title) ? d : null,
                            ...
                            T &&
                                (0, s.jsx)('div', {
                                    ...
                                    children: (0, s.jsx)(es, {
                                        ...
                                        artistsName: null != (u = null == (l = T.track) ? void 0 : l.artistsName) ? u : null,
                                        trackTitle: null != (m = null == (r = T.track) ? void 0 : r.title) ? m : null,
                                        coverUri: null != (_ = null == (n = T.track) ? void 0 : n.coverUri) ? _ : void 0,
                                    }),
                                }),
                        ],
                    });
                    ...
                    if (t.data)
                        switch (t.type) {
                            ...
                            case o.x.SINGLE_ENTITY:
                                return (0, s.jsx)(W, { data: t.data, withPersonalColor: a });
                            case o.x.TEXT_FACT:
        ...
        65958: (e, t, a) => {
            ...
            let c = (e) => (0, s.wg)({ uri: null == e ? void 0 : e.uri, color: null == e ? void 0 : e.color, videoUrl: null == e ? void 0 : e.videoUrl }),
                u = (e) => (0, s.wg)({ value: e.value, title: e.title, titleType: e.titleType, subtitle: e.subtitle, cover: e.cover, coverType: e.coverType }),
                g = (e) => (0, s.wg)({ value: e.value, valueDescription: e.valueDescription, valueSuffix: e.valueSuffix, footer: e.footer }),
                m = (e) => {
                    var t, a, i, l, r, n, s;
                    return {
                        ...
                        track: {
                            ...
                            artistsName: null != (s = null == (a = e.track.artists) ? void 0 : a.map((e) => e.name).join(', ')) ? s : null,
                        },
                    };
                },
                _ = (e, t) => {
                    ...
                    if (null == (l = e.content) ? void 0 : l.type)
                        switch (null == (_ = e.content) ? void 0 : _.type) {
                            ...
                            case d.x.SINGLE_ENTITY:
                                h = ((e) => {
                                    let { coverMask: t, coverBackground: a } = e.data;
                                    return (
                                        (t && a) ||
                                            ((t = 'avatars.mds.yandex.net/get-music-misc/28592/img.68eebe12749d24738fe2018e/%%'),
                                            (a = 'avatars.mds.yandex.net/get-music-misc/28592/img.68eebdb294053d016bcd7bf0/%%')),
                                        (0, s.wg)({
                                            type: e.type,
                                            data: {
                                                title: e.data.title,
                                                ...
                                                coverBackground: a,
                                                align: e.data.align,
                                                smallRoundCover: e.data.smallRoundCover ? c(e.data.smallRoundCover) : void 0,
                                            },
                                        })
                                    );
                                })(e.content);
                            ...
                            case d.x.TEXT:
                                ...
                                break;
                            case d.x.TEXT_FACT:
                                h = ((e) => (0, s.wg)({ type: e.type, data: g(e.data) }))(e.content);
                                break;
                            case d.x.CHART_ARTIST:
                                h = ((e) => {
                                    let t = e.data.cover ? c(e.data.cover) : null;
                                    return (0, s.wg)({ type: e.type, data: { title: e.data.title, cover: t, items: e.data.items.map(u) } });
                                })(e.content);
                                break;
                            case d.x.ARTISTS:
                                h = ((e) => {
                                    let t = e.data.covers ? e.data.covers.slice(0, 3).map(c) : [];
                                    return (0, s.wg)({
                                        type: e.type,
                                        data: {
                                            value: e.data.value,
                    ...
                    let N = null != (v = null == (r = e.trailer) ? void 0 : r.tracks) ? v : [],
                        y = null != (x = null == (n = e.meta) ? void 0 : n.animationDuration) ? x : 0.5;
                    return (0, s.wg)({
                        id: e.id,
                        background: {
                            animationDuration: y,
                            bgImageUrl: null != (p = e.background.bgImageUrl) ? p : '',
                            videoUrl: null != (S = e.background.videoUrl) ? S : '',
                            withSound: !!e.background.withSound,
                            firstFrameVideoUrl: null != (C = e.background.firstFrameVideoUrl) ? C : '',
            ...
            var v = a(75305);
            let x = s.gK.model('SlideButtonActionData', { title: s.gK.maybeNull(s.gK.string), imageUrl: s.gK.maybeNull(s.gK.string), url: s.gK.maybeNull(s.gK.string) }),
                p = s.gK.model('SlideButtonAction', { type: s.gK.literal(i.ACTION), data: x }),
                ...
                C = s.gK.model('SlideButtonSimple', { type: s.gK.literal(i.SIMPLE), data: S }),
                T = s.gK.model('SlideContentCover', { uri: s.gK.maybeNull(s.gK.string), color: s.gK.maybeNull(s.gK.string), videoUrl: s.gK.maybeNull(s.gK.string) }),
                ...
                h = s.gK.compose(s.gK.model('SlideContentArtistsModelData', { covers: s.gK.array(T) }), b),
                N = s.gK.model('SlideContentArtistsModel', { type: s.gK.literal(d.x.ARTISTS), data: s.gK.maybe(h) }),
                ...
                K = s.gK.model('SlideContentChartArtistData', { title: s.gK.maybeNull(s.gK.string), cover: s.gK.maybeNull(T), items: s.gK.array(y) }),
                E = s.gK.model('SlideContentChartArtist', { type: s.gK.literal(d.x.CHART_ARTIST), data: s.gK.maybe(K) }),
                I = s.gK.compose(
                    s.gK.model('SlideContentChartFavoritesData', { description: s.gK.maybeNull(s.gK.string), isOrderVisible: s.gK.boolean, items: s.gK.array(y) }),
                    b,
                ),
                f = s.gK.model('SlideContentChartFavorites', { type: s.gK.literal(d.x.CHART_FAVORITES), data: s.gK.maybe(I) }),
                A = s.gK.model('SlideContentChartData', { description: s.gK.maybeNull(s.gK.string), isOrderVisible: s.gK.boolean, items: s.gK.array(y) }),
                R = s.gK.model('SlideContentChart', { type: s.gK.literal(d.x.CHART), data: s.gK.maybe(A) }),
                ...
                j = s.gK.model('SlideContentSingleEntity', { type: s.gK.literal(d.x.SINGLE_ENTITY), data: s.gK.maybe(w) }),
                ...
                k = s.gK.model('SlideContentStats', { type: s.gK.literal(d.x.STATS), data: s.gK.maybe(L) }),
                O = s.gK.model('SlideContentTextExtendedData', {
                    title: s.gK.maybeNull(s.gK.string),
                    subtitle: s.gK.maybeNull(s.gK.string),
                    description: s.gK.maybeNull(s.gK.string),
                }),
                D = s.gK.model('SlideContentTextExtended', { type: s.gK.literal(d.x.TEXT_EXTENDED), data: s.gK.maybe(O) }),
                P = s.gK.model('SlideContentTextFact', { type: s.gK.literal(d.x.TEXT_FACT), data: s.gK.maybe(b) }),
                ...
                H = s.gK.model('SlideContentText', { type: s.gK.literal(d.x.TEXT), data: s.gK.maybe(X) }),
                ...
                V = s.gK.model('SlideContentThenNowComparison', { type: s.gK.literal(d.x.THEN_NOW_COMPARISON), data: s.gK.maybe(M) }),
                ...
                U = s.gK
                    .model('Slide', {
                        ...
                        content: s.gK.maybe(s.gK.union(R, f, j, H, k, P, E, N, D, V)),
                ...
                F = s.gK
                    .model('Slides', {
                        userSlidesLoadingState: s.gK.enumeration(Object.values(o.GuX)),
                        artistSlidesLoadingState: s.gK.enumeration(Object.values(o.GuX)),
                        podcastSlidesLoadingState: s.gK.enumeration(Object.values(o.GuX)),
                        specialSlidesLoadingState: s.gK.enumeration(Object.values(o.GuX)),
                        consumer: s.gK.maybe(s.gK.enumeration(Object.values(r))),
                    ...
                    .views((e) => ({
                        get shouldShowUserSlides() {
                            ...
                            return t.checkExperiment(o.zal.WebNextRewind2024, 'on');
                        },
                        get shouldShowMusicBirthdaySlides() {
                            if (!(0, s._n)(e)) return !1;
                            let { experiments: t } = (0, s.Zn)(e);
                            return t.checkExperiment(o.zal.WebNextMusicBirthday2025, 'on');
                        },
                        get isLoaded() {
                            return (
                    ...
                    .actions((e) => ({
                        ...
                        getUserSlides: (0, s.L3)(function* () {
                            let { slidesResource: t, modelActionsLogger: a } = (0, s._$)(e);
                        ...
                        getArtistSlides: (0, s.L3)(function* (t) {
                            let { slidesResource: a, modelActionsLogger: i } = (0, s._$)(e);
                ...
                return (0, W.jsxs)(ei.N_, {
                    ...
                    children: [
                        (0, W.jsx)(et.Paper, {
                            radius: 'xs',
                            className: er().cover,
                            children: a.imageUrl && (0, W.jsx)(ei.BW, { src: a.imageUrl, withAvatarReplace: !0, fit: 'contain', className: er().image, size: 100 }),
                        }),
                        (0, W.jsx)(ea.Caption, { variant: 'span', type: 'controls', size: 'l', weight: 'medium', className: er().text, lineClamp: 1, children: a.title }),
                        (0, W.jsx)(ee.Icon, { variant: 'arrowRight', size: 'xs', className: er().icon }),
                    ],
                });
            };
            var es = a(44189),
            ...
            let ec = (e) => {
                    ...
                    let { data: a, className: i } = e,
                        ...
                        r = (0, J.useMemo)(() => ({ '--text-color': a.textColor, '--button-color': a.buttonColor }), [a.buttonColor, a.textColor]);
                    return (0, W.jsx)(es.Button, {
                        ...
                        withRipple: !1,
                        onClick: l,
                        children: (0, W.jsx)(ea.Caption, { variant: 'span', type: 'controls', size: 'l', weight: 'medium', lineClamp: 1, children: a.title }),
                    });
                },
                eu = (e) => {
                    ...
                    switch (t.type) {
                        case i.ACTION:
                            if (t.data.url) return (0, W.jsx)(en, { data: t.data, className: a });
                            return null;
                        case i.SIMPLE:
                            if (t.data.url) return (0, W.jsx)(ec, { data: t.data, className: a });
                            return null;
                    }
                };
            var eg = a(65520),
            ...
            let ev = (e) => {
                ...
                return (0, W.jsx)('div', {
                    ...
                    children: (0, W.jsxs)(Q.Background, {
                        ...
                        children: [
                            t.logo && (0, W.jsx)('div', { className: e_().logo, children: (0, W.jsx)(Y.Logo, { alignIcon: 'center', lang: i }) }),
                            t.content &&
                                l &&
                                (0, W.jsx)('div', {
                                    className: (0, $.$)(e_().content, e_()['content_align_'.concat(s)], { [e_().playAnimation]: l }),
                                    children: (0, W.jsx)(eg.SlideContent, { content: t.content, withPersonalColor: t.background.withPersonalColor }),
                                }),
                            t.button && (0, W.jsx)(eu, { button: t.button, className: e_().button }),
                        ],
                    }),
                });
            };
