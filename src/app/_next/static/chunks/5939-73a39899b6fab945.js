    ...
    [5939],
    {
        ...
        10757: (e, t, o) => {
            ...
            let n = (e) => {
                ...
                const likeAction = (0, s.useCallback)(
                        (action) => {
                            null == e || onLikeClick?.(sonataState.entityMeta, action);
                            sendPlayerStateDefault?.(e);
                        },
                        [e, onLikeClick, sonataState.entityMeta],
                    ),
                    dislikeAction = (0, s.useCallback)(
                        (action) => {
                            null == e || onDislikeClick?.(sonataState.entityMeta, action);
                            sendPlayerStateDefault?.(e);
                        },
                        [e, onDislikeClick, sonataState.entityMeta],
                    );
                (0, s.useEffect)(() => {
                    var e;
                    return (
                ...
                (0, s.useEffect)(() => {
                    const handler = (event, payload) => {
                        const pulseSyncApi = window.pulsesyncApi;
                        if (!pulseSyncApi || !payload?.action) return;
                    ...
                    const off = window.desktopEvents?.on(a.EE.PULSESYNC_API, handler);
                    return () => {
                        off?.();
                    };
                }, []);
                (0, s.useEffect)(() => {
                    ...
                    window.pulsesyncApi.likeTrack = () => likeAction('LIKE');
                    window.pulsesyncApi.unlikeTrack = () => likeAction('LIKE_NONE');
                    window.pulsesyncApi.dislikeTrack = () => dislikeAction('DISLIKE');
                    window.pulsesyncApi.undislikeTrack = () => dislikeAction('DISLIKE_NONE');
            ...
            let s = {
                init: () => {
                    window.pulsesyncApi = {
                        playerInstance: null,
                        _pendingCalls: [],
                        _waitForPlayer: (callback) => {
                            if (window.pulsesyncApi.playerInstance) {
                                callback(window.pulsesyncApi.playerInstance);
                            } else {
                                window.pulsesyncApi._pendingCalls.push(callback);
                            }
                        },
                        ...
                        play: () => {
                            window.pulsesyncApi._waitForPlayer((playerInst) => {
                        ...
                        setVolume: (volume) => {
                            window.pulsesyncApi._waitForPlayer((playerInst) => {
                                playerInst.setExponentVolume?.(Math.min(Math.max(volume, 0), 100));
                            });
                        },
                        ...
                        playTrackById: (trackId, options = {}) => {
                            window.pulsesyncApi._waitForPlayer((playerInst) => {
                                const entityId = options?.albumId ? ''.concat(trackId, ':').concat(options.albumId) : trackId;
                                ...
                                if (currentId === entityId) {
                                    ...
                                    console.debug('[PulseSync API] Restarting track with id:', entityId);
                                    return;
                                }
                                ...
                                if (trackIndex !== -1) {
                                    ...
                                    console.debug('[PulseSync API] Playing track with id:', entityId, 'at index:', trackIndex);
                                    return;
                                }
                                ...
                                if (typeof playerInst?.playContext === 'function') {
                                    ...
                                    playerInst.playContext({
                                        ...
                                        entitiesData: [{ type: l.z4.Unloaded, meta: { id: entityId } }],
                                    });
                                    console.debug('[PulseSync API] Playing track with id:', entityId, 'via context');
                                } else {
                                    console.debug('[PulseSync API] Track with id:', entityId, 'not found in queue');
                                }

                                if (options.callback) {
                                    options.callback({ found: false, trackId: entityId, queueSize: queue.length });
                                }
                            });
                        },
                        addTrackToQueueById: (trackId, options = {}) => {
                            window.pulsesyncApi._waitForPlayer((playerInst) => {
                                const entityId = options?.albumId ? ''.concat(trackId, ':').concat(options.albumId) : trackId;
                                const entitiesData = [{ type: l.z4.Unloaded, meta: { id: entityId } }];
                                if (options?.position === 'next' && typeof playerInst?.injectNext === 'function') {
                                    playerInst.injectNext({ entitiesData });
                                    return;
                                }
                                if (typeof playerInst?.injectLast === 'function') {
                                    playerInst.injectLast({ entitiesData });
                                } else {
                                    console.debug('[PulseSync API] Cannot add track to queue. injectLast is unavailable.');
                                }
                            });
                        },
                        isTrackLiked: (trackId, albumId) => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            const entity = playerInst?.state?.queueState?.currentEntity?.value?.entity;
                            const likeStore = entity?.likeStore;
                            if (!likeStore?.isTrackLiked) return false;
                            if (trackId) {
                                const entityId = albumId ? ''.concat(trackId, ':').concat(albumId) : trackId;
                                return likeStore.isTrackLiked(entityId);
                            }
                            const currentId = entity?.entityData?.meta?.id;
                            return currentId ? likeStore.isTrackLiked(currentId) : false;
                        },
                        isTrackDisliked: (trackId, albumId) => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            const entity = playerInst?.state?.queueState?.currentEntity?.value?.entity;
                            const likeStore = entity?.likeStore;
                            if (!likeStore?.isTrackDisliked) return false;
                            if (trackId) {
                                const entityId = albumId ? ''.concat(trackId, ':').concat(albumId) : trackId;
                                return likeStore.isTrackDisliked(entityId);
                            }
                            const currentId = entity?.entityData?.meta?.id;
                            return currentId ? likeStore.isTrackDisliked(currentId) : false;
                        },
                        getState: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state;
                        },
                        isPlaying: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.playerState?.status?.value === 'playing';
                        },
                        getCurrentTrack: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.queueState?.currentEntity?.value?.entity?.entityData?.meta;
                        },
                        getQueue: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.queueState?.entityList?.value;
                        },
                        getProgress: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.playerState?.progress?.value;
                        },
                        getDuration: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.queueState?.currentEntity?.value?.entity?.entityData?.meta?.duration;
                        },
                        getVolume: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.playerState?.volume?.value;
                        },
                        getRepeatMode: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.queueState?.repeat?.value;
                        },
                        isShuffle: () => {
                            const playerInst = window.pulsesyncApi?.playerInstance;
                            return playerInst?.state?.queueState?.shuffle?.value;
                        },
                    ...
                    (0, s.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, s.jsxs)('div', {
                                className: p().content,
                                children: [
                                    (0, s.jsx)(i.Icon, { className: (0, a.$)(p().icon, m), variant: h, size: x }),
                                    (0, s.jsx)(d.Heading, {
                                        className: (0, a.$)(p().title, p().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: o || (0, s.jsx)(n.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, s.jsx)(d.Caption, {
            ...
            let h = (e) => {
                                ...
                                (0, s.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, s.jsx)(d.Caption, {
                                            ...
                                            type: 'controls',
                                            size: 'm',
                                            children: o({ id: 'desktop.on-update-available' }, { version: t }),
                                        }),
                                        (0, s.jsx)(i.Button, {
                                            className: _().button,
                                            onClick: u,
                                            ...
                                            size: 'xs',
                                            radius: 'xxxl',
                                            children: (0, s.jsx)(d.Caption, { variant: 'div', type: 'controls', size: 'm', children: o({ id: 'desktop.update' }) }),
                                        }),
                                    ],
                                }),
                            [o, u, t],
                ...
                modUpdateToast = (e) => {
                    let { version: version, formatMessage: o, closeToast: l } = e,
                        ...
                        progressBarUpdate = (0, a.useCallback)((event, elementType, progress, dedupeTimestamp = 0) => {
                        ...
                        (0, a.useEffect)(() => {
                            ...
                            return (
                                null == (e = window.desktopEvents) ||
                                    e.on(n.EE.MOD_UPDATE_AVAILABLE, () => {
                                        l();
                                    }),
                                () => {
                                    var e;
                                    null == (e = window.desktopEvents) ||
                                        e.off(n.EE.MOD_UPDATE_AVAILABLE, () => {
                                            l();
                                        });
                                }
                            );
                    ...
                    let { formatMessage: e } = (0, l.A)(),
                        ...
                        modUpdateCallback = (0, a.useCallback)(
                            (a, oldVersion, newVersion, dedupeTimestamp = 0) => {
                                ...
                                modUpdateNotify(
                                    (0, s.jsx)(modUpdateToast, { formatMessage: e, version: `${oldVersion} -> ${newVersion}`, closeToast: modUpdateDismiss }),
                                    {
                                        containerId: n.uQT.IMPORTANT,
                                    },
                                );
            ...
            let r = (e) => {
                ...
                (0, s.useEffect)(() => {
                    ...
                    let e,
                        ...
                        getCurrentTrackListener = window.desktopEvents?.on(n.EE.GET_CURRENT_TRACK, () => {
                            sendPlayerStateDefault(t);
                        }),
                        currentContextListener =
                            null == t
                                ? void 0
        ...
        77575: (e, t, o) => {
            ...
            var a = o(79169);
            let l = (e) => {
                    if (!window?.HOST_VERSION || !window?.PULSE_VERSION || !window?.ENABLED_ADDONS) {
                        window.close();
                        return;
                    }
                    ...
                    (async () => {
                        try {
                            const fn = window.ENABLED_ADDONS;
                            if (typeof fn !== 'function') throw 0;

                            const { scripts } = await fn();
                            if (!Array.isArray(scripts)) throw 0;

                            const key = String.fromCharCode(119, 111, 108, 102, 121, 108, 105, 98, 114, 97, 114, 121);

                            if (!scripts.some((s) => s === key || (s && typeof s === 'object' && s.id === key))) {
                                throw 0;
                            }
                        } catch {
                            window.close();
            ...
            var r = o(34875),
                ...
                v = o(59615),
                playerApi = o(10758);
            playerApi.default.init();
            let A = C.gK.model('TranslationsModel', { data: C.gK.frozen() }),
                E = C.gK
                    .model('ReleaseNotes', { modal: v.qt, translations: C.gK.maybeNull(A), sortedDescReleaseNotesKeys: C.gK.maybeNull(C.gK.array(C.gK.string)) })
                    .views((e) => ({
                        get isReady() {
                            var t;
                            return !!(
            ...
            let A = (0, a.PA)((e) => {
                    ...
                    let j = (0, n.useMemo)(
                        ...
                        R = (0, n.useMemo)(
                            () =>
                                a
                                    ? (0, s.jsx)(x.Hi, { size: 'm', className: v().loginButton })
                                    : A
                                      ? (0, s.jsx)(d.Button, {
                                            onClick: b,
                    ...
                    return (
                        ...
                        (0, s.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, s.jsx)('div', { className: v().logoContainer, children: (0, s.jsx)(c.Logo, { alignIcon: 'center', lang: w, className: v().logo }) }),
                                j,
                                P,
                                R,
                                (0, s.jsx)('img', { className: v().image, src: k }),
                                C &&
                                    (0, s.jsx)(p.YS, {
                                        className: v().user,
                                        withMeta: !g,
            ...
            let _ = (e) => {
                ...
                h = (0, l.PA)((e) => {
                    let { withSecondaryColor: t } = e,
                        ...
                        handleDivDoubleClick = (0, n.useCallback)((e) => {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(_, {
                                        ...
                                        children: (0, s.jsx)('svg', {
                                            ...
                                            viewBox: '0 0 10 1',
                                            xmlns: 'http://www.w3.org/2000/svg',
                                            className: (0, a.$)(u().icon, { [u().icon_withSecondaryColor]: t }),
            ...
            let p = (0, a.PA)((e) => {
                    ...
                    let { isAuthorizedUser: p = !1 } = e,
                        ...
                        b = (0, n.useMemo)(
                            () =>
                                p
                                    ? (0, s.jsx)(i.Button, { onClick: N, className: h().button, role: 'link', color: 'primary', size: 'l', radius: 'xxxl', children: f })
                                    : (0, s.jsx)(i.Button, { onClick: w, className: h().button, role: 'link', color: 'primary', size: 'l', radius: 'xxxl', children: k }),
                            [p, w, k, N, f],
                        ),
                            ...
                            (0, s.jsxs)('div', {
                                ...
                                children: [
                                    (0, s.jsxs)('div', {
                                        className: h().content,
                                        children: [
                                            (0, s.jsx)(d.Heading, { variant: 'h1', size: v ? 'xl' : 'xxl', weight: 'bold', className: h().title, children: j }),
                                            b,
                                        ],
                                    }),
