    ...
    [6659],
    {
        ...
        25601: (e, t, i) => {
            ...
            var n,
                ...
                p = { UNSPECIFIED: 'UNSPECIFIED', NONE: 'NONE', ONE: 'ONE', ALL: 'ALL' },
                f = { DO_NOT_INTERCEPT_BY_DEFAULT: 'DO_NOT_INTERCEPT_BY_DEFAULT', INTERCEPT_EAGER: 'INTERCEPT_EAGER' },
                d = { UNSPECIFIED: 'UNSPECIFIED', TRACK: 'TRACK', LOCAL_TRACK: 'LOCAL_TRACK', INFINITE: 'INFINITE', VIDEO_CLIP: 'VIDEO_CLIP' },
                v = {
                ...
                O = (function () {
                    function e(e) {
                        (Object.defineProperty(this, 'state', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            Object.defineProperty(this, 'lastRemoteDeviceChangingState', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            Object.defineProperty(this, 'lastRemoteDeviceChangingStateTS', { enumerable: !0, configurable: !0, writable: !0, value: 0 }),
                            Object.defineProperty(this, 'listenersMap', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            (this.options = e),
                    ...
                    return (
                        Object.defineProperty(e.prototype, 'on', {
                            ...
                            value: function (e, t, i) {
                                ...
                                return (
                                    r ? r.push({ callback: t, trigger: i }) : this.listenersMap.set(e, [{ callback: t, trigger: i }]),
                                    function () {
                                        return n.off(e, t);
                                    }
                                );
                        ...
                        Object.defineProperty(e.prototype, 'fullState', {
                            get: function () {
                                return m({ state: this.state, prevState: this.prevState, diff: this.diff });
                            },
                            enumerable: !1,
                            configurable: !0,
                        }),
                        Object.defineProperty(e.prototype, 'updateState', {
                            ...
                            value: function (e) {
                                ...
                                this.diff = {};
                                try {
                                    for (var r = e.isSetNewState; i.length > 0; )
                                        for (var a = i.pop(), o = 0, s = Object.keys(a); o < s.length; o++) {
                                            var c = a[s[o]];
                                            'function' == typeof c ? c(e) : i.push(c);
                                        }
                        ...
                        Object.defineProperty(e.prototype, 'calculateDevicesDiff', {
                            ...
                            value: function (e) {
                                var t = this,
                                    ...
                                    r = this.state.devices.find(function (e) {
                                        var i;
                                        return (null == (i = e.info) ? void 0 : i.device_id) === t.options.deviceConfig.info.device_id;
                                    }),
                                    ...
                                    o = (function (e, t, i) {
                                        if (!t || !i) return { isVolumeChanged: !1, isNewVersion: !1 };
                                        var n = t.volume_info,
                                            r = i.volume_info,
                                            a = g(e, n.version, r.version);
                                        return {
                                            isVolumeChanged: _(n.volume, t.capabilities.volume_granularity) !== _(r.volume, i.capabilities.volume_granularity),
                                            isNewVersion: a,
                                        };
                                    })(void 0 !== n && n, r, a),
                                    s = o.isVolumeChanged,
                                    c = o.isNewVersion;
                                s && c && a && (this.diff.deviceVolume = a.volume_info);
                                var l = (function (e, t) {
                                    ...
                                    if (e.length < t.length)
                                        for (
                                            var n = function (t) {
                                                    ...
                                                    }) || (i = { isAnyoneConnectionChanged: !0, changedConnectionStatusDevice: t });
                                                },
                                                r = 0;
                                            r < t.length;
                                            r++
                                        ...
                                        for (
                                            var o = function (t) {
                                                    ...
                                                    n && n.is_offline !== t.is_offline && (i = { isAnyoneConnectionChanged: !0, changedConnectionStatusDevice: t });
                                                },
                                                s = 0;
                                            s < t.length;
                                            s++
                                    ...
                                    return i;
                                })(this.state.devices, i.devices).isAnyoneConnectionChanged;
                                ((s && c) || l) && (this.diff.devices = i.devices);
                            },
                        }),
                        Object.defineProperty(e.prototype, 'calculateEntityIdDiff', {
                            ...
                            value: function (e) {
                                ...
                                g(void 0 !== i && i, a.version, r) &&
                                    ...
                                    this.diff.player_state && this.diff.player_state.player_queue && (this.diff.player_state.player_queue.entity_id = n));
                            },
                        }),
                        Object.defineProperty(e.prototype, 'calculateEntityTypeDiff', {
                            ...
                            value: function (e) {
                                ...
                                g(void 0 !== r && r, a.version, n) &&
                                    o !== i &&
                                    (this.initPlayerState(!0, !1),
                                    this.diff.player_state && this.diff.player_state.player_queue && (this.diff.player_state.player_queue.entity_type = i));
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'calculatePlayableListDiff', {
                            ...
                            value: function (e) {
                                    ...
                                    c = (function (e, t) {
                                        ...
                                        if (e.length === t.length) {
                                            for (var r = e.length, a = 0; a < r; a++)
                                                if (t[a] && (null == (i = e[a]) ? void 0 : i.playable_id) !== (null == (n = t[a]) ? void 0 : n.playable_id)) return !1;
                                            return !0;
                                        }
                                        return !1;
                                    })(o, n);
                                s &&
                                    !c &&
                                    (this.initPlayerState(!0, !1),
                                    this.diff.player_state && this.diff.player_state.player_queue && (this.diff.player_state.player_queue.playable_list = n));
                            },
                        }),
                            ...
                            value: function (e) {
                                var t = e.newState.player_state.player_queue,
                                    ...
                                    c = (function (e, t) {
                                        ...
                                        if (e && t && e.playable_indices.length === t.playable_indices.length) {
                                            for (var i = !0, n = 0; n <= e.playable_indices.length; n++)
                                ...
                                s &&
                                    ...
                                    this.diff.player_state &&
                                        ...
                                        (i
                                            ? (this.diff.player_state.player_queue.shuffle_optional = i)
                        ...
                        Object.defineProperty(e.prototype, 'calculateRepeatDiff', {
                            ...
                            value: function (e) {
                                ...
                                g(void 0 !== r && r, c, n) &&
                                    l !== a &&
                                    (this.initPlayerState(!0, !1),
                                    this.diff.player_state && this.diff.player_state.player_queue && (this.diff.player_state.player_queue.options = i));
                            },
                        }),
                        Object.defineProperty(e.prototype, 'calculateProgressMsDiff', {
                            ...
                            value: function (e) {
                                var t,
                                    ...
                                    p = (t = Number(a)) !== (i = Number(c)) && (i < 1500 || Math.abs(t - i) > l);
                                u &&
                                    p &&
                                    (this.initPlayerState(!1, !0),
                                    this.diff.player_state && this.diff.player_state.status && (this.diff.player_state.status.progress_ms = a));
                            },
                        }),
                        Object.defineProperty(e.prototype, 'calculateSpeedDiff', {
                            ...
                            value: function (e) {
                                ...
                                g(void 0 !== r && r, a.version, n) &&
                                    o !== i &&
                                    (this.initPlayerState(!1, !0),
                                    this.diff.player_state && this.diff.player_state.status && (this.diff.player_state.status.playback_speed = i));
                            },
                        }),
                        Object.defineProperty(e.prototype, 'calculatePausedDiff', {
                            ...
                            value: function (e) {
                                ...
                                g(void 0 !== i && i, a.version, r) &&
                                    o !== n &&
                                    (this.initPlayerState(!1, !0), this.diff.player_state && this.diff.player_state.status && (this.diff.player_state.status.paused = n));
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'updateLastRemoteDeviceChangingState', {
                            ...
                            value: function (e) {
                                var t,
                                    ...
                                    s = this.options.deviceConfig.info.device_id,
                                    c = [n, r],
                                    l = a.find(function (e) {
                                ...
                                if (u.length > 0) {
                                    ...
                                    (this.lastRemoteDeviceChangingState &&
                                        ...
                                        ((void 0 === this.lastRemoteDeviceChangingState && f) ||
                                            (this.lastRemoteDeviceChangingState && f && this.lastRemoteDeviceChangingState.info.device_id !== f.info.device_id) ||
                                            (this.lastRemoteDeviceChangingState &&
                                                f &&
                                                this.lastRemoteDeviceChangingState.info.device_id === f.info.device_id &&
                                                this.lastRemoteDeviceChangingState.is_offline &&
                        ...
                        Object.defineProperty(e.prototype, 'getLastRemoteDeviceChangingState', {
                            ...
                            writable: !0,
                            value: function () {
                                return { device: this.lastRemoteDeviceChangingState, timestampMs: this.lastRemoteDeviceChangingStateTS };
                            },
                        }),
                        Object.defineProperty(e.prototype, 'getOnlineRemoteDevices', {
                            ...
                            value: function () {
                                ...
                                return t.filter(function (e) {
                                    var t = [u.ANDROID, u.IOS, u.WEB].includes(e.info.type);
                ...
                w = function (e, t) {
                    ...
                    if (null != e && 'function' == typeof Object.getOwnPropertySymbols)
                        for (var r = 0, n = Object.getOwnPropertySymbols(e); r < n.length; r++)
                            0 > t.indexOf(n[r]) && Object.prototype.propertyIsEnumerable.call(e, n[r]) && (i[n[r]] = e[n[r]]);
                    return i;
                },
                D = (function (e) {
                    function t(i, n) {
                        ...
                        var r = this,
                            ...
                            o = w(n, ['code']);
                        return (
                            Object.defineProperty((r = e.call(this, i, R({ code: void 0 === a ? 'E_HUB_EXCEPTION' : a }, o)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
                                value: 'HubException',
                ...
                k = (function (e) {
                    function t(i, n) {
                        ...
                        var r = this,
                            ...
                            o = j(n, ['code']);
                        return (
                            Object.defineProperty((r = e.call(this, i, N({ code: void 0 === a ? 'E_REDIRECTOR_EXCEPTION' : a }, o)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
            ...
            var L = function (e, t) {
                        ...
                        return function (c) {
                            ...
                            for (; a && ((a = 0), l[0] && (o = 0)), o; )
                                try {
                                    if (
                                        ((i = 1),
                                        n && (r = 2 & l[0] ? n.return : l[0] ? n.throw || ((r = n.return) && r.call(n), 0) : n.next) && !(r = r.call(n, l[1])).done)
                                    )
                                        return r;
                                                    ...
                                                    var v = new WebSocket(Object.values(t.connectionConfig).join(''), [
                                                        ...
                                                        h = function (e) {
                                                            try {
                                                                ...
                                                                'error' in t
                                                                    ? (v.close(), n(new k('Error message from redirector', { data: { redirectorResponse: t.error } })))
                                                                    : (v.close(), i(t));
                                                            } catch (e) {
                                                                new k('Error while processing message from redirector', {
                ...
                Y = (function () {
                    function e(e) {
                        ...
                        (Object.defineProperty(this, 'connectorConfig', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            Object.defineProperty(this, 'state', {
                                ...
                                configurable: !0,
                                writable: !0,
                                value: new A({ redirectorResponse: null, connectionState: a.DISCONNECTED }),
                            }),
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'updatePlayingStatus', {
                            ...
                            value: function (e, t) {
                                var i = B({}, e);
                                i.playing_status.version = y(this.connectorConfig.device.device_id);
                        ...
                        Object.defineProperty(e.prototype, 'updateVolumeInfo', {
                            ...
                            value: function (e, t) {
                                var i = B({}, e);
                                i.volume_info.version = y(this.connectorConfig.device.device_id);
                                ...
                                (void 0 !== i && (this.connectorConfig.oauth = i),
                                    ...
                                    [a.DISCONNECTED, a.READY_TO_RECONNECT].includes(this.state.connectionState.value) &&
                                        ...
                                        this.redirectorSocket
                                            ...
                                            .catch(function (e) {
                                                if (
                                                    ((t.state.connectionState.value = a.DISCONNECTED),
                            ...
                            value: function () {
                                ...
                                if (this.state.redirectorResponse.value) {
                                    var p,
                                        ...
                                        C =
                                            ((p = this.state.redirectorResponse.value),
                                            (d = n.type),
                                            (v = n.app_name),
                                            (h = n.app_version),
                                            (y = n.device_id),
                                            ...
                                            ((e.state.connectionState.value = a.DISCONNECTED),
                                                e.reconnectAttempts < e.connectorConfig.reconnectAttemptsLimit
                                                    ...
                                                    : ((e.reconnectAttempts = 0),
                                                      e.emitter.emit(
                                                          o.HUB_ERROR,
                                                          new D('Error in connection to hub', {
                                                              data: {
                        ...
                        Object.defineProperty(e.prototype, 'reconnect', {
                            ...
                            value: function (e) {
                                ...
                                void 0 === e && (e = {});
                                var i = e.timeout,
                                    n = void 0 === i ? this.connectorConfig.defaultReconnectTimeoutMS : i;
                                this.state.connectionState.value === a.DISCONNECTED &&
                        ...
                        Object.defineProperty(e.prototype, 'onRecieveMessage', {
                            ...
                            value: function (e) {
                                try {
                                    var t = JSON.parse(e.data);
                                    if ('error' in t)
                                        if (((this.state.connectionState.value = a.DISCONNECTED), this.reconnectAttempts < this.connectorConfig.reconnectAttemptsLimit)) {
                                    ...
                                    this.emitter.emit(
                                        o.HUB_ERROR,
                                        new D('Error while processing message from hub', {
                                            data: { redirectorResponse: this.state.redirectorResponse.value ? this.state.redirectorResponse.value : {}, hubResponse: {} },
                                            cause: M(e),
                                        }),
                                    );
                                }
                        ...
                        Object.defineProperty(e.prototype, 'sendRequest', {
                            ...
                            value: function (e) {
                                null !== this.socket &&
                                    ...
                                    this.state.connectionState.value === a.CONNECTED &&
                ...
                W = function (e, t, i) {
                    ...
                    return {
                        ...
                        capabilities: { can_be_player: !0, can_be_remote_controller: !1, volume_granularity: null != (r = t.granularity) ? r : 16 },
                        info: e,
                        volume_info: { volume: null != (a = t.value) ? a : 0.5, version: null },
                ...
                G = (function () {
                    function e(e) {
                        ...
                        (Object.defineProperty(this, 'stateController', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            (this.stateController = new O({ deviceConfig: this.deviceConfig })),
                            ...
                            this.connector.on(o.RECEIVE_MESSAGE, this.onMessageReceived.bind(this)),
                            this.stateController.on(n.UPDATED, this.onStateChanged.bind(this), 'WSConnector'),
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'getDeviceStateTransition', {
                            ...
                            value: function (e) {
                                var t = e.rawData.active_device_id_optional === this.deviceConfig.info.device_id,
                                    i = e.rawData.active_device_id_optional !== this.stateController.currentState.active_device_id_optional;
                                return {
                                    willBecomeActive: !this.isActive && t,
                                    willBecomePassive: this.isActive && !t,
                                    willStayPassive: !this.isActive && !t,
                                    isAnotherActiveDeviceUpdated: !this.isActive && !t && i,
                                };
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'processMessageState', {
                            ...
                            value: function (e, t) {
                                var i = e.rawData;
                                return (this.isActive || (i = this.overrideIncomingDeviceVolume(i)), this.shouldIgnorePlayerStateUpdate(t))
                                    ? this.createActiveDeviceStateUpdate(i)
                                    : this.shouldOverridePauseState(t)
                                      ? this.createPausedStateUpdate(i)
                                      : { newState: i, trigger: 'WSConnector' };
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'createPausedStateUpdate', {
                            ...
                            value: function (e) {
                                ...
                                return (
                                    ...
                                    (t.player_state.status.version = y(this.deviceConfig.info.device_id, 0)),
                            ...
                            value: function (e) {
                                var t,
                                    ...
                                    l = s.devices.find(function (e) {
                                        var t;
                                        return (null == (t = e.info) ? void 0 : t.device_id) === o.deviceConfig.info.device_id;
                                    }),
                                ...
                                if (l) {
                                    var p = {
                                        volume:
                                            null !=
                                            (n = null != (i = null == (t = null == u ? void 0 : u.volume_info) ? void 0 : t.volume) ? i : this.deviceConfig.defaultVolume)
                                                ? n
                                                : 0.5,
                        ...
                        Object.defineProperty(e.prototype, 'processOutgoingPlayerState', {
                            ...
                            writable: !0,
                            value: function (e) {
                                return H(H({}, e), { status: this.processOutgoingPlayerStatus(e.status) });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'processOutgoingPlayerStatus', {
                            ...
                            writable: !0,
                            value: function (e) {
                                return this.variables.isShadow || !this.isActive ? H(H({}, e), { paused: !0 }) : e;
                            },
                        }),
                        Object.defineProperty(e.prototype, 'createOutgoingDeviceData', {
                            ...
                            value: function () {
                                var e,
                                    t,
                                    i = this,
                                    n = this.stateController.currentState.devices.find(function (e) {
                                        var t;
                                        return (null == (t = e.info) ? void 0 : t.device_id) === i.deviceConfig.info.device_id;
                                    });
                                return W(
                                    this.deviceConfig.info,
                                    {
                                        value: null != (t = null == (e = null == n ? void 0 : n.volume_info) ? void 0 : e.volume) ? t : this.deviceConfig.defaultVolume,
                        ...
                        Object.defineProperty(e.prototype, 'onStateChanged', {
                            ...
                            value: function (e) {
                                var t,
                                    i,
                                    n = !!(this.stateController.currentState.active_device_id_optional && !this.isActive);
                                this.isUpdateFullStateCompleted &&
                                    !n &&
