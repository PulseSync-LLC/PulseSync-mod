...
`,
                            ...
                            ((i += '"use strict";\n'),
                                (i += this.header()),
                                (i += 'return new Promise((function(_resolve, _reject) {\n'),
                                r &&
                                    ((i += 'var _sync = true;\n'),
                ...
                contentWithInterceptors(e) {
                    if (!(this.options.interceptors.length > 0)) return this.content(e);
                    {
                        let t = e.onError,
                            r = e.onResult,
                            n = e.onDone,
...
`),
                ...
                args({ before: e, after: t } = {}) {
                    let r = this._args;
                    return (e && (r = [e].concat(r)), t && (r = r.concat(t)), 0 === r.length) ? '' : r.join(', ');
                }
                getTapFn(e) {
                    return `_x[${e}]`;
                }
        ...
        28217: (e, t, r) => {
            'use strict';
            let n = r(59783).deprecate(() => {}, 'Hook.context is deprecated and will be removed'),
                i = function (...e) {
        ...
        43458: (e, t, r) => {
            ...
            function V(e, t, r, n) {
                if (e.invalidDynamicUsageError) throw (H(e, e.invalidDynamicUsageError), new o.StaticGenBailoutError());
                if (0 !== t) {
                    if (r.hasSuspenseAboveBody) return;
                    if (n.syncDynamicErrorWithStack) throw (H(e, n.syncDynamicErrorWithStack), new o.StaticGenBailoutError());
...
`),
        ...
        51111: (e, t, r) => {
                    ...
                    if (
                        ...
                        (this.enabled = (function (e, t) {
                            let r,
                                ...
                                i = k(n);
                            return n ? (t.setItem(P, `${i}`), i) : k(t.getItem(P));
                        })(e, t)),
                        (this.storage = t),
                        !this.enabled)
                    )
            ...
            var C = class {
                ...
                $ = { subscription: 'plusPaymentSession', gift: 'plusGiftPaymentSession' };
            function U(e, t, r) {
                var n, i, o, s;
                ((n = e.replace(/\D/g, '')),
                    (i = $[r]),
                    i ? ((o = b()), (s = 'goal://' + (g && window.location ? window.location.hostname : '') + '/' + i)) : ((o = p ? document.referrer : ''), (s = b())),
                    (function (e) {
                        var t,
                            r,
                            n,
                            ...
                            l = {
                                'browser-info':
                                    ...
                                    E(r, 's', m ? [screen.width, screen.height, screen.colorDepth].join('x') : ''),
                                    E(r, 'w', g ? [window.innerWidth, window.innerHeight].join('x') : ''),
                                    E(r, 'en', p && 'string' == typeof document.charset ? document.charset.toLowerCase() : ''),
                                    E(r, 'et', (n = Math.round(Date.now() / 1e3))),
                                    E(r, 'st', n),
                                    E(r, 't', v(t, 512)),
                                    r.join(':')),
                                rn: w(),
            ...
            var W = class {
                        ...
                        (this.bindPlusPaymentSession(t, n, r),
                            (function (e, t) {
                                ...
                                G(z({}, e), {
                                    ...
                                    custom_parameters: G(z({}, this.customParameters), { metrikaCounterId: t }),
                                    test_ids: 'NO_VALUE',
                    ...
                    offerShow(e) {
                        ...
                        })(this.logger, G(z({}, e), { custom_parameters: this.customParameters }));
                    }
                    offerClick(e) {
                        !(function (e, t) {
                            let r = f(1),
                    ...
                    constructor(e, t, r, n) {
                        ...
                        ((this.logger = e),
                            ...
                            (this.customParameters = z({}, o ? { bot_flg: !0 } : {}, n)),
                            (this.bindPlusPaymentSession = t));
                    }
                },
                q = class {
            ...
            var er = class e {
                request(e) {
                    ...
                    return (null == (t = this.opts) ? void 0 : t._forceIgnore)
                        ? ('production' !== this.env && console.warn(`%c AcqToolkit (ver. ${Y})`, Z, '_forceIgnore'), Promise.resolve())
                        : ((n = (null == (r = this.opts) ? void 0 : r.url) || 'https://yandex.ru/clck/click'),
                          (i = { body: e }),
                                  ...
                                  ((u = et(
                                      {
                                          ...
                                          yandexuid: (null == (s = this.opts) ? void 0 : s.yandexuid) || V(),
                                          ua: 'undefined' != typeof navigator && navigator.userAgent,
                                      },
                                      r,
                                  )),
                                  (l = l = { additional: JSON.stringify(et({}, null == (a = this.opts) ? void 0 : a.additional, r.additional)) }),
                                  Object.getOwnPropertyDescriptors
                ...
                logError(e, t = {}) {
                    var r = this;
                    return Q(function* () {
                        ('production' !== r.env && console.log(`%c AcqToolkit (ver. ${Y})`, Z, null == e ? void 0 : e.message, t),
                            yield r.request(
                                r.buildRequestData(K.ERRORS, et({ msg: (null == e ? void 0 : e.message) || t.message, stack: null == e ? void 0 : e.stack }, t)),
                            ));
                    })();
                }
                logEvent(e, t, r) {
                    var n = this;
                    return Q(function* () {
                        ('production' !== n.env && console.log(`%c AcqToolkit (ver. ${Y})`, Z, e, t, r),
                            yield n.request(n.buildRequestData(K.EVENTS, { type: 'string', name: e, value: t, additional: r }, ['table=rum_events'])));
                    })();
                }
                constructor(e, t) {
                    (ee(this, 'env', void 0),
            ...
            var en = (((o = {}).INITED = 'OFFERS_INITED'), (o.FETCH = 'OFFERS_FETCH'), (o.GET = 'OFFERS_GET'), (o.GET_URL = 'OFFERS_GET_URL'), o),
                ei =
            ...
            (((a = {}).INITED = 'TOOLKIT_INITED'), (a.GET_PW_TOOLS = 'TOOLKIT_GET_PW_TOOLS'), (a.GET_OFFERS = 'TOOLKIT_GET_OFFERS'));
                ...
                constructor(t) {
                    ...
                    if (
                        (super(
                            ...
                            ea(es({}, i), { additional: ea(es({}, null == i ? void 0 : i.additional), { widgetServiceName: s.widgetServiceName, puid: s.puid }) }),
                        ),
                    ...
                    let a = new L('undefined' != typeof window ? window.location.href : '', X),
                        u =
                            null != (r = s.etld)
                                ? r
                                : (function (e) {
                    ...
                    this.manager = new C(s.environment, s.platform, u, s.preloadManager || !1, a, H, l);
                    ...
                    ((this.plusPaymentEvents = new W(b, U, { service: s.widgetServiceName, externalId: s.serviceSessionId }, this.getCustomParams())),
            ...
            var eb = (e, t) => {
                let { options: r, requestParams: n } = t,
                    ...
                    { requester: o } = r,
                    s = em(r, ['requester']);
                return ey(eg({}, i), { eventName: e, requestParams: n, options: ey(eg({}, s), { withCustomRequester: !!o }) });
            };
            ...
            var eS = class extends er {
                ...
                getBestOffers(e, t, r) {
                    ...
                    return (
                        Array.isArray(e)
                            ? ((n = e_({ targetToFeatures: e }, t)), (o = { signal: null == t ? void 0 : t.signal, timeout: null == t ? void 0 : t.timeout }))
                            : ((n = e_({ page: e, places: t }, r)), (o = { signal: null == r ? void 0 : r.signal, timeout: null == r ? void 0 : r.timeout })),
                        i({ context: n }, o)
                    );
                }
                    ...
                    return ew(function* () {
                        ...
                        if (Array.isArray((i = t.context)) || 'contextId' in i) {
                            ...
                            let e = t.context,
                                ...
                                i = eO(e, ['oneClickSupported', 'eventSessionId']);
                            ((c = new URLSearchParams(e_({}, r ? { oneClickSupported: r ? 'true' : 'false' } : null, n ? { eventSessionId: n } : null)).toString()),
                                (o = { context: e_({ widgetServiceName: u }, i) }));
                        }
                        let f = n.getUrl(e),
                            h = e_({ geoInfo: null == t ? void 0 : t.geoInfo }, o),
                            d = performance.now();
                        n.logEvent('start', en.FETCH, { params: t, url: f, queryParamsForV2: c, isOptionsDefined: r && Object.keys(r).length > 0 });
                        try {
                            let t = yield a(
                                    e_(
                                        {
                                            ...
                                            })(eA(e_({}, l), { oAuthToken: n.oAuthToken })),
                                            signal: (function (e) {
                                        ...
                                        n.oAuthToken ? { credentials: 'omit' } : null,
                                    ),
                                ),
                                i = performance.now();
                            return (n.logEvent('success', en.GET, { latency: Math.trunc(i - d) }), t);
                        } catch (t) {
                            let e = performance.now();
                            throw (
                                n.logError(t, {
                                    service: n.options.service,
                                    additional: eb(en.GET, { options: n.options, requestParams: h, latency: Math.trunc(e - d) }),
                                }),
                                t
                            );
                        }
                ...
                getUrl(e) {
                    ...
                    try {
                        ...
                        throw (this.logError(e || Error('Unknow prepareApiUrl error'), { service: n, additional: eb(en.GET_URL, { options: this.options }) }), e);
                    }
                ...
                constructor(e) {
                    ...
                    (super(
                        ...
                        eA(e_({}, r), {
                            ...
                            additional: e_({ puid: i.puid }, null == r ? void 0 : r.additional),
                        }),
                    ),
                        eE(this, 'urls', { v1: '', v2: '' }),
        ...
        54115: (e, t, r) => {
            let { MAX_SAFE_COMPONENT_LENGTH: n, MAX_SAFE_BUILD_LENGTH: i, MAX_LENGTH: o } = r(60583),
                s = r(64261),
                a = ((t = e.exports = {}).re = []),
                u = (t.safeRe = []),
                l = (t.src = []),
        ...
        61934: (e, t, r) => {
            'use strict';
            ((t.SyncHook = r(24830)), r(97622), r(48242), r(51668), r(90238), r(80790), (t.AsyncSeriesHook = r(65228)), r(88104), r(73098), r(2744), r(33449), r(19312));
        },
        62160: (e, t, r) => {
            'use strict';
            r.d(t, { A: () => h });
        ...
        72454: (e, t, r) => {
            ...
            let ez = (0, p.memo)(function (e) {
                    var t, r, n, s, a, u;
                    let { id: h, accessibility: m, autoScroll: b = !0, children: v, sensors: E = eT, collisionDetection: _ = M, measuring: O, modifiers: S, ...x } = e,
                        ...
                        ee = (0, p.useMemo)(() => {
                            var e;
                            return null != U ? { id: U, data: null != (e = null == H ? void 0 : H.data) ? e : eP, rect: Q } : null;
                        }, [U, H]),
                        er = (0, p.useRef)(null),
                    ...
                    let e_ = eA(ep, ec.draggable.measure, em),
                        ...
                        eL = X.getNodeFor(null == (t = eD.current.over) ? void 0 : t.id),
                        ez = (function (e) {
                            let { measure: t } = e,
                        ...
                        eZ = eB(S, {
                            transform: { x: z.x - eX.x, y: z.y - eX.y, scaleX: 1, scaleY: 1 },
                            activatorEvent: eo,
                            active: ee,
                            activeNodeRect: e_,
                        ...
                        e1 = (0, y.WQ)(eZ, eQ),
                        e2 = eW ? $(eW, eZ) : null,
                        e6 = ee && e2 ? _({ active: ee, collisionRect: e2, droppableRects: ef, droppableContainers: el, pointerCoordinates: eK }) : null,
                        e3 = k(e6, 'id'),
                        [e5, e8] = (0, p.useState)(null),
                        e4 =
                            ((a = eq ? eZ : (0, y.WQ)(eZ, e0)),
                            (u = null != (s = null == e5 ? void 0 : e5.rect) ? s : null),
                            ...
                            (e, t) => {
                                ...
                                function u(e) {
                                    return async function () {
                                        ...
                                        ((er.current = null),
                                            (0, g.unstable_batchedUpdates)(() => {
                                                (T({ type: e }), L(d.Uninitialized), e8(null), ei(null), es(null));
                    ...
                    ((0, p.useEffect)(
                        ...
                        (0, p.useEffect)(() => {
                            ...
                            (0, g.unstable_batchedUpdates)(() => {
                                (e8(a), null == o || o(u), P({ type: 'onDragOver', event: u }));
                            });
                        }, [e3]),
                        (0, y.Es)(() => {
                            ((eD.current = {
                    ...
                    let tt = (0, p.useMemo)(
                            ...
                            [ee, ep, e_, eo, e6, ek, ez, B, X, ef, e5, eh, eV, eY, ec, ed, eH],
                        ),
                        tr = (0, p.useMemo)(
                            () => ({
                                activatorEvent: eo,
                    ...
                    return p.createElement(
                        ...
                        p.createElement(
                            eN.Provider,
                            { value: tr },
                            p.createElement(eM.Provider, { value: tt }, p.createElement(eF.Provider, { value: e4 }, v)),
            ...
            function eV(e) {
                let { data: t, disabled: r = !1, id: n, resizeObserverConfig: o } = e,
                    ...
                    d = (0, p.useRef)(null),
                    g = (0, p.useRef)(null),
                    { disabled: m, updateMeasurementsFor: b, timeout: v } = { ...eH, ...o },
                    w = (0, y.YN)(null != b ? b : n),
                    E = eE({
                        callback: (0, p.useCallback)(() => {
                            if (!h.current) {
        ...
        86353: (e, t, r) => {
            ...
            function u(e, t, r) {
                ...
                if (
                    ...
                    ('undefined' != typeof SharedArrayBuffer && (C(e, SharedArrayBuffer) || (e && C(e.buffer, SharedArrayBuffer))))
                )
                    return h(e, t, r);
            ...
            ((t.Buffer = a),
                ...
                (a.concat = function (e, t) {
                    ...
                    for (r = 0; r < e.length; ++r) {
                        let t = e[r];
                        if (C(t, Uint8Array)) i + t.length > n.length ? (a.isBuffer(t) || (t = a.from(t)), t.copy(n, i)) : Uint8Array.prototype.set.call(n, t, i);
                ...
                (a.prototype.write = function (e, t, r, n) {
                    ...
                    for (;;)
                        switch (n) {
                            ...
                            case 'utf8':
                            case 'utf-8':
                                return ((i = t), (o = r), M(L(e, this.length - i), this, i, o));
                            case 'ascii':
                            case 'latin1':
                            case 'binary':
                                return (
        ...
        86700: (e, t, r) => {
            ...
            function w(e) {
                ...
                let {
                    ...
                    N = S.indexOf(E),
                    M = (0, n.useMemo)(() => ({ sortable: { containerId: x, index: N, items: S }, ...d }), [x, d, N, S]),
                    C = (0, n.useMemo)(() => S.slice(S.indexOf(E)), [S, E]),
                    {
                        ...
                        isOver: B,
                        setNodeRef: F,
                    } = (0, i.zM)({ id: E, data: M, disabled: L.droppable, resizeObserverConfig: { updateMeasurementsFor: C, ...A } }),
                    {
                        active: z,
                        activatorEvent: G,
                        activeNodeRect: W,
                        ...
                        transform: K,
                    } = (0, i.PM)({ id: E, data: M, attributes: { ...v, ...c }, disabled: L.draggable }),
                    J = (0, o.jn)(F, X),
                    Q = !!z,
                    ee = Q && !T && a(j) && a(I),
                    et = !k && V,
