(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [54, 3576, 3949, 7673, 9837],
    {
                        ...
                        (this.endVal = e),
                            ...
                            (this.formatNumber = function (t) {
                                var e,
                                    i,
                                    r,
                                    s = (Math.abs(t).toFixed(n.options.decimalPlaces) + '').split('.');
                                ...
                                return (
                                    ...
                                    (t < 0 ? '-' : '') + n.options.prefix + e + i + n.options.suffix
                                );
                            }),
                            (this.easeOutExpo = function (t, e, i, r) {
                                return (i * (1 - Math.pow(2, (-10 * t) / r)) * 1024) / 1023 + e;
                            }),
                        ...
                        (t.prototype.handleScroll = function (t) {
                            if (t && window && !t.once) {
                                ...
                                n < e && n > window.scrollY && t.paused
                                    ...
                                    : (window.scrollY > n || r > e) && !t.paused && t.reset();
                            }
                        }),
        ...
        5471: (t, e, i) => {
            ...
            i.d(e, { WQ: () => d, Qr: () => m, lw: () => f, gL: () => c, bY: () => u, Wj: () => h, Lp: () => l, fP: () => o, PY: () => s, Pn: () => a });
            let o = r,
                l = r,
                u = r,
                h = r,
                        ...
                        value: function (t) {
                            ...
                            return (
                                ...
                                this.observableValue.subscribe(function (i) {
                                    i !== e.prevValueByListener.get(t) && (e.prevValueByListener.set(t, i), t(i));
                                })
                            );
                        },
                    });
        ...
        8690: (t, e, i) => {
            ...
            class s {
                ...
                getItem(t) {
                    ...
                    return document.cookie.substring(r, -1 === n ? document.cookie.length : n);
                }
                setItem(t, e) {
                ...
                clear() {
                    ...
                    for (let t = 0; t < e.length; t++) {
                        ...
                        r.startsWith(this.prefix) && this.removeItem(r.substring(this.prefix.length));
                    }
                }
                get length() {
                    let t = 0,
                    ...
                    for (let e = 0; e < i.length; e++) {
                        let r = i[e].indexOf('=');
                        -1 !== r && i[e].substring(0, r).trim().startsWith(this.prefix) && t++;
                    }
                    return t;
                }
                key(t) {
                ...
                p =
                    -1 === r.indexOf('__VPUID')
                        ...
                        : (f.getItem(n) ??
                          (function () {
                              let t = [];
                              for (let e = 0; e < 10; e++) t.push(g[Math.floor((0, m.y)() * g.length)]);
                              return t.join('');
                          })());
            f.setItem(n, p);
        },
            ...
            let o = { loader: () => Promise.resolve(a(() => null)), loading: null, ssr: !0 },
                l = function (t) {
                    let e = { ...o, ...t },
                        ...
                        l = e.loading;
                    function u(t) {
                        let a = l ? (0, r.jsx)(l, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            o = !e.ssr || !!e.loading,
                            u = o ? n.Suspense : n.Fragment,
                            h = e.ssr
                                ? (0, r.jsxs)(r.Fragment, { children: [null, (0, r.jsx)(i, { ...t })] })
        ...
        16811: (t, e, i) => {
            ...
            let o = Date && a(Date.now) ? () => Date.now() : () => new Date().getTime(),
                ...
                d = l && l.timeOrigin ? l.timeOrigin : h ? l.timing.navigationStart : o(),
                c = 0,
        ...
        19679: (t, e, i) => {
                            ...
                            : e < 4 && t >= 4
                              ...
                              : e < 10 && t >= 10
                                ...
                                : e < 20 && t >= 20
                                  ...
                                  : h(e) < h(t) && this.params.onEvent(r.Heartbeat30Sec),
            ...
            class b {
                ...
                needFlush() {
                    let t = (0, y.lh)();
                    return this.wasFirstFlush ? t - this.lastFlushTime >= v : t - this.startTime >= m;
                }
                getTimeout() {
            ...
            class E {
                ...
                writeState() {
                    ...
                    f(this.prevState, t) || ((this.prevState = t), this.states.push({ ...t, timestamp: (0, u.Wj)(this.props.getTimestamp()) }));
                }
                getPlayerAliveState() {
                    let t = {
                            ...w,
                            ...
                            rtt: (function (t = window) {
                                ...
                                return 'number' == typeof (e = i.rtt) && isFinite(e) ? i.rtt : T;
                            })(),
                    ...
                    return {
                        ...
                        isVisible: m,
                        bitrate: M?.bitrate ? Math.max(0, Math.floor((0, u.lw)(M.bitrate, 1e3))) : void 0,
                        width: f?.videoWidth === void 0 || isNaN(f?.videoWidth) ? void 0 : Math.max(0, Math.floor((0, u.Lp)(f?.videoWidth))),
                        height: f?.videoHeight === void 0 || isNaN(f?.videoHeight) ? void 0 : Math.max(0, Math.floor((0, u.Lp)(f?.videoHeight))),
                        maxWidth: C && k[0]?.width ? Math.max(0, Math.floor((0, u.Lp)(k[0].width))) : void 0,
                        maxHeight: C && k[0]?.height ? Math.max(0, Math.floor((0, u.Lp)(k[0].height))) : void 0,
                        audioTrack: c?.value || void 0,
                        audioLang: c?.lang || void 0,
                        audioBitrate: c?.bitrate ? Math.max(0, Math.floor((0, u.lw)(c.bitrate, 1e3))) : void 0,
                        capHeight: C && g ? Math.max(0, Math.floor((0, u.Lp)(g))) : void 0,
                        capWidth: C && p ? Math.max(0, Math.floor((0, u.Lp)(p))) : void 0,
                        containerHeight: void 0 !== v ? Math.max(0, Math.floor(v)) : void 0,
                        containerWidth: void 0 !== y ? Math.max(0, Math.floor(y)) : void 0,
                        bandwidthEstimate: void 0 === b || isNaN(b) ? void 0 : Math.max(0, (0, u.bY)(Math.round(b))),
                        bandwidthSource: S || void 0,
                        droppedFrames: void 0 === x ? void 0 : Math.max(0, Math.floor(x)),
                        shownFrames: void 0 === E ? void 0 : Math.max(0, Math.floor(E)),
            ...
            class A {
                                ...
                                i = I.filter((i, r) => {
                                    ...
                                    if ((0, u.Qr)(e, 1e3) > s) {
                                        ...
                                        return (
                                            ...
                                            (this.currentStalled = { id: t, expectedStalled: n, duration: s, getElapsedTime: N() }),
                                            this.send(!1, n, s, t),
                                            !1
                                        );
                                    }
                ...
                isExpiredStalled(t) {
                    ...
                    return !(M.indexOf(i) > -1) && (!this.currentStalled || this.currentStalled.expectedStalled !== t) && e() >= P;
                }
                getExpectedStalled() {
                ...
                send(t, e, i, r) {
                    ...
                    if (o) {
                        ...
                        a = { ...a, remainingBufferedTime: e, videoTrack: r, isMuted: t };
                    }
                    this.logEvent({ name: t ? 'StalledEnd' : 'Stalled', data: a, labels: { reason: n } });
                }
            }
            let L = (t) => ('hidden' in t ? 'hidden' : 'webkitHidden' in t ? 'webkitHidden' : void 0);
            function j(t, e = !0) {
                let i = L(t);
                return i ? !t[i] : e;
            }
            ...
            class R {
                ...
                calc(t, e, i) {
                    if (void 0 !== this.lastUpdate) {
                        var r, n;
                        let i =
                            ((r = (0, u.Qr)((0, u.gL)(t, this.lastUpdate.videoTime), e)),
                            (n = (0, u.Qr)((0, u.Wj)(this.lastUpdate.getElapsedTime()), 1e3)),
                            (0, u.fP)(Math.max(0, r >= 0 && r <= n + 0.5 ? r : n)));
                        this.watchedTime = (0, u.WQ)(this.watchedTime, i);
                    }
                    this.lastUpdate = i ? { getElapsedTime: N(), videoTime: t } : void 0;
                }
                get() {
            ...
            class U {
                ...
                now = () => {
                    let t = H(),
                        ...
                        n = (i) => ((this.lastDateNow = t), (this.lastPerformanceNow = e), (this.total = (0, u.WQ)(this.total, i)), this.total);
                    return n(r <= 0 ? i : r);
                };
                stop() {
            ...
            i(34340);
            let Y = { enabled: !0, events: [r.Watched10Sec, r.Watched20Sec, r.Heartbeat30Sec] },
                $ = { logVersion: '1.2.0' };
            class G {
                static getVpuid() {
                    return z.$;
                ...
                constructor({ sendLog: t, playerInfo: e, getState: i }) {
                    (this.playerInfo = e),
                        ...
                        (this.stalledController = new A({ getState: this.getState, logEvent: (t) => this.logEvent(t) })),
                        (this.watchedTimeTracker = new B(i, (t) => this.playbackTracker.onWatchedTimeChange(t))),
                ...
                logEvent(t, e) {
                    ...
                    let i = this.getFullEventLog(t, e),
                        r = this.getUrlParams(i.eventType, i.eventName, t.labels);
                    this.sendData(i, r);
                }
                logError({ error: t, labels: e, extraRootFields: i }, r) {
                    ...
                    let n = this.getFullErrorLog({ error: t, labels: e, extraRootFields: i, sourceIndex: r }),
                ...
                getFullEventLog(t, e) {
                    let i = this.getState(),
                        r = { ...this.staticParams.labels, ...t.labels, videoType: i?.videoType },
                        n = W.includes(t.name) ? { ...t.data, ...this.getDataToSend(i) } : t.data,
                        s = {};
                    return (
                ...
                getFullErrorLog({ error: t, labels: e, extraRootFields: i, sourceIndex: r }) {
                    let n = { ...this.staticParams.labels, ...e };
                    return (
                        (t.details = D(() => ('string' == typeof t.details ? t.details : JSON.stringify(t.details))) || t.details),
                        {
                            ...$,
                            ...this.playerInfo,
                            ...this.staticParams,
                ...
                getDataToSend(t) {
                    if (!t) return {};
                    let { duration: e, currentTime: i, utcStartTime: r, isFullscreen: n, volume: s, muted: a } = t;
                    return {
                ...
                sendData(t, e) {
                    void 0 !== t && (D(() => this.sendLog(t, e), k), this.eventIndex++);
                }
                ...
                setExternalStalledDuration(t) {
                    ...
                    e.reason === o.Init && t && ((e.details = { externalStalledDuration: (0, u.Qr)(t, 1e3) }), this.setExpectedBuffering(e));
                }
        ...
        23949: (t, e, i) => {
            ...
            function s(t, e, i) {
                ...
                function s() {
                    var s, a, o, l;
                    let u, h;
                    i.key && (null == (s = i.debug) ? void 0 : s.call(i)) && (u = Date.now());
                    let d = t();
                    if (!(d.length !== n.length || d.some((t, e) => n[e] !== t))) return r;
                    if (
                        ((n = d),
                        i.key && (null == (a = i.debug) ? void 0 : a.call(i)) && (h = Date.now()),
                        (r = e(...d)),
            ...
            let o = (t, e, i) => {
                ...
                v = (t, e, i) => {
                    ...
                    return t[i.options.horizontal ? 'offsetWidth' : 'offsetHeight'];
                },
                y = (t, { adjustments: e = 0, behavior: i }, r) => {
                    var n, s;
                    null == (s = null == (n = r.scrollElement) ? void 0 : n.scrollTo) || s.call(n, { [r.options.horizontal ? 'left' : 'top']: t + e, behavior: i });
                },
                    ...
                    (this.unsubs = []),
                        ...
                        (this.getFurthestMeasurement = (t, e) => {
                            ...
                            for (let n = e - 1; n >= 0; n--) {
                                ...
                                let s = r.get(e.lane);
                                if ((null == s || e.end > s.end ? r.set(e.lane, e) : e.end < s.end && i.set(e.lane, !0), i.size === this.options.lanes)) break;
                            }
                            return r.size === this.options.lanes
                                ? Array.from(r.values()).sort((t, e) => (t.end === e.end ? t.index - e.index : t.end - e.end))[0]
                                : void 0;
                        }),
                        (this.getMeasurementOptions = s(
                            ...
                            (t, e, i, r, n) => ((this.pendingMeasuredCacheIndexes = []), { count: t, paddingStart: e, scrollMargin: i, getItemKey: r, enabled: n }),
                            { key: !1 },
                        )),
                        (this.getMeasurements = s(
                            ...
                            ({ count: t, paddingStart: e, scrollMargin: i, getItemKey: r, enabled: n }, s) => {
                                ...
                                for (let n = a; n < t; n++) {
                                    let t = r(n),
                                        a = 1 === this.options.lanes ? o[n - 1] : this.getFurthestMeasurement(o, n),
                                        l = a ? a.end + this.options.gap : e + i,
                                        u = s.get(t),
                                        h = 'number' == typeof u ? u : this.options.estimateSize(n),
                                        d = l + h,
                        ...
                        (this.calculateRange = s(
                            ...
                            (t, e, i, r) =>
                                (this.range =
                                    t.length > 0 && e > 0
                                        ? (function ({ measurements: t, outerSize: e, scrollOffset: i, lanes: r }) {
                                              let n = t.length - 1;
                                              if (t.length <= r) return { startIndex: 0, endIndex: n };
                                              let s = w(0, n, (e) => t[e].start, i),
                                                  a = s;
                                              if (1 === r) for (; a < n && t[a].end < i + e; ) a++;
                                              else if (r > 1) {
                        ...
                        (this.getVirtualIndexes = s(
                            ...
                            (t, e, i, r, n) => (null === r || null === n ? [] : t({ startIndex: r, endIndex: n, overscan: e, count: i })),
                            { key: !1, debug: () => this.options.debug },
                        )),
                        ...
                        (this.resizeItem = (t, e) => {
                            ...
                            if (!i) return;
                            let r = e - (this.itemSizeCache.get(i.key) ?? i.size);
                            0 !== r &&
                                ((void 0 !== this.shouldAdjustScrollPositionOnItemSizeChange
                                    ? this.shouldAdjustScrollPositionOnItemSizeChange(i, r, this)
                        ...
                        (this.getOffsetForAlignment = (t, e, i = 0) => {
                            ...
                            return (
                                'auto' === e && (e = t >= n + r ? 'end' : 'start'),
                                'center' === e ? (t += (i - r) / 2) : 'end' === e && (t -= r),
                                Math.max(Math.min(this.getTotalSize() - r, t), 0)
                            );
                        }),
                        (this.getOffsetForIndex = (t, e = 'auto') => {
                            ...
                            let r = this.getSize(),
                                n = this.getScrollOffset();
                            if ('auto' === e)
                                if (i.end >= n + r - this.options.scrollPaddingEnd) e = 'end';
                                else {
                                    if (!(i.start <= n + this.options.scrollPaddingStart)) return [n, e];
                                    e = 'start';
                                }
                                ...
                                'smooth' !== i &&
                                    ...
                                    (this.scrollToIndexTimeoutId = this.targetWindow.setTimeout(() => {
                                        if (((this.scrollToIndexTimeoutId = null), this.elementsCache.has(this.options.getItemKey(t)))) {
                                            let e = this.getOffsetForIndex(t, s);
                                            if (!e) return;
                                            let [r] = e;
            ...
            let w = (t, e, i, r) => {
                ...
                T = 'undefined' != typeof document ? r.useLayoutEffect : r.useEffect;
            function x(t) {
            ...
            let r = (t) => {
                    ...
                    return i && e
                        ? (function (t, e, i) {
                              let r = { ...t };
                              return (
                                  e.top + t.y <= i.top ? (r.y = i.top - e.top) : e.bottom + t.y >= i.top + i.height && (r.y = i.top + i.height - e.bottom),
                                  e.left + t.x <= i.left ? (r.x = i.left - e.left) : e.right + t.x >= i.left + i.width && (r.x = i.left + i.width - e.right),
                                  r
                              );
                          })(r, i, e)
                        : r;
                ...
                n = function (t, e) {
                    ...
                    if (null != t && 'function' == typeof Object.getOwnPropertySymbols)
                        for (var n = 0, r = Object.getOwnPropertySymbols(t); n < r.length; n++)
                            0 > e.indexOf(r[n]) && Object.prototype.propertyIsEnumerable.call(t, r[n]) && (i[r[n]] = t[r[n]]);
                    return i;
                },
                s = (function (t) {
                    function e(i, r) {
                        ...
                        var s = this,
                            ...
                            u = i || 'Internal error';
                        return (
                            Object.defineProperty((s = t.call(this, u, l) || this), 'name', { enumerable: !0, configurable: !0, writable: !0, value: 'BaseException' }),
        ...
        43576: (t, e, i) => {
            ...
            function c(t, e) {
                if (!e) return t;
                var i = l.S.formats;
                return (0, r.__assign)((0, r.__assign)((0, r.__assign)({}, i), t), {
            ...
            var f = function (t, e, i, s, a) {
                    ...
                    var w = String(b),
                        T = d && Object.prototype.hasOwnProperty.call(d, w) && d[w];
                    if (Array.isArray(T) && 1 === T.length && T[0].type === o.TYPE.literal) return T[0].value;
                    if (!s && T && 'string' == typeof T && !y) return T.replace(/'\{(.*?)\}'/gi, '{$1}');
                    if (((s = (0, r.__assign)((0, r.__assign)({}, y), s || {})), (h = c(h, v)), (m = c(m, v)), !T)) {
                        if (!1 === g && '' === T) return T;
                        if (((!S || (l && l.toLowerCase() !== f.toLowerCase())) && p(new u.sb(i, l)), S))
                            try {
                                var x = e.getMessageFormat(S, f, m, a);
                                return x.format(s);
                            } catch (t) {
                                return (
                                    p(new u.Ho('Error formatting default message for: "'.concat(w, '", rendering default message verbatim'), l, i, t)),
                                    'string' == typeof S ? S : w
                                );
                            }
                        return w;
                    ...
                    try {
                        var x = e.getMessageFormat(T, l, h, (0, r.__assign)({ formatters: e }, a || {}));
                        return x.format(s);
                    } catch (t) {
                        p(new u.Ho('Error formatting message: "'.concat(w, '", using ').concat(S ? 'default message' : 'id', ' as fallback.'), l, i, t));
                    }
                    if (S)
                        try {
                            var x = e.getMessageFormat(S, f, m, a);
                            ...
                            p(new u.Ho('Error formatting the default message for: "'.concat(w, '", rendering message verbatim'), l, i, t));
                        }
                    return 'string' == typeof T ? T : 'string' == typeof S ? S : w;
                },
                m = [
                    'formatMatcher',
                    'timeZone',
            ...
            function g(t, e, i, s) {
                ...
                void 0 === s && (s = {});
                var h = s.format,
                    d = (0, r.__assign)((0, r.__assign)({}, u && { timeZone: u }), h && (0, n.F3)(o, e, h, l)),
                    c = (0, n.J9)(s, m, d);
                return (
                    'time' !== e ||
                        c.hour ||
                        ...
                        c.timeStyle ||
                        c.dateStyle ||
                        (c = (0, r.__assign)((0, r.__assign)({}, c), { hour: 'numeric', minute: 'numeric' })),
                    i(a, c)
                );
            }
            function p(t, e) {
            ...
            function O(t, e, i, s) {
                ...
                try {
                    ...
                    return e(a, l)
                        .formatToParts(d)
                        .map(function (t) {
                            return 'literal' === t.type ? t : (0, r.__assign)((0, r.__assign)({}, t), { value: h[t.value] || t.value });
                        });
                } catch (t) {
            ...
            function V(t, e, i, r, s) {
                ...
                try {
                    ...
                    (h = t.onError),
                    void 0 === a && (a = {}),
                    (c = (!!(d = a.format) && (0, n.F3)(l, 'relative', d, h)) || {}),
            ...
            var j = function (t, e, i, n) {
                    ...
                    var l = L(n),
                        u = f.apply(void 0, (0, r.__spreadArray)([t, e, i, l], s, !1));
                ...
                W = function (t, e) {
                    var i,
                        ...
                        w = L(m),
                        T =
                            ((i = (0, r.__assign)((0, r.__assign)((0, r.__assign)({}, a.JF), g), { defaultRichTextElements: w })),
                            (s = (0, n.GT)(e)),
                            (l = (o = (0, r.__assign)((0, r.__assign)({}, n.JF), i)).locale),
                            (h = o.defaultLocale),
                            (d = o.onError),
                            l
                                    ...
                                    ? d(
                                          new u.hr(
                                              'Missing locale data for locale: "'
                                                  ...
                                                  .concat(h, '" as fallback. See https://formatjs.github.io/docs/react-intl#runtime-requirements for more details'),
                                          ),
                                      )
                            ...
                            (0, r.__assign)((0, r.__assign)({}, o), {
                                formatters: s,
                                formatNumber: k.bind(null, o, s.getNumberFormat),
                                formatNumberToParts: D.bind(null, o, s.getNumberFormat),
                                formatRelativeTime: V.bind(null, o, s.getRelativeTimeFormat),
                                formatDate: p.bind(null, o, s.getDateTimeFormat),
                                formatDateToParts: b.bind(null, o, s.getDateTimeFormat),
                                formatTime: v.bind(null, o, s.getDateTimeFormat),
                                formatDateTimeRange: y.bind(null, o, s.getDateTimeFormat),
                                formatTimeToParts: S.bind(null, o, s.getDateTimeFormat),
                                formatPlural: _.bind(null, o, s.getPluralRules),
                                formatMessage: f.bind(null, o, s),
                                $t: f.bind(null, o, s),
                                formatList: F.bind(null, o, s.getListFormat),
                                formatListToParts: O.bind(null, o, s.getListFormat),
                    ...
                    return (0, r.__assign)((0, r.__assign)({}, T), { formatMessage: j.bind(null, E, T.formatters), $t: j.bind(null, E, T.formatters) });
                },
                R = i(26519);
            function B(t) {
                return {
                    ...
                    return (
                                    ...
                                    : (Object.keys(
                                          (r = (function (t, e) {
                                              ...
                                              var r,
                                                  ...
                                                  s = [];
                                              for (var a in t) a in e ? s.length && ((n[a] = s), (s = [])) : s.push(a);
                                              var o = {};
                                              for (var l in e) {
                                                  if (n[l])
                                              ...
                                              for (r = 0; r < s.length; r++) o[s[r]] = i(s[r]);
                                              return o;
                                          })(n, (i = l(t.children)))),
                                      ).forEach(function (e) {
                                          var o = r[e];
                                          if ((0, a.isValidElement)(o)) {
                                              ...
                                              h && (!l || c)
                                                  ? (r[e] = (0, a.cloneElement)(o, { onExited: s.bind(null, o), in: !0, exit: u(o, 'exit', t), enter: u(o, 'enter', t) }))
                                                  : h || !l || c
                                                    ? h &&
                                                      l &&
                                                      (0, a.isValidElement)(d) &&
                                                      (r[e] = (0, a.cloneElement)(o, {
                                                          onExited: s.bind(null, o),
                                                          in: d.props.in,
                                                          exit: u(o, 'exit', t),
                                                          enter: u(o, 'enter', t),
                                                      }))
                                                    : (r[e] = (0, a.cloneElement)(o, { in: !1 }));
                                          }
                                      }),
                                      r),
                                firstRender: !1,
                        ...
                        (i.render = function () {
                            ...
                            return (delete n.appear, delete n.enter, delete n.exit, null === e)
                                ...
                                : a.createElement(o.A.Provider, { value: s }, a.createElement(e, n, l));
                        }),
                        e
                    );
                })(a.Component);
        ...
        93973: (t) => {
            ...
            t.exports = function t(n, s) {
                ...
                if (n && s && 'object' == typeof n && 'object' == typeof s) {
                    ...
                    for (a = o; 0 != a--; ) if (!t(n[(l = g[a])], s[l])) return !1;
                    return !0;
                }
                return n != n && s != s;
            };
