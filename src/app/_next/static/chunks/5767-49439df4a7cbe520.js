(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5767],
    {
        537: (e, t, a) => {
            'use strict';
            a.d(t, { mi: () => d.SortDropdown, wY: () => u, WG: () => l.W, hl: () => r, y8: () => i.useSort });
            var l = a(25585),
                s = a(19964);
            ...
            var i = a(99963),
                ...
                n = a(75729);
            let u = o.gK
                .model('Sort', { sortBy: o.gK.maybe(o.gK.enumeration(Object.values(n.g))), sortOrder: o.gK.maybe(o.gK.enumeration(Object.values(s.x))) })
                .actions((e) => ({
                    setSortBy(t) {
                        e.sortBy = t;
                    },
        ...
        56932: (e, t, a) => {
            ...
            let C = (0, r.PA)((e) => {
                ...
                let { labelId: C, preloadedLabel: P } = e,
                    ...
                    { contentScrollRef: I, setContentScrollRef: w } = (0, S.gKY)(),
                    { notify: X } = (0, S.lkh)(),
                    { shareLink: B } = (0, S.bNS)('/label/:labelId', { params: { labelId: null != (a = T.id) ? a : '' } }),
                    O = (0, o.useRef)(null),
                    U = (0, o.useRef)(0);
                ...
                let k = (0, m.c)(async () => {
                    ...
                    D = T.isPublisher ? R({ id: 'entity-names.publisher' }) : R({ id: 'entity-names.label' }),
                    G = T.isPublisher ? R({ id: 'entity-names.non-music-releases' }) : R({ id: 'entity-names.releases' });
                ...
                (T.isNotFound || !j.checkExperiment(S.zal.WebNextLabelPage, 'on')) && (0, i.notFound)(),
                (0, o.useEffect)(
                    () => () => {
                        U.current = 0;
                    },
                ...
                (0, o.useEffect)(() => {
                    T.isRejected &&
                        U &&
                        !(U.current > 0) &&
                        (X((0, l.jsx)(A.hT, { error: R({ id: 'error-messages.error-load-part-page' }) }), { containerId: S.uQT.ERROR }), U.current++);
                }, [T.isRejected, X, R]),
                (0, S.Jzs)(T.isResolved),
                T.isNeededToLoad && (0, o.use)(T.getData({ labelId: Number(C), preloadedLabel: P })),
                                  ...
                                  (0, l.jsxs)(b.N, {
                                      ...
                                      children: [
                                          (0, l.jsxs)('div', {
                                              className: v().header,
                                              children: [
                                                  (0, l.jsx)(p.Caption, { variant: 'div', type: 'text', size: 'm', weight: 'medium', children: D }),
                                                  (0, l.jsx)(L.RR, { className: v().title, title: T.name || '', headingVariant: 'h1' }),
                                                  F,
                                              ],
                                          }),
                                          T.hasAlbums &&
                                              ...
                                              (0, l.jsx)(h.pZ, {
                                                  ...
                                                  headerClassName: (0, s.$)(v().carouselBlock, v().carouselBlockHeader),
                                          ...
                                          T.hasArtists &&
                                              (0, l.jsx)(A.OY, {
                                                  isShimmerVisible: T.isLoading,
                                                  isShimmerActive: !0,
                                                  headerClassName: (0, s.$)(v().carouselBlockHeader, v().carouselBlock),
                                                  containerClassName: v().carouselBlock,
                                                  viewAllActionLink: T.artistsUrl,
                                                  title: R({ id: 'entity-names.artists' }),
                                                  headingVariant: 'h2',
                                          ...
                                          (0, l.jsx)(A.A, { children: (0, l.jsx)(A.wi, { className: v().footer }) }),
                                      ],
                                  }),
                              ],
                          }),
        ...
        87666: (e, t, a) => {
            ...
            let S = (0, r.PA)((e) => {
                let { labelId: t, preloadedLabel: a, preloadedAlbums: r, sortBy: y } = e,
                    {
                        label: { id: S, type: A, name: x, albumsSubpage: f, reset: v, isNeededToLoad: C, getData: P, isPublisher: T },
                        settings: { isMobile: E },
                        experiments: j,
                    } = (0, L.Pjs)(),
                    { formatMessage: R } = (0, n.A)(),
                    { contentScrollRef: I, setContentScrollRef: w } = (0, L.gKY)(),
                    X = (0, L.W6M)(),
                    B = T ? R({ id: 'page.label-podcast-header' }, { labelName: x }) : R({ id: 'page.label-albums-header' }, { labelName: x }),
                    O = (0, d.c)((e) => {
                        var a;
                ...
                if (f.isNeededToLoad) {
                    ...
                    D.push(f.getData({ labelId: Number(t), page: 0, pageSize: 20, preloadedAlbums: e ? r : void 0, sortBy: null != (G = f.sort.sortBy) ? G : y }));
                }
                if (
                    (C && D.push(P({ labelId: Number(t), preloadedLabel: a, withLabelEntities: !1 })),
                        ...
                        children: (0, l.jsxs)('div', {
                            ...
                            children: [
                                (0, l.jsxs)(N.Y9, {
                                    ...
                                    children: [
                                        (0, l.jsx)(m.Heading, { variant: 'h1', weight: 'bold', size: 'xl', lineClamp: 1, children: B }),
                                        (0, l.jsx)(p.mi, { sortModel: f.sort, onSort: U }),
                                    ],
                                }),
                                (0, l.jsx)(N.$$, {
                                    ...
                                    itemContentCallback: (e) => {
                                        let t = f.items[e],
                                            a = R({ id: 'loading-messages.entity-is-loading' }, { entityName: R({ id: 'entity-names.album' }) });
                                        return t
        ...
        87754: (e, t, a) => {
            ...
            let _ = (0, r.PA)((e) => {
                let { labelId: t, preloadedLabel: a, preloadedArtists: r } = e,
                    {
                        label: { id: h, name: _, type: S, artistsSubpage: A, reset: x, isNeededToLoad: f, getData: v },
                        settings: { isMobile: C },
                        experiments: P,
                    } = (0, p.Pjs)(),
                    { formatMessage: T } = (0, n.A)(),
                    { contentScrollRef: E, setContentScrollRef: j } = (0, p.gKY)(),
                    R = (0, p.W6M)(),
                    I = T({ id: 'page.label-artists-header' }, { labelName: _ }),
                    w = (0, d.c)((e) => {
                ...
                let X = (0, o.useMemo)(() => ({ Footer: () => (0, l.jsx)(L.A, { children: (0, l.jsx)(L.wi, { className: y().footer }) }) }), []),
                    ...
                    O = [];
                if (
                    (A.isNeededToLoad && O.push(A.getData({ labelId: Number(t), page: 0, pageSize: 20, preloadedArtists: r })),
                    f && O.push(v({ labelId: Number(t), preloadedLabel: a, withLabelEntities: !1 })),
                        ...
                        children: (0, l.jsxs)('div', {
                            ...
                            children: [
                                (0, l.jsx)(L.Y9, {
                                    ...
                                    className: y().header,
                                    children: (0, l.jsx)(m.Heading, { variant: 'h1', weight: 'bold', size: 'xl', lineClamp: 1, children: I }),
                                }),
                                (0, l.jsx)(L.$$, {
