                                            ...
                                            s = (t) => {
                                                e((e, r) => {
                                                    ...
                                                    let { clientX: _, clientY: p } = d ? t.touches[0] : t,
                                                        ...
                                                        w = Math.sqrt(E * E + b * b) / (y || 1),
                                                        O = [m / (y || 1), k / (y || 1)],
                                                        R = ((s = E), (c = b), (u = m), (f = k), s > c ? (u > 0 ? a : n) : f > 0 ? l : i),
                                                        j = 'number' == typeof r.delta ? r.delta : r.delta[R.toLowerCase()] || o.delta;
                                                    if (E < j && b < j && !e.swiping) return e;
                                                    let h = {
                                                        absX: E,
                                                        absY: b,
                                                        deltaX: m,
                    ...
                    8119: function (e, t, r) {
                        ...
                        let n = r(1082),
                            ...
                            c = (e) => {
                                ...
                                let I = (0, a.useMemo)(() => (S ? (0, n.jsx)('div', { className: o.default.spinnerContainer, children: _ }) : null), [S, _]),
                                    D = (0, a.useCallback)(
                                        (e) => {
                                            S || (b && (0, l.createRipple)(e, o.default.ripple), null == v || v(e));
                                        },
                                        [S, v, b],
                                    );
                                return (0, n.jsx)('button', {
                                    ...
                                    className: (0, i.clsx)(
                                        o.default.root,
                                        o.default['root_'.concat(f, '_').concat(E)],
                                        o.default['root_radius_'.concat(g)],
                                        o.default.root_size,
                                        {
                                            [o.default['root_'.concat(f, '_withHover_').concat(E)]]: y && !O && !S,
                            ...
                            let L = (0, i.useCallback)(() => {
                                ...
                                C = (0, i.useMemo)(
                                    () =>
                                        (0, n.jsx)(u.Button, {
                                            radius: 'round',
                                            className: (0, a.clsx)(f.default.reset, { [f.default.reset_show]: R }),
                                            'aria-label': _,
                                            size: d,
                                            disabled: p,
                                            onClick: L,
