    ...
    [4547],
    {
            ...
            class n extends i.Y {
                createHttpOptions(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        { timeoutKey: r, params: a, headers: i, signal: n, cacheControl: s, ...o } = t,
                        { prefixUrl: c, ...l } = o,
                        { timeouts: u = this.config.timeouts, withoutPrefixUrl: h, withoutHeaders: d } = e,
                        g = null == u ? void 0 : u[r],
                        y = d ? void 0 : null != i ? i : this.createRequestHeaders({ params: a, timeout: g });
                    y && s && (y['cache-control'] = s);
                    let m = null != c ? c : this.config.prefixUrl,
                        v = { headers: y, retry: this.getRetryPolicyConfig(), timeout: g, signal: n, ...l };
                    return h ? v : { prefixUrl: m, ...v };
                }
                ...
                createRequestHeadersFromParams(t) {
                    var e, r, a, i, n, s, o, c, l, u, h, d, g, y, m, v, p, w, E;
                    let b = (null == t || null == (e = t.common) ? void 0 : e.oauth) || this.config.params.common.oauth,
                        ...
                        I = null == (E = null == t || null == (d = t.common) ? void 0 : d.withoutInvocationInfo) || E,
                        ...
                        O = (null == t || null == (m = t.common) ? void 0 : m.clientIp) || this.config.params.common.clientIp,
                        D = (null == t || null == (v = t.common) ? void 0 : v.tracestate) || this.config.params.common.tracestate,
                    ...
                    return (
                        void 0 !== A && (L['x-ya-user-ticket'] = A),
                        void 0 !== S && (L['x-ya-service-ticket'] = S),
                        I && (L['x-yandex-music-without-invocation-info'] = '1'),
                        void 0 !== _ && (L['x-yandex-icookie'] = _),
                        void 0 !== R && (L['x-request-id'] = R),
                        void 0 !== O && ((L['x-forwarded-for-y'] = O), (L['x-forwarded-for'] = O)),
        ...
        44547: (t, e, r) => {
            ...
            let h = Symbol('CONTAINER_USER_CONFIG_TOKEN'),
                ...
                m = Symbol('CONTAINER_REPOSITORY_CONTAINER_TOKEN'),
                v = Symbol('CONTAINER_FILE_STORAGE_TOKEN'),
                ...
                A = Symbol('CONTAINER_ALBUMS_CONTROLLER_TOKEN'),
                S = Symbol('CONTAINER_DOWNLOADER_TOKEN'),
            ...
            class tw {
                async getFileInfo(t, e) {
                    let r = (0, tm.T)(),
                        ...
                        n = await (0, tm.m)({ secretKey: this.secretKey, data: i });
            ...
            class tS {
                ...
                async validateTracks() {
                    try {
                        ...
                        this.hooks.afterError.promise(new tA('Failed to validate tracks', { cause: t }));
                    }
                }
                download(t) {
                ...
                async deleteTrack(t) {
                    try {
                        ...
                        this.hooks.afterError.promise(new tA('Failed to delete track', { cause: e, data: { id: t } }));
                    }
                }
                async refreshTracksAvailability() {
                    try {
                        ...
                        this.hooks.afterError.promise(new tA('Failed to refresh tracks availability', { cause: t }));
                    }
                }
                async refreshTracksMeta() {
                    try {
                        ...
                        this.hooks.afterError.promise(new tA('Failed to refresh tracks meta', { cause: t }));
                    }
                }
            ...
            class t9 extends tP {
                ...
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let a = await r.get(q.name, t2(t, e));
                        return null != a ? a : null;
                    }).catch((r) => {
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(q.name, t2(t, e))).catch((r) => {
                        ...
                        (this.repositoryContainer = ((t) => {
                            ...
                            return (
                                ...
                                a &&
                                    ...
                                    (i.usersTracksRepository = new t7()),
                                    (i.usersAlbumsRepository = new t9())),
                                i
                            );
                        })(t)),
            ...
            var t5 = r(34097);
            class t8 extends t5.Q {
                async about(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: t5.Q.constructor.name, methodName: this.about.name, args: [t] });
                ...
                async settings(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: t5.Q.constructor.name, methodName: this.settings.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
                ...
                async experiments(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: t5.Q.constructor.name, methodName: this.experiments.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
                ...
                async experimentsDetails(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: t5.Q.constructor.name, methodName: this.experimentsDetails.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
            ...
            class es extends ee.v {
                ...
                async getSign(t, e, r, a) {
                    ...
                    return (0, tm.m)({ secretKey: this.variables.secretKey, data: o });
                }
                async getFileInfoBatch(t, e) {
        ...
        77175: (t, e, r) => {
            ...
            class l extends n.X {
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                signal: null == e ? void 0 : e.signal,
                                searchParams: (0, s.P)({ showWizard: t.showWizard, locations: t.locations }),
                            }),
                        )
                    ).json();
                }
                ...
                async getPromoPreview(t, e) {
                    return (
                        await this.httpClient.get(
                            'landing/promo/preview',
                            this.createHttpOptions({ timeoutKey: 'getPromoPreview', signal: null == e ? void 0 : e.signal, searchParams: (0, s.P)({ promoId: t.id }) }),
                        )
                    ).json();
                }
                constructor(t, e) {
            ...
            let a = () => Math.floor(Date.now() / 1e3),
                i = async (t) => {
                    let { secretKey: e, data: r } = t,
                        a = new TextEncoder(),
                        i = a.encode(e);
                    return crypto.subtle.importKey('raw', i, { name: 'HMAC', hash: { name: 'SHA-256' } }, !0, ['sign', 'verify']).then(async (t) => {
                        let e = a.encode(r);
                        return crypto.subtle.sign('HMAC', t, e).then((t) => btoa(String.fromCharCode(...new Uint8Array(t))).slice(0, -1));
                    });
                };
        },
        79722: (t, e, r) => {
