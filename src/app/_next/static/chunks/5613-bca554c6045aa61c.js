(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5613],
    {
        ...
        37257: (e, t, a) => {
            ...
            let A = (0, s.PA)((e) => {
                ...
                if (((0, N.Jzs)(A.isResolved), A.isNeededToLoad && (0, n.use)(A.getData({ categoryId: y, page: 0, pageSize: 20 })), A.isSomethingWrong))
                    return (0, l.jsx)(g.w, {});
                let I = A.isLoading ? 20 : null != (a = null == A || null == (t = A.playlists) ? void 0 : t.length) ? a : 0;
                return (0, l.jsx)(N.nVz, {
                    ...
                    children: (0, l.jsx)(c.hO, {
                        ...
                        children: (0, l.jsxs)('div', {
                            className: C().root,
                            ...(0, u.Am)(u.Xk.nonMusic.NON_MUSIC_CATEGORY_PLAYLISTS),
                            children: [
                                (0, l.jsx)(_.Y9, {
                                    variant: _.Vw.TEXT,
                                    withForwardControl: !1,
                                    withBackwardControl: T.canBack,
                                    children: (0, l.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: A.title }),
                                }),
                                (0, l.jsx)(_.$$, {
                                    context: { listAriaLabel: b({ id: 'mixes.playlists-list' }, { genreName: A.title || '' }) },
                                    className: (0, i.$)(C().scrollContainer, C().important),
                                    customComponents: L,
                                    itemContentCallback: (e) => {
                                        var t, a;
                                        let i = null == A || null == (a = A.playlists) || null == (t = a[e]) ? void 0 : t.data,
                                            s = b({ id: 'loading-messages.entity-is-loading' }, { entityName: b({ id: 'entity-names.playlist' }) });
                                        return i ? (0, l.jsx)(m.B6, { playlist: i, contentLinesCount: 3 }, i.key) : (0, l.jsx)(_.Vt, { isActive: !0, 'aria-label': s });
                                    },
                                    initialItemCount: I,
                                    totalCount: I,
                                    onGetDataByPage: P,
                                    pageSize: 20,
                                    totalRequests: null != (s = A.requests) ? s : 0,
        ...
        55613: (e, t, a) => {
            'use strict';
            a.d(t, { gD: () => R.NonMusicAlbumsPage, xq: () => i.x, ol: () => k.NonMusicCategoryPage, bB: () => v.NonMusicCategoryPlaylistsPage, rN: () => K });
            var l = a(79169),
                i = a(33129),
                s = a(41028),
                o = a(61979),
                ...
                r = a(25911),
                u = a(59615);
            let d = s.gK.model('NonMusicCategoryPlaylistsDataItem', { uid: s.gK.number, kind: s.gK.number, data: s.gK.maybeNull(n.IP) }),
                g = s.gK
                    .compose(
                        ...
                        let t = {
                            getPlaylists: (0, s.L3)(function* (t) {
                                ...
                                let { page: u = 0, pageSize: d = 20 } = t,
                                    { playlistsResource: g, modelActionsLogger: c } = (0, s._$)(e);
                                if ((null == (a = e.playlists) ? void 0 : a.length) && !e.alreadyRequestedPages.has(''.concat(u))) {
                                    e.alreadyRequestedPages.set(''.concat(u), u);
                                    try {
                                        let t = u * d,
                                            a = e.playlists.slice(t, t + d),
                                            l = yield g.getPlaylists({ playlistIds: a.map((e) => ''.concat(e.uid, ':').concat(e.kind)), resumeStream: !1 });
                                        e.requests = (null != (n = e.requests) ? n : 0) + 1;
                                        let o = { page: u, perPage: d, total: null == (i = e.playlists) ? void 0 : i.length },
                            ...
                            getData: (0, s.L3)(function* (a) {
                                let { categoryId: i, page: n = 0, pageSize: r = 20 } = a,
                                    { nonMusicResource: u, modelActionsLogger: d } = (0, s._$)(e);
            ...
            var c = a(12898),
                m = a(52732);
            let N = s.gK.model('NonMusicAlbumsPageItem', { id: s.gK.number, data: s.gK.maybeNull(m.JC) }),
                _ = s.gK
                    .compose(
                    ...
                    .actions((e) => ({
                        getEditorialAlbums: (0, s.L3)(function* (t) {
                            let { id: a } = t,
                                { nonMusicResource: i, modelActionsLogger: n } = (0, s._$)(e);
                            if (e.loadingState !== l.GuX.PENDING)
                                try {
                                    var r;
                                    e.loadingState = l.GuX.PENDING;
            ...
            var y = a(65),
                ...
                A = a(16285),
                p = a(34874);
            let T = s.gK.model('NonMusicBaseBlock').props({
                ...
                E = T.named('NonMusicCategoryBlock').props({
                    ...
                    landingBlockType: s.gK.literal(C.t.NON_MUSIC_EDITORIAL_COMPILATION),
            ...
            let L = T.named('NonMusicMixesBlock').props({
                ...
                O = s.gK
                    .compose(
                        s.gK.model('NonMusicCategoryPage', { errorStatusCode: s.gK.maybeNull(s.gK.number), title: s.gK.maybeNull(s.gK.string), blocks: s.gK.array(M) }),
                        u.XT,
                    )
                    .views((e) => {
                        let t = {
                            ...
                            get isNotFound() {
                                let t = e.isResolved && 0 === e.blocks.length,
                                    a = e.errorStatusCode === o.X1.NOT_FOUND || e.errorStatusCode === o.X1.BAD_REQUEST;
                    ...
                    .actions((e) => ({
                        getData: (0, s.L3)(function* (t) {
                            let { categoryId: a } = t,
                                { nonMusicResource: i, modelActionsLogger: r } = (0, s._$)(e);
                            if (e.loadingState !== l.GuX.PENDING)
                                try {
                                    e.loadingState = l.GuX.PENDING;
                                        ...
                                        (t.blocks.forEach((e) => {
                                            switch (e.type) {
                                                    ...
                                                    o.push(
                                                        ((e) => {
                                                            let t = e.entities.map((e) => ({
                                                                ...(0, m.pp)(e.data.album),
                                                                chart: e.data.chartPosition && (0, A.ws)(e.data.chartPosition),
                                                                likesCount: e.data.album.likesCount,
                                                            }));
                                                            return (0, s.wg)({
                                                                id: e.id,
                                                                type: y.K.ALBUM_CHART,
                                                                landingBlockType: C.t.CHART_ALBUMS,
                                                                title: e.title,
                                                    ...
                                                    o.push(
                                                        ((e) => {
                                                            let t = e.entities.map((e) => {
                                                                switch (e.type) {
                                                                    case y.j.PLAYLIST:
                                                                        return { type: p._.PLAYLIST_ITEM, data: (0, n.Ew)({ ...e.data, artists: [] }) };
                                                                    case y.j.ALBUM:
                                                                        return { type: p._.ALBUM_ITEM, data: (0, m.pp)(e.data) };
                                                                }
                                                            });
                                                            return (0, s.wg)({
                                                                id: e.id,
                                                                type: y.K.EDITORIAL_PLAYLISTS,
                                                                landingBlockType: C.t.RECENTLY_PLAYED,
                                                                title: e.title,
                                                                description: e.description,
                                                                viewAllActionLink: e.viewAllUrl,
                                                                items: t,
                                                ...
                                                case y.K.CATEGORY:
                                                    o.push(
                                                        ((e) => {
                                                            let t = e.entities.map((e) => ({ type: p._.NON_MUSIC_ALBUM_ITEM, data: (0, m.pp)(e.data) }));
                                                            return (0, s.wg)({
                                                                id: e.id,
                                                                type: y.K.CATEGORY,
                                                                landingBlockType: C.t.NON_MUSIC_EDITORIAL_COMPILATION,
                                                                title: e.title,
                                                                description: e.description,
                                                                viewAllActionLink: e.viewAllUrl,
                                                                items: t,
                                                    ...
                                                    o.push(
                                                        ((e) => {
                                                            ...
                                                            return (0, s.wg)({
                                                                id: e.id,
                                                                type: y.K.PROMOTIONS,
                                                                landingBlockType: C.t.NON_MUSIC_PROMOTIONS,
                                                                title: e.title,
                                                                description: e.description,
                                                ...
                                                case y.K.CATEGORIES_TAB:
                                                    o.push(
                                                        ((e) => {
                                                            ...
                                                            return (0, s.wg)({
                                                                id: e.id,
                                                                type: y.K.CATEGORIES_TAB,
                                                                landingBlockType: C.t.MIXES_GRID,
                                                                title: e.title,
                                                                items: t,
                                                            });
                                                        })(e),
                        ...
                        children: (0, l.jsxs)(y.hO, {
                            ...
                            children: [
                                ...
                                (0, l.jsxs)(c.N, {
                                    ...
                                    children: [
                                        (0, l.jsx)('div', {
                                            className: (0, i.$)(T().landing, { [T().landing_onlyWizard]: b }),
                                        ...
                                        (0, l.jsx)(A.A, { children: (0, l.jsx)(A.wi, { className: T().footer }) }),
                                    ],
                                }),
                            ],
                        }),
        ...
        66901: (e, t, a) => {
            ...
            var l = a(33008),
                ...
                y = a(85291),
                C = a.n(y);
            let A = { [r.K.ALBUM_CHART]: g.SQ, [r.K.EDITORIAL_PLAYLISTS]: g.g0, [r.K.CATEGORY]: g.tl, [r.K.PROMOTIONS]: g.nM, [r.K.CATEGORIES_TAB]: g.qh },
                p = (0, s.PA)((e) => {
                    let { id: t } = e,
                        {
                            ...
                            a.blocks.map((e, t) => {
                                ...
                                return (0, l.jsx)(
                                    N.FoH,
                                    {
                                        blockId: e.id,
                                        blockType: e.type,
                                        blockIdForFrom: ''.concat(N.hf$.DISCOVERY_BLOCK, '-').concat(e.id),
                                        blockPosX: 1,
                                        blockPosY: t + 1,
                                        ...
                                        children: (0, l.jsx)(
                                            s,
                                            {
                                                headerClassName: (0, i.$)(C().carouselBlockHeader, C().carouselBlock),
                                                containerClassName: C().carouselBlock,
                              ...
                              children: (0, l.jsxs)(m.hO, {
                                  ...
                                  children: [
                                      (0, l.jsx)(_.Y9, {
                                          ...
                                          children: (0, l.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', children: a.title }),
                                      }),
                                      (0, l.jsxs)(u.N, {
                                          className: C().root,
                                          ...
                                          ref: r,
                                          children: [
                                              (0, l.jsx)('div', { className: C().carouselBlocks, children: p }),
                                              (0, l.jsx)(_.A, { children: (0, l.jsx)(_.wi, { className: C().footer }) }),
                                          ],
                                      }),
                                  ],
                              }),
        ...
        70829: (e, t, a) => {
            ...
            let A = (0, s.PA)((e) => {
                ...
                let P = (0, n.useCallback)(
                    ...
                    L = (0, n.useMemo)(() => ({ Footer: () => (0, l.jsx)(N.A, { children: (0, l.jsx)(N.wi, { className: C().footer }) }) }), []),
                    I = A.isLoading ? 20 : null != (a = null == (t = A.albums) ? void 0 : t.length) ? a : 0;
                return (
                    s && A.isNeededToLoad && (y === _.x.EDITORIAL ? (0, n.use)(A.getEditorialAlbums({ id: s })) : (0, n.use)(A.getCategoryAlbums({ id: s }))),
                    (0, l.jsx)(m.nVz, {
                        ...
                        children: (0, l.jsx)(c.hO, {
                            ...
                            children: (0, l.jsxs)('div', {
                                className: C().root,
                                ...(0, u.Am)(u.Xk.nonMusic.NON_MUSIC_ALBUMS_PAGE),
                                children: [
                                    (0, l.jsx)(N.Y9, {
                                        variant: N.Vw.TEXT,
                                        withForwardControl: !1,
                                    ...
                                    (0, l.jsx)(N.$$, {
                                        ...
                                        itemContentCallback: (e) => {
                                            var t, a;
                                            let i = null == (a = A.albums) || null == (t = a[e]) ? void 0 : t.data,
                                        ...
                                        itemClassName: C().item,
                                        handleRef: S,
                                        context: { listAriaLabel: T({ id: 'mixes.albums-list' }, { genreName: A.title || '' }) },
                                        isMobileLayout: h,
                                        useWindowScroll: h,
                                    }),
                                ],
