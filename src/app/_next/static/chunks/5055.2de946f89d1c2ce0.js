    ...
    [5055],
    {
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                searchParams: (0, o.P)({ campaignId: t.campaignId }),
                            }),
                        )
                    ).json();
                }
        ...
        14031: (t, e, s) => {
            ...
            let n = ['x-request-id', 'x-retry-count', 'X-Requested-With', 'X-Retpath-Y'],
                o = { statusCodes: {}, totalRequestsLimit: 0 };
            class r extends a.Y {
                async ping(t) {
            ...
            class p {
                ...
                optionsConverter(t) {
                    let {
                        ...
                        m = {};
                    if ((void 0 !== u && (m.credentials = u), void 0 !== e && (m.prefixUrl = e), void 0 !== s && (m.method = s), void 0 !== a)) {
                        var y;
                        m.headers = { ...a, 'user-agent': null != (y = a['user-agent']) ? y : a['User-Agent'] };
                    }
                    if (
                        (void 0 !== i && (m.searchParams = i),
                        void 0 !== n && (m.json = n),
                        'number' == typeof l && (m.timeout = l),
                        void 0 !== c && (m.body = c),
                        void 0 !== d && (m.signal = d),
                        (null == r ? void 0 : r.config) &&
                            ...
                            (m.hooks = m.hooks || {}),
                            (m.hooks.beforeRetry = m.hooks.beforeRetry || []),
                            m.hooks.beforeRetry.push(async (t) => {
                                await h({ request: t.request, options: t.options, error: t.error, retryAttempt: t.retryCount, clientRetryConfig: r });
                            })),
                        o)
                    ) {
                        let t,
                        ...
                        void 0 === m.hooks && (m.hooks = {}),
                            ...
                            Array.isArray(s) &&
                                ((m.hooks.beforeRetry = m.hooks.beforeRetry || []),
                                (m.hooks.beforeRetry = m.hooks.beforeRetry.concat(
                                    s.map((t) => async (e) => {
                                        let { request: s, options: i, error: a, retryCount: n } = e;
                                        await t(this.errorConverter(a, s, i), n);
                                    }),
                                ))),
                            Array.isArray(i) && (m.hooks.beforeError = i.map((t) => async (e) => (await t(this.errorConverter(e)), e))),
                            Array.isArray(a) &&
                    ...
                    return (
                        void 0 !== p &&
                            (void 0 === m.hooks && (m.hooks = {}),
                            void 0 === m.hooks.beforeRequest && (m.hooks.beforeRequest = []),
                            m.hooks.beforeRequest.push((t) => {
                                if (p) for (let e of p) t.headers.has(e) && t.headers.delete(e);
                            })),
                        m
                    );
                }
                ...
                convertMethod(t) {
                    return void 0 !== t && g.includes(t) ? t.toUpperCase() : 'GET';
                }
                convertMethods(t) {
                    let e = new Set();
                    return (
                        t.forEach((t) => {
                            g.includes(t) && e.add(t.toUpperCase());
                        }),
                        [...e]
                    );
                }
        ...
        38979: (t, e, s) => {
            ...
            class r extends n.X {
                async getStorageData(t, e) {
                    let { formatFlags: s, direct: i, preview: a, canUseStreaming: n, tsInSeconds: r, sign: l, debug: c, isAliceRequester: u, requireMp3Link: d } = t;
                    return (
                        await this.httpClient.get(
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ sign: t.sign, timeStamp: t.timeStamp, format: t.format }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
        ...
        42068: (t, e, s) => {
            ...
            class o {
                ...
                getPassportHostWithTld(t, e) {
                    ...
                    return (0, a.getTldHost)(s, this.tld, n.B);
                }
                get passportLogin() {}
                get yandexUid() {}
                observe(t) {}
            ...
            class n {
                async send(t, e) {
                    ...
                    let { name: u, data: d } = t,
                        ...
                        g = this.rum._buildAdditional(h.additional, d),
                        p = this.rum._buildExperiments(null != (c = h.experiments) ? c : []),
                        m = {
                            ...this.rum._vars,
                        ...
                        f = null == (n = (o = this.rum).getSetting) ? void 0 : n.call(o, 'slots'),
                        k = null == (r = (l = this.rum).getSetting) ? void 0 : r.call(l, 'experiments');
                    try {
        ...
        55256: (t, e, s) => {
            var i = {
                './default.ts': [37469, 7469],
                './development.ts': [289, 289],
                './production.ts': [12771, 2771],
                './qa.ts': [23342, 3342],
                './stress.ts': [35196, 5196],
                './tokens/DevToolsTokens.ts': [12583],
            };
            function a(t) {
                if (!s.o(i, t))
                    return Promise.resolve().then(() => {
        ...
        61933: (t, e, s) => {
            ...
            async function i(t, e) {
                let { config: i } = await s(94753)('./'.concat(t, '.ts'));
                return i(e);
            }
            s.d(e, { z: () => i });
        },
                ...
                c = l(
                    {
                        ...
                        waveResource: { createRoom: i, getRooms: i, getRoomById: i, editRoom: i, enterRoom: i, exitRoom: i },
                        rotorResource: {
                            getStationInfo: 180,
                            sessionNew: i,
                            sessionTracks: i,
                        ...
                        landingResource: { getSkeleton: 5e3, getBlock: i, getSpecialHeader: 500, getPromoPreview: i },
                        ...
                        concertsResource: { getTabConfig: i, getFeed: i, getInfo: i, getSkeleton: i, getLocations: i },
                        ...
                        radioStationsResource: {
                            ...
                            getCollectionShows: i,
                            addCollectionShows: i,
                            getCollectionShowsIds: i,
                            bulkDeleteCollectionShows: i,
                        ...
                        wheelResource: { wheelNew: i, feedbacks: i },
                        lumenResource: { getLumen: i },
                    },
                    [
        ...
        64552: (t, e, s) => {
            ...
            let n = async (t) => t.then((t) => t.default),
                o = a.pE[a.cy],
                r = o.langs.reduce((t, e) => (t.set(e, async () => n(s(12526)('./'.concat(e, '.json')))), t), new Map()),
                l = o.langs.reduce((t, e) => (t.set(e, async () => n(s(46646)('./'.concat(e, '.json')))), t), new Map()),
                c = async function (t) {
        ...
        64642: (t, e, s) => {
            ...
            class n extends a.X {
                async sendMetrics(t) {
                    let { varsString: e, reqid: s, table: i, path: a, slots: n, experimentsSetting: o } = t,
                        r = [
                            '/reqid='.concat(s),
                            '/table='.concat(i),
                            a ? '/path='.concat(a) : '',
                            n ? '/slots='.concat(Array.isArray(n) ? n.join(';') : n) : '',
                            o ? '/experiments='.concat(Array.isArray(o) ? o.join(';') : o) : '',
                            '/vars='.concat(e),
                            '/cts='.concat(Date.now()),
                            '/*',
                        ]
            ...
            class o {
                ...
                constructor(t) {
                    (0, i._)(this, 'logger', void 0),
                        ...
                        (0, i._)(this, 'beforeErrorHook', void 0),
                        (this.logger = t),
                        ...
                        (this.beforeRetryHook = (t, e) => {
                            let s = t.cause;
                            if ((0, a.N)(s)) {
                                var i, n, o, r, l, c, u, d, h, g, p, m, y, v;
                                let a = {
                                    ...
                                    request: {
                                        ...
                                        url: (null == (o = s.request) ? void 0 : o.url) || (null == (r = s.options) ? void 0 : r.url),
                                ...
                                let f = this.getUrl((null == (h = s.request) ? void 0 : h.url) || (null == (g = s.options) ? void 0 : g.url));
                                this.logger.warn(
                                    '[Resource] Retry request '
                                        .concat((null == (p = s.request) ? void 0 : p.method) || (null == (m = s.options) ? void 0 : m.method), ' ')
                                        .concat(f.origin, ' ')
                                        .concat(f.pathname)
                                        .concat(f.search),
                                    a,
                        ...
                        (this.beforeErrorHook = (t) => {
                            let e = t.cause;
                            if ((0, a.N)(e)) {
                                var s, i, n, o, r, l, c, u, d, h, g, p, m, y;
                                let a = {
                                    error: { name: t.name, message: t.message, code: t.code, data: t.data, stack: t.stack },
                                    request: {
                                        method: (null == (s = e.request) ? void 0 : s.method) || (null == (i = e.options) ? void 0 : i.method),
                                        url: (null == (n = e.request) ? void 0 : n.url) || (null == (o = e.options) ? void 0 : o.url),
                                        headers: this.getHeaders((null == (r = e.request) ? void 0 : r.headers) || (null == (l = e.options) ? void 0 : l.headers)),
                                ...
                                this.logger.error(
                                    '[Resource] Request failed '
                                        .concat((null == (g = e.request) ? void 0 : g.method) || (null == (p = e.options) ? void 0 : p.method), ' ')
                                        .concat(v.origin, ' ')
                                        .concat(v.pathname)
        ...
        73422: (t, e, s) => {
            ...
            var i = s(91945),
                ...
                n = s(84570),
                o = s(40363);
            let r = (t) => o.U.parseAcceptLanguage(null != t ? t : void 0);
            var l = s(18870);
            let c = (t) => {
                var e;
                ...
                constructor({ serverDetectedLocale: t, isBuildTypeDesktop: e, storage: s, changeLanguageHandler: l, logger: c }) {
                    ...
                    if (
                        ...
                        if ('undefined' != typeof navigator) {
                            var d;
                            let t;
                            u = ((t = this.config), new o.U({ brandConfig: t, enableWideLanguageSelectWithBrandLangs: !0 })).getLang({
                                cookieLang: (null == (d = this.storage) ? void 0 : d.get()) || void 0,
                                acceptLangs: r(navigator.languages.join()),
                            });
                        }
                    } else [u] = r(t) || [];
        ...
        76198: (t, e, s) => {
            ...
            class r extends a.X {
                    ...
                    let s = (0, n.F)({ trackIds: t.trackIds, viewedCards: t.viewedCards, viewedBigCards: t.viewedBigCards, locations: t.locations }),
                        i = await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                json: s,
                                searchParams: (0, o.P)({ locations: t.locations }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        );
                ...
                async bigCards(t, e) {
                    let s = (0, n.F)({ bigCardIds: t.bigCardIds }),
                        i = await this.httpClient.post(
                            'words/big-cards',
        ...
        92023: (t, e, s) => {
            ...
            function a(t) {
                let e,
                    ...
                    o = !1 === navigator.onLine ? 'offline' : 'unknown',
                    r = !1,
                    l = 0,
                    c = new Set();
                function u(t) {
                    o !== t && ((o = t), c.forEach((t) => t(o)));
                }
                function d() {
        ...
        94753: (t, e, s) => {
            var i = {
                './clientSafeConfig/default.ts': [37469, 7469],
                './clientSafeConfig/development.ts': [289, 289],
                './clientSafeConfig/production.ts': [12771, 2771],
                './clientSafeConfig/qa.ts': [23342, 3342],
                './clientSafeConfig/stress.ts': [35196, 5196],
                './clientSafeConfig/tokens/DevToolsTokens.ts': [12583],
                './default.ts': [62016, 9635],
                './development.ts': [52708, 2708],
                './production.ts': [35616, 5616],
                './qa.ts': [24793, 4793],
                './retryPolicyConfigs/musicExternalApiRetryPolicyConfig.ts': [62885],
                './retryPolicyConfigs/musicExternalApiRetryPolicyServerConfig.ts': [63970, 3970],
                './stress.ts': [81935, 1935],
                './types/ConfigVariables.ts': [81732, 1732],
                './types/ConfigVariablesMainPlayback.ts': [76360, 3979],
                './types/ConfigVariablesPayment.ts': [90794, 794],
                './types/ConfigVariablesPlayer.ts': [50769, 769],
                './types/ConfigVariablesResource.ts': [13240, 3240],
                './types/ConfigVariablesTelemetry.ts': [33499, 3499],
                './types/ConfigVariablesTrailerPlayback.ts': [52186, 2186],
                './types/ConfigVariablesVHMediaProvider.ts': [19959, 9959],
                './utils/getAfishaClientId.ts': [36293, 6293],
                './utils/getApiPrefixUrl.ts': [6170, 3789],
                './utils/getClientSafeConfig.ts': [75887],
                './utils/getConfig.ts': [61933],
            };
            function a(t) {
                if (!s.o(i, t))
                    return Promise.resolve().then(() => {
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                body: (0, o.P)({ diff: t.diff, revision: t.revision }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
