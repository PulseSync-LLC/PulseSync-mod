        ...
        16510: (e, t, r) => {
            ...
            class eP {
                async afterResponse(e) {
                    try {
                        if (!e.headers['content-range'] && e.headers['content-type'] && eL.test(e.headers['content-type'])) {
            ...
            var e_ = r(49502),
                ...
                eX = r(10808);
            async function eB(e) {
                let { tld: t, env: r, serverDetectedLocale: eU, changeLanguageToken: eL, browserName: eB, browserVersion: eI, executionContextStore: ev } = e,
                ...
                return new l.Dt()
                    ...
                    .registerMany({
                        ...
                        [eH.TK]: (0, l.Gr)(
                            (e) =>
                                new ((0, eh.b)(d.r))({
                                    maxLogLevel: c.cm.DEBUG,
                                    secureFields: ex.x,
                                    disableLogToConsole: 'development' !== e.get(eH.SX),
                                    additionalData: {
                                        get puid() {
                                            return e.get(eH.WA).getPassportUid();
                                        },
                        ...
                        [eH.y$]: (0, l.Gr)(() => new eo.Mz({ config: { useEntitiesStorage: !1, useFileStorage: !1, useResponseCacheStorage: !1 } })),
                        [eH.Xc]: (0, l.Gr)((e) => {
                            let r = e.get(eH.oo),
                                n = e.get(eH.Zf),
                                { i18n: s } = e.get(eH.tw),
                                i = new Date(Date.now() + 24 * s.cookieExpirationDays * 36e5);
                            return new ef.E({
                                serverDetectedLocale: eU,
                                logger: n,
                                changeLanguageHandler: new ew(t, eL),
                                storage: {
                                    get: () => r.get(eR.c.SavedUserLanguage, !1),
                                    set(e) {
                                        r.set(eR.c.SavedUserLanguage, e, { path: '/', domain: window.location.hostname, expires: i, secure: !0 }, !1);
                                    },
                                },
                            });
                        }),
                    ...
                    .registerMany({
                        [eH.QG]: (0, l.Gr)((e) => new ea.b(e.get(eH.DP), e.get(eH.tw), e.get(eH.Xc).getLanguage(), e.get(eH.WA))),
                        [eH.OP]: (0, l.P9)(
                            (e) =>
                                function () {
                                    var t, r, n, s, i, g;
                                    ...
                                    return (
                                        ...
                                        (o.hooks = {
                                            ...
                                            beforeRequest: [eT.x, d.beforeRequestHook, ...((null == o || null == (s = o.hooks) ? void 0 : s.beforeRequest) || [])],
                                            beforeRetry: [eW.i, c.beforeRetryHook, ...((null == o || null == (i = o.hooks) ? void 0 : i.beforeRetry) || [])],
                            ...
                            (e) =>
                                function () {
                                    ...
                                    let n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                        s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.get(eH.OP),
                                        i = e.get(eH.QG),
                                        { resources: o } = e.get(eH.tw),
                                        l = s({ credentials: 'include' }, e.get(eH.Hm)),
                                        { prefixUrl: u, timeouts: a, retryPolicyConfig: c } = o.musicExternalApi,
                                        d = e.get(eH.Xc).getLanguage(),
                                        p = new m.Q(l, {
                                            prefixUrl: (0, g.getTldHost)(u, t, eE.B),
                                            retryPolicyConfig: c,
                                    ...
                                    return (
                                        (n.hooks = { beforeError: [(0, ec.o)(i, p), ...((null == n || null == (r = n.hooks) ? void 0 : r.beforeError) || [])] }),
                                        s(n, e.get(eH.Hm))
                                    );
                                },
                        ),
                                ...
                                function () {
                                    ...
                                    return (
                                        ...
                                        (o.hooks = {
                                            ...
                                            afterTimeout: [c.beforeErrorHook, ...((null == o || null == (r = o.hooks) ? void 0 : r.afterTimeout) || [])],
                                            beforeError: [c.beforeErrorHook, ...((null == o || null == (n = o.hooks) ? void 0 : n.beforeError) || [])],
                                            beforeRequest: [eT.x, ...((null == o || null == (s = o.hooks) ? void 0 : s.beforeRequest) || [])],
                                            beforeRetry: [eW.i, c.beforeRetryHook, ...((null == o || null == (i = o.hooks) ? void 0 : i.beforeRetry) || [])],
                                            onRequestDone: [...((null == o || null == (g = o.hooks) ? void 0 : g.onRequestDone) || [])],
                                        }),
                                        l(o)
                    ...
                    .registerMany({
                        [eH.$I]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                                { prefixUrl: n, timeouts: s, retryPolicyConfig: i } = r.musicExternalApi,
                        ...
                        [eH.uM]: (0, l.Gr)((e) => {
                            ...
                            let { acqOffers: s, rumSettings: i } = e.get(eH.tw),
                                { brand: g, service: o, environment: l, appVersion: u } = s,
                                { platform: a, page: c } = i,
                                d = e.get(eH.QG),
                                ...
                                { request_id: w, puid: f } = null != (r = e.get(eH.Zi).getStore()) ? r : {};
                            return new n.mZ({
                                brand: g,
                                service: o,
                                environment: l,
                                ...
                                rumOptions: { platform: a, page: c, requestId: w },
                            });
                        }),
                        [eH.$$]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                        ...
                        [eH.LC]: (0, l.Gr)((e) => {
                            let { resources: t, player: r } = e.get(eH.tw),
                                { timeouts: n, retryPolicyConfig: s } = t.musicExternalApi,
                    ...
                    .register(
                        ...
                        (0, l.Gr)((e) => {
                            let t = e.get(eH.oo),
                                r = (0, i.A)(),
                                n = {
                                    info: { app_name: eB || 'Browser', app_version: eI || '', title: 'Browser '.concat(eB), device_id: r, type: s.bq.WEB },
                                    volumeGranularity: 20,
                                    get defaultVolume() {
                                        var g;
                                        return null != (g = t.get(eR.c.YmPlayerVolume)) ? g : void 0;
                                    },
                                },
                            ...
                            return new s.Jd({
                                ...
                                multiAuthUserId: o,
                                oauth: l.token,
                                ynisonConnectionConfig: ek.ynisonConnectionConfig,
