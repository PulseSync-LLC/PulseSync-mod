(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2489],
    {
        ...
        33426: (t, e, s) => {
            ...
            class r extends a.X {
                async cards(t, e) {
                    let s = (0, n.F)({ trackIds: t.trackIds, viewedCards: t.viewedCards }),
                        i = await this.httpClient.post(
                            'words/cards',
                            this.createHttpOptions({ timeoutKey: 'cards', params: t, json: s, signal: null == e ? void 0 : e.signal }),
                        );
        ...
        55256: (t, e, s) => {
            var i = {
                './default.ts': [35625, 5625],
                './development.ts': [5533, 5533],
                './production.ts': [27591, 7591],
                './qa.ts': [71090, 1090],
                './stress.ts': [42720, 2720],
                './tokens/DevToolsTokens.ts': [36931],
            };
            function a(t) {
                if (!s.o(i, t))
        ...
        94753: (t, e, s) => {
            var i = {
                './clientSafeConfig/default.ts': [35625, 5625],
                './clientSafeConfig/development.ts': [5533, 5533],
                './clientSafeConfig/production.ts': [27591, 7591],
                './clientSafeConfig/qa.ts': [71090, 1090],
                './clientSafeConfig/stress.ts': [42720, 2720],
                './clientSafeConfig/tokens/DevToolsTokens.ts': [36931],
                './default.ts': [23932, 3932],
                './development.ts': [81952, 1952],
                './production.ts': [66900, 6900],
                './qa.ts': [69405, 9405],
                './retryPolicyConfigs/musicExternalApiRetryPolicyConfig.ts': [81497],
                './retryPolicyConfigs/musicExternalApiRetryPolicyServerConfig.ts': [89086, 9086],
                './stress.ts': [50259, 259],
                './types/ConfigVariables.ts': [94499, 6880],
                './types/ConfigVariablesMainPlayback.ts': [5228, 5228],
                './types/ConfigVariablesPayment.ts': [70638, 638],
                './types/ConfigVariablesPlayer.ts': [59101, 9101],
                './types/ConfigVariablesResource.ts': [51300, 1300],
                './types/ConfigVariablesTelemetry.ts': [11159, 1159],
                './types/ConfigVariablesTrailerPlayback.ts': [96014, 6014],
                './types/ConfigVariablesVHMediaProvider.ts': [9931, 9931],
                './utils/getAfishaClientId.ts': [71945, 1945],
                './utils/getApiPrefixUrl.ts': [31678, 1678],
                './utils/getClientSafeConfig.ts': [45011],
                './utils/getConfig.ts': [7310],
            };
            function a(t) {
                if (!s.o(i, t))
                    return Promise.resolve().then(() => {
