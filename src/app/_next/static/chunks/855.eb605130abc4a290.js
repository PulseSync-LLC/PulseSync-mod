    ...
    [855],
    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                this.observableValue.subscribe(function (r) {
                                    r !== t.prevValueByListener.get(e) && (t.prevValueByListener.set(e, r), e(r));
                                })
                            );
                        },
                    });
                ...
                s = function (e, t) {
                    ...
                    if (null != e && 'function' == typeof Object.getOwnPropertySymbols)
                        for (var s = 0, o = Object.getOwnPropertySymbols(e); s < o.length; s++)
                            0 > t.indexOf(o[s]) && Object.prototype.propertyIsEnumerable.call(e, o[s]) && (r[o[s]] = e[o[s]]);
                    return r;
                },
                i = (function (e) {
                    function t(r, o) {
                        ...
                        var i = this,
                            ...
                            l = r || 'Internal error';
                        return (
                            Object.defineProperty((i = e.call(this, l, u) || this), 'name', { enumerable: !0, configurable: !0, writable: !0, value: 'BaseException' }),
        ...
        44865: (e, t, r) => {
            ...
            let i = (e) => null !== e && 'object' == typeof e,
                ...
                b = { json: 'application/json', text: 'text/*', formData: 'multipart/form-data', arrayBuffer: '*/*', blob: '*/*' },
                d = Symbol('stop'),
                y = [413, 429, 503],
                m = {
                    limit: 2,
                    ...
                    try {
                        ...
                        if (0 !== t && this._retryCount > 0) {
                            for (let e of (await w(t, { signal: this._options.signal }), this._options.hooks.beforeRetry))
                                if ((await e({ request: this.request, options: this._options, error: r, retryCount: this._retryCount })) === d) return;
