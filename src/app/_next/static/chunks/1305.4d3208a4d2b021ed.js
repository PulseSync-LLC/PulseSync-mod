            ...
            async function eB(e) {
                ...
                return new l.Dt()
                    ...
                    .registerMany({
                        ...
                        [eH.DP]: (0, l.Gr)(() => new ea.MJ('client '.concat('desktop'), 'cookie')),
                    ...
                    .registerMany({
                        [eH.QG]: (0, l.Gr)((e) => new ec.G(e.get(eH.oo), e.get(eH.tw), e.get(eH.Xc).getLanguage())),
                        [eH.OP]: (0, l.P9)(
                            (e) =>
                                function () {
                                    var t, r, o, n, g;
                            ...
                            (e) =>
                                function () {
                                    ...
                                    let o = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                        n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.get(eH.OP),
                                        g = e.get(eH.QG),
                                        ...
                                        d = new p.Q(l, {
                                            prefixUrl: (0, i.getTldHost)(c, t, eE.B),
                                            retryPolicyConfig: s,
                                            timeouts: u.accountResource,
                                            params: { common: { oauth: g.token, client: (0, el._)(), device: (0, ev.V)(), language: m } },
                                        });
                                    return (
                                        (o.hooks = { beforeError: [(0, eu.o)(g, d), ...((null == o || null == (r = o.hooks) ? void 0 : r.beforeError) || [])] }),
                                        n(o, e.get(eH.Hm))
                                    );
                                },
                        ),
                    ...
                    .registerMany({
                        [eH.$I]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                                ...
                                m = {
                                    ...
                                    params: { common: { oauth: s.token, client: (0, el._)(), device: (0, ev.V)(), language: a } },
                                };
                            return c.cacheController ? new ei.wV(u, m, { cacheController: c.cacheController }) : new p.Q(u, m);
                        }),
                        [eH._1]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                                { prefixUrl: o, timeouts: n, retryPolicyConfig: g } = r.musicExternalApi,
                            ...
                            return new d.d(l, {
                                ...
                                params: { common: { oauth: c.token, client: (0, el._)(), device: (0, ev.V)(), language: a } },
                            });
                        }),
                        [eH.V3]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                        ...
                        [eH.qT]: (0, l.Gr)((e) => {
                            let { resources: r, player: o } = e.get(eH.tw),
                                ...
                                p = {
                                    ...
                                    params: { common: { oauth: u.token, client: (0, el._)(), device: (0, ev.V)(), language: l } },
                                },
                        ...
                        [eH.aE]: (0, l.Gr)((e) => {
                            ...
                            return u.cacheController
                                ? (0, ei._2)({
                                      ...
                                      config: { common: { resourceName: y.l.constructor.name }, enabled: !0, priority: ei.OU.HIGH, ttl: 6048e5 },
                                  })
                                : s;
                        }),
                        [eH.ki]: (0, l.Gr)((e) => {
                        ...
                        [eH.re]: (0, l.Gr)((e) => {
                            ...
                            return new q.s(g, {
                                ...
                                params: { common: { client: (0, el._)(), device: (0, ev.V)(), language: n } },
                            });
                        }),
                        [eH.Lk]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                        ...
                        [eH.he]: (0, l.Gr)((e) => {
                            ...
                            return new K.K(l, {
                                ...
                                params: { common: { client: (0, el._)(), device: (0, ev.V)(), language: a } },
                            });
                        }),
                        [eH.uM]: (0, l.Gr)((e) => {
                            var t;
                            let { acqOffers: r, rumSettings: n } = e.get(eH.tw),
                                ...
                                { request_id: G, puid: A } = null != (t = e.get(eH.Zi).getStore()) ? t : {};
                            return new o.mZ({
                                brand: g,
                                service: i,
                                environment: a,
                        ...
                        [eH.$$]: (0, l.Gr)((e) => {
                            ...
                            return new I.E(l, {
                                ...
                                params: { common: { oauth: c.token, client: (0, el._)(), language: a } },
                            });
                        }),
                        [eH.sv]: (0, l.Gr)((e) => {
                            let { resources: r } = e.get(eH.tw),
                        ...
                        [eH.N1]: (0, l.Gr)((e) => {
                            ...
                            return u.cacheController
                                ? (0, ei._2)({
                                      resource: s,
                                      cacheController: u.cacheController,
                                      config: { common: { resourceName: F.H.constructor.name }, enabled: !0, priority: ei.OU.HIGH, ttl: 6048e5 },
                                  })
                                : s;
                        }),
                        [eH.u2]: (0, l.Gr)((e) => {
                    ...
                    .register(
                        ...
                        (0, l.Gr)((e) => {
                            ...
                            o || ((o = (0, g.A)()), r.set(ek.c.YnisonDeviceId, o));
                            let i = {
                                    info: { app_name: 'Desktop', app_version: (0, eh.H)() || '', title: 'Music Desktop App', device_id: o, type: n.bq.WEB_DESKTOP },
                                    volumeGranularity: 20,
                                    get defaultVolume() {
                                        var a;
                                        return null != (a = t.get(ek.c.YmPlayerVolume)) ? a : void 0;
                                    },
                                },
                            ...
                            return new n.Jd({
                                ...
                                multiAuthUserId: l,
                                oauth: c.token,
                                ynisonConnectionConfig: eB.ynisonConnectionConfig,
