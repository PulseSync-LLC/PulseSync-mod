                ...
                return {
                    player_state: {
                        player_queue: {
                            ...
                            entity_id: '',
                            entity_type: l.VARIOUS,
                            playable_list: [],
                            options: { repeat_mode: f.NONE },
                            shuffle_optional: null,
                            entity_context: c.BASED_ON_ENTITY_BY_DEFAULT,
                            version: t,
                            from_optional: '',
                ...
                k = (function () {
                    function e(e) {
                        Object.defineProperty(this, 'state', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            Object.defineProperty(this, 'emitter', { enumerable: !0, configurable: !0, writable: !0, value: new A() }),
                            (this.options = e),
                            (this.state = j(e.deviceConfig.info.device_id)),
                            (this.prevState = j(e.deviceConfig.info.device_id)),
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'fullState', {
                            get: function () {
                                return P({ state: this.state, prevState: this.prevState, diff: this.diff, remoteControllerDevice: this.remoteControllerDevice });
                            },
                            enumerable: !1,
                            configurable: !0,
                        }),
                        Object.defineProperty(e.prototype, 'updateState', {
                            ...
                            value: function (e) {
                                ...
                                try {
                                    ...
                                    var p = new M.t('YnisonStateController. Parsing error', { cause: T(e) });
                            ...
                            value: function (e) {
                                var t = this,
                                    ...
                                    a = (function (e, t, n) {
                                        ...
                                        var r = t.volume_info,
                                            i = n.volume_info,
                                            o = L(e, r.version, i.version);
                                        return {
                                            isVolumeChanged: U(r.volume, t.capabilities.volume_granularity) !== U(i.volume, n.capabilities.volume_granularity),
                                            isNewVersion: o,
                                        };
                                    })(void 0 !== r && r, i, o),
                                    s = a.isVolumeChanged,
                        ...
                        Object.defineProperty(e.prototype, 'calculateProgressMsDiff', {
                            ...
                            value: function (e) {
                                var t,
                                    ...
                                    l = s.progress_ms,
                                    c = L(void 0 !== i && i, s.version, a),
                                    u = (t = Number(o)) !== (n = Number(l)) && (n < 1500 || Math.abs(t - n) > R);
                                c &&
                                    u &&
                ...
                B = (function (e) {
                    function t(n, r) {
                        ...
                        var i = this,
                            ...
                            a = F(r, ['code']);
                        return (
                            Object.defineProperty((i = e.call(this, n, Y({ code: void 0 === o ? 'E_HUB_MESSAGE_EXCEPTION' : o }, a)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
                ...
                K = (function (e) {
                    function t(n, r) {
                        ...
                        var i = this,
                            ...
                            a = Z(r, ['code']);
                        return (
                            Object.defineProperty((i = e.call(this, n, W({ code: void 0 === o ? 'E_REDIRECTOR_EXCEPTION' : o }, a)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
                                                    ...
                                                    var v = new WebSocket(Object.values(t.connectionConfig).join(''), [
                                                        ...
                                                        b = function (e) {
                                                            try {
                                                                ...
                                                                'error' in t
                                                                    ? (v.close(), r(new K('Error message from redirector', { data: { redirectorResponse: t.error } })))
                                                                    : (v.close(), n(t));
                                                            } catch (e) {
                ...
                eo = (function (e) {
                    function t(n, r) {
                        ...
                        var i = this,
                            ...
                            a = ei(r, ['code']);
                        return (
                            Object.defineProperty((i = e.call(this, n, er({ code: void 0 === o ? 'E_HUB_CONNECTION_EXCEPTION' : o }, a)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
                ...
                el = (function () {
                    function e(e) {
                        Object.defineProperty(this, 'connectorConfig', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            Object.defineProperty(this, 'state', {
                                ...
                                configurable: !0,
                                writable: !0,
                                value: new q({ redirectorResponse: null, connectionState: b.DISCONNECTED }),
                            }),
                    ...
                    return (
                            ...
                            value: function (e) {
                                ...
                                void 0 !== n && (this.connectorConfig.oauth = n),
                                    ...
                                    [b.DISCONNECTED, b.READY_TO_RECONNECT].includes(this.state.connectionState.value) &&
                                        ...
                                        this.emitter.emit(h.NEW_CONNECTION_ATTEMPT, {}),
                                        this.redirectorSocket
                                            ...
                                            .catch(function (e) {
                                                ...
                                                if ((t.emitter.emit(h.CONNECTION_ERROR, { destination: E.REDIRECTOR, error: e, shouldReconnect: n }), n)) {
                                                    var r =
                                                        e.data.redirectorResponse.extra_headers && e.data.redirectorResponse.extra_headers[y.ynisonGoAwayForSeconds]
                            ...
                            value: function () {
                                ...
                                if (this.state.redirectorResponse.value) {
                                    var l,
                                        ...
                                        y,
                                        g,
                                        m = this.state.redirectorResponse.value.host,
                                        C =
                                            ...
                                            (y = l.redirect_ticket),
                                            (g = J(u)),
                                            ((c = {})[O.ynisonDeviceId] = d),
                                            (c[O.ynisonRedirectTicket] = y),
                            ...
                            value: function (e) {
                                try {
                                    ...
                                    if ('error' in t) {
                                        ...
                                        this.closeConnection(1e3, ''.concat(es, 'Error in message'));
                                        ...
                                        if ((this.emitter.emit(h.HUB_ERROR, { error: r, shouldReconnect: n }), n)) {
                                            var i = t.error.details[y.ynisonGoAwayForSeconds]
                                    ...
                                    this.emitter.emit(h.HUB_MESSAGE_PARSING_ERROR, { error: o });
                                }
                            },
                        }),
                        Object.defineProperty(e.prototype, 'sendRequest', {
                            ...
                            writable: !0,
                            value: function (e) {
                                null !== this.socket && this.socket.readyState === WebSocket.OPEN && this.state.connectionState.value === b.CONNECTED
                                    ? (this.socket.send(JSON.stringify(e)), this.emitter.emit(h.MESSAGE_SENT, e))
                                    : this.emitter.emit(h.MESSAGE_LOST, e);
                            },
                        }),
                        e
                    );
                ...
                ef = (function () {
                    function e(e) {
                        ...
                        (this.stateController = new k({ deviceConfig: this.deviceConfig })),
                            ...
                            this.connector.on(h.RECEIVE_MESSAGE, this.onMessageReceived.bind(this)),
                            ...
                            this.connector.on(h.CONNECTION_ERROR, function (e) {
                                t.logger.error('[Ynison] Connection error: '.concat(e.error.message), eu({}, e));
                            }),
                            this.connector.on(h.HUB_MESSAGE_PARSING_ERROR, function (e) {
                                t.logger.error('[Ynison] Hub message error: '.concat(e.error.message), eu({}, e));
                            }),
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'registerMetrics', {
                            ...
                            value: function () {
                                this.connector.on(h.NEW_CONNECTION_ATTEMPT, this.metricsController.onNewConnectionAttempt.bind(this.metricsController)),
                                    ...
                                    this.connector.on(h.HUB_MESSAGE_PARSING_ERROR, this.metricsController.onHubMessageParsingError.bind(this.metricsController)),
                        ...
                        Object.defineProperty(e.prototype, 'createActiveDeviceStateUpdate', {
                            ...
                            value: function (e) {
                                var t = P(e);
                                return (
                                    (t.player_state = P(this.stateController.currentState.player_state)), { newState: t, skipVersionCompare: !0, trigger: 'WSConnector' }
                                );
                            },
                        }),
                        Object.defineProperty(e.prototype, 'processOutgoingPlayerState', {
                            ...
                            writable: !0,
                            value: function (e) {
                                return eu(eu({}, e), { status: this.processOutgoingPlayerStatus(e.status) });
                            },
                        }),
                ...
                e_ = (function () {
                    ...
                    return (
                        Object.defineProperty(e.prototype, 'onYnisonStateParsingError', {
                            ...
                            value: function (e) {
                                this.sendEvent({
                                    name: g.YNISON_STATE_ERROR,
                                    data: ey(ey({}, this.getBaseEventPayload()), { errorType: S.OTHER, errorDescription: e.error.message }),
                                });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'onHubConnectionError', {
                            ...
                            writable: !0,
                            value: function (e) {
                                if (e.error.data.connectingState === b.CONNECTING)
                                    return void this.sendEvent({
                                        name: g.YNISON_CONNECTING_ERROR,
                                        data: ey(ey({}, this.getBaseEventPayload()), { destination: N.HUB, errorType: S.WS, errorDescription: e.error.message }),
                                    });
                                this.sendEvent({
                                    name: g.YNISON_CHANNEL_ERROR,
                                    data: ey(ey({}, this.getBaseEventPayload()), { errorType: S.WS, errorDescription: e.error.message }),
                                });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onHubError', {
                            ...
                            value: function (e) {
                                ...
                                this.sendEvent({
                                    name: g.YNISON_CHANNEL_ERROR,
                                    data: ey(ey({}, this.getBaseEventPayload()), { errorType: S.WS, code: n, errorDescription: ''.concat(r, ' ').concat(i) }),
                                });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'onDisconnectedByServer', {
                            ...
                            value: function (e) {
                                this.sendEvent({
                                    name: g.YNISON_CHANNEL_ERROR,
                                    data: ey(ey({}, this.getBaseEventPayload()), { errorType: S.SERVER, code: e.code, errorDescription: e.reason }),
                                });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onDisconnectedByClient', {
                            ...
                            writable: !0,
                            value: function (e) {
                                this.sendEvent({ name: g.YNISON_CLIENT_DISCONNECTED, data: ey(ey({}, this.getBaseEventPayload()), { reason: e.reason }) });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onMessageSent', {
                            enumerable: !1,
                            ...
                            value: function (e) {
                                ...
                                t && this.sendEvent({ name: g.YNISON_EVENT_SENDED, data: ey(ey({}, this.getBaseEventPayload()), { type: t }) });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onMessageLost', {
                            ...
                            value: function (e) {
                                var t = this.getMessageType(e);
                                t && this.sendEvent({ name: g.YNISON_EVENT_LOST, data: ey(ey({}, this.getBaseEventPayload()), { type: t }) });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'getBaseEventPayload', {
                            ...
                            value: function () {
                                var e = m.PASSIVE;
                                return (
                                    this.variables.isShadow ? (e = m.SHADOW) : this.variables.isActive && (e = m.ACTIVE),
                                    { uuid: this.state.uuid, puid: String(this.variables.puid), mode: e, connectionType: C.UNKNOWN }
                                );
                            },
                        }),
