    ...
    [819],
    {
        ...
        7541: (e, t, a) => {
            ...
            function o(e, t) {
                ...
                let o = a.clone();
                return o.headers.append('accept', 'msw/passthrough'), o;
            }
        },
        20253: (e, t, a) => {
            a.d(t, { L: () => O });
            var s = a(49809),
                o = ((e) => ((e.Success = '#69AB32'), (e.Warning = '#F0BB4B'), (e.Danger = '#E95F5D'), e))(o || {}),
                i = a(45029);
            async function r(e) {
                let t = e.clone(),
                    a = await t.text();
            ...
            let { message: n } = a(50706).A;
            async function l(e) {
                let t = e.clone(),
                    a = await t.text(),
                    s = t.status || 200,
                    o = t.statusText || n[s] || 'OK';
                return { status: s, statusText: o, headers: Object.fromEntries(t.headers.entries()), body: a };
            }
            var u = a(45100),
                c = a(5529),
                d = Object.create,
                ...
                k = ((e, t, a) =>
                    ((e, t, a, s) => {
                        if ((t && 'object' == typeof t) || 'function' == typeof t)
                            for (let a of p(t)) f.call(e, a) || void 0 === a || h(e, a, { get: () => t[a], enumerable: !(s = m(t, a)) || s.enumerable });
                        return e;
                        ...
                        'node_modules/.pnpm/cookie@1.0.2/node_modules/cookie/dist/index.js'(e) {
                            Object.defineProperty(e, '__esModule', { value: !0 }),
                                ...
                                (e.serialize = function (e, r, n) {
                                    ...
                                    let u = l(r);
                                    if (!a.test(u)) throw TypeError(`argument val is invalid: ${r}`);
                                    let c = e + '=' + u;
                                    if (!n) return c;
                                    if (void 0 !== n.maxAge) {
                                    ...
                                    if (n.domain) {
                                        if (!s.test(n.domain)) throw TypeError(`option domain is invalid: ${n.domain}`);
                                        c += '; Domain=' + n.domain;
                                    }
                                    if (n.path) {
                                    ...
                                    if (n.expires) {
                                        var d;
                                        if (((d = n.expires), '[object Date]' !== i.call(d) || !Number.isFinite(n.expires.valueOf())))
            ...
            class q extends E.w {
                constructor(e, t, a, s) {
                    let o = 'function' == typeof t ? '[custom predicate]' : t;
                    super({ info: { header: `${e}${o ? ` ${o}` : ''}`, path: t, method: e }, resolver: a, options: s }), this.checkRedundantQueryParameters();
                }
                ...
                async parse(e) {
                    let t = new URL(e.request.url),
                        a = (function (e) {
                            ...
                            for (let t in s) e.headers.append('cookie', v(t, s[t]));
                            let o = w.C.getCookies(e.url),
                                i = Object.fromEntries(o.map((e) => [e.key, e.value]));
                            for (let t of o) e.headers.append('cookie', t.toString());
                            return { ...s, ...i, ...a };
                        })(e.request);
                ...
                async log(e) {
                    ...
                    console.groupCollapsed(s.J.formatMessage(`${(0, i.l)()} ${e.request.method} ${a} (%c${n.status} ${n.statusText}%c)`), `color:${u}`, 'color:inherit'),
        ...
        28480: (e, t, a) => {
            ...
            var m = (0, s.S)(),
                p = class {
                    ...
                    logEntry(e) {
                        let { level: t, message: a, prefix: s, colors: o, positionals: i = [] } = e,
                            r = this.createEntry(t, a),
                            l = o?.timestamp || 'gray',
                            u = o?.prefix || 'gray',
                            c = { timestamp: n[l], prefix: n[u] };
                        this.getWriter(t)(
                            [c.timestamp(this.formatTimestamp(r.timestamp))]
                ...
                f = () => void 0;
            function k(e, ...t) {
                if (m) return void i.stdout.write((0, o.GP)(e, ...t) + '\n');
                console.log(e, ...t);
            }
            function b(e, ...t) {
                if (m) return void i.stderr.write((0, o.GP)(e, ...t) + '\n');
                console.warn(e, ...t);
            }
            function y(e, ...t) {
                if (m) return void i.stderr.write((0, o.GP)(e, ...t) + '\n');
            ...
            var z = class {
                ...
                dispose() {
                    ...
                    if ((this.clearInstance(), e.info('global symbol deleted:', S(this.symbol)), this.subscriptions.length > 0)) {
            ...
            function n(e, t, a) {
                ...
                let p = (function (e, t) {
                            ...
                            : (function (e, t, a) {
                                  ...
                                  for (
                                      var i = a.strict,
                                          ...
                                          d = a.delimiter,
                                          h = a.endsWith,
                                          m = '['.concat(s(void 0 === h ? '' : h), ']|$'),
                                          p = '['.concat(s(void 0 === d ? '/#?' : d), ']'),
                                          g = void 0 === n || n ? '^' : '',
                                          f = 0;
                                      f < e.length;
                                      f++
                                  ...
                                  if (void 0 === l || l) r || (g += ''.concat(p, '?')), (g += a.endsWith ? '(?='.concat(m, ')') : '$');
                                  else {
                                      var w = e[e.length - 1],
                                          x = 'string' == typeof w ? p.indexOf(w[w.length - 1]) > -1 : void 0 === w;
                                      r || (g += '(?:'.concat(p, '(?=').concat(m, '))?')), x || (g += '(?='.concat(p, '|').concat(m, ')'));
                                  }
                                  return new RegExp(g, o(a));
                              })(
                                  (function (e, t) {
                                      void 0 === t && (t = {});
                                      for (
                                          var a = (function (e) {
                                                  for (var t = [], a = 0; a < e.length; ) {
                                                      ...
                                                      if (':' === s) {
                                                          for (var o = '', i = a + 1; i < e.length; ) {
                                                              var r = e.charCodeAt(i);
                                                              if ((r >= 48 && r <= 57) || (r >= 65 && r <= 90) || (r >= 97 && r <= 122) || 95 === r) {
                                                                  o += e[i++];
                                                                  continue;
                                                              }
                                                              break;
                                                          }
                                                          if (!o) throw TypeError('Missing parameter name at '.concat(a));
                                                          t.push({ type: 'NAME', index: a, value: o }), (a = i);
                                                          continue;
                                                      }
                                                      if ('(' === s) {
                                                          var n = 1,
                    ...
                    function (e) {
                        var t = u.exec(e);
                        if (!t) return !1;
                        for (var a = t[0], s = t.index, o = Object.create(null), i = 1; i < t.length; i++)
                            !(function (e) {
                                if (void 0 !== t[e]) {
                                    var a = c[e - 1];
                                    '*' === a.modifier || '+' === a.modifier
                                        ? (o[a.name] = t[e].split(a.prefix + a.suffix).map(function (e) {
                                              return m(e, a);
                                          }))
                                        : (o[a.name] = m(t[e], a));
                                }
        ...
        49230: (e, t, a) => {
            a.d(t, { w: () => i });
            let s = /[/\\]msw[/\\]src[/\\](.+)/,
                o = /(node_modules)?[/\\]lib[/\\](core|browser|node|native|iife)[/\\]|^[^/\\]*$/;
            class i {
                ...
                async run(e) {
                    ...
                    let s = this.wrapResolver(this.resolver)({
                        ...
                        o = await s;
                    return this.createExecutionResult({ request: t, requestId: e.requestId, response: o, parsedResult: a });
                }
                wrapResolver(e) {
                    return async (t) => {
                        ...
                        this.isUsed = !1;
                        let { done: a, value: s } = await this.resolverIterator.next(),
                            o = await s;
                        return (o && (this.resolverIteratorResult = o.clone()), a) ? ((this.isUsed = !0), this.resolverIteratorResult?.clone()) : o;
                    };
                }
        ...
        50706: (e, t, a) => {
            ...
            var s = Object.create,
                ...
                d = ((e, t, a) =>
                    ((e, t, a, s) => {
                        if ((t && 'object' == typeof t) || 'function' == typeof t)
                            for (let a of r(t)) l.call(e, a) || void 0 === a || o(e, a, { get: () => t[a], enumerable: !(s = i(t, a)) || s.enumerable });
                        return e;
                    })(o((a = null != e ? s(n(e)) : {}), 'default', { value: e, enumerable: !0 }), e))(
                    u({
                        'node_modules/.pnpm/statuses@2.0.2/node_modules/statuses/index.js'(e, t) {
                            var a,
                                ...
                                o = c();
                            function i(e) {
                                if (!Object.prototype.hasOwnProperty.call(r.message, e)) throw Error('invalid status code: ' + e);
                                return r.message[e];
                            }
                            function r(e) {
                                ...
                                var a = e.toLowerCase();
                                if (!Object.prototype.hasOwnProperty.call(r.code, a)) throw Error('invalid status message: "' + e + '"');
                                return r.code[a];
                            }
                            (t.exports = r),
                                (r.message = o),
                                (s = {}),
                                Object.keys((a = o)).forEach(function (e) {
                                    var t = a[e],
                                        o = Number(e);
                                    s[t.toLowerCase()] = o;
                                }),
                                (r.code = s),
                                (r.codes = Object.keys(o).map(function (e) {
                                    return Number(e);
                                })),
        ...
        55498: (e, t, a) => {
            ...
            var n = class e extends Response {
                ...
                constructor(t, a = {}) {
                    let s = a.status ?? 200,
                        o = e.isConfigurableStatusCode(s) ? s : 200;
                    if ((super(e.isResponseWithBody(s) ? t : null, { status: o, statusText: a.statusText, headers: a.headers }), s !== o)) {
                        let e = r('state', this);
        ...
        56694: (e, t, a) => {
            ...
            function i(e, t) {
                ...
                if (!t) {
                    ...
                    if (47 === e.charCodeAt(a) && 47 === e.charCodeAt(a + 1)) a += 2;
                        ...
                        if (-1 !== t) {
                            let s = t - a,
                                ...
                                n = e.charCodeAt(a + 3),
                                l = e.charCodeAt(a + 4);
                            if (5 === s && 104 === o && 116 === i && 116 === r && 112 === n && 115 === l);
                            else if (4 === s && 104 === o && 116 === i && 116 === r && 112 === n);
                            else if (3 === s && 119 === o && 115 === i && 115 === r);
                            else if (2 === s && 119 === o && 115 === i);
                            else
                                for (let s = a; s < t; s += 1) {
                    ...
                    for (let n = a; n < s; n += 1) {
                        ...
                        64 === a ? (t = n) : 93 === a ? (i = n) : 58 === a ? (r = n) : a >= 65 && a <= 90 && (o = !0);
                    }
            ...
            function n(e) {
                if (e.length > 255 || 0 === e.length || (!r(e.charCodeAt(0)) && 46 !== e.charCodeAt(0) && 95 !== e.charCodeAt(0))) return !1;
                let t = -1,
                    a = -1,
                    s = e.length;
                for (let o = 0; o < s; o += 1) {
                    ...
                    if (46 === s) {
                        if (o - t > 64 || 46 === a || 45 === a || 95 === a) return !1;
                        t = o;
                    } else if (!(r(s) || 45 === s || 95 === s)) return !1;
                    a = s;
                }
            ...
            function l({
                ...
                return { allowIcannDomains: e, allowPrivateDomains: t, detectIp: a, extractHostname: s, mixedInputs: o, validHosts: i, validateHostname: r };
            }
            let u = l({}),
                c = (function () {
                    let e = [1, {}],
                ...
                d = (function () {
                    let e = [1, {}],
                        ...
                        n = [2, { id: t }],
                        l = [1, { gov: e }],
                        u = [0, { airflow: o, 'lambda-url': t, 'transfer-webapp': t }],
                        c = [0, { airflow: o, 'transfer-webapp': t }],
                        ...
                        T = [0, { s3: t, 's3-accesspoint': t, 's3-accesspoint-fips': t, 's3-fips': t, 's3-website': t }],
                        A = [
                            0,
                            {
                                'execute-api': t,
                        ...
                        0,
                        {
                            ...
                            at: [
                                1,
                                {
                                    ...
                                    or: e,
                                    funkfeuer: [0, { wien: t }],
                                    futurecms: [0, { '*': t, ex: o, in: o }],
                                    futurehosting: t,
                                    futuremailing: t,
                                    ortsinfo: [0, { ex: o, kunden: o }],
                                    biz: t,
                                    info: t,
                                    '123webseite': t,
                                    priv: t,
                                        ...
                                        1,
                                        {
                                            amazonaws: [
                                                0,
                                                {
                                                    ...
                                                    compute: o,
                                                    airflow: [0, { 'cn-north-1': o, 'cn-northwest-1': o }],
                            ...
                            com: [
                                1,
                                {
                                    ...
                                    'on-vapor': t,
                                    lpusercontent: t,
                                    linode: [0, { members: t, nodebalancer: o }],
                                    linodeobjects: o,
                                    ...
                                    orsites: t,
                                    operaunite: t,
                                    'customer-oci': [0, { '*': t, oci: o, ocp: o, ocs: o }],
                                    oraclecloudapps: o,
                                    oraclegovcloudapps: o,
                                    'authgear-staging': t,
                                    authgearapps: t,
                                    skygearapp: t,
                                    outsystemscloud: t,
                                    ...
                                    sakuraweb: t,
                                    x0: t,
                                    code: [0, { builder: o, 'dev-builder': o, 'stg-builder': o }],
                                    salesforce: [0, { platform: [0, { 'code-builder-stg': [0, { test: [0, { '001': o }] }] }] }],
                                    logoip: t,
                                    scrysec: t,
                                    'firewall-gateway': t,
                                    myshopblocks: t,
                            ...
                            cz: [
                                1,
                                {
                                    ...
                                    e4: t,
                                    co: t,
                                    metacentrum: [0, { cloud: o, custom: t }],
                            ...
                            eu: [1, { cloudns: t, prvw: t, dogado: [0, { jelastic: t }], barsy: t, spdns: t, nxa: o, directwp: t, transurl: o, diskstation: t }],
                            fi: [
                                1,
                                {
                                    aland: e,
                            ...
                            fk: b,
                            fm: [1, { com: e, edu: e, net: e, org: e, radio: t, user: o }],
                            fo: e,
                            fr: [
                                1,
                                {
                            ...
                            gf: e,
                            gg: [1, { co: e, net: e, org: e, ply: [0, { at: o, d6: t }], botdash: t, kaas: t, stackit: t, panel: [2, { daemon: t }] }],
                            ...
                            nl: [1, { co: t, 'hosting-cluster': t, gov: t, khplay: t, '123website': t, myspreadshop: t, transurl: o, cistron: t, demon: t }],
                            no: [
                                1,
                                {
                                    fhs: e,
                            ...
                            ru: [
                                1,
                                {
                                    ...
                                    na4u: t,
                                    mircloud: t,
                                    myjino: [2, { hosting: o, landing: o, spectrum: o, vps: o }],
                                    cldmail: [0, { hb: t }],
                                    mcdir: [2, { vps: t }],
                                    mcpre: t,
                                    net: t,
                            ...
                            va: e,
                            vc: [1, { com: e, edu: e, gov: e, mil: e, net: e, org: e, gv: [2, { d: t }], '0e': o, mydns: t }],
                            ve: [
                                1,
                                {
                                    arts: e,
                            ...
                            vu: G,
                            wf: [1, { biz: t, sch: t }],
                            ws: [1, { com: e, edu: e, gov: e, net: e, org: e, advisor: o, cloud66: t, dyndns: t, mypets: t }],
                            yt: [1, { org: t }],
                            'xn--mgbaam7a8h': e,
                            امارات: e,
                            'xn--y9a3aq': e,
                            ...
                            dev: [
                                1,
                                {
                                    ...
                                    crm: [0, { d: o, w: o, wa: o, wb: o, wc: o, wd: o, we: o, wf: o }],
                                    erp: J,
                                    vercel: t,
                                    webhare: o,
                                    hrsn: t,
                            ...
                            goo: e,
                            goodyear: e,
                            goog: [1, { cloud: t, translate: t, usercontent: o }],
                            google: e,
                            gop: e,
                            got: e,
                            grainger: e,
                            ...
                            limo: e,
                            lincoln: e,
                            link: [1, { myfritz: t, cyon: t, joinmc: t, dweb: o, inbrowser: o, nftstorage: es, mypep: t, storacha: es, w3s: es }],
                            live: [1, { aem: t, hlx: t, ewp: o }],
                            living: e,
                            llc: e,
                            llp: e,
                            loan: e,
                            ...
                            netbank: e,
                            netflix: e,
                            network: [1, { aem: t, alces: o, co: t, arvo: t, azimuth: t, tlon: t }],
                            neustar: e,
                            new: e,
                            news: [1, { noticeable: t }],
                            next: e,
                            ...
                            ollo: e,
                            omega: e,
                            one: [1, { kin: o, service: t, website: t }],
                            ong: [1, { obl: t }],
                            onl: e,
                            ...
                            'xn--zfr164b': e,
                            政务: e,
                            xyz: [1, { caffeine: t, botdash: t, telebit: o }],
                            yachts: e,
                            yahoo: e,
                            yamaxun: e,
                            yandex: e,
                            ...
                            zero: e,
                            zip: e,
                            zone: [1, { triton: o, stackit: t, lima: t }],
                            zuerich: e,
                        },
                    ];
                })();
            function h(e, t, a, s) {
                let o = null,
                    i = t;
                for (; void 0 !== i && ((i[0] & s) != 0 && (o = { index: a + 1, isIcann: 1 === i[0], isPrivate: 2 === i[0] }), -1 !== a); ) {
                    let t = i[1];
            ...
            function m(e, t, a) {
                    ...
                    (function (e, t, a) {
                        if (!t.allowPrivateDomains && e.length > 3) {
                            let t = e.length - 1,
                                ...
                                i = e.charCodeAt(t - 2),
                                r = e.charCodeAt(t - 3);
                            if (109 === s && 111 === o && 99 === i && 46 === r) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'com'), !0;
                            if (103 === s && 114 === o && 111 === i && 46 === r) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'org'), !0;
                            if (117 === s && 100 === o && 101 === i && 46 === r) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'edu'), !0;
                            else if (118 === s && 111 === o && 103 === i && 46 === r) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'gov'), !0;
                            else if (116 === s && 101 === o && 110 === i && 46 === r) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'net'), !0;
                            else if (101 === s && 100 === o && 46 === i) return (a.isIcann = !0), (a.isPrivate = !1), (a.publicSuffix = 'de'), !0;
                        }
                        return !1;
                    })(e, t, a)
                )
                ...
                let o = e.split('.'),
                    ...
                    r = h(o, c, o.length - 1, i);
                if (null !== r) {
                    (a.isIcann = r.isIcann), (a.isPrivate = r.isPrivate), (a.publicSuffix = o.slice(r.index + 1).join('.'));
                    return;
                }
                let n = h(o, d, o.length - 1, i);
                if (null !== n) {
                    (a.isIcann = n.isIcann), (a.isPrivate = n.isPrivate), (a.publicSuffix = o.slice(n.index).join('.'));
                    return;
                }
                (a.isIcann = !1), (a.isPrivate = !1), (a.publicSuffix = null != (s = o[o.length - 1]) ? s : null);
            }
                ...
                let c = (function (e, t = {}) {
                    return (
                        ...
                        (function (e, t, a, s, o) {
                            ...
                            if (
                                (p.extractHostname ? (p.mixedInputs ? (o.hostname = i(e, n(e))) : (o.hostname = i(e, !1))) : (o.hostname = e),
                                p.detectIp && null !== o.hostname) &&
                                ((o.isIp =
                                    (function (e) {
                                ...
                                return o;
                            return p.validateHostname && p.extractHostname && null !== o.hostname && !n(o.hostname)
                                ? ((o.hostname = null), o)
                                : null === o.hostname ||
                                    (a(o.hostname, p, o), null === o.publicSuffix) ||
                                    ((o.domain = (function (e, t, a) {
                                        ...
                                        let o = t.length - e.length - 2,
                                            i = t.lastIndexOf('.', o);
                                        return -1 === i ? t : t.slice(i + 1);
                                    })(o.publicSuffix, o.hostname, p)),
                                    3 === t || null === o.domain) ||
                                    ((c = o.hostname), (o.subdomain = (d = o.domain).length === c.length ? '' : c.slice(0, -d.length - 1)), 4 === t)
                                  ? o
                                  : ((h = o.domain), (m = o.publicSuffix), (o.domainWithoutSuffix = h.slice(0, -m.length - 1)), o);
                        })(e, 3, m, t, p).domain
                    );
            ...
            var E = class extends v {
                ...
                findCookie(e, t, a, s) {
                    let o = S(s);
                    if (null == e || null == t || null == a) return o.resolve(void 0);
                ...
                putCookie(e, t) {
                    let a = S(t),
                        { domain: s, path: o, key: i } = e;
                    if (null == s || null == o || null == i) return a.resolve(void 0);
                    let r = this.idx[s] ?? Object.create(null);
                    this.idx[s] = r;
                    let n = r[o] ?? Object.create(null);
                    return (r[o] = n), (n[i] = e), a.resolve(void 0);
                }
                updateCookie(e, t, a) {
                ...
                removeCookie(e, t, a, s) {
                    let o = S(s);
                    return delete this.idx[e]?.[t]?.[a], o.resolve(void 0);
                }
                removeCookies(e, t, a) {
                    let s = S(a),
                        o = this.idx[e];
                    return o && (t ? delete o[t] : delete this.idx[e]), s.resolve(void 0);
                }
                removeAllCookies(e) {
                    let t = S(e);
            ...
            var P = class extends Error {},
                T = { SILENT: 'silent', STRICT: 'strict', DISABLED: 'unsafe-disabled' };
            Object.freeze(T);
            var A = `
\\[?(?:
...
`
            ...
            var M = /[\x09\x20-\x2F\x3B-\x40\x5B-\x60\x7B-\x7E]/,
            ...
            function W(e, t, a, s) {
                ...
                if (!(o < t) && !(o > a) && (s || o == e.length)) return parseInt(e.slice(0, o), 10);
            }
            function U(e) {
                let t, a, s, o, i, r;
                if (!e) return;
                ...
                for (let e = 0; e < n.length; e++) {
                    ...
                    if (l.length) {
                        ...
                        if (void 0 === r) {
                            let e = W(l, 2, 4, !0);
                            void 0 !== e && ((r = e) >= 70 && r <= 99 ? (r += 1900) : r >= 0 && r <= 69 && (r += 2e3));
                        }
                    }
                }
                if (
                    ...
                    return new Date(Date.UTC(r, i, o, t, a, s));
            }
                        ...
                        return (function (e, t) {
                            ...
                            let a = (e = e.trim()).indexOf(';'),
                                s = (function (e, t) {
                                    ...
                                    if (t) 0 === o && (o = (e = e.substring(1)).indexOf('='));
                                    else if (o <= 0) return;
                                    if ((o <= 0 ? ((a = ''), (s = e.trim())) : ((a = e.slice(0, o).trim()), (s = e.slice(o + 1).trim())), G.test(a) || G.test(s))) return;
                                    let i = new X();
                                    return (i.key = a), (i.value = s), i;
                                })(-1 === a ? e : e.slice(0, a), t?.loose ?? !1);
                            if (!s) return;
                            if (-1 === a) return s;
                            let o = e.slice(a + 1).trim();
                            ...
                            for (; i.length; ) {
                                ...
                                let o = a.indexOf('=');
                                switch (
                                    (-1 === o ? ((e = a), (t = null)) : ((e = a.slice(0, o)), (t = a.slice(o + 1))), (e = e.trim().toLowerCase()), t && (t = t.trim()), e)
                                ) {
                                    case 'expires':
                                        if (t) {
                                            let e = U(t);
            ...
            function Q(e, t, a) {
                let s, o;
                if (null == e || null == t || (!1 !== a ? ((s = N(e)), (o = N(t))) : ((s = e), (o = t)), null == s || null == o)) return;
                if (s == o) return !0;
                let i = s.lastIndexOf(o);
                return !(i <= 0) && s.length === o.length + i && '.' === s.substring(i - 1, i) && !Y.test(s);
            }
            ...
            var ei = class e {
                constructor(e, t) {
                    'boolean' == typeof t && (t = { rejectPublicSuffixes: t }),
                        ...
                        (this.prefixSecurity = eo(t?.prefixSecurity ?? 'silent')),
                        (this.store = e ?? new E());
                }
                callSync(e) {
                    let t;
                ...
                setCookie(e, t, a, s) {
                    ...
                    let i = S(s),
                        r = i.callback;
                    try {
                        if (('string' == typeof t && L(z(t), s, j(a)), (o = ea(t)), 'function' == typeof t)) return i.reject(Error('No URL was specified'));
                        if (('function' == typeof a && (a = Z), L('function' == typeof r, r), !z(e) && !O(e) && e instanceof String && 0 == e.length))
                            return i.resolve(void 0);
                    } catch (e) {
                        return i.reject(e);
                    }
                    let n = N(o.hostname) ?? null,
                        l = a?.loose || this.enableLooseMode,
                        u = null;
                    if (a?.sameSiteContext && !(u = es(a.sameSiteContext))) return i.reject(Error(et));
                    ...
                    let d = this.prefixSecurity === T.SILENT;
                    if (this.prefixSecurity !== T.DISABLED) {
                        var h, m;
                        let t,
                            s = !1;
                        if (
                            ...
                            return a?.ignoreError || d ? i.resolve(void 0) : i.reject(Error(t));
                    }
                    let p = this.store;
                    return (
                        p.updateCookie ||
                        ...
                        p.findCookie(e.domain, e.path, e.key, function (t, s) {
                            ...
                            let o = function (t) {
                                t ? r(t) : 'string' == typeof e ? r(null, void 0) : r(null, e);
                            };
                            if (s) {
                                if (a && 'http' in a && !1 === a.http && s.httpOnly) {
                                    (t = Error("old Cookie is HttpOnly and this isn't an HTTP API")), a.ignoreError ? r(null, void 0) : r(t);
                                    return;
                                }
                                e instanceof X && ((e.creation = s.creation), (e.creationIndex = s.creationIndex), (e.lastAccessed = c), p.updateCookie(s, e, o));
                            } else e instanceof X && ((e.creation = e.lastAccessed = c), p.putCookie(e, o));
                        }),
                        i.promise
                    );
                }
                ...
                getCookies(e, t, a) {
                    ...
                    let o = S(a),
                        i = o.callback;
                    try {
                        'string' == typeof e && L(z(e), i, e), (s = ea(e)), L(O(t), i, j(t)), L('function' == typeof i, i);
                    } catch (e) {
                        return o.reject(e);
                    }
                    let r = N(s.hostname),
                        ...
                        l = (function (e, t = !0) {
                            ...
                            let s = a.protocol.replace(':', '').toLowerCase(),
                                o = ((i = a.hostname).length >= 2 && i.startsWith('[') && i.endsWith(']') ? i.substring(1, i.length - 1) : i).replace(/\.+$/, '');
                            ...
                            if (R.test(o)) return '::1' === o;
                            let r = o.toLowerCase();
                            return 'localhost' === r || r.endsWith('.localhost');
                        })(e, this.allowSecureOnLocal),
                        u = 0;
                    if (t.sameSiteContext) {
                        let e = es(t.sameSiteContext);
                        if (null == e || !(u = X.sameSiteLevel[e])) return o.reject(Error(et));
                    }
                    let c = t.http ?? !0,
                        d = Date.now(),
                        h = t.expire ?? !0,
                    ...
                    function f(e) {
                        if (e.hostOnly) {
                            if (e.domain != r) return !1;
                        } else if (!Q(r ?? void 0, e.domain ?? void 0, !1)) return !1;
                    ...
                    return (
                        p.findCookies(r, m ? null : n, this.allowSpecialUseDomain, (e, a) => {
                ...
                serialize(e) {
                    ...
                    let s = {
                        ...
                        prefixSecurity: eo(this.prefixSecurity),
                        cookies: [],
                    };
                ...
                _importCookies(e, t) {
                    ...
                    let s = (e) => {
                        ...
                        if (Array.isArray(a)) {
                            ...
                            try {
                                o = X.fromJSON(a.shift());
                            } catch (e) {
                                t(e instanceof Error ? e : Error(), void 0);
                                return;
                            }
                            if (void 0 === o) return void s(null);
                            this.store.putCookie(o, s);
                        }
                    };
                    s(null);
                }
                ...
                clone(t, a) {
                    ...
                    let s = S(a),
                        o = s.callback;
                    return this.serialize((a, i) => (a ? s.reject(a) : e.deserialize(i ?? '', t, o))), s.promise;
                }
                _cloneSync(e) {
                        ...
                        'function' == typeof s.removeAllCookies && s.removeAllCookies !== v.prototype.removeAllCookies
                            ...
                            : s.getAllCookies((e, t) => {
                                  ...
                                  let o = 0,
                                      i = [],
                                      r = function (e) {
                                          if ((e && i.push(e), ++o === t.length)) return void (i[0] ? a(i[0]) : a(null, void 0));
                                      };
                                  t.forEach((e) => {
                                      s.removeCookie(e.domain, e.path, e.key, r);
                                  });
                              }),
                        t.promise
                    );
                ...
                static deserialize(t, a, s) {
                    ...
                    let r = (e) => (o && 'object' == typeof o && e in o ? o[e] : void 0),
                        n = (e) => {
                            let t = r(e);
                ...
                static deserializeSync(t, a) {
                    let s = 'string' == typeof t ? JSON.parse(t) : t,
                        o = (e) => (s && 'object' == typeof s && e in s ? s[e] : void 0),
                        i = (e) => {
                            let t = o(e);
                            return 'boolean' == typeof t ? t : void 0;
                        },
                    ...
                    if (!r.store.synchronous) throw Error('CookieJar store is not synchronous; use async API instead.');
                    return r._importCookiesSync(s), r;
                }
                static fromJSON(t, a) {
            ...
            class er {
                ...
                constructor() {
                    (0, s.S)() ||
                        ...
                        (this.#s = new E()),
                        (this.#s.idx = this.getCookieStoreIndex()),
                        (this.#a = new ei(this.#s));
                }
                getCookies(e) {
                ...
                getCookieStoreIndex() {
                    ...
                    let e = localStorage.getItem(this.#t);
                    if (null == e) return {};
                    let t = (function (e) {
                        try {
                            return JSON.parse(e);
                ...
                persist() {
                    ...
                    let e = [],
                        { idx: t } = this.#s;
                    for (let a in t) for (let s in t[a]) for (let o in t[a][s]) e.push(t[a][s][o].toJSON());
                    localStorage.setItem(this.#t, JSON.stringify(e));
                }
            }
            let en = new er();
        },
        71642: (e, t, a) => {
            ...
            var s = class extends Promise {
                ...
                then(e, t) {
                    return this.#i(super.then(e, t));
                }
                catch(e) {
                    return this.#i(super.catch(e));
                }
                finally(e) {
                    return this.#i(super.finally(e));
                }
                #i(e) {
        ...
        80776: (e, t, a) => {
            ...
            var s,
                ...
                m = ((e, t, a) => (
                    ...
                    ((e, t, a, s) => {
                        if ((t && 'object' == typeof t) || 'function' == typeof t)
                            for (let a of c(t)) h.call(e, a) || void 0 === a || l(e, a, { get: () => t[a], enumerable: !(s = u(t, a)) || s.enumerable });
                        return e;
                        ...
                        'node_modules/set-cookie-parser/lib/set-cookie.js'(e, t) {
                            ...
                            function o(e, t) {
                                var o,
                                    ...
                                    u =
                                        ...
                                        (i = ''),
                                        (r = ''),
                                        (n = o.split('=')).length > 1 ? ((i = n.shift()), (r = n.join('='))) : (r = o),
                                        { name: i, value: r }),
                                    c = u.name,
                                    d = u.value;
                                ...
                                return (
                                    l.forEach(function (e) {
                                        var t = e.split('='),
                                            ...
                                            s = t.join('=');
                                        'expires' === a
                                            ? (h.expires = new Date(s))
                                            : 'max-age' === a
                                              ? (h.maxAge = parseInt(s, 10))
                                              : 'secure' === a
                                                ? (h.secure = !0)
                                                : 'httponly' === a
                                                  ? (h.httpOnly = !0)
                            ...
                            function i(e, t) {
                                ...
                                return (Array.isArray(e) || (e = [e]), (t = t ? Object.assign({}, a, t) : a).map)
                                    ? e.filter(s).reduce(function (e, a) {
                                          var s = o(a, t);
                                          return (e[s.name] = s), e;
                                      }, {})
                            ...
                            (t.exports = i),
                                ...
                                (t.exports.splitCookiesString = function (e) {
                                    ...
                                    for (; n < e.length; ) {
                                        for (t = n, i = !1; l(); )
                                            if (',' === (a = e.charAt(n))) {
                                                for (s = n, n += 1, l(), o = n; n < e.length && '=' !== (a = e.charAt(n)) && ';' !== a && ',' !== a; ) n += 1;
                                                n < e.length && '=' === e.charAt(n) ? ((i = !0), (n = o), r.push(e.substring(t, s)), (t = n)) : (n = s + 1);
                                            } else n += 1;
                                        (!i || n >= e.length) && r.push(e.substring(t, e.length));
                                    }
                                    return r;
                                });
                        },
            ...
            var w = Symbol('normalizedHeaders'),
                ...
                j = class e {
                    ...
                    [((s = w), (o = x), (i = Symbol.toStringTag), Symbol.iterator)]() {
                        return this.entries();
                    }
                    *keys() {
                    ...
                    *entries() {
                    ...
                    set(e, t) {
                        ...
                        let a = g(e),
                            s = b(t);
                        (this[w][a] = b(s)), this[x].set(a, e);
                    }
                    append(e, t) {
                        if (!y(e) || !v(t)) return;
                        let a = g(e),
                            s = b(t),
                            o = this.has(a) ? `${this.get(a)}, ${s}` : s;
                        this.set(e, o);
                    }
                    delete(e) {
            ...
            function z(e = {}) {
                ...
                return { ...e, headers: s, status: t, statusText: a };
            }
            function q(e, t) {
        ...
        99524: (e, t, a) => {
            ...
            let r = async ({ request: e, requestId: t, handlers: a, resolutionContext: s }) => {
                let o = null,
                    i = null;
                for (let r of a) if ((null !== (i = await r.run({ request: e, requestId: t, resolutionContext: s })) && (o = r), i?.response)) break;
                return o ? { handler: o, parsedResult: i?.parsedResult, response: i?.response } : null;
            };
            var n = a(5529);
            async function l(e, t = 'warn') {
                let a = new URL(e.url),
                    o = (0, n.e)(a) + a.search,
                    i = 'HEAD' === e.method || 'GET' === e.method ? null : await e.clone().text(),
                    r = `
...
`
        : ''
                    ...
                    u = `intercepted a request without a matching request handler:${r}If you still wish to intercept this unhandled request, please create a request handler for it.
Read more: https://mswjs.io/docs/http/intercepting-requests`;
                function c(e) {
                    switch (e) {
                        case 'error':
                            throw (
                                (s.J.error('Error: %s', u),
                                new s.G(s.J.formatMessage('Cannot bypass a request when using the "error" strategy for the "onUnhandledRequest" option.')))
                            );
                        case 'warn':
                            s.J.warn('Warning: %s', u);
                            break;
                        case 'bypass':
                            break;
                        default:
                ...
                if ('function' == typeof t) return void t(e, { warning: c.bind(null, 'warn'), error: c.bind(null, 'error') });
                !(function (e) {
                    let t = new URL(e.url);
                    return (
            ...
            async function d(e, t) {
                let a = Reflect.get(t, c.sz);
                a && (await u.C.setCookie(a, e.url));
            }
            async function h(e, t, a, s, o, n) {
                if ((o.emit('request:start', { request: e, requestId: t }), e.headers.get('accept')?.includes('msw/passthrough'))) {
                    o.emit('request:end', { request: e, requestId: t }), n?.onPassthroughResponse?.(e);
                    return;
                }
                let [u, c] = await i(() => r({ request: e, requestId: t, handlers: a, resolutionContext: n?.resolutionContext }));
                if (u) throw (o.emit('unhandledException', { error: u, request: e, requestId: t }), u);
                if (!c) {
                    await l(e, s.onUnhandledRequest),
                        o.emit('request:unhandled', { request: e, requestId: t }),
                        o.emit('request:end', { request: e, requestId: t }),
                        n?.onPassthroughResponse?.(e);
                    return;
                }
                let { response: h } = c;
                if (!h || (302 === h.status && 'passthrough' === h.headers.get('x-msw-intention'))) {
                    o.emit('request:end', { request: e, requestId: t }), n?.onPassthroughResponse?.(e);
                    return;
                }
                return (
                    await d(e, h),
                    o.emit('request:match', { request: e, requestId: t }),
                    n?.onMockedResponse?.(h, c),
                    o.emit('request:end', { request: e, requestId: t }),
                    h
                );
            }
                ...
                constructor(...e) {
                    super(),
                        (0, p.V1)(
                            ...
                            s.J.formatMessage('Failed to apply given request handlers: invalid input. Did you forget to spread the request handlers Array?'),
                        ),
                        (this.handlersController = new k(e)),
                        (this.emitter = new g.v()),
                        (this.publicEmitter = new g.v()),
                        (function (e, t) {
                            let a = e.emit;
                            if (a._isPiped) return;
                            let s = function (e, ...s) {
                                return t.emit(e, ...s), a.call(this, e, ...s);
                            };
            ...
            let S = Symbol('kCancelable'),
                E = Symbol('kDefaultPrevented');
            var z = class extends MessageEvent {
                    constructor(e, t) {
                        super(e, t), (this[S] = !!t.cancelable), (this[E] = !1);
                    }
                    get cancelable() {
                        return this[S];
                    }
                    ...
                    preventDefault() {
                        this.cancelable && !this[E] && (this[E] = !0);
                    }
                },
                q = class extends Event {
                    constructor(e, t = {}) {
                        super(e, t),
            ...
            var P = class {
                constructor(e, t) {
                    (this.socket = e),
                        ...
                        (this[O] = new EventTarget()),
                        this.transport.addEventListener('outgoing', (e) => {
                            let t = j(this.socket, new z('message', { data: e.data, origin: e.origin, cancelable: !0 }));
                            this[O].dispatchEvent(t), t.defaultPrevented && e.preventDefault();
                        }),
                        this.transport.addEventListener('close', (e) => {
                            this[O].dispatchEvent(j(this.socket, new q('close', e)));
                        });
                }
                addEventListener(e, t, a) {
                    ...
                    this[O].addEventListener(e, Reflect.get(t, L), a);
                }
                removeEventListener(e, t, a) {
                    this[O].removeEventListener(e, Reflect.get(t, L), a);
                }
                send(e) {
            ...
            let T = 'InvalidAccessError: close code out of user configurable range',
                A = Symbol('kPassthroughPromise'),
                R = Symbol('kOnSend'),
                I = Symbol('kClose');
            var D = class extends EventTarget {
                    ...
                    super(),
                        ...
                        queueMicrotask(async () => {
                            (await this[A]) ||
                                ...
                                this.readyState === this.CONNECTING && ((this.readyState = this.OPEN), this.dispatchEvent(j(this, new Event('open')))));
                        });
                }
                set onopen(e) {
                ...
                send(e) {
                    ...
                    this.readyState !== this.CLOSING &&
                        ...
                        queueMicrotask(() => {
                            (this.bufferedAmount = 0), this[R]?.(e);
                        }));
                }
                close(e = 1e3, t) {
                    (0, p.V1)(e, T), (0, p.V1)(1e3 === e || (e >= 3e3 && e <= 4999), T), this[I](e, t);
                }
                [I](e = 1e3, t, a = !0) {
                    this.readyState !== this.CLOSING &&
                        this.readyState !== this.CLOSED &&
                        ...
                        queueMicrotask(() => {
                            (this.readyState = this.CLOSED),
                                this.dispatchEvent(j(this, new q('close', { code: e, reason: t, wasClean: a }))),
                                (this._onopen = null),
                                (this._onmessage = null),
                                (this._onerror = null),
                                (this._onclose = null);
            ...
            let N = Symbol('kEmitter'),
                M = Symbol('kBoundListener'),
                $ = Symbol('kSend');
            var W = class {
                    constructor(e, t, a) {
                        (this.client = e),
                            ...
                            (this[N] = new EventTarget()),
                            (this.mockCloseController = new AbortController()),
                            (this.realCloseController = new AbortController()),
                            this.transport.addEventListener('outgoing', (e) => {
                                void 0 !== this.realWebSocket &&
                                    queueMicrotask(() => {
                                        e.defaultPrevented || this[$](e.data);
                                    });
                            }),
                    ...
                    connect() {
                        ...
                        (e.binaryType = this.client.binaryType),
                            e.addEventListener(
                                'open',
                                (e) => {
                                    this[N].dispatchEvent(j(this.realWebSocket, new Event('open', e)));
                                },
                                { once: !0 },
                            ),
                            e.addEventListener('message', (e) => {
                                this.transport.dispatchEvent(j(this.realWebSocket, new MessageEvent('incoming', { data: e.data, origin: e.origin })));
                            }),
                            ...
                            e.addEventListener('error', () => {
                                ...
                                this[N].dispatchEvent(t), t.defaultPrevented || this.client.dispatchEvent(j(this.client, new Event('error')));
                            }),
                    ...
                    addEventListener(e, t, a) {
                        if (!Reflect.has(t, M)) {
                            ...
                            Object.defineProperty(t, M, { value: e, enumerable: !1 });
                        }
                        this[N].addEventListener(e, Reflect.get(t, M), a);
                    }
                    removeEventListener(e, t, a) {
                        this[N].removeEventListener(e, Reflect.get(t, M), a);
                    }
                    send(e) {
                        this[$](e);
                    }
                    ...
                    close() {
                        ...
                        (0, p.V1)(
                            ...
                            e.readyState !== WebSocket.CLOSING &&
                                ...
                                (e.close(),
                                queueMicrotask(() => {
                                    this[N].dispatchEvent(j(this.realWebSocket, new C('close', { code: 1e3, cancelable: !0 })));
                                }));
                    }
                    handleIncomingMessage(e) {
                        let t = j(e.target, new z('message', { data: e.data, origin: e.origin, cancelable: !0 }));
                        this[N].dispatchEvent(t),
                            t.defaultPrevented || this.client.dispatchEvent(j(this.client, new MessageEvent('message', { data: e.data, origin: e.origin })));
                    }
                    handleMockClose(e) {
                    ...
                    handleRealClose(e) {
                        ...
                        let t = j(this.realWebSocket, new C('close', { code: e.code, reason: e.reason, wasClean: e.wasClean, cancelable: !0 }));
                        this[N].dispatchEvent(t), t.defaultPrevented || this.client[I](e.code, e.reason);
                    }
                },
                U = class extends EventTarget {
                    constructor(e) {
                        super(),
                            ...
                            this.socket.addEventListener('close', (e) => {
                                this.dispatchEvent(j(this.socket, new q('close', e)));
                            }),
                            (this.socket[R] = (e) => {
                                this.dispatchEvent(j(this.socket, new z('outgoing', { data: e, origin: this.socket.url, cancelable: !0 })));
                            });
                    }
                    addEventListener(e, t, a) {
                        return super.addEventListener(e, t, a);
                    ...
                    send(e) {
                        queueMicrotask(() => {
                            ...
                            let t = () => {
                                this.socket.dispatchEvent(j(this.socket, new MessageEvent('message', { data: e, origin: this.socket.url })));
                            };
                                ...
                                return (
                                    queueMicrotask(async () => {
                                        try {
                                            ...
                                            await w(this.emitter, 'connection', { client: new P(r, n), server: e, info: { protocols: o } }),
                                                t
                                                    ? r[A].resolve(!1)
                                                    : (r[A].resolve(!0),
                                                      e.connect(),
                                                      e.addEventListener('open', () => {
                                                          r.dispatchEvent(j(r, new Event('open'))), e.realWebSocket && (r.protocol = e.realWebSocket.protocol);
                                                      }));
                                        } catch (e) {
                                            e instanceof Error &&
                                                (r.dispatchEvent(new Event('error')),
                                                r.readyState !== WebSocket.CLOSING && r.readyState !== WebSocket.CLOSED && r[I](1011, e.message, !1),
                                                console.error(e));
                                        }
                                    }),
                                    r
            ...
            var _ = a(45029);
            function G(e) {
                return e instanceof Blob ? e.size : y(e) && 'byteLength' in e ? e.byteLength : new Blob([e]).size;
            }
            function F(e) {
            ...
            async function B(e) {
                ...
                if (y(e)) {
                    ...
                    return `ArrayBuffer(${F(t)})`;
                }
                return F(e);
            }
            let J = { system: '#3b82f6', outgoing: '#22c55e', incoming: '#ef4444', mocked: '#ff6a33' };
            async function V(e) {
                let t = G(e.data),
                    a = await B(e.data),
                    o = e.defaultPrevented ? '⇡' : '⬆';
                console.groupCollapsed(
                    s.J.formatMessage(`${(0, _.l)({ milliseconds: !0 })} %c${o}%c ${a} %c${t}%c`),
                    `color:${J.outgoing}`,
                    'color:inherit',
            ...
            async function X(e) {
                let t = G(e.data),
                    a = await B(e.data);
                console.groupCollapsed(
                    s.J.formatMessage(`${(0, _.l)({ milliseconds: !0 })} %c\u2B06%c ${a} %c${t}%c`),
                    `color:${J.mocked}`,
                    'color:inherit',
                    'color:gray;font-weight:normal',
                    'color:inherit;font-weight:inherit',
            ...
            var et = class extends Error {
                ...
                ea = (e, t, ...a) => {
                    if (!e) throw new et(t, ...a);
                };
            function es() {
                if ('undefined' != typeof navigator && 'ReactNative' === navigator.product) return !0;
                if (void 0 !== Q) {
                    let e = Q.type;
                    return 'renderer' !== e && 'worker' !== e && !!(Q.versions && Q.versions.node);
                }
                return !1;
            }
            ea.as = (e, t, a, ...s) => {
                if (!t) {
                    let t,
                        o = 0 === s.length ? a : ee(a, ...s);
                    try {
                        t = Reflect.construct(e, [o]);
                    } catch (a) {
                        t = e(o);
                    }
                    throw t;
            ...
            var el = async (e, t = {}, a) => {
                let o = new URL(e, location.href).href,
                    i = await navigator.serviceWorker.getRegistrations().then((e) => e.filter((e) => en(e, o, a)));
                !navigator.serviceWorker.controller && i.length > 0 && location.reload();
                let [r] = i;
                if (r) return r.update(), [en(r, o, a), r];
                let [n, l] = await er(async () => {
...
Learn more about creating the Service Worker script: https://mswjs.io/docs/cli/init`),
                    ...
                    throw Error(s.J.formatMessage('Failed to register the Service Worker:\n\n%s', n.message));
                }
                return l;
            };
            function eu(e = {}) {
                ...
                console.groupCollapsed(`%c${s.J.formatMessage(t)}`, 'color:orangered;font-weight:bold;'),
            ...
            var eh = (function () {
                ...
                em = Symbol('isPatchedModule'),
                ep = class e extends Error {
                    constructor(t) {
                        super(t), (this.name = 'InterceptorError'), Object.setPrototypeOf(this, e.prototype);
                    }
                },
                eg = class e {
                    ...
                    constructor(t, a) {
                        (this.request = t), (this.source = a), (this.readyState = e.PENDING), (this.handled = new eo());
                    }
                    get #e() {
                        return this.handled;
                    }
            ...
            var eb = class e extends Response {
                    static {
                        this.STATUS_CODES_WITHOUT_BODY = [101, 103, 204, 205, 304];
                    }
                    static {
            ...
            ((e, t) => {
                for (var a in t) ew(e, a, { get: t[a], enumerable: !0 });
            })(ex, { blue: () => eS, gray: () => eE, green: () => eq, red: () => ez, yellow: () => ej });
            var eC = es(),
                eO = class {
                    constructor(e) {
                        (this.name = e), (this.prefix = `[${this.name}]`);
                        let t = eI('DEBUG'),
                            a = eI('LOG_LEVEL');
                        '1' === t || 'true' === t || (void 0 !== t && this.name.startsWith(t))
                            ? ((this.debug = eD(a, 'debug') ? eP : this.debug),
                              (this.info = eD(a, 'info') ? eP : this.info),
                              (this.success = eD(a, 'success') ? eP : this.success),
                              (this.warning = eD(a, 'warning') ? eP : this.warning),
                              (this.error = eD(a, 'error') ? eP : this.error))
                            : ((this.info = eP), (this.success = eP), (this.warning = eP), (this.error = eP), (this.only = eP));
                    }
                    prefix;
                    extend(e) {
                        return new eO(`${this.name}:${e}`);
                    }
                    debug(e, ...t) {
                        this.logEntry({ level: 'debug', message: eE(e), positionals: t, prefix: this.prefix, colors: { prefix: 'gray' } });
                    }
                    info(e, ...t) {
                        this.logEntry({ level: 'info', message: e, positionals: t, prefix: this.prefix, colors: { prefix: 'blue' } });
                        let a = new eL();
                    ...
                    logEntry(e) {
                        let { level: t, message: a, prefix: s, colors: o, positionals: i = [] } = e,
                            ...
                            n = o?.timestamp || 'gray',
                            l = o?.prefix || 'gray',
                            u = { timestamp: ex[n], prefix: ex[l] };
                        this.getWriter(t)(
                            [u.timestamp(this.formatTimestamp(r.timestamp))]
                ...
                eP = () => void 0;
            function eT(e, ...t) {
                if (eC) return void Q.stdout.write(ee(e, ...t) + '\n');
                console.log(e, ...t);
            }
            function eA(e, ...t) {
                if (eC) return void Q.stderr.write(ee(e, ...t) + '\n');
                console.warn(e, ...t);
            }
            function eR(e, ...t) {
                if (eC) return void Q.stderr.write(ee(e, ...t) + '\n');
            ...
            function eI(e) {
                return eC ? Q.env[e] : globalThis[e]?.toString();
            }
            function eD(e, t) {
                return void 0 !== e && e !== t;
            }
            ...
            var eM = class extends Error {
                ...
                e$ = class {
                    ...
                    constructor() {
                        (this.events = new Map()), (this.maxListeners = e$.defaultMaxListeners), (this.hasWarnedAboutPotentialMemoryLeak = !1);
                    }
                    ...
                    addListener(e, t) {
                        ...
                        return (
                            ...
                            this.maxListeners > 0 &&
                                ...
                                ((this.hasWarnedAboutPotentialMemoryLeak = !0), console.warn(new eM(this, e, this.listenerCount(e)))),
                            this
                        );
                    }
                    on(e, t) {
            ...
            var eU = (function (e) {
                ...
                eH = class {
                    constructor(e) {
                        (this.symbol = e),
                            (this.readyState = eU.INACTIVE),
                            (this.emitter = new e$()),
                            (this.subscriptions = []),
                            (this.logger = new eO(e.description)),
                            this.emitter.setMaxListeners(0),
                            this.logger.info('constructing the interceptor...');
                    }
                    checkEnvironment() {
                    ...
                    apply() {
                        let e = this.logger.extend('apply');
                        if ((e.info('applying the interceptor...'), this.readyState === eU.APPLIED)) return void e.info('intercepted already applied!');
                        if (!this.checkEnvironment()) return void e.info('the interceptor cannot be applied in this environment!');
                        this.readyState = eU.APPLYING;
                        let t = this.getInstance();
                        if (t) {
                            e.info('found a running instance, reusing...'),
                                (this.on = (a, s) => (
                                ...
                                (this.readyState = eU.APPLIED);
                            return;
                        }
                        e.info('no running instance found, setting up a new instance...'), this.setup(), this.setInstance(), (this.readyState = eU.APPLIED);
                    }
                    setup() {}
                    on(e, t) {
                        let a = this.logger.extend('on');
                        return (
                            this.readyState === eU.DISPOSING || this.readyState === eU.DISPOSED
                                ? a.info('cannot listen to events, already disposed!')
                                : (a.info('adding "%s" event listener:', e, t), this.emitter.on(e, t)),
                            this
                        );
                    ...
                    dispose() {
                        let e = this.logger.extend('dispose');
                        if (this.readyState === eU.DISPOSED) return void e.info('cannot dispose, already disposed!');
                        if ((e.info('disposing the interceptor...'), (this.readyState = eU.DISPOSING), !this.getInstance()))
                            return void e.info('no interceptors running, skipping dispose...');
                        if ((this.clearInstance(), e.info('global symbol deleted:', eW(this.symbol)), this.subscriptions.length > 0)) {
                            for (let t of (e.info('disposing of %d subscriptions...', this.subscriptions.length), this.subscriptions)) t();
                            (this.subscriptions = []), e.info('disposed of all subscriptions!', this.subscriptions.length);
                        }
                        this.emitter.removeAllListeners(), e.info('destroyed the listener!'), (this.readyState = eU.DISPOSED);
                    }
                    getInstance() {
                        let e = eW(this.symbol);
                        return this.logger.info('retrieved global instance:', e?.constructor?.name), e;
                    }
                    setInstance() {
                        var e;
            ...
            var eG = new TextEncoder(),
                ...
                eB = class {
                    ...
                    #n;
                    constructor() {
                        (this.#r = []), (this.#n = new Map());
                    }
                    get [Symbol.iterator]() {
                        return this.#r[Symbol.iterator].bind(this.#r);
                    }
                    entries() {
                    ...
                    getAll() {
                        return this.#r.map(([, e]) => e);
                    }
                    append(e, t) {
                        this.#r.push([e, t]), this.#l(e, (e) => e.push(t));
                    }
                    prepend(e, t) {
                        this.#r.unshift([e, t]), this.#l(e, (e) => e.unshift(t));
                    }
                    delete(e, t) {
                        if (0 !== this.size)
                            for (let [a, s] of ((this.#r = this.#r.filter((e) => e[1] !== t)), this.#n)) a === e && s.includes(t) && s.splice(s.indexOf(t), 1);
                    }
                    deleteAll(e) {
                        0 !== this.size && ((this.#r = this.#r.filter((t) => t[0] !== e)), this.#n.delete(e));
                    }
                    get size() {
                        return this.#r.length;
                    }
                    clear() {
                        0 !== this.size && ((this.#r.length = 0), this.#n.clear());
                    }
                    #l(e, t) {
                        t(this.#n.get(e) || this.#n.set(e, []).get(e));
                    }
                },
                eJ = Symbol('kDefaultPrevented'),
                eV = Symbol('kPropagationStopped'),
                eX = Symbol('kImmediatePropagationStopped'),
                eK = class extends MessageEvent {
                    #u;
                    [eJ];
                    [eV];
                    [eX];
                    constructor(...e) {
                        super(e[0], e[1]), (this[eJ] = !1);
                    }
                    get defaultPrevented() {
                        return this[eJ];
                    }
                    preventDefault() {
                        super.preventDefault(), (this[eJ] = !0);
                    }
                    stopImmediatePropagation() {
                        super.stopImmediatePropagation(), (this[eX] = !0);
                    }
                },
                eY = Symbol('kListenerOptions'),
                eQ = class {
                    #c;
                    constructor() {
                        this.#c = new eB();
                    ...
                    on(e, t, a) {
                        return this.#d(e, t, a), this;
                    }
                    once(e, t, a) {
                        return this.on(e, t, { ...(a || {}), once: !0 });
                    }
                    earlyOn(e, t, a) {
                        return this.#d(e, t, a, 'prepend'), this;
                    }
                    earlyOnce(e, t, a) {
                        return this.earlyOn(e, t, { ...(a || {}), once: !0 });
                    }
                    emit(e) {
                        if (0 === this.#c.size) return !1;
                        let t = this.listenerCount(e.type) > 0,
                            a = this.#h(e);
                        for (let t of this.#m(e.type)) {
                            if (null != a.event[eV] && a.event[eV] !== this) return a.revoke(), !1;
                            if (a.event[eX]) break;
                            this.#p(a.event, t);
                        }
                        return a.revoke(), t;
                    ...
                    async emitAsPromise(e) {
                        if (0 === this.#c.size) return [];
                        let t = [],
                            a = this.#h(e);
                        for (let s of this.#m(e.type)) {
                            if (null != a.event[eV] && a.event[eV] !== this) return a.revoke(), [];
                            if (a.event[eX]) break;
                            let e = await Promise.resolve(this.#p(a.event, s));
                            this.#g(s) || t.push(e);
                        }
                    ...
                    *emitAsGenerator(e) {
                        if (0 === this.#c.size) return;
                        let t = this.#h(e);
                        for (let a of this.#m(e.type)) {
                            if (null != t.event[eV] && t.event[eV] !== this) return void t.revoke();
                            if (t.event[eX]) break;
                            let e = this.#p(t.event, a);
                            this.#g(a) || (yield e);
                        }
                        t.revoke();
                    }
                    ...
                    removeAllListeners(e) {
                        if (null == e) return void this.#c.clear();
                        this.#c.deleteAll(e);
                    }
                    listeners(e) {
                        return null == e ? this.#c.getAll() : this.#c.get(e);
                    }
                    listenerCount(e) {
                        return null == e ? this.#c.size : this.listeners(e).length;
                    }
                    #d(e, t, a, s = 'append') {
                        'prepend' === s ? this.#c.prepend(e, t) : this.#c.append(e, t),
                            a &&
                                (Object.defineProperty(t, eY, { value: a, enumerable: !1, writable: !1 }),
                                a.signal &&
                    ...
                    #h(e) {
                        ...
                        return (
                            (e.stopPropagation = new Proxy(e.stopPropagation, { apply: (t, a, s) => ((e[eV] = this), Reflect.apply(t, a, s)) })),
                            {
                                event: e,
                                revoke() {
                                    e.stopPropagation = t;
                    ...
                    #p(e, t) {
                        let a = t.call(this, e);
                        if (t[eY]?.once) {
                            let a = this.#g(t) ? '*' : e.type;
                            this.#c.delete(a, t);
                        }
                        return a;
                    }
                    *#m(e) {
                        for (let [t, a] of this.#c) ('*' === t || t === e) && (yield a);
                    }
                    #g(e) {
                        return this.#c.get('*').includes(e);
                    }
                },
                eZ = ed(),
                e1 = class extends eK {
                    #f;
                    constructor(e) {
                        super(e.data.type, { data: e.data.payload }), (this.#f = e);
                    }
                    get ports() {
                        return this.#f.ports;
                    }
                    postMessage(e, ...t) {
                        this.#f.ports[0].postMessage({ type: e, data: t[0] }, { transfer: t[1] });
                    }
                },
                e0 = class extends eQ {
                    constructor(e) {
                        if ((super(), (this.options = e), !eZ)) return;
                        navigator.serviceWorker.addEventListener('message', async (e) => {
                            let t = await this.options.worker;
                            (null == e.source || e.source === t) && e.data && y(e.data) && 'type' in e.data && this.emit(new e1(e));
                        });
                    }
                    postMessage(e) {
                        ea(
            ...
            function e7(e) {
                return null != e && e instanceof Response && e9(e, 'type') && 'error' === e.type;
            }
            async function e6(e) {
                let t = async (t) =>
                        t instanceof Error
                            ...
                            : e7(t)
                              ...
                              : e5(t, !0) && e9(t, 'status') && e9(t, 'statusText') && e9(t, 'bodyUsed')
                                ? (await e.controller.respondWith(t), !0)
                                : !!e5(t) && (await e.controller.errorWith(t), !0),
                    a = async (a) => {
                        if (a instanceof ep) throw o.error;
                ...
                let o = await e4(async () => {
                    let t = e2(e.emitter, 'request', { requestId: e.requestId, request: e.request, controller: e.controller });
                ...
                if (o.error) {
                    var i;
                    if (await a(o.error)) return;
                    if (e.emitter.listenerCount('unhandledException') > 0) {
                        let a = new eg(e.request, {
                            passthrough() {},
                            async respondWith(e) {
                                await t(e);
                            },
                        ...
                        if (
                            (await e2(e.emitter, 'unhandledException', { error: o.error, request: e.request, requestId: e.requestId, controller: a }),
                            a.readyState !== eg.PENDING)
                        )
                            return;
                    }
                    await e.controller.respondWith(
                        new Response(JSON.stringify((i = o.error) instanceof Error ? { name: i.name, message: i.message, stack: i.stack } : i), {
                            status: 500,
                ...
                return e.controller.readyState === eg.PENDING ? await e.controller.passthrough() : e.controller.handled;
            }
            function e8(e) {
                return Object.assign(TypeError('Failed to fetch'), { cause: e });
            }
            var te = ['content-encoding', 'content-language', 'content-location', 'content-type', 'content-length'],
                tt = Symbol('kRedirectCount');
            async function ta(e, t) {
                let a;
                if (303 !== t.status && null != e.body) return Promise.reject(e8());
                let s = new URL(e.url);
                try {
                    a = new URL(t.headers.get('location'), e.url);
                } catch (e) {
                    return Promise.reject(e8(e));
                }
                if ('http:' !== a.protocol && 'https:' !== a.protocol) return Promise.reject(e8('URL scheme must be a HTTP(S) scheme'));
                if (Reflect.get(e, tt) > 20) return Promise.reject(e8('redirect count exceeded'));
                if ((Object.defineProperty(e, tt, { value: (Reflect.get(e, tt) || 0) + 1 }), 'cors' === e.mode && (a.username || a.password) && !ts(s, a)))
                    return Promise.reject(e8('cross origin not allowed for request mode "cors"'));
                let o = {};
                (([301, 302].includes(t.status) && 'POST' === e.method) || (303 === t.status && !['HEAD', 'GET'].includes(e.method))) &&
                    ...
                    ts(s, a) || (e.headers.delete('authorization'), e.headers.delete('proxy-authorization'), e.headers.delete('cookie'), e.headers.delete('host')),
                    (o.headers = e.headers);
                let i = await fetch(new Request(a, o));
            ...
            var to = class extends TransformStream {
                ...
                ti = class extends TransformStream {
                    constructor(e, ...t) {
                        super({}, ...t);
                ...
                tr = class e extends eH {
                    ...
                    async setup() {
                        ...
                        ea(!e[em], 'Failed to patch the "fetch" module: already patched.'),
                            (globalThis.fetch = async (t, a) => {
                                let s = e_(),
                                    o = new Request('string' != typeof t || 'undefined' == typeof location || ef(t) ? t : new URL(t, location.href), a);
                                t instanceof Request && ev(o, t);
                                let i = new eo(),
                                    r = new eg(o, {
                                        passthrough: async () => {
                                            this.logger.info('request has not been handled, passthrough...');
                                            let t = o.clone(),
                                                { error: a, data: r } = await e4(() => e(o));
                                            if (a) return i.reject(a);
                                            if ((this.logger.info('original fetch performed', r), this.emitter.listenerCount('response') > 0)) {
                                                this.logger.info('emitting the "response" event...');
                                                let e = r.clone();
                                                await e2(this.emitter, 'response', { response: e, isMockedResponse: !1, request: t, requestId: s });
                                            }
                                            i.resolve(r);
                                        },
                                        respondWith: async (e) => {
                                            if (e7(e)) {
                                                this.logger.info('request has errored!', { response: e }), i.reject(e8(e));
                                                return;
                                            }
                                            ...
                                            let t = (function (e) {
                                                ...
                                                a = null === t ? e : new eb(t, e);
                                            if ((eb.setUrl(o.url, a), eb.isRedirectResponse(a.status))) {
                                                if ('error' === o.redirect) return void i.reject(e8('unexpected redirect'));
                                                if ('follow' === o.redirect)
                                                    return void ta(o, a).then(
                                                        (e) => {
                                                            i.resolve(e);
                                                        },
                                                        (e) => {
                                            ...
                                            this.emitter.listenerCount('response') > 0 &&
                                                (this.logger.info('emitting the "response" event...'),
                                                await e2(this.emitter, 'response', { response: a.clone(), isMockedResponse: !0, request: o, requestId: s })),
                                                i.resolve(a);
                                        },
                                        errorWith: (e) => {
                                ...
                                return (
                                    ...
                                    await e6({ request: o, requestId: s, emitter: this.emitter, controller: r }),
                                    i
                                );
                            }),
                            Object.defineProperty(globalThis.fetch, em, { enumerable: !0, configurable: !0, value: !0 }),
                            this.subscriptions.push(() => {
                                Object.defineProperty(globalThis.fetch, em, { value: void 0 }),
                                    (globalThis.fetch = e),
                ...
                tu = 'undefined' != typeof ProgressEvent;
            function tc(e, t) {
                return new Proxy(
                    e,
                    (function (e) {
                        let { constructorCall: t, methodCall: a, getProperty: s, setProperty: o } = e,
                            i = {};
                        return (
                            void 0 !== t &&
                                (i.construct = function (e, a, s) {
                                    let o = Reflect.construct.bind(null, e, a, s);
                                    return t.call(s, a, o);
                                }),
                            (i.set = function (e, t, a) {
                                let s = () => {
                                    let s =
                                        ...
                                        o = Reflect.getOwnPropertyDescriptor(s, t);
                                    return void 0 !== o?.set
                                        ? (o.set.apply(e, [a]), !0)
                                        : Reflect.defineProperty(s, t, { writable: !0, enumerable: !0, configurable: !0, value: a });
                                };
                                return void 0 !== o ? o.call(e, [t, a], s) : s();
                            }),
                            (i.get = function (e, t, o) {
                                let i = () => e[t],
                                    r = void 0 !== s ? s.call(e, [t, o], i) : i();
                                return 'function' == typeof r
                                    ? (...s) => {
                                          let o = r.bind(e, ...s);
                                          return void 0 !== a ? a.call(e, [t, s], o) : o();
                                      }
                                    : r;
                            }),
                            i
            ...
            var th = Symbol('kIsRequestHandled'),
                tm = es(),
                tp = Symbol('kFetchRequest'),
                tg = class {
                    constructor(e, t) {
                                ...
                                methodCall: ([e, t], a) => {
                                    switch (e) {
                                        case 'open': {
                                            let [e, s] = t;
                                            return (
                                                void 0 === s ? ((this.method = 'GET'), (this.url = tf(e))) : ((this.method = e), (this.url = tf(s))),
                                        ...
                                        case 'send': {
                                            ...
                                            this.request.addEventListener('load', () => {
                                                if (void 0 !== this.onResponse) {
                                                    let e = (function (e, t) {
                                                        return new eb(eb.isResponseWithBody(e.status) ? t : null, {
                                                            url: e.responseURL,
                                                            status: e.status,
                                                    ...
                                                    this.onResponse.call(this, { response: e, isMockedResponse: this[th], request: o, requestId: this.requestId });
                                                }
                                            });
                                            let s = 'string' == typeof e ? eG.encode(e) : e,
                                                o = this.toFetchApiRequest(s);
                                            (this[tp] = o.clone()),
                                                queueMicrotask(() => {
                                                    (this.onRequest?.call(this, { request: o, requestId: this.requestId }) || Promise.resolve()).finally(() => {
                                                        if (!this[th])
                                                            return (
                                                                this.logger.info(
                                                                ...
                                                                tm && this.request.setRequestHeader('x-interceptors-internal-request-id', this.requestId),
                                                                a()
                                                            );
                                                    });
                                                });
                    ...
                    async respondWith(e) {
                        if (((this[th] = !0), this[tp])) {
                            let e = await td(this[tp]);
                        ...
                        this.logger.info('responding with a mocked response: %d %s', e.status, e.statusText),
                            ...
                            (this.request.getResponseHeader = new Proxy(this.request.getResponseHeader, {
                                apply: (t, a, s) => {
                                    ...
                                    return this.logger.info('resolved response header "%s" to', s[0], o), o;
                                },
                            })),
                    ...
                    get responseText() {
                        if (
                            (ea('' === this.request.responseType || 'text' === this.request.responseType, 'InvalidStateError: The object is in invalid state.'),
                    ...
                    get responseXML() {
                        if (
                            (ea('' === this.request.responseType || 'document' === this.request.responseType, 'InvalidStateError: The object is in invalid state.'),
                        ...
                        let s = t[`on${e}`],
                            o = (function (e, t, a) {
                                ...
                                return ['error', 'progress', 'loadstart', 'loadend', 'load', 'timeout', 'abort'].includes(t)
                                    ...
                                    : new tn(t, { target: e, currentTarget: e });
                            })(t, e, a);
                        for (let [i, r] of (this.logger.info('trigger "%s"', e, a || ''),
                        'function' == typeof s && (this.logger.info('found a direct "%s" callback, calling...', e), s.call(t, o)),
                        t instanceof XMLHttpRequestUpload ? this.uploadEvents : this.events))
                            i === e && (this.logger.info('found %d listener(s) for "%s" event, calling...', r.length, e), r.forEach((e) => e.call(t, o)));
                    }
                    toFetchApiRequest(e) {
            ...
            var tb = class e extends eH {
                    ...
                    checkEnvironment() {
                        return e3('XMLHttpRequest');
                    }
                    setup() {
                        let e = this.logger.extend('setup');
                        e.info('patching "XMLHttpRequest" module...');
                        let t = globalThis.XMLHttpRequest;
                        ea(!t[em], 'Failed to patch the "XMLHttpRequest" module: already patched.'),
                            (globalThis.XMLHttpRequest = (function ({ emitter: e, logger: t }) {
                                return new Proxy(globalThis.XMLHttpRequest, {
                                    construct(a, s, o) {
                                        ...
                                        let i = Reflect.construct(a, s, o),
                                            r = Object.getOwnPropertyDescriptors(a.prototype);
                                        for (let e in r) Reflect.defineProperty(i, e, r[e]);
                                        let n = new tg(i, t);
                                        return (
                                            (n.onRequest = async function ({ request: t, requestId: a }) {
                                                let s = new eg(t, {
                                                    ...
                                                    respondWith: async (e) => {
                                                        if (e7(e)) return void this.errorWith(TypeError('Network error'));
                                                ...
                                                this.logger.info('awaiting mocked response...'),
                                                    ...
                                                    await e6({ request: t, requestId: a, controller: s, emitter: e });
                                            }),
                                            (n.onResponse = async function ({ response: t, isMockedResponse: a, request: s, requestId: o }) {
                                                this.logger.info('emitting the "response" event for %s listener(s)...', e.listenerCount('response')),
                                                    e.emit('response', { response: t, isMockedResponse: a, request: s, requestId: o });
                                            }),
                                            n.request
                                        );
                                    },
                            ...
                            Object.defineProperty(globalThis.XMLHttpRequest, em, { enumerable: !0, configurable: !0, value: !0 }),
                            this.subscriptions.push(() => {
                                Object.defineProperty(globalThis.XMLHttpRequest, em, { value: void 0 }),
                        ...
                        if (
                            ...
                            (this.context.startOptions = (function e(t, a) {
                                return Object.entries(a).reduce(
                                    (t, [a, s]) => {
                                        let o = t[a];
                                        return Array.isArray(o) && Array.isArray(s) ? (t[a] = o.concat(s)) : y(o) && y(s) ? (t[a] = e(o, s)) : (t[a] = s), t;
                                    },
                                    Object.assign({}, t),
                                );
                            })(ei, e)),
                                ...
                                onMockedConnection: (e) => {
                                    this.context.startOptions.quiet ||
                                        (function (e) {
                                            ...
                                            (function (e) {
                                                let t = (0, n.e)(e.url);
                                                console.groupCollapsed(s.J.formatMessage(`${(0, _.l)()} %c\u25B6%c ${t}`), `color:${J.system}`, 'color:inherit'),
                                                ...
                                                t.addEventListener('close', (e) => {
                                                    ...
                                                    let a = t.target,
                                                        o = (0, n.e)(a.url);
                                                    console.groupCollapsed(
                                                        s.J.formatMessage(`${(0, _.l)({ milliseconds: !0 })} %c\u25A0%c ${o}`),
                                                        `color:${J.system}`,
                                                        'color:inherit',
                                                    ),
                                                        console.log(t),
                                                ...
                                                t.socket.addEventListener('error', (e) => {
                                                    ...
                                                    let a = t.target,
                                                        o = (0, n.e)(a.url);
                                                    console.groupCollapsed(
                                                        s.J.formatMessage(`${(0, _.l)({ milliseconds: !0 })} %c\xd7%c ${o}`),
                                                        `color:${J.system}`,
                                                        'color:inherit',
                                                    ),
                                                        console.log(t),
                                                ...
                                                (t.send = new Proxy(t.send, {
                                                    apply(e, a, s) {
                                                        let [o] = s,
                                                            i = new MessageEvent('message', { data: o });
                                                        return (
                            ...
                            H.on('connection', async (e) => {
                                let a = t.getHandlers().filter(m('EventHandler'));
                                if (a.length > 0) {
                                    t?.onMockedConnection(e), await Promise.all(a.map((t) => t.run(e)));
                                    return;
                                }
                                let s = new Request(e.client.url, { headers: { upgrade: 'websocket', connection: 'upgrade' } });
                                await l(s, t.getUnhandledRequestStrategy()).catch((t) => {
                            ...
                            let e = (function (e, t) {
                                let a = new eF({ name: 'fallback', interceptors: [new tr(), new tb()] });
                                return (
                                    a.on('request', async ({ request: a, requestId: s, controller: o }) => {
                                        let i = a.clone(),
                                            r = await h(a, s, e.getRequestHandlers().filter(m('RequestHandler')), t, e.emitter, {
                                                resolutionContext: { quiet: t.quiet },
                                                onMockedResponse(a, { handler: s, parsedResult: o }) {
                                                    t.quiet ||
                                                        e.emitter.once('response:mocked', ({ response: e }) => {
                                                            s.log({ request: i, response: e, parsedResult: o });
                                                        });
                                                },
                                            });
                                        r && o.respondWith(r);
                                    }),
                                    a.on('response', ({ response: t, isMockedResponse: a, request: s, requestId: o }) => {
                                        e.emitter.emit(a ? 'response:mocked' : 'response:bypass', { response: t, request: s, requestId: o });
                                    }),
                                    a.apply(),
                                    a
                                );
                            ...
                            this.subscriptions.push(() => {
                                ...
                                eu({ message: 'Mocking enabled (fallback mode).', quiet: this.context.startOptions.quiet });
                            return;
                        }
                        let i =
                                ((a = this.context),
                                    ...
                                    return (async () => {
                                        ...
                                        a.workerChannel.removeAllListeners(),
                                            a.workerChannel.on('REQUEST', async (t) => {
                                                ...
                                                o.w.cache.set(r, l);
                                                try {
                                                    await h(r, i, a.getRequestHandlers().filter(m('RequestHandler')), e, a.emitter, {
                                                        resolutionContext: { quiet: e.quiet },
                                                        onPassthroughResponse() {
                                                            t.postMessage('PASSTHROUGH');
                                                        },
                                                        async onMockedResponse(s, { handler: o, parsedResult: i }) {
                                                            let r = s.clone(),
                                                                l = s.clone(),
                                                                u = { status: s.status, statusText: s.statusText, headers: Object.fromEntries(s.headers.entries()) };
                                                            if (eh) {
                                                                let e = s.body;
                                                                t.postMessage('MOCK_RESPONSE', { ...u, body: e }, e ? [e] : void 0);
                                                            } else {
                                                                let e = null === s.body ? null : await r.arrayBuffer();
                                                                t.postMessage('MOCK_RESPONSE', { ...u, body: e });
                                                            }
                                                            e.quiet ||
                                                                a.emitter.once('response:mocked', () => {
                                                                    o.log({ request: n, response: l, parsedResult: i });
                                                                });
                                                        },
                                                    });
                                                } catch (e) {
...
This exception has been gracefully handled as a 500 response, however, it's strongly recommended to resolve this error, as it indicates a mistake in your code. If you wish to mock an error response, please see this guide: https://mswjs.io/docs/http/mocking-responses/error-responses`,
                                            ...
                                            a.workerChannel.on('RESPONSE', (e) => {
                                                ...
                                                let o =
                                                    0 === t.response.status
                                                        ? Response.error()
                                                        : new eb(eb.isResponseWithBody(t.response.status) ? t.response.body : null, { ...t.response, url: s.url });
                                        ...
                                        let [r, n] = await el(e.serviceWorker.url, e.serviceWorker.options, e.findWorker);
                                        if (!r)
                                            throw Error(
                                                t?.findWorker
                                                    ? s.J.formatMessage(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
                                        ...
                                        return (
                                            a.workerPromise.resolve(r),
                                            (a.registration = n),
                                            window.addEventListener('beforeunload', () => {
                                                'redundant' !== r.state && a.workerChannel.postMessage('CLIENT_CLOSED'),
...
- Set the "Service-Worker-Allowed" response header to allow out-of-scope workers.`),
                                        ...
                                        return (
                                            await (function (e, t) {
                                                ...
                                                return (
                                                    ...
                                                    e.workerChannel.once('MOCKING_ENABLED', async (s) => {
                                                        e.isMockingEnabled = !0;
                                                        let o = await e.workerPromise;
                                                        eu({ quiet: t.quiet, workerScope: e.registration?.scope, workerUrl: o.scriptURL, client: s.data.client }),
                                                            a.resolve(!0);
                                                    }),
                                                    a
                                                );
                    ...
                    stop() {
                        ...
                        (this.context.isMockingEnabled = !1),
                            ...
                            ed() && (this.context.workerChannel.removeAllListeners('RESPONSE'), window.clearInterval(this.context.keepAliveInterval)),
                            window.postMessage({ type: 'msw/worker:stop' }),
                            (function (e = {}) {
                                e.quiet || console.log(`%c${s.J.formatMessage('Mocking disabled.')}`, 'color:orangered;font-weight:bold;');
        ...
        99800: (e, t, a) => {
            ...
            class r extends s.Aj {
                [i] = null;
                constructor(e, t) {
                    let a = (0, o.Tl)(t);
                    super(e, a), (0, o.fX)(this, a);
                }
                static error() {
                    return super.error();
                }
                ...
                static json(e, t) {
                    ...
                    return a.headers.has('Content-Length') || a.headers.set('Content-Length', s ? new Blob([s]).size.toString() : '0'), new r(s, a);
                }
                static xml(e, t) {
                    let a = (0, o.Tl)(t);
                    return a.headers.has('Content-Type') || a.headers.set('Content-Type', 'text/xml'), new r(e, a);
                }
                static html(e, t) {
                    let a = (0, o.Tl)(t);
                    return a.headers.has('Content-Type') || a.headers.set('Content-Type', 'text/html'), new r(e, a);
                }
