    ...
    [9615],
    {
        59615: (e, t, i) => {
            ...
            var s,
                ...
                a = i(94407);
            let n = r.gK
                    .model('BaseAdvertBanner', { type: r.gK.enumeration(Object.values(a.h)), noAds: r.gK.boolean, hasError: r.gK.boolean, isShowBanner: r.gK.boolean })
                    .views((e) => ({
                        get isVisible() {
                ...
                u = r.gK.model('Cover', { uri: r.gK.maybe(r.gK.string), color: r.gK.maybe(r.gK.string), videoUrl: r.gK.maybe(r.gK.string) }),
                d = r.gK.model('DisclaimerDetails', { text: r.gK.maybe(r.gK.string), url: r.gK.maybe(r.gK.string) }),
                m = r.gK.model('DisclaimerData', { title: r.gK.maybe(r.gK.string), description: r.gK.maybe(r.gK.string), details: r.gK.maybe(d) }),
                c = r.gK.compose(r.gK.model({ id: r.gK.string, type: r.gK.string }), m),
                K = ['Safari', 'MobileSafari'],
                p = ['iOS', 'MacOS'],
                f = r.gK.model('DomainTrailerEntity', { available: r.gK.boolean }).views((e) => ({
                    get isAvailable() {
                        ...
                        if (
                            ...
                            ((e) => {
                                ...
                                return !!(e.name && K.includes(e.name) && e.OSFamily && p.includes(e.OSFamily) && t && t < 18);
                            })(t.browserInfo)
                        )
                            return !1;
                        return e.available;
            ...
            var v = i(19943),
                ...
                y = i(4642),
                L = i(99537);
            let S = r.gK.model('Experiment', { group: r.gK.maybe(r.gK.string), value: r.gK.maybe(r.gK.frozen()) }),
                T = r.gK
                    .model('Experiments', {
                    ...
                    .views((e) => {
                        let t = {
                            ...
                            getExperiment(i) {
                                ...
                                return l?.[i] ?? window?.DEFAULT_MUSIC_EXPERIMENT_OVERRIDES()?.[i] ?? n;
                            },
                            isExperimentEnabled(e) {
                                let i = t.getExperiment(e);
                                return (0, v.A)(null == i ? void 0 : i.value.enabled)
                                    ? null == i
                                        ? void 0
                                        : i.value.enabled
                            ...
                            checkExperiment(t, i) {
                                let s = e.experiments.get(t),
                                    ...
                                    l = n.get(b.yc);
                                return (0, I.i)({ containerStorage: a, name: t, value: i, experimentDetail: s }, l);
                            },
            ...
            let R = r.gK
                .model('ExplicitModel', {
                    contentWarning: r.gK.maybe(r.gK.enumeration(Object.values(E.K))),
                ...
                .views((e) => ({
                    ...
                    get explicitDisclaimer() {
                        ...
                        let t = ((e, t) => {
                            ...
                            return null;
                        })(e.disclaimers, [k.M.EXPLICIT_ICON, k.M.AGE_18_ICON, k.M.EXCLAMATION_ICON]);
                        if ((null == t ? void 0 : t.type) === k.M.EXCLAMATION_ICON) return N.J.EXCLAMATION;
                        if ((null == t ? void 0 : t.type) === k.M.EXPLICIT_ICON) return N.J.E;
                        if ((null == t ? void 0 : t.type) === k.M.AGE_18_ICON) return N.J.NUMERIC;
                        return null;
                    },
                }))
                .actions((e) => ({
                    getDescriptionTexts: (0, r.L3)(function* () {
                        ...
                        let { disclaimers: t } = (0, r.Zn)(e),
                            i = (0, A.b)(e.disclaimers, k.M.DESCRIPTION_TEXT) || [],
                            s = [];
                        if (!t) return s;
                        for (let e of i) {
                ...
                return r.gK
                    ...
                    .views((e) => {
                        let t = {
                            ...
                            get isSomePageResolved() {
                                var i;
                                return !!((null == (i = e.pageStates) ? void 0 : i.length) && e.pageStates.some((e) => e === L.G.RESOLVE));
                            },
                            get isEmpty() {
                                var s;
                            ...
                            get rejectedPagesCount() {
                                var r;
                                if (t.isInitialRequestRejected || !(null == (r = e.pageStates) ? void 0 : r.length)) return 0;
                    ...
                    .actions((e) => {
                        let t = {
                            setPageState: (i, s) => {
                                var r, a, n, l;
                                [L.G.IDLE, L.G.PENDING].includes(e.initialRequestLoadingState) && (e.initialRequestLoadingState = s);
                                let o = Math.max(
                                    i + 1,
                                    Math.ceil(
                                        (null != (n = null == (r = e.pager) ? void 0 : r.total) ? n : 0) /
                            ...
                            resetRejectedPagesState() {
                                ...
                                for (let r = 0; r < (null != (i = null == (t = e.pageStates) ? void 0 : t.length) ? i : 0); r++)
                                    (null == (s = e.pageStates) ? void 0 : s[r]) === L.G.REJECT && (e.pageStates[r] = L.G.IDLE);
                            },
                            ...
                            ensurePageStatesInitialized(t) {
                                ...
                                if (t > i) {
                                    let s = Array.from({ length: t - i }, () => L.G.IDLE);
                                    e.pageStates.push(...s);
                                }
                            },
                            reset() {
            ...
            let G = [M.s.LIKED_ALBUMS, M.s.LIKED_ARTISTS, M.s.LIKED_PLAYLISTS, M.s.LIKED_TRACKS, M.s.LIKED_CLIPS],
                ...
                j = r.gK.model('LibraryRecord', { revision: r.gK.maybeNull(r.gK.number), items: V }),
                F = r.gK
                    .model('Library', { loadingState: r.gK.enumeration(Object.values(L.G)), tracks: j, albums: j, artists: j, playlists: j, clips: j })
                    .views((e) => ({
                    ...
                    .actions((e) => {
                        let t = {
                            getData: (0, r.L3)(function* () {
                                let i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : G,
                                    { modelActionsLogger: s, collectionResource: a } = (0, r._$)(e);
                                if (e.loadingState !== L.G.PENDING)
                                    try {
                                        e.loadingState = L.G.PENDING;
                                        let s = {};
                            ...
                            toggleTrackLike: (0, r.L3)(function* (i) {
                                ...
                                try {
                                    let r,
                                        a = { entityId: i.albumId ? ''.concat(i.entityId, ':').concat(i.albumId) : i.entityId, userId: i.userId };
                                    return (
                                        '1' === e.tracks.items.get(n)
                                            ? (e.tracks.items.delete(n), (r = yield s.unlikeTrack(a)))
                                            : (e.tracks.items.set(n, '1'), (r = yield s.likeTrack(a))),
                                ...
                                try {
                                    ...
                                    return (
                                        '0' === e.tracks.items.get(n)
                                            ? (e.tracks.items.delete(n), (r = yield s.undislikeTrack(a)))
                                            : (e.tracks.items.set(n, '0'), (r = yield s.dislikeTrack(a))),
                                        t.getData([M.s.LIKED_TRACKS]),
                                        r
                                    );
                                } catch (t) {
                                ...
                                try {
                                    ...
                                    return (
                                        '1' === e.artists.items.get(n)
                                            ? (e.artists.items.delete(n), (r = yield s.unlikeArtist(i)))
                                            : (e.artists.items.set(n, '1'), (r = yield s.likeArtist(i))),
                                ...
                                try {
                                    ...
                                    return (
                                        '0' === e.artists.items.get(n)
                                            ? (e.artists.items.delete(n), (r = yield s.undislikeArtist(i)))
                                            : (e.artists.items.set(n, '0'), (r = yield s.dislikeArtist(i))),
                                        t.getData([M.s.LIKED_ARTISTS]),
                                        r
                                    );
                                } catch (t) {
                                ...
                                try {
                                    ...
                                    return (
                                        '1' === e.albums.items.get(n)
                                            ? (e.albums.items.delete(n), (r = yield s.unlikeAlbum(i)))
                                            : (e.albums.items.set(n, '1'), (r = yield s.likeAlbum(i))),
                                ...
                                try {
                                    ...
                                    return (
                                        '1' === e.playlists.items.get(n)
                                            ? (e.playlists.items.delete(n), (r = yield s.unlikePlaylist(i)))
                                            : (e.playlists.items.set(n, '1'), (r = yield s.likePlaylist(i))),
                                ...
                                try {
                                    return (
                                        '1' === e.clips.items.get(n)
                                            ? (e.clips.items.delete(n), yield s.unlikeClip(i))
                                            : (e.clips.items.set(n, '1'), yield s.likeClip(i)),
                ...
                W = r.gK.model('LoadingState', { loadingState: r.gK.enumeration(Object.values(L.G)) }).views((e) => ({
                    get isNeededToLoad() {
            ...
            var U = i(54960),
                J = i(2044),
                X = i(51218);
            let z = { INTRO_PLAN: X.N.IntroPlan, INTRO_UNTIL_PLAN: X.N.IntroUntilPlan, TRIAL_PLAN: X.N.TrialPlan, TRIAL_UNTIL_PLAN: X.N.TrialUntilPlan },
                H = (e) => {
                    let { repetitionCount: t, typename: i, ...s } = e;
                    return { ...(Number.isFinite(t) ? { repeatCount: t } : {}), ...s, typename: z[i] || i };
                };
            var Y = i(97581);
            let Z = (e) => (0, r.wg)(e),
                Q = (e) => {
                ...
                et = (e) => {
                    let { positionId: t, silentInvoiceAvailable: i, structureType: s, tariffOffer: a, optionOffers: n } = e;
                    return (0, r.wg)({
                        positionId: t,
                                ...
                                catalogCompositeOffer: et(
                                    ((e) => {
                                        ...
                                        return {
                                            ...
                                            tariffOffer: i ? { ...i, offerVendorType: i.offerVendorType, plans: null == (t = i.plans) ? void 0 : t.map(H) } : void 0,
                                            optionOffers: null == s ? void 0 : s.map((e) => ({ ...e, plans: (e.plans || []).map(H) })),
                                        };
                                    })(i),
                                ),
                                offerTexts: ((e) => {
            ...
            var er = i(32904);
            let ea = r.gK.model({ batchId: r.gK.string, positionId: r.gK.string, placeId: r.gK.maybe(r.gK.string) }),
                en = r.gK.model({
            ...
            let eo = r.gK.model({ amount: r.gK.number, currency: r.gK.string }),
                ...
                eu = r.gK.model({ typename: r.gK.literal(X.N.IntroUntilPlan), price: eo, until: r.gK.string }),
                ed = r.gK.model({ typename: r.gK.literal(X.N.TrialPlan), period: r.gK.string }),
                em = r.gK.model({ typename: r.gK.literal(X.N.TrialUntilPlan), until: r.gK.string }),
                ...
                ey = r.gK.model({ offer: r.gK.maybeNull(eb), acqOffer: r.gK.maybeNull(eI) }).views((e) => {
                    let t = {
                        get target() {
                            var i;
                        ...
                        get offerPosition() {
                            var s, r;
                            return null != (r = null == (s = e.acqOffer) ? void 0 : s.position) ? r : 0;
                        },
                        get place() {
                            var a;
                            return null == (a = e.acqOffer) ? void 0 : a.place;
                        },
                        get catalogCompositeOffer() {
                            var n;
                            return (null == (n = e.acqOffer) ? void 0 : n.catalogCompositeOffer) || e.offer;
                        },
                        get offersPositionId() {
                            var l, o;
                            return (
                                (null == (l = e.acqOffer) ? void 0 : l.analyticData.positionId) || (null == (o = t.catalogCompositeOffer) ? void 0 : o.positionId) || ''
                            );
                        },
                        get tariffOffer() {
                            var g;
                        ...
                        get oneClickDisclaimerTextA11y() {
                            var p;
                            return null == (p = t.customTexts) ? void 0 : p.oneClickDisclaimerTextA11y;
                        },
                        get mainText() {
                            var f, v;
                            return (null == (f = t.customTexts) ? void 0 : f.buttonText) || (null == (v = t.tariffOffer) ? void 0 : v.text);
                        },
                        get mainTextA11y() {
                            var b;
                        ...
                        get offersBatchId() {
                            var L, S;
                            return (null == (L = e.acqOffer) ? void 0 : L.analyticData.batchId) || (null == (S = e.offer) ? void 0 : S.positionId) || '';
                        },
                    };
                    return t;
                }),
                ...
                eS = r.gK.compose(eL, W, r.gK.model({ isLoadOffersResultSent: r.gK.boolean })),
                eT = r.gK.model({ eventSessionId: r.gK.string, batchPositionId: r.gK.string, offers: r.gK.array(ey) }),
                eE = r.gK
                    .compose(
                        r.gK.model({
                    ...
                    .volatile(() => ({ sessionId: (0, U.A)(), isFrontSessionStartSent: !1 }))
                    .views((e) => {
                        let t = {
                            ...
                            getOffersPositionIds(t) {
                                ...
                                return (
                                    (e.isWebNextPlusAcqToolkitOn &&
                                        t &&
                                        (null == (r = e.acqData) || null == (s = r.get(t)) || null == (i = s.offers) ? void 0 : i.map((e) => e.offersPositionId))) ||
                                    (null == (n = e.data) || null == (a = n.offers) ? void 0 : a.map((e) => e.offersPositionId)) ||
                                    []
                                );
                            },
                            getOffer(t, i) {
                                var s, r;
                                let a = e.isWebNextPlusAcqToolkitOn && (null == (s = e.acqData) ? void 0 : s.get(t));
                                return a ? (i ? a.offers.find((e) => e.place === i) : a.offers[0]) : null == (r = e.data) ? void 0 : r.offers[0];
                            },
                            getTarget(i, s) {
                                var r;
                                return (e.isWebNextPlusAcqToolkitOn && (null == (r = t.getOffer(i, s)) ? void 0 : r.target)) || e.customTarget || 'music';
                            },
                        };
                        return t;
                    })
                    .actions((e) => {
                        let t = {
                            ...
                            toggleIsLoadOffersResultSentTrue() {
                                let i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : J.l.NO_VALUE;
                            ...
                            setLoadingState(i) {
                                let s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : J.l.NO_VALUE;
                                e.isWebNextPlusAcqToolkitOn ? t.setAcqData(s, { ...e.acqData.get(s), loadingState: i }) : (e.loadingState = i);
                            },
                            setAcqData(t, i) {
                                var s;
                                e.acqData.set(t, { loadingState: L.G.IDLE, isLoadOffersResultSent: !1, ...(null != (s = e.acqData.get(t)) ? s : {}), ...i });
                            },
                            getData: (0, r.L3)(function* (i) {
                                let s,
                                    { uid: a, page: n, places: l, communicationId: o, campaignId: g, customTarget: u, widgetServiceName: d } = i,
                                    { acqOffers: m, offersResource: c, modelActionsLogger: K } = (0, r._$)(e),
                                    { experiments: p } = (0, r.Zn)(e),
                                    f = p.getEnabledFlags(),
                                    v = p.checkExperiment(er.z.WebNextPlusAcqToolkit, 'on'),
                                    b = v ? n || J.l.NO_VALUE : void 0;
                                if (((e.isWebNextPlusAcqToolkitOn = v), e.getLoadingState(n) !== L.G.PENDING)) {
                                        ...
                                        if ((t.setLoadingState(L.G.PENDING, b), v)) {
                                            ...
                                            (o && (i.communication_id = o),
                                                ...
                                                t.setAcqData(b || J.l.NO_VALUE, {
                                                    ...((e) => {
                                                        let { sessionId: t, result: i, offerConfigId: s, mlRequestId: a, page: n, language: l } = e;
                                                        return (0, r.wg)({ sessionId: t, page: n, offers: i.map(es), mlRequestId: a, offerConfigId: s, language: l });
                                                    })(s),
            ...
            let eP = r.gK
                    .model('Settings', {
                        layout: r.gK.maybeNull(r.gK.enumeration(Object.keys(ek.u))),
                        isLandscape: r.gK.boolean,
                        isMobileLandscapeHeight: r.gK.boolean,
                        platform: r.gK.maybe(r.gK.enumeration(Object.values(eN.O))),
                        browserInfo: o,
                        liteVersionMode: r.gK.maybe(r.gK.enumeration(Object.values(eA.w))),
                    })
                    .views((e) => {
                        let t = {
                            get isMobile() {
                    ...
                    .actions((e) => {
                        let t = {
                            ...
                            initializeLiteVersionMode() {
                                ...
                                if (a) {
                                    if ('2' !== a.version || !i.checkExperiment(er.z.WebNextLiteVersion, 'on')) return void s.remove(eR.c.LiteVersionMode);
                ...
                eD = r.gK.model('TrackIdModel', { id: r.gK.union(r.gK.string, r.gK.number), albumId: r.gK.maybe(r.gK.number), timestamp: r.gK.maybe(r.gK.string) });
        },
        60866: (e, t, i) => {
            var s;
            (i.d(t, { f: () => s }),
