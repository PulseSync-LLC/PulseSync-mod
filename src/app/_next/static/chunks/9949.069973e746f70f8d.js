    ...
    [9949],
    {
        ...
        19731: (t, e, s) => {
            ...
            let h = async (t) => {
                ...
                p = ['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'HEAD', 'get', 'post', 'put', 'patch', 'delete', 'head'];
            class g {
                async get(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    ...
                    if (
                        ...
                        (null == o ? void 0 : o.config) &&
                            ...
                            y.hooks.beforeRetry.push(async (t) => {
                                await h({ request: t.request, options: t.options, error: t.error, retryAttempt: t.retryCount, clientRetryConfig: o });
                            })),
                        r)
                    ) {
                        let t,
                ...
                convertMethod(t) {
                    return void 0 !== t && p.includes(t) ? t.toUpperCase() : 'GET';
                }
                convertMethods(t) {
                    let e = new Set();
                    return (
                        t.forEach((t) => {
                            p.includes(t) && e.add(t.toUpperCase());
                        }),
                        [...e]
                    );
                }
        ...
        25500: (t, e, s) => {
            ...
            let r = () => ''.concat(n.DESKTOP).concat((0, a.t)((0, i.u)()));
        },
        26964: (t, e, s) => {
            'use strict';
            s.d(e, { c: () => i });
        ...
        76198: (t, e, s) => {
            ...
            class o extends a.X {
                async cards(t, e) {
                    let s = (0, n.F)({ trackIds: t.trackIds, viewedCards: t.viewedCards, locations: t.locations }),
            ...
            function a(t) {
                ...
                return (
                    ...
                    'unknown' === r && g(),
                    {
                        ...
                        dispose: () => {
                            (o = !0), window.removeEventListener('offline', y), window.removeEventListener('online', m), d(), h(), c.clear();
                        },
                    }
                );
            }
        ...
        94753: (t, e, s) => {
            var i = {
                ...
                './utils/getApiPrefixUrl.ts': [6170, 6170],
