(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3359],
    {
        ...
        21128: (e, t, r) => {
            ...
            (null == (n = null == C ? void 0 : C.timing) ? void 0 : n.navigationStart) &&
                    ...
                    return (
                        (0, c.useEffect)(
                            function () {
                                ...
                                E && u(window.matchMedia('(max-width: ' + r + 'px)').matches ? 'touch' : 'desktop');
                            },
                            [r, a],
                        ),
                        (0, l.E)(
            ...
            function I(e) {
                var t,
                    ...
                    eh =
                        ...
                        (0, c.useMemo)(
                            function () {
                                return k.includes(t) ? 'com.' + t : L.includes(t) ? 'co.' + t : t;
                            },
                            [t],
                        ));
                ...
                var ep = (0, o.__read)((0, c.useState)(!0), 2),
                    ...
                    eE = ey[0],
                    eb = ey[1],
                    e_ = (0, c.useRef)({ colorScheme: U, theme: eo, retpath: eC }),
                    eS = (0, c.useMemo)(
                        function () {
                            if (A) return 'https://' + A;
                    ...
                    ek = (0, c.useMemo)(
                        function () {
                            eE ||
                                (e_.current.colorScheme === U && e_.current.theme === eo && e_.current.retpath === eC) ||
                                (e_.current = { colorScheme: U, theme: eo, retpath: eC });
                            var e = new URL('user-id', eS);
                            if (
                                (e_.current.retpath && e.searchParams.set('encodedRetpath', encodeURIComponent(e_.current.retpath)),
                                e_.current.colorScheme && e.searchParams.set('colorScheme', e_.current.colorScheme),
                                e_.current.theme && e.searchParams.set('theme', e_.current.theme),
                            ...
                            for (var r in (ee && e.searchParams.set('project', ee), H && e.searchParams.set('env', H), e.searchParams.set('dir', T), et))
                ...
                var eL = S({ platform: $, touchBreakpointWidth: ei }),
                    ...
                    eP = (0, c.useMemo)(
                        function () {
                            return null === x ? null : 'number' == typeof x ? x : 'touch' === eL ? x[1] : x[0];
                        },
                        [eL, x],
                    ),
                    eR = (0, c.useCallback)(
                        ...
                        rpcHandler: (0, c.useCallback)(
                            function (e, t) {
                                ...
                                switch (e.methodCall) {
                                    ...
                                    case 'onDataLoad':
                                        var n = ed.current;
                                        if ('number' == typeof n.start && 'number' != typeof n.end && eB.current) {
                                            n.end = y();
                                            var a = n.end - n.start;
                                    ...
                                    default:
                                        ...
                                        Promise.resolve(
                                            null == (r = null == ea ? void 0 : ea[e.methodCall]) ? void 0 : r.call.apply(r, (0, o.__spread)([ea], e.params)),
                                        ).then(t);
                                }
                            },
                    ...
                    (f = (0, c.useCallback)(
                        function (e) {
                            var t,
                                r,
                                o = JSON.stringify(e);
                            n ? d.current.push(o) : null == (r = null == (t = a.current) ? void 0 : t.contentWindow) || r.postMessage(o, '*');
                        },
                        [n, a],
                    )),
                    (v = (0, c.useCallback)(
                        ...
                        function () {
                            a &&
                                ...
                                (d.current.forEach(function (e) {
                                    var t, r;
                                    null == (r = null == (t = a.current) ? void 0 : t.contentWindow) || r.postMessage(e, '*');
                                }),
                                (d.current = []));
                        },
                        [n, a],
                ...
                (eB.current = eH),
                    ...
                    (0, c.useEffect)(
                        function () {
                            eH({ methodCall: 'onParamsChange', params: [(0, o.__assign)({}, er)] });
                        },
                        [er, eH],
                    ),
                    (0, c.useEffect)(
                ...
                var eW = (0, c.useCallback)(
                    ...
                    ej = (0, c.useCallback)(
                        function () {
                            eu ? (eW(!0), eR()) : (eE || eb(!0), eW(!1), null == Z || Z());
                        },
                        [eW, Z, eE, eu, eR],
                    );
                (h = (m = {
                    ...
                    (w = m.essentialRefs),
                    (C = m.unsafe_strategy),
                    ((I = (0, c.useRef)({ onClose: p, refs: w, closeStrategy: void 0 === C ? 'pressdown' : C })).current.onClose = p),
                    (I.current.refs = w),
                    (0, c.useEffect)(
                        function () {
                            if (h) {
                ...
                return {
                    avatarProps: { avatarSize: eP, env: H, onClick: ej, onPointerEnter: eI, platform: eL, ref: ef, retpath: eC, userData: eO, visible: eu, tld: eh },
                    contentProps: eY,
                    dialogProps: eA,
                };
            }
            ...
            var c = (0, a.cn)('UserID', 'CloseButton'),
                i = function (e) {
                    ...
                    return n.createElement(
                        'button',
                        { className: c({ colorScheme: r }), onClick: t, 'aria-label': 'Закрыть', tabIndex: 1 },
                        n.createElement(
                            'svg',
                    ...
                    return (
                        ...
                        n.createElement(
                            'div',
                            {
                                ...
                                'aria-busy': s,
                                'aria-modal': 'true',
                                className: l('Dialog', { visible: c, loading: s, colorScheme: u, platform: d }, [v]),
                                ref: t,
                            },
                            s && n.createElement(i, { colorScheme: u, onClick: f }),
                            e.children,
                        )
                    );
                });
                ...
                var r,
                    i = function (r) {
                        var i = r.onOpen,
                            ...
                            m = (0, c.w)((0, n.__assign)((0, n.__assign)({}, r), { visible: u, onOpen: f, onClose: v })),
                            h = m.avatarProps,
                            p = m.contentProps,
                            g = m.dialogProps;
            ...
            var o = (0, a.cn)('UserWidget', 'Content'),
                c = n.forwardRef(function (e, t) {
                    ...
                    return n.createElement(
                        ...
                        a && n.createElement('iframe', { className: 'UserWidget-Iframe', ref: t, width: u, src: s, height: r ? 300 : c }),
            ...
            t.cn = (function (e) {
                ...
                return function (e, r) {
                    return function (n, a, o) {
                        return 'string' == typeof n ? (Array.isArray(a) ? t(e, n, void 0, a) : t(e, n, a, o)) : t(e, r, n, a);
                    };
                };
            })({ e: '-', m: '_' });
        },
        79218: (e, t, r) => {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 });
            var n = r(62986);
            n.__exportStar(r(81312), t),
                n.__exportStar(r(41581), t),
                n.__exportStar(r(38843), t),
                n.__exportStar(r(97043), t),
                n.__exportStar(r(54304), t),
                n.__exportStar(r(60583), t);
        },
        81246: (e, t, r) => {
            'use strict';
                ...
                if (a.O) {
                    ...
                    !(function (e) {
                        ...
                        var r = (function (e) {
                                ...
                                if (r || a || ((t = getComputedStyle(e).overflowY), /scroll/.test(t))) {
                            ...
                            o = i(e, { paddingRight: ''.concat(a + r, 'px'), overflow: 'hidden', overflowX: 'hidden', overflowY: 'hidden' });
        ...
        97043: (e, t, r) => {
            ...
            var l = (0, a.cn)('UserID', 'Avatar'),
                s = function (e) {
                    ...
                    return (
                        ...
                        n.createElement(
                            'div',
                            { className: l({ child: f, plus: d, small: p, dark: 'dark' === v }, [m]), ref: E },
                            n.createElement('img', { src: C, className: 'UserID-Avatar-Image', srcSet: y }),
                            f &&
                                n.createElement(
                                    'svg',
            ...
            (s.displayName = 'UserIDAvatar'), r(54945);
            var u = function (e) {
                var t = e.children,
                    r = e.fetchMail,
                    a = e.tld,
            ...
            (u.displayName = 'UserIDBadge'), r(67545);
            var d = (0, a.cn)('UserID', 'Wrapper'),
                f = (0, n.forwardRef)(function (e, t) {
                    ...
                    return (
                        ...
                        n.createElement(
                            'div',
                            { className: d({ child: L, plus: I, default: !I }, [h]), style: null !== E ? { '--user-id-size': (E || 42) + 'px' } : void 0 },
                            n.createElement(
                                'button',
                                {
                                    'aria-expanded': C,
                                ...
                                n.createElement(
                                    u,
                                    {
                                        ...
                                        tld: void 0 === r ? 'ru' : r,
                                        colorScheme: l,
                                        showCounter: 'touch' !== b && (p || !0 === g),
                                    },
                                    n.createElement(s, { env: i, avatarId: P, plus: I, child: L, colorScheme: l }),
                                ),
                                S,
                            ),
                            c,
        ...
        99830: (e, t, r) => {
            ...
            r.d(t, { E: () => a });
            var n = r(44020),
                a = r(97512).O ? n.useLayoutEffect : n.useEffect;
        },
    },
]);
