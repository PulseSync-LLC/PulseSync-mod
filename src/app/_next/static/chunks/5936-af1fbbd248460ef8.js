(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5936],
    {
        ...
        49825: (e) => {
            e.exports = { root: 'RestrictionBlock_root__P_g9o', restrictions: 'RestrictionBlock_restrictions__BhR_r' };
        },
        67053: (e) => {
            e.exports = {
        ...
        78597: (e, t, i) => {
            ...
            let c = s.gK.model('ContextItem', {
                ...
                u = s.gK.model('RestrictonValue', { value: s.gK.string, title: s.gK.string, seed: s.gK.string, imageUrl: s.gK.maybe(s.gK.string) }),
                d = s.gK.model('Restricton', { type: s.gK.enumeration(Object.values(l)), title: s.gK.string, values: s.gK.array(u) }),
                p = s.gK
                    .compose(
                    ...
                    .actions((e) => ({
                        getData: (0, s.L3)(function* (t) {
                            let { rotorResource: i, modelActionsLogger: a } = (0, s._$)(e);
                ...
                S = {
                    7672: (e, t, i) => {
                        ...
                        function g(e) {
                            ...
                            for (m in ((h.current = Object.assign({}, v.current)), (v.current = Object.assign(Object.assign({}, l), e)), l))
                                void 0 === v.current[m] && (v.current[m] = l[m]);
                            let [x, y] = n.useMemo(
                                () =>
                                    (function (e, t) {
                                        let i = (t) => {
                                                ...
                                                (i && t.touches.length > 1) ||
                                                    e((e, s) => {
                                                        s.trackMouse && !i && (document.addEventListener(u, n), document.addEventListener(d, m));
                                                        let { clientX: a, clientY: o } = i ? t.touches[0] : t,
                                                            r = p([a, o], s.rotationAngle);
                                                        return (
                                                            s.onTouchStartOrOnMouseDown && s.onTouchStartOrOnMouseDown({ event: t }),
                                                            Object.assign(Object.assign(Object.assign({}, e), c), { initial: r.slice(), xy: r, start: t.timeStamp || 0 })
                                                        );
                                                    });
                                            },
                                            n = (t) => {
                                                e((e, i) => {
                                                    var n, c, u, d;
                                                    let g = 'touches' in t;
                                                    if (g && t.touches.length > 1) return e;
                                                    if (t.timeStamp - e.start > i.swipeDuration)
                                                        return e.swiping ? Object.assign(Object.assign({}, e), { swiping: !1 }) : e;
                                                    let { clientX: m, clientY: b } = g ? t.touches[0] : t,
                                                        [_, v] = p([m, b], i.rotationAngle),
                                                        h = _ - e.xy[0],
                                                        x = v - e.xy[1],
                                                        y = Math.abs(h),
                                                        S = Math.abs(x),
                                                        E = (t.timeStamp || 0) - e.start,
                                                        f = Math.sqrt(y * y + S * S) / (E || 1),
                                                        N = [h / (E || 1), x / (E || 1)],
                                                        T = ((n = y), (c = S), (u = h), (d = x), n > c ? (u > 0 ? a : s) : d > 0 ? r : o),
                                                        B = 'number' == typeof i.delta ? i.delta : i.delta[T.toLowerCase()] || l.delta;
                                                    if (y < B && S < B && !e.swiping) return e;
                                                    let j = {
                                                        absX: y,
                                                        absY: S,
                                                        deltaX: h,
                                                    ...
                                                    return (
                                                        ...
                                                        O && i.preventScrollOnSwipe && i.trackTouch && t.cancelable && t.preventDefault(),
                                                    ...
                                                    null !== t &&
                                                        e((e, i) => {
                                                            ...
                                                            return (
                                                                ...
                                                                i.trackTouch && t && (n.cleanUpTouch = b(t, i)),
                            ...
                            return (
                                ...
                                (_.current =
                                    i.trackTouch && t.el
                                        ? t.cleanUpTouch
                                            ? i.preventScrollOnSwipe !== g.preventScrollOnSwipe || i.touchEventOptions.passive !== g.touchEventOptions.passive
                    ...
                    1381: (e, t, i) => {
                                ...
                                requestAnimationFrame(() => {
                                    t.current &&
                                        ...
                                        (t.current.style.transform =
                                            a === n.TOP || a === n.BOTTOM ? 'translateY('.concat(i || 0, 'px)') : 'translateX('.concat(s || 0, 'px)')));
                                });
                            },
                            r = (e) => {
                                requestAnimationFrame(() => {
                        ...
                        t.useComponentSwipeable = (e) => {
                            let { ref: t, swipeableProps: i = {}, onClose: l, disableSwipe: c, placement: u, threshold: d } = e,
                                ...
                                g = (0, a.useCallbackRef)((e) => {
                                    c ||
                                        ((e) => {
                                            ...
                                            switch (a) {
                                                case n.TOP:
                                                    i <= 0 && o({ ref: t, deltaY: i, deltaX: s, placement: a });
                                                    break;
                                                case n.RIGHT:
                                                    s >= 0 && o({ ref: t, deltaY: i, deltaX: s, placement: a });
                                                    break;
                                                case n.LEFT:
                                                    s <= 0 && o({ ref: t, deltaY: i, deltaX: s, placement: a });
                                                    break;
                                ...
                                m = (0, a.useCallbackRef)((e) => {
                                    !c &&
                                        (((e) => {
                                            let { ref: t, deltaY: i, deltaX: s, placement: a, threshold: o = 25 } = e;
                                            if (!t.current) return !1;
                                            let r = (o / 100) * (a === n.TOP || a === n.BOTTOM ? t.current.offsetHeight : t.current.offsetWidth);
                                            switch (a) {
                                                case n.TOP:
                            ...
                            return { handlers: (0, s.useSwipeable)({ onSwiped: m, onSwiping: g, trackMouse: !0, trackTouch: !0, ...i }), onCloseCallback: p };
                        };
                    },
                    810: (e) => {
                        e.exports = _;
            ...
            ((() => {
                ...
                N.usePopoverSwipeable = (i) => {
                    let { ref: n, swipeableProps: s = {}, onClose: a, disableSwipe: o, placement: r, threshold: l } = i,
                        c = (0, e.useMemo)(() => {
                            switch (r) {
                                case 'top':
                                case 'top-end':
            ...
            let G = (e) => {
                ...
                return (0, g.jsxs)('section', {
                    ...
                    children: [
                        (0, g.jsx)(C.Caption, { variant: 'span', type: 'text', size: 'm', weight: 'medium', 'aria-hidden': !0, children: t }),
                        (0, g.jsx)(P.q, { children: (0, g.jsx)(C.Heading, { variant: 'h4', children: t }) }),
                        (0, g.jsx)('div', { className: (0, k.$)(L().restrictions, n), children: i }),
                    ],
                });
            };
            var U = i(52756);
            let K = (e) => {
                ...
                let { seed: a, title: o, isStation: r } = e,
                    ...
                    { applySetting: c } = (0, n.B0S)({
                        seeds: null != (s = null == (t = l.meta) ? void 0 : t.seeds) ? s : [],
                    ...
                    g = (0, b.useMemo)(
                        () => (d ? ''.concat(u({ id: 'vibe-actions.remove' }), ' ').concat(o) : ''.concat(u({ id: 'vibe-actions.apply' }), ' ').concat(o)),
                        [d, o, u],
                    );
                return {
                    isApplying: p,
            ...
            let X = (0, m.PA)((e) => {
                    let { item: t } = e,
                        { vibe: i } = (0, n.Pjs)(),
                        s = (0, b.useRef)(null),
                        { isApplying: a, isSelected: o, ariaPressed: r, onClickHandler: l } = K({ seed: t.seed, title: t.title, isStation: !0 }),
                        c = (0, b.useCallback)(
                            (e) => {
                                i.isApplying || (s.current && (0, j.P)(e, D().ripple, s.current), l());
                            },
                            [l, i.isApplying],
                        );
                    return (0, g.jsxs)(O.Button, {
                        radius: 'xxxl',
                        className: (0, k.$)(D().button, D().textButton, { [D().button_selected]: o, [D().button_applying]: a, [D().specialButton]: t.specialContext }),
                        onClick: c,
                        ...
                        children: [
                            t.specialContext &&
                                (0, g.jsx)(U.Image, { className: D().specialImage, src: t.specialContextImage, size: 100, fit: 'cover', withAvatarReplace: !0 }),
                            (0, g.jsx)(C.Caption, { variant: 'span', type: 'controls', size: 'm', weight: 'medium', className: D().title, children: t.title }),
                            (0, g.jsx)('div', { className: D().rippleContainer, ref: s }),
                        ],
                    });
                }),
                F = (0, m.PA)((e) => {
                    let { type: t, restrictionValue: i } = e,
                        { vibe: s } = (0, n.Pjs)(),
                        a = (0, b.useRef)(null),
                        { isApplying: o, isSelected: r, ariaPressed: c, onClickHandler: u } = K({ seed: i.seed, title: i.title }),
                        d = (0, b.useCallback)(
                            (e) => {
                                s.isApplying || (a.current && (0, j.P)(e, D().ripple, a.current), u());
                            },
                            [u, s.isApplying],
                        ),
                        p = (0, b.useMemo)(
                            () => (0, g.jsx)(C.Caption, { variant: 'span', type: 'controls', size: 'm', weight: 'medium', className: D().title, children: i.title }),
                            [i.title],
                        );
                    switch (t) {
                        case l.DIVERSITY:
                            return (0, g.jsxs)(O.Button, {
                                className: (0, k.$)(D().button, D().diversityButton, { [D().button_selected]: r, [D().button_applying]: o }),
                                radius: 'xl',
                                ...
                                children: [
                                    ...
                                    p,
                                    (0, g.jsx)('div', { className: D().rippleContainer, ref: a }),
                                ],
                            });
                        case l.MOOD_ENERGY:
                            return (0, g.jsxs)('div', {
                                ...
                                children: [
                                    (0, g.jsx)(O.Button, {
                                        variant: 'text',
                                        className: (0, k.$)(D().button, D().moodEnergyButton, { [D().button_selected]: r, [D().button_applying]: o }),
                                        radius: 'round',
                                        onClick: d,
                                        withRipple: !1,
                                        'aria-disabled': s.isApplying,
                                        ...
                                        children: (0, g.jsx)(U.Image, {
                                            ...
                                            'aria-hidden': !0,
                                            withAvatarReplace: !0,
                                            className: D().moodEnergyButtonImage,
                                        }),
                                    }),
                                    (0, g.jsx)('span', { 'aria-hidden': !0, children: p }),
                                ],
                            });
                        case l.LANGUAGE:
                            return (0, g.jsxs)(O.Button, {
                                radius: 'xxxl',
                                className: (0, k.$)(D().button, D().textButton, { [D().button_selected]: r, [D().button_applying]: o }),
                                onClick: d,
                                withRipple: !1,
                                'aria-disabled': s.isApplying,
                                'aria-pressed': c,
                                ...(0, x.Am)(x.Kq.vibeSettings.VIBE_SETTINGS_LANGUAGE_BUTTON),
                                children: [p, (0, g.jsx)('div', { className: D().rippleContainer, ref: a })],
                            });
                        default:
                            return null;
                    }
                        ...
                        children: [
                            e.contextItems.length > 0 &&
                                (0, g.jsx)(G, {
                                    ...
                                    children: e.contextItems.map((e) => (0, g.jsx)(X, { item: e, ...(0, x.Am)(x.Kq.vibeSettings.VIBE_SETTINGS_CONTEXT_BUTTON) }, e.seed)),
                                }),
                            e.diversity &&
                                (0, g.jsx)(G, {
                                    ...
                                    children: e.diversity.values.map((t) => {
                                        var i;
                                        return (0, g.jsx)(F, { type: null == (i = e.diversity) ? void 0 : i.type, restrictionValue: t }, t.value);
                                    }),
                                }),
                            e.moodEnergy &&
                                (0, g.jsx)(G, {
                                    ...
                                    children: e.moodEnergy.values.map((t) => {
                                        var i;
                                        return (0, g.jsx)(F, { type: null == (i = e.moodEnergy) ? void 0 : i.type, restrictionValue: t }, t.value);
                                    }),
                                }),
                            e.language &&
                                (0, g.jsx)(G, {
                                    ...
                                    children: e.language.values.map((t) => {
                                        var i;
                                        return (0, g.jsx)(F, { type: null == (i = e.language) ? void 0 : i.type, restrictionValue: t }, t.value);
                                    }),
                                }),
                        ],
                    })
            ...
            let J = (0, m.PA)(() => {
                ...
                let { formatMessage: a } = (0, v.A)(),
                    ...
                    p = (0, b.useRef)(null),
                    m = (0, b.useRef)(null),
                    { resetSettings: _ } = (0, n.B0S)({ seeds: null != (s = null == (e = o.meta) ? void 0 : e.seeds) ? s : [], pageIdForFrom: c, blockIdForFrom: u }),
                    { contentRef: S } = (0, n.gKY)(),
                    { contentHeight: E } = w(0),
                ...
                let M = (0, b.useMemo)(
                        () => (r ? { height: '88vh', transitionProperty: 'opacity' } : S ? { insetInlineEnd: 7, insetBlockStart: S.offsetTop + 7, height: E - 16 } : {}),
                        [E, S, r],
                    ),
                        ...
                        if (
                            ((e) =>
                                ...
                                e.some((e) => {
                                    ...
                                    return e === n.M19 || (t && n.UMA.includes(t));
                            ...
                            return (null == (t = o.meta) ? void 0 : t.context)
                                ? (0, g.jsx)(O.Button, {
                                      ...
                                      size: 'm',
                                      radius: 'round',
                                      icon: (0, g.jsx)(I.Icon, { variant: 'filter', size: 'xs' }),
                                ...
                                : (0, g.jsx)(O.Button, {
                                      ...
                                      size: 'default',
                                      radius: 'xxxl',
                                      icon: (0, g.jsx)(I.Icon, { variant: 'filter', size: 'xxs' }),
                                      'aria-label': a({ id: 'vibe-actions.aria-label-settings' }),
                                      ...(0, x.Am)(x.Kq.vibeSettings.VIBE_SETTINGS_BUTTON),
                                      children: (0, g.jsx)(C.Caption, {
                                          ...
                                          size: 'm',
                                          weight: 'medium',
                                          children: (0, g.jsx)(h.A, { id: 'interface-actions.configure-my-vibe' }),
                                      }),
                                  });
                    }, [a, null == (t = o.meta) ? void 0 : t.context, null == (i = o.meta) ? void 0 : i.seeds]),
                    { handlers: G } = T({ ref: m, onClose: k, placement: 'bottom', disableSwipe: !r, swipeableProps: { preventScrollOnSwipe: !0 } });
                    ...
                    children: [
                        ...
                        (0, g.jsx)(A.hl, {
                            ...
                            children: (0, g.jsxs)('div', {
                                className: $().root,
                                children: [
                                    r && (0, g.jsx)('div', { ref: G.ref, onMouseDown: G.onMouseDown, className: $().swipeableArea }),
                                    (0, g.jsxs)('div', {
                                        className: $().header,
                                        children: [
                                            (0, g.jsx)(C.Heading, {
                                                ...
                                                children: (0, g.jsx)(h.A, { id: 'interface-actions.my-vibe-settings' }),
                                            }),
                                            (0, g.jsxs)('div', {
                                                className: $().actions,
                                                children: [
                                                    (0, g.jsx)(R.m_, {
                                                        ...
                                                        children: (0, g.jsx)(O.Button, {
                                                            variant: 'outline',
                                                            radius: 'round',
                                                            size: 'xxxs',
                                                            icon: (0, g.jsx)(I.Icon, { variant: 'reset', size: 'xxxs' }),
                                                            onClick: V,
                                                            disabled: !!o.isMyVibe,
                                                            'aria-hidden': !!o.isMyVibe,
                                                            'aria-disabled': P,
                                                    ...
                                                    (0, g.jsx)(O.Button, {
                                                        ...
                                                        color: 'secondary',
                                                        size: 'xxs',
                                                        icon: (0, g.jsx)(I.Icon, { variant: 'close', size: 'xxs' }),
                                                        onClick: k,
        ...
        95936: (e, t, i) => {
            ...
            let j = (0, a.PA)((e) => {
                let { withVideoModal: t } = e,
                    { main: i, user: a, experiments: T, releaseNotes: j, fullscreenVideoPlayer: O } = (0, f.Pjs)(),
                    { formatMessage: I } = (0, l.A)(),
                    A = (0, f.HFS)(),
                    { contentScrollRef: R, setContentScrollRef: C } = (0, f.gKY)(),
                    [w, k] = (0, d.d)(),
                ...
                let z = T.checkExperiment(f.zal.WebNextDisableVibe, 'on'),
                    ...
                    X = (0, r.useMemo)(() => (z ? { 'margin-block-start': '1vh' } : {}), [z]),
                    F = (0, r.useMemo)(() => {
                        if (T.checkExperiment(f.zal.WebNextBetaLabel, 'off')) return null;
                        {
                            let e = T.checkExperiment(f.zal.WebNextBetaLabel, 'version'),
                                t = I({ id: 'desktop.app-version' }, { version: A }),
                                i = e ? A : 'Beta';
                            return (0, n.jsxs)(b.m_, {
                                ...
                                children: [
                                    (0, n.jsx)(g.Button, {
                                        ...
                                        className: (0, s.$)(B().beta, { [B().beta_withReleaseNotes]: j.isReady }),
                                        onClick: D,
                                        children: (0, n.jsx)(_.Caption, { variant: 'div', type: 'text', size: 's', weight: 'medium', children: i }),
                                    }),
                    ...
                    Y = (0, p.L)(() =>
                        T.checkExperiment(f.zal.WebNextFooterDisclaimer, 'on')
                            ...
                            : (0, n.jsx)(N.A, { children: (0, n.jsx)(N.wi, { className: B().footer }) }),
                    );
                if (i.landing.isNeededToLoad) {
                    let e = a.isAuthorized ? u.p.MAIN : u.p.MAIN_NOLOGIN;
                    (0, r.use)(i.landing.getSkeleton({ id: e, showWizard: a.settings.showWizard }, { preloadBlocksCount: 2 }));
                }
                return (
                    t && !U && (0, o.notFound)(),
                    (0, n.jsx)(f.nVz, {
                            ...
                            children: (0, n.jsx)(S.hO, {
                                ...
                                children: (0, n.jsxs)(m.N, {
                                    ...
                                    children: [
                                        ...
                                        !z &&
                                            (0, n.jsx)(f.FoH, {
                                                blockIdForFrom: f.hf$.RUP_MAIN_RADIO,
                                                blockId: f.UfI.RUP,
                                                blockType: f.UfI.RUP,
                                                blockPosX: 0,
                                                blockPosY: 0,
                                                objectsCount: 0,
                                                children: (0, n.jsx)(x.C, { className: B().vibe }),
                                            }),
                                        (0, n.jsx)(v.EA, {
                                            landing: i.landing,
                                            headerConcealerComponent: (0, n.jsx)('div', { ref: k }),
                                            errorComponent: (0, n.jsx)(h.w, { className: B().error, withBackwardControl: !1 }),
        ...
        96342: (e, t, i) => {
            ...
            let l = s.gK
                .compose(
                    s.gK.model('VibeActions', {
                        ...
                        vibeResetLoadingState: s.gK.enumeration(Object.values(o.GuX)),
                    }),
                    r.XT,
                )
                .views((e) => ({
                    get isMyVibe() {
                        return e.meta && 1 === e.meta.seeds.length && e.meta.seeds[0] === o.M19;
                    },
                }))
                .actions((e) => ({
            ...
            let O = !0,
                I = (0, d.PA)((e) => {
                    let { isPlaying: t, onClick: i, ariaDisabled: n, className: s } = e,
                        ...
                        _ = t ? b.e8.vibe.MY_VIBE_PAUSE_BUTTON : b.e8.vibe.MY_VIBE_PLAY_BUTTON,
                    ...
                    return (
                        ...
                        (0, c.jsx)(x.Button, {
                            className: (0, u.$)(j().root, { [j().root_isVibeLoading]: a.isApplying }, s),
                            withRipple: !1,
                            withHover: !1,
                            onClick: h,
                            variant: 'text',
                            ...
                            'aria-label': v,
                            icon: (0, c.jsx)(T.Icon, { size: 's', className: j().icon, variant: p }),
                            ...(0, b.Am)(_),
                            children: (0, c.jsx)(m.A, { id: 'entity-names.my-vibe' }),
                        })
                    );
                });
            ...
            let P = (0, d.PA)((e) => {
                    ...
                    let { context: i, onResetClick: n, className: s } = e,
                        ...
                        _ = (0, C.L)(() => {
                            var e;
                            return d.checkExperiment(o.zal.WebNextVibeDescription, 'on') && (null == (e = r.meta) ? void 0 : e.isMix)
                                ? p({ id: 'vibe-actions.vibe-context' }, { type: r.meta.type, name: i })
                                : i;
                        });
                    return (0, c.jsxs)('div', {
                        ...
                        children: [
                            ...
                            i &&
                                (0, c.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, c.jsx)(y.Caption, { variant: 'span', type: 'controls', size: 'm', weight: 'medium', lineClamp: 1, children: _ }),
                                        (0, c.jsx)(x.Button, {
                                            className: M().resetButton,
                                            variant: 'text',
                                            radius: 'round',
                                            withRipple: !1,
                                            icon: (0, c.jsx)(T.Icon, { variant: 'close', size: 'xxs' }),
                                            onClick: n,
                                            'aria-label': ''.concat(p({ id: 'vibe-actions.reset-settings' }), ' ').concat(_),
                                            ...(0, b.Am)(b.e8.vibe.RESET_VIBE_CONTEXT_BUTTON),
                                        }),
                                    ],
                                }),
                        ],
                ...
                G = (0, d.PA)((e) => {
                    ...
                    let { className: a } = e,
                        ...
                        { isFreemium: C } = (0, o.XCI)(),
                        {
                            ...
                            mainTextA11y: K,
                            additionText: z,
                        } = (0, o.DpZ)({ storeName: 'music', isEnabled: C, offerElement: { element: B, intersectionPropertyId: L } }),
                        { isIntersecting: D } = null != (n = (0, h.BL)([T], { preflightCheck: !1 }, !T.current)[V]) ? n : {},
                        X = (0, o.NFA)().get(o.QGx),
                        {
                            isVibeContext: F,
                            isPlaying: Y,
                            togglePlay: q,
                            resetSettings: W,
                        } = (0, o.B0S)({ seeds: null != (s = null == (t = l.meta) ? void 0 : t.seeds) ? s : [], pageIdForFrom: O, blockIdForFrom: A }),
                        H = d.checkExperiment(o.zal.WebNextDisableVibeSettings, 'on') || C || !N.isAuthorized,
                        $ = (0, g.useCallback)(() => {
                            F ? W() : l.vibeResetLoadingState !== o.GuX.PENDING && l.vibeReset();
                        }, [F, l, W]),
                        J = (0, g.useCallback)(() => {
                            if (!N.isAuthorized) {
                        ...
                        ee = (0, g.useMemo)(
                            () =>
                                d.checkExperiment(o.zal.WebNextShaderFallbackEnabled, 'on')
                                    ? (0, c.jsx)(S, { className: R().vibeAnimation })
                                    : (0, c.jsx)(E, { isIntersecting: D, className: R().vibeAnimation }),
                            [d, D],
                        ),
                        et = (0, _.c)(() => {
                        ...
                        ei = (0, g.useMemo)(
                            () =>
                                d.checkExperiment(o.zal.WebNextUnauthorizedSubscriptionButton, 'on')
                                    ? (0, c.jsxs)(x.Button, {
                                          isBlock: !0,
                                          radius: 'xxxl',
                                          size: 'l',
                                          ...
                                          className: R().button,
                                          onClick: et,
                                          ...(0, b.Am)(b.e8.vibe.MY_VIBE_SUBSCRIPTION_BUTTON_UNAUTH),
                                          children: [
                                              (0, c.jsx)(y.Caption, { className: R().text_main, variant: 'div', size: 'l', children: U }),
                                              z && (0, c.jsx)(y.Caption, { className: R().text_addition, variant: 'div', size: 'm', children: z }),
                                          ],
                                      })
                                    : (0, c.jsx)(f.Hi, { size: 'l', className: R().button }),
                            [z, d, et, U],
                        );
                    return (
                        (0, g.useEffect)(() => {
                            ...
                            window.pulsesyncApi.playVibeNative = fn;

                            return () => {
                                if (window.pulsesyncApi && window.pulsesyncApi.playVibeNative === fn) {
                                    delete window.pulsesyncApi.playVibeNative;
                                }
                            };
                        }, [Q]),
                        (0, g.useEffect)(
                        ...
                        (0, c.jsxs)('div', {
                            className: (0, u.$)(R().root, { [R().root_freemium]: C || !N.isAuthorized }, a),
                            ref: T,
                            ...
                            children: [
                                ...
                                (0, c.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, c.jsx)(I, { className: R().playButton, isPlaying: Y, ariaDisabled: C || !N.isAuthorized, onClick: Q }),
                                        !H && (0, c.jsx)(P, { className: R().settingsButton, context: null == (i = l.meta) ? void 0 : i.context, onResetClick: $ }),
                                        (C || !N.isAuthorized) &&
                                            (0, c.jsx)(y.Caption, {
                                                className: R().subscriptionText,
                                                variant: 'div',
                                                size: 'l',
                                                ...(0, b.Am)(b.e8.vibe.MY_VIBE_SUBSCRIPTION_TEXT),
                                                children: (0, c.jsx)(m.A, { id: 'vibe-freemium.available-in-plus', values: { br: (0, c.jsx)('br', {}) } }),
                                            }),
                                        !N.isAuthorized && ei,
                                        N.isAuthorized &&
                                            C &&
                                            (0, c.jsx)(f.b4, {
                                                ...
                                                additionText: z,
                                                className: R().button,
                                                ...(0, b.Am)(b.e8.vibe.MY_VIBE_SUBSCRIPTION_BUTTON),
                                            }),
                                    ],
                                }),
                            ],
