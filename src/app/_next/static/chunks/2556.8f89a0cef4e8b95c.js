                        ...
                        let m = () => {
                            ...
                            h({ version: t })
                                .then(() => {
                                    ...
                                    let s = window.Ya.YaspAudioElement;
                                    s.messenger.on('yasp-event', this.yaspEventHandler);
                                    let o = this.getTelemetryTestIds ? this.getTelemetryTestIds() : void 0;
                                    null == (t = this.yaspTelemetry) || t.setStaticParams({ testIds: o }), s.setWorkerConfig({ sourceLimit: r, perfLogUrl: i }), e();
                                })
                                .catch((e) => {
