        ...
        57747: (e, t, r) => {
            ...
            var n,
                ...
                a = {
                    ...
                    7672: (e, t, r) => {
                        r.r(t), r.d(t, { DOWN: () => l, LEFT: () => o, RIGHT: () => u, UP: () => a, useSwipeable: () => b });
                        var n = r(810);
                        let o = 'Left',
                            u = 'Right',
                            a = 'Up',
                        ...
                        function b(e) {
                            ...
                            for (p in ((m.current = Object.assign({}, O.current)), (O.current = Object.assign(Object.assign({}, s), e)), s))
                                void 0 === O.current[p] && (O.current[p] = s[p]);
                            let [h, y] = n.useMemo(
                                () =>
                                    (function (e, t) {
                                        let r = (t) => {
                                                ...
                                                (r && t.touches.length > 1) ||
                                                    e((e, o) => {
                                                        o.trackMouse && !r && (document.addEventListener(c, n), document.addEventListener(f, p));
                                                        let { clientX: u, clientY: a } = r ? t.touches[0] : t,
                                                            l = d([u, a], o.rotationAngle);
                                                        return (
                                                            o.onTouchStartOrOnMouseDown && o.onTouchStartOrOnMouseDown({ event: t }),
                                                            Object.assign(Object.assign(Object.assign({}, e), i), { initial: l.slice(), xy: l, start: t.timeStamp || 0 })
                                                        );
                                                    });
                                            },
                                            n = (t) => {
                                                e((e, r) => {
                                                    ...
                                                    let { clientX: p, clientY: v } = b ? t.touches[0] : t,
                                                        ...
                                                        E = [m / (S || 1), h / (S || 1)],
                                                        T = ((n = y), (i = w), (c = m), (f = h), n > i ? (c > 0 ? u : o) : f > 0 ? l : a),
                                                        R = 'number' == typeof r.delta ? r.delta : r.delta[T.toLowerCase()] || s.delta;
                                                    if (y < R && w < R && !e.swiping) return e;
                                                    let P = {
                                                        absX: y,
                                                        absY: w,
                                                        deltaX: m,
                                            ...
                                            b = (t) => {
                                                e((e, r) => {
                                                    ...
                                                    return (
                                                        ...
                                                        Object.assign(Object.assign(Object.assign({}, e), i), { eventData: n })
                                                    );
                                                });
                                            },
                                            p = (e) => {
                                    ...
                                    })((e) => (g.current = e(g.current, O.current)), { trackMouse: v }),
                                [v],
                            );
                            return (
                                (t = g.current),
                    ...
                    1381: (e, t, r) => {
                        ...
                        t.useComponentSwipeable = (e) => {
                            let { ref: t, swipeableProps: r = {}, onClose: s, disableSwipe: i, placement: c, threshold: f } = e,
                                ...
                                p = (0, u.useCallbackRef)((e) => {
                                    !i &&
                                        (((e) => {
                                            ...
                                            let l = (a / 100) * (u === n.TOP || u === n.BOTTOM ? t.current.offsetHeight : t.current.offsetWidth);
                                            switch (u) {
                                                case n.TOP:
                            ...
                            return { handlers: (0, o.useSwipeable)({ onSwiped: p, onSwiping: b, trackMouse: !0, trackTouch: !0, ...r }), onCloseCallback: d };
                        };
                    },
                    6699: (e, t, r) => {
                    ...
                    5663: (e, t, r) => {
                        ...
                        (t.defaultOptions = { threshold: 0, preflightCheck: !0 }),
                            ...
                            (t.useIntersectionObserver = function (e, r, o) {
                                let [{ freezeOnceVisible: u, preflightCheck: i, ...c }, f = !1] =
                    ...
                    4395: (e, t, r) => {
                        ...
                        t.usePopoverSwipeable = (e) => {
                            let { ref: t, swipeableProps: r = {}, onClose: u, disableSwipe: a, placement: l, threshold: s } = e,
                                i = (0, n.useMemo)(() => {
                                    switch (l) {
                                        case 'top':
                                        case 'top-end':
                            ...
                            return (0, o.useComponentSwipeable)({ ref: t, swipeableProps: r, onClose: u, disableSwipe: a, placement: i, threshold: s });
                        };
                    },
                    2947: (e, t, r) => {
                    ...
                    2067: (e, t, r) => {
                        ...
                        t.useScroll = (e) => {
                            let { onScroll: t, listenIsScrolling: r, elementRef: a } = e,
                                { state: l, handleDebouncedToggle: s } = (0, u.useDebouncedToggle)({ delay: 1e3, throttleTimeout: 100 }),
                                i = (0, n.useCallback)(() => {
                                    r && s(), null == t || t();
                                }, [r, s, t]);
                            return (
                    ...
                    8429: function (e, t, r) {
                        ...
                        (t.ScrollableContentComponent = (e) => {
                            let { forwardRef: t, className: r, containerClassName: n, children: u, ...i } = e,
                                c = (0, l.useForwardRef)(t, null),
                                f = (0, l.useScroll)({ listenIsScrolling: !0, elementRef: c });
                            return (0, o.jsx)('div', {
                                className: (0, a.clsx)(s.default.root, { [s.default.root_scrolling]: f, [s.default.root_notScrolling]: !f }, r),
                                ref: c,
                                ...i,
                                children: (0, o.jsx)('div', { className: (0, a.clsx)(s.default.container, n), children: u }),
                            });
                        }),
                            (t.ScrollableContent = (0, u.forwardRef)((e, r) => (0, o.jsx)(t.ScrollableContentComponent, { forwardRef: r, ...e })));
                    },
                    352: (e) => {
                        e.exports = o;
                    },
