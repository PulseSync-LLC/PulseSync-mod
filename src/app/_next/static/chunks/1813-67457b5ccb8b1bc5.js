(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [1813],
    {
        537: (e, s, t) => {
            'use strict';
            t.d(s, { mi: () => m.SortDropdown, wY: () => d, WG: () => i.W, hl: () => r, y8: () => n.useSort });
            var i = t(25585),
                o = t(19964);
            ...
            var n = t(99963),
                ...
                a = t(75729);
            let d = l.gK
                .model('Sort', { sortBy: l.gK.maybe(l.gK.enumeration(Object.values(a.g))), sortOrder: l.gK.maybe(l.gK.enumeration(Object.values(o.x))) })
                .actions((e) => ({
                    setSortBy(s) {
                        e.sortBy = s;
                    },
        ...
        2614: (e, s, t) => {
            ...
            var i = t(33008),
                ...
                P = t(3417),
                c = t.n(P);
            let p = { [l.g.RATING]: (0, i.jsx)(n.A, { id: 'sort.sort-by-rating' }), [l.g.YEAR]: (0, i.jsx)(n.A, { id: 'sort.sort-by-year' }) },
                x = (0, o.PA)((e) => {
                    var s;
                    let { sortModel: t, onSort: o } = e,
                        ...
                        x = (0, a.c)((e) => {
                            (0, u.W)(e.id) && t.sortBy !== e.id && (t.setSortBy(e.id), o());
                        }),
                        _ = (0, r.useMemo)(
                            () =>
                                P
                                    ? (0, i.jsx)(d.Button, { radius: 'xxxl', className: c().button, icon: (0, i.jsx)(b.Icon, { variant: 'filter', size: 'xs' }) })
                                    : (0, i.jsxs)(d.Button, {
                                          radius: 'xxxl',
                                          className: c().button,
                                          children: [
                                              (0, i.jsx)(h.Caption, {
                                                  ...
                                                  size: 'm',
                                                  weight: 'medium',
                                                  children: t.sortBy ? p[t.sortBy] : (0, i.jsx)(n.A, { id: 'sort.select-filter' }),
                                              }),
                                              (0, i.jsx)(b.Icon, { size: 'xxs', variant: 'arrowDown' }),
                                          ],
                                      }),
                            [P, t.sortBy],
                        );
                    return (0, i.jsx)(m.ms, {
                        ...
                        header: P ? (0, i.jsx)('div', { className: c().header }) : void 0,
                        children: Object.values(l.g).map((e) => (0, i.jsx)(m.c$, { id: e, label: p[e] }, e)),
                    });
                });
        },
        3417: (e) => {
        ...
        27618: (e, s, t) => {
            ...
            var i = t(33008),
                ...
                u = t.n(v);
            let P = (0, r.PA)((e) => {
                let { className: s, title: t, description: r, iconVariant: v = 'musicLogo', iconClassName: P, iconSize: c } = e,
                ...
                return (
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, o.$)(u().root, { [u().root_desktop]: !p }, s),
                        children: [
                            (0, i.jsx)(b.Lh, { withBackwardFallback: '/', className: u().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: u().content,
                                children: [
                                    (0, i.jsx)(a.Icon, { className: (0, o.$)(u().icon, P), variant: v, size: c }),
                                    (0, i.jsx)(d.Heading, {
                                        className: (0, o.$)(u().title, u().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: t || (0, i.jsx)(n.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, i.jsx)(d.Caption, {
        ...
        56932: (e, s, t) => {
            ...
            let f = (0, r.PA)((e) => {
                ...
                let { labelId: f, preloadedLabel: S } = e,
                    ...
                    { contentScrollRef: k, setContentScrollRef: E } = (0, N.gKY)(),
                    { notify: R } = (0, N.lkh)(),
                    { shareLink: F } = (0, N.bNS)('/label/:labelId', { params: { labelId: null != (t = w.id) ? t : '' } }),
                    I = (0, l.useRef)(null),
                    z = (0, l.useRef)(0);
                        ...
                        () =>
                            B
                                ? (0, i.jsx)(h.Button, {
                                      className: L().button,
                                      onClick: O,
                                      icon: (0, i.jsx)(v.Icon, { variant: 'share', size: 'xxs' }),
                                      size: 'l',
                                      radius: 'xxxl',
                                ...
                                : (0, i.jsx)(h.Button, {
                                      ...
                                      radius: 'xxxl',
                                      ...(0, m.Am)(m.Xk.label.SHARE_COPY_LINK_BUTTON),
                                      children: (0, i.jsx)(d.A, { id: 'interface-actions.share' }),
                                  }),
                        [B, O],
                    ),
                    W = w.isPublisher ? T({ id: 'entity-names.publisher' }) : T({ id: 'entity-names.label' }),
                    D = w.isPublisher ? T({ id: 'entity-names.non-music-releases' }) : T({ id: 'entity-names.releases' });
                ...
                (w.isNotFound || !C.checkExperiment(N.zal.WebNextLabelPage, 'on')) && (0, n.notFound)(),
                (0, l.useEffect)(
                    () => () => {
                        z.current = 0;
                    },
                ...
                (0, l.useEffect)(() => {
                    w.isRejected &&
                        z &&
                        !(z.current > 0) &&
                        (R((0, i.jsx)(y.hT, { error: T({ id: 'error-messages.error-load-part-page' }) }), { containerId: N.uQT.ERROR }), z.current++);
                }, [w.isRejected, R, T]),
                (0, N.Jzs)(w.isResolved),
                w.isNeededToLoad && (0, l.use)(w.getData({ labelId: Number(f), preloadedLabel: S })),
                                  ...
                                  (0, i.jsxs)(u.N, {
                                      ...
                                      children: [
                                          (0, i.jsxs)('div', {
                                              className: L().header,
                                              children: [
                                                  (0, i.jsx)(P.Caption, { variant: 'div', type: 'text', size: 'm', weight: 'medium', children: W }),
                                                  (0, i.jsx)(c.RR, { className: L().title, title: w.name || '', headingVariant: 'h1' }),
                                                  U,
                                              ],
                                          }),
                                          w.hasAlbums &&
                                              ...
                                              (0, i.jsx)(x.pZ, {
                                                  ...
                                                  headerClassName: (0, o.$)(L().carouselBlock, L().carouselBlockHeader),
                                                  containerClassName: L().carouselBlock,
                                                  title: D,
                                          ...
                                          w.hasArtists &&
                                              (0, i.jsx)(y.OY, {
                                                  isShimmerVisible: w.isLoading,
                                                  isShimmerActive: !0,
                                                  headerClassName: (0, o.$)(L().carouselBlockHeader, L().carouselBlock),
                                                  containerClassName: L().carouselBlock,
                                                  viewAllActionLink: w.artistsUrl,
                                                  title: T({ id: 'entity-names.artists' }),
                                                  headingVariant: 'h2',
                                                  ...(0, m.Am)(m.Xk.label.ARTISTS_CAROUSEL),
                                                  children: null == (s = w.artists) ? void 0 : s.map((e) => (0, i.jsx)(_.ao, { artist: e, contentLinesCount: 3 }, e.id)),
                                              }),
                                          (0, i.jsx)(y.A, { children: (0, i.jsx)(y.wi, { className: L().footer }) }),
                                      ],
                                  }),
                              ],
                          }),
        ...
        58005: (e, s, t) => {
            ...
            let d = (e, s) => {
                (0, i.useEffect)(() => {
                    switch (s) {
                        case 'root':
                            (0, l.I)(e, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, o.jxB)(e);
                            });
                            break;
                        case 'albums':
                            ...
                            break;
                        case 'artists':
                            (0, n.M)(e, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, o.jxB)(e);
                            });
                    }
                }, [null == e ? void 0 : e.id, null == e ? void 0 : e.type, null == e ? void 0 : e.name, s, e]);
            };
        },
        62175: (e, s, t) => {
            'use strict';
            ...
            async function o(e, s) {
                ...
                let n = await (0, i.WGy)(s.locale),
                    l = n({ id: 'metadata.label-artists-title' }, { labelName: e.name, labelType: e.type }),
                    a = n({ id: 'metadata.label-artists-description' }, { labelName: e.name, labelType: e.type });
                return {
                    title: l,
                    description: a,
                    openGraph: (0, i.i$E)({
                    ...
                    twitter: (0, i.HRN)({ cardType: i.WfF.APP, title: l, url: s.url, appName: n({ id: 'metadata.yandex-music' }) }),
                    appLinks: (0, i.X5i)({
                        additional: { ...s, url: null != (o = s.url) ? o : '', fullUrl: null != (r = s.fullUrl) ? r : '', host: s.host },
                        appName: n({ id: 'metadata.yandex-music' }),
                    }),
                    alternates: (0, i.SEs)('/label/:labelId/artists', s.tld, { params: { labelId: e.id } }),
                };
            }
        },
        68544: (e) => {
        ...
        68811: (e, s, t) => {
            ...
            async function o(e, s) {
                ...
                if (!e) return { title: '', description: '', openGraph: {}, twitter: {}, appLinks: {}, other: {} };
                let n = await (0, i.WGy)(s.locale),
                    l = n({ id: 'metadata.label-albums-title' }, { labelName: e.name, labelType: e.type }),
                    a = n({ id: 'metadata.label-albums-description' }, { labelName: e.name, labelType: e.type });
                return {
                    title: l,
                    description: a,
                    openGraph: (0, i.i$E)({
                    ...
                    alternates: (0, i.SEs)('/label/:labelId/albums', s.tld, { params: { labelId: e.id } }),
                };
            }
        },
        71029: (e, s, t) => {
        ...
        74295: (e, s, t) => {
            ...
            async function o(e, s) {
                ...
                if (!e) return { title: '', description: '', openGraph: {}, twitter: {}, appLinks: {}, other: {} };
                let n = await (0, i.WGy)(s.locale),
                    l = n({ id: 'metadata.label-title' }, { labelTitle: e.name, labelType: e.type }),
                    a = n({ id: 'metadata.label-description' }, { labelTitle: e.name, labelType: e.type });
                return {
                    title: l,
                    description: a,
                    openGraph: (0, i.i$E)({
                    ...
                    alternates: (0, i.SEs)('/label/:labelId', s.tld, { params: { labelId: e.id } }),
                };
            }
        },
        87666: (e, s, t) => {
            ...
            var i = t(33008),
                ...
                g = t.n(_);
            let N = (0, r.PA)((e) => {
                let { labelId: s, preloadedLabel: t, preloadedAlbums: r, sortBy: _ } = e,
                    {
                        label: { id: N, type: y, name: j, albumsSubpage: A, reset: L, isNeededToLoad: f, getData: S, isPublisher: w },
                        settings: { isMobile: B },
                        experiments: C,
                    } = (0, c.Pjs)(),
                    { formatMessage: T } = (0, a.A)(),
                    { contentScrollRef: k, setContentScrollRef: E } = (0, c.gKY)(),
                    R = (0, c.W6M)(),
                    F = w ? T({ id: 'page.label-podcast-header' }, { labelName: j }) : T({ id: 'page.label-albums-header' }, { labelName: j }),
                    I = (0, m.c)((e) => {
                        var t;
                ...
                if (A.isNeededToLoad) {
                    ...
                    W.push(A.getData({ labelId: Number(s), page: 0, pageSize: 20, preloadedAlbums: e ? r : void 0, sortBy: null != (D = A.sort.sortBy) ? D : _ }));
                }
                if (
                    (f && W.push(S({ labelId: Number(s), preloadedLabel: t, withLabelEntities: !1 })),
                        ...
                        children: (0, i.jsxs)('div', {
                            ...
                            children: [
                                (0, i.jsxs)(p.Y9, {
                                    ...
                                    children: [
                                        (0, i.jsx)(b.Heading, { variant: 'h1', weight: 'bold', size: 'xl', lineClamp: 1, children: F }),
                                        (0, i.jsx)(P.mi, { sortModel: A.sort, onSort: z }),
                                    ],
                                }),
                                (0, i.jsx)(p.$$, {
                                    ...
                                    itemContentCallback: (e) => {
                                        let s = A.items[e],
                                            t = T({ id: 'loading-messages.entity-is-loading' }, { entityName: T({ id: 'entity-names.album' }) });
                                        return s
                                            ? (0, i.jsx)(v.aX, { album: s, contentLinesCount: 4, withAddition: !s.isNonMusic, withLikesCount: s.isNonMusic }, s.id)
                                            : (0, i.jsx)(p.Vt, { 'aria-label': t, linesCount: 4 });
                                    },
                                    totalCount: M,
                                    onGetDataByPage: I,
                                    pageSize: 20,
        ...
        87754: (e, s, t) => {
            ...
            let g = (0, r.PA)((e) => {
                let { labelId: s, preloadedLabel: t, preloadedArtists: r } = e,
                    {
                        label: { id: x, name: g, type: N, artistsSubpage: y, reset: j, isNeededToLoad: A, getData: L },
                        settings: { isMobile: f },
                        experiments: S,
                    } = (0, P.Pjs)(),
                    { formatMessage: w } = (0, a.A)(),
                    { contentScrollRef: B, setContentScrollRef: C } = (0, P.gKY)(),
                    T = (0, P.W6M)(),
                    k = w({ id: 'page.label-artists-header' }, { labelName: g }),
                    E = (0, m.c)((e) => {
                ...
                let R = (0, l.useMemo)(() => ({ Footer: () => (0, i.jsx)(c.A, { children: (0, i.jsx)(c.wi, { className: _().footer }) }) }), []),
                    ...
                    I = [];
                if (
                    (y.isNeededToLoad && I.push(y.getData({ labelId: Number(s), page: 0, pageSize: 20, preloadedArtists: r })),
                    A && I.push(L({ labelId: Number(s), preloadedLabel: t, withLabelEntities: !1 })),
                        ...
                        children: (0, i.jsxs)('div', {
                            ...
                            children: [
                                (0, i.jsx)(c.Y9, {
                                    ...
                                    className: _().header,
                                    children: (0, i.jsx)(b.Heading, { variant: 'h1', weight: 'bold', size: 'xl', lineClamp: 1, children: k }),
                                }),
                                (0, i.jsx)(c.$$, {
                                    className: (0, o.$)(_().scrollContainer, _().important),
                                    listClassName: _().content,
                                    itemClassName: _().item,
                                    customComponents: R,
                                    itemContentCallback: (e) => {
                                        let s = y.items[e],
                                            t = w({ id: 'loading-messages.entity-is-loading' }, { entityName: w({ id: 'entity-names.artist' }) });
                                        return s
                                            ? (0, i.jsx)(v.ao, { artist: s, contentLinesCount: 4 }, s.id)
                                            : (0, i.jsx)(c.Vt, { 'aria-label': t, round: !0, centered: !0, linesCount: 4 });
                                    },
                                    totalCount: z,
                                    onGetDataByPage: E,
                                    pageSize: 20,
