(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [4204],
    {
        ...
        28882: (t, e, r) => {
            ...
            let p = (0, i.PA)((t) => {
                ...
                let { artist: p, onOpenChange: g, open: h, ...x } = t,
                    { shouldShowBuySubscriptionModal: b, showBuySubscriptionModal: A } = (0, v.qBP)(),
                    {
                        settings: { isMobile: C },
                    ...
                    w = (0, _.mW)(p),
                    S = (0, v.Ftl)(),
                    E = ''.concat(v.UfI.ARTIST, '-').concat(null == p ? void 0 : p.id),
                    { formatMessage: L } = (0, l.A)(),
                    { utmLink: B } = (0, v.fyy)({ blockId: v.UfI.ARTIST, contextType: s.K.Artist, contextId: null == p ? void 0 : p.id }),
                    { shareLink: P, pathname: I } = (0, v.bNS)('/artist/:artistId', { params: { artistId: null != (r = null == p ? void 0 : p.id) ? r : '' } }),
                    K = (0, m.A_)({ entityVariant: v.DwC.ARTIST, urlParams: { id: null == p ? void 0 : p.id } }),
                    { isPlaying: R, togglePlay: O } = (0, v.B0S)({
                        seeds: null != (i = null == p ? void 0 : p.seeds) ? i : [],
                        pageIdForFrom: v._Q$.RADIO,
                        blockIdForFrom: E,
                        parentContextId: null == p ? void 0 : p.id,
                    }),
                    F = (0, v.PT7)(),
                    z = L((null == p ? void 0 : p.isComposer) ? { id: 'artist.about-composer' } : { id: 'artist.about-artist' }),
                    D = (0, u.c)(() => {
                    ...
                    U = (0, u.c)(() => {
                        if (!F()) {
                            if (b) return void A();
                            (null == p ? void 0 : p.id) && (k.setUtmLink(B), k.openArtistTrailer(p.id), S(a.ky.Artist, p.id));
                        }
                    }),
                    H = (0, u.c)(() => {
                ...
                (0, v.NBO)(h);
                let W = { variant: v.Yxq.ARTIST, id: null == p ? void 0 : p.id, title: null == p ? void 0 : p.name, path: I },
                    q = T.checkExperiment(v.zal.WebEditorsFeatures, 'on'),
                    X = null == p || null == (e = p.trailer) ? void 0 : e.isAvailable,
                ...
                return (0, o.jsxs)(d.W1, {
                    ...
                    ...x,
                    children: [
                        q && (0, o.jsx)(f.aQ, { fallback: (0, o.jsx)(m.dx, { entityVariant: v.DwC.ARTIST, adminUrl: K }) }),
                        !C && (0, o.jsx)(f.aQ, { fallback: (0, o.jsx)(f.L1, { onClick: M, isPinned: null == p ? void 0 : p.isPinned }) }),
                        (0, o.jsx)(f.aQ, {
                        ...
                        X && (0, o.jsx)(f.aQ, { fallback: (0, o.jsx)(f.No, { onClick: U }) }),
                        (0, o.jsx)(f.aQ, {
                            fallback: (0, o.jsx)(f.C6, { onClick: D, disabled: !(null == p ? void 0 : p.isAvailable), variant: v.IGO.ARTIST, onOpenMenuChange: g }),
                        }),
                        (0, o.jsx)(f.Ht, { disabled: !p, shareLink: P, entityMeta: W }),
                        G &&
                            (0, o.jsx)(f.aQ, {
                                fallback: (0, o.jsx)(d.Dr, {
                                    onClick: H,
                                    icon: (0, o.jsx)(c.Icon, { variant: 'info', size: 'xxs' }),
                                    ...(0, n.Am)(n.Kq.artist.ARTIST_CONTEXT_MENU_ABOUT_ARTIST_BUTTON),
                                    children: z,
                                }),
                            }),
                        (0, o.jsx)(f.aQ, {
                            fallback: (0, o.jsx)(f.DZ, { onClick: w, isDisliked: null == p ? void 0 : p.isDisliked, disabled: !(null == p ? void 0 : p.isAvailable) }),
                        }),
                    ],
                });
            });
        ...
        29517: (t, e, r) => {
            ...
            let b = (0, l.PA)((t) => {
                    var e;
                    let { className: r, artist: l, likeIconSize: n = 'xxs' } = t,
                        ...
                        [b, A] = (0, a.useState)(!1),
                        C = (0, d.c)(async () => {
                            (b || l.isLiked || (A(!0), null == m || m()), await h());
                        }),
                        y = (0, f.Ftl)(),
                        k = (0, d.c)((t) => {
                    ...
                    return (0, o.jsxs)('div', {
                        className: (0, i.$)(x().root, x().controls, r, { [x().controls_disabled]: !l.isAvailable }),
                        children: [
                            l.isAvailable &&
                                (0, o.jsxs)(o.Fragment, {
                                    children: [
                            ...
                            (0, o.jsx)('div', {
                                ...
                                children: (0, o.jsx)(g.Icon, { className: p.$f.buttonArrow, variant: 'arrowRight', size: 'xs' }),
                            }),
                        ],
                    });
                }),
                A = (0, l.PA)((t) => {
                    let { className: e, artist: r, pageId: l, description: g, coverClassName: h, playButtonIconSize: x, likeIconSize: A } = t,
                        ...
                        w = (0, f.brA)(),
                        S = (0, f.PT7)(),
                        { sendNavigateSearchFeedback: E, sendPlaySearchFeedback: L } = (0, f.zEv)(),
                        B = (0, f.NKK)(),
                        {
                            isPlaying: P,
                            isCurrent: I,
                            togglePlay: K,
                        } = (0, f.Dx4)({ playContextParams: { contextData: { type: c.K.Artist, meta: { id: Number(r.id) }, from: j }, loadContextMeta: !0 } }),
                        R = (0, v.SA)({ artist: r, callback: N }),
                        O = (0, v.SA)({ artist: r, callback: K }),
                        F = (0, d.c)((t) => {
                            (null == E || E(), B({ to: s.QT.ArtistScreen }), R(t));
                        }),
                        z = (0, d.c)(() => {
                            S() || (T || P || (M(!0), null == L || L()), O(), w(!P));
                        }),
                        D = (0, d.c)((t) => {
                        ...
                        W = null == H ? void 0 : H({ onPlayButtonClick: z, isPlaying: P, isCurrent: I, playButtonIconSize: x }),
                        q = (0, a.useMemo)(
                            () =>
                                r.url && r.isAvailable
                                    ? (0, o.jsx)(p.N_, {
                                          className: (0, i.$)(p.$f.text, p.$f.titleLink),
                                          href: r.url,
                                          onClick: U,
                                          ...(0, u.Am)(u.Kq.artist.SEARCH_ARTIST_CARD_TITLE_LINK),
                                          children: r.name,
                                      })
                                    : (0, o.jsx)(m.Caption, {
                                          className: (0, i.$)(p.$f.text, p.$f.titleText),
                                          size: 'm',
                                          variant: 'div',
                                          type: 'text',
                                          children: r.name,
                    ...
                    return (0, o.jsxs)(p.Cj, {
                        ...
                        className: (0, i.$)(p.$f.root, { [p.$f.root_disabled]: !r.isAvailable }, e),
                        'aria-label': r.name,
                        onClick: D,
                        ...
                        children: [
                            ...
                            (0, o.jsx)(b, { className: p.$f.controlsBar, artist: r, likeIconSize: A }),
                        ],
                    });
                });
        },
        40258: (t, e, r) => {
                ...
                a = {
                    6699: (t, e, r) => {
                        ...
                        e.useDebouncedToggle = (t) => {
                            let { delay: e, initialState: r, throttleTimeout: l } = t,
                                a = (0, i.useRef)(null),
                                [n, s] = (0, i.useState)(!!r),
                                u = (0, i.useMemo)(
                                    () =>
            ...
            ((() => {
                ...
                let t = s(810),
                    ...
                    r = s(6699);
                u.useScroll = (o) => {
                    let { onScroll: i, listenIsScrolling: l, elementRef: a } = o,
                    ...
                    return (
                        (0, t.useEffect)(() => {
                            ...
                            return (r.addEventListener('scroll', u, o), () => r.removeEventListener('scroll', u, o));
                        }, [a, u]),
                        n
                    );
                };
                ...
                a = {
                    ...
                    7327: (t, e) => {
                        ...
                        function o(t, e, o) {
                            ...
                            if ((void 0 !== o && (i = '' + o), void 0 !== e.key && (i = '' + e.key), 'key' in e))
                                for (var l in ((o = {}), e)) 'key' !== l && (o[l] = e[l]);
                            else o = e;
                    ...
                    4601: (t, e, r) => {
                        ...
                        e.useToggle = (t) => {
                            ...
                            return { state: e, toggle: i, setState: r, toggleTrue: l, toggleFalse: a };
                        };
                    },
                    666: (t, e, r) => {
                        ...
                        e.useTruncate = (t) => {
                            let [e, r] = (0, i.useState)(0),
                                { state: a, toggleTrue: n, toggleFalse: s } = (0, l.useToggle)(!1),
                                u = (0, i.useMemo)(
                                    () =>
                                        (0, o.throttle)(() => {
                        ...
                        (Object.defineProperty(e, '__esModule', { value: !0 }),
                            ...
                            (e.createRipple = function (t, e, r) {
                                let o = null != r ? r : t.currentTarget,
                                    ...
                                    u = 0 === t.clientY ? Math.round(n.height / 2) : t.clientY - n.top;
                                ((i.style.width = ''.concat(l, 'px')),
                                    (i.style.height = ''.concat(l, 'px')),
                                    (i.style.left = 0 === t.clientX ? '0px' : ''.concat(s - a, 'px')),
                                    (i.style.top = ''.concat(u - a, 'px')),
                                    i.classList.add(e));
                                let c = o.getElementsByClassName(e)[0];
                                (c && c.remove(), o.insertBefore(i, o.firstChild));
                            }));
                    },
                    361: (t, e) => {
                        (Object.defineProperty(e, '__esModule', { value: !0 }),
                        ...
                        let i = r(1082),
                            ...
                            u = (t) => {
                                let {
                                    ...
                                    N = (0, l.useId)(),
                                    w = !l.Children.toArray(u).filter(Boolean).length,
                                    S = 'left' === o,
                                    E = null,
                                ...
                                if (m) {
                                    ...
                                    E = (0, l.cloneElement)(m, {
                                        className: (0, a.clsx)(
                                            s.default.icon,
                                            {
                                                [s.default['icon_position_'.concat(o)]]: o && !w,
                                                [s.default.icon_withButtonSize]: !(null == (B = m.props) ? void 0 : B.size),
                                            },
                                            null == (P = m.props) ? void 0 : P.className,
                                            j,
                                        ),
                                        key: N,
                                    });
                                }
                                let I = (0, l.useMemo)(() => (L ? (0, i.jsx)('div', { className: s.default.spinnerContainer, children: v }) : null), [L, v]),
                                    K = (0, l.useCallback)(
                                        (t) => {
                                            L || (A && (0, n.createRipple)(t, s.default.ripple), null == p || p(t));
                                        },
                                        [L, p, A],
                                    );
                                return (0, i.jsx)('button', {
                                    ...
                                    className: (0, a.clsx)(
                                        s.default.root,
                                        s.default['root_'.concat(d, '_').concat(b)],
                                        s.default['root_radius_'.concat(g)],
                                        s.default.root_size,
                                        {
                                            [s.default['root_'.concat(d, '_withHover_').concat(b)]]: C && !k && !L,
                                            ...
                                            [s.default.root_icon_left]: m && !w && S,
                                            [s.default.root_icon_right]: m && !w && !S,
                                        },
                                        c,
                                    ),
                                    type: x,
                                    ...
                                    children:
                                        m || L
                                            ? (0, i.jsxs)('span', {
                                                  className: (0, a.clsx)(s.default.contentContainer, { [s.default.contentContainer_block]: r }, T),
                                                  children: [m && S && E, !w && u, m && !S && E, I],
                                              })
                                            : u,
                                });
                            };
                        e.Button = (0, l.forwardRef)((t, e) => (0, i.jsx)(u, { forwardRef: e, ...t }));
                    },
                    217: function (t, e, r) {
                        var o =
                            (this && this.__importDefault) ||
                        ...
                        e.CollapsableText = (t) => {
                            ...
                            let {
                                ...
                                j = (0, a.cloneElement)(o, {
                                    ...
                                    className: (0, l.clsx)(null == (e = o.props) ? void 0 : e.className, u.default.text),
                                }),
                                T = (0, a.useMemo)(
                                    () => (v && C ? (0, i.jsx)('div', { className: (0, l.clsx)(u.default.fade, { [u.default.fade_active]: !y }), children: j }) : j),
                                    [C, y, j, v],
                                ),
                                M = (0, a.useCallback)(() => {
                                    k(!y);
                                ...
                                children: [
                                    ...
                                    C &&
                                        ...
                                        (0, i.jsx)(s.Button, {
                                            ...
                                            withRipple: !1,
                                            onClick: M,
                                            className: (0, l.clsx)(u.default.button, m),
                                            color: 'primary',
                                            children: N,
                                        }),
                                ],
        ...
        57639: (t, e, r) => {
            ...
            let k = (0, i.PA)((t) => {
                let { covers: e } = t,
                    ...
                    u = e.length - 2 + 1,
                    c = (0, b.c)((t) => () => {
                        (l.close(), i.openImages({ images: e, initialSlideIndex: t }));
                    });
                return (0, o.jsxs)('div', {
                    className: y().root,
                    children: [
                        n.map((t, e) =>
                            (0, o.jsx)(
                                s.Button,
                                {
                                    ...
                                    children: (0, o.jsx)(A.Image, { fit: 'contain', className: y().image, src: t, size: 400, withAvatarReplace: !0 }),
                                },
                                e,
                            ),
                        ),
                        e[1] &&
                            (0, o.jsxs)(s.Button, {
                                ...
                                'aria-label': r({ id: 'slider.view-artist-covers' }),
                                children: [
                                    (0, o.jsx)(A.Image, { fit: 'contain', className: y().image, src: e[1], size: 400, withAvatarReplace: !0 }),
                                    (0, o.jsx)('div', {
                                        ...
                                        children: (0, o.jsx)(g.Caption, {
                                            ...
                                            size: 'm',
                                            weight: 'medium',
                                            children: (0, o.jsx)(x.A, { id: 'slider.images-left-count', values: { imagesLeft: u } }),
                                        }),
                                    }),
                                ],
                            }),
                    ...
                    children: [
                        c.isResolved &&
                            (0, o.jsxs)('header', {
                                className: T().header,
                                children: [
                                    (0, o.jsx)(g.Caption, { variant: 'div', type: 'text', size: 'm', weight: 'medium', className: T().subtitle, children: v }),
                                    (0, o.jsx)(g.Heading, { size: 'xxl', variant: 'div', className: T().title, children: null == (t = c.artist) ? void 0 : t.name }),
                                ],
                            }),
                        c.description &&
                            (0, o.jsx)(p.K, {
                                ...
                                lineClamp: 7,
                                withFade: !0,
                                children: (0, o.jsx)(g.Caption, { variant: 'div', className: T().description, size: 'l', weight: 'medium', children: c.description }),
                            }),
                        c.isArtistStatsAvailable &&
                            (0, o.jsx)(h.FO, { lastMonthListeners: null != (n = c.lastMonthListeners) ? n : 0, lastMonthListenersDelta: c.lastMonthListenersDelta }),
                        c.isResolved &&
                            (0, o.jsx)(h.lW, {
                                className: T().bandlinkScanner,
                                artistId: null == (e = c.artist) ? void 0 : e.id,
                                artistName: null == (r = c.artist) ? void 0 : r.name,
                            }),
                        c.links &&
                            (null == (i = c.links) ? void 0 : i.length) > 0 &&
                            (0, o.jsx)(h.KH, { links: c.links, artistName: null != (s = null == (l = c.artist) ? void 0 : l.name) ? s : '' }),
                        c.covers && c.covers.length > 0 && (0, o.jsx)(k, { covers: c.covers }),
                    ],
                });
            });
            var N = r(91342),
            ...
            let E = () =>
                    (0, o.jsxs)('div', {
                        className: S().root,
                        children: [(0, o.jsx)(N.Shimmer, { className: S().entityName }), (0, o.jsx)(N.Shimmer, { className: S().title }), (0, o.jsx)(_.q$, { count: 4 })],
                    }),
                L = (0, i.PA)(() => {
                    ...
                    (0, l.useEffect)(() => {
                        i.isRejected &&
                            (e((0, o.jsx)(_.hT, { error: t({ id: 'artist-errors.error-during-loading-artist-info' }) }), { containerId: d.uQT.ERROR }), i.close());
                    }, [i, i.isRejected, t, e]);
                    let f = (0, n.L)(() => (i.isLoading ? (0, o.jsx)(E, {}) : (0, o.jsx)(M, {})));
                    return (0, o.jsxs)(c.a, {
        ...
        64143: (t, e, r) => {
            'use strict';
            (r.d(e, { hO: () => _, jr: () => m, jp: () => v, QZ: () => i }), r(57323));
            var o = r(66268);
            let i = (t, e, r) => {
                let i = null != r && r;
                return {
            ...
            let d = (t) => {
                ...
                _ = (0, n.PA)((t) => {
                    ...
                    let E = (0, o.useCallback)(() => {
                        ...
                        let o = (t) => {
                            (M(t > e),
                                m && w(t > 30),
                                (null == p ? void 0 : p.current) && y(d({ element: null == p ? void 0 : p.current, scrollTop: t, isMobile: S })),
                                (null == h ? void 0 : h.current) && j(d({ element: null == h ? void 0 : h.current, scrollTop: t, isMobile: S })));
                        };
                    ...
                    let L = (0, o.useMemo)(() => (S ? { onScroll: (0, a.A)(E, 200) } : { onScroll: (0, a.A)(E, 200), elementRef: r }), [E, r, S]);
                    (0, s.L)(L);
                    let B = (0, o.useMemo)(
                        () => ({
                            title: v,
                ...
                m = (t) => {
                    let { children: e, child: r, className: i } = t,
                        { setChildElement: a, setChild: n } = (0, o.useContext)(c.B9),
                        s = (0, o.useRef)(null);
                    return (
                        (0, o.useEffect)(() => {
                ...
                v = (t) => {
                    let { children: e, title: r, className: i } = t,
                        { setTitleElement: a, setTitle: n } = (0, o.useContext)(c.B9),
                        s = (0, o.useRef)(null);
                    return (
                        (0, o.useEffect)(() => {
                            ((null == s ? void 0 : s.current) && a(s), r && n(r));
        ...
        86804: (t, e, r) => {
            ...
            var o = r(33008),
                ...
                C = r.n(A);
            let y = (0, l.PA)((t) => {
                let { artist: e, className: r, children: l, contentLinesCount: A, topTitleElement: y, bottomTitleElement: k } = t,
                    { ref: j, intersectionPropertyId: T } = (0, h.nMI)(),
                    { trailer: M, user: N } = (0, h.Pjs)(),
                    { from: w, utmLink: S } = (0, h.fyy)({ contextId: e.id, contextType: c.K.Artist }),
                    { formatMessage: E } = (0, n.A)(),
                    [L, B] = (0, a.useState)(!1),
                    [P, I] = (0, a.useState)(!1),
                    [K, R] = (0, a.useState)(!1),
                    { sendLikeSearchFeedback: O, sendNavigateSearchFeedback: F, sendPlaySearchFeedback: z } = (0, h.zEv)(),
                    D = (0, h.NKK)(),
                    U = (0, h.brA)(),
                    H = (0, g.KX)(e),
                    W = (0, g.A7)(e),
                    ...
                    te = (0, a.useMemo)(() => {
                        let t = E({ id: 'entity-names.artist-name' }, { artistName: X }),
                            e = Y ? E({ id: 'entity-names.has-your-like' }) : '';
                        return ''.concat(t, ' ').concat(e);
                    }, [X, Y, E]),
                    { isPlaying: tr, togglePlay: to } = (0, h.Dx4)({
                        playContextParams: { contextData: { type: c.K.Artist, meta: { id: Number(q) }, from: w, utmLink: S }, loadContextMeta: !0 },
                    }),
                        ...
                        () =>
                            (0, o.jsx)(
                                b.ArtistContextMenu,
                                {
                                    ...
                                    size: 's',
                                    icon: (0, o.jsx)(v.Icon, { size: 'xxs', variant: 'more' }),
                                    ...(0, u.Am)(u.Kq.artist.ARTIST_CONTEXT_MENU_BUTTON),
                                },
                ...
                return (0, o.jsx)(m.MN, {
                    ...
                    srTitle: (0, o.jsx)(x.N_, { href: e.url, onClick: ta, children: te }),
        ...
        90317: (t, e, r) => {
            ...
            ((0, p.cache)(async function (t, e) {
                let r,
                    o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : { artistId: t, page: 0, pageSize: m, sort: { sortBy: g.g.YEAR } };
                (0, h.LLJ)(t) || (0, f.notFound)();
                try {
                    let i,
                        { container: l, backendHostTld: a, locale: n, host: u, fullUrl: c, isRSC: d, requestUrl: _ } = await (0, h.IhE)();
                    if (d) return { artist: void 0, albums: void 0, backendHostTld: a, locale: n, host: u, fullUrl: c, requestUrl: _ };
                    let m = l.get(h.O9U),
                    ...
                    r = { artist: v, albums: i, backendHostTld: a, locale: n, host: u, fullUrl: c, requestUrl: _ };
                } catch (t) {
                    return (0, h.tfF)(t, () => ({ artist: void 0, albums: void 0, ...(0, h.Bj3)() }));
                }
                let { artist: i } = r;
                return (((null == i ? void 0 : i.error) === 'not-found' || (null == i ? void 0 : i.artist.error) === 'not-found') && (0, f.notFound)(), r);
            }),
                (0, p.cache)(async function (t) {
                    let e,
                        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { artistId: t, page: 0, pageSize: v };
                    try {
                        let { container: o, backendHostTld: i, locale: l, host: a, fullUrl: n, isRSC: u, requestUrl: c } = await (0, h.IhE)();
                        if (u) return { artist: void 0, clips: void 0, backendHostTld: i, locale: l, host: a, fullUrl: n, requestUrl: c };
                        let d = o.get(h.O9U),
                        ...
                        e = { artist: _, clips: m, backendHostTld: i, locale: l, host: a, fullUrl: n, requestUrl: c };
                    } catch (t) {
                        return (0, h.tfF)(t, () => ({ artist: void 0, clips: void 0, ...(0, h.Bj3)() }));
                    }
                    let { artist: o } = e;
                    return (((null == o ? void 0 : o.error) === 'not-found' || (null == o ? void 0 : o.artist.error) === 'not-found') && (0, f.notFound)(), e);
                }),
                (0, p.cache)(async (t) => {
                    let e;
                    (0, h.LLJ)(t) || (0, f.notFound)();
                    try {
                        let { container: r, backendHostTld: o, locale: i, host: l, fullUrl: a, isRSC: n, requestUrl: u } = await (0, h.IhE)();
                        if (n) return { artist: void 0, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                        let c = r.get(h.O9U),
                        ...
                        e = { artist: d, concerts: _, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                    } catch (t) {
                        return (0, h.tfF)(t, () => ({ artist: void 0, concerts: void 0, ...(0, h.Bj3)() }));
                    }
                    let { artist: r } = e;
                    return (((null == r ? void 0 : r.error) === 'not-found' || (null == r ? void 0 : r.artist.error) === 'not-found') && (0, f.notFound)(), e);
                }),
                (0, p.cache)(async (t) => {
                    let e;
                    (0, h.LLJ)(t) || (0, f.notFound)();
                    try {
                        let { container: r, backendHostTld: o, locale: i, host: l, fullUrl: a, isRSC: n, requestUrl: u } = await (0, h.IhE)();
                        if (n) return { artist: void 0, familiar: void 0, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                        let c = r.get(h.O9U),
                            d = await c.getBriefInfo({
                                artistId: t,
                                popularTracksCount: s,
                            ...
                            _ = await c.getFamiliarYou({ artistId: t, waveTracksLimit: 100, collectionTracksLimit: 100, collectionAlbumsLimit: 20 });
                        e = { artist: d, familiar: _, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                    } catch (t) {
                        return (0, h.tfF)(t, () => ({ artist: void 0, familiar: void 0, ...(0, h.Bj3)() }));
                    }
                    let { artist: r } = e;
                    return (((null == r ? void 0 : r.error) === 'not-found' || (null == r ? void 0 : r.artist.error) === 'not-found') && (0, f.notFound)(), e);
                }),
                (0, p.cache)(async (t) => {
                    ...
                    try {
                        ...
                        return (0, h.tfF)(t, () => ({ artist: void 0, ...(0, h.Bj3)() }));
                    }
                    let { artist: r } = e;
                    return (((null == r ? void 0 : r.error) === 'not-found' || (null == r ? void 0 : r.artist.error) === 'not-found') && (0, f.notFound)(), e);
                }),
                (0, p.cache)(async (t) => {
                    ...
                    try {
                        let { container: r, backendHostTld: o, locale: i, host: l, fullUrl: a, isRSC: n, requestUrl: u } = await (0, h.IhE)();
                        if (n) return { artist: void 0, similarArtists: void 0, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                        let c = r.get(h.O9U),
                            d = await c.getBriefInfo({
                                artistId: t,
                                popularTracksCount: s,
                        ...
                        e = { artist: d, similarArtists: _, backendHostTld: o, locale: i, host: l, fullUrl: a, requestUrl: u };
                    } catch (t) {
                        return (0, h.tfF)(t, () => ({ artist: void 0, similarArtists: void 0, ...(0, h.Bj3)() }));
                    }
                    let { artist: r } = e;
                    return (((null == r ? void 0 : r.error) === 'not-found' || (null == r ? void 0 : r.artist.error) === 'not-found') && (0, f.notFound)(), e);
                }));
            ...
            let A = o.gK
                            ...
                            getData: (0, o.L3)(function* (e) {
                                ...
                                if (!t.isLoading)
                                    try {
                                        ...
                                        ((t.artist = (0, l.as)({ artist: i.artist })),
                                            (t.description = null != (c = i.description) ? c : null),
                                            (t.artistType = i.artistType === x.o.COMPOSER ? x.o.COMPOSER : x.o.ARTIST),
                                            i.stats &&
                                                Number.isFinite(null == (a = i.stats) ? void 0 : a.lastMonthListeners) &&
                                        ...
                                        (d && (t.covers = (0, o.wg)(d)),
                                            (t.links = (0, o.wg)(null == (u = i.links) ? void 0 : u.map(l.DZ))),
                                            t.loadingState !== h.GuX.IDLE && (t.loadingState = h.GuX.RESOLVE));
                                    } catch (e) {
                                        (i.error(e), t.loadingState !== h.GuX.IDLE && (t.loadingState = h.GuX.REJECT));
                                    }
                            }),
                            close() {
                ...
                k = o.gK
                    .model('ArtistTop', { artist: l.PK, listenTimeSeconds: o.gK.number, top: o.gK.maybe(a.Iz) })
                    .views((t) => ({
