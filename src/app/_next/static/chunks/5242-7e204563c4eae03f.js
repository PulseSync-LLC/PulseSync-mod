    ...
    [5242],
    {
        ...
        17999: (t, i, e) => {
            ...
            let n = (t) => {
                    ...
                    return (0, l.jsx)(s.OY, {
                        ...
                        headingVariant: p,
                        ..._,
                        children: null == c ? void 0 : c.map((t) => (0, l.jsx)(r.PlaylistCard, { playlist: t, contentLinesCount: 3 }, t.key)),
                    });
                },
                o = (0, a.forwardRef)((t, i) => (0, l.jsx)(n, { forwardRef: i, ...t }));
        },
        19525: (t) => {
            t.exports = {
        ...
        45242: (t, i, e) => {
            ...
            let c = (t) => ({ uid: t.uid, login: t.login, name: t.name, sex: t.sex, verified: t.verified }),
                d = (t) =>
                    (0, l.wg)({
                        ...
                        modified: t.modified,
                        madeFor: t.madeFor
                            ? ((t) => (0, l.wg)({ userInfo: t.userInfo ? c(t.userInfo) : null, caseForms: t.caseForms ? (0, a.NH4)(t.caseForms) : null }))(t.madeFor)
                            : null,
                    });
            var u = e(70879);
            let y = (t) => {
                var i, e;
                return (0, l.wg)({ ...(0, o.jX)(t), artists: null != (e = null == t || null == (i = t.artists) ? void 0 : i.map(u.dM)) ? e : [] });
            };
            var m = e(61744);
            let p = (t) => {
                var i, e;
                return (0, l.wg)({ ...(0, o.jX)(t), tracks: null != (e = null == t || null == (i = t.tracks) ? void 0 : i.map(m.Rw)) ? e : [] });
            };
            var _ = e(59615),
                v = e(64802);
            let C = l.gK.model('PlaylistOwner', {
                ...
                k = l.gK.model('PlaylistOwner', { userInfo: l.gK.maybeNull(C), caseForms: l.gK.maybeNull(_.lg) }),
                P = l.gK.model('PlaylistTag', { id: l.gK.string, value: l.gK.string }),
                x = o.$o
                    .props({
                        owner: l.gK.maybe(C),
        ...
        56395: (t, i, e) => {
            ...
            let f = (0, s.PA)((t) => {
                ...
                let { playlist: e, onOpenChange: a, open: s, ...r } = t,
                    ...
                    K = (0, L.A_)({ entityVariant: P.DwC.PLAYLIST, urlParams: { id: e.uid, kind: e.kind } });
                (0, P.NBO)(s);
                let N = (0, u.c)(() => {
                    if (d) return void y();
                    A() || (_.openPlaylistTrailer(e.id), f(o.ky.Playlist, e.id));
                });
            ...
            var j = e(96973),
                A = e.n(j);
            let b = (0, s.PA)((t) => {
                let { className: i, playlist: e, children: s, contentLinesCount: h, customDescription: L } = t,
                    ...
                    { sendLikeSearchFeedback: z, sendNavigateSearchFeedback: I, sendPlaySearchFeedback: E } = (0, P.zEv)(),
                    [F, S] = (0, r.useState)(!1),
                    [R, M] = (0, r.useState)(!1),
                    [O, $] = (0, r.useState)(!1),
                    Y = (0, g.r)(e),
                    ...
                    tn = (0, r.useMemo)(() => {
                        var t;
                        return L
                            ? (0, l.jsx)(v.Caption, { variant: 'span', type: 'entity', size: 's', weight: 'medium', lineClamp: 2, children: L }, e.getKey('description'))
        ...
        75658: (t, i, e) => {
                ...
                return (0, l.jsxs)('div', {
                    ...
                    children: [
                        ...
                        (0, l.jsx)('div', {
                            ...
                            children: (0, l.jsx)(p.Icon, { className: C.$f.buttonArrow, variant: 'arrowRight', size: 'xs' }),
                        }),
                    ],
                });
            });
            ...
            let j = (0, s.PA)((t) => {
                let { className: i, playlist: e, pageId: s, coverClassName: P, playButtonIconSize: x, likeIconSize: g } = t,
                    ...
                    I = (0, v.PT7)(),
                    { sendNavigateSearchFeedback: E, sendPlaySearchFeedback: F } = (0, v.zEv)(),
                    S = (0, v.NKK)(),
                    {
                        isPlaying: R,
                        isCurrent: M,
                    ...
                    X = (0, r.useMemo)(
                        () =>
                            e.url && e.isAvailable
                                ? (0, l.jsx)(C.N_, { className: (0, a.$)(C.$f.text, C.$f.titleLink), href: e.url, onClick: q, children: T })
                                : (0, l.jsx)(_.Caption, { className: (0, a.$)(C.$f.text, C.$f.titleText), size: 'm', variant: 'div', type: 'text', children: T }),
                        ...
                        return (0, l.jsxs)('div', {
                            ...
                            children: [
                                (0, l.jsxs)('div', {
                                    ...
                                    'aria-hidden': !0,
                                    children: [
                                        (0, l.jsx)(p.Icon, { className: f().icon, variant: i, size: 'xxs' }),
                ...
                return (0, l.jsxs)(C.Cj, {
                    ...
                    className: (0, a.$)(C.$f.root, { [C.$f.root_disabled]: !e.isAvailable }, i),
                    'aria-label': e.title || w({ id: 'entity-names.playlist' }),
                    onClick: U,
                    ...(0, d.Am)(d.Kq.playlist.HORIZONTAL_PLAYLIST_CARD),
                    children: [Z, (0, l.jsx)(C.ro, { isDisabled: !e.isAvailable, title: X, description: W }), (0, l.jsx)(h, { playlist: e, likeIconSize: g })],
                });
            });
        },
        91919: (t, i, e) => {
