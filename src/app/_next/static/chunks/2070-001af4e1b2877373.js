                    ...
                    children: [
                        o &&
                            (0, r.jsx)(P.Lh, {
                                ...
                                className: (0, s.$)(_().navigation, { [_().navigation_desktop]: !p }),
                                withForwardControl: !1,
                            }),
                        (0, r.jsxs)('div', {
                            className: (0, s.$)(_().content, { [_().content_shrink]: !o }),
                            children: [
                                (0, r.jsx)(m.Icon, { className: _().icon, variant: 'attention', size: 'xxl' }),
                                (0, r.jsx)(v.Heading, { className: (0, s.$)(_().title, _().important), variant: 'h3', size: 'xs', children: a }),
                                (0, r.jsxs)(v.Caption, {
            ...
            let b = (e) => {
                let { children: n } = e,
                    ...
                    c = (0, i.useCallback)(
                        (e) => {
                            ...
                            return ''.concat(n, '/media/splash_screen/splash_screen_').concat(_, '.').concat(e);
                        },
                        [_],
                    ),
                ...
                return (0, r.jsxs)(d.nlO.Provider, {
                    ...
                    children: [
                        !o &&
                            (0, r.jsx)('div', {
                                className: (0, s.$)(m().root, m()['root_'.concat(_)], { [m().root_hidden]: b }),
                                onAnimationEnd: h,
                                children: (0, r.jsxs)('video', {
                                    ...
                                    onEnded: P,
                                    onError: h,
                                    children: [(0, r.jsx)('source', { src: c('webm'), type: 'video/webm' }), (0, r.jsx)('source', { src: c('mp4'), type: 'video/mp4' })],
                                }),
                            }),
                        n,
                    ],
