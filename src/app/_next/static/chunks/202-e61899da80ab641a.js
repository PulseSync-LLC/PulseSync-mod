    ...
    [202],
    {
        ...
        27618: (t, e, i) => {
            ...
            var s = i(33008),
                ...
                m = i.n(p);
            let g = (0, n.PA)((t) => {
                let { className: e, title: i, description: n, iconVariant: p = 'musicLogo', iconClassName: g, iconSize: v } = t,
                ...
                return (
                    ...
                    (0, s.jsxs)('div', {
                        className: (0, a.$)(m().root, { [m().root_desktop]: !_ }, e),
                        children: [
                            (0, s.jsx)(c.Lh, { withBackwardFallback: '/', className: m().navigation, withForwardControl: !1 }),
                            (0, s.jsxs)('div', {
                                className: m().content,
                                children: [
                                    (0, s.jsx)(l.Icon, { className: (0, a.$)(m().icon, g), variant: p, size: v }),
                                    (0, s.jsx)(d.Heading, {
        ...
        91396: (t, e, i) => {
            ...
            let k = (t) => {
                ...
                let { slide: i, isVisible: n } = t,
                    o = (0, V.eGp)(),
                    { from: l } = (0, V.fyy)({ pageId: V._Q$.TRAILER_OF_THE_YEAR, blockId: V.UfI.DEFAULT }),
                    { isActive: d } = (0, f.JO)();
                (0, V.GWZ)(n);
                let u = null == o ? void 0 : o.getState(V.V_r.TRAILER).queueState.entityList.value,
                    c = (0, r.useMemo)(
                        () =>
                            i.entitiesData &&
                            u &&
                            i.entitiesData.every((t, e) => {
                                var i;
                                return t.meta.id === (null == (i = u[e]) ? void 0 : i.entity.data.meta.id);
                            }),
                        [i.entitiesData, u],
                    ),
                    h = n && i.hasTrailer && (!c || (null == o ? void 0 : o.getState(V.V_r.TRAILER).playerState.status.value) !== v.MT.PLAYING),
                    p = h && (null == o || null == (e = o.getState(V.V_r.TRAILER).currentContext.value) ? void 0 : e.data.meta.id) === i.id;
                return (
                    (0, r.useEffect)(() => {
                        if (p) return void o.restartContext({ playAfterRestart: !0, queueParams: { index: 0 }, entitiesData: i.entitiesData }, V.V_r.TRAILER);
                        h &&
                            (null == o ||
                                o.playContext(
                                    {
                                        contextData: { type: I.K.Various, overrideContextType: w.b.Other, trailer: !0, meta: { id: i.id }, from: l },
                                        queueParams: { index: 0 },
                    ...
                    (0, s.jsx)(N.Paper, {
                        className: (0, a.$)(F().root, { [F().root_isActive]: d }),
                        radius: 'l',
                        tabIndex: 0,
                                ...
                                (0, s.jsx)(
                                    f.qr,
                                    {
                                        children: (0, s.jsx)(V.Rau, {
                                            ...
                                            artistId: n.artistId,
                                            children: (0, s.jsx)(k, { isVisible: n.activeSlide === i, slide: t }),
                                        }),
                                    },
                                    t.id,
                                ),
            ...
            var T = i(67220),
                R = i.n(T);
            function L(t, e) {
                return (t === V.GuX.RESOLVE || t === V.GuX.REJECT) && 0 === e.length;
            }
            let D = (0, n.PA)((t) => {
                var e;
                let { slidesConsumer: i, artistId: n, podcastId: _, campaignId: f } = t,
                    { formatMessage: S } = (0, l.A)(),
                    { slides: b, experiments: E, sonataState: A, settings: I } = (0, V.Pjs)(),
                    w = (0, V.eGp)(),
                    N = E.checkExperiment(V.zal.WebNextRewind2024, 'on') || E.checkExperiment(V.zal.WebNextMusicBirthday2025, 'on'),
                    y = !(null == (e = I.browserInfo) ? void 0 : e.isMobile) || !I.browserInfo.isTouch,
                ...
                (0, r.useEffect)(() => {
                    if (N)
                        switch (i) {
                            case x.z6.USER:
                                L(b.userSlidesLoadingState, j) && (0, o.notFound)();
                                break;
                            case x.z6.ARTIST:
                                L(b.artistSlidesLoadingState, j) && (0, o.notFound)();
                                break;
                            case x.z6.PODCAST:
                                L(b.podcastSlidesLoadingState, j) && (0, o.notFound)();
                                break;
                            case x.z6.SPECIAL:
                                L(b.specialSlidesLoadingState, j) && (0, o.notFound)();
                        }
                    else (0, o.notFound)();
                ...
                let T = (0, r.useMemo)(() => {
                        var t;
                        let e,
                            i = null == (t = j[b.activeSlide]) ? void 0 : t.slideColor;
                        if (i) {
                ...
                switch (i) {
                    case x.z6.USER:
                        b.userSlidesLoadingState === V.GuX.IDLE && (0, r.use)(b.getUserSlides());
                        break;
                    case x.z6.ARTIST:
                        n && b.artistSlidesLoadingState === V.GuX.IDLE && (0, r.use)(b.getArtistSlides({ artistId: n }));
                        break;
                    case x.z6.PODCAST:
                        _ && b.podcastSlidesLoadingState === V.GuX.IDLE && (0, r.use)(b.getPodcastSlides({ podcastId: Number(_) }));
                        break;
                    case x.z6.SPECIAL:
                        f && b.specialSlidesLoadingState === V.GuX.IDLE && (0, r.use)(b.getSpecialSlides({ campaignId: f }));
                }
                return (0, s.jsxs)('div', {
                    className: R().root,
                    style: T,
                    ...
                    children: [
                        (0, s.jsx)(m.q, { children: (0, s.jsx)(g.Heading, { variant: 'h1', children: (0, s.jsx)(d.A, { id: 'page.results-of-the-year' }) }) }),
                        (0, s.jsxs)('header', {
                            className: R().header,
                            children: [
                                    ...
                                    (0, s.jsxs)('div', {
                                        ...
                                        children: [
                                            (0, s.jsx)(g.Caption, {
                                                ...
                                                size: 'l',
                                                weight: 'medium',
                                                children: Number(b.activeSlide) + 1,
                                            }),
                                            (0, s.jsx)(g.Caption, {
                                                variant: 'span',
                                                type: 'text',
                                            ...
                                            (0, s.jsx)(g.Caption, {
                                                ...
                                                weight: 'medium',
                                                className: R().counterItem,
                                                children: null == j ? void 0 : j.length,
                                            }),
                                        ],
                                    }),
                                y &&
                                    (0, s.jsx)(h.Button, {
                                        ...
                                        radius: 'round',
                                        size: 'xxxs',
                                        icon: (0, s.jsx)(p.Icon, { size: 'xs', className: R().icon, variant: B }),
                                        onClick: D,
