        ...
        82427: (t, e, i) => {
            ...
            let z = (0, n.PA)((t) => {
                ...
                let B = (0, r.useMemo)(() => {
                    ...
                    O = B.some((t) => t.background.withSound || t.hasTrailer);
                (0, r.useEffect)(() => {
                    O && I.status === f.MT.PLAYING && (null == A || A.togglePause());
                }, [O, A, I.status]),
                    (0, r.useEffect)(() => {
                        if (y)
                            switch (i) {
                ...
                let M = (0, r.useMemo)(() => {
                    ...
                    q = V.isMuted ? 'volumeOff' : 'volume',
                    U = x(V.isMuted ? { id: 'player-actions.volume-off' } : { id: 'player-actions.volume-on' });
                switch (i) {
                    case j.z6.USER:
                                    ...
                                    children: [
                                        ...
                                        w &&
                                            ...
                                            (0, s.jsx)(p.$, {
                                                ...
                                                radius: 'round',
                                                size: 'xxxs',
                                                icon: (0, s.jsx)(m.Icon, { size: 'xs', className: R().icon, variant: q }),
                                                onClick: G,
