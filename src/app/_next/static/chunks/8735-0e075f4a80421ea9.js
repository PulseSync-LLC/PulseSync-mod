        ...
        43956: (e, t, a) => {
            ...
            let es = (0, s.PA)((e) => {
                ...
                let { autoFocus: h, className: k } = e,
                    ...
                    { from: A } = (0, p.fyy)({ pageId: I, blockId: p.UfI.FILTERED }),
                    { from: T } = (0, p.fyy)({ pageId: I, blockId: p.UfI.SUGGESTED }),
                    [C, N] = (0, n.useState)(!1);
                (0, n.useEffect)(
                    () => () => {
                ...
                let S = (0, n.useMemo)(
                                            ...
                                            ? (0, l.jsx)(
                                                  p.Bki,
                                                  {
                                                      ...
                                                      children: (0, l.jsx)(B.Kd, {
                                                          withPodcastName: !0,
                                                          track: e,
                                                          playContextParams: ea({ item: e, from: A, tracks: j.playlistTracks }),
                    ...
                    }, [j.isLoading, j.playlistTracks, j.additionTrackInProggress, A]),
                    R = (0, n.useMemo)(() => {
                        var e, t;
                    ...
                    }, [null == (a = b.meta) ? void 0 : a.canUserChange, j.isLoading, j.suggestedTracks, j.additionTrackInProggress, T, F]),
                    O = (0, n.useMemo)(() => {
                        var e, t, a;
                        ...
                        return (null == (a = j.playlistTrackIds) ? void 0 : a.length) || !i || j.isLoading
                            ? null
                            : (0, l.jsx)(G.pA, { className: ei().emptyBlockContainer, isEmptySearch: !0 });
                    }, [
            ...
            let ey = (0, s.PA)(() => {
                    ...
                    return t.isAdvertDisabled(p.fDi.PLAYLIST_BRANDING)
                        ? null
                        : (0, l.jsx)('div', {
                ...
                s.isLoading || !s.meta || s.isRejected)
                    ...
                    : (0, l.jsxs)(p.FoH, {
                          ...
                          children: [
                              ...
                              s.shouldShowEmptyBlock && (0, l.jsx)(G.pA, { className: ev().emptyPlaylist }),
                          ],
                      });
            });
            var ek = a(82736);
            let e_ = (0, s.PA)((e) => {
                ...
                eb = (0, s.PA)((e) => {
                    var t, a, s, b, x;
                    let { userId: f, kind: I, playlistUuid: T, preloadedPlaylistByUuid: C, isWebNextNavigationOn: N } = e,
                        {
                            user: S,
                            playlist: L,
                            settings: { isMobile: D },
                    ...
                    let $ = (0, n.useMemo)(
                            () => ({
                                ...
                                Item: L.isDragAndDropEnabled ? A : void 0,
                        ...
                        G = (0, n.useCallback)((e) => e, []),
                        Q = (0, g.Qj)();
                    if (
                        (L.isNeededToLoad &&
                            ('string' == typeof T
                                ? (0, n.use)(L.getPlaylistByUuid({ playlistUuid: T, resumeStream: !1, preloadedPlaylist: C }))
                                : 'string' == typeof f &&
                                  'string' == typeof I &&
                        ...
                        return (0, l.jsx)(m.w, {});
                    let q = Q.isEnabled ? P.Vw.BRANDED_PLAYLIST : P.Vw.INNER;
                            ...
                            (0, l.jsx)(y.hO, {
                                ...
                                children: (0, l.jsxs)('div', {
                                    ...
                                    children: [
                                        ...
                                        !Q.isEnabled && (0, l.jsx)('div', { className: j().averageColorBackground, style: Y }),
                                        (0, l.jsx)(V, {
                                            playlist: L,
                                            children: (0, l.jsx)(P.$$, {
                                                context: {
                                                ...
                                                customComponents: $,
                                                computeItemKey: L.isDragAndDropEnabled ? X : G,
