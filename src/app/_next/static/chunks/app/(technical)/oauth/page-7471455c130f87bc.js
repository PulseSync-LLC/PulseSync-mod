(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        29275: (e, t, r) => {
            Promise.resolve().then(r.bind(r, 72169));
        },
        72169: (e, t, r) => {
            'use strict';
            r.d(t, { OAuthPage: () => u });
                ...
                let e = (0, p.NFA)(),
                    ...
                    y = (function (e, t) {
                        ...
                        if (
                            ...
                            i(e[e.length - 1], t.removeDirectoryIndex) && (a.pathname = (e = e.slice(0, -1)).slice(1).join('/') + '/');
                        }
                        if (
                            (a.hostname &&
                            ...
                            for (let e of [...a.searchParams.keys()]) i(e, t.removeQueryParameters) && a.searchParams.delete(e);
                        if (
                            ...
                            for (let e of [...a.searchParams.keys()]) i(e, t.keepQueryParameters) || a.searchParams.delete(e);
                        ...
                        return (
                            (e = a.toString()),
                            t.removeSingleSlash || '/' !== a.pathname || o.endsWith('/') || '' !== a.hash || (e = e.replace(/\/$/, '')),
                    ...
                    })(''.concat(d.origin, '/').concat(f));
                return (
                    (0, c.useEffect)(() => {
                        s.remove(p.cYZ.YmUid);
                        ...
                        try {
                            if (e.length) {
                                ...
                                if (r.expires_in && r.access_token && r.state) {
                                    var a;
                                    null == (a = t.setToken) || a.call(t, { expiresIn: parseInt(r.expires_in, 10), token: r.access_token, state: r.state });
                                } else throw new o.t('No OAuth-token in URL returned by OAuth-service', { code: 'E_OAUTH_PAGE_NO_TOKEN' });
                            }
                        } catch (t) {
                            let e = new o.t('Error on OAuth page', { code: 'E_OAUTH_PAGE', cause: (0, h.createObjectFromError)(t) });
                            r.error(e);
                        }
                        (0, n.redirect)(y);
                    }, [y, t, r, e, s]),
    ...
    (e) => {
        e.O(0, [6041, 9834, 5355, 1023, 1311, 7764, 6706, 5148, 3005, 3252, 585, 5843, 3290, 7358], () => e((e.s = 29275))), (_N_E = e.O());
    },
]);
