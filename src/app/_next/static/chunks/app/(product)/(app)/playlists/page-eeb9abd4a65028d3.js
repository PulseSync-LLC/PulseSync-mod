(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5242, 8134],
    {
                    ...
                    2067: (e, t, a) => {
                        ...
                        t.useScroll = (e) => {
                            let { onScroll: t, listenIsScrolling: a, elementRef: n } = e,
                                { state: s, handleDebouncedToggle: o } = (0, r.useDebouncedToggle)({ delay: 1e3, throttleTimeout: 100 }),
                                d = (0, i.useCallback)(() => {
                                    (a && o(), null == t || t());
                                }, [a, o, t]);
                            return (
                                (0, i.useEffect)(() => {
                                    let e = (0, l.getElementFromRefOrElement)(n);
                                    if (null === e) return;
            ...
            ((() => {
                ...
                d.useElementOffsetY = (i) => {
                    let [l, r] = (0, a.useForceUpdateRef)(),
                        [n, s] = (0, e.useState)(),
                        o = (0, e.useCallback)(() => {
                            let e = null == l ? void 0 : l.getBoundingClientRect();
                            e && s(e.y);
                        }, [l]);
                    return ((0, e.useLayoutEffect)(o), (0, t.useScroll)({ onScroll: o, elementRef: i }), { forceUpdateRefCallback: r, offsetY: n });
                };
            })(),
                d.__esModule);
        ...
        2117: (e, t, a) => {
            ...
            function d(e) {
                var t = function (t) {
                    ...
                    return l('formatDate' === e ? a.formatDateToParts(o, n) : a.formatTimeToParts(o, n));
                };
        ...
        2865: (e, t, a) => {
            ...
            let s = (e) => {
                if (e.data.type !== l.R.Clip) return null;
                {
                    ...
                    let l = null == (t = a.artists) ? void 0 : t.map((e) => (0, r.as)({ artist: e })),
            ...
            var o = a(53555);
            let d = (e, t) => ({ type: o.z4.Unloaded, meta: { id: e, albumId: t } });
            var u = a(95592),
                c = a(61744);
            let m = (e) => {
                var t, a, s;
                switch (e.data.type) {
                    case l.R.Generative: {
                        let a = e.data.meta,
                            l = (0, n.QBb)(null == a ? void 0 : a.derivedColors);
                        return (0, i.wg)({
                            id: String(a.id),
                            coverUri: a.imageUrl,
                    ...
                    default: {
                        let t = e.data.meta,
                            l = null == (a = t.substituted?.artists ?? t.artists) ? void 0 : a.map(r.dM),
                            n = null == (s = t.albums) ? void 0 : s.map(u.e7);
                        return (0, i.wg)({ ...(0, c.gK)(t), artists: l, albums: n, isHiddenFromSonataQueue: e.hidden });
                    }
                }
            };
            var g = a(48148),
                ...
                k = a(43090),
                _ = a(10663);
            let b = i.gK.model('UnloadedEntityMeta', { id: i.gK.union(i.gK.number, i.gK.string), albumId: i.gK.maybe(i.gK.union(i.gK.number, i.gK.string)) }),
                P = i.gK.model('UnloadedEntityData', { meta: b, type: i.gK.literal(o.z4.Unloaded) });
            var C = a(6247),
                S = a(16285);
            let T = c.OQ.props({ artists: i.gK.array(r.PK), albums: i.gK.array(u.GI), chart: i.gK.maybe(S.Iz), isHiddenFromSonataQueue: i.gK.maybe(i.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
                        ...
                        get index() {
                            var n, s, o;
                            return null != (o = null == (s = e.albums[0]) || null == (n = s.trackPosition) ? void 0 : n.index) ? o : null;
                        },
                        get isPodcast() {
                            var d;
                    ...
                    .actions((e) => ({
                        changeTrackInfo: (0, i.L3)(function* (t, a) {
                            let { ugcResource: l, modelActionsLogger: s } = (0, i._$)(e);
                            if (e.artists.map((e) => e.name).join(', ') === a && t === e.title) return n.FlZ.OK;
                            try {
                                var o;
                                (yield l.changeTrack({ trackId: e.id, title: t, artist: a }), (e.title = t));
                                let s = (null == (o = e.artists[0]) ? void 0 : o.id) || '0';
                                if (((e.artists = (0, i.wg)([])), a)) {
                                    let t = r.PK.create({ id: s, name: a, isAvailable: !0 });
                                    e.artists = (0, i.wg)([t]);
                                }
                                return n.FlZ.OK;
                            } catch (e) {
                ...
                x = i.gK
                    .model('BaseSonataState', {
                        contextType: i.gK.maybeNull(i.gK.enumeration(Object.values(f.K))),
                    ...
                    .views((e) => ({
                        get unloadedEntitiesDataFromModels() {
                            var t;
                            return null != (t = e.volatileUnloadedEntitiesData) ? t : (0, h.HO)(e.unloadedEntitiesData);
                        },
                        get isVibeContext() {
                    ...
                    .actions((e) => ({
                        ...
                        setUnloadedEntitiesData: (t) => {
                            t && ((e.volatileUnloadedEntitiesData = (0, y.A)(t)), (e.unloadedEntitiesData = (0, i.wg)(t)));
                        },
                ...
                E = a(60030)
                    .z8.props({ artists: i.gK.array(r.PK), isHiddenFromSonataQueue: i.gK.maybe(i.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
                ...
                K = x
                    ...
                    .actions((e) => ({
                        ...
                        setCrossFadeMode: (t) => {
                            ...
                            (a.set(n.cYZ.CrossFadeMode, t), (e.isCrossFadeEnabled = t));
                        },
                    }))
                    .named('SonataState');
            (a(75797), a(1199));
        ...
        17999: (e, t, a) => {
            ...
            let s = (e) => {
                    ...
                    return (0, i.jsx)(r.OY, {
                        ...
                        headingVariant: v,
                        ...p,
                        children: null == d ? void 0 : d.map((e) => (0, i.jsx)(n.PlaylistCard, { playlist: e, contentLinesCount: 3 }, e.key)),
                    });
                },
                o = (0, l.forwardRef)((e, t) => (0, i.jsx)(s, { forwardRef: t, ...e }));
        },
        19525: (e) => {
            e.exports = {
        ...
        27618: (e, t, a) => {
            ...
            var i = a(33008),
                ...
                v = a.n(g);
            let p = (0, r.PA)((e) => {
                let { className: t, title: a, description: r, iconVariant: g = 'musicLogo', iconClassName: p, iconSize: y } = e,
                ...
                return (
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, l.$)(v().root, { [v().root_desktop]: !h }, t),
                        children: [
                            (0, i.jsx)(c.Lh, { withBackwardFallback: '/', className: v().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: v().content,
                                children: [
                                    (0, i.jsx)(o.Icon, { className: (0, l.$)(v().icon, p), variant: g, size: y }),
                                    (0, i.jsx)(d.Heading, {
                                        className: (0, l.$)(v().title, v().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: a || (0, i.jsx)(n.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, i.jsx)(d.Caption, {
                                        className: (0, l.$)(v().text, v().important),
                                        variant: 'span',
                                        type: 'text',
                                        size: 'l',
                                        weight: 'normal',
        ...
        43250: (e, t, a) => {
            ...
            let o = () => {
                ...
                return (
                    ...
                    (0, i.jsxs)(r.Suspense, { fallback: (0, i.jsx)(n.Cm, {}), children: [(0, i.jsx)(n.SM, { playlistUuid: e }), ';'] })
                );
            };
        },
        45242: (e, t, a) => {
            ...
            let r = (e) => {
                var t, a;
                let { playlist: r, generatedPlaylistType: n, likesCount: s, trailer: o, tracksCount: d } = e;
                return (0, i.wg)({
            ...
            ((0, s.cache)(async (e, t) => {
                ...
                let i;
                try {
                    let { container: a, backendHostTld: r, locale: n, host: s, fullUrl: o, isRSC: d, requestUrl: u } = await (0, l.IhE)();
                    if (d) return { playlist: void 0, backendHostTld: r, locale: n, host: s, fullUrl: o, requestUrl: u };
                    let c = a.get(l._19);
                    i = {
                        playlist: await c.getPlaylistWithTracksIds({ userId: e, playlistKind: t, resumeStream: !1 }),
                        backendHostTld: r,
                        locale: n,
                        host: s,
                        fullUrl: o,
                    ...
                    return (0, l.tfF)(e, () => ({ playlist: void 0, ...(0, l.Bj3)() }));
                }
                return ((null == (a = i.playlist) ? void 0 : a.error) === 'not-found' && (0, n.notFound)(), i);
            }),
                (0, s.cache)(async (e) => {
                    var t;
                    let a;
                    ...
                    try {
                        let { container: t, backendHostTld: i, locale: r, host: n, fullUrl: s, isRSC: o, requestUrl: d } = await (0, l.IhE)();
                        if (o) return { playlist: void 0, backendHostTld: i, locale: r, host: n, fullUrl: s, requestUrl: d };
                        let u = t.get(l.qNr);
                        a = {
                            playlist: await u.getPlaylist({ playlistUuid: e, resumeStream: !1, richTracks: !1 }),
                            backendHostTld: i,
                            locale: r,
                            host: n,
                            fullUrl: s,
                    ...
                    return ((null == (t = a.playlist) ? void 0 : t.error) === 'not-found' && (0, n.notFound)(), a);
                }));
            var o = a(25911);
            let d = (e) => ({ uid: e.uid, login: e.login, name: e.name, sex: e.sex, verified: e.verified }),
                u = (e) =>
                    (0, i.wg)({
                        ...
                        modified: e.modified,
                        madeFor: e.madeFor
                            ? ((e) => (0, i.wg)({ userInfo: e.userInfo ? d(e.userInfo) : null, caseForms: e.caseForms ? (0, l.NH4)(e.caseForms) : null }))(e.madeFor)
                            : null,
                    });
            var c = a(70879);
            let m = (e) => {
                var t, a;
                return (0, i.wg)({ ...(0, o.jX)(e), artists: null != (a = null == e || null == (t = e.artists) ? void 0 : t.map(c.dM)) ? a : [] });
            };
            var g = a(61744);
            let v = (e) => {
                var t, a;
                return (0, i.wg)({ ...(0, o.jX)(e), tracks: null != (a = null == e || null == (t = e.tracks) ? void 0 : t.map(g.Rw)) ? a : [] });
            };
            var p = a(59615),
                y = a(64802);
            let h = i.gK.model('PlaylistOwner', {
                ...
                f = i.gK.model('PlaylistOwner', { userInfo: i.gK.maybeNull(h), caseForms: i.gK.maybeNull(p.lg) }),
                k = i.gK.model('PlaylistTag', { id: i.gK.string, value: i.gK.string }),
                _ = o.$o
                    .props({
                        owner: i.gK.maybe(h),
                    ...
                    .views((e) => ({
                        ...
                        get tagsString() {
                            ...
                            if (!t.checkExperiment(l.zal.WebEditorsFeatures, 'on') || !Array.isArray(e.tags) || !e.tags.length) return null;
                    ...
                    .actions((e) => ({
                        changeDescription: (0, i.L3)(function* (t) {
                            ...
                            let { usersResource: a, modelActionsLogger: r } = (0, i._$)(e);
                            if (e.canUserChange) {
                                let i = e.description;
                                e.description = t;
                                try {
                                    let i = yield a.changePlaylistDescription({ description: t, userId: e.uid, playlistKind: e.kind });
                                    return ((e.description = i.description), l.FlZ.OK);
                                } catch (t) {
        ...
        56395: (e, t, a) => {
            ...
            let S = (0, r.PA)((e) => {
                ...
                let { playlist: a, onOpenChange: l, open: r, ...n } = e,
                    { shouldShowBuySubscriptionModal: u, showBuySubscriptionModal: m } = (0, k.qBP)(),
                    {
                        experiments: g,
                        settings: { isMobile: v },
                        trailer: p,
                    ...
                    K = (0, C.A_)({ entityVariant: k.DwC.PLAYLIST, urlParams: { id: a.uid, kind: a.kind } });
                (0, k.NBO)(r);
                let N = (0, c.c)(() => {
                    if (u) return void m();
                    x() || (p.openPlaylistTrailer(a.id), S(o.ky.Playlist, a.id));
                });
            ...
            var T = a(96973),
                x = a.n(T);
            let E = (0, r.PA)((e) => {
                let { className: t, playlist: a, children: r, contentLinesCount: P, customDescription: C } = e,
                    { ref: T, intersectionPropertyId: E } = (0, k.nMI)(),
                    { trailer: K, user: N } = (0, k.Pjs)(),
                    { from: I, utmLink: L } = (0, k.fyy)({ contextId: a.uuid, contextType: u.K.Playlist }),
                    { formatMessage: F } = (0, s.A)(),
                    { sendLikeSearchFeedback: A, sendNavigateSearchFeedback: w, sendPlaySearchFeedback: j } = (0, k.zEv)(),
                    [D, O] = (0, n.useState)(!1),
                    [R, M] = (0, n.useState)(!1),
                    [B, U] = (0, n.useState)(!1),
                    X = (0, b.r)(a),
                    ...
                    Q = (0, c.c)((e) => {
                        ...
                        (K.setUtmLink(L), K.openPlaylistTrailer(a.id), Y(o.ky.Playlist, a.id));
                    }),
                    [q, W] = (0, n.useState)(!1),
                    { isPlaying: J, togglePlay: ee } = (0, k.Dx4)({
                        playContextParams: { contextData: { type: u.K.Playlist, meta: { id: a.id, uuid: a.uuid }, from: I, utmLink: L }, loadContextMeta: !0 },
                    }),
                    et = (0, c.c)(() => {
                    ...
                    es = (0, n.useMemo)(() => {
                        var e;
                        return C
                            ? (0, i.jsx)(y.Caption, { variant: 'span', type: 'entity', size: 's', weight: 'medium', lineClamp: 2, children: C }, a.getKey('description'))
                            : (null == (e = a.artists) ? void 0 : e.length)
                              ? (0, i.jsx)(
                                    h.iQ,
                                    { className: x().artists, artists: a.artists, lineClamp: 1, linkClassName: x().artistLink, captionSize: 's' },
                    ...
                    eo = (0, m.L)(() => {
                        if (!a.isFavouritePlaylist)
                            return (0, i.jsx)(
                                _.cy,
                                {
                                    className: (0, l.$)(x().likeButton, x().control),
                                    isLiked: a.isLiked,
                                    onClick: el,
                                    variant: 'default',
                                    size: 's',
                        ...
                        if (null == a || null == (e = a.trailer) ? void 0 : e.isAvailable)
                            return (0, i.jsx)(
                                _.nE,
                                {
                                    children: (0, i.jsx)(
                                        _.kJ,
                                        { className: (0, l.$)(x().trailerButton, x().control), radius: 'round', size: 's', iconSize: 'xxs', onClick: Q },
                    ...
                    eu = (0, n.useMemo)(
                        () =>
                            (0, i.jsx)(
                                _.O0,
                                { onClick: z, isPinned: a.isPinned, className: (0, l.$)(x().pinButton, x().control), withRipple: !1 },
                                a.getKey('PinButton'),
                            ),
                        [z, a],
                    ),
                                    ...
                                    children: [
                                        ...
                                        (0, i.jsx)(g.hg, {
                                            ...
                                            playControl: (0, i.jsx)(
                                                _.DM,
                                                {
                                                    className: (0, l.$)(x().playButton, x().control),
                                            ...
                                            menuControl: (0, i.jsx)(
                                                S,
                                                {
                                                    ...
                                                    open: B,
                                                    onClick: er,
                                                    className: (0, l.$)(x().menuButton, x().control),
                                                    icon: (0, i.jsx)(v.Icon, { size: 'xxs', variant: 'more' }),
                                                    size: 's',
                ...
                return (0, i.jsxs)(g.MN, {
                    ...
                    title: (0, i.jsx)(y.Caption, {
                        ...
                        children: (0, i.jsx)(_.N_, { className: x().titleLink, href: a.url, onClick: et, children: a.title }),
                    }),
                    srTitle: (0, i.jsx)(_.N_, { href: a.url, onClick: et, children: a.title }),
                    ...
                    children: [
                        em &&
                            (0, i.jsx)(_.xW, {
                                ariaLabel: F({ id: 'entity-names.likes-counter' }, { counter: a.actualLikesCount }),
        ...
        75658: (e, t, a) => {
            ...
            let P = (0, r.PA)((e) => {
                ...
                return (0, i.jsxs)('div', {
                    className: (0, l.$)(b().root, b().controls, a, { [b().controls_disabled]: !r.isAvailable }),
                    children: [
                        r.isAvailable &&
                            (0, i.jsxs)(i.Fragment, {
                                children: [
                                    (0, i.jsx)(h.aQ, {
                                        fallback: (0, i.jsx)(h.cy, {
                                            size: 'xs',
                                            iconSize: s,
                                            className: (0, l.$)(b().item, b().likeIcon),
                                            isLiked: r.isLiked,
                                            onClick: P,
                                            disabled: !o.isAuthorized,
                                        }),
                                    }),
                                    (null == (t = r.trailer) ? void 0 : t.isAvailable) &&
                                        (0, i.jsx)(h.aQ, {
                                            fallback: (0, i.jsx)(h.kJ, {
                                                className: (0, l.$)(b().item, b().trailerIcon),
                                                iconSize: 'xs',
                                                variant: 'text',
                                                onClick: S,
                                                withRipple: !1,
                        ...
                        (0, i.jsx)('div', {
                            ...
                            children: (0, i.jsx)(v.Icon, { className: h.$f.buttonArrow, variant: 'arrowRight', size: 'xs' }),
                        }),
                    ],
                });
            });
            var C = a(19525),
                S = a.n(C);
            let T = (0, r.PA)((e) => {
                let { className: t, playlist: a, pageId: r, coverClassName: k, playButtonIconSize: _, likeIconSize: b } = e,
                    ...
                    w = (0, y.PT7)(),
                    { sendNavigateSearchFeedback: j, sendPlaySearchFeedback: D } = (0, y.zEv)(),
                    O = (0, y.NKK)(),
                    {
                        isPlaying: R,
                        isCurrent: M,
                        togglePlay: B,
                    } = (0, y.Dx4)({ playContextParams: { contextData: { type: c.K.Playlist, meta: { id: a.id, uuid: a.uuid }, from: x }, loadContextMeta: !0 } }),
                    U = (0, y.ZpR)(a.url),
                    X = (0, m.c)((e) => {
                        (null == j || j(), O({ to: d.QT.PlaylistScreen }), e.preventDefault(), U(e));
                    }),
                    G = (0, m.c)(() => {
                        w() || (E || R || (K(!0), null == D || D()), B(), N(!R));
                    }),
                    z = (0, m.c)((e) => {
                    ...
                    $ = (0, n.useCallback)(
                        (e) =>
                            (0, i.jsx)(h.q1, {
                                ...
                                alt: F({ id: 'entity-names.playlist-name' }, { playlistName: L }),
                                radius: 'xs',
                                ...e,
                            }),
                        [a, L, k, F],
                    ),
                    H = null == $ ? void 0 : $({ onPlayButtonClick: G, isPlaying: R, isCurrent: M, playButtonIconSize: _ }),
                    Y = (0, n.useMemo)(
                        () =>
                            a.url && a.isAvailable
                                ? (0, i.jsx)(h.N_, { className: (0, l.$)(h.$f.text, h.$f.titleLink), href: a.url, onClick: Z, children: L })
                                : (0, i.jsx)(p.Caption, { className: (0, l.$)(h.$f.text, h.$f.titleText), size: 'm', variant: 'div', type: 'text', children: L }),
                        [Z, a.isAvailable, a.url, L],
                    ),
                    V = (0, n.useMemo)(() => {
                        if (void 0 === a.actualLikesCount || void 0 === a.tracksCount) return;
                        let e = (0, i.jsx)(p.Caption, { variant: 'span', size: 'm', weight: 'medium', 'aria-hidden': !0, children: '•' }),
                            t = a.isLiked ? 'likedVariant' : 'likeVariant',
                            l = ''.concat(I, ' ').concat(F({ id: 'entity-names.tracks-count' }, { value: a.tracksCount }));
                        return (0, i.jsxs)('div', {
                            ...
                            children: [
                                (0, i.jsxs)('div', {
                                    ...
                                    'aria-hidden': !0,
                                    children: [
                                        (0, i.jsx)(v.Icon, { className: S().icon, variant: t, size: 'xxs' }),
                                        (0, i.jsx)(p.Caption, { variant: 'span', size: 'm', weight: 'medium', children: A(a.actualLikesCount) }),
                                    ],
                                }),
                                (0, i.jsxs)('div', {
                                    ...
                                    children: [
                                        ...
                                        (0, i.jsx)(p.Caption, {
                                            ...
                                            size: 'm',
                                            weight: 'medium',
                                            children: (0, i.jsx)(o.A, { id: 'entity-names.tracks-count', values: { value: A(a.tracksCount) } }),
                                        }),
                                    ],
                                }),
                            ],
                ...
                return (0, i.jsxs)(h.Cj, {
                    ...
                    className: (0, l.$)(h.$f.root, { [h.$f.root_disabled]: !a.isAvailable }, t),
                    'aria-label': a.title || F({ id: 'entity-names.playlist' }),
                    onClick: z,
                    ...(0, u.Am)(u.Kq.playlist.HORIZONTAL_PLAYLIST_CARD),
                    children: [H, (0, i.jsx)(h.ro, { isDisabled: !a.isAvailable, title: Y, description: V }), (0, i.jsx)(P, { playlist: a, likeIconSize: b })],
                });
            });
        },
        84706: (e, t, a) => {
            'use strict';
            (a.d(t, { SM: () => C.PlaylistPage, Pn: () => P, Cm: () => S.PlaylistShimmersPage }), a(48708));
            var i = a(41028),
                l = a(30293),
                r = a(79169),
                n = (function (e) {
                ...
                .views((e) => {
                    let t = {
                        getNumberGroupTrackDuplicated(t) {
                            ...
                            if (t && a.checkExperiment(r.zal.WebEditorsFeatures, 'on')) return e.duplicate.get(String(t.id));
                        },
                        ...
                        get sheetDataPlaylist() {
                            ...
                            let { location: t, playlist: r } = (0, i.Zn)(e),
                                ...
                                u = {
                                    ...
                                    columns: [
                                        ...
                                        { label: n.ALBUM_ID, value: s.ALBUM_ID },
                                        { label: n.TRACK_ID, value: s.TRACK_ID },
                                    ],
                                    content: r.items
                                        .filter((e) => e.data)
                                        .map((e) => {
                                            var t, a, i, r, n, s, o, u, c, m, g, v, p;
                                            let { href: y } = (0, l.getLinkAttributesBase)(null != (u = null == (t = e.data) ? void 0 : t.url) ? u : '', {
                                                    options: { host: d },
                                                }),
                                                h = (null == (a = e.data) ? void 0 : a.url) ? y : '';
                                            return {
                                                major: null != (c = null == (r = e.data) || null == (i = r.major) ? void 0 : i.name) ? c : '',
                                                name: null != (m = null == (n = e.data) ? void 0 : n.title) ? m : '',
                                                artists: null != (g = null == (s = e.data) ? void 0 : s.artists.map((e) => e.name).join(', ')) ? g : '',
                                                link: h,
                                                albumId: null != (v = e.albumId) ? v : '',
                            ...
                            return {
                                ...
                                settings: {
                                    fileName:
                                        (null == (a = r.meta) ? void 0 : a.uid) && (null == (o = r.meta) ? void 0 : o.kind)
                                            ? '%'.concat(r.meta.uid, '%_%').concat(r.meta.kind, '%_to_text')
                                            : 'to_text',
                                },
                            };
                        },
                ...
                .actions((e) => ({
                    ...
                    getAllPlaylistItems: (0, i.L3)(function* (t) {
                        let { batchSize: a } = t,
                            { playlist: l } = (0, i.Zn)(e),
                            r = l.items.length - 1;
                        for (let e = 0; e < r; e += a) yield l.getTracksByRange({ startIndex: e, endIndex: Math.min(e + a, r) });
                    }),
                    getColorForMajor(t) {
                        ...
                        s = (null == (a = e.tracks) ? void 0 : a.length)
                            ? null == (l = e.tracks)
                                ...
                                : l.map((e, t) =>
                                      ((e, t) => {
                                          let [a, l] = e.split(':');
                                          return (0, i.wg)({ id: a || '', albumId: l || '', key: ''.concat(a, '-').concat(t), data: null, loadingState: r.GuX.IDLE });
                                      })(e, t),
                                  )
                            : [];
                    return { id: e.id, name: e.name, tracks: (0, i.wg)(s), unloadedTracks: (0, i.wg)(n) };
                },
                _ = i.gK
                    .compose(
                    ...
                    .actions((e) => {
                        let t = {
                            getFilters: (0, i.L3)(function* () {
                                var a, l;
                                let { filtersResource: n, modelActionsLogger: s } = (0, i._$)(e),
                                ...
                                try {
                                    ...
                                    let a = yield n.getTracksFilters({ trackIds: u });
                                    ((e.items = (0, i.wg)(
                                        ((e) => {
                                            let t = e.filters.map(k);
                                            if (t.length < 3) return [];
                                            let a = t.find((e) => e.id === m.Q1.ALL);
                                            if (!a) return [];
                                        ...
                                        t.getFilterName(o.playlistFilter || m.Q1.ALL));
                                    let s = null == (l = e.items) ? void 0 : l.find((t) => t.id === e.activeFilter);
                                    (s && (d.setItems(s.tracks), o.setUnloadedEntitiesData(f(d.items))), (e.loadingState = r.GuX.RESOLVE));
                                } catch (t) {
                                    (s.error(t), (e.loadingState = r.GuX.REJECT));
                                }
                            }),
                            getFilterName: (0, i.L3)(function* (t) {
                                let { filtersResource: a, modelActionsLogger: l } = (0, i._$)(e);
                                try {
                            ...
                            handleFilterClick(a) {
                                if (!(0, i._n)(e)) return;
                                let { sonataState: l, playlist: r } = (0, i.Zn)(e);
                            ...
                            setActiveFilter(t) {
                                t !== m.Q1.ALL ? (e.activeFilter = t) : (e.activeFilter = void 0);
                            },
                        ...
                        let t = {
                            getTracksMeta: (0, i.L3)(function* () {
                                let { tracksResource: t, modelActionsLogger: a } = (0, i._$)(e),
                                    l = [...(e.playlistTrackIds || [])].concat(e.suggestedTrackIds || []);
                                try {
                                    let a = yield t.getTracksMeta({ trackIds: l, removeDuplicates: !0, withProgress: !0 });
                                    ((e.tracks = (0, i.wg)(null == a ? void 0 : a.map((e) => (0, v.vU)(e)))),
                            ...
                            getTracks: (0, i.L3)(function* (a) {
                                let { uid: l, kind: n } = a,
                                    { searchPlaylistResource: s, modelActionsLogger: o } = (0, i._$)(e);
                                if (e.loadingState === r.GuX.PENDING || !e.hasText || !(0, i._n)(e)) return;
                                let { playlist: d } = (0, i.Zn)(e);
                                try {
                                    var c, m;
                                    let a;
                                    e.loadingState = r.GuX.PENDING;
                                    let { playlistTrackIds: o = [], suggestedTrackIds: u = [] } = yield s.getTrackIds({ uid: l, kind: n, part: e.text }),
                                        g =
                                            ((a = d.items),
                                            o.map((e) => {
                                    ...
                                    ((e.playlistTrackIds = (0, i.wg)(g)),
                                        ...
                                        ((null == (c = e.playlistTrackIds) ? void 0 : c.length) || 0) + ((null == (m = e.suggestedTrackIds) ? void 0 : m.length) || 0) > 0
                                            ? t.getTracksMeta()
                ...
                P = i.gK
                    ...
                    .views((e) => {
                        let t = {
                            getUrl(t) {
                                if (!e.uuid) return '';
                                let { href: a } = (0, r.uvd)('/playlists/:playlistUuid', { params: { playlistUuid: e.uuid }, query: t });
                                return a;
                            },
                            get isLoading() {
                                return e.isNeededToLoad || e.loadingState === r.GuX.PENDING;
                            ...
                            get contextMeta() {
                                ...
                                return {
                                    ...
                                    likesCount: null == (m = e.meta) ? void 0 : m.likesCount,
                                    averageColor: null == (g = e.meta) ? void 0 : g.averageColor,
                                    owner: null == (v = e.meta) ? void 0 : v.owner,
                                    description: null == (y = e.meta) ? void 0 : y.description,
                                    modified: null == (h = e.meta) ? void 0 : h.modified,
                                };
                            },
                            get isDragAndDropEnabled() {
                                ...
                                return !!(
                                    (null == (f = e.meta) ? void 0 : f.canUserChange) &&
                            ...
                            get isFavouritePlaylist() {
                                var k;
                                return (null == (k = e.meta) ? void 0 : k.kind) === p.ji.LIKE;
                            },
                            ...
                            get isRewind2024Playlist() {
                                var _;
                                return (null == (_ = e.meta) ? void 0 : _.generatedPlaylistType) === 'rewind2024';
                            },
                            get areAllTracksUploaded() {
                                return e.items.every((e) => e.loadingState === r.GuX.RESOLVE);
                            },
                            get shouldShowEmptyBlock() {
                                var b, P;
                                if (!(0, i._n)(e)) return !1;
                                let { ugcUploadCenter: a } = (0, i.Zn)(e),
                                    l = !!(null == (b = e.meta) ? void 0 : b.isOwnPlaylist),
                                    r = !!((null == (P = e.meta) ? void 0 : P.kind) && a.getUploadingTracksByPlaylistKind(e.meta.kind).length),
                                    n = !!e.search.hasText;
                            ...
                            get virtualListItemsCount() {
                                ...
                                return null != (S = null == (C = e.items) ? void 0 : C.length) ? S : 0;
                            },
                            get isFiltersAvailable() {
                                var T;
                                return !!(t.isFavouritePlaylist && (null == (T = e.meta) ? void 0 : T.isOwnPlaylist));
                            },
                            get analyticsParams() {
                    ...
                    .actions((e) => {
                        let t = {
                            getTracksByRange: (0, i.L3)(function* (t) {
                                ...
                                if (!(null == (a = e.meta) ? void 0 : a.uid) || !(null == (l = e.meta) ? void 0 : l.kind)) return null;
                                ...
                                let u = ((e, t) => {
                                    ...
                                    for (let t = a; t <= i; t++) {
                                        var n, s;
                                        ((null == (n = e[t]) ? void 0 : n.loadingState) === r.GuX.IDLE ||
                                            (null == (s = e[t]) ? void 0 : s.loadingState) === r.GuX.REJECT) &&
                                            l.push(t);
                                    }
                                    return l;
                                ...
                                try {
                                    ...
                                    u.forEach((t, a) => {
                                        ...
                                        if (e.items[t] && l) {
                                            ...
                                            e.items[t] = {
                                                id: l.id,
                                                albumId: (null == (s = l.albums) || null == (n = s[0]) ? void 0 : n.id) || null,
                            ...
                            updateData: (0, i.L3)(function* (a) {
                                var l;
                                if ((null == a ? void 0 : a.error) === 'not-found') return ((e.errorStatusCode = u.X1.NOT_FOUND), (e.loadingState = r.GuX.REJECT), null);
                                ((e.similarPlaylists = (0, i.wg)(null == (l = a.similarPlaylists) ? void 0 : l.map(g.Ew))),
                                    (e.meta = (0, g.ZC)(a)),
                                    (e.items = (0, i.wg)(
                                        a.tracks.map((e, t) => ({
                                            id: String(e.id),
                                ...
                                let { sonataState: n, playlist: s, experiments: o } = (0, i.Zn)(e);
                                return (
                                    n.setUnloadedEntitiesData(f(e.items)),
                                    (null == o ? void 0 : o.checkExperiment(r.zal.WebEditorsFeatures, 'on')) && s.editorFeature.getDuplicates(e.items),
                                    yield t.getTracksByRange({ startIndex: 0, endIndex: 10 })
                                );
                            }),
                            getPlaylistByUserIdAndKind: (0, i.L3)(function* (a) {
                                let { userId: l, playlistKind: n, resumeStream: s = !1, trackMetaType: o, preloadedPlaylist: d } = a,
                                    { usersResource: c, modelActionsLogger: m } = (0, i._$)(e);
                                if (e.loadingState !== r.GuX.PENDING)
                                    try {
                                        e.loadingState = r.GuX.PENDING;
                                        let a = d;
                                        if (
                                            (a || (a = yield c.getPlaylistWithTracksIds({ userId: l, playlistKind: n, resumeStream: s, trackMetaType: o })),
                                            (e.uuid = null == a ? void 0 : a.playlistUuid),
                                            'string' != typeof a.playlistUuid)
                                        ) {
                                            ((e.errorStatusCode = u.X1.NOT_FOUND), (e.loadingState = r.GuX.REJECT));
                                            return;
                                        }
                                        (yield t.updateData(a), (e.loadingState = r.GuX.RESOLVE));
                                    } catch (t) {
                                        (m.error(t),
                                            t instanceof u.GX &&
                                                (t.statusCode === u.X1.NOT_FOUND || t.statusCode === u.X1.BAD_REQUEST) &&
                            ...
                            getPlaylistByUuid: (0, i.L3)(function* (a) {
                                let { playlistUuid: l, richTracks: n = !1, resumeStream: s = !1, preloadedPlaylist: o } = a,
                                    { playlistResource: d, modelActionsLogger: c } = (0, i._$)(e);
                                if (((e.uuid = l), e.loadingState !== r.GuX.PENDING))
                                    try {
                                        e.loadingState = r.GuX.PENDING;
                                        let a = o;
                                        (a || (a = yield d.getPlaylist({ playlistUuid: l, resumeStream: s, richTracks: n })),
                            ...
                            updatePlaylistTrackByUuid: (0, i.L3)(function* (a) {
                                let { playlistUuid: l, richTracks: n = !1, resumeStream: s = !1 } = a,
                                    { playlistResource: o, modelActionsLogger: d } = (0, i._$)(e);
                                e.uuid = l;
                                try {
                                    let a = yield o.getPlaylist({ playlistUuid: l, resumeStream: s, richTracks: n }),
                                        d = [];
                                    if (
                                        ((e.items = (0, i.wg)(
                                            a.tracks.map((t, a) => {
                                                ...
                                                let n = String(t.id),
                                                    s = t.albumId || null;
                                                return n === (null == (i = e.items[a]) ? void 0 : i.id) && s === (null == (l = e.items[a]) ? void 0 : l.albumId)
                                                    ? e.items[a]
                                                    : (d.push(a),
                                                      { id: String(t.id), albumId: t.albumId || null, key: ''.concat(t.id, '-').concat(a), loadingState: r.GuX.IDLE });
                                            }),
                                        )),
                                    ...
                                    if ((e.loadingState !== r.GuX.IDLE && (e.loadingState = r.GuX.RESOLVE), (0, i._n)(e))) {
                            ...
                            moveTrack(t, a) {
                                ...
                                if (
                                    ...
                                    !(a >= e.items.length) &&
                                    l &&
                                    (e.items.splice(t, 1), e.items.splice(a, 0, l), (0, i._n)(e))
                                ) {
                                    let { sonataState: t } = (0, i.Zn)(e);
                                    t.setUnloadedEntitiesData(f(e.items));
                                }
        ...
        91919: (e, t, a) => {
            ...
            let m = (e) => {
                let { className: t, isEmptySearch: a } = e,
                    u = (0, r.useMemo)(
                        () => (a ? (0, i.jsx)(n.A, { id: 'search-results.not-found-title' }) : (0, i.jsx)(n.A, { id: 'error-messages.empty-collection-playlist-title' })),
                        [a],
                    ),
                    m = (0, r.useMemo)(
                        () =>
                            a
                                ? (0, i.jsx)(n.A, { id: 'search-results.not-found-description' })
                                : (0, i.jsx)(n.A, { id: 'error-messages.empty-collection-playlist-description' }),
                        [a],
                    );
                return (0, i.jsxs)('div', {
                    ...
                    children: [
                        (0, i.jsx)('div', {
                            ...
                            children: (0, i.jsx)(o.Icon, { variant: 'search', size: 'l', className: c().icon, ...(0, s.Am)(s.Kq.playlist.PLAYLIST_EMPTY_BLOCK_ICON) }),
                        }),
                        (0, i.jsx)(d.Heading, { variant: 'h3', size: 'xs', className: c().title, ...(0, s.Am)(s.Kq.playlist.PLAYLIST_EMPTY_BLOCK_TITLE), children: u }),
                        (0, i.jsx)(d.Caption, {
                            variant: 'span',
                            size: 'l',
    ...
    (e) => {
        (e.O(
            0,
            [
                7098, 8282, 9712, 5271, 7309, 8712, 6451, 9775, 952, 1709, 9284, 8004, 9323, 1020, 1311, 7764, 6706, 2089, 996, 4236, 6728, 9169, 8740, 9615, 3588, 2732,
                1744, 4204, 4078, 9718, 4760, 508, 2561, 8096, 9902, 5598, 7358,
            ],
            () => e((e.s = 25518)),
        ),
            (_N_E = e.O()));
