(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9729],
    {
        ...
        34959: (t, a, e) => {
            ...
            let q = (0, l.PA)((t) => {
                var a, e, l;
                let { artistId: x, variant: G, preloadedArtist: E, preloadedAlbums: O } = t,
                    {
                        artist: j,
                ...
                (0, v.X)(j.albumsSubpage.pagesLoader, J);
                ...
                let tt = (0, n.useMemo)(() => ({ Footer: () => (0, i.jsx)(T.A, { children: (0, i.jsx)(P.w, { className: Q().footer }) }) }), []),
                    ta = (0, n.useMemo)(() => {
                        switch (G) {
                            case L.h.DISCOGRAPHY:
                ...
                return (x &&
                    ...
                    ts.push(j.albumsSubpage.getData({ artistId: x, page: 0, pageSize: h.r3, sort: { sortBy: d.g.YEAR }, preloadedAlbums: O }))),
                x && j.infoLoadingState.isNeededToLoad && ts.push(j.getInfo({ artistId: x, preloadedArtist: E })),
                ts.length && (0, n.use)(Promise.allSettled(ts)),
                null == (l = j.meta) ? void 0 : l.artist.isLegalRejected)
                    ? (0, i.jsx)(C.M, { modalState: D })
                                        ...
                                        (0, i.jsx)(w.$, {
                                            ...
                                            itemContentCallback: (t) => {
                                                ...
                                                return a
                                                    ...
                                                    : (0, i.jsx)(U.V, { 'aria-label': e, linesCount: 4 });
                                            },
                                            totalCount: $,
                                            onGetDataByPage: J,
                                            pageSize: h.r3,
        ...
        94107: (t, a, e) => {
            ...
            let o = () => {
                ...
                return (t && (0, n.L)(t)) || (0, s.notFound)(), (0, i.jsx)(l.r, { artistId: t, variant: r.h.ALBUMS });
            };
        },
        99171: (t, a, e) => {
            Promise.resolve().then(e.bind(e, 94107));
        },
    },
    (t) => {
        t.O(
