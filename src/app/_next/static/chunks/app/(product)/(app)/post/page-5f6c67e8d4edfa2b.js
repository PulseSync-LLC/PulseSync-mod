    ...
    [3069],
    {
        ...
        27618: (t, e, o) => {
            ...
            var s = o(33008),
                ...
                g = o.n(u);
            let p = (0, n.PA)((t) => {
                let { className: e, title: o, description: n, iconVariant: u = 'musicLogo', iconClassName: p, iconSize: h } = t,
                ...
                return (
                    ...
                    (0, s.jsxs)('div', {
                        className: (0, a.$)(g().root, { [g().root_desktop]: !x }, e),
                        children: [
                            (0, s.jsx)(m.Lh, { withBackwardFallback: '/', className: g().navigation, withForwardControl: !1 }),
                            (0, s.jsxs)('div', {
                                className: g().content,
                                children: [
                                    (0, s.jsx)(l.Icon, { className: (0, a.$)(g().icon, p), variant: u, size: h }),
                                    (0, s.jsx)(d.Heading, {
                    ...
                    children: [
                        ...
                        (0, s.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, s.jsx)(m.Heading, { className: (0, a.$)(p().title, p().important), variant: 'h3', size: 'xs', children: g }),
                                (0, s.jsxs)(m.Caption, {
