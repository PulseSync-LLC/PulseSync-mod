    ...
    [6432],
    {
        ...
        27618: (e, t, n) => {
            ...
            var o = n(33008),
                ...
                c = n.n(h);
            let b = (0, s.PA)((e) => {
                let { className: t, title: n, description: s, iconVariant: h = 'musicLogo', iconClassName: b, iconSize: P } = e,
                ...
                return (
                    ...
                    (0, o.jsxs)('div', {
                        className: (0, r.$)(c().root, { [c().root_desktop]: !_ }, t),
                        children: [
                            (0, o.jsx)(u.Lh, { withBackwardFallback: '/', className: c().navigation, withForwardControl: !1 }),
                            (0, o.jsxs)('div', {
                                className: c().content,
                                children: [
                                    (0, o.jsx)(a.Icon, { className: (0, r.$)(c().icon, b), variant: h, size: P }),
                                    (0, o.jsx)(d.Heading, {
                                        className: (0, r.$)(c().title, c().important),
                                        variant: 'h3',
                                        size: 'xs',
                    ...
                    children: [
                        n &&
                            (0, o.jsx)(h.Lh, {
                                ...
                                className: (0, r.$)(b().navigation, { [b().navigation_desktop]: !g }),
                        ...
                        (0, o.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, o.jsx)(u.Heading, { className: (0, r.$)(b().title, b().important), variant: 'h3', size: 'xs', children: c }),
                                (0, o.jsxs)(u.Caption, {
        ...
        64143: (e, t, n) => {
            ...
            let u = (e) => {
                ...
                v = (0, l.PA)((e) => {
                    let { children: t, scrollElement: n, outerTitle: r = '', headerElement: l, headerThreshold: v, shouldHideHeader: h } = e,
                        [c, b] = (0, o.useState)(r),
        ...
        99556: (e, t, n) => {
            ...
            let _ = (0, s.PA)((e) => {
                ...
                let { tagId: b } = e,
                    ...
                    { contentScrollRef: x, setContentScrollRef: f } = (0, h.gKY)(),
                    N = (0, h.W6M)();
                b || (0, i.notFound)();
                              ...
                              children: (0, o.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, o.jsx)(c.Y9, {
                                          ...
                                          children: (0, o.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: _.title }),
                                      }),
                                      (0, o.jsx)(c.$$, {
                                          ...
                                          itemContentCallback: (e) => {
                                              var t;
                                              let n = null == _ || null == (t = _.playlists) ? void 0 : t[e],
                                                  r = p({ id: 'loading-messages.entity-is-loading' }, { entityName: p({ id: 'entity-names.playlist' }) });
                                              return n ? (0, o.jsx)(v.B6, { playlist: n, contentLinesCount: 3 }, n.key) : (0, o.jsx)(c.Vt, { 'aria-label': r });
                                          },
                                          totalCount: null != (n = null == _ || null == (t = _.pager) ? void 0 : t.total) ? n : 0,
                                          onGetDataByPage: j,
                                          pageSize: 20,
                                          totalRequests: null != (s = _.requests) ? s : 0,
                                          listClassName: P().content,
                                          itemClassName: P().item,
                                          handleRef: f,
                                          context: { listAriaLabel: p({ id: 'mixes.albums-list' }, { genreName: _.title || '' }) },
                                          isMobileLayout: g,
                                          useWindowScroll: g,
                                      }),
                                  ],
