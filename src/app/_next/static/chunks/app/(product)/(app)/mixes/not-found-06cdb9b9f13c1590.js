    ...
    [6046],
    {
        ...
        27618: (e, t, n) => {
            ...
            let b = (0, s.PA)((e) => {
                ...
                return (
                    ...
                    (0, r.jsxs)('div', {
                        className: (0, o.$)(u().root, { [u().root_desktop]: !_ }, t),
                        children: [
                            (0, r.jsx)(c.Lh, { withBackwardFallback: '/', className: u().navigation, withForwardControl: !1 }),
                            (0, r.jsxs)('div', {
                                className: u().content,
                                children: [
                                    (0, r.jsx)(a.Icon, { className: (0, o.$)(u().icon, b), variant: v, size: P }),
                                    (0, r.jsx)(d.Heading, {
                    ...
                    children: [
                        ...
                        (0, r.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(c.Heading, { className: (0, o.$)(b().title, b().important), variant: 'h3', size: 'xs', children: u }),
                                (0, r.jsxs)(c.Caption, {
        ...
        64143: (e, t, n) => {
            ...
            let c = (e) => {
                ...
                h = (0, l.PA)((e) => {
                    let { children: t, scrollElement: n, outerTitle: o = '', headerElement: l, headerThreshold: h, shouldHideHeader: v } = e,
                        [u, b] = (0, r.useState)(o),
                    ...
                    (0, r.useEffect)(() => {
                        E ? 0 === window.scrollY && W(!1) : (n && 0 !== n.scrollTop) || W(!1);
                    }, [n, null == n ? void 0 : n.scrollTop, E]);
                    let T = (0, r.useMemo)(() => (E ? { onScroll: (0, i.A)(F, 200) } : { onScroll: (0, i.A)(F, 200), elementRef: n }), [F, n, E]);
                    (0, a.L)(T);
                    let y = (0, r.useMemo)(
                        () => ({
                            title: u,
        ...
        74270: (e, t, n) => {
            ...
            let P = (0, o.PA)((e) => {
                let { navigationId: t } = e,
                    { genres: n } = (0, h.Pjs)(),
                    { contentScrollRef: o, setContentScrollRef: u } = (0, h.gKY)(),
                    P = (0, h.W6M)();
