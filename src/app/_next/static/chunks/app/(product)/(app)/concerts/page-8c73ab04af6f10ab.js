(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9940],
    {
        2117: (e, t, n) => {
            ...
            function c(e) {
                var t = function (t) {
                    ...
                    return r('formatDate' === e ? n.formatDateToParts(l, s) : n.formatTimeToParts(l, s));
                };
                    ...
                    function c(e) {
                        let s = l ? (0, o.jsx)(l, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            ...
                            d = t.ssr
                                ...
                                : (0, o.jsx)(a.BailoutToCSR, { reason: 'next/dynamic', children: (0, o.jsx)(n, { ...e }) });
                        return (0, o.jsx)(c, { ...(i ? { fallback: s } : {}), children: d });
                    }
        ...
        27618: (e, t, n) => {
            ...
            var o = n(33008),
                ...
                g = n.n(f);
            let _ = (0, a.PA)((e) => {
                let { className: t, title: n, description: a, iconVariant: f = 'musicLogo', iconClassName: _, iconSize: h } = e,
        ...
        44958: (e, t, n) => {
                            ...
                            if (!e.config.isLoading && !e.isLoading)
                                try {
                                    ...
                                    let { items: n } = yield t.getFeed({}),
                                        { feedConcerts: a, topConcerts: i } = ((e, t) => {
                                            let { topLimit: n, topOffset: o, feedLimit: r, feedOffset: a } = e;
                                            return { topConcerts: l(t, o, n), feedConcerts: l(t, a, r) };
                                        })(
                                            e.config,
                                            n.map((e) => (0, s.ho)(e.data.concert, e.data.minPrice)),
                                        );
                                    (e.feedConcerts = (0, r.wg)(a)), (e.topConcerts = (0, r.wg)(i)), (e.loadingState = o.GuX.RESOLVE);
                                } catch (t) {
                                    n.error(t), (e.loadingState = o.GuX.REJECT);
                                }
                        }),
            ...
            let w = (0, m.PA)(() => {
                    ...
                    x = (0, f.useCallback)(
                        (e) => {
                            ...
                            return !i || t.isShimmerVisible
                                ? (0, u.jsx)(s.LY, { isActive: t.isShimmerActive })
                                : (0, u.jsx)(o.Bki, {
                                      objectType: j.ky.Concert,
                                      objectId: i.id,
                                      objectPosX: (e % g) + 1,
                                      objectPosY: Math.floor(e / g) + 1,
                                      objectsCount: null != (a = null == (r = t.feedConcerts) ? void 0 : r.length) ? a : 0,
                                      children: (0, u.jsx)(s.Qb, { concert: i }),
                                  });
                        },
                ...
                return (
                    ...
                    (0, u.jsxs)('div', {
                        className: T().root,
                        children: [
                            (0, u.jsx)(F.Tw, { className: T().header, labeledForId: e, title: n({ id: 'concerts.all-concerts' }), headingVariant: 'h2' }),
                            (0, u.jsx)('div', {
                                'aria-labelledby': e,
                                ref: a,
                                style: h,
            ...
            let R = (e) => {
                    ...
                    return (0, u.jsxs)('div', {
                        ...
                        children: [
                            (0, u.jsx)(F.Tw, {
                                ...
                                controls: (0, u.jsx)(F.X9, { className: E().controls, carouselRef: o }),
                                headingVariant: 'h2',
                            }),
                            (0, u.jsx)(W.Carousel, {
                                className: E().carousel,
                                ref: o,
                                itemClassName: (0, L.$)(E().item, E().important),
                                'aria-labelledby': n,
                                children: t,
                            }),
                        ],
                ...
                O = (e) => Array.from({ length: 10 }, (t, n) => (0, u.jsx)(s.LY, { isActive: e, withPriceButton: !0 }, n)),
                I = (0, m.PA)(() => {
                    let { concerts: e } = (0, o.Pjs)(),
                        t = (0, o.fBs)(),
                        n = (0, f.useRef)(!1),
                                ...
                                ? e.topConcerts.map((t, n) => {
                                      ...
                                      return (0, u.jsx)(
                                          o.Bki,
                                          {
                                              ...
                                              objectPosX: n + 1,
                                              objectPosY: 1,
                                              objectsCount: null != (a = null == (r = e.topConcerts) ? void 0 : r.length) ? a : 0,
                                              children: (0, u.jsx)(s.Qb, { withMask: !1, withPriceButton: !0, concert: t }),
                                          },
                                          t.getKey(n),
                                      );
                                  })
                ...
                D = () => (0, u.jsx)(f.Suspense, { fallback: (0, u.jsx)(R, { children: O(!0) }), children: (0, u.jsx)(I, {}) });
            var z = n(83888),
                B = n(64143),
                K = n(48551),
                G = n(94503),
            ...
            let M = (0, m.PA)(() => {
                    ...
                    let { formatMessage: m } = (0, p.A)(),
                        ...
                        T = (() => {
                            ...
                            return (0, y.c)((o, r) => {
                                if (!e) return;
                                let a = { hash: n, pageId: j.QT.ConcertsLandingScreen, pageStyle: j.QL.Fullscreen, pagePlacement: j.c4.Fullscreen, viewUuid: r },
                                    s = (0, j.Fx)({ params: a, logger: t, context: 'useSendEventOnConcertsOpenedOrClosed' });
                                s && (o ? (0, j.Fn)(e.evgenInstance, s) : (0, j.PO)(e.evgenInstance, s));
                            });
                        })(),
                        L = (0, f.useRef)(String((0, b.A)())),
                        W = null != (i = null == (e = P.landing.meta) ? void 0 : e.selectedTabIndex) ? i : 0,
                        A = null != (l = null == (n = P.landing.tabs.data) || null == (t = n[W]) ? void 0 : t.blocks.length) ? l : 0;
                    return (k.checkExperiment(o.zal.WebNextConcertsTab, 'on') || (0, h.notFound)(),
                    ...
                    P.landing.isNeededToLoad && (0, f.use)(P.landing.getSkeleton({ id: v.p.CONCERTS, showWizard: S.settings.showWizard }, { preloadBlocksCount: 2 })),
                                  ...
                                  children: [
                                      ...
                                      (0, u.jsxs)(C.N, {
                                          ...
                                          children: [
                                              (0, u.jsx)(o.jPc, {
                                                  children: (0, u.jsx)(o.hjC, {
                                                      ...
                                                      children: (0, u.jsx)(o.FoH, {
                                                          ...
                                                          blockPosX: 1,
                                                          blockPosY: 1,
                                                          objectsCount: null != (c = null == (r = P.topConcerts) ? void 0 : r.length) ? c : 0,
                                                          children: (0, u.jsx)(D, {}),
                                                      }),
                                                  }),
                                              }),
                                              (0, u.jsx)(o.MZP, {
                                                  offsetBlockPosY: 1,
                                                  children: (0, u.jsx)(a.EA, { landing: P.landing, errorComponent: (0, u.jsx)(z.w, { withBackwardControl: !1 }) }),
                                              }),
                                              (0, u.jsx)(o.jPc, {
                                                  children: (0, u.jsx)(o.hjC, {
                                                      tabId: '',
                                                      ...
                                                      children: (0, u.jsx)(o.FoH, {
                                                          ...
                                                          blockPosX: 1,
                                                          blockPosY: A + 2,
                                                          objectsCount: null != (d = null == (s = P.feedConcerts) ? void 0 : s.length) ? d : 0,
                                                          children: (0, u.jsx)(w, {}),
                                                      }),
                                                  }),
                                              }),
                                              (0, u.jsx)(F.A, { children: (0, u.jsx)(F.wi, { className: X().footer }) }),
                                          ],
                                      }),
                                  ],
                              }),
        ...
        60628: (e, t, n) => {
            ...
            var o = n(33008),
                r = n(66268),
                a = n(44958);
            let s = () => (0, o.jsx)(r.Suspense, { fallback: (0, o.jsx)(a.k_, {}), children: (0, o.jsx)(a.h4, {}) });
        },
        74375: (e, t, n) => {
            'use strict';
            n.d(t, { default: () => r.a });
    ...
    (e) => {
        e.O(
            0,
            [
                7098, 8282, 9712, 5271, 7309, 8712, 8004, 9284, 7509, 1709, 4397, 9775, 8065, 952, 1311, 7764, 6706, 2089, 2140, 996, 4236, 6728, 3949, 9169, 8740, 9615,
                3588, 2732, 1744, 4204, 7747, 4078, 9718, 4760, 8747, 5765, 2898, 9902, 5598, 7358,
            ],
            () => e((e.s = 95700)),
        ),
            (_N_E = e.O());
