    ...
    [1784],
    {
        ...
        27618: (e, s, o) => {
            ...
            var i = o(33008),
                ...
                b = o.n(h);
            let c = (0, r.PA)((e) => {
                let { className: s, title: o, description: r, iconVariant: h = 'musicLogo', iconClassName: c, iconSize: _ } = e,
                ...
                return (
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, n.$)(b().root, { [b().root_desktop]: !u }, s),
                        children: [
                            (0, i.jsx)(a.Lh, { withBackwardFallback: '/', className: b().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: b().content,
                                children: [
                                    (0, i.jsx)(d.Icon, { className: (0, n.$)(b().icon, c), variant: h, size: _ }),
                                    (0, i.jsx)(m.Heading, {
        ...
        49077: (e, s, o) => {
            ...
            let a = (0, r.PA)(() => {
                let {
                    playlistPersonal: { dummyCoverUrl: e, dummyDescription: s, title: o },
                } = (0, l.Pjs)();
                return (0, i.jsxs)('div', {
                    className: P().root,
                    children: [
                        (0, i.jsx)(d.Y9, {}),
                        (0, i.jsx)(d.BW, { src: e, size: 200, fit: 'cover', withAvatarReplace: !0, 'aria-hidden': !0, className: P().cover }),
                        o && (0, i.jsx)(t.Heading, { className: (0, n.$)(P().title, P().important), variant: 'h1', size: 'xs', children: o }),
                        s &&
                            (0, i.jsx)(t.Caption, {
        ...
        95985: (e, s, o) => {
            ...
            let m = (0, n.PA)((e) => {
                ...
                if (
                    ((0, t.useEffect)(() => {
                        n.isNeededToLoad && n.getPlaylistPersonalDetails(s.playlistId);
