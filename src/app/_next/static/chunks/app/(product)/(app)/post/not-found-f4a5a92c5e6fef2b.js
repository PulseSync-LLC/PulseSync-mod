    ...
    [4004],
    {
        ...
        27618: (e, o, n) => {
            ...
            var s = n(33008),
                ...
                a = n.n(b);
            let c = (0, r.PA)((e) => {
                let { className: o, title: n, description: r, iconVariant: b = 'musicLogo', iconClassName: c, iconSize: _ } = e,
                ...
                return (
                    ...
                    (0, s.jsxs)('div', {
                        className: (0, i.$)(a().root, { [a().root_desktop]: !x }, o),
                        children: [
                            (0, s.jsx)(v.Lh, { withBackwardFallback: '/', className: a().navigation, withForwardControl: !1 }),
                            (0, s.jsxs)('div', {
                                className: a().content,
                                children: [
                                    (0, s.jsx)(d.Icon, { className: (0, i.$)(a().icon, c), variant: b, size: _ }),
                                    (0, s.jsx)(m.Heading, {
                    ...
                    children: [
                        n &&
                            (0, s.jsx)(b.Lh, {
                                ...
                                className: (0, i.$)(c().navigation, { [c().navigation_desktop]: !p }),
                                withForwardControl: !1,
                            }),
                        (0, s.jsxs)('div', {
                            className: (0, i.$)(c().content, { [c().content_shrink]: !n }),
                            children: [
                                (0, s.jsx)(h.Icon, { className: c().icon, variant: 'attention', size: 'xxl' }),
                                (0, s.jsx)(v.Heading, { className: (0, i.$)(c().title, c().important), variant: 'h3', size: 'xs', children: a }),
                                (0, s.jsxs)(v.Caption, {
        ...
        69686: (e, o, n) => {
            ...
            let p = () =>
                (0, s.jsxs)('div', {
                    className: x().root,
                    children: [(0, s.jsx)(h.Shimmer, { radius: 'l', className: x().top }), (0, s.jsx)(h.Shimmer, { radius: 'l', className: x().bottom })],
                });
            var u = n(46052),
                g = n.n(u),
                j = n(52732),
            ...
            let W = (0, r.PA)((e) => {
                ...
                return (0, s.jsx)('div', {
                    ...
                    children: (0, s.jsx)('div', {
                        ...
                        tabIndex: 0,
                        children: o.map((e) => (0, s.jsx)(j.aX, { className: S().item, album: e, contentLinesCount: 3 }, e.id)),
                    }),
                });
            });
            var k = n(90317),
            ...
            let y = (0, r.PA)((e) => {
                ...
                return (0, s.jsx)('div', {
                    ...
                    children: (0, s.jsx)('div', {
                        ...
                        'aria-labelledby': 'post-page-header',
                        tabIndex: 0,
                        children: o.map((e) => (0, s.jsx)(k.ao, { className: w().item, artist: e, contentLinesCount: 3 }, e.id)),
                    }),
                });
            });
            var F = n(45242),
            ...
            let z = (0, r.PA)((e) => {
                    ...
                    return (0, s.jsx)('div', {
                        ...
                        children: (0, s.jsx)('div', {
                            ...
                            'aria-labelledby': 'post-page-header',
                            tabIndex: 0,
                            children: o.map((e) => (0, s.jsx)(F.B6, { className: f().item, playlist: e, contentLinesCount: 3 }, e.id)),
                        }),
                    });
                }),
                L = (0, r.PA)((e) => {
                    ...
                    let u = (0, l.useMemo)(() => {
                        ...
                        switch (n.promotionType) {
                            ...
                            case d.Q.PLAYLISTS:
                                return (0, s.jsx)(z, { playlists: n.playlists });
                            default:
                                (0, t.notFound)();
                        }
                    }, [n.albums, n.artists, n.isLoading, n.playlists, n.promotionType]);
                    return (o && n.isNeededToLoad && (0, l.use)(n.getData({ promoId: o })), n.isSomethingWrong)
                        ? (0, s.jsx)(P.w, {})
                        : (0, s.jsx)(a.nVz, {
                              pageId: a._Q$.POST,
                                      ...
                                      children: [
                                          (0, s.jsx)(c.Y9, {
                                              ...
                                              children: n.title
                                                  ...
                                                  : (0, s.jsx)(h.Shimmer, { className: g().shimmerTitle, radius: 'l' }),
                                          }),
                                          (0, s.jsx)(m.N, {
                                              containerClassName: (0, i.$)(g().scrollContainer, g().important),
                                              className: g().scrollableContainer,
                                              ref: x,
                                              children: (0, s.jsx)('div', { className: g().container, children: u }),
                                          }),
                                      ],
                                  }),
                              }),
