(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [4905],
    {
        ...
        50510: (t, e, i) => {
            ...
            let c = (t) => {
                var e, i;
                return (0, a.wg)({ ...(0, o.jX)(t), artists: null != (i = null == t || null == (e = t.substituted?.artists ?? t.artists) ? void 0 : e.map(u.dM)) ? i : [] });
            };
            var m = i(93510);
            let g = (t) => {
                var e, i;
        ...
        74871: (t, e, i) => {
            Promise.resolve().then(i.bind(i, 74659));
        },
        75645: (t, e, i) => {
            'use strict';
            i.d(e, { hO: () => m, jr: () => g, jp: () => p, QZ: () => l }), i(85377);
            var a = i(55178);
            let l = (t, e, i) => {
                let l = null != i && i;
                return {
        ...
        83460: (t, e, i) => {
            ...
            let downloadPlaylistToFile = ({ playlist: t }) => {
                let e = Array.isArray(t?.trackIds) ? t.trackIds : [],
                    i = (0, c.c)(() => {
                        var e;
                        t?.title && t?.trackIds?.length && (null == (e = window.desktopEvents) || e.send(C.EE.DOWNLOAD_TRACKS, t.trackIds, 'playlist', t.title));
                    });
                return e.length
                    ? (0, a.jsx)(P.Dr, {
                          onClick: i,
    ...
    (t) => {
        t.O(0, [1670, 3445, 6375, 9745, 4567, 2575, 1311, 7764, 6706, 3267, 9769, 9574, 4574, 5428, 4089, 4220, 9562, 7358], () => t((t.s = 74871))), (_N_E = t.O());
    },
]);
