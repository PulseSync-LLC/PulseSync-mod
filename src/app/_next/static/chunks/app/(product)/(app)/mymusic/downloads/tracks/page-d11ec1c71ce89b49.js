    ...
    [1287, 9366],
    {
            ...
            let u = (0, d.PA)((e) => {
                ...
                c = (e) => {
                    ...
                    return (0, s.useCallback)(async () => {
                        if (!r.isAuthorized)
                            return void t((0, i.jsx)(a.hT, { error: d({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: l.uQT.ERROR });
                        if (m) return;
            ...
            let v = (0, u.PA)((e) => {
                ...
                h = () => {
                    ...
                    return (0, a.c)(async (s) => {
                        let { album: o, withLink: a = !0, withNotification: c = !0 } = s;
                        if (r) return;
        ...
        39959: (e, r, t) => {
            ...
            let T = (0, s.PA)(() => {
                ...
                return (
                    ...
                    (0, i.jsx)('div', { className: k().root, children: n.map((e, r) => (0, o.cloneElement)(e, { key: r })) })
                );
            });
            var x = t(36442),
                C = t.n(x);
                    ...
                    (0, i.jsxs)(i.Fragment, {
                        children: [
                            ...
                            (0, i.jsxs)('div', {
                                className: M().root,
                                children: [
                                    (0, i.jsx)(y.Icon, { className: M().icon, size: 'l', variant: 'download' }),
                                    (0, i.jsx)(f.Heading, {
                                        className: M().title,
                                        variant: 'div',
                                        size: 'xs',
                            ...
                            children: (0, i.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    (0, i.jsx)(P.$$, {
                                        ...
                                        testId: a.Xk.myMusic.MY_MUSIC_DOWNLOADED_TRACKS_PAGE,
                                    }),
                                ],
                            }),
                        }),
                    ...
                    children: [
                        ...
                        y &&
                            (0, i.jsx)(m.Icon, {
                                ...
                                size: 'xxs',
                                'aria-label': A,
                                className: (0, n.$)(v().progress, v()['progress_'.concat(k)], { [v().progress_disliked]: b, [v().progress_disabled]: P }),
        ...
        47416: (e, r, t) => {
            ...
            var i = t(88075),
                ...
                a = t(59615);
            let d = n.gK
                .compose(n.gK.model('DownloadedTracks', { items: n.gK.maybeNull(n.gK.array(o.vj)), tracks: n.gK.maybeNull(n.gK.frozen()) }), a.XT)
                .views((e) => ({
        ...
        57609: (e, r, t) => {
            ...
            let l = (e) => {
                ...
                return (
                    (0, i.useEffect)(() => {
                        a.isUnsafeDisclaimerConfirmed && a.id === m.current && !u.current && (null == t || t(), (u.current = !0));
                    ...
                    (0, s.c)(async (e) => {
                        let i = c.get(o.cYZ.ExEx),
                            n = (null == r ? void 0 : r.isPodcast)
                                ? null == i
                                    ? void 0
                                    : i.includes(''.concat(o.nPY.PODCAST, '_').concat(r.id))
                                : null == i
                                  ? void 0
                                  : i.includes(''.concat(o.nPY.ALBUM, '_').concat(null == r ? void 0 : r.id));
        ...
        59173: (e, r, t) => {
            ...
            let a = (e) => {
                let {
                        user: r,
                        modals: { promoLandingBuySubscriptionModal: t, crackdownModal: a },
                        settings: { isMobile: d },
                        paywall: m,
                ...
                return (0, s.c)(async () => {
                    ...
                    if ((!v || (null == e ? void 0 : e.isLiked) || (d ? t.open() : a.open()), r.isAuthorized) && e) {
                        if (!e.isLiked) {
                            var i, s;
                            c.sendLikeFeedback({
                                reaction: n.g.LIKE,
                ...
                return (0, s.c)(async () => {
                    if (e)
                        return d({ pageAlbumId: v, albumId: e.id, isNonMusic: e.isNonMusic })
                            ...
                            : r.isAuthorized
                              ? c({ album: e })
                              : void u((0, i.jsx)(l.hT, { error: m({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: o.uQT.ERROR });
                });
            };
        },
        64143: (e, r, t) => {
            ...
            let u = (e) => {
                ...
                c = (0, l.PA)((e) => {
                    let { children: r, scrollElement: t, outerTitle: n = '', headerElement: l, headerThreshold: c, shouldHideHeader: v } = e,
                        [h, b] = (0, i.useState)(n),
                    ...
                    (0, i.useEffect)(() => {
                        E ? 0 === window.scrollY && O(!1) : (t && 0 !== t.scrollTop) || O(!1);
                    }, [t, null == t ? void 0 : t.scrollTop, E]);
                    let S = (0, i.useMemo)(() => (E ? { onScroll: (0, o.A)(w, 200) } : { onScroll: (0, o.A)(w, 200), elementRef: t }), [w, t, E]);
                    (0, a.L)(S);
                    let N = (0, i.useMemo)(
                        () => ({
                            title: h,
                ...
                v = (e) => {
                    let { children: r, child: t, className: n } = e,
                        { setChildElement: o, setChild: l } = (0, i.useContext)(m.B9),
                        a = (0, i.useRef)(null);
                    return (
                        (0, i.useEffect)(() => {
                ...
                h = (e) => {
                    let { children: r, title: t, className: n } = e,
                        { setTitleElement: o, setTitle: l } = (0, i.useContext)(m.B9),
                        a = (0, i.useRef)(null);
                    return (
                        (0, i.useEffect)(() => {
                            (null == a ? void 0 : a.current) && o(a), t && l(t);
        ...
        82548: (e, r, t) => {
            'use strict';
            t.d(r, { AlbumEntityNameConsumer: () => o, useAlbumEntityName: () => l });
            var i = t(66268),
                n = t(73827),
                s = t(15479),
                o = (function (e) {
        ...
        89414: (e, r, t) => {
            ...
            let m = (e) => {
                ...
                u = (e) => {
                    ...
                    return (0, s.useCallback)(async () => {
                        if (!r.isAuthorized)
                            return void t((0, i.jsx)(d.hT, { error: v({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: a.uQT.ERROR });
                        if (u) return;
        ...
        91450: (e, r, t) => {
            ...
            let s = (e) => {
                let { albumId: r, albumUrl: t, callback: s } = e,
                    { getAlbumUrlWithSavedClid: o, checkIsCurrentAlbumPage: l } = (0, n.IQF)(),
                    a = (0, n.pqZ)();
                return (0, i.c)((e) => {
                    if (!r || !t) {
                        null == s || s(e);
        ...
        92725: (e, r, t) => {
            ...
            let d = () => {
                ...
                return (0, n.useCallback)(async () => {
                    var n, s;
                    if (!r) return;
                    let u = t.modal.isOpened ? l.uQT.FULLSCREEN_ERROR : l.uQT.ERROR;
                    return e.isAuthorized
                        ? (await r.setListeningFinishedStatus()) !== o.T.OK
                            ? void d((0, i.jsx)(a.hT, { error: m({ id: 'error-messages.error-during-action' }) }), { containerId: u })
                            : void (null == (s = r.meta) || s.updateFinished(!(null == (n = r.meta) ? void 0 : n.listeningFinished)))
                        : void d((0, i.jsx)(a.hT, { error: m({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: u });
        ...
        95592: (e, r, t) => {
            ...
            var l = (function (e) {
                ...
                f = t(60866),
                A = t(59615);
            let k = i.gK.model('TrackPosition', { volume: i.gK.number, index: i.gK.number }),
                T = i.gK
                    .compose(
                        i.gK.model({
                            id: i.gK.number,
                            ...
                            availableForOptions: i.gK.maybe(i.gK.array(i.gK.enumeration(Object.values(_.E)))),
                    ...
                    .views((e) => {
                        let r = {
                            ...
                            get modalDisclaimerId() {
                                if (e.disclaimers) {
                                    var t;
                                    let r = null == (t = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : t[0];
                                    if (r) {
                                        let { id: e } = r;
                                        return e;
                                    }
                            ...
                            get isForeignAgent() {
                                ...
                                if (e.disclaimers) {
                                    let r = null == (o = (0, n.bRW)(e.disclaimers, y.M.FOREIGN_AGENT)) ? void 0 : o[0];
                                    t = (null == r ? void 0 : r.type) === y.M.FOREIGN_AGENT;
                                }
                                return t && r.checkExperiment(n.zal.WebNextAgentPodcast, 'on');
                            },
                            get isLegalRejected() {
                                if (!(0, i._n)(e)) return !1;
                                if (e.disclaimers) {
                                    var l;
                                    let r = null == (l = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : l[0],
                                        t = (null == r ? void 0 : r.type) === y.M.MODAL;
                            ...
                            get isUnsafeLegal() {
                                ...
                                if (e.disclaimers) {
                                    var a;
                                    let r = null == (a = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : a[0];
                                    return e.isAvailable && (null == r ? void 0 : r.type) === y.M.MODAL;
                                }
                                return !1;
                            },
                            get isAvailableOnlyForPlus() {
                                var d;
                                return !e.isAvailable && (e.availableForPremiumUsers || !!(null == (d = e.availableForOptions) ? void 0 : d.includes(_.E.BOOKMATE)));
                            },
                            get shouldShowBooksBadge() {
                                var m;
                                return !!(
                                    e.bookmateOptionRequired ||
                                    (!e.availableForPremiumUsers && (null == (m = e.availableForOptions) ? void 0 : m.includes(_.E.BOOKMATE)))
                                );
                            },
                        };
                        return r;
    ...
    (e) => {
        e.O(
            ...
            [
                ...
                7747, 4078, 3984, 3477, 5897, 5939, 9902, 5598, 7358,
            ],
            () => e((e.s = 72210)),
        ),
            (_N_E = e.O());
