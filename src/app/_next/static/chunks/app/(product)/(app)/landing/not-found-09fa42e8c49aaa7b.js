    ...
    [8781],
    {
        ...
        27618: (e, t, n) => {
            ...
            var r = n(33008),
                ...
                g = n.n(_);
            let f = (0, a.PA)((e) => {
                let { className: t, title: n, description: a, iconVariant: _ = 'musicLogo', iconClassName: f, iconSize: h } = e,
                ...
                return (
                    ...
                    (0, r.jsxs)('div', {
                        className: (0, o.$)(g().root, { [g().root_desktop]: !p }, t),
                        children: [
                            (0, r.jsx)(u.Lh, { withBackwardFallback: '/', className: g().navigation, withForwardControl: !1 }),
                            (0, r.jsxs)('div', {
                                className: g().content,
                                children: [
                                    (0, r.jsx)(l.Icon, { className: (0, o.$)(g().icon, f), variant: _, size: h }),
                                    (0, r.jsx)(d.Heading, {
        ...
        39139: (e, t, n) => {
            ...
            let h = (0, o.PA)((e) => {
                ...
                n.isNeededToLoad && (0, a.use)(n.getSkeleton({ id: t, showWizard: !1 }, { preloadBlocksCount: 2 })),
                n.isRejected)
                    ? (0, r.jsx)(c.w, {})
                    : (0, r.jsx)(m.nVz, {
                          pageId: m._Q$.LANDING,
                                  ...
                                  children: (0, r.jsxs)(s.N, {
                                      ...
                                      children: [
                                          (0, r.jsxs)('div', {
                                              className: f().header,
                                              children: [
                                                  o.canBack && (0, r.jsx)(_.Lh, { withForwardControl: !1, withBackwardControl: o.canBack }),
                                                  (0, r.jsx)(l.Heading, {
                                                      variant: 'h1',
                                                      weight: 'bold',
                                                      size: 'xl',
                                          ...
                                          (0, r.jsx)('div', {
                                              ...
                                              children: (0, r.jsx)(d.EA, {
                                                  landing: n,
                                                  errorComponent: (0, r.jsx)(c.w, { className: f().error, withBackwardControl: !1 }),
                                              }),
                                          }),
        ...
        75295: (e, t, n) => {
            Promise.resolve().then(n.bind(n, 77995)), Promise.resolve().then(n.bind(n, 39139));
        },
        77995: (e, t, n) => {
            'use strict';
