(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2307],
    {
        ...
        5723: (e, t, s) => {
            ...
            let _ = (0, r.PA)((e) => {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsx)(d.Tw, { className: m().carouselHeader, title: u({ id: 'entity-names.mixes' }), titleSize: 'xs', viewAllActionLink: a.Zyd.mixes.href }),
                        (0, i.jsx)(l.Carousel, { className: m().carouselBlock, itemClassName: m().mixItem, children: _ }),
                    ],
                });
            });
            var g = s(98794);
            let x = (0, r.PA)((e) => {
                ...
                return (r.mixes.loadingState === a.GuX.IDLE && (0, n.use)(r.mixes.getMixes(!1)), s)
                    ? (0, i.jsx)(_, { isShimmerVisible: r.mixes.isLoading || r.mixes.isRejected, isShimmerActive: r.mixes.isLoading, mixes: r.mixes.items })
                    : (0, i.jsx)(g.MixesGrid, {
        ...
        8720: (e, t, s) => {
            ...
            let l = i.gK
                .compose(
                    i.gK.model('GenresPageModel', { title: i.gK.maybeNull(i.gK.string), items: i.gK.array(n.Gc), errorStatusCode: i.gK.maybeNull(i.gK.number) }),
                    o.XT,
                )
                .views((e) => ({
                    get isLoading() {
                        return e.isNeededToLoad || e.loadingState === a.GuX.PENDING;
                    },
                    get isNotFound() {
                ...
                .actions((e) => ({
                    getData: (0, i.L3)(function* (t) {
                        let { landing3Resource: s, modelActionsLogger: o } = (0, i._$)(e);
                        if (e.loadingState !== a.GuX.PENDING)
                            try {
                                e.loadingState = a.GuX.PENDING;
                                let o = (yield s.getMetatags({})).trees.find((e) => e.navigationId === t);
                                if (!o) {
                                    e.errorStatusCode = r.X1.NOT_FOUND;
                                    return;
                                }
                                (e.title = o.title), (e.items = (0, i.wg)(o.leaves.map(n.kc))), e.loadingState !== a.GuX.IDLE && (e.loadingState = a.GuX.RESOLVE);
                            } catch (t) {
                                o.error(t),
                                    t instanceof r.GX && (t.statusCode === r.X1.NOT_FOUND || t.statusCode === r.X1.BAD_REQUEST) && (e.errorStatusCode = r.X1.NOT_FOUND),
                                    e.loadingState !== a.GuX.IDLE && (e.loadingState = a.GuX.REJECT);
                            }
                    }),
                    reset() {
                        (e.loadingState = a.GuX.IDLE), (e.title = null), (e.items = (0, i.wg)([])), (e.errorStatusCode = null);
                    },
                }));
            s(10858);
            var c = s(54896);
        ...
        34899: (e, t, s) => {
            ...
            let p = (0, o.PA)(() => {
                    let { mixes: e } = (0, a.Pjs)(),
                        { contentScrollRef: t, setContentScrollRef: s } = (0, a.gKY)(),
                        n = (0, a.W6M)(),
                        { formatMessage: o } = (0, c.A)();
                    return (e.isNotFound && (0, r.notFound)(), (0, a.Jzs)(e.isResolved), e.isNeededToLoad && (0, l.use)(e.getMixes(!0)), e.isRejected)
                        ? (0, i.jsx)(g.w, {})
                        : (0, i.jsx)(x.hO, {
                              scrollElement: t,
                                  ...
                                  children: [
                                      (0, i.jsx)(v.Y9, {
                                          ...
                                          children: (0, i.jsx)(m.Heading, {
                                              ...
                                              size: 'xl',
                                              lineClamp: 1,
                                              children: (0, i.jsx)(d.A, { id: 'entity-names.mixes' }),
                                          }),
                                      }),
                                      (0, i.jsx)(u.N, {
                                          ref: s,
                                          ...
                                          children: (0, i.jsxs)('div', {
                                              ...
                                              children: [
                                                  ...
                                                  (0, i.jsx)(v.A, { children: (0, i.jsx)(v.wi, { className: N().footer }) }),
                                              ],
                                          }),
                                      }),
                                  ],
                ...
                j = () => {
                    ...
                    return e ? (0, i.jsx)(n.uN, { navigationId: e }) : (0, i.jsx)(p, {});
                };
        },
        36118: (e, t, s) => {
            'use strict';
                    ...
                    children: [
                        s &&
                            (0, i.jsx)(_.Lh, {
                                ...
                                className: (0, r.$)(x().navigation, { [x().navigation_desktop]: !N }),
                                withForwardControl: !1,
                            }),
                        (0, i.jsxs)('div', {
                            className: (0, r.$)(x().content, { [x().content_shrink]: !s }),
                            children: [
                                (0, i.jsx)(d.Icon, { className: x().icon, variant: 'attention', size: 'xxl' }),
                                (0, i.jsx)(u.Heading, { className: (0, r.$)(x().title, x().important), variant: 'h3', size: 'xs', children: g }),
                                (0, i.jsxs)(u.Caption, {
        ...
        37440: (e, t, s) => {
                ...
                a = {
                    6699: (e, t, s) => {
                        ...
                        t.useDebouncedToggle = (e) => {
                            let { delay: t, initialState: s, throttleTimeout: n } = e,
                                a = (0, r.useRef)(null),
                                [o, l] = (0, r.useState)(!!s),
                                c = (0, r.useMemo)(
                                    () =>
                                ...
                                d = (0, r.useCallback)(() => {
                                    l(!!s), a.current && window.clearTimeout(a.current);
                                }, [s]);
                            return (
                                (0, r.useEffect)(
                                    () => () => {
            ...
            (() => {
                ...
                let e = l(810),
                    ...
                    s = l(6699);
                c.useScroll = (i) => {
                    let { onScroll: r, listenIsScrolling: n, elementRef: a } = i,
                        { state: o, handleDebouncedToggle: l } = (0, s.useDebouncedToggle)({ delay: 1e3, throttleTimeout: 100 }),
                        c = (0, e.useCallback)(() => {
                            n && l(), null == r || r();
                        }, [n, l, r]);
                    return (
                        (0, e.useEffect)(() => {
                            ...
                            return s.addEventListener('scroll', c, i), () => s.removeEventListener('scroll', c, i);
                        }, [a, c]),
                        o
                    );
                };
        ...
        47020: (e, t, s) => {
            ...
            var i = s(51606),
                ...
                l = s(54690);
            let c = i.gK
                .compose(i.gK.model('Mixes', { items: i.gK.array(a.f), errorStatusCode: i.gK.maybeNull(i.gK.number) }), l.XT)
                .views((e) => ({
                    get isLoading() {
                ...
                .actions((e) => ({
                    getMixes: (0, i.L3)(function* (t) {
                        let { landingResource: s, modelActionsLogger: l } = (0, i._$)(e);
                        if (e.loadingState !== o.GuX.PENDING)
                            try {
                                e.loadingState = o.GuX.PENDING;
                                let r = yield s.getBlock({ source: { uri: '/landing/block/mixes', fullList: t }, type: n.t.MIXES });
                                (e.items = { items: (0, i.wg)(r.items.map((e) => (0, a.Ju)(e.data))) }.items), (e.loadingState = o.GuX.RESOLVE);
                            } catch (t) {
                                l.error(t),
                                    t instanceof r.GX && (t.statusCode === r.X1.NOT_FOUND || t.statusCode === r.X1.BAD_REQUEST) && (e.errorStatusCode = r.X1.NOT_FOUND),
                    ...
                    : (0, i.jsxs)(d.hO, {
                          ...
                          children: [
                              (0, i.jsx)(_.Y9, {
                                  ...
                                  children: (0, i.jsx)(l.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: s.title }),
                              }),
                              (0, i.jsx)(o.N, {
                                  className: x().root,
                                  ...
                                  children: (0, i.jsx)('div', {
                                      className: x().list,
                                      children: s.items.map((e) => (0, i.jsx)(u.G4, { tag: e.tag, title: e.title, subGenres: e.subGenres }, e.tag)),
                                  }),
                              }),
                          ],
                      });
        ...
        68573: (e, t, s) => {
            Promise.resolve().then(s.bind(s, 34899));
        },
        71659: (e, t, s) => {
            'use strict';
            ...
            let r = (e) => ({ tag: e.tag, title: e.title, subGenres: (0, i.wg)((e.leaves || []).map((e) => ({ tag: e.tag, title: e.title }))) }),
                n = i.gK.model('GenreListItemSubGenreModel', { tag: i.gK.string, title: i.gK.string }),
                a = i.gK.model('GenreListItemModel', { tag: i.gK.string, title: i.gK.string, subGenres: i.gK.array(n) });
            var o = s(82181);
        },
        74351: (e, t, s) => {
            'use strict';
            ...
            var i = s(62936),
                ...
                _ = s.n(m);
            let g = (0, n.PA)((e) => {
                let { className: t, title: s, weblink: n, covers: m = [], coverSize: g = 100, imagesLayoutType: x, headingVariant: v = 'h3' } = e;
                return (0, i.jsx)(u.N_, {
                    href: n,
                    ...
                    children: (0, i.jsxs)(c.Paper, {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)('div', {
                                className: (0, r.$)(_().covers, { [_().covers_radial]: x === o.R.RADIAL, [_().covers_stack]: x === o.R.STACK }),
                                ...
                                children: [
                                    (0, i.jsx)(l.Image, {
                                        ...
                                        className: _().cover,
                                        size: g,
                                        ...(0, a.Am)(a.OA.mix.MIX_CARD_COVER_IMAGE_3),
                                    }),
                                    (0, i.jsx)(l.Image, {
                                        src: m[1],
                                        withAvatarReplace: !0,
                                        ...
                                        className: _().cover,
                                        size: g,
                                        ...(0, a.Am)(a.OA.mix.MIX_CARD_COVER_IMAGE_2),
                                    }),
                                    (0, i.jsx)(l.Image, {
                                        src: m[0],
                                        withAvatarReplace: !0,
                                        ...
                                        className: _().cover,
                                        size: g,
                                        ...(0, a.Am)(a.OA.mix.MIX_CARD_COVER_IMAGE_1),
                                    }),
                                ],
                            }),
                        ],
                ...
                return (0, i.jsxs)('div', {
                    ...
                    children: [
                        (0, i.jsx)(a.N_, {
                            className: l().link,
                            href: '/genre/'.concat(t),
                            children: (0, i.jsx)(n.Heading, { variant: 'h2', size: 'm', lineClamp: 1, className: l().linkTitle, children: s }),
                        }),
                        r.length > 0 &&
                            (0, i.jsx)('div', {
                                className: l().list,
        ...
        91455: (e, t, s) => {
            ...
            var i = s(62936),
                ...
                g = s.n(_);
            let x = (0, n.PA)((e) => {
                let { className: t, title: s, description: n, iconVariant: _ = 'musicLogo', iconClassName: x, iconSize: v } = e,
                ...
                return (
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, r.$)(g().root, { [g().root_desktop]: !h }, t),
                        children: [
                            (0, i.jsx)(u.Lh, { withBackwardFallback: '/', className: g().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: g().content,
                                children: [
                                    (0, i.jsx)(l.Icon, { className: (0, r.$)(g().icon, x), variant: _, size: v }),
                                    (0, i.jsx)(c.Heading, {
                                        className: (0, r.$)(g().title, g().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: s || (0, i.jsx)(a.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, i.jsx)(c.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: n || (0, i.jsx)(a.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, i.jsx)(o.$, {
                                        onClick: p,
                                        className: g().button,
                                        ...
                                        children: (0, i.jsx)(c.Caption, {
                                            ...
                                            variant: 'span',
                                            size: 'm',
                                            children: (0, i.jsx)(a.A, { id: 'navigation.page-main' }),
                                        }),
                                    }),
                                ],
                            }),
        ...
        92229: (e, t, s) => {
            'use strict';
            s.d(t, { hO: () => m, jr: () => _, jp: () => g, QZ: () => r }), s(21485);
            var i = s(44020);
            let r = (e, t, s) => {
                let r = null != s && s;
                return {
                    topColorStyle: (0, i.useMemo)(() => {
                        ...
                        let s = r ? 93 : 17,
                            i = t - s;
                        return { '--average-color-background': e, transform: 'translateY('.concat(t >= s ? 0 : i, 'px)'), opacity: 1 };
                    }, [t, r, e]),
            ...
            let u = (e) => {
                ...
                m = (0, o.PA)((e) => {
                    let { children: t, scrollElement: s, outerTitle: r = '', headerElement: o, headerThreshold: m, shouldHideHeader: _ } = e,
                        [g, x] = (0, i.useState)(r),
                    ...
                    let T = (0, i.useCallback)(() => {
                        ...
                        let i = (e) => {
                            M(e > t),
                                _ && b(e > 30),
                                (null == v ? void 0 : v.current) && S(u({ element: null == v ? void 0 : v.current, scrollTop: e, isMobile: k })),
                                (null == N ? void 0 : N.current) && A(u({ element: null == N ? void 0 : N.current, scrollTop: e, isMobile: k }));
                        };
                        k ? i(window.scrollY) : s && i(s.scrollTop);
                    }, [m, o, k, _, v, N, s]);
                    (0, i.useEffect)(() => {
                        k ? 0 === window.scrollY && M(!1) : (s && 0 !== s.scrollTop) || M(!1);
                    }, [s, null == s ? void 0 : s.scrollTop, k]);
                    let y = (0, i.useMemo)(() => (k ? { onScroll: (0, a.A)(T, 200) } : { onScroll: (0, a.A)(T, 200), elementRef: s }), [T, s, k]);
                    (0, l.L)(y);
                    let L = (0, i.useMemo)(
                        () => ({
                            title: g,
                ...
                _ = (e) => {
                    let { children: t, child: s, className: r } = e,
                        { setChildElement: a, setChild: o } = (0, i.useContext)(d.B9),
                        l = (0, i.useRef)(null);
                    return (
                        (0, i.useEffect)(() => {
                ...
                g = (e) => {
                    let { children: t, title: s, className: r } = e,
                        { setTitleElement: a, setTitle: o } = (0, i.useContext)(d.B9),
                        l = (0, i.useRef)(null);
                    return (
                        (0, i.useEffect)(() => {
                            (null == l ? void 0 : l.current) && a(l), s && o(s);
        ...
        98794: (e, t, s) => {
            ...
            var i = s(62936),
                ...
                _ = s.n(m);
            let g = (0, n.PA)((e) => {
                let { isShimmerVisible: t, isShimmerActive: s, withTitle: n, mixes: m, shimmerCount: g = 5, className: x } = e,
                    v = (0, a.useMemo)(
                        () =>
                            t
                                ? (0, i.jsx)(u.eI, { isActive: s, round: !1, centered: !1, withInfo: !1, count: g })
                                : m.map((e) => (0, i.jsx)(d.NZ, { title: e.title, weblink: e.weblink, covers: e.covers, imagesLayoutType: e.imagesLayoutType }, e.id)),
                        [s, t, m, g],
                    );
                return (0, i.jsxs)('div', {
                    ...
                    children: [
                        n &&
                            (0, i.jsx)(c.Heading, {
                                ...
                                children: (0, i.jsx)(o.A, { id: 'entity-names.mixes' }),
                            }),
                        (0, i.jsx)('div', { className: (0, r.$)(_().mixesGrid, x), children: v }),
                    ],
                });
            });
        },
    ...
    (e) => {
        e.O(0, [260, 85, 3196, 403, 1970, 2670, 2537, 4103, 7125, 1311, 7764, 6706, 2899, 5419, 2561, 5906, 4690, 4501, 1009, 4670, 7358], () => e((e.s = 68573))),
            (_N_E = e.O());
    },
]);
