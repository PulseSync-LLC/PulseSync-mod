(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [813],
    {
        ...
        36806: (t, e, n) => {
            Promise.resolve().then(n.bind(n, 48129));
        },
        42421: (t, e, n) => {
            'use strict';
            n.d(e, { M: () => r.NotFound });
        ...
        48129: (t, e, n) => {
            ...
            var r = n(54486),
                ...
                i = n(83252);
            let s = () => {
                let t = (0, a.useSearchParams)().get('artistId');
                return (t && (0, i.LLJ)(t)) || (0, a.notFound)(), (0, r.jsx)(o.rJ, { artistId: t, variant: i.hVl.COMPILATIONS });
            };
        },
        57249: (t, e, n) => {
            'use strict';
        ...
        65034: (t, e, n) => {
            ...
            var r = n(54486),
                ...
                f = n.n(_);
            let p = (0, o.PA)((t) => {
                let { className: e, title: n, description: o, iconVariant: _ = 'musicLogo', iconClassName: p, iconSize: g } = t,
                ...
                return (
                    ...
                    (0, r.jsxs)('div', {
                        className: (0, a.$)(f().root, { [f().root_desktop]: !h }, e),
                        children: [
                            (0, r.jsx)(c.Lh, { withBackwardFallback: '/', className: f().navigation, withForwardControl: !1 }),
                            (0, r.jsxs)('div', {
                                className: f().content,
                                children: [
                                    (0, r.jsx)(l.Icon, { className: (0, a.$)(f().icon, p), variant: _, size: g }),
                                    (0, r.jsx)(d.Heading, {
                    ...
                    children: [
                        n &&
                            (0, r.jsx)(_.Lh, {
                                ...
                                className: (0, a.$)(p().navigation, { [p().navigation_desktop]: !v }),
                        ...
                        (0, r.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(c.Heading, { className: (0, a.$)(p().title, p().important), variant: 'h3', size: 'xs', children: f }),
                                (0, r.jsxs)(c.Caption, {
        ...
        97151: (t, e, n) => {
            ...
            function d(t) {
                var e = function (e) {
                    ...
                    return a('formatDate' === t ? n.formatDateToParts(l, i) : n.formatTimeToParts(l, i));
                };
