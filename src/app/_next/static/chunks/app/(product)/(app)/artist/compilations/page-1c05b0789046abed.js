(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [813],
    {
            ...
            let l = { loader: () => Promise.resolve(i(() => null)), loading: null, ssr: !0 },
                s = function (e) {
                    let t = { ...l, ...e },
                        ...
                        s = t.loading;
                    function u(e) {
                        let i = s ? (0, a.jsx)(s, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            l = !t.ssr || !!t.loading,
                        ...
                        return (0, a.jsx)(u, { ...(l ? { fallback: i } : {}), children: d });
                    }
            ...
            let p = (0, n.PA)((e) => {
                ...
                return (
                    ...
                    (0, a.jsxs)('div', {
                        ...
                        children: [
                            (0, a.jsx)(m.Lh, { withBackwardFallback: '/', className: _().navigation, withForwardControl: !1 }),
                            (0, a.jsxs)('div', {
                                className: _().content,
                                children: [
                                    (0, a.jsx)(s.Icon, { className: (0, o.$)(_().icon, p), variant: f, size: v }),
                                    (0, a.jsx)(u.Heading, {
                                        className: (0, o.$)(_().title, _().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: r || (0, a.jsx)(i.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, a.jsx)(u.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: n || (0, a.jsx)(i.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, a.jsx)(l.Button, {
                                        onClick: x,
                                        className: _().button,
                                        ...
                                        children: (0, a.jsx)(u.Caption, {
                                            ...
                                            variant: 'span',
                                            size: 'm',
                                            children: (0, a.jsx)(i.A, { id: 'navigation.page-main' }),
                                        }),
                                    }),
                                ],
                            }),
        ...
        67453: (e, t, r) => {
            ...
            let l = () => {
                ...
                return ((e && (0, i.LLJ)(e)) || (0, o.notFound)(), (0, a.jsx)(n.rJ, { artistId: e, variant: i.hVl.COMPILATIONS }));
            };
        },
        74375: (e, t, r) => {
            'use strict';
    ...
    (e) => {
        (e.O(
            0,
            [
                7098, 8282, 9712, 5271, 7309, 8712, 8004, 9284, 7509, 1709, 4397, 952, 9775, 9149, 9323, 1311, 7764, 6706, 2089, 2140, 996, 4236, 6728, 3949, 9152, 9169,
                8740, 9615, 3588, 2732, 1744, 4204, 7747, 4078, 9718, 4760, 8747, 5765, 2898, 508, 5897, 939, 682, 9902, 5598, 7358,
            ],
            () => e((e.s = 12253)),
        ),
            (_N_E = e.O()));
