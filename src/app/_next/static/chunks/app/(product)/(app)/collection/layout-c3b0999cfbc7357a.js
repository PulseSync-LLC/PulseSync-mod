(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        5217: (e, t, o) => {
            Promise.resolve().then(o.bind(o, 84078));
        },
        20472: (e, t, o) => {
            'use strict';
            o.d(t, { Z: () => n });
                ...
                a = (function (e) {
                    function t(o, i) {
                        ...
                        var a = this,
                            ...
                            s = o || 'Internal error';
                        return (
                            Object.defineProperty((a = e.call(this, s, b) || this), 'name', { enumerable: !0, configurable: !0, writable: !0, value: 'BaseException' }),
        ...
        32087: (e, t, o) => {
            ...
            let a = () => {
                var e, t, o;
                let { user: a, experiments: l, settings: r } = (0, i.g)();
                return (
                    !l.checkExperiment(n.z.WebNextDisableCollection, 'on') &&
                    !(null == (e = r.browserInfo) ? void 0 : e.isTouch) &&
                    a.isAuthorized &&
                    !a.hasPlus &&
                    (null == (o = l.getExperiment(n.z.WebNextDesktopWebFreemium)) || null == (t = o.value) ? void 0 : t.closeCollection) === 'on'
                );
            };
        },
        57594: (e, t, o) => {
        ...
        84078: (e, t, o) => {
            ...
            var i = o(96103),
                ...
                b = o(57594);
            let s = [
                r.Z.collectionNonMusic.href,
                r.Z.collectionNonMusicLiked.href,
                r.Z.collectionVibeRooms.href,
                r.Z.collectionShelf.href,
                r.Z.collectionShelfLiked.href,
                r.Z.collectionShelfRecentlyPlayed.href,
            ];
            var c = o(79406);
            let W = (0, i.PA)((e) => {
                let { children: t } = e,
                ...
                return (
                    (() => {
                        let e = (0, n.usePathname)(),
                            t = (0, l.n)(),
                            { paywall: o } = (0, b.g)(),
                            i = (0, a.useMemo)(() => s.includes(e), [e]),
                            r = t && !i;
                        (0, a.useEffect)(
                            () => (
                                r && o.openFreemiumCollectionPaywall(),
                                () => {
                                    o.clearFreemiumCollectionBarrier();
                                }
                            ),
                            [r, o],
                        );
                    })(),
                    o.checkExperiment(c.z.WebNextDisableCollection, 'on') && (0, n.redirect)(r.Z.main.href),
                    t
                );
            });
        },
