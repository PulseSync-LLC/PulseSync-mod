    ...
    [7706],
    {
        ...
        34959: (t, a, e) => {
            ...
            async function B(t, a) {
                ...
                return {
                    ...
                    alternates: (0, H.S)('/artist/:artistId/albums', a.tld, { params: { artistId: t.artist.id } }),
                };
            }
            async function W(t, a) {
                ...
                return {
                    ...
                    alternates: (0, H.S)('/artist/:artistId/compilations', a.tld, { params: { artistId: t.artist.id } }),
                };
            }
            async function F(t, a) {
                ...
                return {
                    ...
                    alternates: (0, H.S)('/artist/:artistId/discography', a.tld, { params: { artistId: t.artist.id } }),
                };
            }
            var X = e(22644),
                z = e(51714),
            ...
            let q = (0, l.PA)((t) => {
                var a, e, l;
                let { artistId: G, variant: x, preloadedArtist: O, preloadedAlbums: E } = t,
                    {
                        artist: j,
                    ...
                    J = (0, m.c)((t) => {
                        j.albumsSubpage.getData({ artistId: G, page: t, pageSize: h.r3, sort: { sortBy: d.g.YEAR } });
                    });
                ...
                (0, z.G)(G),
                    ...
                    ((t, a) => {
                        ...
                        (0, n.useEffect)(() => {
                            ...
                            switch (a) {
                                case L.h.ALBUMS:
                                    B({ artist: e }, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((t) => {
                                        (0, k.j)(t);
                                    });
                                    break;
                ...
                let tt = (0, n.useMemo)(() => ({ Footer: () => (0, i.jsx)(T.A, { children: (0, i.jsx)(v.w, { className: Q().footer }) }) }), []),
                    ta = (0, n.useMemo)(() => {
                        switch (x) {
                            case L.h.DISCOGRAPHY:
                                return H({ id: 'page.artist-discography-header' }, { artistName: j.commonSubPage.artistName });
                            case L.h.COMPILATIONS:
                                return H({ id: 'page.artist-compilations-header' }, { artistName: j.commonSubPage.artistName });
                            default:
                                return H({ id: 'page.artist-albums-header' }, { artistName: j.commonSubPage.artistName });
                        }
                    }, [j.commonSubPage.artistName, H, x]),
                    te = (0, n.useMemo)(() => {
                        switch (x) {
                            case L.h.DISCOGRAPHY:
                                return H({ id: 'entity-names.artist-studio-albums-list' });
                            case L.h.COMPILATIONS:
                                return H({ id: 'entity-names.artist-compilations-list' });
                            default:
                                return H({ id: 'entity-names.artist-albums-list' });
                        }
                    }, [H, x]),
                    ti = (0, n.useMemo)(() => {
                        switch (x) {
                ...
                return (G &&
                    ...
                    (j.albumsSubpage.setVariant(x),
                    ts.push(j.albumsSubpage.getData({ artistId: G, page: 0, pageSize: h.r3, sort: { sortBy: d.g.YEAR }, preloadedAlbums: E }))),
                G && j.infoLoadingState.isNeededToLoad && ts.push(j.getInfo({ artistId: G, preloadedArtist: O })),
                                        ...
                                        (0, i.jsx)(M.$, {
                                            ...
                                            itemContentCallback: (t) => {
                                                let a = j.albumsSubpage.items[t],
                                                    e = H({ id: 'loading-messages.entity-is-loading' }, { entityName: H({ id: 'entity-names.playlist' }) });
                                                return a
        ...
        42136: (t, a, e) => {
            ...
            let o = () => {
                ...
                return (t && (0, n.L)(t)) || (0, s.notFound)(), (0, i.jsx)(l.r, { artistId: t, variant: r.h.DISCOGRAPHY });
            };
        },
        52381: (t) => {
            t.exports = {
        ...
        67498: (t, a, e) => {
            Promise.resolve().then(e.bind(e, 42136));
        },
    },
    (t) => {
        t.O(
