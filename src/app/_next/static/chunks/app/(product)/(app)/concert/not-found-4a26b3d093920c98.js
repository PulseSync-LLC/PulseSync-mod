    ...
    [7290],
    {
                ...
                l = {
                    ...
                    2067: (e, t, r) => {
                        ...
                        t.useScroll = (e) => {
                            ...
                            return (
                                (0, o.useEffect)(() => {
                                    let e = (0, n.getElementFromRefOrElement)(l);
                                    if (null === e) return;
        ...
        5884: (e, t, r) => {
            ...
            function n(e, t) {
                ...
                let a = { ...n, ...t };
                return (0, o.default)({ ...a, modules: null == (r = a.loadableGenerated) ? void 0 : r.modules });
            }
            ...
            let s = { loader: () => Promise.resolve(l(() => null)), loading: null, ssr: !0 },
                i = function (e) {
                    let t = { ...s, ...e },
                        ...
                        i = t.loading;
                    function u(e) {
                        let l = i ? (0, o.jsx)(i, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            s = !t.ssr || !!t.loading,
        ...
        27618: (e, t, r) => {
            ...
            var o = r(33008),
                ...
                g = r.n(f);
            let p = (0, a.PA)((e) => {
                let { className: t, title: r, description: a, iconVariant: f = 'musicLogo', iconClassName: p, iconSize: _ } = e,
                ...
                return (
                    ...
                    (0, o.jsxs)('div', {
                        className: (0, n.$)(g().root, { [g().root_desktop]: !v }, t),
                        children: [
                            (0, o.jsx)(c.Lh, { withBackwardFallback: '/', className: g().navigation, withForwardControl: !1 }),
                            (0, o.jsxs)('div', {
                                className: g().content,
                                children: [
                                    (0, o.jsx)(i.Icon, { className: (0, n.$)(g().icon, p), variant: f, size: _ }),
                                    (0, o.jsx)(u.Heading, {
                                        className: (0, n.$)(g().title, g().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: r || (0, o.jsx)(l.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, o.jsx)(u.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: a || (0, o.jsx)(l.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, o.jsx)(s.Button, {
                                        onClick: N,
                                        className: g().button,
                                        ...
                                        children: (0, o.jsx)(u.Caption, {
                                            ...
                                            variant: 'span',
                                            size: 'm',
                                            children: (0, o.jsx)(l.A, { id: 'navigation.page-main' }),
                                        }),
                                    }),
                                ],
                            }),
        ...
        63661: (e, t, r) => {
            ...
            var o = r(41028);
            let n = o.gK.model('ConcertDescription', { text: o.gK.string, genre: o.gK.maybe(o.gK.string), source: o.gK.maybe(o.gK.string) });
            var a = r(61979),
                l = r(12898),
                s = r(70879),
                i = r(51551),
            ...
            let c = o.gK
                .compose(
                    o.gK.model('ConcertPage', {
                        ...
                        leadArtistId: o.gK.maybeNull(o.gK.union(o.gK.string, o.gK.number)),
                ...
                .actions((e) => ({
                    getInfo: (0, o.L3)(function* (t) {
                        let { concertId: r } = t,
                            { concertsResource: n, modelActionsLogger: l } = (0, o._$)(e);
                        if (!e.isLoading)
                            try {
            ...
            let N = (0, f.PA)(() => {
                    ...
                    return (0, m.jsx)(_.M, { title: n, description: a, iconVariant: 'attention', iconSize: 'xxl', iconClassName: b().icon });
                }),
                j = (0, f.PA)(() => (0, m.jsx)(u.nVz, { pageId: u._Q$.PAGE_NOT_FOUND_SCREEN, children: (0, m.jsx)(N, {}) }));
            var x = r(17846),
                y = r(54960),
                C = r(93967),
                h = r(43836),
            ...
            let I = (0, f.PA)((e) => {
                    ...
                    let { concertId: n, isWebNextNavigationOn: a } = e,
                        ...
                        c = (() => {
                            ...
                            return (0, P.c)((n, a) => {
                                if (!e || !r) return;
                                let l = { hash: o, pageId: r, pageStyle: C.QL.Fullscreen, pagePlacement: C.c4.Fullscreen, viewUuid: a, mainObjectType: C.ky.Concert },
                                    s = (0, C.Fx)({ params: l, logger: t, context: 'useSendEventOnConcertOpenedOrClosed' });
                                s && (n ? (0, C.Fn)(e.evgenInstance, s) : (0, C.PO)(e.evgenInstance, s));
                            });
                        })(),
                        f = (0, g.useRef)(String((0, y.A)())),
                        { setContentScrollRef: p, contentScrollRef: _ } = (0, u.gKY)(),
                        { forceUpdateRefCallback: v, offsetY: b } = (0, F.G)(_),
                        N = (0, u.ytd)(null == (r = i.covers) || null == (t = r[0]) ? void 0 : t.color),
                        { topColorStyle: j, headerStyle: D } = (0, S.QZ)(N, b, a),
                        I = (0, P.c)(() => {
                    ...
                    if (
                        ...
                        i.landing.isNeededToLoad && K.push(i.landing.getConcertSkeleton({ concertId: n, skeletonId: h.p.CONCERT_PAGE }, { preloadBlocksCount: 2 })),
                    ...
                    let B = (0, E.L)(() => {
                        ...
                        return i.isLoading || !i.meta || i.isRejected
                            ? (0, m.jsx)(k.c6, { className: L().header, isActive: !0 })
                            : (0, m.jsx)(u.Bki, {
                    ...
                    return (0, m.jsx)(u.jPc, {
                        children: (0, m.jsxs)(S.hO, {
                            scrollElement: _,
                            children: [
                                (0, m.jsx)(w.Y9, { style: D, variant: w.Vw.INNER, showControls: !1 }),
                                (0, m.jsx)('div', { className: L().averageColorBackground, style: j }),
                                (0, m.jsxs)(O.N, {
                                    ref: p,
                                    className: L().root,
                                        ...
                                        (0, m.jsxs)('div', {
                                            children: [
                                                (0, m.jsx)(u.hjC, {
                                                    ...
                                                    children: (0, m.jsx)(u.FoH, {
                                                        blockId: C.LA.ConcertHeader,
                                                        blockType: C.LA.ConcertHeader,
                                                        blockPosX: 1,
                                                        blockPosY: 1,
                                                        objectsCount: 1,
                                                        mainObjectType: C.ky.Concert,
                                                        mainObjectId: null == (o = i.meta) ? void 0 : o.id,
                                                        children: B,
                                                    }),
                                                }),
                                                (0, m.jsx)(l.EA, {
                                                    containerClassName: L().skeleton,
                                                    landing: i.landing,
                                                    errorComponent: (0, m.jsx)(T.w, { className: L().error, withBackwardControl: !1 }),
                                                }),
                                            ],
                                        }),
                                        (0, m.jsx)(w.A, { children: (0, m.jsx)(w.wi, { className: L().footer }) }),
                                    ],
                                }),
                            ],
                        }),
                ...
                R = (0, f.PA)((e) => (0, m.jsx)(u.nVz, { pageId: u._Q$.CONCERT, pageEntityId: e.concertId, children: (0, m.jsx)(I, { ...e }) }));
        },
        74375: (e, t, r) => {
            'use strict';
            r.d(t, { default: () => n.a });
    ...
    (e) => {
        e.O(
            ...
            [
                ...
                3588, 2732, 1744, 4204, 7747, 4078, 9718, 4760, 8747, 5765, 2898, 508, 9902, 5598, 7358,
            ],
            () => e((e.s = 7050)),
        ),
            (_N_E = e.O());
