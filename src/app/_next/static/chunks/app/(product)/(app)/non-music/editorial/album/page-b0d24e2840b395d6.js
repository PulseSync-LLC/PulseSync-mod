        ...
        51819: (e, t, r) => {
            ...
            let I = (0, s.PA)((e) => {
                ...
                let w = (0, i.useCallback)(
                    ...
                    j = (0, i.useMemo)(() => ({ Footer: () => (0, l.jsx)(f.A, { children: (0, l.jsx)(R.w, { className: v().footer }) }) }), []),
                    F = I.isLoading ? 20 : null != (r = null == (t = I.albums) ? void 0 : t.length) ? r : 0;
                return (
                    s && I.isNeededToLoad && (O === L.x.EDITORIAL ? (0, i.use)(I.getEditorialAlbums({ id: s })) : (0, i.use)(I.getCategoryAlbums({ id: s }))),
                    (0, l.jsx)(h.n, {
