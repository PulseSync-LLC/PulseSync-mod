    ...
    [7779],
    {
        ...
        44958: (e, t, n) => {
            ...
            let w = (0, m.PA)(() => {
                ...
                return (
                    ...
                    (0, u.jsxs)('div', {
                        className: S().root,
                        children: [
                            (0, u.jsx)(F.Tw, { className: S().header, labeledForId: e, title: n({ id: 'concerts.all-concerts' }), headingVariant: 'h2' }),
                            (0, u.jsx)('div', {
                                'aria-labelledby': e,
                                ref: a,
                                style: h,
            ...
            let M = (0, m.PA)(() => {
                    ...
                    P.landing.isNeededToLoad && (0, f.use)(P.landing.getSkeleton({ id: v.p.CONCERTS, showWizard: T.settings.showWizard }, { preloadBlocksCount: 2 })),
