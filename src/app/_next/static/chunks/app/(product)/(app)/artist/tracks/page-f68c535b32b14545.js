(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        2841: (e, t, a) => {
            Promise.resolve().then(a.bind(a, 15763));
        },
        15763: (e, t, a) => {
            'use strict';
            ...
            let n = () => {
                ...
                return (e && (0, i.LLJ)(e)) || (0, o.notFound)(), (0, r.jsx)(s.fD, { artistId: e });
            };
        },
        30310: (e) => {
            e.exports = {
            ...
            let p = r.gK
                .compose(
                    r.gK.model('ArtistConcertsPage', {
                        errorStatusCode: r.gK.maybeNull(r.gK.number),
                        concerts: r.gK.maybeNull(r.gK.array(f.aR)),
                    ...
                    getData: (0, r.L3)(function* (t) {
                        ...
                        if (e.loadingState !== n.GuX.PENDING)
                            try {
                                ...
                                (e.concerts = (0, r.wg)(t.map(f.oP))), (e.artistTitle = null != o ? o : null), (e.loadingState = n.GuX.RESOLVE);
                            } catch (t) {
                                l.error(t),
                                    t instanceof o.GX && (t.statusCode === o.X1.NOT_FOUND || t.statusCode === o.X1.BAD_REQUEST) && (e.errorStatusCode = o.X1.NOT_FOUND),
                                            ...
                                            (0, r.wg)({
                                                ...
                                                donationUrl: (0, n.Kgy)(null == (N = S.donation) ? void 0 : N.tipUrl)
                                                    ? null == (f = S.donation)
                                                        ...
                                                        : f.tipUrl
                                                    : void 0,
                                                lastMonthListeners: null == (p = S.stats) ? void 0 : p.lastMonthListeners,
        ...
        60194: (e, t, a) => {
            ...
            let f = (0, s.PA)((e) => {
                ...
                (0, c.CgZ)(S);
                let { sendRefreshEvent: f } = (0, c.cYT)(),
                    p = (0, i.useCallback)(() => {
                        f(), (window.location.href = c.Zyd.main.href);
                    }, [f]),
