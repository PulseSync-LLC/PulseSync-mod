    ...
    [5063],
    {
        ...
        5884: (e, t, a) => {
            ...
            function n(e, t) {
                ...
                let l = { ...n, ...t };
                return (0, i.default)({ ...l, modules: null == (a = l.loadableGenerated) ? void 0 : a.modules });
            }
        ...
        11463: (e, t, a) => {
            ...
            let x = (0, l.PA)((e) => {
                ...
                let { id: y } = e,
                    ...
                    b = (0, p.W6M)(),
                    { contentScrollRef: j, setContentScrollRef: v } = (0, p.gKY)(),
                ...
                if (((0, p.Jzs)(x.isResolved), x.isNeededToLoad && (0, r.use)(x.getData({ id: y, page: 0, pageSize: 20 })), x.isSomethingWrong))
                    return (0, i.jsx)(m.w, {});
                let K = x.isLoading ? 20 : null != (a = null == x || null == (t = x.albums) ? void 0 : t.length) ? a : 0;
                        ...
                        children: (0, i.jsxs)('div', {
                            ...
                            children: [
                                (0, i.jsx)(N.Y9, {
                                    ...
                                    children: (0, i.jsx)(c.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: x.title }),
                                }),
                                (0, i.jsx)(N.$$, {
                                    context: { listAriaLabel: S({ id: 'mixes.albums-list' }, { genreName: x.title || '' }) },
                                    className: (0, n.$)(f().scrollContainer, f().important),
                                    customComponents: E,
                                    itemContentCallback: (e) => {
                                        var t, a;
                                        let n = null == x || null == (a = x.albums) || null == (t = a[e]) ? void 0 : t.data,
                                            l = S({ id: 'loading-messages.entity-is-loading' }, { entityName: S({ id: 'entity-names.album' }) });
                                        return n
                                            ? (0, i.jsx)(_.aX, { withLikesCount: !0, album: n, contentLinesCount: 3 }, n.id)
                                            : (0, i.jsx)(N.Vt, { isActive: !0, 'aria-label': l });
                                    },
                                    initialItemCount: K,
                                    totalCount: K,
                                    onGetDataByPage: C,
                                    pageSize: 20,
                                    totalRequests: null != (l = x.requests) ? l : 0,
        ...
        16092: (e, t, a) => {
            ...
            a(81382);
            let r = { loader: () => Promise.resolve(s(() => null)), loading: null, ssr: !0 },
                o = function (e) {
                    let t = { ...r, ...e },
                        a = (0, n.lazy)(() => t.loader().then(s)),
                        o = t.loading;
                    function d(e) {
                        let s = o ? (0, i.jsx)(o, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            r = !t.ssr || !!t.loading,
        ...
        17353: (e, t, a) => {
            ...
            let P = (0, l.PA)(() => {
                    let { experiments: e } = (0, _.Pjs)(),
                        ...
                        a = (0, y.L)(() =>
                            t ? (0, i.jsx)(h.OY, { isShimmerVisible: !0, isShimmerActive: !0, isShimmerCentered: !0 }) : (0, i.jsx)(g.Rj, { isActive: !0, length: 4 }),
                        );
                    return (0, i.jsxs)('div', {
                        className: x().root,
                        children: [
                            (0, i.jsx)('div', { children: a }),
                            (0, i.jsx)(h.OY, { isShimmerVisible: !0, isShimmerActive: !0 }),
                            (0, i.jsx)(h.OY, { isShimmerVisible: !0, isShimmerActive: !0 }),
                        ],
                    });
                }),
                            ...
                            children: (0, i.jsxs)(m.hO, {
                                ...
                                children: [
                                    ...
                                    (0, i.jsxs)(d.N, {
                                        ...
                                        children: [
                                            (0, i.jsx)('div', { className: (0, n.$)(N().landing, { [N().landing_onlyWizard]: f }), children: x }),
                                            (0, i.jsx)(h.A, { children: (0, i.jsx)(h.wi, { className: N().footer }) }),
                                        ],
                                    }),
                                ],
                            }),
        ...
        17660: (e, t, a) => {
            'use strict';
            a.d(t, { jM: () => N.KidsCategoryPage, u3: () => y.KidsEditorialAlbumsPage, bU: () => f.KidsEditorialPlaylistsPage, GY: () => p });
            var i = a(79169),
                n = a(41028),
                l = a(61979),
                s = a(52732),
                r = a(95592),
                o = a(59615);
            let d = n.gK.model('KidsEditorialAlbumItem', { id: n.gK.number, data: n.gK.maybeNull(s.JC) }),
                u = n.gK
                    .compose(
                    ...
                    .views((e) => {
                        let t = {
                            ...
                            get isNotFound() {
                                let t = e.errorStatusCode === l.X1.NOT_FOUND || e.errorStatusCode === l.X1.BAD_REQUEST;
                        ...
                        let t = {
                            getAlbums: (0, n.L3)(function* (t) {
                                ...
                                let { page: d = 0, pageSize: u = 20 } = t,
                                    { albumResource: g, modelActionsLogger: c } = (0, n._$)(e);
                                if ((null == (a = e.albums) ? void 0 : a.length) && !e.alreadyRequestedPages.has(''.concat(d))) {
                                    ...
                                    try {
                                        let t = d * u,
                                            ...
                                            i = yield g.getAlbums({ albumIds: a });
                                        e.requests = (null != (o = e.requests) ? o : 0) + 1;
                                        let l = { page: d, perPage: u, total: null == (s = e.albums) ? void 0 : s.length },
                                            c = i.map(r.e7),
                                            m = d * u,
                                            _ = 0;
                                        for (let t = m; t < m + u; t++) {
                            ...
                            getData: (0, n.L3)(function* (a) {
                                let { id: s, page: r = 0, pageSize: o = 20 } = a,
            ...
            var g = a(45242),
                c = a(25911);
            let m = n.gK.model('KidsEditorialPlaylistItem', { uid: n.gK.number, kind: n.gK.number, data: n.gK.maybeNull(g.IP) }),
                _ = n.gK
                    .compose(
                        ...
                        let t = {
                            getPlaylists: (0, n.L3)(function* (t) {
                                ...
                                let { page: o = 0, pageSize: d = 20 } = t,
                                    { playlistsResource: u, modelActionsLogger: g } = (0, n._$)(e);
                                if ((null == (a = e.playlists) ? void 0 : a.length) && !e.alreadyRequestedPages.has(''.concat(o))) {
                                    ...
                                    try {
                                        ...
                                        e.requests = (null != (r = e.requests) ? r : 0) + 1;
                                        let l = { page: o, perPage: d, total: null == (s = e.playlists) ? void 0 : s.length },
            ...
            var h = a(12898);
            let p = n.gK.model('KidsPage', { landing: h.Ju, kidsEditorialPlaylistSubpage: _, kidsEditorialAlbumSubpage: u });
            var N = a(17353),
                y = a(11463),
                f = a(90157);
            a(84031), a(29601);
        ...
        27618: (e, t, a) => {
            ...
            var i = a(33008),
                ...
                _ = a.n(m);
            let h = (0, l.PA)((e) => {
                let { className: t, title: a, description: l, iconVariant: m = 'musicLogo', iconClassName: h, iconSize: p } = e,
                    ...
                    (0, i.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)('div', {
                                className: _().content,
                                children: [
                                    (0, i.jsx)(o.Icon, { className: (0, n.$)(_().icon, h), variant: m, size: p }),
                                    (0, i.jsx)(d.Heading, {
                                        className: (0, n.$)(_().title, _().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: a || (0, i.jsx)(s.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, i.jsx)(d.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: l || (0, i.jsx)(s.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, i.jsx)(r.Button, {
                                        onClick: f,
                                        className: _().button,
                        ...
                        children: (0, i.jsxs)(h.hO, {
                            ...
                            children: [
                                ...
                                (0, i.jsxs)(g.N, {
                                    ...
                                    children: [
                                        (0, i.jsx)('div', {
                                            className: (0, n.$)(f().landing, { [f().landing_onlyWizard]: x }),
                    ...
                    children: [
                        a &&
                            (0, i.jsx)(m.Lh, {
                                ...
                                className: (0, n.$)(h().navigation, { [h().navigation_desktop]: !y }),
                                withForwardControl: !1,
                            }),
                        (0, i.jsxs)('div', {
                            className: (0, n.$)(h().content, { [h().content_shrink]: !a }),
                            children: [
                                (0, i.jsx)(u.Icon, { className: h().icon, variant: 'attention', size: 'xxl' }),
                                (0, i.jsx)(g.Heading, { className: (0, n.$)(h().title, h().important), variant: 'h3', size: 'xs', children: _ }),
                                (0, i.jsxs)(g.Caption, {
        ...
        90157: (e, t, a) => {
            ...
            let x = (0, l.PA)((e) => {
                ...
                if (((0, p.Jzs)(x.isResolved), x.isNeededToLoad && (0, r.use)(x.getData({ id: y, page: 0, pageSize: 20 })), x.isSomethingWrong))
                    return (0, i.jsx)(m.w, {});
                let K = x.isLoading ? 20 : null != (a = null == x || null == (t = x.playlists) ? void 0 : t.length) ? a : 0;
                return (0, i.jsx)(p.nVz, {
                    ...
                    children: (0, i.jsx)(_.hO, {
                        ...
                        children: (0, i.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, i.jsx)(N.$$, {
                                    context: { listAriaLabel: S({ id: 'mixes.playlists-list' }, { genreName: x.title || '' }) },
                                    className: (0, n.$)(f().scrollContainer, f().important),
                                    customComponents: E,
                                    itemContentCallback: (e) => {
                                        var t, a;
                                        let n = null == x || null == (a = x.playlists) || null == (t = a[e]) ? void 0 : t.data,
                                            l = S({ id: 'loading-messages.entity-is-loading' }, { entityName: S({ id: 'entity-names.playlist' }) });
                                        return n ? (0, i.jsx)(h.B6, { playlist: n, contentLinesCount: 3 }, n.key) : (0, i.jsx)(N.Vt, { isActive: !0, 'aria-label': l });
                                    },
                                    initialItemCount: K,
                                    totalCount: K,
                                    onGetDataByPage: C,
    ...
    (e) => {
        e.O(
            ...
            [
                ...
                2732, 1744, 4204, 7747, 4078, 9718, 4760, 8747, 5765, 2898, 9902, 5598, 7358,
            ],
            () => e((e.s = 23033)),
        ),
            (_N_E = e.O());
