    ...
    [6890],
    {
        ...
        5884: (e, t, i) => {
            ...
            function a(e, t) {
                ...
                let n = { ...a, ...t };
                return (0, s.default)({ ...n, modules: null == (i = n.loadableGenerated) ? void 0 : i.modules });
            }
            ...
            let r = { loader: () => Promise.resolve(o(() => null)), loading: null, ssr: !0 },
                l = function (e) {
                    let t = { ...r, ...e },
                        ...
                        l = t.loading;
                    function d(e) {
                        let o = l ? (0, s.jsx)(l, { isLoading: !0, pastDelay: !0, error: null }) : null,
                            r = !t.ssr || !!t.loading,
                        ...
                        return (0, s.jsx)(d, { ...(r ? { fallback: o } : {}), children: u });
                    }
        ...
        30434: (e, t, i) => {
            ...
            let l = () => {
                ...
                return (
                    e || (0, a.notFound)(), (0, s.jsx)(n.ZH, { withRedirectToMainPage: !1, children: (0, s.jsx)(o.C, { slidesConsumer: r.z6.PODCAST, podcastId: e }) })
                );
            };
        },
        34965: (e) => {
        ...
        91396: (e, t, i) => {
                ...
                return (0, s.jsxs)('div', {
                    ...
                    children: [
                        (0, s.jsx)(h.Button, {
                            ...
                            onClick: d,
                            disabled: t,
                            icon: (0, s.jsx)(p.Icon, { variant: 'arrowDown', size: 'xxs' }, 'prevIcon'),
                            withRipple: !1,
                        ...
                        (0, s.jsx)(h.Button, {
                            ...
                            onClick: u,
                            disabled: i,
                            icon: (0, s.jsx)(p.Icon, { variant: 'arrowDown', size: 'xxs' }, 'nextIcon'),
                            withRipple: !1,
            ...
            let j = (e) => {
                ...
                let { slide: i, isVisible: n } = e,
                    o = (0, b.eGp)(),
                    { from: l } = (0, b.fyy)({ pageId: b._Q$.TRAILER_OF_THE_YEAR, blockId: b.UfI.DEFAULT }),
                    { isActive: d } = (0, S.JO)();
                (0, b.GWZ)(n);
                let u = null == o ? void 0 : o.getState(b.V_r.TRAILER).queueState.entityList.value,
                    c = (0, r.useMemo)(
                        () =>
                            i.entitiesData &&
                            u &&
                            i.entitiesData.every((e, t) => {
                                var i;
                                return e.meta.id === (null == (i = u[t]) ? void 0 : i.entity.data.meta.id);
                            }),
                        [i.entitiesData, u],
                    ),
                    h = n && i.hasTrailer && (!c || (null == o ? void 0 : o.getState(b.V_r.TRAILER).playerState.status.value) !== g.MT.PLAYING),
                    p = h && (null == o || null == (t = o.getState(b.V_r.TRAILER).currentContext.value) ? void 0 : t.data.meta.id) === i.id;
                return (
                    (0, r.useEffect)(() => {
                        if (p) return void o.restartContext({ playAfterRestart: !0, queueParams: { index: 0 }, entitiesData: i.entitiesData }, b.V_r.TRAILER);
                        h &&
                            (null == o ||
                                o.playContext(
                                    {
                                        contextData: { type: A.K.Various, overrideContextType: I.b.Other, trailer: !0, meta: { id: i.id }, from: l },
                                        queueParams: { index: 0 },
                    ...
                    (0, s.jsx)(w.Paper, {
                        className: (0, a.$)(P().root, { [P().root_isActive]: d }),
                        radius: 'l',
                        tabIndex: 0,
                                ...
                                (0, s.jsx)(
                                    S.qr,
                                    {
                                        children: (0, s.jsx)(b.Rau, {
                                            ...
                                            artistId: n.artistId,
                                            children: (0, s.jsx)(j, { isVisible: n.activeSlide === i, slide: e }),
                                        }),
                                    },
                                    e.id,
                                ),
            ...
            var N = i(67220),
                R = i.n(N);
            function L(e, t) {
                return (e === b.GuX.RESOLVE || e === b.GuX.REJECT) && 0 === t.length;
            }
            let D = (0, n.PA)((e) => {
                var t;
                let { slidesConsumer: i, artistId: n, podcastId: v, campaignId: S } = e,
                    { formatMessage: _ } = (0, l.A)(),
                    { slides: V, experiments: E, sonataState: y, settings: A } = (0, b.Pjs)(),
                    I = (0, b.eGp)(),
                    w = E.checkExperiment(b.zal.WebNextRewind2024, 'on') || E.checkExperiment(b.zal.WebNextMusicBirthday2025, 'on'),
                    C = !(null == (t = A.browserInfo) ? void 0 : t.isMobile) || !A.browserInfo.isTouch,
                ...
                (0, r.useEffect)(
                    () => () => {
                        V.resetUser(), V.resetArtist(), V.resetPodcast(), V.resetSpecial(), null == I || I.pause(b.V_r.TRAILER);
                    },
                    [V, I],
                ),
                    w || (0, o.notFound)(),
                    ...
                    (0, r.useEffect)(() => {
                        y.status === g.MT.PLAYING && (null == I || I.togglePause());
                    }, [I, y.status]);
                let T = (0, r.useMemo)(() => {
                    switch (i) {
                        case x.z6.USER:
                ...
                (0, r.useEffect)(() => {
                    if (w)
                        switch (i) {
                            case x.z6.USER:
                                L(V.userSlidesLoadingState, T) && (0, o.notFound)();
                                break;
                            case x.z6.ARTIST:
                                L(V.artistSlidesLoadingState, T) && (0, o.notFound)();
                                break;
                            case x.z6.PODCAST:
                                L(V.podcastSlidesLoadingState, T) && (0, o.notFound)();
                                break;
                            case x.z6.SPECIAL:
                                L(V.specialSlidesLoadingState, T) && (0, o.notFound)();
                        }
                    else (0, o.notFound)();
                ...
                let N = (0, r.useMemo)(() => {
                        var e;
                        let t,
                            i = null == (e = T[V.activeSlide]) ? void 0 : e.slideColor;
                        if (i) {
                ...
                switch (i) {
                    ...
                    case x.z6.ARTIST:
                        ...
                        break;
                    case x.z6.PODCAST:
                        v && V.podcastSlidesLoadingState === b.GuX.IDLE && (0, r.use)(V.getPodcastSlides({ podcastId: Number(v) }));
                        break;
                    case x.z6.SPECIAL:
                        S && V.specialSlidesLoadingState === b.GuX.IDLE && (0, r.use)(V.getSpecialSlides({ campaignId: S }));
                }
                return (0, s.jsxs)('div', {
                    className: R().root,
                    style: N,
                    ...
                    children: [
                        (0, s.jsx)(m.q, { children: (0, s.jsx)(f.Heading, { variant: 'h1', children: (0, s.jsx)(d.A, { id: 'page.results-of-the-year' }) }) }),
                        (0, s.jsxs)('header', {
                            className: R().header,
                            children: [
                                ...
                                C &&
                                    (0, s.jsx)(h.Button, {
                                        ...
                                        radius: 'round',
                                        size: 'xxxs',
                                        icon: (0, s.jsx)(p.Icon, { size: 'xs', className: R().icon, variant: M }),
                                        onClick: D,
                                ...
                                (0, s.jsx)(h.Button, {
                                    ...
                                    radius: 'round',
                                    size: 'xs',
                                    icon: (0, s.jsx)(p.Icon, { size: 'xs', variant: 'close' }, 'handleBackIcon'),
                                    onClick: k,
                                ...
                                (0, s.jsx)(h.Button, {
                                    ...
                                    radius: 'round',
                                    size: 'xs',
                                    icon: (0, s.jsx)(p.Icon, { size: 'xs', variant: 'arrowLeft' }, 'handleBackIcon'),
                                    onClick: k,
