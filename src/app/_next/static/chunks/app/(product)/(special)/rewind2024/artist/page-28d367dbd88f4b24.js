    ...
    [3222],
    {
        ...
        46066: (e, t, i) => {
            ...
            let l = () => {
                ...
                return (
                    e || (0, a.notFound)(),
                    (0, s.jsx)(n.ZH, { withRedirectToMainPage: !1, children: (0, s.jsx)(o.C, { slidesConsumer: r.z6.ARTIST, artistId: e }) })
                );
            };
        },
        56984: (e, t, i) => {
        ...
        91396: (e, t, i) => {
            ...
            let j = (e) => {
                ...
                let { slide: i, isVisible: n } = e,
                    ...
                    { isActive: u } = (0, S.JO)();
                (0, b.GWZ)(n);
                let d = null == o ? void 0 : o.getState(b.V_r.TRAILER).queueState.entityList.value,
                    c = (0, r.useMemo)(
                        () =>
                            i.entitiesData &&
                            d &&
                            i.entitiesData.every((e, t) => {
                                var i;
                                return e.meta.id === (null == (i = d[t]) ? void 0 : i.entity.data.meta.id);
                            }),
                        [i.entitiesData, d],
                    ),
                ...
                return (
                    (0, r.useEffect)(() => {
                        ...
                        h &&
                            (null == o ||
                                o.playContext(
                                    {
                                        contextData: { type: y.K.Various, overrideContextType: A.b.Other, trailer: !0, meta: { id: i.id }, from: l },
                                        queueParams: { index: 0 },
                    ...
                    (0, s.jsx)(w.Paper, {
                        className: (0, a.$)(P().root, { [P().root_isActive]: u }),
                        radius: 'l',
                        tabIndex: 0,
            ...
            let D = (0, n.PA)((e) => {
                ...
                let { slidesConsumer: i, artistId: n, podcastId: v, campaignId: S } = e,
                    ...
                    { slides: V, experiments: E, sonataState: I, settings: y } = (0, b.Pjs)(),
                    A = (0, b.eGp)(),
                    w = E.checkExperiment(b.zal.WebNextRewind2024, 'on') || E.checkExperiment(b.zal.WebNextMusicBirthday2025, 'on'),
                    C = !(null == (t = y.browserInfo) ? void 0 : t.isMobile) || !y.browserInfo.isTouch,
                ...
                return (0, s.jsxs)('div', {
                    ...
                    children: [
                        (0, s.jsx)(m.q, { children: (0, s.jsx)(f.Heading, { variant: 'h1', children: (0, s.jsx)(u.A, { id: 'page.results-of-the-year' }) }) }),
                        (0, s.jsxs)('header', {
                            className: R().header,
                            children: [
