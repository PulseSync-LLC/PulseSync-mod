(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9953],
    {
        ...
        31804: (e, t, i) => {
            Promise.resolve().then(i.bind(i, 47437));
        },
        31905: (e, t, i) => {
            'use strict';
            var s;
        ...
        46965: (e, t, i) => {
            ...
            let j = (e) => {
                ...
                let { slide: i, isVisible: n } = e,
                    ...
                    S = n && i.hasTrailer && (!m || (null == d ? void 0 : d.getState(x.V_r.TRAILER).playerState.status.value) !== f.MT.PLAYING),
                    g = S && (null == d || null == (t = d.getState(x.V_r.TRAILER).currentContext.value) ? void 0 : t.data.meta.id) === i.id;
                return (
                    (0, r.useEffect)(() => {
                        if (g)
                    ...
                    }, [u, c, S, g, i.entitiesData, i.id, d]),
                    (0, s.jsx)(y.Paper, {
                        className: (0, a.$)(C().root, { [C().root_isActive]: h }),
                        radius: 'l',
                        tabIndex: 0,
            ...
            let L = (0, n.PA)((e) => {
                ...
                let I = (0, r.useCallback)(
                    (e) => {
                        g(e.isBeginning), V(e.isEnd), n.setActiveSlide(e.activeIndex);
                    },
                    [n],
                );
                return (0, s.jsx)('div', {
                    ...
                    children: (0, s.jsxs)(b.RC, {
                        ...
                        children: [
                            ...
                            (0, s.jsx)(E, { isFirstSlide: S, isLastSlide: f }),
                        ],
                    }),
                });
            });
            ...
            let z = (0, n.PA)((e) => {
                ...
                let { slidesConsumer: i, artistId: n, podcastId: v, campaignId: b } = e,
                    ...
                    C = null == k ? void 0 : k.getState(x.V_r.TRAILER),
                    j = (0, h.c)((e) => {
                ...
                (0, r.useEffect)(() => {
                    E.status === f.MT.PLAYING && (null == k || k.togglePause());
                }, [k, E.status]),
                    (0, r.useEffect)(
                        () => (
                            z(!0),
                ...
                let M = (0, r.useMemo)(() => {
                    ...
                    B = (0, r.useCallback)(() => {
                        V.toggleMute(), (null == C ? void 0 : C.playerState.exponentVolume.value) !== 0 ? j(0) : j(1);
                    }, [j, V, null == C ? void 0 : C.playerState.exponentVolume.value]),
                    G = (0, h.c)(() => {
                        T ? F() : R();
                    }),
                ...
                return (0, s.jsx)(x.jPc, {
                    children: (0, s.jsx)(x.nVz, {
                        ...
                        children: (0, s.jsxs)('div', {
                            ...
                            children: [
                                (0, s.jsx)(S.q, { children: (0, s.jsx)(g.Heading, { variant: 'h1', children: (0, s.jsx)(d.A, { id: 'page.results-of-the-year' }) }) }),
                                (0, s.jsxs)('header', {
                                    className: N().header,
                                    children: [
