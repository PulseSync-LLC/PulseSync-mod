    ...
    [3358],
    {
        10757: (e, s, o) => {
            ...
            let i = (e) => {
                ...
                const likeAction = (0, n.useCallback)(
                        (t) => {
                            null == e || onLikeClick?.(sonataState.entityMeta, t);
                            sendPlayerStateDefault?.(e);
                        },
                        [e, onLikeClick, sonataState.entityMeta],
                    ),
                    dislikeAction = (0, n.useCallback)(
                        (t) => {
                            null == e || onDislikeClick?.(sonataState.entityMeta, t);
                            sendPlayerStateDefault?.(e);
                        },
                ...
                (0, n.useEffect)(() => {
                    ...
                    const off = window.desktopEvents?.on(t.EE.PULSESYNC_API, handler);
                    return () => {
                        off?.();
                    };
                }, []);
                    ...
                    (0, n.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, n.jsxs)('div', {
                                className: P().content,
                                children: [
                                    (0, n.jsx)(d.Icon, { className: (0, t.$)(P().icon, c), variant: b, size: u }),
                                    (0, n.jsx)(a.Heading, {
                                    ...
                                    (0, n.jsx)(a.Caption, {
                                        ...
                                        size: 'l',
                                        weight: 'normal',
                                        children: r || (0, n.jsx)(i.A, { id: 'page-error.page-does-not-exist-description' }),
                                    }),
                                    (0, n.jsx)(l.Button, {
                                        onClick: C,
                                        className: P().button,
                        ...
                        (0, t.useEffect)(() => {
                            ...
                            return (
                                null == (e = window.desktopEvents) ||
                                    e.on(i.EE.MOD_UPDATE_AVAILABLE, () => {
                                        r();
                                    }),
                                () => {
                                    var e;
                                    null == (e = window.desktopEvents) ||
                                        e.off(i.EE.MOD_UPDATE_AVAILABLE, () => {
                                            r();
                                        });
                                }
                            );
        ...
        58290: (e, s, o) => {
            ...
            let l = (e) => {
                ...
                (0, n.useEffect)(() => {
                    if (s && window.pulsesyncApi) {
                        window.pulsesyncApi.setPlayerInstance(s);
                    }
                    let e,
                        n,
                        t =
                        ...
                        getCurrentTrackListener = window.desktopEvents?.on(i.EE.GET_CURRENT_TRACK, () => {
                            sendPlayerStateDefault(s);
                        }),
            ...
            let m = (e) => {
                ...
                b = (0, r.PA)((e) => {
                    let { withSecondaryColor: s } = e,
                        ...
                        handleDivDoubleClick = (0, i.useCallback)((e) => {
                    ...
                    (0, i.useEffect)(() => {
                        ...
                        const forceStyleId = `pulsesync-titlebar-force-style-${h().pulseText}`;
                                ...
                                children: [
                                    ...
                                    (0, n.jsx)(m, {
                                        ...
                                        children: (0, n.jsx)('svg', {
                                            ...
                                            viewBox: '0 0 10 1',
                                            xmlns: 'http://www.w3.org/2000/svg',
                                            className: (0, t.$)(h().icon, { [h().icon_withSecondaryColor]: s }),
    ...
    (e) => {
        e.O(
            ...
            [
                ...
                1020, 8400, 8387, 9750, 7245, 5952, 1917, 1311, 7764, 6706, 2089, 2140, 996, 4236, 6728, 7508, 9152, 5675, 9837, 9169, 8740, 9615, 3588, 2732, 1744, 4204,
                7747, 4078, 9718, 4760, 8747, 5765, 2898, 508, 3984, 3477, 7111, 5897, 3663, 939, 5958, 682, 3761, 7443, 2561, 5971, 8096, 7410, 5613, 5767, 4691, 6659,
                5936, 8941, 1799, 9902, 5598, 7358,
            ],
            () => e((e.s = 76555)),
        ),
            (_N_E = e.O());
