                    ...
                    return (s =
                        ...
                        function (e) {
                            for (var i, t = 1, s = arguments.length; t < s; t++)
                                for (var n in (i = arguments[t])) Object.prototype.hasOwnProperty.call(i, n) && (e[n] = i[n]);
                            return e;
                        ...
                        (this.endVal = i),
                            ...
                            (this.formatNumber = function (e) {
                                ...
                                return (
                                    ...
                                    (e < 0 ? '-' : '') + n.options.prefix + i + t + n.options.suffix
                                );
                            }),
                            (this.easeOutExpo = function (e, i, t, s) {
                                return (t * (1 - Math.pow(2, (-10 * e) / s)) * 1024) / 1023 + i;
                            }),
                    ...
                    return (
                        (e.prototype.handleScroll = function (e) {
                            if (e && window && !e.once) {
                                ...
                                n < i && n > window.scrollY && e.paused
                                    ...
                                    : (window.scrollY > n || s > i) && !e.paused && e.reset();
                            }
                        }),
                        ...
                        (e.prototype.printValue = function (e) {
                            ...
                            if (this.el) {
                                ...
                                (null == (i = this.options.plugin) ? void 0 : i.render)
        ...
        91396: (e, i, t) => {
            ...
            let C = (e) => {
                ...
                let { slide: t, isVisible: o } = e,
                    r = (0, _.eGp)(),
                    { from: a } = (0, _.fyy)({ pageId: _._Q$.TRAILER_OF_THE_YEAR, blockId: _.UfI.DEFAULT }),
                    { isActive: d } = (0, S.JO)();
                (0, _.GWZ)(o);
                let h = null == r ? void 0 : r.getState(_.V_r.TRAILER).queueState.entityList.value,
                    m = (0, l.useMemo)(
                        () =>
                            t.entitiesData &&
                            h &&
                            t.entitiesData.every((e, i) => {
                                var t;
                                return e.meta.id === (null == (t = h[i]) ? void 0 : t.entity.data.meta.id);
                            }),
                        [t.entitiesData, h],
                    ),
                    u = o && t.hasTrailer && (!m || (null == r ? void 0 : r.getState(_.V_r.TRAILER).playerState.status.value) !== P.MT.PLAYING),
                    v = u && (null == r || null == (i = r.getState(_.V_r.TRAILER).currentContext.value) ? void 0 : i.data.meta.id) === t.id;
                return (
                    (0, l.useEffect)(() => {
                        if (v) return void r.restartContext({ playAfterRestart: !0, queueParams: { index: 0 }, entitiesData: t.entitiesData }, _.V_r.TRAILER);
                        u &&
                            (null == r ||
                                r.playContext(
                                    {
                                        contextData: { type: A.K.Various, overrideContextType: I.b.Other, trailer: !0, meta: { id: t.id }, from: a },
                                        queueParams: { index: 0 },
                    ...
                    (0, s.jsx)(w.Paper, {
                        className: (0, n.$)(k().root, { [k().root_isActive]: d }),
                        radius: 'l',
                        tabIndex: 0,
                                ...
                                (0, s.jsx)(
                                    S.qr,
                                    {
                                        children: (0, s.jsx)(_.Rau, {
                                            ...
                                            artistId: o.artistId,
                                            children: (0, s.jsx)(C, { isVisible: o.activeSlide === t, slide: e }),
                                        }),
                                    },
                                    e.id,
                                ),
            ...
            var R = t(67220),
                j = t.n(R);
            function D(e, i) {
                return (e === _.GuX.RESOLVE || e === _.GuX.REJECT) && 0 === i.length;
            }
            let L = (0, o.PA)((e) => {
                var i;
                let { slidesConsumer: t, artistId: o, podcastId: p, campaignId: S } = e,
                    { formatMessage: g } = (0, a.A)(),
                    { slides: x, experiments: V, sonataState: E, settings: A } = (0, _.Pjs)(),
                    I = (0, _.eGp)(),
                    w = V.checkExperiment(_.zal.WebNextRewind2024, 'on') || V.checkExperiment(_.zal.WebNextMusicBirthday2025, 'on'),
                    y = !(null == (i = A.browserInfo) ? void 0 : i.isMobile) || !A.browserInfo.isTouch,
                ...
                (0, l.useEffect)(() => {
                    if (w)
                        switch (t) {
                            case f.z6.USER:
                                D(x.userSlidesLoadingState, N) && (0, r.notFound)();
                                break;
                            case f.z6.ARTIST:
                                D(x.artistSlidesLoadingState, N) && (0, r.notFound)();
                                break;
                            case f.z6.PODCAST:
                                D(x.podcastSlidesLoadingState, N) && (0, r.notFound)();
                                break;
                            case f.z6.SPECIAL:
                                D(x.specialSlidesLoadingState, N) && (0, r.notFound)();
                        }
                    else (0, r.notFound)();
                ...
                let R = (0, l.useMemo)(() => {
                        var e;
                        let i,
                            t = null == (e = N[x.activeSlide]) ? void 0 : e.slideColor;
                        if (t) {
                            let { r: e, g: s, b: n } = (0, _.E2N)(t);
                            i = 'rgba('.concat(e, ', ').concat(s, ', ').concat(n, ', 0.5)');
                        }
                ...
                switch (t) {
                    case f.z6.USER:
                        x.userSlidesLoadingState === _.GuX.IDLE && (0, l.use)(x.getUserSlides());
                        break;
                    case f.z6.ARTIST:
                        o && x.artistSlidesLoadingState === _.GuX.IDLE && (0, l.use)(x.getArtistSlides({ artistId: o }));
                        break;
                    case f.z6.PODCAST:
                        p && x.podcastSlidesLoadingState === _.GuX.IDLE && (0, l.use)(x.getPodcastSlides({ podcastId: Number(p) }));
                        break;
                    case f.z6.SPECIAL:
                        S && x.specialSlidesLoadingState === _.GuX.IDLE && (0, l.use)(x.getSpecialSlides({ campaignId: S }));
                }
                return (0, s.jsxs)('div', {
                    className: j().root,
                    style: R,
                    ...
                    children: [
                        (0, s.jsx)(c.q, { children: (0, s.jsx)(b.Heading, { variant: 'h1', children: (0, s.jsx)(d.A, { id: 'page.results-of-the-year' }) }) }),
                        (0, s.jsxs)('header', {
                            className: j().header,
                            children: [
                                ...
                                y &&
                                    (0, s.jsx)(u.Button, {
                                        ...
                                        radius: 'round',
                                        size: 'xxxs',
                                        icon: (0, s.jsx)(v.Icon, { size: 'xs', className: j().icon, variant: B }),
                                        onClick: L,
                                        className: (0, n.$)(j().button, j().volumeButton),
                                        withRipple: !1,
                                    }),
                                (0, s.jsx)(u.Button, {
                                    ...
                                    onClick: T,
                                    className: (0, n.$)(j().button, j().desktopBackButton),
                                    role: 'link',
                                }),
                                (0, s.jsx)(u.Button, {
                                    variant: 'text',
                                    ...
                                    onClick: T,
                                    className: (0, n.$)(j().button, j().mobileBackButton),
                                    role: 'link',
                                }),
                            ],
                        }),
            ...
            let u = (e) => {
                let { children: i } = e,
                    ...
                    P = (0, o.useCallback)(
                        (e) => {
                            ...
                            return ''.concat(i, '/media/splash_screen/splash_screen_').concat(b, '.').concat(e);
                        },
                        [b],
                    ),
                ...
                return (0, s.jsxs)(a.nlO.Provider, {
                    ...
                    children: [
                        !t &&
                            (0, s.jsx)('div', {
                                className: (0, n.$)(h().root, h()['root_'.concat(b)], { [h().root_hidden]: u }),
                                onAnimationEnd: d,
                                children: (0, s.jsxs)('video', {
                                    ...
                                    onEnded: v,
                                    onError: d,
                                    children: [(0, s.jsx)('source', { src: P('webm'), type: 'video/webm' }), (0, s.jsx)('source', { src: P('mp4'), type: 'video/mp4' })],
                                }),
                            }),
                        i,
                    ],
