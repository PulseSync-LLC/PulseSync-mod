    ...
    [1766, 5242],
    {
                ...
                o = {
                    ...
                    2067: (e, t, i) => {
                        ...
                        t.useScroll = (e) => {
                            ...
                            return (
                                (0, r.useEffect)(() => {
                                    let e = (0, n.getElementFromRefOrElement)(o);
                                    if (null === e) return;
        ...
        2865: (e, t, i) => {
            ...
            let l = (e) => {
                if (e.data.type !== n.R.Clip) return null;
                {
                    ...
                    let n = null == (t = i.artists) ? void 0 : t.map((e) => (0, s.as)({ artist: e })),
            ...
            var a = i(53555);
            let d = (e, t) => ({ type: a.z4.Unloaded, meta: { id: e, albumId: t } });
            var m = i(95592),
                u = i(61744);
            let v = (e) => {
                var t, i, l;
                switch (e.data.type) {
                    case n.R.Generative: {
                        let i = e.data.meta,
                            n = (0, o.QBb)(null == i ? void 0 : i.derivedColors);
                        return (0, r.wg)({
                            id: String(i.id),
                            coverUri: i.imageUrl,
                    ...
                    default: {
                        let t = e.data.meta,
                            n = null == (i = t.substituted?.artists ?? t.artists) ? void 0 : i.map(s.dM),
                            o = null == (l = t.albums) ? void 0 : l.map(m.e7);
                        return (0, r.wg)({ ...(0, u.gK)(t), artists: n, albums: o, isHiddenFromSonataQueue: e.hidden });
                    }
                }
            };
            var c = i(48148),
                ...
                g = i(43090),
                _ = i(10663);
            let f = r.gK.model('UnloadedEntityMeta', { id: r.gK.union(r.gK.number, r.gK.string), albumId: r.gK.maybe(r.gK.union(r.gK.number, r.gK.string)) }),
                C = r.gK.model('UnloadedEntityData', { meta: f, type: r.gK.literal(a.z4.Unloaded) });
            var x = i(6247),
                k = i(16285);
            let K = u.OQ.props({ artists: r.gK.array(s.PK), albums: r.gK.array(m.GI), chart: r.gK.maybe(k.Iz), isHiddenFromSonataQueue: r.gK.maybe(r.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
                        ...
                        get mainArtist() {
                            var i, r;
                            return null != (r = null == (i = e.artists) ? void 0 : i[0]) ? r : null;
                        },
                        get mainAlbum() {
                            var n, s;
                            return null != (s = null == (n = e.albums) ? void 0 : n[0]) ? s : null;
                        },
                        get index() {
                            var o, l, a;
                            return null != (a = null == (l = e.albums[0]) || null == (o = l.trackPosition) ? void 0 : o.index) ? a : null;
                        },
                        get isPodcast() {
                            var d;
                        ...
                        get isAvailableOnlyForPlus() {
                            var m;
                            return !!(null == (m = this.mainAlbum) ? void 0 : m.isAvailableOnlyForPlus);
                        },
                    }))
                    .actions((e) => ({
                ...
                N = r.gK
                    .model('BaseSonataState', {
                        contextType: r.gK.maybeNull(r.gK.enumeration(Object.values(y.K))),
                    ...
                    .views((e) => ({
                        get unloadedEntitiesDataFromModels() {
                            var t;
                            return null != (t = e.volatileUnloadedEntitiesData) ? t : (0, p.HO)(e.unloadedEntitiesData);
                        },
                        get isVibeContext() {
                ...
                A = i(60030)
                    .z8.props({ artists: r.gK.array(s.PK), isHiddenFromSonataQueue: r.gK.maybe(r.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
        ...
        17999: (e, t, i) => {
            ...
            let l = (e) => {
                    ...
                    return (0, r.jsx)(s.OY, {
                        ...
                        headingVariant: b,
                        ...h,
                        children: null == d ? void 0 : d.map((e) => (0, r.jsx)(o.PlaylistCard, { playlist: e, contentLinesCount: 3 }, e.key)),
                    });
                },
                a = (0, n.forwardRef)((e, t) => (0, r.jsx)(l, { forwardRef: t, ...e }));
        },
        19525: (e) => {
            e.exports = {
        ...
        27618: (e, t, i) => {
            ...
            var r = i(33008),
                ...
                b = i.n(c);
            let h = (0, s.PA)((e) => {
                let { className: t, title: i, description: s, iconVariant: c = 'musicLogo', iconClassName: h, iconSize: P } = e,
                ...
                return (
                    ...
                    (0, r.jsxs)('div', {
                        className: (0, n.$)(b().root, { [b().root_desktop]: !p }, t),
                        children: [
                            (0, r.jsx)(u.Lh, { withBackwardFallback: '/', className: b().navigation, withForwardControl: !1 }),
                            (0, r.jsxs)('div', {
                                className: b().content,
                                children: [
                                    (0, r.jsx)(a.Icon, { className: (0, n.$)(b().icon, h), variant: c, size: P }),
                                    (0, r.jsx)(d.Heading, {
                                        className: (0, n.$)(b().title, b().important),
                                        variant: 'h3',
                                        size: 'xs',
                                        children: i || (0, r.jsx)(o.A, { id: 'page-error.page-does-not-exist' }),
                                    }),
                                    (0, r.jsx)(d.Caption, {
            ...
            let r = (e) => {
                    ...
                    return i && t
                        ? (function (e, t, i) {
                              let r = { ...e };
                              return (
                                  t.top + e.y <= i.top ? (r.y = i.top - t.top) : t.bottom + e.y >= i.top + i.height && (r.y = i.top + i.height - t.bottom),
                                  t.left + e.x <= i.left ? (r.x = i.left - t.left) : t.right + e.x >= i.left + i.width && (r.x = i.left + i.width - t.right),
                                  r
                              );
                          })(r, i, t)
                        : r;
        ...
        45242: (e, t, i) => {
            ...
            (0, l.cache)(async (e, t) => {
                ...
                let r;
                try {
                    let { container: i, backendHostTld: s, locale: o, host: l, fullUrl: a, isRSC: d, requestUrl: m } = await (0, n.IhE)();
                ...
                (0, l.cache)(async (e) => {
                    ...
                    try {
                        let { container: t, backendHostTld: r, locale: s, host: o, fullUrl: l, isRSC: a, requestUrl: d } = await (0, n.IhE)();
            ...
            let d = (e) => ({ uid: e.uid, login: e.login, name: e.name, sex: e.sex, verified: e.verified }),
                m = (e) =>
                    (0, r.wg)({
                        ...
                        modified: e.modified,
                        madeFor: e.madeFor
                            ? ((e) => (0, r.wg)({ userInfo: e.userInfo ? d(e.userInfo) : null, caseForms: e.caseForms ? (0, n.NH4)(e.caseForms) : null }))(e.madeFor)
                            : null,
                    });
            var u = i(70879);
            let v = (e) => {
                var t, i;
                return (0, r.wg)({ ...(0, a.jX)(e), artists: null != (i = null == e || null == (t = e.artists) ? void 0 : t.map(u.dM)) ? i : [] });
            };
            var c = i(61744);
            let b = (e) => {
                var t, i;
                return (0, r.wg)({ ...(0, a.jX)(e), tracks: null != (i = null == e || null == (t = e.tracks) ? void 0 : t.map(c.Rw)) ? i : [] });
            };
            var h = i(59615),
                P = i(64802);
            let p = r.gK.model('PlaylistOwner', {
                ...
                y = r.gK.model('PlaylistOwner', { userInfo: r.gK.maybeNull(p), caseForms: r.gK.maybeNull(h.lg) }),
                g = r.gK.model('PlaylistTag', { id: r.gK.string, value: r.gK.string }),
                _ = a.$o
                    .props({
                        owner: r.gK.maybe(p),
                    ...
                    .views((e) => ({
                        ...
                        get tagsString() {
                            ...
                            if (!t.checkExperiment(n.zal.WebEditorsFeatures, 'on') || !Array.isArray(e.tags) || !e.tags.length) return null;
        ...
        56395: (e, t, i) => {
            ...
            let k = (0, s.PA)((e) => {
                ...
                let { playlist: i, onOpenChange: n, open: s, ...o } = e,
                    { shouldShowBuySubscriptionModal: m, showBuySubscriptionModal: v } = (0, g.qBP)(),
                    {
                        experiments: c,
                        settings: { isMobile: b },
                        trailer: h,
                    ...
                    j = (0, x.A_)({ entityVariant: g.DwC.PLAYLIST, urlParams: { id: i.uid, kind: i.kind } });
                (0, g.NBO)(s);
                let L = (0, u.c)(() => {
                    if (m) return void v();
                    N() || (h.openPlaylistTrailer(i.id), k(a.ky.Playlist, i.id));
                });
            ...
            var K = i(96973),
                N = i.n(K);
            let A = (0, s.PA)((e) => {
                let { className: t, playlist: i, children: s, contentLinesCount: C, customDescription: x } = e,
                    { ref: K, intersectionPropertyId: A } = (0, g.nMI)(),
                    { trailer: j, user: L } = (0, g.Pjs)(),
                    { from: F, utmLink: T } = (0, g.fyy)({ contextId: i.uuid, contextType: m.K.Playlist }),
                    { formatMessage: w } = (0, l.A)(),
                    { sendLikeSearchFeedback: E, sendNavigateSearchFeedback: S, sendPlaySearchFeedback: M } = (0, g.zEv)(),
                    [B, R] = (0, o.useState)(!1),
                    [I, O] = (0, o.useState)(!1),
                    [z, D] = (0, o.useState)(!1),
                    U = (0, f.r)(i),
                    ...
                    el = (0, o.useMemo)(() => {
                        var e;
                        return x
                            ? (0, r.jsx)(P.Caption, { variant: 'span', type: 'entity', size: 's', weight: 'medium', lineClamp: 2, children: x }, i.getKey('description'))
                        ...
                        if (null == i || null == (e = i.trailer) ? void 0 : e.isAvailable)
                            return (0, r.jsx)(
                                _.nE,
                                {
                                    children: (0, r.jsx)(
                                        _.kJ,
                                        { className: (0, n.$)(N().trailerButton, N().control), radius: 'round', size: 's', iconSize: 'xxs', onClick: W },
                    ...
                    em = (0, o.useMemo)(
                        () =>
                            (0, r.jsx)(
                                _.O0,
                                { onClick: Y, isPinned: i.isPinned, className: (0, n.$)(N().pinButton, N().control), withRipple: !1 },
                                i.getKey('PinButton'),
                            ),
                        [Y, i],
                    ),
                                        ...
                                        (0, r.jsx)(c.hg, {
                                            ...
                                            menuControl: (0, r.jsx)(
                                                k,
                                                {
                                                    ...
                                                    icon: (0, r.jsx)(b.Icon, { size: 'xxs', variant: 'more' }),
                                                    size: 's',
                ...
                return (0, r.jsxs)(c.MN, {
                    ...
                    title: (0, r.jsx)(P.Caption, {
                        ...
                        children: (0, r.jsx)(_.N_, { className: N().titleLink, href: i.url, onClick: et, children: i.title }),
                    }),
                    srTitle: (0, r.jsx)(_.N_, { href: i.url, onClick: et, children: i.title }),
                    ...
                    children: [
                        ev &&
                            (0, r.jsx)(_.xW, {
                                ariaLabel: w({ id: 'entity-names.likes-counter' }, { counter: i.actualLikesCount }),
        ...
        75658: (e, t, i) => {
                ...
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                                ...
                                children: [
                                    (0, r.jsx)(p.aQ, {
                                        fallback: (0, r.jsx)(p.cy, {
                                            size: 'xs',
                                            iconSize: l,
                                            className: (0, n.$)(f().item, f().likeIcon),
                                            isLiked: s.isLiked,
                                            onClick: C,
                                    ...
                                    (null == (t = s.trailer) ? void 0 : t.isAvailable) &&
                                        (0, r.jsx)(p.aQ, {
                                            fallback: (0, r.jsx)(p.kJ, {
                                                className: (0, n.$)(f().item, f().trailerIcon),
                                                iconSize: 'xs',
                                                variant: 'text',
                                                onClick: k,
                                                withRipple: !1,
                        ...
                        (0, r.jsx)('div', {
                            ...
                            children: (0, r.jsx)(b.Icon, { className: p.$f.buttonArrow, variant: 'arrowRight', size: 'xs' }),
                        }),
                    ],
                });
            });
            var x = i(19525),
                k = i.n(x);
            let K = (0, s.PA)((e) => {
                let { className: t, playlist: i, pageId: s, coverClassName: g, playButtonIconSize: _, likeIconSize: f } = e,
                    ...
                    S = (0, P.PT7)(),
                    { sendNavigateSearchFeedback: M, sendPlaySearchFeedback: B } = (0, P.zEv)(),
                    R = (0, P.NKK)(),
                    {
                        isPlaying: I,
                        isCurrent: O,
                    ...
                    q = null == Z ? void 0 : Z({ onPlayButtonClick: $, isPlaying: I, isCurrent: O, playButtonIconSize: _ }),
                    Q = (0, o.useMemo)(
                        () =>
                            i.url && i.isAvailable
                                ? (0, r.jsx)(p.N_, { className: (0, n.$)(p.$f.text, p.$f.titleLink), href: i.url, onClick: H, children: T })
                                : (0, r.jsx)(h.Caption, { className: (0, n.$)(p.$f.text, p.$f.titleText), size: 'm', variant: 'div', type: 'text', children: T }),
                        [H, i.isAvailable, i.url, T],
                    ),
                    V = (0, o.useMemo)(() => {
                        if (void 0 === i.actualLikesCount || void 0 === i.tracksCount) return;
                        let e = (0, r.jsx)(h.Caption, { variant: 'span', size: 'm', weight: 'medium', 'aria-hidden': !0, children: '•' }),
                            t = i.isLiked ? 'likedVariant' : 'likeVariant',
                            n = ''.concat(F, ' ').concat(w({ id: 'entity-names.tracks-count' }, { value: i.tracksCount }));
                        return (0, r.jsxs)('div', {
                            ...
                            children: [
                                (0, r.jsxs)('div', {
                                    ...
                                    'aria-hidden': !0,
                                    children: [
                                        (0, r.jsx)(b.Icon, { className: k().icon, variant: t, size: 'xxs' }),
                                        (0, r.jsx)(h.Caption, { variant: 'span', size: 'm', weight: 'medium', children: E(i.actualLikesCount) }),
                                    ],
                                }),
                                (0, r.jsxs)('div', {
                                    ...
                                    children: [
                                        ...
                                        (0, r.jsx)(h.Caption, {
                                            ...
                                            size: 'm',
                                            weight: 'medium',
                                            children: (0, r.jsx)(a.A, { id: 'entity-names.tracks-count', values: { value: E(i.tracksCount) } }),
                                        }),
                                    ],
                                }),
                            ],
                ...
                return (0, r.jsxs)(p.Cj, {
                    ...
                    className: (0, n.$)(p.$f.root, { [p.$f.root_disabled]: !i.isAvailable }, t),
                    'aria-label': i.title || w({ id: 'entity-names.playlist' }),
                    onClick: Y,
                    ...(0, m.Am)(m.Kq.playlist.HORIZONTAL_PLAYLIST_CARD),
                    children: [q, (0, r.jsx)(p.ro, { isDisabled: !i.isAvailable, title: Q, description: V }), (0, r.jsx)(C, { playlist: i, likeIconSize: f })],
                });
            });
        },
        91919: (e, t, i) => {
            ...
            let v = (e) => {
                let { className: t, isEmptySearch: i } = e,
                    m = (0, s.useMemo)(
                        () => (i ? (0, r.jsx)(o.A, { id: 'search-results.not-found-title' }) : (0, r.jsx)(o.A, { id: 'error-messages.empty-collection-playlist-title' })),
                        [i],
                    ),
                    v = (0, s.useMemo)(
                        () =>
                ...
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)('div', {
                            ...
                            children: (0, r.jsx)(a.Icon, { variant: 'search', size: 'l', className: u().icon, ...(0, l.Am)(l.Kq.playlist.PLAYLIST_EMPTY_BLOCK_ICON) }),
                        }),
                        (0, r.jsx)(d.Heading, { variant: 'h3', size: 'xs', className: u().title, ...(0, l.Am)(l.Kq.playlist.PLAYLIST_EMPTY_BLOCK_TITLE), children: m }),
                        (0, r.jsx)(d.Caption, {
                            variant: 'span',
                            size: 'l',
