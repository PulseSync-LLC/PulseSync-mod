(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3761],
    {
        ...
        73761: (e, a, l) => {
            'use strict';
            l.d(a, { rk: () => D, iV: () => i, MZ: () => I, ML: () => k, Sq: () => s });
            var r,
                u = l(38230),
                t = l(66268);
                ...
                k = o.gK
                    ...
                    .actions((e) => ({
                        ...
                        setEnabled(a) {
                            ...
                            l.set(d.cYZ.EqualizerConfig, { ...r, isEnabled: a, version: '6' });
                        },
                        loadPresets() {
                        ...
                        changeCurrentPreset(a) {
                            ...
                            if ((l.set(d.cYZ.EqualizerConfig, { ...u, lastPresetId: a, version: '6' }), a === r.CUSTOM)) {
                                e.currentPreset = (0, o.o8)(e.customPreset);
                                return;
                            }
                            let t = v[a];
            ...
            var E = l(33008),
                ...
                R = l.n(h);
            let L = {
                    [r.DEFAULT]: (0, E.jsx)(O.A, { id: 'equalizer.default-preset' }),
                    [r.CUSTOM]: (0, E.jsx)(O.A, { id: 'equalizer.custom-preset' }),
                    [r.CLASSICAL]: (0, E.jsx)(O.A, { id: 'equalizer.classical-preset' }),
                    [r.CLUB]: (0, E.jsx)(O.A, { id: 'equalizer.club-preset' }),
                    [r.DANCE]: (0, E.jsx)(O.A, { id: 'equalizer.dance-preset' }),
                    [r.BASS_BOOST]: (0, E.jsx)(O.A, { id: 'equalizer.bass-boost-preset' }),
                    [r.BASS_AND_TREBLE_BOOST]: (0, E.jsx)(O.A, { id: 'equalizer.bass-and-treble-boost-preset' }),
                    [r.TREBLE_BOOST]: (0, E.jsx)(O.A, { id: 'equalizer.treble-boost-preset' }),
                    [r.SPEAKERS]: (0, E.jsx)(O.A, { id: 'equalizer.speakers-preset' }),
                    [r.LARGE_HALL]: (0, E.jsx)(O.A, { id: 'equalizer.large-hall-preset' }),
                    [r.CONCERT]: (0, E.jsx)(O.A, { id: 'equalizer.concert-preset' }),
                    [r.PARTY]: (0, E.jsx)(O.A, { id: 'equalizer.party-preset' }),
                    [r.POP]: (0, E.jsx)(O.A, { id: 'equalizer.pop-preset' }),
                    [r.REGGAE]: (0, E.jsx)(O.A, { id: 'equalizer.reggae-preset' }),
                    ...
                    [r.SOFT_ROCK]: (0, E.jsx)(O.A, { id: 'equalizer.soft-rock-preset' }),
                    [r.TECHNO]: (0, E.jsx)(O.A, { id: 'equalizer.techno-preset' }),
                },
                g = (0, p.PA)((e) => {
                    let { isDisabled: a } = e,
                        l = s(),
                    ...
                    return (0, E.jsx)(T.ms, {
                        ...
                        reference: (0, E.jsxs)(x.Button, {
                            radius: 'xxxl',
                            className: (0, m.$)(R().button, { [R().button_disabled]: a }),
                            ...(0, b.Am)(b.Kq.equalizer.EQUALIZER_PRESETS_BUTTON),
                            children: [
                                (0, E.jsx)(z.Caption, { className: R().buttonText, variant: 'span', size: 's', weight: 'medium', children: L[l.currentPreset.id] }),
                                (0, E.jsx)(P.Icon, { className: R().buttonIcon, size: 'xxs', variant: 'arrowDown' }),
                            ],
                        }),
                        placement: 'top',
                        offsetOptions: -40,
            ...
            let K = (e) => {
                    ...
                    return (0, E.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, E.jsx)(z.Caption, {
                                'aria-hidden': !0,
                                className: (0, m.$)(B().label, { [B().label_disabled]: t }),
                                variant: 'div',
                                weight: 'normal',
                                size: 'xs',
                                children: u,
                        ...
                        children: [
                            (0, E.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    (0, E.jsx)(S.l, { 'aria-label': v, isChecked: o.isEnabled, onChange: d, ...(0, b.Am)(b.Kq.equalizer.EQUALIZER_TOGGLE) }),
                                ],
                            }),
                            (0, E.jsx)(q.A, {
                                in: r,
                                ...
                                children: (0, E.jsxs)('div', {
                                    ref: i,
                                    className: (0, m.$)(C().equalizer, { [C().equalizer_disabled]: u }),
            ...
            let I = (0, p.PA)(() => {
                ...
                return (0, E.jsx)(M.a, {
                    ...
                    children: (0, E.jsx)(D, { title: e({ id: 'equalizer.enable' }), isExpanded: !0, isDisabled: !a.isEnabled }),
                });
            });
        },
        98316: (e, a, l) => {
