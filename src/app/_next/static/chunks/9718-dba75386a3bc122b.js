    ...
    [9718],
    {
                    ...
                    let {
                        ...
                        y = (0, s.useMemo)(
                            () =>
                                (0, i.A)(h, 2)
                                    .slice(0, 4)
                                    .map((e, t) => (0, r.jsx)('div', { className: u().concertsColumn, children: e }, t)),
                            [h],
                        );
                    return (0, r.jsxs)('section', {
                        ...
                        children: [
                            (0, r.jsx)(c.Tw, {
                                ...
                                viewAllActionLink: C,
                                onViewAllAction: j,
                                controls: (0, r.jsx)(c.X9, { className: u().controls, carouselRef: k }),
                                headingVariant: f,
                            }),
                            (0, r.jsx)(l.Carousel, {
                                itemClassName: (0, n.$)(u().item, { [u().item_singleColumn]: 2 >= s.Children.count(h) }, x),
                                className: (0, n.$)(g, { [u().preventScroll]: m }),
                                ref: k,
                                'aria-labelledby': N,
                                children: m ? Array.from({ length: 2 }, (e, t) => (0, r.jsx)('div', { className: u().concertsColumn, children: (0, c.Tb)(2) }, t)) : y,
                            }),
                        ],
                    });
                },
                C = (0, s.forwardRef)((e, t) => (0, r.jsx)(_, { forwardRef: t, ...e }));
        },
        5858: (e, t, a) => {
            'use strict';
            a.d(t, { t: () => n });
        ...
        6204: (e, t, a) => {
            ...
            let c = (0, n.PA)((e) => {
                let { id: t, concert: a } = e,
                    n = [],
                    o = (0, r.jsx)(s.Caption, { variant: 'span', size: 'm', weight: 'medium', 'aria-hidden': !0, children: '•' });
                return (
                    (null == a ? void 0 : a.city) && n.push((0, r.jsx)(s.Caption, { variant: 'span', size: 'm', weight: 'medium', lineClamp: 1, children: a.city })),
                    (null == a ? void 0 : a.contentRating) &&
                        n.push(o, (0, r.jsx)(s.Caption, { variant: 'span', size: 'm', weight: 'medium', children: a.contentRating })),
                    (0, r.jsxs)('div', {
                        className: l().root,
                        id: t,
                        children: [
                            ...
                            (0, r.jsx)('div', { className: l().info, children: n.map((e, t) => (0, i.cloneElement)(e, { key: t })) }),
                        ],
                    })
                );
            });
        ...
        13031: (e, t, a) => {
            ...
            let o = () => {
                let { hash: e } = (0, n.gf)(),
                    ...
                    a = (0, n.st)(),
                    { pageId: o } = (0, s.$au)(),
                    { blockId: l, blockType: c, blockPosX: d, blockPosY: m } = (0, s.N8n)(),
                    { objectType: u, objectId: _, objectPosX: C, objectPosY: h, objectsCount: v, mainObjectId: g, mainObjectType: p } = (0, s.Jfv)();
                return (0, i.c)((n, i) => {
                    if (!a || !o) return;
                    let x = s.Wft[o];
                    if (!x) return;
                    ...
                    i && (f.deepLink = i);
                    let b = (0, r.Fx)({ params: f, logger: t, context: 'useSendEventOnDonationNavigated' });
        ...
        14952: (e, t, a) => {
                ...
                d = {
                    4601: (e, t, a) => {
                        ...
                        t.useToggle = (e) => {
                            ...
                            return { state: t, toggle: n, setState: a, toggleTrue: i, toggleFalse: s };
                        };
                    },
                    352: (e) => {
                        e.exports = c;
            ...
            ((() => {
                ...
                _.useTruncate = (r) => {
                    let [n, i] = (0, t.useState)(0),
                        { state: s, toggleTrue: o, toggleFalse: l } = (0, a.useToggle)(!1),
                        c = (0, t.useMemo)(
                            () =>
                                (0, e.throttle)(() => {
                                    let { offsetHeight: e, scrollHeight: t } = (null == r ? void 0 : r.current) || {};
                                    e && t && n < t ? o() : l();
                                }, 100),
                            [n, r, l, o],
                        );
                    return (
                        (0, t.useEffect)(() => {
                            var e, t;
                            !n && (null == (e = r.current) ? void 0 : e.offsetHeight) && i(null == (t = r.current) ? void 0 : t.offsetHeight);
                        }, [n, r]),
                        (0, t.useEffect)(
                            () => (
                                c(),
            ...
            var C = _.useTruncate,
                ...
                b = a(51704);
            let N = (0, i.PA)((e) => {
                    let { message: t, title: a, className: i, credits: s, messageClassName: o } = e,
                        {
                    ...
                    return (0, r.jsxs)(b.a, {
                        ...
                        headerClassName: (0, n.$)(x().modalHeader, { [x().modalHeader_withTitle]: a }),
                        size: 'fitContent',
                                ...
                                (0, r.jsxs)(r.Fragment, {
                                    children: [
                                        (0, r.jsx)(h.Button, {
                                            ...
                                            children: (0, r.jsx)(v.Caption, { size: 'm', variant: 'span', children: m }),
                                        }),
                                        (0, r.jsx)(N, { message: t.message, title: t.title, className: i, credits: o, messageClassName: d }),
                                    ],
                                }),
                        ],
                    });
        ...
        16763: (e, t, a) => {
            ...
            let o = (e) => {
                let { artistId: t, viewUuid: a } = e,
                    ...
                    { hash: l } = (0, i.gf)(),
                    { pageId: c } = (0, s.$au)(),
                    { objectsCount: d, objectType: m, objectId: u, objectPosX: _, objectPosY: C, objectPos: h } = (0, s.Jfv)(),
                    v = (0, s.NKK)(),
                    g = (0, s.UlF)(),
                    p = (0, r.useCallback)(
                        (e) => {
                            let a = (0, n.Fx)({
                                params: { hash: l, artistId: t, objectsCount: d, objectType: m, objectId: u, objectPosX: _, objectPosY: C, to: e },
                                logger: g,
                    ...
                    x = (0, r.useCallback)(
                        (e) => {
                            let r = (0, n.Fx)({
                                params: { hash: l, artistId: t, viewUuid: a, objectId: u, objectPos: h, to: e },
                                logger: g,
                                context: 'useSendEventOnConcertNavigated',
                            });
        ...
        19911: (e, t, a) => {
            ...
            var r = a(33008),
                ...
                d = a(78016);
            let m = (0, n.PA)((e) => {
                    let { onClick: t, className: a, size: n = 's', iconSize: i = 'xxs', forwardRef: m, ...u } = e,
                ...
                u = (0, i.forwardRef)((e, t) => (0, r.jsx)(m, { forwardRef: t, ...e }));
        },
        22397: (e, t, a) => {
            'use strict';
            a.d(t, { ConcertDate: () => m });
            var r = a(33008),
                ...
                d = a.n(c);
            let m = (e) => {
                let { datetime: t, className: a, monthClassName: c, dayClassName: m, weekdayClassName: u, withWeekday: _ = !0, ...C } = e,
                    { formatDate: h } = (0, i.A)(),
                    v = (0, l.mkF)(t);
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)(o.Caption, { variant: 'div', size: 'xs', weight: 'bold', className: (0, n.$)(d().month, c), children: v }),
                        (0, r.jsx)(o.Caption, { variant: 'div', className: (0, n.$)(d().day, m), children: h(t, (0, l.Uw7)()) }),
                        _ &&
                            (0, r.jsx)(o.Caption, {
                                variant: 'div',
                                size: 'xs',
        ...
        23923: (e, t, a) => {
            ...
            var r = a(33008),
                ...
                h = a.n(C);
            let v = (e) => {
                    let { artist: t, goal: a, onNavigateToArtist: i, onNavigateToDonation: C, forwardRef: v, ...g } = e,
                        ...
                        children: [
                            (0, r.jsx)(m.Paper, {
                                ...
                                children: (0, r.jsx)(_.N_, {
                                    href: t.url,
                                    onClick: i,
                                    'aria-label': p({ id: 'entity-names.artist-name' }, { artistName: t.name }),
                            ...
                            (0, r.jsxs)('div', {
                                ...
                                children: [
                                    (0, r.jsxs)('div', {
                                        className: h().text,
                                        children: [
                                            (0, r.jsx)(u.Heading, { variant: 'span', size: 'xs', weight: 'bold', lineClamp: 2, className: h().artist, children: t.name }),
                                            (0, r.jsx)(u.Caption, {
                                                variant: 'span',
                                                type: 'text',
                                                size: 'l',
                                    ...
                                    (0, r.jsxs)(c.Button, {
                                        ...
                                        withRipple: !1,
                                        children: [
                                            (0, r.jsx)(d.Icon, { variant: 'ruble', size: 'xxxs' }),
                                            (0, r.jsx)(u.Caption, {
                                                type: 'text',
                                                size: 'm',
                                                weight: 'medium',
                                                variant: 'span',
                                                children: (0, r.jsx)(o.A, { id: 'donation.support-button' }),
                                            }),
                                        ],
                                    }),
                                ],
                ...
                g = (0, i.forwardRef)((e, t) => (0, r.jsx)(v, { forwardRef: t, ...e }));
        },
        26369: (e) => {
            e.exports = {
        ...
        40765: (e, t, a) => {
            ...
            let N = ' • ',
                k = (0, n.PA)((e) => {
                    var t, a, n;
                    let { concert: x, withMask: b = !0, withPriceButton: k } = e,
                        { state: w, toggleTrue: j, toggleFalse: y } = (0, d.e)(!1),
                        ...
                        { href: D } = (0, C.uvd)('/concert/:concertId', { params: { concertId: x.id } }),
                        S = (0, C.ZpR)(D),
                        K = O(x),
                        P = (0, l.c)((e) => {
                        ...
                        $ = (0, c.L)(() => {
                            if (x.isCashbackExperimentEnabled && x.cashbackTitle)
                                return (0, r.jsx)(g.m, { className: f().cashback, titleClassName: f().cashbackTitle, title: x.cashbackTitle });
                        });
                    return (0, r.jsxs)(r.Fragment, {
                        children: [
                            (0, r.jsxs)('div', {
                                ...
                                children: [
                                    (0, r.jsx)(u.q, { children: (0, r.jsx)(_.Caption, { variant: 'div', children: (0, r.jsx)(i.A, { id: 'entity-names.concert' }) }) }),
                                    (0, r.jsx)('div', {
                                        className: f().cover,
                                    ...
                                    (0, r.jsxs)('div', {
                                        ...
                                        children: [
                                            (0, r.jsx)(_.Caption, {
                                                ...
                                                lineClamp: 1,
                                                className: f().title,
                                                ...(0, o.Am)(o.OA.concert.CONCERT_CARD_TITLE),
                                                children: x.title,
                                            }),
                                            (0, r.jsxs)(_.Caption, {
                                                variant: 'span',
                                                ...
                                                children: [
                                                    (0, r.jsx)(_.Caption, {
                                                        ...
                                                        'aria-label': F(' '),
                                                        ...(0, o.Am)(o.OA.concert.CONCERT_CARD_LOCATION),
                                                        children: F(N),
                                                    }),
                                                    (0, r.jsx)(_.Caption, {
                                                        'aria-hidden': !0,
                                                    ...
                                                    (0, r.jsx)(_.Caption, {
                                                        ...
                                                        weight: 'medium',
                                                        className: f().rating,
                                                        ...(0, o.Am)(o.OA.concert.CONCERT_CARD_CONTENT_RATING),
                                                        children: x.contentRating,
                                                    }),
                                                ],
                                            }),
                                            $,
                                    ...
                                    (null == (n = x.price) ? void 0 : n.value) && (0, r.jsx)(u.q, { children: (0, r.jsx)(_.Caption, { variant: 'div', children: K }) }),
                                    k &&
                                        (0, r.jsx)(m.Button, {
                                            'aria-hidden': !0,
                                            tabIndex: -1,
                            ...
                            (0, r.jsx)(v.AfishaWidget, { dataSessionId: x.dataSessionId, isOpened: w, onOpen: j, onClose: y }),
                        ],
                    });
                });
        },
        ...
        44872: (e, t, a) => {
            ...
            let c = (e) => {
                ...
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)(i.Icon, { 'aria-hidden': !0, className: l().icon, variant: 'plus' }),
                        (0, r.jsx)(s.Caption, {
                            variant: 'span',
                            type: 'text',
                            size: 'm',
        ...
        47487: (e, t, a) => {
            ...
            var r = a(33008),
                ...
                l = a(79169),
                c = a(30293);
            let d = (e) => (0, c.httpsReplacer)(e.replace('%%', '960x690_noncrop'));
            var m = a(10395),
                u = a(22397),
                _ = a(22445),
                C = a.n(_);
            let h = (0, i.PA)((e) => {
                let { uri: t, withMask: a, datetime: i, coverColor: c } = e,
                    ...
                    h = _.checkExperiment(l.zal.NewConcertsTicketRedesign, 'on') && a,
                    v = (0, s.L)(() => {
                        if (c) return { '--concert-image-date-background': (0, m.J)(c) };
                    });
                return (0, r.jsxs)('div', {
                    className: (0, n.$)(C().root, { [C().root_withMask]: h }),
                    style: v,
                    children: [
                        (0, r.jsx)(o.Image, { className: C().image, fit: 'cover', src: t, withAvatarReplace: !0, createUrlReplacer: d, 'aria-hidden': !0 }),
                        i &&
                            (0, r.jsx)(u.ConcertDate, {
                                dayClassName: C().day,
                                weekdayClassName: (0, n.$)(C().weekday, C().important),
        ...
        51551: (e, t, a) => {
            ...
            let n = /[+-]\d{2}:?\d{2}/,
                ...
                o = (e) => {
                    ...
                    return (0, r.wg)({
                        id: e.id,
                        dataSessionId: null != (a = e['data-session-id']) ? a : '',
            ...
            var c = a(83992),
                d = a(79169),
                m = a(59615);
            let u = r.gK.model('Price', { value: r.gK.number, currency: r.gK.string }),
                _ = r.gK
                    .model('Concert', {
                        id: r.gK.string,
                    ...
                    .views((e) => ({
                        get isCashbackExperimentEnabled() {
                            ...
                            return t.checkExperiment(d.zal.WebNextConcertsCashback, 'on');
                        },
                    }))
            ...
            let w = (e) => {
                ...
                return (0, f.jsxs)('div', {
                    className: k().root,
                    children: [
                        (0, f.jsx)(b.Shimmer, { radius: 'm', className: k().shimmerCover, isActive: t }),
                        (0, f.jsx)('div', { className: k().meta, children: (0, f.jsx)(b.Shimmer, { isActive: t, radius: 'xxxl', className: k().shimmerTitle }) }),
                        a && (0, f.jsx)(b.Shimmer, { isActive: t, radius: 'xxxl', className: k().shimmerButton }),
                    ],
                });
            };
            var j = a(22397),
        ...
        53706: (e, t, a) => {
            ...
            let o = (e) => {
                ...
                return (0, i.wg)({ url: t, goal: r, artist: (0, s.as)({ artist: a }) });
            };
            var l = a(17846),
                c = a(66268),
                d = a(79169);
            let m = { [d.Sxu.Light]: 'yandex_music', [d.Sxu.Dark]: 'yandex_music_dark' },
                u = () => {
                ...
                _ = i.gK.model('Donation', { url: i.gK.string, artist: s.PK, goal: i.gK.maybe(i.gK.string) });
            var C = a(19911),
                h = a(23923),
                v = a(76595),
                g = a(33008),
            ...
            let N = (e) => {
                    ...
                    return (0, g.jsxs)('div', {
                        ...
                        children: [
                            (0, g.jsx)(x.Shimmer, { isActive: t, radius: 'round', className: b().shimmerCover }),
                            (0, g.jsxs)('div', {
                                ...
                                children: [
                                    (0, g.jsxs)('div', {
                                        ...
                                        children: [
                                            (0, g.jsx)(x.Shimmer, { isActive: t, radius: 'xxxl', className: b().shimmerArtist }),
                                            (0, g.jsx)(x.Shimmer, { isActive: t, radius: 'xxxl', className: b().shimmerGoal }),
                                        ],
                                    }),
                                    (0, g.jsx)(x.Shimmer, { isActive: t, radius: 'xxxl', className: b().shimmerButton }),
                                ],
                            }),
                        ],
                    });
                },
                k = (e) => Array.from({ length: 10 }, (t, a) => (0, g.jsx)(N, { isActive: e }, a));
        },
        60153: (e, t, a) => {
            'use strict';
            a.d(t, { ArtistMeta: () => u });
            ...
            let u = (0, n.PA)((e) => {
                let { id: t, concert: a } = e,
                    { formatDate: n } = (0, s.A)(),
                    d = [],
                    u = (0, r.jsx)(o.Caption, { variant: 'span', size: 'm', weight: 'medium', 'aria-hidden': !0, children: '•' });
                return (
                    (null == a ? void 0 : a.place) && d.push((0, r.jsx)(o.Caption, { variant: 'span', size: 'm', weight: 'medium', lineClamp: 1, children: a.place })),
                    (null == a ? void 0 : a.datetime) &&
                        d.push(u, (0, r.jsx)(o.Caption, { variant: 'span', size: 'm', weight: 'medium', children: n(a.datetime, (0, l.fS8)()) })),
                    (null == a ? void 0 : a.contentRating) &&
                        d.push(u, (0, r.jsx)(o.Caption, { variant: 'span', size: 'm', weight: 'medium', children: a.contentRating })),
                    (0, r.jsxs)('div', {
                        className: m().root,
                        id: t,
                        children: [
                            ...
                            (0, r.jsx)('div', { className: m().info, children: d.map((e, t) => (0, i.cloneElement)(e, { key: t })) }),
                            (null == a ? void 0 : a.isCashbackExperimentEnabled) &&
                                (null == a ? void 0 : a.cashbackTitle) &&
                                (0, r.jsx)(c.m, { className: m().cashback, title: a.cashbackTitle }),
                        ],
                    })
                );
            });
        ...
        70139: (e, t, a) => {
            ...
            let o = () => {
                ...
                return (0, i.c)((n, i) => {
                    ...
                    f && (n ? (0, r.Pf)(a.evgenInstance, f) : (0, r.nv)(a.evgenInstance, f));
                });
            };
        },
        74571: (e, t, a) => {
            ...
            var r = a(33008),
                ...
                m = a.n(d);
            let u = (e) => {
                let { dataSessionId: t, isOpened: a, onOpen: d, onClose: u } = e,
                    _ = (0, c.NFA)().get(c.twC),
                    { formatMessage: C } = (0, i.A)(),
                    h = (0, n.useCallback)(
                        (e) => {
                            e.origin === _.afisha.host && 'close' === e.data.type && u();
                        },
                        [u, _.afisha.host],
                    );
                (0, n.useEffect)(
                ...
                let v = (0, n.useCallback)(
                    ...
                    g = ''.concat(_.afisha.host, '/w/sessions/').concat(t, '?clientKey=').concat(_.afisha.clientId);
                return (0, r.jsxs)(o.a, {
                    size: 'fitContent',
                    placement: 'center',
                    open: a,
                    ...
                    overlayColor: 'full',
                    children: [
                        (0, r.jsx)(l.q, { children: (0, r.jsx)(s.Button, { 'aria-label': C({ id: 'interface-actions.close' }), onClick: u }) }),
                        (0, r.jsx)('iframe', {
                            src: g,
                            className: m().root,
                    ...
                    return (0, r.jsxs)('section', {
                        ...
                        children: [
                            (0, r.jsx)(l.Tw, {
                                ...
                                description: h,
                                viewAllActionLink: C,
                                controls: (0, r.jsx)(l.X9, { className: d().controls, carouselRef: x }),
                                headingVariant: u,
                                withDescription: !!h,
                            }),
                            (0, r.jsx)(o.Carousel, { ref: x, itemClassName: (0, n.$)(d().item, d().important), className: m, 'aria-labelledby': p, children: v }),
                        ],
                    });
                },
                u = (0, i.forwardRef)((e, t) => (0, r.jsx)(m, { forwardRef: t, ...e }));
                ...
                return (0, n.c)((a) => {
                    ...
                    return (null == (r = a.price) ? void 0 : r.value)
                        ? e(
                              ...
                              { value: t(a.price.value, { style: 'currency', currency: null == (n = a.price) ? void 0 : n.currency, maximumFractionDigits: 0 }) },
                          )
                        : e({ id: 'payment.buy' });
                });
            };
        ...
        84218: (e, t, a) => {
            ...
            var r = a(33008),
                ...
                f = a.n(x);
            let b = (0, i.PA)((e) => {
                let { artistId: t, concert: a, meta: i, viewUuid: x, radius: b = 'l', className: N, shouldSendAnalyticsOnHide: k } = e,
                    { state: w, toggleTrue: j, toggleFalse: y } = (0, c.e)(!1),
                    { experiments: A } = (0, _.Pjs)(),
                    I = A.checkExperiment(_.zal.WebNextConcertPage, 'on'),
                    { href: T } = (0, _.uvd)('/concert/:concertId', { params: { concertId: a.id } }),
                    E = (0, _.ZpR)(T),
                    R = ((e) => {
                        let { artistId: t, viewUuid: a } = e,
                            r = (0, h.st)(),
                            { hash: n } = (0, h.gf)(),
                            { pageId: i } = (0, _.$au)(),
                            { objectsCount: l, objectType: c, objectId: d, objectPosX: m, objectPosY: u, objectPos: C } = (0, _.Jfv)(),
                            v = (0, _.UlF)(),
                            g = (0, s.useCallback)(() => {
                                let e = (0, o.Fx)({
                                    params: { hash: n, artistId: t, objectsCount: l, objectType: c, objectId: d, objectPosX: m, objectPosY: u },
                                    logger: v,
                            ...
                            p = (0, s.useCallback)(() => {
                                let e = (0, o.Fx)({
                                    params: { hash: n, artistId: t, viewUuid: a, objectId: d, objectPos: C },
                                    logger: v,
                                    context: 'useSendEventOnConcertShowed',
                                });
                    ...
                    { ref: D, intersectionPropertyId: S } = (0, _.nMI)({ callback: null !== t ? R : void 0, singleEvent: !k }),
                    K = (0, s.useId)(),
                    P = (0, s.useId)(),
                ...
                return (0, r.jsxs)(u.Paper, {
                    ...
                    children: [
                        a.datetime &&
                            (0, r.jsx)(p.ConcertDate, { datetime: a.datetime, id: K, className: f().date, dayClassName: f().dateColor, monthClassName: f().dateColor }),
                            ...
                            (0, r.jsxs)(r.Fragment, {
                                children: [
                                    (0, r.jsx)(m.Button, {
                                        ...
                                        radius: 'xxxl',
                                        className: f().button,
                                        'aria-describedby': ''.concat(K, ' ').concat(P),
                                        'aria-label': B,
                                        onClick: z,
                                        children: B,
                                    }),
                                    (0, r.jsx)(g.AfishaWidget, { dataSessionId: a.dataSessionId, isOpened: w, onOpen: j, onClose: y }),
                                ],
                            }),
                    ],
                });
        ...
        88012: (e) => {
            e.exports = { root: 'ConcertMeta_root__CkKU3', city: 'ConcertMeta_city__ngDq2', info: 'ConcertMeta_info__czKlU', cashback: 'ConcertMeta_cashback__fkZfk' };
        },
        89396: (e) => {
