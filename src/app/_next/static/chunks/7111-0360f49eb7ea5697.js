                ...
                i = {
                    ...
                    1017: (e, t, r) => {
                            ...
                            ((n = function (e) {
                                    ...
                                    i.useEffect(
                                        function () {
                                            if (e.inert) {
                                                ...
                                                })([e.lockRef.current], (e.shards || []).map(A), !0).filter(Boolean);
                                                return (
                                                    t.forEach(function (e) {
                                ...
                                var l = i.useCallback(function (e, t) {
                                    ...
                                    d = i.useCallback(function (t) {
                                        u(t.type, I(t), t.target, l(t, e.lockRef.current));
                                    }, []),
                        ...
                        var V = i.forwardRef(function (e, t) {
                            return i.createElement(v, a({}, e, { ref: t, sideCar: W }));
                        });
                    ...
                    9430: function (e, t, r) {
                        ...
                        t.Popover = (e) => {
                            ...
                            let {
                                ...
                                ee = (0, a.useId)(),
                                et = (0, a.useId)(),
                                er = (0, o.useListNavigation)($, { listRef: z, activeIndex: I, nested: R, onNavigate: A }),
                                en = (0, o.useTypeahead)($, { listRef: U, onMatch: N ? A : void 0, activeIndex: I });
                            (0, a.useEffect)(() => {
                                if (!Z) return;
                                let e = () => {
                                        B(!1);
                                ...
                                (0, a.useEffect)(() => {
                                    N && Z && Z.events.emit('menuopen', { parentId: V, nodeId: W });
                                }, [Z, N, W, V]),
                                (0, a.useLayoutEffect)(() => {
                            ...
                            let { handlers: es } = (0, f.usePopoverSwipeable)({
                                ...
                                ea = L ? [K.setFloating, L] : [K.setFloating, null == es ? void 0 : es.ref],
                                ...
                                ek = (0, o.useMergeRefs)([K.setReference, Y.ref]),
                                ...
                                ew = {
                                    ...
                                    arrow: eb,
                                    children: (0, a.cloneElement)(F.props.children, { onClose: J, key: et }),
                                },
                                eh = (0, a.cloneElement)(F, ew),
                                eO = (0, a.useMemo)(() => ({ activeIndex: I, setActiveIndex: A, getItemProps: ep, isOpen: N }), [I, ep, N]),
                                eR = R ? -1 : 0;
