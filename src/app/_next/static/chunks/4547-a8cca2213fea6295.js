    ...
    [4547],
    {
            ...
            class s extends i.Y {
                createHttpOptions(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        { timeoutKey: r, params: a, headers: i, signal: s, cacheControl: n, ...o } = t,
                        { prefixUrl: c, ...l } = o,
                        { timeouts: h = this.config.timeouts, withoutPrefixUrl: u, withoutHeaders: d } = e,
                        g = null == h ? void 0 : h[r],
                        y = d ? void 0 : null != i ? i : this.createRequestHeaders({ params: a, timeout: g });
                    y && n && (y['cache-control'] = n);
                    let p = null != c ? c : this.config.prefixUrl,
                        m = { headers: y, retry: this.getRetryPolicyConfig(), timeout: g, signal: s, ...l };
                    return u ? m : { prefixUrl: p, ...m };
                }
                ...
                createRequestHeadersFromParams(t) {
                    ...
                    let T = (null == t || null == (e = t.common) ? void 0 : e.oauth) || this.config.params.common.oauth,
                        ...
                        f = (null == t || null == (a = t.common) ? void 0 : a.language) || this.config.params.common.language,
                        C = (null == t || null == (i = t.common) ? void 0 : i.device) || this.config.params.common.device,
                    ...
                    return (
                        ...
                        void 0 !== D && ((L['x-forwarded-for-y'] = D), (L['x-forwarded-for'] = D)),
        ...
        44547: (t, e, r) => {
            ...
            let u = Symbol('CONTAINER_USER_CONFIG_TOKEN'),
                ...
                C = Symbol('CONTAINER_PLAYLISTS_CONTROLLER_TOKEN'),
            ...
            let th = { afterError: new (r(68413).AsyncSeriesHook)(['error']) };
            class tu {
                get state() {
            ...
            class tC {
                ...
                stopDownload(t) {
                    ...
                    (!this.store.tracks.state[r] || (a && tf.includes(a))) && (this.changeState(r, { loadingState: o.IDLE }), this.downloader.removeTask(String(t)));
                }
            ...
            class t7 extends tM {
                ...
                async getCountByTrackId(t) {
                    return this.executeTransaction(async (e) => e.countFromIndex(V.name, t9, t)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { trackId: t });
                    });
                }
                async getCountByUid(t) {
                    ...
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                ...
                                e.createIndex('uid', 'uid'), e.createIndex(t9, 'trackId');
                            },
                        },
                    });
                }
                    ...
                    this.container ||
                        (this.container = (function (t) {
                            ...
                            return new te.Dt().registerMany({
                                ...
                                [v]: (0, te.do)((t) => new tC({ container: t })),
                        ...
                        (this.repositoryContainer = ((t) => {
                            ...
                            return (
                                ...
                                a &&
                                    ...
                                    (i.usersAlbumsRepository = new t3())),
                                i
                            );
                        })(t)),
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                signal: null == e ? void 0 : e.signal,
                                searchParams: (0, n.P)({ showWizard: t.showWizard, locations: t.locations }),
                            }),
                        )
                    ).json();
                }
