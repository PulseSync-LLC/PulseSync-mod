(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [7410],
    {
        320: (e, t, a) => {
            ...
            let T = (0, i.PA)((e) => {
                ...
                let { metatagId: S, preloadedMeta: T } = e,
                    ...
                    { contentScrollRef: C, setContentScrollRef: A } = (0, p.gKY)(),
                    L = (0, p.W6M)(),
                    G = (0, n.useCallback)(
                        (e) => {
                            S && _.getData({ metatagId: S, page: e, pageSize: f.c });
                        },
                        [_, S],
                    );
                (0, n.useEffect)(
                        ...
                        (0, n.useEffect)(() => {
                            ...
                            let t = ((e) => {
                                ...
                                return {
                                    ...
                                    pager: {
                                        page: (null == (t = e.pager) ? void 0 : t.page) || 0,
                                        perPage: (null == (a = e.pager) ? void 0 : a.perPage) || 0,
                                        total: (null == (l = e.pager) ? void 0 : l.total) || 0,
                                    },
                                };
                            })(e);
                            (0, N.H)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, p.jxB)(e);
                            });
                        }, [e]);
                    })(_);
                              ...
                              children: (0, l.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, l.jsx)(y.Y9, {
                                          ...
                                          children: (0, l.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: _.fullTitle }),
                                      }),
                                      (0, l.jsx)(y.$$, {
                                          className: (0, s.$)(P().scrollContainer, P().important),
                                          customComponents: R,
                                          itemContentCallback: (e) => {
                                              var t;
                                              let a = null == _ || null == (t = _.items) ? void 0 : t[e],
                                                  s = E({ id: 'loading-messages.entity-is-loading' }, { entityName: E({ id: 'entity-names.playlist' }) });
                                              return a ? (0, l.jsx)(m.B6, { playlist: a, contentLinesCount: 3 }, a.key) : (0, l.jsx)(y.Vt, { 'aria-label': s });
                                          },
                                          totalCount: null != (a = null == _ || null == (t = _.pager) ? void 0 : t.total) ? a : 0,
                                          onGetDataByPage: G,
                                          pageSize: f.c,
                                          totalRequests: null != (i = _.requests) ? i : 0,
                                          listClassName: P().content,
                                          itemClassName: P().item,
                                          handleRef: A,
                                          context: { listAriaLabel: E({ id: 'mixes.playlists-list' }, { genreName: _.fullTitle || '' }) },
                                          isMobileLayout: b,
                                          useWindowScroll: b,
                                      }),
                                  ],
        ...
        10456: (e, t, a) => {
            ...
            async function r(e, t) {
                ...
                return {
                    ...
                    twitter: (0, l.HRN)({ cardType: l.WfF.APP, title: c, url: null != n ? n : '', appName: d({ id: 'metadata.yandex-music' }) }),
                    appLinks: (0, l.X5i)({
                        additional: { tld: o, url: null != n ? n : '', fullUrl: null != r ? r : '', host: u },
        ...
        21682: (e, t, a) => {
            ...
            async function r(e, t) {
                let { locale: a, fullUrl: r, url: n, tld: o, host: u } = t,
                    ...
                    p = (0, s.f)({ genreTitle: g, artists: m, messageFormatter: d }),
        ...
        53628: (e, t, a) => {
            ...
            let b = (0, s.PA)((e) => {
                let { metatagId: t, preloadedMeta: a } = e,
                    ...
                    { contentScrollRef: b, setContentScrollRef: E } = (0, f.gKY)(),
                    C = (0, f.W6M)(),
                    A = (0, u.c)(() => 315),
                    L = (0, u.c)(() => {
                        var e;
                        return !s.isShimmerVisible && (null == (e = s.pagesLoader.pager) ? void 0 : e.total) ? s.pagesLoader.pager.total : 30;
                    }),
                    G = (0, r.useCallback)(
                        (e) => {
                            t && s.getData({ metatagId: t, page: e, pageSize: h.c });
                        },
                        [s, t],
                    ),
                ...
                let v = (0, u.c)((e) => {
                    ...
                    return t ? (0, l.jsx)(m.ao, { artist: t, contentLinesCount: 3 }, t.id) : (0, l.jsx)(N.Vt, { 'aria-label': a, round: !0, centered: !0 });
                });
                    ...
                    (0, r.useEffect)(() => {
                        ...
                        let t = ((e) => {
                            ...
                            return {
                                id: '',
                                title: { title: '', fullTitle: e.fullTitle || '' },
                                artists: e.items.map((e) => ({ artist: (0, P.NE)(e), popularTracks: [] })),
                                pager: {
                ...
                t && s.isNeededToLoad && (0, r.use)(s.getData({ preloadedMeta: a, metatagId: t, page: 0, pageSize: h.c })),
                s.isSomethingWrong)
                    ? (0, l.jsx)(c.w, {})
                    : (0, l.jsx)(f.nVz, {
                              ...
                              children: (0, l.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, l.jsx)(N.Y9, {
                                          ...
                                          children: (0, l.jsx)(g.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: s.fullTitle }),
                                      }),
                                      (0, l.jsxs)(d.N, {
                                          ref: E,
                                          className: _().root,
                                          ...
                                          children: [
                                              ...
                                              (0, l.jsx)(N.A, { children: (0, l.jsx)(N.wi, { className: _().footer }) }),
                                          ],
                                      }),
                                  ],
                              }),
        ...
        74543: (e, t, a) => {
            ...
            let P = (0, i.PA)((e) => {
                ...
                let { metatagId: h, preloadedMeta: P } = e,
                    ...
                    { contentScrollRef: E, setContentScrollRef: C } = (0, p.gKY)(),
                    A = (0, p.W6M)(),
                    L = (0, n.useCallback)(
                        (e) => {
                            h && T.getData({ metatagId: h, page: e, pageSize: f.c });
                        },
                        [T, h],
                    );
                (0, n.useEffect)(
                    ...
                    ((e) => {
                        (0, n.useEffect)(() => {
                            ...
                            (0, N.g)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, p.jxB)(e);
                            });
                        }, [e]);
                    })(T);
                              ...
                              children: (0, l.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, l.jsx)(y.Y9, {
                                          ...
                                          children: (0, l.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: T.fullTitle }),
                                      }),
                                      (0, l.jsx)(y.$$, {
                                          className: (0, s.$)(S().scrollContainer, S().important),
                                          customComponents: G,
                                          itemContentCallback: (e) => {
                                              let t = T.items[e],
                                                  a = b({ id: 'loading-messages.entity-is-loading' }, { entityName: b({ id: 'entity-names.album' }) });
                                              return t
                                                  ? (0, l.jsx)(c.aX, { album: t, contentLinesCount: 4 }, t.id)
                                                  : (0, l.jsx)(y.Vt, { 'aria-label': a, linesCount: 4 });
                                          },
                                          totalCount: null != (a = null == T || null == (t = T.pager) ? void 0 : t.total) ? a : 0,
                                          onGetDataByPage: L,
                                          pageSize: f.c,
                                          totalRequests: null != (i = T.requests) ? i : 0,
                                          listClassName: S().content,
                                          itemClassName: S().item,
                                          handleRef: C,
                                          context: { listAriaLabel: b({ id: 'mixes.albums-list' }, { genreName: T.fullTitle || '' }) },
                                          isMobileLayout: _,
                                          useWindowScroll: _,
                                      }),
                                  ],
                ...
                return (
                    Array.isArray(a) &&
                        (s = a
                            ...
                            .join(', ')),
                    s ? l({ id: 'metadata.genre-description' }, { genreTitle: t, artistsList: s }) : l({ id: 'metadata.genre-description-short' }, { genreTitle: t })
                );
            }
            a.d(t, { f: () => l });
        },
        97410: (e, t, a) => {
            'use strict';
            a.d(t, { Z3: () => y.GenreAlbumsPage, P0: () => f.GenreArtistsPage, L6: () => N.GenrePage, G8: () => p, ys: () => h.GenrePlaylistsPage });
            var l = a(41028),
                s = a(61979),
                i = a(52732),
                r = a(45242),
            ...
            let d = l.gK
                    ...
                    .views((e) => {
                        let t = {
                            get isNotFound() {
                                var a;
                                let t = e.isResolved && (null == (a = e.pager) ? void 0 : a.total) === 0,
                                    l = e.errorStatusCode === s.X1.NOT_FOUND || e.errorStatusCode === s.X1.BAD_REQUEST;
                    ...
                    .actions((e) => ({
                        getData: (0, l.L3)(function* (t) {
                            let { metatagId: a, page: r = 0, pageSize: n = 20, preloadedMeta: u } = t,
                                { metatagsResource: d, modelActionsLogger: g } = (0, l._$)(e);
                            if (!(e.loadingState === o.GuX.PENDING && e.pendingPages.has(''.concat(r))) && !e.alreadyRequestedPages.has(''.concat(r))) {
                ...
                g = l.gK
                    ...
                    .actions((e) => ({
                        getData: (0, l.L3)(function* (t) {
                            let { metatagId: a, page: i = 0, pageSize: r = 20, preloadedMeta: u } = t,
                                { metatagsResource: d, modelActionsLogger: g } = (0, l._$)(e);
            ...
            let m = l.gK
                    ...
                    .views((e) => {
                        let t = {
                            ...
                            get isSomethingWrong() {
                                return !t.isNotFound && e.isRejected && 0 === e.alreadyRequestedPages.size;
                            },
                        };
                        return t;
                    })
                    .actions((e) => ({
                        getData: (0, l.L3)(function* (t) {
                            let { metatagId: a, page: s = 0, pageSize: i = 20, preloadedMeta: r } = t,
                                { metatagsResource: n, modelActionsLogger: u } = (0, l._$)(e);
                            if (!(e.loadingState === o.GuX.PENDING && e.pendingPages.has(''.concat(s))) && !e.alreadyRequestedPages.has(''.concat(s))) {
            ...
            let T = async (e, t) => {
                try {
                    let { container: a, backendHostTld: l, locale: s, host: i, fullUrl: r, isRSC: n, requestUrl: u } = await (0, o.IhE)();
                    if (!e || n) return { genreMeta: void 0, tld: '', locale: null, host: '', fullUrl: null, url: null };
                    let d = a.get(o.UtQ);
                    return { genreMeta: await t(d, e), tld: l, locale: s, host: i, fullUrl: r, url: u };
                } catch (e) {
            ...
            let b = (0, i.PA)((e) => {
                ...
                ((e) => {
                    (0, n.useEffect)(() => {
                        ...
                        (0, h.M)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                            (0, f.jxB)(e);
                        });
                    }, [e]);
                })(i),
                t && i.isNeededToLoad && (0, n.use)(i.getData({ id: t, preloadedMeta: a })),
                          ...
                          children: (0, l.jsxs)(p.hO, {
                              ...
                              children: [
                                  (0, l.jsx)(N.Y9, {
                                      ...
                                      withForwardControl: !1,
                                      withBackwardControl: C.canBack,
                                      children: (0, l.jsx)(d.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: i.fullTitle }),
                                  }),
                                  (0, l.jsx)(u.N, {
                                      className: _().root,
                                      ...
                                      children: (0, l.jsxs)('div', {
                                          ...
                                          children: [
                                              i.hasPlaylists &&
                                                  (0, l.jsx)(f.FoH, {
                                                      blockId: f.hf$.PLAYLISTS_CAROUSEL,
                                                      blockType: f.hf$.PLAYLISTS_CAROUSEL,
                                                      blockPosX: 1,
                                                      blockPosY: 1,
                                                      blockIdForFrom: f.hf$.PLAYLISTS_CAROUSEL,
                                                      objectsCount: i.albums.length,
                                                      children: (0, l.jsx)(y.EC, {
                                                          isShimmerVisible: i.isLoading,
                                                          isShimmerActive: !0,
                                                          headerClassName: (0, s.$)(_().carouselBlockHeader, _().carouselBlock),
                                                          containerClassName: _().carouselBlock,
                                                          playlists: i.playlists,
                                                          title: T({ id: 'entity-names.popular-playlists' }),
                                                          viewAllActionLink: '/genre/'.concat(i.id, '/playlists'),
                                                      }),
                                                  }),
                                              i.hasAlbums &&
                                                  (0, l.jsx)(f.FoH, {
                                                      blockId: f.hf$.ALBUMS_CAROUSEL,
                                                      blockType: f.hf$.ALBUMS_CAROUSEL,
                                                      blockPosX: 1,
                                                      blockPosY: 2,
                                                      blockIdForFrom: f.hf$.ALBUMS_CAROUSEL,
                                                      objectsCount: i.albums.length,
                                                      children: (0, l.jsx)(c.pZ, {
                                                          isShimmerVisible: i.isLoading,
                                                          isShimmerActive: !0,
                                                          headerClassName: (0, s.$)(_().carouselBlockHeader, _().carouselBlock),
                                                          containerClassName: _().carouselBlock,
                                                          ...
                                                          viewAllActionLink: '/genre/'.concat(i.id, '/albums'),
                                                      }),
                                                  }),
                                              i.hasArtists &&
                                                  (0, l.jsx)(f.FoH, {
                                                      blockId: f.hf$.ARTISTS_CAROUSEL,
                                                      blockType: f.hf$.ARTISTS_CAROUSEL,
                                                      blockPosX: 1,
                                                      blockPosY: 3,
                                                      blockIdForFrom: f.hf$.ARTISTS_CAROUSEL,
                                                      objectsCount: i.albums.length,
                                                      children: (0, l.jsx)(N.OY, {
                                                          isShimmerVisible: i.isLoading,
                                                          isShimmerActive: !0,
                                                          headerClassName: (0, s.$)(_().carouselBlockHeader, _().carouselBlock),
                                                          containerClassName: _().carouselBlock,
                                                          title: T({ id: 'entity-names.popular-artists' }),
                                                          viewAllActionLink: '/genre/'.concat(i.id, '/artists'),
                                                          children: i.artists.map((e) => (0, l.jsx)(m.ao, { artist: e, contentLinesCount: 3 }, e.id)),
                                                      }),
                                                  }),
                                          ],
                                      }),
