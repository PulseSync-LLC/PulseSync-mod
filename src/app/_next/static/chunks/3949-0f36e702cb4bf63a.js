        ...
        23949: (e, t, s) => {
            ...
            function l(e, t, s) {
                ...
                function l() {
                    var l, o, r, h;
                    let a, d;
                    s.key && (null == (l = s.debug) ? void 0 : l.call(s)) && (a = Date.now());
                    let u = e();
                    if (!(u.length !== n.length || u.some((e, t) => n[t] !== e))) return i;
                    if (
                        ((n = u),
            ...
            color: hsl(${Math.max(0, Math.min(120 - 120 * i, 120))}deg 100% 31%);`,
                    ...
                    return (null == (h = null == s ? void 0 : s.onChange) || h.call(s, i), i);
                }
                return (
                    (l.updateDeps = (e) => {
                        n = e;
                ...
                g = (e, t) => {
                    ...
                    let n = 0,
                        ...
                        o = (i) => () => {
                            ...
                            ((n = o ? s.scrollLeft * ((r && -1) || 1) : s.scrollTop), l(), t(n, i));
                        },
                        h = o(!0),
                        a = o(!1);
                    ...
                    return (
                        ...
                        () => {
                            (s.removeEventListener('scroll', h), d && s.removeEventListener('scrollend', a));
                        }
                    );
                },
                p = (e, t) => {
                    ...
                    ((this.unsubs = []),
                        ...
                        (this.getMeasurements = l(
                            ...
                            ({ count: e, paddingStart: t, scrollMargin: s, getItemKey: i, enabled: n }, l) => {
                                ...
                                for (let n = o; n < e; n++) {
                                    let e = i(n),
                                        o = 1 === this.options.lanes ? r[n - 1] : this.getFurthestMeasurement(r, n),
                                        h = o ? o.end + this.options.gap : t + s,
                                        a = l.get(e),
                                        d = 'number' == typeof a ? a : this.options.estimateSize(n),
                                        u = h + d,
                                        c = o ? o.lane : n % this.options.lanes;
                                    r[n] = { index: n, start: h, size: d, end: u, key: e, lane: c };
                                }
                                ...
                                (this.range =
                                    e.length > 0 && t > 0
                                        ? (function ({ measurements: e, outerSize: t, scrollOffset: s, lanes: i }) {
                                              let n = e.length - 1;
                                              if (e.length <= i) return { startIndex: 0, endIndex: n };
                                              let l = E(0, n, (t) => e[t].start, s),
                                                  o = l;
                        ...
                        (this.getOffsetForAlignment = (e, t, s = 0) => {
                            ...
                            return (
                                ...
                                Math.max(Math.min(this.getTotalSize() - i, e), 0)
                            );
                        }),
                                ...
                                'smooth' !== s &&
                                    ...
                                    (this.scrollToIndexTimeoutId = this.targetWindow.setTimeout(() => {
                                        if (((this.scrollToIndexTimeoutId = null), this.elementsCache.has(this.options.getItemKey(e)))) {
                                            ...
                                            if (!t) return;
                                            let [i] = t;
                                            1 >= Math.abs(i - this.getScrollOffset()) || this.scrollToIndex(e, { align: l, behavior: s });
            ...
            function y(e) {
                ...
                return (l.setOptions(s), w(() => l._didMount(), []), w(() => l._willUpdate()), l);
            }
            function M(e) {
                return y({ observeElementRect: u, observeElementOffset: g, scrollToFn: S, ...e });
            }
            function z(e) {
                return y({
