    ...
    [4760],
    {
        357: (e, t, a) => {
            ...
            let P = (0, s.PA)((e) => {
                let {
                    ...
                    E = b.checkExperiment(r.zal.WebNextPlayerBarYellowButton, 'on');
                return (0, o.jsxs)('div', {
                        ...
                        (0, o.jsxs)('div', {
                            ...
                            children: [
                                ...
                                !t &&
                                    c &&
                                    (0, o.jsx)(v.Button, {
                                        className: (0, n.$)(k().sonataButton, k().rewind),
                                        color: 'secondary',
                                        size: 'm',
                                        radius: 'round',
                                        withRipple: !1,
                                        'aria-label': O({ id: 'player-actions.rewind-backwards' }),
                                        icon: (0, o.jsx)(m.Icon, { variant: 'rewindBackwards', size: 'xxs' }),
                                        onClick: _,
                        ...
                        (0, o.jsxs)('div', {
                            ...
                            children: [
                                (0, o.jsx)(v.Button, {
                                    ...
                                    icon: (0, o.jsx)(m.Icon, { variant: 'previous', size: 'xxs' }),
                                    onClick: p,
                                    ...(0, h.Am)(h.Kq.sonata.PREVIOUS_TRACK_BUTTON),
                                }),
                                (0, o.jsx)(C.DM, {
                                    className: (0, n.$)(k().sonataButton, k().sonataPlayButton),
                                    iconSize: 'm',
                                    size: 'l',
                                    radius: 'round',
                                    color: 'secondary',
                                    ...
                                    isPlaying: a,
                                    iconClassName: (0, n.$)(k().playPauseButtonIcon, { [k().playPauseButtonIcon_withYellowPlayButton]: E }),
                                    onClick: x,
                                }),
                                (0, o.jsx)(v.Button, {
                                    className: k().sonataButton,
                                    ...
                                    icon: (0, o.jsx)(m.Icon, { variant: 'next', size: 'xxs' }),
                                    onClick: d,
                            ...
                            children: [
                                !t &&
                                    ...
                                    (0, o.jsx)(v.Button, {
                                        ...
                                        icon: (0, o.jsx)(m.Icon, { variant: 'rewindForward', size: 'xxs' }),
                                        onClick: f,
            ...
            let b = (0, s.PA)((e) => {
                            ...
                            () =>
                                i
                                    ? (0, o.jsx)(v.Button, {
                                          ...
                                          radius: 'round',
                                          withRipple: !1,
                                          'aria-label': x({ id: 'player-actions.rewind-backwards' }),
                                          icon: (0, o.jsx)(m.Icon, { variant: 'rewindBackwards', size: 'xs' }),
                                          onClick: d,
                                      })
                                    : (0, o.jsx)(v.Button, {
                                          className: O().sonataButton,
                                          ...
                                          icon: (0, o.jsx)(m.Icon, { variant: 'previous', size: 'xs' }),
                                          onClick: u,
                            ...
                            () =>
                                i
                                    ? (0, o.jsx)(v.Button, {
                                          ...
                                          disabled: !a,
                                          withRipple: !1,
                                          'aria-label': x({ id: 'player-actions.rewind-forward' }),
                                          icon: (0, o.jsx)(m.Icon, { variant: 'rewindForward', size: 'xs' }),
                                          onClick: p,
                                      })
                                    : (0, o.jsx)(v.Button, {
                                          className: O().sonataButton,
                                          ...
                                          icon: (0, o.jsx)(m.Icon, { variant: 'next', size: 'xs' }),
                                          onClick: c,
                    ...
                    return (0, o.jsxs)('div', {
                        ...
                        children: [
                            (0, o.jsx)('div', {
                                ...
                                children: k && A && (0, o.jsx)(C.aQ, { fallback: (0, o.jsx)(C._I, { isDisliked: k.isDisliked, iconSize: 'xs', onClick: E }) }),
                            }),
                            (0, o.jsxs)('div', {
                            ...
                            (0, o.jsx)('div', {
                                ...
                                children:
                                    k &&
                                    A &&
                                    (0, o.jsx)(C.aQ, { fallback: (0, o.jsx)(C.cy, { isLiked: k.isLiked, iconSize: 'xs', onClick: b, disabled: !B.isAuthorized }) }),
                            }),
                        ],
                    });
                }),
                E = (0, s.PA)((e) => {
                    var t, a;
                    let { isMobile: s, entityMeta: _, isFullscreen: N, className: h, withShuffle: v, withRepeat: m } = e,
                        {
                            sonataState: C,
                            vibe: B,
                            advert: M,
                        ...
                        I = k.checkExperiment(r.zal.WebNextPlayerBarYellowButton, 'on'),
                        w = (0, r.zwV)(),
                        A = (0, r.eGp)(),
                            ...
                            return {
                                ...
                                rewindForward: (0, l.useCallback)(() => {
                                    ...
                                    let a = e.durationMs / 1e3,
                                        o = t.state.playerState.progress.value.position + 30;
                        ...
                        y = (0, r.rs2)(),
                        R = (0, r.brA)(),
                        T = (null == _ ? void 0 : _.isNonMusic) && !M.isAdvertShown,
                        j = (0, r.PT7)(),
                        ...
                        F = (0, l.useMemo)(() => (M.isAdvertShown ? M.isAdvertPlaying : c.w.includes(C.status)), [C.status, M.isAdvertShown, M.isAdvertPlaying]),
                        g = (0, i.c)(() => {
                            if (M.isAdvertShown) {
                                var e;
                                null == y || null == (e = y.audioAdvertPlayback) || e.togglePause();
                                return;
                            }
                    ...
                    (0, l.useEffect)(() => {
                        if (!N && (null == w || w.addShortcutsListener(r.Mo.MAIN, r.lbr.TOGGLE_PLAY, g), !M.isAdvertShown))
                            return (
                    ...
                    let q = (0, l.useMemo)(() => (N ? (s ? b : P) : s ? p.K : x.Z), [s, N]);
                    return (0, o.jsx)(q, {
                        className: (0, n.$)(h, { [f().root]: I }),
                        disabled: null === C.entityMeta || (M.isAdvertShown && !s),
                        isPlaying: F || !1,
            ...
            let p = (e) => {
                let { shuffle: t, closeToast: a } = e,
                    u = (0, s.useMemo)(() => {
                        let e;
                        return (
                            (e = t ? (0, o.jsx)(l.A, { id: 'notifications-info.shuffle-enabled' }) : (0, o.jsx)(l.A, { id: 'notifications-info.shuffle-disabled' })),
                            (0, o.jsx)(r.Caption, { className: d().message, variant: 'div', type: 'controls', size: 'm', children: e })
                        );
                    }, [t]);
                return (0, o.jsx)(c.$W, {
                    cover: (0, o.jsx)(i.Icon, { className: (0, n.$)(d().icon, { [d().icon_unset]: !t }), size: 'xs', variant: 'shuffle' }),
                    message: u,
                    closeToast: a,
                    coverRadius: 's',
                });
        ...
        5453: (e, t, a) => {
            ...
            var o = a(33008),
                n = a(18740);
            let s = (e) => {
                let { disabled: t, isPlaying: a, onClickPlayPause: s, className: l } = e;
                return (0, o.jsx)(n.DM, { className: l, size: 's', iconSize: 'xs', disabled: t, isPlaying: a, onClick: s });
            };
        },
        12085: (e) => {
            e.exports = {
        ...
        33363: (e, t, a) => {
            ...
            let _ = (0, s.PA)((e) => {
                let { className: t } = e,
                    ...
                    d = s.checkExperiment(c.zal.WebNextPlayerBarYellowButton, 'on'),
                    _ = (0, c.eGp)(),
                    { from: f } = (0, c.fyy)({ pageId: c._Q$.VIDEO_PLAYER, contextId: a.state.contextId, contextType: l.K.Various }),
                    x = (0, r.c)(() => {
                    ...
                    { isPlaying: h, togglePlay: v } = (0, c.Dx4)({
                        playContextParams: { contextData: { type: l.K.Various, meta: { id: c.H7u.VARIOUS_CLIP_CONTEXT }, from: f }, loadContextMeta: !0 },
                        sonataState: a.state,
            ...
            let _ = (e) => {
                ...
                return (0, o.jsx)(c.Button, {
                    ...
                    icon: (0, o.jsx)(u.Icon, {
                        size: x,
                        variant: C,
                        className: (0, n.$)(p().repeatIcon, p()['repeatIcon_'.concat(a)], { [p().repeatIcon_disabled]: t }, _),
                    }),
                    ...(0, l.Am)(
                        ((e, t) =>
                            e === i.pM.NONE || t
                                ...
                                : e === i.pM.ONE
                                  ...
                                  : l.Kq.sonata.REPEAT_BUTTON_REPEAT_CONTEXT)(a, t),
                    ),
                });
            };
        },
                        ...
                        (0, o.jsxs)('div', {
                            ...
                            children: [
                                (0, o.jsx)(c.Button, {
                                    ...
                                    icon: (0, o.jsx)(u.Icon, { variant: 'previous', size: 'xxs' }),
                                    onClick: w,
                                    ...(0, i.Am)(i.Kq.sonata.PREVIOUS_TRACK_BUTTON),
                                }),
                                C,
                                (0, o.jsx)(c.Button, {
                                    className: f().sonataButton,
                                    ...
                                    icon: (0, o.jsx)(u.Icon, { variant: 'next', size: 'xxs' }),
                                    onClick: I,
        ...
        61646: (e, t, a) => {
            ...
            let v = (0, n.PA)((e) => {
                    let {
                        ...
                        { experiments: B } = (0, r.Pjs)(),
                        M = B.checkExperiment(r.zal.WebNextPlayerBarYellowButton, 'on');
                    return (0, o.jsx)(x.a, {
                        onShuffleClick: C,
                        onRepeatClick: m,
                        ...
                        playButton: (0, o.jsx)(f.DM, {
                            ...
                            variant: 'filled',
                            isPlaying: n,
                            iconClassName: (0, _.$)(h().playButtonIcon, { [h().playButtonIcon_withYellowPlayButton]: M }),
                            onClick: p,
                        }),
                    });
                }),
                m = (0, n.PA)((e) => {
                    let { className: t, isMobile: a, entityMeta: n } = e,
                        ...
                        B = (0, l.c)(() => {
                            n && (null == f || f.togglePause(r.V_r.PROMO_LANDING), x(!C));
                        }),
                        M = (0, l.c)(() => {
                    ...
                    (0, s.useEffect)(
                        () => (
                            null == m || m.addShortcutsListener(r.Mo.PROMO_LANDING, r.lbr.TOGGLE_PLAY, B),
            ...
            let x = { mainAxis: 44 },
                N = (0, n.PA)((e) => {
                    ...
                    return (0, o.jsx)(p.a, {
                        ...
                        withShuffle: ((t || h) && !(null == A ? void 0 : A.isAdvertShown)) || !!k,
                        shuffle: v,
                        canMoveBackward: N,
                        canMoveForward: _,
                        onClickNext: m,
                        onClickPrev: C,
                        withRepeat: ((t || M) && !(null == A ? void 0 : A.isAdvertShown)) || !!P,
                        repeatMode: n,
                        className: S,
                        playButton: L,
                        onRepeatClick: I,
            ...
            let p = (e) => {
                ...
                return (0, o.jsx)(r.Button, {
                    ...
                    icon: (0, o.jsx)(c.Icon, {
                        variant: 'shuffle',
                        size: f,
                        className: (0, n.$)(d().shuffleIcon, { [d().shuffleIcon_disabled]: t, [d().shuffleIcon_on]: !t && a, [d().shuffleIcon_off]: !t && !a }),
                    }),
                    onClick: v,
                    ...(0, l.Am)(!a || t ? l.Kq.sonata.SHUFFLE_BUTTON : l.Kq.sonata.SHUFFLE_BUTTON_ON),
                });
            };
        },
        68342: (e, t, a) => {
            ...
            let i = () => {
                ...
                return (0, n.c)((n, i) => {
                    null !== n.entityMeta &&
                        ...
                        e((0, o.jsx)(l.NotificationShuffle, { shuffle: !!(null == a ? void 0 : a.getState(i).queueState.shuffle.value) }), {
                            containerId: t.modal.isOpened ? s.uQT.FULLSCREEN_INFO : s.uQT.INFO,
                        }));
                });
            };
        },
            ...
            let _ = (e) => {
                let { repeatMode: t, closeToast: a } = e,
                    ...
                    _ = (0, s.useMemo)(() => {
                        ...
                        switch (t) {
                            case i.pM.CONTEXT:
                                e = (0, o.jsx)(l.A, { id: 'notifications-info.change-repeat-context' });
                                break;
                            case i.pM.ONE:
                                e = (0, o.jsx)(l.A, { id: 'notifications-info.change-repeat-track' });
                                break;
                            case i.pM.NONE:
                            default:
                                e = (0, o.jsx)(l.A, { id: 'notifications-info.change-repeat-none' });
                        }
                        return (0, o.jsx)(c.Caption, { className: p().message, variant: 'div', type: 'controls', size: 'm', children: e });
                    }, [t]);
                return (0, o.jsx)(u.$W, {
                    cover: (0, o.jsx)(r.Icon, { className: (0, n.$)(p().icon, { [p().icon_unset]: t === i.pM.NONE }), size: 'xs', variant: d }),
                    message: _,
                    closeToast: a,
                    coverRadius: 's',
                });
