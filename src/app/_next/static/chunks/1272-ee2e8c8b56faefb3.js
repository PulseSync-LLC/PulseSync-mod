        ...
        14177: (e, t, r) => {
                    ...
                    5151: function (e, t, r) {
                        ...
                        (t.iconsCollectionBySize = {
                            ...
                            (t.iconsCollection = {
                                ...
                                trailer_xxs: eN.default,
                                unpin_xxs: eD.default,
                                upload_xxs: eT.default,
                                vibe_xxs: eM.default,
                                adult_xs: eU.default,
                                album_xs: eI.default,
                                arrowDown_xs: eV.default,
                                arrowLeft_xs: eB.default,
                                arrowRight_xs: eF.default,
                                cast_xs: eG.default,
                                chain_xs: eW.default,
                                check_xs: ez.default,
                                close_xs: eQ.default,
                                close_filled_xs: eK.default,
                                dislike_xs: eY.default,
                                disliked_xs: eZ.default,
                                exclamation_xs: eJ.default,
                                explicit_xs: eq.default,
                                filter_xs: eX.default,
                                ...
                                play_filled_xs: tk.default,
                                playlist_xs: tE.default,
                                ...
                                speed_2x_centered_m: rk.default,
                                ...
                                speed_1_75x_l: rS.default,
                                speed_1x_l: rN.default,
                                speed_2x_l: rD.default,
                                album_xl: rT.default,
                                clip_xl: rM.default,
                                note_xl: rU.default,
                                pause_filled_xl: rI.default,
                                picture_xl: rV.default,
                                play_filled_xl: rB.default,
                                playlist_xl: rF.default,
                                unavailable_xl: rG.default,
                                attention_xxl: rW.default,
                                check_xxl: rz.default,
                                next_xxl: rQ.default,
                                offline_xxl: rK.default,
                                pause_filled_xxl: rY.default,
                                play_filled_xxl: rZ.default,
                                previous_xxl: rJ.default,
                                search_xxl: rq.default,
                                attention_xxxl: rX.default,
                                bandlink: r$.default,
                                googlePlay: r1.default,
                                huaweiAppGallery: r0.default,
                                kinopoiskEn: r8.default,
                                kinopoiskRu: r2.default,
                                macos: r5.default,
                                musicLogo: r7.default,
                                musicLogoCenterEn: r3.default,
                                musicLogoCenterRu: r9.default,
                                musicLogoLeftEn: r4.default,
                                musicLogoLeftRu: r6.default,
                                pause: se.default,
                                play: st.default,
                                plus: sr.default,
                    ...
                    7743: function (e, t, r) {
                        ...
                        (t.CaptionComponent = (e) => {
                            ...
                            return (0, n.jsx)(l.Typography, {
                                variant: r,
                                ref: t,
                                className: (0, a.clsx)(o.default.root, o.default['root_'.concat(s, '_').concat(i)], o.default['root_weight_'.concat(x)], c),
                                ...u,
                                children: f,
                            });
                        }),
            ...
            let U = (0, i.PA)(() => {
                ...
                return (0, s.jsx)(N.W1, {
                    ...
                    withRipple: !1,
                    className: M().button,
                    label: (0, s.jsx)(D.n, { className: M().button, hasPlus: e.hasPlus }),
            ...
            let B = (0, i.PA)((e) => {
                let { className: t, variant: r = 'desktop', withMeta: i, metaClassName: o, usernameClassName: d, userIdClassName: _ } = e,
                    { user: p, location: g, settings: S, slam: N } = (0, O.g)(),
                    { theme: D, setTheme: T } = (0, h.W)(),
                    M = (0, E.N)(),
                    I = M.get(k.oo),
                    B = M.get(k.tw),
                    { getThemeFromStorage: F, setThemeToStorage: G } = (0, H.Q)(I),
                    [W, z] = (0, l.useState)(() => {
                        var e;
                        return null != (e = F()) ? e : R.W;
                    }),
                    {
                        passportCredentials: { origin: Q },
                    } = B,
                    K = (0, l.useRef)(null),
                    [Y, Z] = (0, l.useState)(0),
                    ...
                    el = (0, l.useMemo)(() => {
                        if (N.networkStatus.isOffline || N.isOfflineModeEnabled) return (0, s.jsx)(U, {});
                        let e = void 0 !== p.puid ? String(p.puid) : '';
                        return (0, s.jsx)(n.User, {
                            className: (0, a.$)(V().userId, _),
                            ...
                            dialogClassName: (0, a.$)(V().dialog, V()['dialog_'.concat(r)]),
                            retpath: g.href,
                            onMenuItemClick: en,
                            tld: g.tld,
                            preload: !0,
                ...
                return (0, s.jsxs)('div', {
                    ...
                    ref: K,
                    style: ei,
                    'data-test-id': x.OA.user.USER_PROFILE,
                    children: [
                        el,
                        i &&
                            (0, s.jsxs)('div', {
                                className: (0, a.$)(V().meta, o),
                                'data-test-id': x.OA.user.USER_PROFILE_META,
                                children: [
                                    (0, s.jsx)(m.HL, {
                                        variant: 'div',
                                        type: 'controls',
                                        size: 'm',
                                        weight: 'medium',
                                        className: (0, a.$)(V().userName, d),
                                        lineClamp: 1,
                                        'data-test-id': x.OA.user.USER_PROFILE_USERNAME,
                                    ...
                                    p.hasPlus &&
                                        (0, s.jsx)(A.N, {
                                            ...
                                            target: '_blank',
                                            className: V().plusLink,
                                            'data-test-id': x.OA.user.USER_PROFILE_PLUS_LINK,
                                            children: (0, s.jsx)(v, {
                                                'data-test-id': x.OA.user.USER_PROFILE_PLUS_BADGE,
        ...
        26490: (e, t, r) => {
            ...
            let a = (0, n.createContext)(null),
                i = () => {
                    ...
                    if (!e) throw new s.t('Equalizer cannot be null, please add a context provider', { code: 'E_CONTEXT_EQUALIZER_NULL' });
                    return e;
                };
        },
        34291: (e, t, r) => {
