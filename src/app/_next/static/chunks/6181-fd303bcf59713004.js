    ...
    [6181],
    {
        ...
        10160: (e, r, n) => {
            Promise.resolve().then(n.bind(n, 21153)),
                ...
                Promise.resolve().then(n.bind(n, 65106)),
                Promise.resolve().then(n.bind(n, 54024)),
                Promise.resolve().then(n.bind(n, 37376)),
                Promise.resolve().then(n.bind(n, 53887)),
                Promise.resolve().then(n.bind(n, 99746)),
        ...
        36118: (e, r, n) => {
            ...
            let c = (0, s.PA)((e) => {
                ...
                return (0, o.jsxs)('div', {
                    className: (0, i.$)(u().root, r),
                    children: [
                        n &&
                            (0, o.jsx)(P.Lh, {
                                withBackwardFallback: '/',
                                className: (0, i.$)(u().navigation, { [u().navigation_desktop]: !p }),
                                withForwardControl: !1,
                            }),
                        (0, o.jsxs)('div', {
                            className: (0, i.$)(u().content, { [u().content_shrink]: !n }),
                            children: [
                                (0, o.jsx)(v.Icon, { className: u().icon, variant: 'attention', size: 'xxl' }),
                                (0, o.jsx)(h.Heading, { className: (0, i.$)(u().title, u().important), variant: 'h3', size: 'xs', children: a }),
                                (0, o.jsxs)(h.Caption, {
        ...
        55551: (e, r, n) => {
                ...
                t = {
                    6699: (e, r, n) => {
                        ...
                        r.useDebouncedToggle = (e) => {
                            let { delay: r, initialState: n, throttleTimeout: s } = e,
                                t = (0, i.useRef)(null),
                                [l, d] = (0, i.useState)(!!n),
                                m = (0, i.useMemo)(
                                    () =>
                                ...
                                v = (0, i.useCallback)(() => {
                                    d(!!n), t.current && window.clearTimeout(t.current);
                                }, [n]);
                            return (
                                (0, i.useEffect)(
                                    () => () => {
                                ...
                                { state: l, handleDebouncedToggle: m, reset: v }
                            );
                        };
                    },
                    2767: (e, r, n) => {
                        Object.defineProperty(r, '__esModule', { value: !0 }), (r.useForceUpdateRef = void 0);
                        let o = n(810);
                        r.useForceUpdateRef = () => {
                    ...
                    2067: (e, r, n) => {
                        Object.defineProperty(r, '__esModule', { value: !0 }), (r.useScroll = void 0);
                        let o = n(810),
                            i = n(361),
                            s = n(6699);
                        r.useScroll = (e) => {
                            let { onScroll: r, listenIsScrolling: n, elementRef: t } = e,
                                { state: l, handleDebouncedToggle: d } = (0, s.useDebouncedToggle)({ delay: 1e3, throttleTimeout: 100 }),
                                m = (0, o.useCallback)(() => {
                                    n && d(), null == r || r();
                                }, [n, d, r]);
                            return (
                                (0, o.useEffect)(() => {
                                    let e = (0, i.getElementFromRefOrElement)(t);
                                    if (null === e) return;
                                    let r = null != e ? e : window,
                                        n = { capture: !0, passive: !0 };
                                    return r.addEventListener('scroll', m, n), () => r.removeEventListener('scroll', m, n);
                                }, [t, m]),
                                l
                            );
                        };
            ...
            function d(e) {
                ...
                var n = (l[e] = { exports: {} });
                return t[e](n, n.exports, d), n.exports;
            }
            var m = {};
            (() => {
                Object.defineProperty(m, '__esModule', { value: !0 }), (m.useElementOffsetY = void 0);
                let e = d(810),
                    r = d(2067),
                    n = d(2767);
                m.useElementOffsetY = (o) => {
                    let [i, s] = (0, n.useForceUpdateRef)(),
                        [t, l] = (0, e.useState)(),
                        d = (0, e.useCallback)(() => {
                            let e = null == i ? void 0 : i.getBoundingClientRect();
                            e && l(e.y);
                        }, [i]);
                    return (0, e.useLayoutEffect)(d), (0, r.useScroll)({ onScroll: d, elementRef: o }), { forceUpdateRefCallback: s, offsetY: t };
                };
            })(),
                m.__esModule;
            var v = m.useElementOffsetY;
        },
        57249: (e, r, n) => {
            'use strict';
