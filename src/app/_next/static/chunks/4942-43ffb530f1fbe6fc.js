                ...
                u = {
                    ...
                    4490: (e, t, r) => {
                        ...
                        function b(e) {
                            ...
                            for (p in ((h.current = Object.assign({}, m.current)), (m.current = Object.assign(Object.assign({}, s), e)), s))
                                        ...
                                        let r = (t) => {
                                                ...
                                                (r && t.touches.length > 1) ||
                                                    e((e, l) => {
                                                        ...
                                                        return (
                                                            ...
                                                            Object.assign(Object.assign(Object.assign({}, e), i), { initial: a.slice(), xy: a, start: t.timeStamp || 0 })
                                                        );
                                                    });
                                            },
                                            n = (t) => {
                                                e((e, r) => {
                                                    ...
                                                    let { clientX: p, clientY: v } = b ? t.touches[0] : t,
                                                        ...
                                                        j = [h / (w || 1), O / (w || 1)],
                                                        T = ((n = y), (i = S), (c = h), (f = O), n > i ? (c > 0 ? o : l) : f > 0 ? a : u),
                                                        P = 'number' == typeof r.delta ? r.delta : r.delta[T.toLowerCase()] || s.delta;
                                                    if (y < P && S < P && !e.swiping) return e;
                                                    let R = {
                                                        absX: y,
                                                        absY: S,
                                                        deltaX: h,
                                            ...
                                            v = (e, t) => {
                                                ...
                                                if (e && e.addEventListener) {
                                                    let o = Object.assign(Object.assign({}, s.touchEventOptions), t.touchEventOptions),
                                                        u = [
                                                            ['touchstart', r, o],
                    ...
                    5969: (e, t, r) => {
                        ...
                        (t.findOptimalFontSize = (e) => {
                            ...
                            (t.useDynamicText = (e, r, l) => {
                                let { minFontSize: o, maxFontSize: u, lineHeight: a, maxLines: s, fallbackMaxLines: i } = r;
                                (0, n.useLayoutEffect)(() => {
                                    if (null === e) return;
                                    ...
                                    let r = () => {
                                            ...
                                            let { maxLines: f, fontSize: d } = ((e) => {
                                                let { fallbackMaxLines: r, maxLines: n, minFontSize: l } = e,
                                                    o = (0, t.findOptimalFontSize)({ ...e, maxLines: n });
                                                return void 0 === r || o >= l
                                                    ? { maxLines: n, fontSize: o }
                    ...
                    5663: (e, t, r) => {
                        ...
                        (t.defaultOptions = { threshold: 0, preflightCheck: !0 }),
                            ...
                            (t.useIntersectionObserver = function (e, r, l) {
                                let [{ freezeOnceVisible: o, preflightCheck: i, ...c }, f = !1] =
                    ...
                    4395: (e, t, r) => {
                        ...
                        t.usePopoverSwipeable = (e) => {
                            let { ref: t, swipeableProps: r = {}, onClose: o, disableSwipe: u, placement: a, threshold: s } = e,
                                i = (0, n.useMemo)(() => {
                                    switch (a) {
                                        case 'top':
                                        case 'top-end':
                            ...
                            return (0, l.useComponentSwipeable)({ ref: t, swipeableProps: r, onClose: o, disableSwipe: u, placement: i, threshold: s });
                        };
                    },
                    2947: (e, t, r) => {
                        ...
                        let l = r(4377),
                            ...
                            d = (e) => {
                                let { children: t, className: r, forwardRef: n, scrollableContainerRef: d, containerClassName: b, scrollContentClassName: p, ...v } = e,
                                    { state: g, toggleTrue: m, toggleFalse: h } = (0, s.useToggle)(!1),
                                    O = (0, a.useForwardRef)(d, null),
                                    y = (0, u.useRef)(null),
                                    {
                                        ...
                                        handleWheelEvent: E,
                                        isScrolling: j,
                                    } = (0, i.useScrollableContainer)({ containerRef: O, contentRef: y });
                                return (0, l.jsxs)('div', {
                    ...
                    7758: function (e, t, r) {
                        ...
                        t.OverlayScrollbar = (e) => {
                            ...
                            return (
                                ...
                                (0, i.useScrollbarWheel)(v, d),
                                (0, l.jsx)('div', {
                                    className: (0, o.clsx)(c.default.root, { [c.default.root_visible]: n, [c.default.root_dragging]: w }, t),
                                    style: { '--scrollbar-overlay-thumb-size': ''.concat(h, 'px'), '--scrollbar-overlay-thumb-offset': ''.concat(y, 'px') },
                                    ref: v,
                    ...
                    7534: (e, t, r) => {
                        ...
                        t.useScrollableContainer = (e) => {
                            let { containerRef: t, contentRef: r } = e,
                                ...
                                i = (0, l.useMemo)(() => (0, n.throttle)(s, 100), [s]),
                                c = (0, l.useCallback)(
                                    (e) => {
                                        let r = t.current;
                                        if (!r) return;
                            ...
                            return (
                                ...
                                (0, o.useResize)(i, r),
                                {
                                    ...
                                    scrollToRelative: c,
                                    handleWheelEvent: f,
                                    isScrolling: (0, o.useScroll)({ onScroll: s, elementRef: t, listenIsScrolling: !0 }),
                                }
                            );
                        };
                    },
