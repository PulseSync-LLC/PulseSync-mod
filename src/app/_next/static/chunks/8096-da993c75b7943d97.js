(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [8096],
    {
        ...
        27191: (e) => {
            e.exports = { root: 'PlaylistFiltersShimmer_root__dFSKz', shimmer: 'PlaylistFiltersShimmer_shimmer__7myrt' };
        },
        34240: (e) => {
            e.exports = {
        ...
        46369: (e, t, a) => {
            ...
            let s = (e) => {
                let [t, a] = e.split(':');
                return { type: i.z4.Unloaded, meta: { id: String(t), albumId: a } };
            };
            var r = a(75651),
                n = a(41028),
                o = a(2865),
            ...
            let u = n.gK.model('PlaylistItem', {
                    ...
                    albumId: n.gK.maybeNull(n.gK.union(n.gK.string, n.gK.number)),
                    key: n.gK.string,
                    data: n.gK.maybeNull(d.vj),
                    loadingState: n.gK.enumeration(Object.values(c.GuX)),
                }),
                m = n.gK.model('PlaylistFiltersItem', { id: n.gK.string, name: n.gK.string, tracks: n.gK.array(u), unloadedTracks: n.gK.maybe(n.gK.array(o.x6)) });
            var g = a(88233);
            a(94615);
        },
        48708: (e, t, a) => {
        ...
        84684: (e, t, a) => {
            ...
            let I = (0, s.PA)(
                (0, n.forwardRef)((e, t) => {
                    ...
                    return (0, l.jsx)('div', {
                        ...
                        ...o,
                        className: k().root,
                        children: (0, l.jsx)('div', { className: (0, i.$)(k().inner, { [k().dragging]: c }), ...u, ...P, children: s }),
                    });
                }),
            );
            var b = a(72454),
            ...
            let B = (0, s.PA)((e) => {
                    ...
                    let v = [],
                        ...
                        _ = null == (r = o.data) || null == (s = r.albums) || null == (i = s[0]) ? void 0 : i.genre;
                    if ((P && v.push('№'.concat(P)), u && h)) {
                        let e = d.editorFeature.getColorForMajor(h),
                            t = (0, l.jsx)('span', { className: w().major, style: { '--major-color': e }, children: h });
                        v.push(t);
                    }
                    if ((m && _ && v.push(_), !v.length)) return null;
                    let f = v.map((e, t, a) => (0, l.jsxs)(n.Fragment, { children: [e, t < a.length - 1 && '; '] }, t));
                    return (0, l.jsxs)(D.Caption, { className: w().root, type: 'entity', size: 'm', weight: 'medium', variant: 'span', children: ['[', f, '] \xa0'] });
                }),
                R = (0, s.PA)((e) => {
                    let { item: t, track: a, withDNDBlock: i, isDragging: s, draggingClassName: r, from: n, utmLink: o, index: d, className: c } = e,
                        { playlist: u, sonataState: m } = (0, p.Pjs)(),
                        { removeTrackFromPlaylist: g, canRemoveTrackFromPlaylist: y } = (0, F.sR)();
                    return (0, l.jsx)(F.Kd, {
                        ...
                        draggingClassName: r,
                        playContextParams: {
                            contextData: { type: C.K.Playlist, meta: u.contextMeta, from: n, utmLink: o },
                ...
                K = (0, s.PA)((e) => {
                    let { item: t, track: a, withDNDBlock: s, isDragging: r, draggingClassName: n, from: o, utmLink: d, index: c, className: u } = e,
                        { playlist: m, sonataState: g } = (0, p.Pjs)(),
                        { removeTrackFromPlaylist: y, canRemoveTrackFromPlaylist: P } = (0, F.sR)();
                    return (0, l.jsx)(F.Kt, {
                        beforeTitle: (0, l.jsx)(B, { item: t }),
                        withDNDBlock: s,
                        isDragging: r,
                        ...
                        activeFilterIndex: m.filters.analyticsParamsActiveFilterIndex,
                        className: (0, i.$)(u, { [L().isDuplicate]: m.editorFeature.shouldHighlightDublicatedTrack(t) }),
                    });
                }),
                U = (0, s.PA)((e) => {
                    var t, a, s;
                    ...
                    return (
                        (r =
                            h && h.data && u.meta
                                ? h.data.isTrackNonMusic || (null == (s = h.data.mainAlbum) ? void 0 : s.isNonMusic)
                                    ? (0, l.jsx)(R, {
                                          item: h,
                                          withDNDBlock: v,
                                          isDragging: d,
                                    ...
                                    : (0, l.jsx)(K, {
                                          ...
                                          isDragging: d,
                                          draggingClassName: c,
                                          className: (0, i.$)(o, { [L().isDuplicate]: u.editorFeature.shouldHighlightDublicatedTrack(h) }),
                                      })
                                : (0, l.jsx)(y.DS, { isActive: !0, className: L().shimmerItem, variant: p.Xjt.PLAYLIST })),
                        (0, l.jsx)(T.xG.Provider, { value: { playlist: u.meta, trackIndex: n }, children: r })
                    );
                });
            var M = a(42218),
                Y = a.n(M);
            let O = (0, s.PA)((e) => {
                        ...
                        return (0, n.useCallback)(
                            async (i) => {
                                ...
                                let g = await (null == (o = e.meta)
                                    ? void 0
                                    : o.changePlaylist((0, T.Mp)({ operation: T.yC.MOVE, startPosition: d, endPosition: c, tracks: [{ id: u, albumId: m }] })));
                                (g && g === T.Y9.OK) ||
                                    (g === T.Y9.RELOAD ? e.refresh() : e.moveTrack(c, d),
                                    t((0, l.jsx)(y.hT, { error: a({ id: 'drag-and-drop.failed-to-move' }) }), { containerId: p.uQT.ERROR }));
                            },
                            [a, t, e],
                        );
                    })(a),
                ...
                return a.isDragAndDropEnabled
                    ? (0, l.jsxs)(b.Mp, {
                          ...
                          children: [
                              (0, l.jsx)('div', { className: Y().root, children: (0, l.jsx)(f.gB, { items: a.itemsKeys, strategy: f._G, children: t }) }),
                              (0, S.createPortal)(
                                  (0, l.jsx)(b.Hd, {
                                      dropAnimation: { duration: 0 },
                                      children: d
                                          ? (0, l.jsx)('div', {
                                                className: Y().draggableItemWrapper,
                                                children: (0, l.jsx)(U, { index: P, className: Y().noHoverItem, isDragging: !0, draggingClassName: Y().dots }),
                                            })
                                          : null,
                                  }),
            ...
            let V = (0, s.PA)((e) => {
                ...
                return (0, l.jsxs)('div', {
                    ...
                    children: [
                            ...
                            children:
                                ...
                                (0, l.jsx)(p.FoH, {
                                    ...
                                    children: (0, l.jsx)($.EC, {
                                        ...
                                        headerClassName: (0, i.$)(W().carouselBlockHeader, W().carouselBlock),
                        ...
                        (0, l.jsx)(y.A, { children: (0, l.jsx)(y.wi, { className: W().footer }) }),
                    ],
                });
            });
            var Q = a(74837),
            ...
            let X = (e) => {
                let { item: t, from: a, tracks: l } = e,
                    i = l
                        ...
                        .filter((e) => e);
                return {
                    contextData: { type: C.K.Various, meta: { id: t.entityId }, from: a },
            ...
            let ee = (0, s.PA)((e) => {
                ...
                let { autoFocus: P, className: v } = e,
                    ...
                    x = (0, F.Rg)(),
                    k = (0, n.useRef)(0),
                    I = (null == (t = _.meta) ? void 0 : t.isOwnPlaylist) ? p._Q$.OWN_PLAYLISTS : p._Q$.PLAYLIST,
                    { from: b } = (0, p.fyy)({ pageId: I, blockId: p.UfI.FILTERED }),
                    { from: j } = (0, p.fyy)({ pageId: I, blockId: p.UfI.SUGGESTED }),
                    [S, N] = (0, n.useState)(!1);
                (0, n.useEffect)(
                    () => () => {
                ...
                let A = (0, n.useMemo)(
                    ...
                    L = (0, n.useCallback)(
                        async (e) => {
                            if (_.meta) {
                                ...
                                let t = x({ track: e, playlist: _.meta, withSuccessNotification: !1, withPageRefresh: !1 }),
                                    a = new Promise((e) => {
                                        k.current = window.setTimeout(e, 300);
                                    }),
                                    [l] = await Promise.all([t, a]);
                                l === T.Y9.OK ? (f.replaceAdditionTrackInProggress(), N(!0)) : f.resetAdditionTrackAnimation();
                            }
                        },
                        [x, _.meta, f],
                    ),
                    E = (0, n.useMemo)(() => {
                        var e;
                        return f.isLoading
                            ? (0, l.jsx)(y.DS, { isActive: !0, className: J().shimmerItem, variant: p.Xjt.PLAYLIST })
                                        ...
                                        ? e.isTrackNonMusic
                                            ? (0, l.jsx)(
                                                  F.Kd,
                                                  {
                                                      withPodcastName: !0,
                                                      track: e,
                                                      playContextParams: X({ item: e, from: b, tracks: f.playlistTracks }),
                                                      className: (0, i.$)(J().track, { [J().appearingTrack]: e.id === f.additionTrackInProggress }),
                                                  },
                                                  e.id,
                                              )
                                            : (0, l.jsx)(
                                  ...
                                  : t.map((e) =>
                                        e
                                            ? (0, l.jsx)(
                                                  ...
                                                  {
                                                      track: e,
                                                      className: (0, i.$)({ [J().disappearingTrack]: e.id === f.additionTrackInProggress }),
                                                      playContextParams: ((e, t) => ({
                                                          contextData: { type: C.K.Various, meta: { id: e.entityId }, from: t },
                    ...
                    }, [null == (a = _.meta) ? void 0 : a.canUserChange, f.isLoading, f.suggestedTracks, f.additionTrackInProggress, j, L]),
                    B = (0, n.useMemo)(() => {
                        var e, t, a;
                        let i = !(null == (e = f.suggestedTracks) ? void 0 : e.length) || !(null == (t = _.meta) ? void 0 : t.canUserChange);
                        return (null == (a = f.playlistTrackIds) ? void 0 : a.length) || !i || f.isLoading
                            ? null
                            : (0, l.jsx)($.pA, { className: J().emptyBlockContainer, isEmptySearch: !0 });
                    }, [
                ...
                return (0, l.jsxs)(l.Fragment, {
                    children: [
                        (0, l.jsx)(q.D, {
                            ...
                            innerInputProps: (0, d.Am)(d.e8.searchPlaylist.SEARCH_PLAYLIST_INPUT),
                            resetButtonProps: (0, d.Am)(d.e8.searchPlaylist.SEARCH_PLAYLIST_INPUT_RESET_BUTTON),
                            searchIconProps: (0, d.Am)(d.e8.searchPlaylist.SEARCH_PLAYLIST_INPUT_ICON),
                        ...
                        f.text &&
                            (0, l.jsxs)('div', {
                                ...
                                children: [
                                    B,
                                    E,
                                    Number(null == (u = f.suggestedTracks) ? void 0 : u.length) > 0 &&
                                        (null == (m = _.meta) ? void 0 : m.canUserChange) &&
                                        (0, l.jsx)(
                                            D.Heading,
                                            {
                                                variant: 'h3',
                                                className: (0, i.$)(J().catalog, { [J().catalog_withTracks]: null == (g = f.playlistTrackIds) ? void 0 : g.length }),
            ...
            let er = (0, s.PA)((e) => {
                ...
                return (0, l.jsx)(m.jr, {
                    child: (0, l.jsx)(el.AI, { className: es().stickyFilters, tabsState: r, handleFilterClick: g, ref: i, isSticky: !0 }),
            ...
            let ed = (0, s.PA)(() => {
                    ...
                    return t.checkExperiment(p.zal.WebNextDisableAds, 'on')
                        ? null
                        : (0, l.jsx)('div', {
                              className: (0, i.$)({ [eo().brandedPlaylistBannerWrapper]: a.isEnabled }),
                              style: null == (e = a.data) ? void 0 : e.style,
                              children: (0, l.jsx)(g.Zr, { creativeClassName: eo().creative }),
                          });
                }),
                ec = (0, s.PA)((e) => {
                    var t;
                    ...
                    if (0 !== r.length) return (0, l.jsx)('div', { className: a, children: r.map((e, t) => (0, l.jsx)(F.yY, { track: e }, t)) });
                });
            var eu = a(92352),
                em = a.n(eu);
            let eg = (0, s.PA)((e) => {
                    ...
                    a.isLoading || !a.meta || a.isRejected)
                        ...
                        : (0, l.jsxs)(l.Fragment, {
                              children: [
                                  (0, l.jsx)(ed, {}),
                                  (0, l.jsx)(Q.Jq, {
                                      className: (0, i.$)(em().header, { [em().header_branded]: s.isEnabled }),
                                      playlist: a.meta,
                                      isDisabled: a.isDisabled,
                                      ref: t,
                                  }),
                                  (0, l.jsx)(ee, { autoFocus: !!(!a.items.length || a.search.isFocused) }),
                                  a.isFiltersAvailable && (0, l.jsx)(er, { playlist: a }),
                                  (0, l.jsx)(ec, { className: em().content }),
                                  a.shouldShowEmptyBlock && (0, l.jsx)($.pA, { className: em().emptyPlaylist }),
                              ],
                          });
                }),
                ep = (0, s.PA)((e) => {
                    var t, a, s, h, f;
                    let { userId: x, kind: k, playlistUuid: b, preloadedPlaylistByUuid: j, isWebNextNavigationOn: S } = e,
                        {
                            playlist: N,
                            settings: { isMobile: T },
                        } = (0, p.Pjs)(),
                        { formatMessage: C } = (0, o.A)(),
                        { contentScrollRef: A, setContentScrollRef: L } = (0, p.gKY)(),
                        { forceUpdateRefCallback: F, offsetY: D } = (0, c.G)(A),
                        E = (0, p.OQH)(N.analyticsParams),
                        w = (0, p.vXf)(N.analyticsParams),
                        B = (0, p.ytd)(null == N || null == (t = N.meta) ? void 0 : t.averageColor),
                        R = (0, n.useMemo)(() => {
                            var e;
                            ...
                            (0, n.useEffect)(() => {
                                ...
                                let t = ((e) => {
                                    ...
                                    return {
                                        ...
                                        snapshot: 0,
                                        trackCount: p.length,
                                        cover: { uri: (null == (n = e.meta) ? void 0 : n.coverUri) || '', prefix: '', type: 'from-album-cover', custom: !1 },
                                        playlistUuid: (null == (o = e.meta) ? void 0 : o.uuid) || '',
                                        available: (null == (d = e.meta) ? void 0 : d.isAvailable) || !0,
                                        visibility: (null == (c = e.meta) ? void 0 : c.visibility) || P.L.PUBLIC,
                                ...
                                (0, v.C)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                    (0, p.jxB)(e);
                                });
                    ...
                    if (
                        (N.isNeededToLoad &&
                            ('string' == typeof b
                                ? (0, n.use)(N.getPlaylistByUuid({ playlistUuid: b, resumeStream: !1, preloadedPlaylist: j }))
                                : 'string' == typeof x &&
                                  'string' == typeof k &&
                                  (0, n.use)(N.getPlaylistByUserIdAndKind({ userId: x, playlistKind: Number(k), resumeStream: !1 }))),
                    ...
                    return (0, l.jsx)(m.hO, {
                        ...
                        children: (0, l.jsxs)('div', {
                            ...
                            children: [
                                ...
                                !Q.isEnabled && (0, l.jsx)('div', { className: _().averageColorBackground, style: K }),
                                (0, l.jsx)(O, {
                                    playlist: N,
                                    children: (0, l.jsx)(y.$$, {
                                        context: {
                                            listAriaLabel: C(
                                                ...
                                                { playlistName: (null == (h = N.meta) ? void 0 : h.title) || '' },
                                            ),
                                        },
                                        className: (0, i.$)(_().root, _().important),
                                        listClassName: _().content,
                                        customComponents: Y,
                                        computeItemKey: N.isDragAndDropEnabled ? H : W,
                                        totalCount: N.virtualListItemsCount,
                                        itemContentCallback: (e) => (0, l.jsx)(U, { index: e }),
                                        onGetDataByRange: $,
                                        debounceDurationInMs: 300,
                                        initialItemCount: null == (f = N.items) ? void 0 : f.length,
                                        handleRef: L,
                ...
                ey = (0, s.PA)((e) =>
                    (0, l.jsx)(g.te, { children: (0, l.jsx)(p.nVz, { pageId: p._Q$.PLAYLIST, pageEntityId: e.playlistUuid, children: (0, l.jsx)(ep, { ...e }) }) }),
                );
        },
        88233: (e, t, a) => {
            'use strict';
            ...
            var l = a(33008),
                ...
                c = a(20149),
                u = a.n(c);
            let m = { [n.u40.Desktop]: { start: 40, end: 20 }, [n.u40.Mobile]: { start: 40, end: 40 } },
                g = { [n.u40.Desktop]: { start: 40, end: 20 }, [n.u40.Mobile]: { start: 20, end: 50 } },
                p = (0, s.PA)((e) => {
                    let { tabsState: t, handleFilterClick: a, className: s, forwardRef: c, carouselClassName: p, isSticky: y } = e,
                        {
                            playlist: P,
                            settings: { isMobile: v },
                        } = (0, n.Pjs)(),
                        { playlistStickyFiltersRef: h, playlistStaticFiltersRef: _, contentScrollRef: f } = (0, n.gKY)(),
                        x = (0, r.useMemo)(() => {
                            var e;
                            return (0, l.jsx)(o.wI, {
                                ref: c,
                                    ...
                                    null == (e = P.filters.items)
                                        ...
                                        : e.map((e, a) =>
                                              (0, l.jsx)(
                                                  ...
                                                  {
                                                      tabIndex: y ? -1 : 0,
                                                      className: (0, i.$)(u().filter, { [u().filter_selected]: a === t.value }),
                                                      title: e.name,
                                                      value: a,
                                                  },
                                                  a,
                        ...
                        I = (0, r.useCallback)(() => {
                            _ && h && (h.classList.add(u().carousel_noSmooth), (h.scrollLeft = _.scrollLeft), h.classList.remove(u().carousel_noSmooth));
                        }, [_, h]),
                        [b, j] = (0, r.useState)(!1);
                    (0, r.useEffect)(() => {
                        b && I();
                    ...
                    let S = (0, r.useCallback)(() => {
                        j((null == h ? void 0 : h.checkVisibility({ checkOpacity: !0 })) || !1);
                    }, [h]);
                    return ((0, r.useEffect)(() => {
                        ...
                        return (
                            y
                                ? (null == h || h.addEventListener('scroll', k, t), null == h || h.addEventListener('resize', k, t))
                                : v
                                  ? (window.addEventListener('scroll', S, t), window.addEventListener('resize', S, t))
                                  : (null == f || f.addEventListener('scroll', S, t), null == f || f.addEventListener('resize', S, t)),
                            () => {
                                e.abort();
                            }
                        );
                    ...
                    P.filters.isShimmerVisible)
                        ...
                        : P.filters.items && 0 !== P.filters.items.length && P.search.isNeededToLoad
                          ? (0, l.jsx)(o.FY, { className: s, carouselElement: x, ref: c, scrollPadding: y ? g : m })
                          : void 0;
                }),
                y = (0, r.forwardRef)((e, t) => (0, l.jsx)(p, { forwardRef: t, ...e }));
        },
        88834: (e) => {
            e.exports = {
        ...
        94615: (e, t, a) => {
            ...
            let d = (0, s.PA)((e) => {
                ...
                return (0, l.jsx)(r.wI, {
                    ...
                    isShimmerVisible: !0,
                    value: 0,
                    shimmer: (0, l.jsx)(r.zr, { className: o().root, shimmerClassName: o().shimmer, count: 3 }),
                });
            });
        },
    },
