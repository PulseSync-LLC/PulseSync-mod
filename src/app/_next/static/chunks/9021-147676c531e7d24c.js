                ...
                i = {
                    ...
                    4490: (e, t, r) => {
                        ...
                        function d(e) {
                            ...
                            for (_ in ((m.current = Object.assign({}, g.current)), (g.current = Object.assign(Object.assign({}, o), e)), o))
                                void 0 === g.current[_] && (g.current[_] = o[_]);
                            let [k, E] = s.useMemo(
                                () =>
                                    (function (e, t) {
                                        let r = (t) => {
                                                ...
                                                (r && t.touches.length > 1) ||
                                                    e((e, n) => {
                                                        n.trackMouse && !r && (document.addEventListener(f, s), document.addEventListener(u, _));
                                            ...
                                            s = (t) => {
                                                e((e, r) => {
                                                    ...
                                                    let { clientX: _, clientY: p } = d ? t.touches[0] : t,
                                                        [v, g] = x([_, p], r.rotationAngle),
                                                        m = v - e.xy[0],
                                                        k = g - e.xy[1],
                                                        E = Math.abs(m),
                                                        y = Math.abs(k),
                                                        b = (t.timeStamp || 0) - e.start,
                                                        w = Math.sqrt(E * E + y * y) / (b || 1),
                                                        O = [m / (b || 1), k / (b || 1)],
                                                        R = ((s = E), (c = y), (f = m), (u = k), s > c ? (f > 0 ? a : n) : u > 0 ? l : i),
                                                        j = 'number' == typeof r.delta ? r.delta : r.delta[R.toLowerCase()] || o.delta;
                                                    if (E < j && y < j && !e.swiping) return e;
                                                    let h = {
                                                        absX: E,
                                                        absY: y,
                                                        deltaX: m,
                                            ...
                                            _ = (e) => {
                                                document.removeEventListener(f, s), document.removeEventListener(u, _), d(e);
                                            },
                                            p = (e, t) => {
                                                let n = () => {};
                                    ...
                                    r.trackTouch && t.el
                                        ? t.cleanUpTouch
                                            ? r.preventScrollOnSwipe !== d.preventScrollOnSwipe || r.touchEventOptions.passive !== d.touchEventOptions.passive
                                                ? (t.cleanUpTouch(), Object.assign(Object.assign({}, t), { cleanUpTouch: E(t.el, r) }))
                                                : t
                                            : Object.assign(Object.assign({}, t), { cleanUpTouch: E(t.el, r) })
                        ...
                        (t.findOptimalFontSize = (e) => {
                            ...
                            (t.useDynamicText = (e, r) => {
                                (0, s.useLayoutEffect)(() => {
                                    ...
                                    let s = () => {
                                            let { width: s, height: n } = e.getBoundingClientRect(),
                                                a = e.childNodes.length > 0;
                                            if (0 === s || 0 === n || !a) return;
                                            let i = (0, t.findOptimalFontSize)({ container: e, containerWidth: s, containerHeight: n, ...r });
                                            e.style.setProperty('--dynamic-font-size', ''.concat(i, 'px'));
                                        },
                        ...
                        Object.defineProperty(t, '__esModule', { value: !0 }),
                            ...
                            (t.createRipple = function (e, t, r) {
                                ...
                                (n.style.width = ''.concat(a, 'px')),
                                    ...
                                    n.classList.add(t);
                                let f = s.getElementsByClassName(t)[0];
                                f && f.remove(), s.insertBefore(n, s.firstChild);
                            });
                    },
                    361: (e, t) => {
                        Object.defineProperty(t, '__esModule', { value: !0 }),
                        ...
                        let n = r(4377),
                            ...
                            c = (e) => {
                                let {
                                    ...
                                    M = 'left' === s,
                                    S = null,
                                    L = (0, a.isValidElement)(_);
                                if (d) {
                                    var C, T;
                                    S = (0, a.cloneElement)(d, {
                                        className: (0, i.clsx)(
                                            o.default.icon,
                                            {
                                                [o.default['icon_position_'.concat(s)]]: s && !P,
                                                [o.default.icon_withButtonSize]: !(null == (C = d.props) ? void 0 : C.size),
                                            },
                                            null == (T = d.props) ? void 0 : T.className,
                                            R,
                                        ),
                                        key: H,
                                    });
                                }
                                let D = (0, a.useMemo)(() => (L ? (0, n.jsx)('div', { className: o.default.spinnerContainer, children: _ }) : null), [L, _]),
                                    F = (0, a.useCallback)(
                                        (e) => {
                                            L || (y && (0, l.createRipple)(e, o.default.ripple), null == v || v(e));
                                        },
                                        [L, v, y],
                                    );
                                return (0, n.jsx)('button', {
                                    ...
                                    className: (0, i.clsx)(
                                        o.default.root,
                                        o.default['root_'.concat(u, '_').concat(E)],
                                        o.default['root_radius_'.concat(g)],
                                        o.default.root_size,
                                        {
                                            [o.default['root_'.concat(u, '_withHover_').concat(E)]]: b && !O && !L,
                                            ...
                                            [o.default.root_icon_left]: d && !P && M,
                                            [o.default.root_icon_right]: d && !P && !M,
                                        },
                                        f,
                                    ),
                                    type: k,
                                    ...
                                    children:
                                        d || L
                                            ? (0, n.jsxs)('span', {
                                                  className: (0, i.clsx)(o.default.contentContainer, { [o.default.contentContainer_block]: r }, j),
                                                  children: [d && M && S, !P && c, d && !M && S, D],
                                              })
                                            : c,
                                });
                            };
                    ...
                    5151: function (e, t, r) {
                        ...
                        (t.iconsCollectionBySize = {
                            ...
                            (t.iconsCollection = {
                                ...
                                edit_xxs: z.default,
                                exclamation_xxs: N.default,
                                explicit_xxs: V.default,
                                eye_crossed_xxs: U.default,
                                filter_xxs: Y.default,
                                info_xxs: W.default,
                                lightning_xxs: q.default,
                                like_xxs: G.default,
                                likeVariant_xxs: X.default,
                                liked_xxs: Q.default,
                                likedVariant_xxs: Z.default,
                                link_xxs: K.default,
                                link_rounded_xxs: J.default,
                                lock_xxs: $.default,
                                ...
                                trailer_xxs: eO.default,
                                unpin_xxs: eR.default,
                                upload_xxs: ej.default,
                                vibe_xxs: eh.default,
                                adult_xs: eH.default,
                                album_xs: eP.default,
                                arrowDown_xs: eM.default,
                                ...
                                dislike_xs: eA.default,
                                disliked_xs: eB.default,
                                exclamation_xs: eI.default,
                                explicit_xs: ez.default,
                                filter_xs: eN.default,
                                fullscreen_xs: eV.default,
                                like_xs: eU.default,
                                liked_xs: eY.default,
                                ...
                                navigationForYouAndTrends_xs: eZ.default,
                                navigationKids_xs: eK.default,
                                navigationMyVibe_xs: eJ.default,
                                ...
                                note_xs: e2.default,
                                pause_xs: e3.default,
                                pause_filled_xs: e5.default,
                                picture_xs: e7.default,
                                pin_xs: e6.default,
                                pin_filled_xs: e4.default,
                                play_xs: te.default,
                                ...
                                speed_1_75x_centered_xs: tp.default,
                                ...
                                explicit_s: tP.default,
                                likedVariant_s: tM.default,
                                note_s: tS.default,
                                pauseVibe_s: tL.default,
                                picture_s: tC.default,
                                playVibe_s: tT.default,
                                playlist_s: tD.default,
                                collections_m: tF.default,
                                collections_selected_m: tA.default,
                                history_m: tB.default,
                                home_m: tI.default,
                                home_selected_m: tz.default,
                                kids_m: tN.default,
                                kids_selected_m: tV.default,
                                like_m: tU.default,
                                liked_m: tY.default,
                                lock_m: tW.default,
                                more_m: tq.default,
                                non_music_m: tG.default,
                                non_music_selected_m: tX.default,
                                note_m: tQ.default,
                                pause_m: tZ.default,
                                pause_filled_m: tK.default,
                                play_m: tJ.default,
                                ...
                                ruble_m: t8.default,
                                search_m: t9.default,
                                search_selected_m: t2.default,
                                speed_1_25x_centered_m: t3.default,
                                speed_1_5x_centered_m: t5.default,
                                speed_1_75x_centered_m: t7.default,
                                speed_1x_centered_m: t6.default,
                                speed_2x_centered_m: t4.default,
                                ...
                                attention_xxl: rO.default,
                                check_xxl: rR.default,
                                next_xxl: rj.default,
                                offline_xxl: rh.default,
                                pause_filled_xxl: rH.default,
                                play_filled_xxl: rP.default,
                                previous_xxl: rM.default,
                                search_xxl: rS.default,
                                attention_xxxl: rL.default,
                                bandlink: rC.default,
                                booksLogo: rT.default,
                                googlePlay: rD.default,
                                huaweiAppGallery: rF.default,
                                kinopoiskEn: rA.default,
                                kinopoiskRu: rB.default,
                                macos: rI.default,
                                musicLogo: rz.default,
                                musicLogoCenterEn: rN.default,
                                musicLogoCenterRu: rV.default,
                                musicLogoLeftEn: rU.default,
                                musicLogoLeftRu: rY.default,
                                plus: rW.default,
                                plusBadge: rq.default,
                                plusColor: rG.default,
                                plusOutlined: rX.default,
                                windows: rQ.default,
                                yandexBooksEn: rZ.default,
                                yandexBooksRu: rK.default,
                                yandexPayEn: rJ.default,
                        ...
                        let n = r(4377),
                            ...
                            c = (e) => {
                                ...
                                return (0, n.jsxs)('div', {
                                    className: (0, a.clsx)(
                                        o.default.root,
                                        { [o.default.root_disabled]: u, [o.default['root_size_'.concat(_)]]: _, [o.default['root_variant_'.concat(p)]]: p },
                                        t,
                                    ),
                                    onClick: m,
                                    children: [
                                        c,
                                        (0, n.jsx)('input', {
                                            className: (0, a.clsx)(o.default.input, r, { [o.default.textShadowing]: v.readOnly }),
                                            ref: g,
                                            value: d,
                                            disabled: u,
                                            ...v,
                                        }),
                                        (0, n.jsx)('div', { className: (0, a.clsx)(o.default.actions, s), children: f }),
                                    ],
                                });
                            };
                    ...
                    3906: function (e, t, r) {
                        ...
                        t.SearchInput = (e) => {
                            let {
                                ...
                                [R, j] = (0, i.useState)(!!s),
                                h = (0, i.useRef)(null),
                                H = (0, i.useMemo)(() => (0, l.debounce)(t, 500), [t]);
                            (0, i.useEffect)(() => {
                                if (v) {
                                    var e;
                                    null == (e = h.current) || e.focus({ preventScroll: g });
                                }
                            }, [v, g]);
                            let P = (0, i.useCallback)(
                                    (e) => {
                                        let r = e.length > 0;
                                        O(e), H(e), r ? (H(e), j(!0)) : (t(e), j(!1));
                                    },
                                    [H, t],
                                ),
                                M = (0, i.useCallback)(
                            ...
                            let S = (0, i.useCallback)(() => {
                                    var e;
                                    O(''), t(''), j(!1), null == m || m(), null == (e = h.current) || e.focus();
                                }, [t, m]),
                                L = (0, i.useMemo)(
                                    () =>
                                        (0, n.jsx)(c.Icon, {
                                            variant: 'search',
                                            size: 'xs',
                                            className: (0, a.clsx)(u.default.searchIcon, { [u.default.searchIcon_disabled]: p }),
                                            ...y,
                                        }),
                                    [p, y],
                                ),
                                C = (0, i.useMemo)(
                                    () =>
                                        (0, n.jsx)(f.Button, {
                                            radius: 'round',
                                            className: (0, a.clsx)(u.default.reset, { [u.default.reset_show]: R }),
                                            'aria-label': _,
                                            size: d,
                                            disabled: p,
                                            onClick: S,
                            ...
                            return (0, n.jsx)(o.Input, {
                                ref: h,
                                type: 'search',
                                containerClassName: (0, a.clsx)(u.default.searchContainer, k),
                                inputClassName: u.default.searchInput,
                                icon: L,
                                actions: C,
                                onChange: M,
                                value: w,
