    ...
    [8537],
    {
        ...
        62783: (e, n, r) => {
            Promise.resolve().then(r.bind(r, 58360)),
                ...
                Promise.resolve().then(r.bind(r, 92521)),
                ...
                Promise.resolve().then(r.bind(r, 1146)),
                Promise.resolve().then(r.bind(r, 87803)),
                Promise.resolve().then(r.bind(r, 93724)),
                Promise.resolve().then(r.bind(r, 65034));
        },
        63708: (e) => {
            e.exports = {
        ...
        65034: (e, n, r) => {
            ...
            var o = r(54486),
                ...
                P = r.n(a);
            let u = (0, s.PA)((e) => {
                let { className: n, title: r, description: s, iconVariant: a = 'musicLogo', iconClassName: u, iconSize: c } = e,
                ...
                return (
                    ...
                    (0, o.jsxs)('div', {
                        className: (0, i.$)(P().root, { [P().root_desktop]: !_ }, n),
                        children: [
                            (0, o.jsx)(v.Lh, { withBackwardFallback: '/', className: P().navigation, withForwardControl: !1 }),
                            (0, o.jsxs)('div', {
                                className: P().content,
                                children: [
                                    (0, o.jsx)(d.Icon, { className: (0, i.$)(P().icon, u), variant: a, size: c }),
                                    (0, o.jsx)(m.Heading, {
                    ...
                    children: [
                        ...
                        (0, o.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, o.jsx)(v.Heading, { className: (0, i.$)(u().title, u().important), variant: 'h3', size: 'xs', children: P }),
                                (0, o.jsxs)(v.Caption, {
