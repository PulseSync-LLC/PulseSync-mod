    ...
    [3197],
    {
                    ...
                    8119: function (t, e, r) {
                        ...
                        let i = r(4377),
                            ...
                            c = (t) => {
                                ...
                                let P = (0, a.useMemo)(() => (E ? (0, i.jsx)('div', { className: s.default.spinnerContainer, children: p }) : null), [E, p]),
                                    R = (0, a.useCallback)(
                                        (t) => {
        ...
        11334: (t, e, r) => {
            ...
            r.d(e, {
                ...
                Xj: () => b,
                ao: () => j.ArtistCard,
                gg: () => N.ArtistContextMenu,
                G4: () => T,
                NN: () => M.ArtistTopCard,
                GV: () => y,
                eS: () => _,
                cz: () => w.HorizontalArtistCard,
                M$: () => d,
                xx: () => s,
                dg: () => c,
                LH: () => i,
        ...
        75502: (t, e, r) => {
            ...
            let T = (0, a.PA)((t) => {
                let { artist: e, className: r, children: a, contentLinesCount: b, topTitleElement: T, bottomTitleElement: y } = t,
                    ...
                    [P, R] = (0, l.useState)(!1),
                    [O, K] = (0, l.useState)(!1),
                    { sendLikeSearchFeedback: D, sendNavigateSearchFeedback: F, sendPlaySearchFeedback: z } = (0, g.zEv)(),
                    U = (0, g.NKK)(),
                    H = (0, g.brA)(),
                    W = (0, A.KX)(e),
                    q = (0, A.A7)(e),
                    { id: X, name: G, coverUri: Y, isLiked: $ } = e,
                    J = (0, g.ZpR)(e.url),
                    [Q, Z] = (0, l.useState)(!1),
                    V = (0, g.Ftl)(),
                    tt = (0, g.PT7)(),
                    ...
                    tr = (0, l.useMemo)(() => {
                        let t = E({ id: 'entity-names.artist-name' }, { artistName: G }),
                            e = $ ? E({ id: 'entity-names.has-your-like' }) : '';
                    ...
                    ta = (0, A.SA)({ artist: e, callback: J }),
                    tl = (0, A.SA)({ artist: e, callback: ti }),
                    tn = (0, d.c)((t) => {
                        null == F || F(), U({ to: s.QT.ArtistScreen }), ta(t);
                    }),
                    ts = (0, g.NPu)(),
                    tc = (0, d.c)(() => {
                        if (!tt()) {
                            if (ts) return void w.open();
                            L || to || (B(!0), null == z || z()), tl(), H(!to);
                        }
                    }),
                    tu = (0, d.c)(() => {
                        P || $ || (R(!0), null == D || D()), W();
                    ...
                    tv = (0, l.useMemo)(
                        () =>
                            (0, o.jsx)(
                                x.O0,
                                { onClick: q, isPinned: e.isPinned, className: (0, i.$)(C().pinButton, C().control), withRipple: !1 },
                                e.getKey('PinButton'),
                            ),
                        [e, q],
                    ),
            ...
            let h = (0, a.PA)((t) => {
                ...
                b = (0, a.PA)((t) => {
                    let { className: e, artist: r, pageId: a, description: A, coverClassName: g, playButtonIconSize: x, likeIconSize: b } = t,
                        ...
                        F = (0, p.SA)({ artist: r, callback: K }),
                        z = (0, d.c)((t) => {
                            null == S || S(), L({ to: s.QT.ArtistScreen }), D(t);
                        }),
                        U = (0, d.c)(() => {
                            if (!I()) {
                                if (P) return void B.open();
                                j || R || (N(!0), null == E || E()), F(), w(!R);
                            }
                        }),
                        H = (0, d.c)((t) => {
                            (0, _.P)(t, f.$f.ripple), z(t);
                        }),
                        W = (0, d.c)((t) => {
                            t.stopPropagation(), z(t);
                        }),
                        q = (0, l.useCallback)(
                            (t) =>
                                (0, o.jsx)(f.q1, {
                        ...
                        X = null == q ? void 0 : q({ onPlayButtonClick: U, isPlaying: R, isCurrent: O, playButtonIconSize: x }),
                        G = (0, l.useMemo)(
                            () =>
                                r.url && r.isAvailable
                                    ? (0, o.jsx)(f.N_, {
        ...
        92229: (t, e, r) => {
            'use strict';
            r.d(e, { hO: () => _, jr: () => m, jp: () => p, QZ: () => i }), r(21485);
            var o = r(44020);
            let i = (t, e, r) => {
                let i = null != r && r;
                return {
                ...
                _ = (0, n.PA)((t) => {
                    ...
                    let S = (0, o.useCallback)(() => {
                        ...
                        let o = (t) => {
                            N(t > e),
                                m && w(t > 30),
                                (null == f ? void 0 : f.current) && T(d({ element: null == f ? void 0 : f.current, scrollTop: t, isMobile: I })),
                                (null == g ? void 0 : g.current) && k(d({ element: null == g ? void 0 : g.current, scrollTop: t, isMobile: I }));
                        };
        ...
        96072: (t, e, r) => {
            ...
            let f = (0, i.PA)((t) => {
                ...
                let { artist: f, onOpenChange: A, open: g, ...x } = t,
                    ...
                    { shareLink: B, pathname: P } = (0, p.bNS)('/artist/:artistId', { params: { artistId: null != (r = null == f ? void 0 : f.id) ? r : '' } }),
                    R = (0, m.A_)({ entityVariant: p.DwC.ARTIST, urlParams: { id: null == f ? void 0 : f.id } }),
                    { isPlaying: O, togglePlay: K } = (0, p.B0S)({
                ...
                (0, p.NBO)(g);
                let W = { variant: p.Yxq.ARTIST, id: null == f ? void 0 : f.id, title: null == f ? void 0 : f.name, path: P },
                ...
                return (0, o.jsxs)(d.W1, {
                    ...
                    ...x,
                    children: [
                        q && (0, o.jsx)(v.aQ, { fallback: (0, o.jsx)(m.dx, { entityVariant: p.DwC.ARTIST, adminUrl: R }) }),
                        !C && (0, o.jsx)(v.aQ, { fallback: (0, o.jsx)(v.L1, { onClick: N, isPinned: null == f ? void 0 : f.isPinned }) }),
                        (0, o.jsx)(v.aQ, {
