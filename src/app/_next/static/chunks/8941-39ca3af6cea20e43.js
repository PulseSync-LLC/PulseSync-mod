(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [8941],
    {
        ...
        54990: (e, t, a) => {
            ...
            let i = (0, a(66268).createContext)({ observeElement: () => {}, unobserveElement: () => {} });
        },
        61475: (e, t, a) => {
            'use strict';
            var i;
        ...
        68941: (e, t, a) => {
            ...
            let A = (e) => {
                    ...
                    return (0, i.jsxs)('div', {
                        ...
                        children: [
                            (0, i.jsx)(S.Shimmer, { isActive: t, className: k().dateShimmer }),
                            (0, i.jsx)(S.Shimmer, { isActive: t, className: k().contextNameShimmer }),
                            (0, i.jsx)(h.Mo, { withDescription: !0, className: k().contextHeaderShimmer }),
                            a,
                            (0, i.jsx)(S.Shimmer, { isActive: t, className: k().contextNameShimmer }),
                            (0, i.jsx)(h.Mo, { coverRadius: 'round', className: k().contextHeaderShimmer }),
                            a,
                        ],
                    });
                },
        ...
        74557: (e, t, a) => {
            ...
            let C = (0, r.PA)((e) => {
                    ...
                    let { album: m, tabIndex: b, blockIndex: p } = e,
                        { ref: S, intersectionPropertyId: k } = x({ id: m.id, tabIndex: b, blockIndex: p }),
                        ...
                        H = (0, s.useMemo)(() => {
                            ...
                            return m.isShimmerVisible
                                ? (0, i.jsx)(_.Mo, { isActive: m.isShimmerActive, className: A().header, withDescription: !0 })
                                : (0, i.jsx)(_.Tw, {
                                      className: A().header,
                ...
                M = (0, r.PA)((e) => {
                    ...
                    let { artist: n, tabIndex: d, blockIndex: m } = e,
                        ...
                        S = (0, s.useMemo)(() => {
                            ...
                            return n.isShimmerVisible
                                ? (0, i.jsx)(_.Mo, { isActive: n.isShimmerActive, className: A().header, coverRadius: 'round' })
                                : (0, i.jsx)(_.Tw, {
                                      titleSize: 'xs',
                                      titleLineClamp: 1,
                                      className: A().header,
                    ...
                    return (0, i.jsxs)('section', {
                        ...
                        children: [
                            ...
                            S,
                            (0, i.jsx)('div', { className: A().content, children: k }),
                        ],
                    });
                }),
                H = (0, r.PA)((e) => {
                    ...
                    return (0, i.jsxs)('section', {
                        ...
                        children: [
                            ...
                            (0, i.jsx)('div', { className: A().content, children: _ }),
                        ],
                    });
                });
            var T = a(73827);
            let j = (0, r.PA)((e) => {
                ...
                let { playlist: m, tabIndex: h, blockIndex: b } = e,
                    ...
                    { from: k } = (0, c.fyy)({ blockId: m.isResolved ? 'playlist-'.concat(null == (t = m.meta) ? void 0 : t.id) : '' }),
                ...
                return (0, i.jsxs)('section', {
                    ...
                    children: [
                        ...
                        M,
                        (0, i.jsx)('div', { className: A().content, children: H }),
                    ],
                });
            });
            var L = a(42213),
            ...
            let f = (0, r.PA)((e) => {
                ...
                let { vibe: h, blockIndex: b, tabIndex: p } = e,
                    ...
                    { ref: E, intersectionPropertyId: O } = x({ id: h.id, blockIndex: b, tabIndex: p }),
                    ...
                    F = (0, N.L)(() => {
                        ...
                        return h.isShimmerVisible
                            ? (0, i.jsx)(_.Mo, { isActive: h.isShimmerActive, className: A().header, coverRadius: 'round' })
                            : (0, i.jsxs)(_.Cj, {
                                  className: (0, u.$)(A().header, A().vibeHeader),
                                  onClick: Y,
                                  children: [
                                      (0, i.jsx)(_.SU, {
                                          isOpened: j,
                                      ...
                                      (0, i.jsx)(_.Tw, { titleSize: 'xs', titleLineClamp: 1, headingVariant: 'h4', labeledForId: D, className: A().vibeTextBlock, ...X }),
                                  ],
                              });
                    }),
                    G = (0, s.useMemo)(
                ...
                return (0, i.jsxs)('section', {
                    ...
                    children: [
                        ...
                        F,
                        (0, i.jsx)('div', { className: A().content, children: G }),
                    ],
                });
            });
            var w = a(28149),
                            ...
                            : e
                                  .map((e, t) => {
                                      switch (e.type) {
                                          ...
                                          case n.D.PLAYLIST:
                                              return (0, i.jsx)(j, { playlist: e, blockIndex: t, tabIndex: a }, ''.concat(e.key, '_').concat(t));
                                          case n.D.WAVE:
                                              return (0, i.jsx)(f, { vibe: e, blockIndex: t, tabIndex: a }, ''.concat(e.key, '_').concat(t));
                                          case n.D.ARTIST:
                                              return (0, i.jsx)(M, { artist: e, blockIndex: t, tabIndex: a }, ''.concat(e.key, '_').concat(t));
                                          case n.D.SEARCH:
                                          case n.D.OTHER:
                                              return (0, i.jsx)(H, { common: e, blockIndex: t, tabIndex: a }, ''.concat(e.key, '_').concat(t));
                                          default:
                                              return null;
                                      }
                                  })
