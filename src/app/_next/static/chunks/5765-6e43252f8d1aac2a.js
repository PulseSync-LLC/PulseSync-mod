    ...
    [5765],
    {
        2865: (e, t, i) => {
            ...
            let n = (e) => {
                if (e.data.type !== r.R.Clip) return null;
                {
                    ...
                    let r = null == (t = i.artists) ? void 0 : t.map((e) => (0, l.as)({ artist: e })),
            ...
            let p = (e) => {
                ...
                switch (e.data.type) {
                    case r.R.Generative: {
                        let i = e.data.meta,
                            r = (0, s.QBb)(null == i ? void 0 : i.derivedColors);
                        return (0, a.wg)({
                            id: String(i.id),
                            coverUri: i.imageUrl,
                    ...
                    default: {
                        let t = e.data.meta,
                            r = null == (i = t.substituted?.artists ?? t.artists) ? void 0 : i.map(l.dM),
                            s = null == (n = t.albums) ? void 0 : n.map(u.e7);
                        return (0, a.wg)({ ...(0, c.gK)(t), artists: r, albums: s, isHiddenFromSonataQueue: e.hidden });
                    }
                }
            };
            var m = i(48148),
                ...
                x = i(43090),
                y = i(10663);
            let h = a.gK.model('UnloadedEntityMeta', { id: a.gK.union(a.gK.number, a.gK.string), albumId: a.gK.maybe(a.gK.union(a.gK.number, a.gK.string)) }),
                I = a.gK.model('UnloadedEntityData', { meta: h, type: a.gK.literal(o.z4.Unloaded) });
            var f = i(6247),
                A = i(16285);
            let S = c.OQ.props({ artists: a.gK.array(l.PK), albums: a.gK.array(u.GI), chart: a.gK.maybe(A.Iz), isHiddenFromSonataQueue: a.gK.maybe(a.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
                        ...
                        get mainArtist() {
                            var i, a;
                            return null != (a = null == (i = e.artists) ? void 0 : i[0]) ? a : null;
                        },
                        get mainAlbum() {
                            var r, l;
                            return null != (l = null == (r = e.albums) ? void 0 : r[0]) ? l : null;
                        },
                        get index() {
                            var s, n, o;
                    ...
                    .actions((e) => ({
                        changeTrackInfo: (0, a.L3)(function* (t, i) {
                            let { ugcResource: r, modelActionsLogger: n } = (0, a._$)(e);
                ...
                K = a.gK
                    .model('BaseSonataState', {
                        contextType: a.gK.maybeNull(a.gK.enumeration(Object.values(b.K))),
                    ...
                    .views((e) => ({
                        get unloadedEntitiesDataFromModels() {
                            var t;
                            return null != (t = e.volatileUnloadedEntitiesData) ? t : (0, _.HO)(e.unloadedEntitiesData);
                        },
                        get isVibeContext() {
                ...
                k = i(60030)
                    .z8.props({ artists: a.gK.array(l.PK), isHiddenFromSonataQueue: a.gK.maybe(a.gK.boolean) })
                    .views((e) => ({
                        get idWithContext() {
        ...
        10957: (e, t, i) => {
            ...
            var a = i(33008),
                ...
                m = i(18740);
            let C = (0, r.PA)((e) => {
                let { onOpenChange: t, open: i, placement: r, isFullscreenMobile: C = !1, icon: v, size: g, clip: _, ...b } = e,
                    { currentClipInfo: x, settings: y, user: h } = (0, p.Pjs)(),
                    { formatMessage: I } = (0, l.A)(),
                    { shareLink: f, pathname: A } = (0, p.bNS)(p.Zyd.video.href, { query: { ids: String(_.clipId) } }),
                    S = C || y.isMobile;
                (0, p.NBO)(i);
                let K = (0, c.KX)(_),
                    k = (0, o.c)(() => {
                ...
                return (0, a.jsxs)(u.W1, {
                    ...
                    ...b,
                    children: [
                        (0, a.jsx)(m.TW, { onClick: K, isLiked: _.isLiked, disabled: !h.isAuthorized }),
            ...
            let p = () => {
                ...
                let A = (0, o.c)(async (r) => {
                    ...
                    if (!t.isAuthorized) {
                        ...
                        m((0, a.jsx)(c.hT, { error: C({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: e });
                        return;
                    }
                    let l = p.getState(),
                    ...
                    if (l && o && (0, s.S)(l.currentContext.value)) {
                        ...
                        try {
                            ...
                            f();
                            let e = i.modal.isOpened ? u.uQT.FULLSCREEN_ERROR : u.uQT.ERROR;
                            m((0, a.jsx)(c.hT, { error: C({ id: 'error-messages.error-during-action' }) }), { containerId: e });
                        } finally {
                            g(!1);
                        }
                    }
                ...
                return {
                    ...
                    onGenerativeDislikeClick: (0, o.c)(() => A(n.Q.TimestampDislike)),
                };
            };
        },
        16907: (e, t, i) => {
            ...
            let v = (0, l.PA)((e) => {
                    let {
                        ...
                        S = (0, s.useMemo)(() => {
                            if (v) return Array.from({ length: 5 }, (e, t) => (0, a.jsx)(p.k, { isActive: g }, t));
                            return null == y
                                ? void 0
                                : y.map((e, t) =>
                                      (0, a.jsx)(
                    ...
                    return (0, a.jsx)(d.Carousel, {
                        className: (0, r.$)(C().itemCounter, { [C()['itemCounter_'.concat(I)]]: I }, _),
                        ref: t,
                ...
                g = (0, s.forwardRef)((e, t) => (0, a.jsx)(v, { forwardRef: t, ...e }));
        },
        27845: (e) => {
            e.exports = {
        ...
        29663: (e, t, i) => {
            ...
            let A = (0, s.PA)((e) => {
                ...
                let {
                    ...
                    L = (0, b.Cc)(),
                    { from: j } = (0, x.fyy)({ pageId: x._Q$.VIDEO_PLAYER, contextId: N.state.contextId, contextType: c.K.Various, blockId: x.UfI.CLIPS }),
                    M = (0, x.PMf)(null != (t = I.duration) ? t : 0),
                    P = (0, b.Mn)(K),
                    T = (0, b._7)(K),
                    { ref: R, intersectionPropertyId: w } = (0, x.nMI)({ callback: P }),
                    D = (0, n.useRef)(null),
                    O = A && I.previewUrl,
                    U = (0, p.c)(() => {
                        D.current && ((D.current.currentTime = 0), D.current.play());
                    }),
                    ...
                    G = (0, n.useMemo)(() => N.ids.indexOf(I.clipId), [N, I.clipId]),
                    { isPlaying: V, togglePlay: X } = (0, x.Dx4)({
                        playContextParams: {
                            contextData: { type: c.K.Various, meta: { id: x.H7u.VARIOUS_CLIP_CONTEXT }, from: j },
                            queueParams: { index: G },
                    ...
                    H = E({ id: 'entity-names.clip-name' }, { clipName: I.title }),
                    Y = (0, n.useMemo)(
                        () =>
                            I.isAvailable
                                ? (0, a.jsxs)(v.Paper, {
                                      ...
                                      children: [
                                          O &&
                                              (0, a.jsx)('video', {
                                                  className: f().media,
                                                  ref: D,
                                                  poster: I.thumbnail && (0, d.createAvatarVideoUrl)(I.thumbnail, 1280),
                                                  playsInline: !0,
                                                  muted: !0,
                                                  loop: !0,
                                                  'aria-hidden': !0,
                                          ...
                                          void 0 !== I.duration &&
                                              (0, a.jsx)(g.Caption, {
                                                  ...
                                                  size: 'xs',
                                                  weight: 'medium',
                                                  children: (0, a.jsx)('span', { 'aria-hidden': 'true', children: (0, x.E4p)(I.duration, I.duration) }),
                                              }),
                                          (0, a.jsx)(y.DM, { variant: 'filled', className: f().playButton, onClick: $, iconSize: 'xl' }),
                                      ],
                                  })
                                : (0, a.jsx)(v.Paper, {
                                      radius: 'm',
                                      ...
                                      children: (0, a.jsx)(C.FallbackImage, {
                                          ...
                                          ...(0, u.Am)(u.S7.ENTITY_COVER_FALLBACK_IMAGE),
                                      }),
                                  }),
                        [M, I.isAvailable, I.thumbnail, I.previewUrl, I.duration, F, z, $, O],
                    ),
                    q = (0, n.useMemo)(
                        () =>
                            I.hasArtists
                                ? (0, a.jsx)(
                                      _.iQ,
                                      { linkClassName: (0, r.$)(f().artistLink, s), artists: I.artists, lineClamp: 1, withAllArtistsTitle: !0, artistIdWithoutLink: S },
                ...
                return (0, a.jsx)(m.MN, {
                    ...
                    explicitMarkComponent:
                        ...
                        (0, a.jsx)(y.Nq, { getDescriptionTexts: I.getDescriptionTexts, variant: I.explicitDisclaimer, size: 'xxs' }, I.getKey('ExplicitMarkIcon')),
                    'aria-label': H,
                    srTitle: (0, a.jsx)(y.N_, { href: B, onClick: $, children: H }),
                    title: (0, a.jsxs)(
                        g.Caption,
                        {
                            ...
                            children: [
                                ...
                                I.version && (0, a.jsx)(g.Caption, { className: f().version, variant: 'span', children: ' '.concat(I.version) }),
                            ],
                        },
                        I.getKey('Title'),
                    ),
                    ...
                    return (0, a.jsxs)('section', {
                        ...
                        children: [
                            (0, a.jsx)(o.Tw, {
                                ...
                                description: v,
                                viewAllActionLink: b,
                                controls: (0, a.jsx)(o.X9, { className: u().controls, carouselRef: N }),
                                headingVariant: I,
                                withDescription: !!v,
                            }),
        ...
        64641: (e, t, i) => {
            ...
            (0, i(66268).cache)(async (e) => {
                try {
                    let { container: t, backendHostTld: i, locale: a, host: r, fullUrl: l, isRSC: s, requestUrl: n } = await (0, d.IhE)();
                    ...
                    c && ((c.search = ''), c.searchParams.set(d.K3F.IDS, String(null != e ? e : '')));
                    let p = null == c ? void 0 : c.toString();
                    return { clip: null == u ? void 0 : u[0], backendHostTld: i, locale: a, host: r, fullUrl: l, requestUrl: n, canonical: p };
                } catch (e) {
            ...
            let v = s.gK.model('Credit', { title: s.gK.string, value: s.gK.string }),
                g = s.gK
                    .model('CurrentClipInfo', {
                        ...
                        clipLoadingState: s.gK.enumeration(Object.values(d.GuX)),
                        creditsLoadingState: s.gK.enumeration(Object.values(d.GuX)),
        ...
        77898: (e, t, i) => {
                            ...
                            children: [
                                (0, a.jsx)(h.aQ, {
                                    fallback: (0, a.jsx)(h.cy, {
                                        size: 'xs',
                                        iconSize: l,
                                        className: (0, r.$)(N().item, N().likeIcon),
                                        isLiked: i.isLiked,
                                        onClick: v,
                                ...
                                (0, a.jsx)(K.ClipContextMenu, {
                                    placement: 'top-start',
                                    icon: (0, a.jsx)(S.Icon, { variant: 'more', size: 'xs' }),
                                    size: 'xs',
                                    clip: i,
                                    className: (0, r.$)(N().contextMenu, { [N().contextMenu_visible]: m }),
                                    onOpenChange: C,
                                    open: m,
                                }),
                            ],
            ...
            let M = (0, s.PA)((e) => {
                var t;
                let { clip: i, className: s, coverClassName: f, playButtonIconSize: S = 'xs', likeIconSize: K, viewUuid: k, shouldShowTimecode: N = !1 } = e,
                    { fullscreenVideoPlayer: L } = (0, y.Pjs)(),
                    { formatMessage: M } = (0, o.A)(),
                    P = (0, y.PMf)(null != (t = i.duration) ? t : 0),
                    T = (0, x._7)(k),
                    R = (0, x.Mn)(k),
                    { ref: w, intersectionPropertyId: D } = (0, y.nMI)({ callback: R }),
                    { from: O } = (0, y.fyy)({ pageId: y._Q$.VIDEO_PLAYER, contextId: L.state.contextId, contextType: c.K.Various, blockId: y.UfI.CLIPS }),
                    [U, F] = (0, n.useState)(!1),
                    { sendNavigateSearchFeedback: z, sendPlaySearchFeedback: G } = (0, y.zEv)(),
                    V = (0, x.Cc)(),
                    X = (0, n.useRef)(null),
                    B = (0, p.c)(() => {
                    ...
                    H = (0, n.useMemo)(() => L.ids.indexOf(i.clipId), [L, i.clipId]),
                    { isPlaying: Y } = (0, y.Dx4)({
                        playContextParams: {
                            contextData: { type: c.K.Various, meta: { id: y.H7u.VARIOUS_CLIP_CONTEXT }, from: O },
                            queueParams: { index: H },
                    ...
                    ee = (0, n.useCallback)(
                        (e, t) => {
                            ...
                            return (null == (r = i.artists) ? void 0 : r.length)
                                ? (0, a.jsx)(b.iQ, { linkClassName: e, captionClassName: t, artists: i.artists, lineClamp: 1 })
                                : null;
                        },
                        [i.artists],
                    ),
                    et = M({ id: 'entity-names.clip-name' }, { clipName: i.title }),
                    ei = (0, m.L)(() =>
                        i.isAvailable
                            ? (0, a.jsxs)(g.Paper, {
                                  className: (0, r.$)(j().cover, A().cover, A().cover_withoutOffset, f),
                                  radius: 'xs',
                                  onMouseEnter: Q,
                                  onMouseLeave: $,
                                  children: [
                                      i.previewUrl &&
                                          (0, a.jsx)('video', {
                                              className: A().media,
                                              ref: X,
                                              poster: i.thumbnail && (0, d.createAvatarVideoUrl)(i.thumbnail, 80),
                                              playsInline: !0,
                                              muted: !0,
                                              loop: !0,
                                              'aria-hidden': !0,
                                      ...
                                      void 0 !== i.duration &&
                                          ...
                                          (0, a.jsx)(_.Caption, {
                                              variant: 'span',
                                              className: (0, r.$)(A().duration, j().duration),
                                              type: 'entity',
                                              size: 'xs',
                                              weight: 'medium',
                                              role: 'text',
                                              'aria-label': P,
                                              children: (0, a.jsx)('span', { 'aria-hidden': 'true', children: (0, y.E4p)(i.duration, i.duration) }),
                                          }),
                                      (0, a.jsx)(h.DM, { variant: 'filled', className: A().playButton, onClick: Z, iconSize: S }),
                                  ],
                              })
                            : (0, a.jsxs)(g.Paper, {
                                  className: (0, r.$)(j().cover, j().unavailable, f),
                                  radius: 'xs',
                                  children: [
                                      ...
                                      (0, a.jsx)(h.DM, { variant: 'filled', className: A().playButton, iconSize: S, disabled: !0 }),
                                  ],
                              }),
                    );
                return (0, a.jsxs)(h.Cj, {
                    ...
                    className: (0, r.$)(h.$f.root, { [h.$f.root_disabled]: !i.isAvailable }, j().root, s),
                    onClick: W,
                    ...
                    children: [
                        ...
                        (0, a.jsx)(E, { className: h.$f.controlsBar, clip: i, likeIconSize: K }),
                    ],
                });
            });
        },
        80159: (e, t, i) => {
            ...
            let n = (e) => {
                ...
                return (
                    (0, a.useEffect)(() => {
                        o.isUnsafeDisclaimerConfirmed && o.id === u.current && !c.current && (null == i || i(), (c.current = !0));
                    }, [i, o.id, o.isUnsafeDisclaimerConfirmed]),
                    (0, l.c)(async (e) => {
                        let a = p.get(s.cYZ.ExEx);
                        if ((null == t ? void 0 : t.isUnsafeLegal) && (null == a ? void 0 : a.includes(''.concat(s.nPY.CLIP, '_').concat(t.clipId)))) {
                            null == i || i(e);
                            return;
                        }
