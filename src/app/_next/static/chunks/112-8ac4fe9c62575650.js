    ...
    [112],
    {
        1131: (e, t, a) => {
            ...
            let y = [l.MT.PLAYING, l.MT.LOADING_MEDIA_SOURCE, l.MT.BUFFERING],
                A = n.gK.model('UnloadedEntityMeta', { id: n.gK.union(n.gK.number, n.gK.string), albumId: n.gK.maybe(n.gK.union(n.gK.number, n.gK.string)) }),
                E = n.gK.model('UnloadedEntityData', { meta: A, type: n.gK.literal(l.z4.Unloaded) });
            var k = a(96333),
                w = a(62400);
            let I = m.OQ.props({ artists: n.gK.array(i.PK), albums: n.gK.array(u.GI), chart: n.gK.maybe(w.Iz), isHiddenFromSonataQueue: n.gK.maybe(n.gK.boolean) })
                ...
                T = n.gK
                    .model('BaseSonataState', {
                        contextType: n.gK.maybeNull(n.gK.enumeration(Object.values(N.K))),
                    ...
                    .views((e) => ({
                        ...
                        get isVibeContext() {
                            return e.contextType === N.K.Vibe;
                        },
                        get isGenerativeContext() {
                            return e.contextType === N.K.Generative;
                        },
                        get isPaused() {
                    ...
                    .actions((e) => ({
                        ...
                        setEntityMeta: (t) => {
                            t && t.data.meta && (e.entityMeta && (0, n.Yo)(e.entityMeta), (e.entityMeta = p(t)));
                        },
        ...
        5749: (e, t, a) => {
            ...
            let r = () => {
                ...
                return (0, i.c)((s, i) => {
                    ...
                    i && (N.deepLink = i);
                    let f = (0, n.Fx)({ params: N, logger: t, context: 'useSendEventOnDonationNavigated' });
                    f && (0, n.QS)(a.evgenInstance, f);
                });
            };
        },
        8484: (e) => {
        ...
        42181: (e, t, a) => {
            ...
            let _ = (e) => {
                ...
                let g = (0, s.useCallback)(
                    ...
                    N = C(''.concat(v.afisha.host, '/w/sessions/').concat(t, '?clientKey=').concat(v.afisha.clientId));
                return (0, n.jsxs)(l.a, {
                    size: 'fitContent',
                    placement: 'center',
                    open: a,
        ...
        44020: (e, t, a) => {
            ...
            let A = (0, i.PA)((e) => {
                ...
                return (0, n.jsxs)('div', {
                    className: (0, s.$)(y().root, k),
                    children: [
                        (0, n.jsxs)('div', {
                            className: y().buttonContainer,
                            children: [
                                (t || d) &&
                                    (0, n.jsx)(f.ShuffleButton, {
            ...
            let T = (0, i.PA)((e) => {
                    let {
                        ...
                        { formatMessage: N } = (0, v.A)(),
                        { user: f, sonataState: b } = (0, l.Pjs)(),
                        y = (0, l.zwV)(),
                        A = b.entityMeta,
                        w = b.contextType === E.K.Generative,
                        T = f.isAuthorized && !w,
                        O = (0, k.KX)(b.entityMeta),
                        S = (0, k.mW)(b.entityMeta);
                    (0, o.useEffect)(() => {
                            ...
                            () =>
                                r
                                    ? (0, n.jsx)(C.$, {
                                          ...
                                          radius: 'round',
                                          withRipple: !1,
                                          'aria-label': N({ id: 'player-actions.rewind-backwards' }),
                            ...
                            () =>
                                r
                                    ? (0, n.jsx)(C.$, {
                                          ...
                                          disabled: !a,
                                          withRipple: !1,
                                          'aria-label': N({ id: 'player-actions.rewind-forward' }),
                    ...
                    return (0, n.jsxs)('div', {
                        ...
                        children: [
                            (0, n.jsx)('div', {
                                ...
                                children: A && T && (0, n.jsx)(g.aQ, { fallback: (0, n.jsx)(g._I, { isDisliked: A.isDisliked, iconSize: 'xs', onClick: S }) }),
                            }),
                            (0, n.jsxs)('div', {
                            ...
                            (0, n.jsx)('div', {
                                ...
                                children:
                                    A &&
                                    T &&
                                    (0, n.jsx)(g.aQ, { fallback: (0, n.jsx)(g.cy, { isLiked: A.isLiked, iconSize: 'xs', onClick: O, disabled: !f.isAuthorized }) }),
                            }),
                        ],
                    });
                }),
                O = (0, i.PA)((e) => {
                    ...
                    let { isMobile: i, entityMeta: m, isFullscreen: v, className: h, withShuffle: C, withRepeat: x } = e,
                        ...
                        S = (0, l.rs2)(),
                        j = (0, l.brA)(),
                        R = (null == m ? void 0 : m.isNonMusic) && !f.isAdvertShown,
                        P = (0, l.PT7)(),
                        ...
                        B = (0, o.useMemo)(() => (f.isAdvertShown ? f.isAdvertPlaying : g.isPlaying), [f.isAdvertShown, f.isAdvertPlaying, g.isPlaying]),
                        K = (0, r.c)(() => {
                            if (f.isAdvertShown) {
                                var e;
                    ...
                    (0, o.useEffect)(() => {
                        if (!v && (null == k || k.addShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_PLAY, K), !f.isAdvertShown))
                            return (
                                null == k || k.addShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_REPEAT, G),
                                null == k || k.addShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_SHUFFLE, $),
                                () => {
                                    null == k || k.removeShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_PLAY),
                                        f.isAdvertShown ||
                                            (null == k || k.removeShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_SHUFFLE),
                                            null == k || k.removeShortcutsListener(l.Mo.MAIN, l.lbr.TOGGLE_REPEAT));
                                }
                            );
                    }, [v, K, G, $, k, f.isAdvertShown]);
                    let V = (0, o.useMemo)(() => (v ? (i ? T : A) : i ? u.K : _.Z), [i, v]);
                    return (0, n.jsx)(V, {
                        className: (0, s.$)(h, { [p().root]: E }),
                        disabled: null === g.entityMeta || (f.isAdvertShown && !i),
                        isPlaying: B || !1,
                        canMoveBackward: g.canMoveBackward && !f.isAdvertShown,
                        canMoveForward: g.canMoveForward && !f.isAdvertShown,
                        withShuffle: C,
                        withRepeat: x,
        ...
        48977: (e, t, a) => {
            ...
            let r = () => {
                ...
                return (0, i.c)((s, i) => {
                    ...
                    N && (s ? (0, n.Pf)(a.evgenInstance, N) : (0, n.nv)(a.evgenInstance, N));
                });
            };
        },
        52575: (e) => {
        ...
        53109: (e, t, a) => {
                    ...
                    children: [
                        ...
                        (0, n.jsxs)(p.Caption, {
                            ...
                            children: [
                                ...
                                (0, n.jsx)(p.Caption, { 'aria-hidden': !0, className: f().separator, variant: 'span', type: 'controls', weight: 'medium', children: x }),
                                (0, n.jsx)(p.Caption, {
                                    variant: 'span',
                                    type: 'controls',
                                    weight: 'medium',
            ...
            let w = (0, s.PA)((e) => {
                var t, a, s;
                let { concert: x, withMask: g = !0, withPriceButton: N, withInlineMeta: f = !1 } = e,
                    ...
                    G = (0, n.jsx)(y.RedesignedConcertMeta, { concert: x, withCashback: !1, withInlineMeta: f, titleSize: 'l' }),
                    ...
                    children: [
                        (0, n.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, n.jsx)('div', {
                                    className: k().cover,
                                    children: (0, n.jsx)(A.ConcertImage, {
                                        datetime: x.datetime,
        ...
        58564: (e, t, a) => {
            ...
            let b = (e) => {
                    let { isActive: t } = e;
                    return (0, C.jsxs)('div', {
                        className: (0, x.$)(f().shimmer, f().donation),
                        children: [
                            (0, C.jsx)(g.Shimmer, { isActive: t, radius: 'round', className: f().shimmerCover }),
                            (0, C.jsxs)('div', {
                                className: f().shimmerContainer,
                                children: [
                                    (0, C.jsxs)('div', {
                                        className: f().shimmerText,
                                        children: [
                                            (0, C.jsx)(g.Shimmer, { isActive: t, radius: 'xxxl', className: f().shimmerArtist }),
                                            (0, C.jsx)(g.Shimmer, { isActive: t, radius: 'xxxl', className: f().shimmerGoal }),
                                        ],
                                    }),
                                    (0, C.jsx)(g.Shimmer, { isActive: t, radius: 'xxxl', className: f().shimmerButton }),
                                ],
                            }),
                        ],
                    });
                    ...
                    return (0, n.jsxs)('section', {
                        ...
                        children: [
                            ...
                            (0, n.jsx)(l.Carousel, {
                                ...
                                ref: y,
                                'aria-labelledby': b,
                                children: u ? Array.from({ length: 2 }, (e, t) => (0, n.jsx)('div', { className: m().concertsColumn, children: (0, c.Tb)(2) }, t)) : k,
                            }),
                        ],
                    });
                },
        ...
        73298: (e, t, a) => {
            ...
            let O = (e) => {
                ...
                return (0, k.jsxs)('div', {
                    className: T().root,
                    children: [
                        (0, k.jsx)(w.Shimmer, { radius: 'm', className: T().shimmerCover, isActive: t }),
                        (0, k.jsx)('div', { className: T().meta, children: (0, k.jsx)(w.Shimmer, { isActive: t, radius: 'xxxl', className: T().shimmerTitle }) }),
                        a && (0, k.jsx)(w.Shimmer, { isActive: t, radius: 'xxxl', className: T().shimmerButton }),
                    ],
                });
            };
            var S = a(61303),
        ...
        76303: (e, t, a) => {
            ...
            let C = (0, s.PA)((e) => {
                    let {
                        ...
                        { experiments: f } = (0, l.Pjs)(),
                        b = f.checkExperiment(l.zal.WebNextPlayerBarYellowButton, 'on');
                    return (0, n.jsx)(_.a, {
                        onShuffleClick: N,
                        onRepeatClick: g,
        ...
        79589: (e, t, a) => {
            ...
            let b = (0, i.PA)((e) => {
                let {
                    ...
                    })({ artistId: t, viewUuid: N }),
                    M = (0, v.m)({ artistId: t, viewUuid: N }),
                    { ref: B, intersectionPropertyId: K } = (0, _.nMI)({ callback: null !== t ? P : void 0, singleEvent: !A }),
                    D = (0, o.useId)(),
                    F = (0, o.useId)(),
                    L = (0, C.useGetPriceText)()(a),
                    z = (0, c.c)((e) => {
                        (0, u.P)(e, f().ripple), S && (R(e), M(r.H2.ConcertScreen));
                    }),
                    U = (0, c.c)((e) => {
                ...
                return (0, n.jsxs)(p.Paper, {
                    radius: b,
                    className: (0, s.$)(f().root, y, { [f().root_withConcertsRedesign]: a.isIdentityExperimentEnabled }),
                    ref: B,
                    ...
                    children: [
                        a.datetime &&
                            (0, n.jsx)(g.ConcertDate, {
                                datetime: a.datetime,
                                id: D,
                                className: (0, s.$)(f().date, { [f().dateWithMask]: k, [f().important]: k }),
            ...
            let v = { mainAxis: 44 },
                h = (0, s.PA)((e) => {
                    ...
                    return (0, n.jsx)(m.a, {
                        ...
                        isDisabledShuffle: !N || p,
                        withShuffle: ((p || N) && !(null == S ? void 0 : S.isAdvertShown)) || !!w,
                        shuffle: f,
                        canMoveBackward: g,
                        canMoveForward: x,
                        onClickNext: b,
        ...
        96502: (e, t, a) => {
            ...
            let b = (e) => {
                ...
                return (0, i.jsxs)('div', {
                    className: (0, o.$)(f().root, a),
                    ...(0, c.Am)(c.OA.concert.CONCERT_CARD_CASHBACK_PERCENT),
                    children: [
                        (0, i.jsx)(g, { 'aria-hidden': !0, className: f().icon }),
                        (0, i.jsx)(C.Caption, {
                            variant: 'span',
                            type: 'text',
                            size: 'xs',
