    ...
    [5242, 8747],
    {
        8071: (e, t, i) => {
            ...
            var a = i(33008),
                ...
                c = i.n(o);
            let d = (e) => {
                let { agent: t, isPlaying: i, isCurrent: o, onPlayButtonClick: d, shouldShowControl: u = !0, playButtonIconSize: m, alt: _, className: g } = e,
                    p = (0, l.L)(() => {
                ...
                return (0, a.jsx)(s.q1, {
                    ...
                    className: (0, r.$)(c().root, c()['root_radius_'.concat(p)], { [c().root_withShadow]: !!t.entityType }, g),
                    radius: p,
                    onPlayButtonClick: d,
                    isPlaying: i,
                    isCurrent: o,
        ...
        12884: (e, t, i) => {
            ...
            (0, r.setWasmUrl)(''.concat(window.location.origin, '/dotlottie-player.wasm'));
            let b = (0, l.PA)((e) => {
                        ...
                        if (s && j && P) {
                            ...
                            let {
                                    ...
                                    let { averageColor: t, theme: i, custom: a } = e,
                                        ...
                                        o = [0, 0, 0];
                                    a
                                        ? (i === p.Sxu.Dark || (s += 79), (o = (0, p.YLU)(r, y(n), y(s))))
                                        : (o = (0, p.YLU)(r, (n > 25 ? Math.min(n + 25, 60) : n) / 100, (s > 20 ? Math.min(s + 15, 60) : s) / 100));
                                    let c = i === p.Sxu.Dark ? [0.07, 0.07, 0.07] : [0.96, 0.96, 0.96];
                                    return {
                                        color: o,
                                        glow1: i === p.Sxu.Dark ? (0, p.YLU)(r, y(n), y(s + 36)) : (0, p.YLU)(r, y(n), y(s - 29)),
                                        glow2: i === p.Sxu.Dark ? (0, p.YLU)(r, y(n), y(s + 79)) : (0, p.YLU)(r, y(n), y(s - 53)),
                                        mask: c,
                                    };
                ...
                return (0, a.jsxs)('div', {
                    ...
                    children: [
                        (0, a.jsxs)('div', {
                            className: (0, n.$)(C().cover, { [C().cover_round]: f, [C().cover_loading]: N }),
                            children: [
                                t.entityType &&
                                    I &&
                                    (0, a.jsx)(_.Image, { src: I, size: 200, fit: 'cover', withAvatarReplace: !0, className: C().image, withLoadingIndicator: !1 }),
                                (0, a.jsx)(x, { src: t.animationUri, loop: !0, dotLottieRefCallback: l, className: C().animation }),
                            ],
                        }),
                        (0, a.jsx)(g.Shimmer, { className: (0, n.$)(C().shimmer, { [C().shimmer_loading]: N }), isActive: !0, radius: f ? 'round' : 's' }),
                    ],
                });
            });
        },
        ...
        17999: (e, t, i) => {
            ...
            let s = (e) => {
                    ...
                    return (0, a.jsx)(n.OY, {
                        ...
                        headingVariant: g,
                        ...p,
                        children: null == c ? void 0 : c.map((e) => (0, a.jsx)(l.PlaylistCard, { playlist: e, contentLinesCount: 3 }, e.key)),
                    });
                },
                o = (0, r.forwardRef)((e, t) => (0, a.jsx)(s, { forwardRef: t, ...e }));
        },
        19525: (e) => {
            e.exports = {
        ...
        23415: (e, t, i) => {
            ...
            let v = (0, n.PA)((e) => {
                let { vibe: t, className: i } = e,
                    ...
                    L = (0, o.L)(() =>
                        (0, a.jsx)(m.O0, { onClick: k, isPinned: t.isPinned, className: (0, r.$)(y().pinButton, y().control), withRipple: !1 }, t.getKey('PinButton')),
                    ),
                    N = (0, o.L)(() =>
                        (0, a.jsxs)('div', {
                            className: y().cover,
                            children: [
                                t.agent && (0, a.jsx)(g.VibeCardView, { agent: t.agent, isPlaying: P }),
                                (0, a.jsx)(c.hg, { isVisible: b, className: y().controls, playControl: w, pinControl: L }),
                            ],
                        }),
                    );
                return (0, a.jsx)(c.MN, {
                    ...
                    view: N,
                    textPosition: 'center',
                    title: (0, a.jsx)(d.Caption, { variant: 'div', type: 'entity', size: 's', weight: 'medium', lineClamp: 2, children: t.title }),
                    description: (0, a.jsx)(d.Caption, { variant: 'div', type: 'entity', size: 's', weight: 'medium', lineClamp: 1, children: t.description }),
        ...
        28972: (e, t, i) => {
            ...
            let x = (e) => {
                ...
                return (0, n.useCallback)(async () => {
                    if (!e) return;
                    if (!t.isAuthorized)
                        return void d((0, a.jsx)(c.hT, { error: u({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: o.uQT.ERROR });
                    if (m) return;
        ...
        45242: (e, t, i) => {
            ...
            let n = (e) => {
                var t, i;
                let { playlist: n, generatedPlaylistType: l, likesCount: s, trailer: o, tracksCount: c } = e;
                return (0, a.wg)({
            ...
            (0, s.cache)(async (e, t) => {
                ...
                let a;
                try {
                    let { container: i, backendHostTld: n, locale: l, host: s, fullUrl: o, isRSC: c, requestUrl: d } = await (0, r.IhE)();
                    if (c) return { playlist: void 0, backendHostTld: n, locale: l, host: s, fullUrl: o, requestUrl: d };
                    let u = i.get(r._19);
                    a = {
                ...
                (0, s.cache)(async (e) => {
                    ...
                    try {
                        let { container: t, backendHostTld: a, locale: n, host: l, fullUrl: s, isRSC: o, requestUrl: c } = await (0, r.IhE)();
                        if (o) return { playlist: void 0, backendHostTld: a, locale: n, host: l, fullUrl: s, requestUrl: c };
                        let d = t.get(r.qNr);
                        i = {
                            playlist: await d.getPlaylist({ playlistUuid: e, resumeStream: !1, richTracks: !1 }),
                            backendHostTld: a,
                            locale: n,
                            host: l,
                            fullUrl: s,
            ...
            let c = (e) => ({ uid: e.uid, login: e.login, name: e.name, sex: e.sex, verified: e.verified }),
                d = (e) =>
                    (0, a.wg)({
                        ...
                        modified: e.modified,
                        madeFor: e.madeFor
                            ? ((e) => (0, a.wg)({ userInfo: e.userInfo ? c(e.userInfo) : null, caseForms: e.caseForms ? (0, r.NH4)(e.caseForms) : null }))(e.madeFor)
                            : null,
                    });
            var u = i(70879);
            let m = (e) => {
                var t, i;
                return (0, a.wg)({ ...(0, o.jX)(e), artists: null != (i = null == e || null == (t = e.artists) ? void 0 : t.map(u.dM)) ? i : [] });
            };
            var _ = i(61744);
            let g = (e) => {
                var t, i;
            ...
            let v = a.gK.model('PlaylistOwner', {
                ...
                C = a.gK.model('PlaylistOwner', { userInfo: a.gK.maybeNull(v), caseForms: a.gK.maybeNull(p.lg) }),
        ...
        54344: (e, t, i) => {
            ...
            var c = i(59615);
            let d = a.gK.model('VibeAgent', { animationUri: a.gK.string, cover: c.$B, entityType: a.gK.maybe(a.gK.string) });
            var u = i(73273),
                m = i(51379),
                _ = i(79169);
            let g = a.gK
                ...
                .views((e) => {
                    let t = {
                        ...
                        get shouldShowAgent() {
                            if (!(0, a._n)(e)) return !1;
                            let { experiments: t } = (0, a.Zn)(e);
                            return t.checkExperiment(_.zal.WebNextWaveAgentExperiment, 'on');
                        },
                    };
                    return t;
                })
                .actions((e) => ({
                    ...
                    getDescription() {
                        ...
                        return i.checkExperiment(_.zal.WebNextVibeDescription, 'on') && void 0 !== (null == e ? void 0 : e.description) ? e.description : t;
                    },
                }));
            var p = i(54621),
                y = i(23415),
        ...
        54621: (e, t, i) => {
            ...
            var a = i(33008),
                ...
                v = i.n(y);
            let C = (0, n.PA)((e) => {
                let { className: t, vibe: i, cover: n, coverClassName: y, playButtonIconSize: C, description: x, agentVariant: b } = e,
                    ...
                    [N, B] = (0, l.useState)(!1),
                    K = (0, u.PT7)(),
                    { isPlaying: T, togglePlay: V, isCurrent: S } = (0, u.B0S)({ seeds: i.seeds, pageIdForFrom: P, blockIdForFrom: j }),
                    E = (0, o.c)(() => {
                        if (!K()) {
                    ...
                    U = (0, l.useCallback)(() => {
                        if (i.shouldShowAgent && i.agent && b)
                            switch (b) {
                                case _.h.LARGE:
                                    return (0, a.jsxs)('div', {
                                        className: (0, r.$)(v().root, m.$f.playButtonCell, y),
                                        children: [
                    ...
                    }, [b, null == n ? void 0 : n.color, null == n ? void 0 : n.uri, y, x, E, S, T, C, i.agent, i.shouldShowAgent, i.title]);
                return (0, a.jsxs)(m.Cj, {
                    ...
                    children: [
                        ...
                        (0, a.jsx)(m.ro, {
                            title: (0, a.jsx)(d.Caption, { className: (0, r.$)(m.$f.text, m.$f.titleText), size: 'm', variant: 'div', type: 'text', children: i.title }),
                            description: x,
                        }),
                    ],
                });
        ...
        56395: (e, t, i) => {
            ...
            let A = (0, n.PA)((e) => {
                ...
                let { playlist: i, onOpenChange: r, open: n, ...l } = e,
                    { shouldShowBuySubscriptionModal: d, showBuySubscriptionModal: m } = (0, x.qBP)(),
                    {
                        experiments: _,
                        settings: { isMobile: g },
                        trailer: p,
                    ...
                    w = (0, P.A_)({ entityVariant: x.DwC.PLAYLIST, urlParams: { id: i.uid, kind: i.kind } });
                (0, x.NBO)(n);
                let L = (0, u.c)(() => {
                    if (d) return void m();
            ...
            let I = (0, n.PA)((e) => {
                let { className: t, playlist: i, children: n, contentLinesCount: k, customDescription: P } = e,
                    ...
                    { from: N, utmLink: B } = (0, x.fyy)({ contextId: i.uuid, contextType: d.K.Playlist }),
                    { formatMessage: K } = (0, s.A)(),
                    { sendLikeSearchFeedback: T, sendNavigateSearchFeedback: V, sendPlaySearchFeedback: S } = (0, x.zEv)(),
                    [E, z] = (0, l.useState)(!1),
                    [R, U] = (0, l.useState)(!1),
                    [O, M] = (0, l.useState)(!1),
                    $ = (0, h.r)(i),
                ...
                return (0, a.jsxs)(_.MN, {
                    ...
                    title: (0, a.jsx)(y.Caption, {
                        ...
                        children: (0, a.jsx)(b.N_, { className: j().titleLink, href: i.url, onClick: et, children: i.title }),
                    }),
                    srTitle: (0, a.jsx)(b.N_, { href: i.url, onClick: et, children: i.title }),
        ...
        75658: (e, t, i) => {
                                ...
                                children: [
                                    (0, a.jsx)(v.aQ, {
                                        fallback: (0, a.jsx)(v.cy, {
                                            size: 'xs',
                                            iconSize: s,
                                            className: (0, r.$)(h().item, h().likeIcon),
                                            isLiked: n.isLiked,
                                            onClick: k,
                                    ...
                                    (null == (t = n.trailer) ? void 0 : t.isAvailable) &&
                                        (0, a.jsx)(v.aQ, {
                                            fallback: (0, a.jsx)(v.kJ, {
                                                className: (0, r.$)(h().item, h().trailerIcon),
                                                iconSize: 'xs',
                                                variant: 'text',
                                                onClick: A,
                                                withRipple: !1,
            ...
            var P = i(19525),
                A = i.n(P);
            let f = (0, n.PA)((e) => {
                let { className: t, playlist: i, pageId: n, coverClassName: x, playButtonIconSize: b, likeIconSize: h } = e,
                    ...
                    H = (0, l.useCallback)(
                        (e) =>
                            (0, a.jsx)(v.q1, {
                                ...
                                alt: K({ id: 'entity-names.playlist-name' }, { playlistName: B }),
                                radius: 'xs',
                                ...e,
                            }),
                        [i, B, x, K],
                    ),
                    X = null == H ? void 0 : H({ onPlayButtonClick: F, isPlaying: R, isCurrent: U, playButtonIconSize: b }),
                    Z = (0, l.useMemo)(
                        () =>
                            i.url && i.isAvailable
                                ? (0, a.jsx)(v.N_, { className: (0, r.$)(v.$f.text, v.$f.titleLink), href: i.url, onClick: Y, children: B })
                                : (0, a.jsx)(p.Caption, { className: (0, r.$)(v.$f.text, v.$f.titleText), size: 'm', variant: 'div', type: 'text', children: B }),
                    ...
                    W = (0, l.useMemo)(() => {
                        ...
                        let e = (0, a.jsx)(p.Caption, { variant: 'span', size: 'm', weight: 'medium', 'aria-hidden': !0, children: '•' }),
                            ...
                            r = ''.concat(N, ' ').concat(K({ id: 'entity-names.tracks-count' }, { value: i.tracksCount }));
                        return (0, a.jsxs)('div', {
                ...
                return (0, a.jsxs)(v.Cj, {
                    ...
                    children: [X, (0, a.jsx)(v.ro, { isDisabled: !i.isAvailable, title: Z, description: W }), (0, a.jsx)(k, { playlist: i, likeIconSize: h })],
                });
            });
        },
        84781: (e) => {
            ...
            let m = (e) => {
                ...
                return (0, a.jsxs)('div', {
                    ...
                    children: [
                        ...
                        (0, a.jsx)(c.Heading, { variant: 'h3', size: 'xs', className: u().title, ...(0, s.Am)(s.Kq.playlist.PLAYLIST_EMPTY_BLOCK_TITLE), children: d }),
                        (0, a.jsx)(c.Caption, {
                            variant: 'span',
                            size: 'l',
        ...
        96025: (e, t, i) => {
            ...
            let b = (e) => {
                    ...
                    return (0, a.jsx)(g.Shimmer, { isActive: t, className: (0, r.$)(x().root, i) });
                },
                h = (0, n.PA)((e) => {
                    let { className: t, vibe: i } = e,
                        ...
                        { toggleTrue: k, toggleFalse: P, state: A } = (0, c.e)(!1),
                        { isFreemium: f } = (0, y.XCI)(),
                        { isPlaying: j, togglePlay: I } = (0, y.B0S)({ seeds: i.seeds, pageIdForFrom: g, blockIdForFrom: C }),
                        w = (0, y.brA)(),
                        L = (0, l.useCallback)(
                            (e) => {
                                f ||
                        ...
                        B = j ? 'pause' : 'play',
                        K = j ? o.e8.landing.VIBE_DISCOVERY_ITEM_PAUSE_ICON : o.e8.landing.VIBE_DISCOVERY_ITEM_PLAY_ICON,
                        T = (0, l.useCallback)(
                            () =>
                                (0, a.jsxs)(u.Button, {
                                    style: N,
                                    ...
                                    variant: 'text',
                                    onClick: L,
                                    className: (0, r.$)(x().root, x().button, { [x().button_loading]: A }, t),
                                        ...
                                        (0, a.jsxs)('span', {
                                            ...
                                            children: [
                                                ...
                                                (0, a.jsxs)('span', {
                                                    ...
                                                    children: [
                                                        (0, a.jsx)(m.Icon, { className: x().icon, size: 'xxs', variant: B, ...(0, o.Am)(K) }),
                                                        (0, a.jsx)(p.Caption, {
                                                            className: x().title,
                                                            variant: 'span',
                                                            size: 's',
                    ...
                    return (0, a.jsx)(v.SU, { isEnabled: f, placement: 'top', textVariant: 'vibe', vibeTextVariant: i.stationType, renderChildren: T });
                });
        },
        96973: (e) => {
            e.exports = {
