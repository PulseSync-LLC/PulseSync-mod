...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3789, 3970, 4793, 6293, 9635],
    {
        ...
        22389: (e, t, r) => {
            ...
            var _ = r(18557);
            let U = function (e, t, r, n, o, a, s) {
                var U = E(e, r),
                    P = E(t, r),
                    S = s.get(P);
                if (S) return void i(e, r, S);
                var T = a ? a(U, P, r + '', e, t, s) : void 0,
                    C = void 0 === T;
                if (C) {
                    var R = (0, f.A)(P),
                        g = !R && (0, m.A)(P),
        ...
        24793: (e, t, r) => {
            ...
            let d = (e) => {
                var t;
                let r = (0, l.w)('https://api.music.qa.yandex.'.concat(i.B), e);
                return (0, n.A)((0, s.config)(), {
                    ...
                    mocks: {
                        enabled: (null != (t = u.env.NEXT_PUBLIC_MOCKS_ENABLED) ? t : 'true') === 'true',
                        urlCapturePattern: u.env.NEXT_PUBLIC_MOCK_URL_CAPTURE_PATTERN || ''.concat(r, '/*'),
                    },
                });
            };
        },
