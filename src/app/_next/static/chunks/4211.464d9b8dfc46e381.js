...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [4211],
    {
            ...
            Object.create && ((n.prototype = Object.create(null)), new n().__proto__ || (r = !1)),
                ...
                (s.prototype.emit = function (e, t, n, o, i, a) {
                    ...
                    if (h.fn) {
                        ...
                        var f,
                            d = h.length;
                        for (u = 0; u < d; u++)
                            switch ((h[u].once && this.removeListener(e, h[u].fn, void 0, !0), c)) {
                                case 1:
                ...
                (s.prototype.removeListener = function (e, t, n, o) {
                    ...
                    if (s.fn) s.fn !== t || (o && !s.once) || (n && s.context !== n) || a(this, i);
                        ...
                        for (var l = 0, u = [], h = s.length; l < h; l++) (s[l].fn !== t || (o && !s[l].once) || (n && s[l].context !== n)) && u.push(s[l]);
        ...
        21971: (e, t, r) => {
            Object.defineProperty(t, '__esModule', { value: !0 }), (t.MemoryStorage = t.CookieStorage = t.isSupported = t.storage = void 0);
            var n = a(r(76825)),
                o = a(r(27016)),
                i = a(r(50455));
            function a(e) {
            ...
            var o = (function (e) {
                ...
                a = (function () {
                    function e() {
                        ...
                        (this.cookieOptions = Object.assign({ path: '/' }, t)), (i = void 0 === t.prefix ? i : t.prefix);
                    }
                    return (
                        n(e, [
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return t && t.hasOwnProperty(i + e) ? t[i + e] : null;
                                },
                            },
                            {
                                key: 'setItem',
                                value: function (e, t) {
                                    return (document.cookie = o.default.serialize(i + e, t, this.cookieOptions)), t;
                                },
                            },
                            {
                                key: 'removeItem',
                                value: function (e) {
                                    ...
                                    return (document.cookie = o.default.serialize(i + e, '', t)), null;
                                },
                            },
                            {
                                key: 'clear',
                                value: function () {
                                    ...
                                    for (var t in e) 0 === t.indexOf(i) && this.removeItem(t.substr(i.length));
                                    return null;
                                },
                            },
                        ]),
        ...
        34211: (e, t, r) => {
            r.r(t), r.d(t, { VHPlayerCoreAdapter: () => S, loadVHPlayerSdk: () => y });
            var n,
                o,
                i = r(62205);
                ...
                f =
                    -1 === a.indexOf('__VPUID')
                        ...
                        : (u.getItem(s) ??
                          (function () {
                              let e = [];
                              for (let t = 0; t < 10; t++) e.push(c[Math.floor((0, h.y)() * c.length)]);
                              return e.join('');
                          })());
            async function d(e) {
                let t = [
            ...
            async function g(e) {
                ...
                await d({ file: 'player-sdk.js', version: e?.version, checkLoad: () => !!p(() => m.Ya.playerSdk)?.preloadScripts }),
            ...
            class S {
                ...
                currentTimeChangeHandler() {
                    ...
                    this.emitter.emit('currentTimeChange', { duration: e, position: t, loaded: 0 });
                }
                volumeChangeHandler() {
                ...
                subscribePlayerEvents() {
                    this.player &&
                        (this.player.on(n.StatusChange, this.statusChangeHandler),
                        this.player.on(n.CurrentTimeChange, this.currentTimeChangeHandler),
                        this.player.on(n.VolumeChange, this.volumeChangeHandler),
                        this.player.on(n.ErrorChange, this.errorChangeHandler));
                }
                unsubscribePlayerEvents() {
                    this.player &&
                        (this.player.off(n.StatusChange, this.statusChangeHandler),
                        this.player.off(n.CurrentTimeChange, this.currentTimeChangeHandler),
                        this.player.off(n.VolumeChange, this.volumeChangeHandler),
                        this.player.off(n.ErrorChange, this.errorChangeHandler));
                }
                get adConfig() {
                ...
                initPlayer(e) {
                    ...
                    (this.player = window.Ya.playerSdk.init({ element: n, source: t, hiddenControls: '*', autoplay: r, adConfig: this.adConfig })),
                        this.subscribePlayerEvents(),
                        null !== this.storedVolume && (this.player.setVolume(this.storedVolume), (this.storedVolume = null));
                }
                play(e) {
                    let { source: t } = e;
                ...
                internalSetSrc(e) {
                    ...
                    if (this.player)
                        return this.player.setSource({ source: t.src, autoplay: r, adConfig: this.adConfig }).then(() => {
                            if (null !== this.storedVolume) {
                                var e;
                                null == (e = this.player) || e.setVolume(this.storedVolume), (this.storedVolume = null);
                            }
                        });
                    try {
                        return this.container && this.initPlayer({ src: t.src, autoplay: r, container: this.container }), Promise.resolve();
                    } catch (e) {
                ...
                pause() {
                    var e;
                    return null == (e = this.player) || e.pause(), Promise.resolve();
                }
                resume() {
                ...
                setProgress(e) {
                    var t;
                    return null == (t = this.player) || t.seek(e), Promise.resolve(e);
                }
                setVolume(e) {
                    var t;
                    return (this.storedVolume = e), null == (t = this.player) || t.setVolume(e), Promise.resolve(e);
                }
                setSpeed(e) {
                ...
                constructor(e) {
                    (0, v._)(this, 'player', null),
                        ...
                        (this.currentTimeChangeHandler = this.currentTimeChangeHandler.bind(this)),
        ...
        62205: (e, t, r) => {
            ...
            function i(e) {
                return new Promise((t, r) => {
                    !(function (e) {
                        let { dropCacheOnRetry: t = !1, onBeforeLoad: r = n, retries: i = 0 } = e;
                        ...
                        t &&
                            ...
                            (function e(t) {
                                let {
                                    ...
                                    g = (n) => {
                                        l > 0 ? (u(n), e({ ...t, src: r, retries: l - 1 })) : p(n), m.parentNode?.removeChild(m);
                                    };
                                (m.type = 'text/javascript'),
                                    (m.async = s),
                                    (m.onload = () => (c(m) ? d() : g(Error(`checkLoad for ${r} failed`)))),
                                    (m.onerror = (e) => {
                                        try {
                                            i.setTimeout(() => {
                                                g(e);
        ...
        76825: (e, t, r) => {
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.default = function () {
                    ...
                    throw Error(
                        'Storage method `' + e + '` is not available.\n    Please use one of the following: localStorage, sessionStorage, cookieStorage, memoryStorage.',
                    );
                });
            var n = r(27016),
                o = '__test';
