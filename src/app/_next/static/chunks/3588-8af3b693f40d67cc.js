    ...
    [3588],
    {
            ...
            let x = (0, l.PA)((e) => {
                let { className: t } = e,
                    ...
                    A = (0, s.useCallback)(async () => {
                        if (h.current) return;
                        h.current = !0;
                        let e = await l.create({ title: i({ id: 'entity-names.new-playlist' }), visibility: u.L.PUBLIC });
                        if (e) {
                ...
                return (
                    ...
                    (0, r.jsxs)('div', {
                        ...
                        children: [
                            (0, r.jsx)(m.Button, {
                                className: g().button,
                                icon: (0, r.jsx)(_.Icon, { className: g().icon, variant: 'add', size: 'l' }),
                                radius: 's',
        ...
        22721: (e, t, i) => {
            ...
            var r = i(33008),
                ...
                m = i.n(u);
            let _ = (0, a.PA)((e) => {
                let { entityTitle: t, entityVariant: i, entityCoverUri: a, playlist: u, closeToast: _ } = e,
                    ...
                    v = (0, l.useMemo)(() => {
                        ...
                        switch (i) {
                            case d.cp.PODCAST_EPISODE:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.removed-podcast-episode-from-playlist', values: a });
                                break;
                            case d.cp.AUDIOBOOK_EPISODE:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.removed-audiobook-episode-from-playlist', values: a });
                                break;
                            default:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.removed-track-from-playlist', values: a });
                        }
        ...
        25911: (e, t, i) => {
            ...
            let r = (e) => {
                ...
                return e
                    ? {
                          ...
                          isPremiere: !1,
                          durationMs: 0,
                          cover: { uri: e.coverUri || '', type: 'pic', prefix: '', custom: !1 },
                          ogImage: e.coverUri || '',
                          tags: [],
            ...
            var d = i(30293);
            let u = (e) => {
                let { operation: t, position: i, startPosition: r, endPosition: a, tracks: l } = e,
                    n = ((e) =>
                        Object.keys(e)
                            .filter((t) => void 0 !== e[t])
                            .reduce((t, i) => ((t[i] = e[i]), t), {}))({ op: t, at: i, from: r, to: a, tracks: l });
            ...
            let b = a.gK
                    ...
                    .views((e) => ({
                        ...
                        get pinId() {
                            return ''.concat(x._.PLAYLIST_ITEM).concat(e.uid, '_').concat(e.kind);
                        },
                        get id() {
                    ...
                    .actions((e) => ({
                        ...
                        changePlaylist: (0, a.L3)(function* (t) {
                            ...
                            let { usersResource: i, modelActionsLogger: r } = (0, a._$)(e);
                            try {
                                var l, n;
                        ...
                        changeTitle: (0, a.L3)(function* (t) {
                            ...
                            let { usersResource: i, modelActionsLogger: r } = (0, a._$)(e);
                            if (e.canUserChange) {
                                if (t.length < 1 || t.length > c) return l.FlZ.ERROR;
                                let a = e.title;
                                e.title = t;
                                try {
                        ...
                        deletePlaylist: (0, a.L3)(function* () {
                            if (!(0, a._n)(e) || !e.canUserChange) return l.FlZ.ERROR;
                            let { pinsCollection: t } = (0, a.Zn)(e),
                ...
                C = a.gK.model('CreatePlaylist', { meta: a.gK.maybeNull(b) }).actions((e) => ({
                ...
                k = b.props({ tracks: a.gK.maybe(a.gK.array(A.eD)) }).actions((e) => ({ getKey: (t) => ''.concat(t, '_').concat(e.id) }));
            var j = i(80593),
                T = i(13807),
                P = i(72455),
                R = i(64399),
        ...
        28996: (e, t, i) => {
            ...
            let v = (e) => {
                    ...
                    return (0, l.jsx)(_.$W, {
                        message: (0, l.jsx)(m.Caption, {
                            ...
                            type: 'controls',
                            size: 'm',
                            children: (0, l.jsx)(u.A, { id: 'playlist-errors.failed-part-tracks-download-xlsx' }),
                        }),
                        closeToast: t,
                    });
                },
                y = (e) => {
                    ...
                    return (0, l.jsx)(_.$W, {
                        message: (0, l.jsx)(m.Caption, {
                            ...
                            type: 'controls',
                            size: 'm',
                            children: (0, l.jsx)(u.A, { id: 'playlist-errors.failed-download-xlsx' }),
                        }),
                        closeToast: t,
                    });
                };
            ...
            let h = (e) => {
                    ...
                    return (0, l.jsx)(_.$W, {
                        message: (0, l.jsx)(m.Caption, {
                            ...
                            size: 'm',
                            className: x().text,
                            children: (0, l.jsx)(u.A, { id: 'notifications-info.xlsx-success' }),
                        }),
                        closeToast: t,
                        coverRadius: 's',
                    });
                ...
                A = () =>
                    (0, l.jsx)(_.$W, {
                        message: (0, l.jsx)(m.Caption, {
                            ...
                            size: 'm',
                            className: x().text,
                            children: (0, l.jsx)(u.A, { id: 'notifications-info.xlsx-loading' }),
                        }),
                        coverRadius: 's',
                    }),
                b = function () {
            ...
            let R = (0, n.PA)((e) => {
                    ...
                    return (0, l.jsx)(c.Dr, {
                        onClick: i,
                        isSubMenu: !0,
                        children: (0, l.jsx)(m.Caption, { variant: 'div', lineClamp: 1, children: (0, l.jsx)(u.A, { id: 'interface-actions.navigate-to-admin' }) }),
                    });
                }),
                E = (0, n.PA)((e) => {
                    let { entityVariant: t, adminUrl: i, withPlaylistPageFeatures: a, className: n, isDisabled: d } = e,
                        {
                            settings: { isMobile: u },
                        } = (0, r.Pjs)(),
                    ...
                    return (0, l.jsxs)(c.W1, {
                        ...
                        children: [i && (0, l.jsx)(R, { adminUrl: i }), _ && (0, l.jsx)(j, {}), p && (0, l.jsx)(k, {}), f && (0, l.jsx)(C, {}), v && !1],
                    });
                });
        },
        30443: (e) => {
        ...
        37548: (e, t, i) => {
            ...
            let u = (e) => {
                ...
                return (0, r.jsxs)(o.N_, {
                    ...
                    children: [
                        (0, r.jsx)(n.Icon, { className: d().icon, variant: 'bandlink' }),
                        (0, r.jsxs)('div', {
                                ...
                                (0, r.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, r.jsx)(s.Caption, {
                                            ...
                                            children: (0, r.jsx)(l.A, { id: 'artist.artist-in-playlists' }),
                                        }),
                                        (0, r.jsx)(n.Icon, { variant: 'link', size: 'xxs', className: d().descriptionTitleButton }),
                                    ],
                                }),
                                (0, r.jsx)(s.Caption, { variant: 'div', size: 'l', weight: 'medium', className: d().descriptionArtist, children: null != c ? c : '' }),
                            ],
                        }),
                    ],
                });
                    ...
                    children: t.map((e, t) => {
                        ...
                        return (0, r.jsx)(
                            n.N_,
                            {
                                href: e.url,
                                className: o().link,
                                'aria-label': s({ id: 'artist.artist-links-label' }, { artistName: i, linkName: e.title }),
        ...
        46595: (e, t, i) => {
            ...
            let d = (e) => {
                ...
                u = (e) => {
                    ...
                    return (0, l.useCallback)(async () => {
                        if (!t.isAuthorized)
                            return void i((0, r.jsx)(c.hT, { error: _({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: o.uQT.ERROR });
                        if (u) return;
            ...
            var r,
                ...
                l = {
                    ...
                    5817: function (e, t, i) {
                        ...
                        t.CardControls = (e) => {
                            ...
                            return (0, a.jsxs)('div', {
                                ...
                                children: [
                                    (0, a.jsx)('div', { className: s.default.top, children: c }),
                                    (0, a.jsxs)('div', {
                                        className: (0, l.clsx)(s.default.bottom, _),
                                        children: [
                                            f && (0, a.jsxs)('div', { className: s.default.bottom_left, children: [d, i] }),
                                            v && (0, a.jsxs)('div', { className: s.default.bottom_right, children: [o, r] }),
                                        ],
                                    }),
                                    !!p && (0, a.jsx)(n.Label, { className: s.default.label, children: p }),
                                ],
                            });
                        };
                    },
                    440: function (e, t, i) {
                        ...
                        let a = i(1082),
                            ...
                            d = (e) => {
                                ...
                                return (0, a.jsxs)('div', {
                                    ...
                                    ...y,
                                    children: [
                                        (0, a.jsx)(o.SROnly, { tabIndex: -1, children: null != v ? v : u }),
                                        (0, a.jsx)('div', { className: c.default.viewContainer, children: i }),
                                        (0, a.jsxs)('div', {
                        ...
                        t.EntityCard = (0, l.forwardRef)((e, t) => (0, a.jsx)(d, { forwardRef: t, ...e }));
                    },
                    2: function (e, t, i) {
                        var r =
                            (this && this.__importDefault) ||
                    ...
                    2865: function (e, t, i) {
                        ...
                        t.SROnly = (e) => {
                            let { className: t, focusable: i, children: r, ...o } = e,
                                c = (0, l.clsx)(s.default.root, { [s.default.focusable]: i }, t);
                            return (0, n.isValidElement)(r)
                                ? (0, n.cloneElement)(r, { ...o, className: (0, l.clsx)(c, r.props.className) })
                    ...
                    7743: function (e, t, i) {
                        ...
                        (t.CaptionComponent = (e) => {
                            ...
                            return (0, a.jsx)(s.Typography, {
                                variant: i,
                                ref: t,
                                className: (0, l.clsx)(o.default.root, o.default['root_'.concat(r, '_').concat(n)], o.default['root_weight_'.concat(u)], c),
                                ...m,
                                children: d,
                            });
                        }),
                    ...
                    404: function (e, t, i) {
                        ...
                        (t.HeadingComponent = (e) => {
                            ...
                            return (0, a.jsx)(s.Typography, {
                                variant: i,
                                ref: t,
                                className: (0, l.clsx)(o.default.root, o.default['root_size_'.concat(n)], o.default['root_weight_'.concat(r)], c),
                                ...u,
                                children: d,
                            });
                        }),
                    ...
                    4721: function (e, t, i) {
                        ...
                        let a = i(1082),
                            ...
                            s = r(i(5818));
                        function o(e) {
                            let { forwardRef: t, style: i, className: r, children: n, variant: o, lineClamp: c, ...d } = e,
                        ...
                        (0, r.jsxs)(o.Dr, {
                            ...
                            children: [
                                (0, r.jsx)(c.Paper, {
                                    radius: 'round',
                                    className: _().cover,
                                    children: (0, r.jsx)(s.Image, { withAvatarReplace: !0, src: t.coverUri, size: 100, fit: 'contain', className: _().image }),
                                }),
                                (0, r.jsx)(d.Caption, { variant: 'span', size: 'm', weight: 'medium', lineClamp: 1, children: t.name }),
                            ],
                        }),
                        m,
                    ],
        ...
        70400: (e, t, i) => {
            ...
            let d = (e) => {
                let { lastMonthListeners: t, lastMonthListenersDelta: i } = e,
                    o = (0, l.useMemo)(() => {
                        let e = (0, r.jsx)('br', {});
                        if (0 === i) return (0, r.jsx)(n.A, { id: 'artist.stats-same-listeners-per-month', values: { br: e } });
                        let t = (0, r.jsx)(s.Caption, {
                            variant: 'span',
                            className: (0, a.$)({ [c().statsNumber_positive]: i > 0, [c().statsNumber_negative]: i < 0 }),
                            size: 'l',
                            weight: 'medium',
                            children: Math.abs(i).toLocaleString('ru'),
                        });
                        return i > 0
                            ? (0, r.jsx)(n.A, { id: 'artist.stats-more-listeners-per-month', values: { number: t, br: e, nbsp: '\xa0' } })
                            : (0, r.jsx)(n.A, { id: 'artist.stats-less-listeners-per-month', values: { number: t, br: e, nbsp: '\xa0' } });
                    }, [i]);
                return (0, r.jsxs)('div', {
                    children: [
                        (0, r.jsx)(s.Caption, {
                            ...
                            size: 'l',
                            weight: 'medium',
                            children: (0, r.jsx)(n.A, { id: 'artist.stats-listeners-per-month' }),
                        }),
                        (0, r.jsx)(s.Heading, { size: 'xxl', variant: 'div', className: c().count, children: t.toLocaleString('ru') }),
                        (0, r.jsx)(s.Caption, { variant: 'div', className: c().stats, size: 'l', weight: 'medium', children: o }),
                    ],
                });
            };
        },
        70879: (e, t, i) => {
                    ...
                    return e
                        ? {
                              ...
                              counts: {
                                  ...
                                  tracks: (null == (a = e.counts) ? void 0 : a.tracks) || 0,
                                  alsoTracks: 0,
                              },
            ...
            let s = function () {
                ...
                o = (e) => {
                    ...
                    return (0, l.wg)({
                        ...
                        decomposed: r,
                        counts: a,
                        isAvailable: null == (i = null == e ? void 0 : e.available) || i,
                        disclaimers: e.disclaimers,
                        trailer: o,
                    });
                },
                c = (e) => {
                    var t, i;
                    let { artist: r, trailer: a, isComposer: o, likesCount: c } = e,
                        d = s(r.decomposed),
            ...
            var d = i(75227),
                ...
                _ = i(73480),
                p = i(55142);
            let f = l.gK.model('ArtistLink', { imgUrl: l.gK.maybeNull(l.gK.string), title: l.gK.maybeNull(l.gK.string), url: l.gK.maybeNull(l.gK.string) });
            var v = i(34874),
                y = i(93435),
                g = i(60866),
                x = i(59615);
            let h = l.gK
                    ...
                    .views((e) => ({
                        ...
                        get modalDisclaimerId() {
                            if (e.disclaimers) {
                                var t;
                                let i = null == (t = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : t[0];
                                if (i) {
                                    let { id: e } = i;
                                    return e;
                                }
                        ...
                        get isForeignAgent() {
                            ...
                            let { experiments: t } = (0, l.Zn)(e),
                                a = !!(null == (i = e.disclaimers) ? void 0 : i.includes(y.M.FOREIGN_AGENT));
                            if (e.disclaimers) {
                                let t = null == (r = (0, n.bRW)(e.disclaimers, y.M.FOREIGN_AGENT)) ? void 0 : r[0];
                                a = (null == t ? void 0 : t.type) === y.M.FOREIGN_AGENT;
                            }
                            return a && t.checkExperiment(n.zal.WebNextAgentArtist, 'on');
                        },
                        get isLegalRejected() {
                            var a;
                            if (!(0, l._n)(e) || !e.disclaimers || e.isAvailable) return !1;
                            let t = null == (a = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : a[0];
                        ...
                        get isUnsafeLegal() {
                            ...
                            if (e.disclaimers) {
                                var s;
                                let t = null == (s = (0, n.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : s[0];
                                return e.isAvailable && (null == t ? void 0 : t.type) === y.M.MODAL;
                            }
                            return !1;
                        },
                    }))
                ...
                A = l.gK.model('Counts', { albums: l.gK.number, compilations: l.gK.number, tracks: l.gK.number }),
                b = h.props({ separator: l.gK.maybe(l.gK.string) }),
                C = h.props({ decomposed: l.gK.maybe(l.gK.array(b)), averageColor: l.gK.maybe(l.gK.string), counts: l.gK.maybe(A) }).views((e) => ({
            ...
            let s = (e) => {
                ...
                return (
                    ...
                    (0, l.c)(async (e) => {
                        ...
                        if ((null == t ? void 0 : t.isUnsafeLegal) && (null == r ? void 0 : r.includes(''.concat(n.nPY.ARTIST, '_').concat(t.id)))) {
                            null == i || i(e);
                            return;
                        }
                ...
                l = {
                        ...
                        let a = i(1082),
                            ...
                            c = (e) => {
                                let {
                                    ...
                                    R = (0, l.useId)(),
                                    E = !l.Children.toArray(c).filter(Boolean).length,
                                    O = 'left' === r,
                                    I = null,
                                ...
                                if (_) {
                                    ...
                                    I = (0, l.cloneElement)(_, {
                                        className: (0, n.clsx)(
                                            o.default.icon,
                                            {
                                                [o.default['icon_position_'.concat(r)]]: r && !E,
                                                [o.default.icon_withButtonSize]: !(null == (N = _.props) ? void 0 : N.size),
                                            },
                                            null == (S = _.props) ? void 0 : S.className,
                                            j,
                                        ),
                                        key: R,
                                    });
                                }
                                let M = (0, l.useMemo)(() => (L ? (0, a.jsx)('div', { className: o.default.spinnerContainer, children: p }) : null), [L, p]),
                                    w = (0, l.useCallback)(
                                        (e) => {
                                            L || (A && (0, s.createRipple)(e, o.default.ripple), null == v || v(e));
                                        },
                                        [L, v, A],
                                    );
                                return (0, a.jsx)('button', {
                                    ...
                                    className: (0, n.clsx)(
                                        o.default.root,
                                        o.default['root_'.concat(u, '_').concat(h)],
                                        o.default['root_radius_'.concat(y)],
                                        o.default.root_size,
                                        {
                                            [o.default['root_'.concat(u, '_withHover_').concat(h)]]: b && !k && !L,
                                            [o.default['root_size_'.concat(g)]]: g,
                                            [o.default.root_withoutBorder]: !C,
                                            [o.default.root_withActiveSpinner]: L,
                                            [o.default.block]: i,
                                            [o.default.flexIcon]: m,
                                            [o.default.iconOnly]: E,
                                            [o.default.root_icon_left]: _ && !E && O,
                                            [o.default.root_icon_right]: _ && !E && !O,
                                        },
                                        d,
                                    ),
                                    type: x,
                                    ...
                                    children:
                                        _ || L
                                            ? (0, a.jsxs)('span', {
                                                  className: (0, n.clsx)(o.default.contentContainer, { [o.default.contentContainer_block]: i }, T),
                                                  children: [_ && O && I, !E && c, _ && !O && I, M],
                                              })
                                            : c,
                                });
                            };
                    ...
                    7459: function (e, t, i) {
                        ...
                        let a = i(1082),
                            ...
                            c = (e) => {
                                let { isChecked: t } = e;
                                return (0, a.jsx)('div', { className: (0, l.clsx)(o.default.icon, { [o.default.icon_checked]: t }) });
                            };
                        t.Toggle = (e) => {
                            let { className: t, isChecked: i = !1, onChange: r, 'aria-label': d, 'aria-describedby': u, ...m } = e,
                                [_, p] = (0, n.useState)(i),
                                f = (0, n.useCallback)(() => {
                                    let e = !_;
                                    p(e), null == r || r(e);
                            ...
                            return (
                                ...
                                (0, a.jsx)(s.Button, {
                                    className: (0, l.clsx)(o.default.root, { [o.default.root_checked]: _ }, t),
                                    radius: 'xxxl',
                                    variant: 'default',
        ...
        80593: (e, t, i) => {
            ...
            let y = (0, l.PA)((e) => {
                let { className: t, playlist: i } = e,
                    ...
                    y = (0, n.useCallback)(async () => {
                        (await i.toggleVisibility()) === _.FlZ.ERROR &&
                            l((0, r.jsx)(p.hT, { error: f({ id: 'playlist-errors.failed-to-change-privacy-settings' }) }), { containerId: _.uQT.ERROR });
                    }, [f, l, i]);
                return (0, r.jsxs)(u.Dr, {
                    ...
                    isBlock: !0,
                    children: [
                        (0, r.jsx)('span', { className: v().caption, children: (0, r.jsx)(o.A, { id: 'playlist-actions.privacy' }) }),
                        (0, r.jsx)(m.l, { isChecked: !i.isPublic, ariaLabel: f({ id: 'playlist-actions.privacy-label' }), tabIndex: -1 }),
                    ],
                });
            });
        },
            ...
            let _ = (0, a.PA)((e) => {
                let { entityTitle: t, entityVariant: i, entityCoverUri: a, playlist: u, closeToast: _ } = e,
                    ...
                    v = (0, l.useMemo)(() => {
                        ...
                        switch (i) {
                            case d.cp.PODCAST_EPISODE:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.added-podcast-episode-to-playlist', values: a });
                                break;
                            case d.cp.AUDIOBOOK_EPISODE:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.added-audiobook-episode-to-playlist', values: a });
                                break;
                            default:
                                e = (0, r.jsx)(n.A, { id: 'notifications-info.added-track-to-playlist', values: a });
                        }
                        return (0, r.jsx)(o.Caption, { className: m().message, variant: 'div', type: 'controls', size: 'm', lineClamp: 1, children: e });
                    }, [t, i, f, u.title, u.url]);
                return (0, r.jsx)(d.$W, {
        ...
        86600: (e, t, i) => {
            ...
            let y = (e) => {
                    let { coverUri: t, title: i, isDisliked: a, closeToast: l } = e,
                        n = (0, m.L)(() =>
                            a
                                ? (0, r.jsx)(u.A, { id: 'notifications-info.artist-unavailable-in-recommendations' })
                                : (0, r.jsx)(u.A, { id: 'notifications-info.artist-available-in-recommendations' }),
                        );
                    return (0, r.jsx)(d.$W, {
                        closeToast: l,
                        message: (0, r.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(p.Caption, { className: v().text, variant: 'div', type: 'controls', size: 'm', children: n }),
                            ],
                        }),
                    });
                },
                g = (e) => {
                    ...
                    return (0, o.c)(async () => {
                        if (!e) return;
                        if (!t.isAuthorized)
                            return void i((0, r.jsx)(d.hT, { error: _({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: c.uQT.ERROR });
                        if (u) return;
        ...
        93652: (e, t, i) => {
            ...
            let g = (0, l.PA)((e) => {
                                ...
                                (0, p.c)(async (e) => {
                                    ...
                                    if ((null == t ? void 0 : t.isLegalRejected) || (null == t ? void 0 : t.isUnsafeLegal)) {
                                        null == e || e.preventDefault(),
                                            ...
                                            t.isUnsafeLegal && r.setType(o.YwF.UNSAFE),
                                            r.setId(u.current),
                                            r.setEntityId(t.id),
                    ...
                    return i && !t.various
                        ? (0, r.jsx)(v.N_, {
                              'aria-label': h({ id: 'entity-names.artist-name' }, { artistName: t.name }),
                              className: a,
                              href: t.url,
                              onClick: P,
                              ...
                              children: (0, r.jsx)(s.m_, {
                                  ...
                                  text: d || t.name,
                                  hoverSettings: x,
                                  children: (0, r.jsx)(f.Caption, { variant: 'span', type: 'entity', size: c, weight: 'medium', className: l, children: t.name }),
                              }),
                          })
                        : (0, r.jsx)(s.m_, {
                              enabled: !d && g,
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [
                        ...
                        (0, r.jsx)(A.N, {
                            ...
                            onClick: l,
                            rel: 'nofollow',
                            ...(0, _.Am)(_.OA.artists.SEPARATED_ARTISTS_SPOILER),
            ...
            let E = (0, l.PA)((e) => {
                    ...
                    return (0, r.jsxs)(s.m_, {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(s.ZI, { className: R().tooltipContent, children: i.map((e) => (0, r.jsx)(T.ArtistItem, { artist: e }, e.id)) }),
                        ],
                    });
                }),
                O = (0, n.forwardRef)((e, t) => (0, r.jsx)(E, { forwardRef: t, ...e }));
            var I = i(66098),
                L = i(80760),
                N = i.n(L);
            let S = (0, l.PA)((e) => {
                    ...
                    return (0, r.jsx)(I.W1, {
                        ...
                        children: i.map((e) => (0, r.jsx)(T.ArtistItem, { artist: e }, e.id)),
                    });
                }),
                M = (0, l.PA)((e) => {
                    ...
                    if (
                        ...
                        return (l || c) && (!c || 1 !== t.length) ? (c ? (0, r.jsx)(S, { artists: t, label: i }) : (0, r.jsx)(O, { artists: t, label: i })) : i;
                }),
                w = (0, l.PA)((e) => {
                    let {
                            className: t,
                        ...
                        S = (0, n.useMemo)(() => {
                            if (!P && u && u < i.length) {
                                let e = i.length - u;
                                return (0, n.isValidElement)(A) ? A : (0, r.jsx)(b, { spoilerClassName: _, spoilerArtistsCount: e, handleOnSpoilerClick: L });
                            }
                        }, [i.length, L, P, _, A, u]),
                        w = (0, n.useMemo)(() => {
                        ...
                        K = (0, r.jsx)(s.m_, {
                            ...
                            children: (0, r.jsxs)('div', {
                                style: w,
                                className: (0, a.$)(d().root, d()['root_variant_'.concat(y)], { [d().root_clamp]: c && c > 0 }, { [d().ellipsis]: !c }, t),
                                title: g && E && !C && !j ? E : void 0,
                                children: [N, S],
                            }),
                        });
                    return j ? (0, r.jsx)(M, { labelRef: T, artists: i, label: K }) : K;
                });
        },
        97557: (e, t, i) => {
            'use strict';
