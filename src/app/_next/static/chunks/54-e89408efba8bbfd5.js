...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [54, 3576, 3949, 7673],
    {
        ...
        23949: (e, t, n) => {
                                ...
                                'smooth' !== n &&
                                    ...
                                    (this.scrollToIndexTimeoutId = this.targetWindow.setTimeout(() => {
                                        if (((this.scrollToIndexTimeoutId = null), this.elementsCache.has(this.options.getItemKey(e)))) {
                                            ...
                                            if (!t) return;
                                            let [r] = t;
                                            1 >= Math.abs(r - this.getScrollOffset()) || this.scrollToIndex(e, { align: s, behavior: n });
            ...
            function T(e) {
                return _({ observeElementRect: m, observeElementOffset: g, scrollToFn: b, ...e });
            }
            function x(e) {
                return _({
        ...
        43576: (e, t, n) => {
            ...
            var d = function (e, t, n, s, o) {
                    ...
                    var S = String(b),
                        w = m && Object.prototype.hasOwnProperty.call(m, S) && m[S];
                    if (Array.isArray(w) && 1 === w.length && w[0].type === l.TYPE.literal) return w[0].value;
                    if (!s && w && 'string' == typeof w && !y) return w.replace(/'\{(.*?)\}'/gi, '{$1}');
                    if (((s = (0, r.__assign)((0, r.__assign)({}, y), s || {})), (c = h(c, v)), (f = h(f, v)), !w)) {
                        if (!1 === g && '' === w) return w;
                        if (((!E || (a && a.toLowerCase() !== d.toLowerCase())) && p(new u.sb(n, a)), E))
                            try {
                                ...
                                return (
                                    p(new u.Ho('Error formatting default message for: "'.concat(S, '", rendering default message verbatim'), a, n, e)),
                                    'string' == typeof E ? E : S
                                );
                            }
                        return S;
                    ...
                    try {
                        var _ = t.getMessageFormat(w, a, c, (0, r.__assign)({ formatters: t }, o || {}));
                        return _.format(s);
                    } catch (e) {
                        p(new u.Ho('Error formatting message: "'.concat(S, '", using ').concat(E ? 'default message' : 'id', ' as fallback.'), a, n, e));
                    }
                    if (E)
                        try {
                            var _ = t.getMessageFormat(E, d, f, o);
                            ...
                            p(new u.Ho('Error formatting the default message for: "'.concat(S, '", rendering message verbatim'), a, n, e));
                        }
                    return 'string' == typeof w ? w : 'string' == typeof E ? E : S;
                },
                f = [
                    'formatMatcher',
                    'timeZone',
            ...
            var L = function (e, t, n, i) {
                ...
                A = function (e, t) {
                    var n,
                        ...
                        S = k(f),
                        w =
                            ((n = (0, r.__assign)((0, r.__assign)((0, r.__assign)({}, o.JF), g), { defaultRichTextElements: S })),
                            (s = (0, i.GT)(t)),
                    ...
                    return (0, r.__assign)((0, r.__assign)({}, w), { formatMessage: L.bind(null, T, w.formatters), $t: L.bind(null, T, w.formatters) });
                },
                W = n(26519);
            function Z(e) {
                return {
