...
Learn more about creating the Service Worker script: https://mswjs.io/docs/cli/init`),
            ...
            var eG = new TextEncoder(),
                ...
                eB = class {
                    ...
                    #o;
                    constructor() {
                        (this.#s = []), (this.#o = new Map());
                    }
                    get [Symbol.iterator]() {
                        return this.#s[Symbol.iterator].bind(this.#s);
                    }
                    entries() {
                    ...
                    getAll() {
                        return this.#s.map(([, e]) => e);
                    }
                    append(e, t) {
                        this.#s.push([e, t]), this.#i(e, (e) => e.push(t));
                    }
                    prepend(e, t) {
                        this.#s.unshift([e, t]), this.#i(e, (e) => e.unshift(t));
                    }
                    delete(e, t) {
                        if (0 !== this.size)
                            for (let [a, s] of ((this.#s = this.#s.filter((e) => e[1] !== t)), this.#o)) a === e && s.includes(t) && s.splice(s.indexOf(t), 1);
                    }
                    deleteAll(e) {
                        0 !== this.size && ((this.#s = this.#s.filter((t) => t[0] !== e)), this.#o.delete(e));
                    }
                    get size() {
                        return this.#s.length;
                    }
                    clear() {
                        0 !== this.size && ((this.#s.length = 0), this.#o.clear());
                    }
                    #i(e, t) {
                        t(this.#o.get(e) || this.#o.set(e, []).get(e));
                    }
                },
                ...
                eQ = class {
                    ...
                    on(e, t, a) {
                        return this.#l(e, t, a), this;
                    }
                    once(e, t, a) {
                        return this.on(e, t, { ...(a || {}), once: !0 });
                    }
                    earlyOn(e, t, a) {
                        return this.#l(e, t, a, 'prepend'), this;
                    }
                    earlyOnce(e, t, a) {
                        return this.earlyOn(e, t, { ...(a || {}), once: !0 });
                    }
                    emit(e) {
                        if (0 === this.#n.size) return !1;
                        let t = this.listenerCount(e.type) > 0,
                            a = this.#u(e);
                        for (let t of this.#c(e.type)) {
                    ...
                    async emitAsPromise(e) {
                        if (0 === this.#n.size) return [];
                        let t = [],
                            a = this.#u(e);
                        for (let s of this.#c(e.type)) {
                            if (null != a.event[eV] && a.event[eV] !== this) return a.revoke(), [];
                            if (a.event[eX]) break;
                            let e = await Promise.resolve(this.#d(a.event, s));
                            this.#h(s) || t.push(e);
                        }
                    ...
                    *emitAsGenerator(e) {
                    ...
                    removeAllListeners(e) {
                        if (null == e) return void this.#n.clear();
                        this.#n.deleteAll(e);
                    }
                    listeners(e) {
                        return null == e ? this.#n.getAll() : this.#n.get(e);
                    }
                    listenerCount(e) {
                        return null == e ? this.#n.size : this.listeners(e).length;
                    }
                    #l(e, t, a, s = 'append') {
                        'prepend' === s ? this.#n.prepend(e, t) : this.#n.append(e, t),
                            a &&
                    ...
                    #d(e, t) {
                        let a = t.call(this, e);
                        if (t[eY]?.once) {
                            let a = this.#h(t) ? '*' : e.type;
                            this.#n.delete(a, t);
                        }
                        return a;
                    }
                    *#c(e) {
                        for (let [t, a] of this.#n) ('*' === t || t === e) && (yield a);
                    }
                    #h(e) {
                        return this.#n.get('*').includes(e);
                    }
                },
                eZ = ed(),
                e1 = class extends eK {
                    #m;
                    constructor(e) {
                        super(e.data.type, { data: e.data.payload }), (this.#m = e);
                    }
                    get ports() {
                        return this.#m.ports;
                    }
                    postMessage(e, ...t) {
                        this.#m.ports[0].postMessage({ type: e, data: t[0] }, { transfer: t[1] });
                    }
                },
                e0 = class extends eQ {
                    constructor(e) {
            ...
            class er {
                ...
                constructor() {
                    (0, s.S)() ||
                        ...
                        (this.#f = new E()),
                        (this.#f.idx = this.getCookieStoreIndex()),
                        (this.#g = new ei(this.#f));
                }
                getCookies(e) {
                    return this.#g.getCookiesSync(e);
                }
                async setCookie(e, t) {
                    await this.#g.setCookie(e, t), this.persist();
                }
                getCookieStoreIndex() {
                    if ('undefined' == typeof localStorage || 'function' != typeof localStorage.getItem) return {};
                    let e = localStorage.getItem(this.#p);
                    if (null == e) return {};
                    let t = (function (e) {
                        try {
                            return JSON.parse(e);
                ...
                persist() {
                    ...
                    localStorage.setItem(this.#p, JSON.stringify(e));
                }
            }
            let en = new er();
        },
