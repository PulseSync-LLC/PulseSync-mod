    ...
    [2732],
    {
        144: (e, i, t) => {
            ...
            var r = t(33008),
                ...
                h = t.n(y);
            let k = (0, s.PA)((e) => {
                let { className: i, children: t, upcomingAlbum: s, contentLinesCount: y } = e,
                    { user: k } = (0, g.Pjs)(),
                    ...
                    T = (0, l.useMemo)(() => {
                        let e = f({ id: 'entity-names.upcoming-album-name' }, { upcomingAlbumName: s.title }),
                            i = s.isPresave ? f({ id: 'entity-names.has-your-like' }) : '';
                                ...
                                (0, r.jsx)(m.hg, {
                                    ...
                                    playControl: (0, r.jsx)(
                                        d.Button,
                                        {
                                            ...
                                            variant: 'default',
                                            size: 's',
                                            icon: (0, r.jsx)(v.Icon, { variant: 'lock', size: 'xxs', className: h().lockIcon }),
                ...
                return (0, r.jsxs)(m.MN, {
                    ...
                    contentLinesCount: y,
                    view: K,
                    description: (0, r.jsx)(A.iQ, { className: h().artists, artists: s.artists, lineClamp: 1, linkClassName: h().artistLink, captionSize: 's' }),
                    children: [
                        (0, r.jsx)(p.Caption, {
                            ...
                            children: (0, r.jsx)(o.A, { id: 'entity-names.upcoming-album-date', values: { releaseDate: N(s.releaseDate, (0, g.sDH)()) } }),
                        }),
                        t,
                    ],
                });
            ...
            let d = (0, u.PA)((e) => {
                ...
                m = (e) => {
                    ...
                    return (0, s.useCallback)(async () => {
                        if (!i.isAuthorized)
                            return void t((0, r.jsx)(o.hT, { error: u({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: n.uQT.ERROR });
                        if (c) return;
        ...
        38340: (e, i, t) => {
            ...
            let A = (0, a.PA)((e) => {
                var i, t;
                let { album: a, onOpenChange: A, open: g, wrapperClassName: C, variant: y, ...h } = e,
                    { shouldShowBuySubscriptionModal: k, showBuySubscriptionModal: x } = (0, b.qBP)(),
                    {
                        settings: { isMobile: P },
                        trailer: f,
                        user: N,
                        experiments: L,
                        albumCPA: { isPlusCPAEnabled: O, isPlusCPAPlayerBarEnabled: I },
                        album: { tracks: tracks },
                    } = (0, b.Pjs)(),
                    T = (0, m.KX)(a),
                    K = (0, m.A7)(a),
                    ...
                    D = O({ pageAlbumId: E, albumId: a.id, isNonMusic: a.isNonMusic }),
                    S = I(a.id, a.isNonMusic),
                    z = (0, m.Ek)(),
                    { shareLink: F, pathname: $ } = (0, b.bNS)('/album/:albumId', { params: { albumId: a.id } }),
                    G = (0, v.A_)({ entityVariant: b.DwC.ALBUM, urlParams: { id: a.id } }),
                    { isPlaying: Q, togglePlay: q } = (0, b.B0S)({
                        seeds: null != (t = null == a ? void 0 : a.seeds) ? t : [],
                        pageIdForFrom: b._Q$.RADIO,
                        blockIdForFrom: j,
                        parentContextId: a.id,
                    }),
                    { utmLink: W } = (0, b.fyy)({ blockId: b.UfI.ALBUM, contextType: u.K.Album, contextId: null == a ? void 0 : a.id }),
                    Y = (0, c.c)(() => {
                    ...
                    H = (0, c.c)(() => {
                        ...
                        R() || (f.setUtmLink(W), f.openAlbumTrailer(a.id), M(n.ky.Album, String(a.id)));
                    });
                (0, b.NBO)(g);
                let V = (0, s.useMemo)(() => {
                        if (!P) return (0, r.jsx)(p.L1, { onClick: K, isPinned: a.isPinned, disabled: !a.isAvailable });
                    }, [a.isAvailable, a.isPinned, K, P]),
                    Z = (0, s.useMemo)(() => {
                        let e = !D && !N.isAuthorized;
                        return a.isNonMusic
                            ? (0, r.jsx)(p.Uc, { onClick: T, isLiked: a.isLiked, albumType: a.type })
                            : (0, r.jsx)(p.TW, { onClick: T, isLiked: a.isLiked, disabled: e });
                    }, [a.isLiked, a.type, T, a.isNonMusic, N.isAuthorized, D]),
                    J = (0, s.useMemo)(() => {
                        var e;
                        if (!a.isNonMusic && (null == (e = a.trailer) ? void 0 : e.isAvailable)) return (0, r.jsx)(p.No, { onClick: H, disabled: !a.isAvailable });
                    }, [a.isAvailable, null == (i = a.trailer) ? void 0 : i.isAvailable, a.isNonMusic, H]),
                    X = (0, s.useMemo)(() => {
                        if (!a.isNonMusic) return (0, r.jsx)(p.C6, { onClick: Y, disabled: !a.isAvailable || (S && P), variant: b.IGO.ALBUM, onOpenMenuChange: A });
                    }, [a.isAvailable, Y, a.isNonMusic, A, S, P]),
                    ee = { variant: b.Yxq.ALBUM, id: a.id, title: a.title, path: $, albumArtistName: a.artistName, albumArtistId: a.artistId };
                return (0, r.jsxs)(d.W1, {
                    ...
                    ...h,
                    children: [
                        P && (0, r.jsx)(p.Cu, { getDescriptionTexts: a.getDescriptionTexts, entityId: a.id }),
                        B && (0, r.jsx)(v.dx, { entityVariant: b.DwC.ARTIST, adminUrl: G }),
                        V,
                        Z,
                        ...
                        J,
                        X,
                        U && (0, r.jsx)(p.iF, { onClick: z, isFinished: a.listeningFinished }),
                ...
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)(d.Caption, {
                            ...
                            type: 'entity',
                            size: 'm',
                            className: (0, a.$)(v().position, g, { [v().position_disliked]: p, [v().position_disabled]: _ }),
                        ...
                        y &&
                            (0, r.jsx)(c.Icon, {
                                ...
                                size: 'xxs',
                                'aria-label': k,
                                className: (0, a.$)(v().progress, v()['progress_'.concat(x)], { [v().progress_disliked]: p, [v().progress_disabled]: _ }),
        ...
        52732: (e, i, t) => {
            ...
            let s = (e) => {
                ...
                let t = (null == (i = e.artists) ? void 0 : i.map((e) => (0, a.NE)(e))) || [];
                return {
                    id: e.id,
                    title: e.title,
                    type: e.type,
            ...
            let m = (e) => {
                    var i, t;
                    let { album: r, artists: s, bookmateOptionRequired: n, chart: o, likesCount: u, trailer: c, releaseYear: m, releaseDate: v } = e,
                ...
                v = (e) => {
                    ...
                    return (0, l.wg)({ ...m({ album: i, artists: t, likesCount: r }), chart: a && (0, u.ws)(a) });
                },
                b = (e) => {
                    var i;
                    let { album: t, artists: r, releaseDate: s, isPresave: n } = e,
            ...
            ((0, _.cache)(async (e) => {
                ...
                try {
                    let { container: i, backendHostTld: r, locale: a, host: s, fullUrl: l, isRSC: n, requestUrl: o, referer: u } = await (0, d.IhE)();
                    if (n) return { album: void 0, backendHostTld: r, locale: a, host: s, fullUrl: l, requestUrl: o };
                    let c = i.get(d.tzI).getAlbumWithTracksIds({ albumId: Number(e), resumeStream: !1 }),
                        [m, v] = await Promise.allSettled([c]);
                    if (!m || 'fulfilled' !== m.status) return (0, d.tfF)(m.reason, () => ({ album: void 0, ...(0, d.Bj3)() }));
                    {
                        let e = (null == v ? void 0 : v.status) === 'fulfilled' && v.value ? v.value.id : null;
                        t = { album: m.value, backendHostTld: r, locale: a, host: s, fullUrl: l, requestUrl: o, cpa: e };
                    }
                } catch (e) {
                ...
                (0, _.cache)(async (e) => {
                    ...
                    try {
                        let { container: i, backendHostTld: r, locale: a, host: s, fullUrl: l, isRSC: n, requestUrl: o, referer: u } = await (0, d.IhE)();
                        if (n) return { album: void 0, backendHostTld: r, locale: a, host: s, fullUrl: l, requestUrl: o, isActive: !1 };
                        let c = i.get(d.tzI),
                            m = i.get(d.dh7);
                        if (!(await m.getPromoAlbumInfo({ albumId: Number(e) })).active)
                            return { album: void 0, backendHostTld: r, locale: a, host: s, fullUrl: l, requestUrl: o, isActive: !1 };
                        let v = c.getAlbumWithTracksIds({ albumId: Number(e), resumeStream: !1 }),
                            [b, p] = await Promise.allSettled([v]);
                        if (!b || 'fulfilled' !== b.status) return (0, d.tfF)(b.reason, () => ({ album: void 0, isActive: !1, ...(0, d.Bj3)() }));
                        {
                            let e = (null == p ? void 0 : p.status) === 'fulfilled' && p.value ? p.value.id : null;
                            t = { album: b.value, backendHostTld: r, locale: a, host: s, fullUrl: l, requestUrl: o, isActive: !0, cpa: e };
                        }
                    } catch (e) {
            ...
            let A = (e) => {
                ...
                g = n.GI.props({ artists: l.gK.maybe(l.gK.array(a.PK)), chart: l.gK.maybe(u.Iz) }).views((e) => ({
                    get artistNames() {
                        var i;
                ...
                C = n.oM.props({ artists: l.gK.maybe(l.gK.array(a.PK)) }).views((e) => ({
                    get artistNames() {
                        var i;
                        return null == (i = e.artists) ? void 0 : i.map((e) => e.name).join(', ');
                    },
                    ...
                    return (0, k.jsx)(x.OY, {
                        ...
                        children:
                            null == l
                                ? void 0
                                : l.map((e) =>
                                      (0, k.jsx)(y.AlbumCard, { album: e, contentLinesCount: 3, withAddition: !e.isNonMusic, withLikesCount: e.isNonMusic }, e.id),
                                  ),
                    });
                },
                f = (0, _.forwardRef)((e, i) => (0, k.jsx)(P, { forwardRef: i, ...e }));
            var N = t(57176),
                L = t(144);
        },
        56312: (e, i, t) => {
                    ...
                    return (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, r.jsx)('div', {
                                ...
                                children: (0, r.jsx)(g.Icon, { className: A.$f.buttonArrow, variant: 'arrowRight', size: 'xs' }),
                            }),
                        ],
                    });
                }),
                k = (0, s.PA)((e) => {
                    let { className: i, album: t, pageId: s, coverClassName: g, playButtonIconSize: C, likeIconSize: y, shouldShowReleaseYear: k, description: x } = e,
                        P = (0, b.r_)(t.type),
                        ...
                        K = (0, _.ZpR)(t.url),
                        M = (0, _.PT7)(),
                        { sendNavigateSearchFeedback: j, sendPlaySearchFeedback: U } = (0, _.zEv)(),
                        B = (0, _.NKK)(),
                        {
                            isPlaying: w,
                            isCurrent: R,
                            togglePlay: E,
                        } = (0, _.Dx4)({ playContextParams: { contextData: { type: u.K.Album, meta: { id: t.id }, from: L }, loadContextMeta: !0 } }),
                        ...
                        q = null == Q ? void 0 : Q({ onPlayButtonClick: F, isPlaying: w, isCurrent: R, playButtonIconSize: C }),
                        W = (0, l.useMemo)(
                            () =>
                                t.url && t.isAvailable
                                    ? (0, r.jsx)(A.N_, { className: (0, a.$)(A.$f.text, A.$f.titleLink), href: t.url, onClick: G, children: t.title })
                                    : (0, r.jsx)(v.Caption, {
                                          className: (0, a.$)(A.$f.text, A.$f.titleText),
                                          size: 'm',
                                          variant: 'div',
                                          type: 'text',
                                          children: t.title,
                        ...
                        Y = (0, l.useCallback)(
                            (e, i) => {
                                ...
                                return (null == (a = t.artists) ? void 0 : a.length)
                                    ? (0, r.jsx)(p.iQ, { linkClassName: e, captionClassName: i, artists: t.artists, lineClamp: 1, withLink: t.isAvailable })
                                    : null;
                            },
                            [t.artists, t.isAvailable],
                        ),
                        H = (0, d.L)(() => [t.artistNames, t.title, t.version].filter(Boolean).join(' '));
                    return (0, r.jsxs)(A.Cj, {
                        ref: f,
                        'data-intersection-property-id': N,
                        className: (0, a.$)(A.$f.root, { [A.$f.root_disabled]: !t.isAvailable }, i),
                        'aria-label': H,
                        onClick: $,
                        ...
                        children: [
                            ...
                            (0, r.jsx)(A.ro, {
                                ...
                                likesCount: t.isNonMusic ? t.actualLikesCount : void 0,
                                isLiked: t.isNonMusic ? t.isLiked : void 0,
                                releaseYear: t.isNonMusic && k ? t.year : void 0,
                                description: x,
                            }),
                            (0, r.jsx)(h, { className: A.$f.controlsBar, album: t, likeIconSize: y }),
                        ],
                    });
                });
        },
        57609: (e, i, t) => {
            ...
            let n = (e) => {
                ...
                return (
                    (0, r.useEffect)(() => {
                        o.isUnsafeDisclaimerConfirmed && o.id === c.current && !d.current && (null == t || t(), (d.current = !0));
                    ...
                    (0, s.c)(async (e) => {
                        let r = m.get(l.cYZ.ExEx),
                            a = (null == i ? void 0 : i.isPodcast)
                                ? null == r
                                    ? void 0
                                    : r.includes(''.concat(l.nPY.PODCAST, '_').concat(i.id))
                                : null == r
                                  ? void 0
                                  : r.includes(''.concat(l.nPY.ALBUM, '_').concat(null == i ? void 0 : i.id));
        ...
        59173: (e, i, t) => {
            ...
            let o = (e) => {
                let {
                        user: i,
                        modals: { promoLandingBuySubscriptionModal: t, crackdownModal: o },
                        settings: { isMobile: u },
                        paywall: c,
                ...
                return (0, s.c)(async () => {
                    ...
                    if ((!v || (null == e ? void 0 : e.isLiked) || (u ? t.open() : o.open()), i.isAuthorized) && e) {
                        if (!e.isLiked) {
                            var r, s;
                            m.sendLikeFeedback({
                                reaction: a.g.LIKE,
                        ...
                        return b({ album: e, withLink: !1, withNotification: i.hasPlus });
                    }
                });
            };
        },
        60343: (e, i, t) => {
            ...
            let u = (e) => {
                ...
                return (0, s.c)(async () => {
                    if (e)
                        return u({ pageAlbumId: v, albumId: e.id, isNonMusic: e.isNonMusic })
                            ? void t.openModal()
                            : i.isAuthorized
                              ? m({ album: e })
        ...
        82548: (e, i, t) => {
            'use strict';
            t.d(i, { AlbumEntityNameConsumer: () => l, useAlbumEntityName: () => n });
            var r = t(66268),
                a = t(73827),
                s = t(15479),
                l = (function (e) {
            ...
            let n = (e, i) => {
                ...
                return (0, r.useMemo)(() => {
                    switch (e) {
                        ...
                        case s._.AUDIOBOOK:
                            if ('pin' === i) return t({ id: 'entity-names.book' });
        ...
        86335: (e, i, t) => {
            ...
            let T = (0, s.PA)((e) => {
                let {
                    ...
                    { sendLikeSearchFeedback: q, sendNavigateSearchFeedback: W, sendPlaySearchFeedback: Y } = (0, k.zEv)(),
                    [H, V] = (0, l.useState)(!1),
                    [Z, J] = (0, l.useState)(!1),
                    [X, ee] = (0, l.useState)(!1),
                    ei = (0, k.NKK)(),
                    ...
                    ev = S({ pageAlbumId: em, albumId: s.id, isNonMusic: s.isNonMusic }),
                    eb = s.isAvailableOnlyForPlus && !s.isUnsafeLegal && !s.isLegalRejected,
                    ep = eb && !D,
                    ...
                    eP = (0, l.useMemo)(() => {
                        var e;
                        let i = s.isLiked ? G({ id: 'entity-names.has-your-like' }) : '';
                        return ''
                            .concat(ex, ' ')
                            .concat(s.title, ' ')
                    ...
                    ej = (0, l.useMemo)(() => {
                        ...
                        return (0, r.jsxs)(g.Caption, {
                            className: (0, a.$)(I().title, { [I().title_withVersion]: s.version, [I().title_withChart]: K }),
                            variant: 'div',
                            type: 'entity',
                            size: 's',
                            weight: 'medium',
                    ...
                    eE = (0, v.L)(() =>
                        (0, r.jsx)(
                            b.Button,
                            {
                                ...
                                radius: 'xxxl',
                                onClick: eg,
                                children: (0, r.jsx)(g.Caption, { variant: 'div', size: 'm', children: G({ id: 'payment.try-button' }) }),
                            },
                            eA,
                        ),
                    ),
                    eD = (0, l.useMemo)(
                        () =>
                            ep && R.hasPlus && z.checkExperiment(k.zal.WebNextPlusLandingLink, 'on')
                                ? (0, r.jsx)(x.SU, {
                                      className: I().buyPlusPopover,
                                      buttonText: G({ id: 'interface-actions.more-details' }),
                                      isNested: !0,
                                      placement: 'top-start',
                                      isOpened: eu,
                                      onOpenChange: ec,
                            ...
                            (0, r.jsx)(A.Paper, {
                                ...
                                children: (0, r.jsxs)('div', {
                                    ...
                                    children: [
                                        ...
                                        eb && (0, r.jsx)(_.Icon, { variant: 'plusBadge', className: I().plusBadge }),
                                        eF,
                                    ],
                                }),
                            }),
                ...
                return (0, r.jsxs)(p.MN, {
                    ref: B,
                    className: (0, a.$)(I().root, { [I().root_withChart]: K }, i),
                    'aria-label': eP,
                    ...
                    children: [
                        M &&
                            ek &&
                            (0, r.jsx)(g.Caption, { className: I().addition, variant: 'div', type: 'entity', size: 's', weight: 'medium', lineClamp: 1, children: ek }),
                        T &&
                            !!s.actualLikesCount &&
                            (0, r.jsx)(x.xW, {
                                className: I().likeTextButton,
                                ariaLabel: G({ id: 'entity-names.likes-counter' }, { counter: s.actualLikesCount }),
        ...
        89414: (e, i, t) => {
            ...
            let c = (e) => {
                    ...
                    return (0, r.jsx)(u.Pv, { closeToast: t, albumTitle: i.title, coverUri: i.coverUri, entityTitle: i.title, isPresave: i.isPresave });
                },
                d = (e) => {
                    let { user: i } = (0, o.Pjs)(),
                        { notify: t } = (0, o.lkh)(),
                    ...
                    return (0, s.useCallback)(async () => {
                        if (!i.isAuthorized)
                            return void t((0, r.jsx)(u.hT, { error: v({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: o.uQT.ERROR });
                        if (d) return;
        ...
        92725: (e, i, t) => {
            ...
            let u = () => {
                ...
                return (0, a.useCallback)(async () => {
                    var a, s;
                    if (!i) return;
                    let d = t.modal.isOpened ? n.uQT.FULLSCREEN_ERROR : n.uQT.ERROR;
                    return e.isAuthorized
                        ? (await i.setListeningFinishedStatus()) !== l.T.OK
                            ...
                            : void (null == (s = i.meta) || s.updateFinished(!(null == (a = i.meta) ? void 0 : a.listeningFinished)))
                ...
                P = r.gK
                    .compose(
                        r.gK.model({
                            ...
                            availableForOptions: r.gK.maybe(r.gK.array(r.gK.enumeration(Object.values(g.E)))),
                    ...
                    .views((e) => {
                        let i = {
                            get url() {
                                let { href: i } = (0, a.uvd)('/album/:albumId', { params: { albumId: e.id } });
                                return i;
                            },
                            get isLiked() {
                                if (!(0, r._n)(e)) return !1;
                                let { library: i } = (0, r.Zn)(e);
                                return null == i ? void 0 : i.isAlbumLiked(e.id);
                            },
                            get pinId() {
                            ...
                            get isNonMusic() {
                                if (!(0, r._n)(e)) return !1;
                                return i.isPodcast || i.isAudiobook || i.isFairyTale;
                            },
                            get isPinned() {
                                if (!(0, r._n)(e)) return !1;
                            ...
                            get modalDisclaimerId() {
                                if (e.disclaimers) {
                                    var t;
                                    let i = null == (t = (0, a.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : t[0];
                                    if (i) {
                                        let { id: e } = i;
                                        return e;
                                    }
                            ...
                            get isForeignAgent() {
                                ...
                                let { experiments: i } = (0, r.Zn)(e),
                                    t = !!(null == (s = e.disclaimers) ? void 0 : s.includes(y.M.FOREIGN_AGENT));
                                if (e.disclaimers) {
                                    let i = null == (l = (0, a.bRW)(e.disclaimers, y.M.FOREIGN_AGENT)) ? void 0 : l[0];
                                    t = (null == i ? void 0 : i.type) === y.M.FOREIGN_AGENT;
                                }
                                return t && i.checkExperiment(a.zal.WebNextAgentPodcast, 'on');
                            },
                            get isLegalRejected() {
                                if (!(0, r._n)(e)) return !1;
                                if (e.disclaimers) {
                                    var n;
                                    let i = null == (n = (0, a.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : n[0],
                                        t = (null == i ? void 0 : i.type) === y.M.MODAL;
                                    return !e.isAvailable && (t || e.disclaimers.includes(y.M.MODAL));
                                }
                                return !1;
                            },
                            get isUnsafeLegal() {
                                ...
                                if (e.disclaimers) {
                                    var o;
                                    let i = null == (o = (0, a.bRW)(e.disclaimers, y.M.MODAL)) ? void 0 : o[0];
                                    return e.isAvailable && (null == i ? void 0 : i.type) === y.M.MODAL;
                                }
                                return !1;
                            },
                            get isAvailableOnlyForPlus() {
                                var u;
                                return !e.isAvailable && (e.availableForPremiumUsers || !!(null == (u = e.availableForOptions) ? void 0 : u.includes(g.E.BOOKMATE)));
                            },
                            get shouldShowBooksBadge() {
                                var c;
                                return !!(
                                    e.bookmateOptionRequired ||
                                    (!e.availableForPremiumUsers && (null == (c = e.availableForOptions) ? void 0 : c.includes(g.E.BOOKMATE)))
                                );
                            },
                        };
                        return i;
                    ...
                    .actions((e) => ({
                        ...
                        togglePin: (0, r.L3)(function* () {
                            ...
                            if (t.isAuthorized) return yield i.toggleAlbumPin({ id: e.id }, e.pinId);
                        }),
                    ...
                    let i = {
                        ...
                        toggleLike: (0, r.L3)(function* () {
                            ...
                            if (a.account.data.uid)
                                return (
                                    (t = e.isPresave
                                        ? yield i.removePresaveAlbum({ albumId: e.id, userId: a.account.data.uid })
                                        : yield i.presaveAlbum({ albumId: e.id, userId: a.account.data.uid, likeAfterRelease: !0 })),
                                    !(0, r._n)(e),
                                    t
                                );
                        }),
