    ...
    [9906],
    {
        320: (e, t, n) => {
            ...
            let f = (0, s.PA)((e) => {
                ...
                let { metatagId: _, preloadedMeta: f } = e,
                    ...
                    { contentScrollRef: A, setContentScrollRef: k } = (0, u.gKY)(),
                    y = (0, u.W6M)(),
                    T = (0, l.useCallback)(
                        (e) => {
                            _ && N.getData({ metatagId: _, page: e, pageSize: P.c });
                        },
                        [N, _],
                    );
                (0, l.useEffect)(
                            ...
                            let t = ((e) => {
                                ...
                                return {
                                    ...
                                    pager: {
                                        ...
                                        perPage: (null == (n = e.pager) ? void 0 : n.perPage) || 0,
                                        total: (null == (i = e.pager) ? void 0 : i.total) || 0,
                                    },
                                };
                            })(e);
                            (0, g.H)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, u.jxB)(e);
                            });
                        }, [e]);
                    })(N);
                              ...
                              children: (0, i.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, i.jsx)(b.Y9, {
                                          ...
                                          children: (0, i.jsx)(m.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: N.fullTitle }),
                                      }),
                                      (0, i.jsx)(b.$$, {
                                          className: (0, r.$)(x().scrollContainer, x().important),
                                          customComponents: C,
                                          itemContentCallback: (e) => {
                                              var t;
                                              let n = null == N || null == (t = N.items) ? void 0 : t[e],
                                                  r = j({ id: 'loading-messages.entity-is-loading' }, { entityName: j({ id: 'entity-names.playlist' }) });
                                              return n ? (0, i.jsx)(v.B6, { playlist: n, contentLinesCount: 3 }, n.key) : (0, i.jsx)(b.Vt, { 'aria-label': r });
                                          },
                                          totalCount: null != (n = null == N || null == (t = N.pager) ? void 0 : t.total) ? n : 0,
                                          onGetDataByPage: T,
                                          pageSize: P.c,
                                          totalRequests: null != (s = N.requests) ? s : 0,
                                          listClassName: x().content,
                                          itemClassName: x().item,
                                          handleRef: k,
                                          context: { listAriaLabel: j({ id: 'mixes.playlists-list' }, { genreName: N.fullTitle || '' }) },
                                          isMobileLayout: S,
                                          useWindowScroll: S,
                                      }),
                                  ],
        ...
        10456: (e, t, n) => {
            ...
            async function o(e, t) {
                ...
                return {
                    ...
                    twitter: (0, i.HRN)({ cardType: i.WfF.APP, title: c, url: null != l ? l : '', appName: m({ id: 'metadata.yandex-music' }) }),
                    appLinks: (0, i.X5i)({
                        additional: { tld: a, url: null != l ? l : '', fullUrl: null != o ? o : '', host: d },
        ...
        21682: (e, t, n) => {
            ...
            async function o(e, t) {
                let { locale: n, fullUrl: o, url: l, tld: a, host: d } = t,
                    ...
                    u = (0, r.f)({ genreTitle: h, artists: v, messageFormatter: m }),
        ...
        27618: (e, t, n) => {
            ...
            let b = (0, s.PA)((e) => {
                ...
                return (
                    ...
                    (0, i.jsxs)('div', {
                        className: (0, r.$)(u().root, { [u().root_desktop]: !g }, t),
                        children: [
                            (0, i.jsx)(h.Lh, { withBackwardFallback: '/', className: u().navigation, withForwardControl: !1 }),
                            (0, i.jsxs)('div', {
                                className: u().content,
                                children: [
                                    (0, i.jsx)(a.Icon, { className: (0, r.$)(u().icon, b), variant: v, size: P }),
                                    (0, i.jsx)(d.Heading, {
                    ...
                    children: [
                        n &&
                            (0, i.jsx)(v.Lh, {
                                ...
                                className: (0, r.$)(b().navigation, { [b().navigation_desktop]: !p }),
                                withForwardControl: !1,
                            }),
                        (0, i.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, i.jsx)(h.Heading, { className: (0, r.$)(b().title, b().important), variant: 'h3', size: 'xs', children: u }),
                                (0, i.jsxs)(h.Caption, {
        ...
        53628: (e, t, n) => {
            ...
            let S = (0, r.PA)((e) => {
                let { metatagId: t, preloadedMeta: n } = e,
                    ...
                    { contentScrollRef: S, setContentScrollRef: j } = (0, P.gKY)(),
                    A = (0, P.W6M)(),
                    k = (0, d.c)(() => 315),
                    y = (0, d.c)(() => {
                        var e;
                    ...
                    T = (0, o.useCallback)(
                        (e) => {
                            t && r.getData({ metatagId: t, page: e, pageSize: p.c });
                        },
                        [r, t],
                    ),
                ...
                let w = (0, d.c)((e) => {
                    let t = r.items[e],
                        n = f({ id: 'loading-messages.entity-is-loading' }, { entityName: f({ id: 'entity-names.artist' }) });
                    return t ? (0, i.jsx)(v.ao, { artist: t, contentLinesCount: 3 }, t.id) : (0, i.jsx)(g.Vt, { 'aria-label': n, round: !0, centered: !0 });
                });
                    ...
                    (0, o.useEffect)(() => {
                        ...
                        let t = ((e) => {
                            ...
                            return {
                                id: '',
                                title: { title: '', fullTitle: e.fullTitle || '' },
                                artists: e.items.map((e) => ({ artist: (0, x.NE)(e), popularTracks: [] })),
                                pager: {
                                    page: (null == (t = e.pagesLoader.pager) ? void 0 : t.page) || 0,
                                    perPage: (null == (n = e.pagesLoader.pager) ? void 0 : n.perPage) || 0,
                                    total: (null == (i = e.pagesLoader.pager) ? void 0 : i.total) || 0,
                                },
                            };
                        })(e);
                        (0, _.i)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                            (0, P.jxB)(e);
                        });
                    }, [e]);
                })(r),
                t && r.isNeededToLoad && (0, o.use)(r.getData({ preloadedMeta: n, metatagId: t, page: 0, pageSize: p.c })),
                r.isSomethingWrong)
                    ? (0, i.jsx)(c.w, {})
                    : (0, i.jsx)(P.nVz, {
                              ...
                              children: (0, i.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, i.jsx)(g.Y9, {
                                          ...
                                          children: (0, i.jsx)(h.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: r.fullTitle }),
                                      }),
                                      (0, i.jsxs)(m.N, {
                                          ref: j,
                                          className: N().root,
                                          ...
                                          children: [
                                              ...
                                              (0, i.jsx)(g.A, { children: (0, i.jsx)(g.wi, { className: N().footer }) }),
                                          ],
                                      }),
                                  ],
                              }),
        ...
        74543: (e, t, n) => {
            ...
            let x = (0, s.PA)((e) => {
                ...
                let { metatagId: p, preloadedMeta: x } = e,
                    ...
                    { contentScrollRef: j, setContentScrollRef: A } = (0, u.gKY)(),
                    k = (0, u.W6M)(),
                    y = (0, l.useCallback)(
                        (e) => {
                            p && f.getData({ metatagId: p, page: e, pageSize: P.c });
                        },
                        [f, p],
                    );
                (0, l.useEffect)(
                    ...
                    ((e) => {
                        (0, l.useEffect)(() => {
                            ...
                            (0, g.g)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                                (0, u.jxB)(e);
                            });
                        }, [e]);
                    })(f);
                              ...
                              children: (0, i.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, i.jsx)(b.Y9, {
                                          ...
                                          children: (0, i.jsx)(m.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: f.fullTitle }),
                                      }),
                                      (0, i.jsx)(b.$$, {
                                          className: (0, r.$)(_().scrollContainer, _().important),
                                          customComponents: T,
                                          itemContentCallback: (e) => {
                                              let t = f.items[e],
                                                  n = S({ id: 'loading-messages.entity-is-loading' }, { entityName: S({ id: 'entity-names.album' }) });
                                              return t
                                                  ? (0, i.jsx)(c.aX, { album: t, contentLinesCount: 4 }, t.id)
                                                  : (0, i.jsx)(b.Vt, { 'aria-label': n, linesCount: 4 });
                                          },
                                          totalCount: null != (n = null == f || null == (t = f.pager) ? void 0 : t.total) ? n : 0,
                                          onGetDataByPage: y,
                                          pageSize: P.c,
                                          totalRequests: null != (s = f.requests) ? s : 0,
                                          listClassName: _().content,
                                          itemClassName: _().item,
                                          handleRef: A,
                                          context: { listAriaLabel: S({ id: 'mixes.albums-list' }, { genreName: f.fullTitle || '' }) },
                                          isMobileLayout: N,
                                          useWindowScroll: N,
                                      }),
                                  ],
        ...
        95227: (e, t, n) => {
            ...
            let d = { width: 400, height: 400 },
                m = (e) => {
                    let { count: t, getEstimateSize: n, gap: i, containerRef: r } = e,
                        {
                            settings: { isMobile: m },
                        } = (0, s.Pjs)(),
                        ...
                        u = {
                            ...
                            scrollMargin: ((e, t, n) => {
                                ...
                                return e && 1 ? i + window.scrollY : !e && n ? i + n.scrollTop : 0;
                            })(m, r, h),
                        },
                        b = (0, o.XW)(u),
                        P = (0, o.Te)({ ...u, getScrollElement: () => h, initialOffset: null == h ? void 0 : h.scrollTop }),
                        g = m ? b : P,
                        p = (0, a.c)(() => {
                            g.measure();
                        });
                ...
                h = (e) => {
                    let {
                        ...
                        { virtualizer: P, resizeObserver: g } = m({ count: u, getEstimateSize: n, gap: o, containerRef: v }),
                        p = (0, i.A)(
                        ...
                        _ = (0, r.L)(() => {
                            ...
                            let n = null == (e = p[P.range.startIndex]) ? void 0 : e.at(0),
                                i = null == (t = p[P.range.endIndex]) ? void 0 : t.at(-1);
                            return void 0 !== n && void 0 !== i ? { startIndex: n, endIndex: i } : null;
                        });
                    return { virtualizer: P, rowResizeObserver: g, indices: p, columnCount: b, visibleRange: _ };
                };
            var c = n(33008),
                v = n(97531),
                u = n(44612),
                ...
                g = n.n(P);
            let p = (0, v.PA)((e) => {
                let { indices: t, virtualItem: n, renderItemByIndex: i, columnClassName: r, className: s, resizeObserver: o, scrollMargin: a } = e,
                    d = (0, l.useRef)(null),
                    m = t[n.index],
                    h = { '--virtual-grid-row-vertical-offset': ''.concat(n.start - a, 'px') };
                return (
                    (0, l.useEffect)(() => {
                        let e = d.current;
                        if (e)
                    ...
                    (0, c.jsx)('div', {
                        ...
                        children: null == m ? void 0 : m.map((e) => (0, c.jsx)('div', { className: r, children: i(e) }, ''.concat(n.key, '_').concat(e))),
                    })
                );
            });
            var _ = n(27160),
            ...
            let f = (0, v.PA)((e) => {
                ...
                let S = { '--virtual-grid-height': ''.concat(g.getTotalSize(), 'px'), '--virtual-grid-column-count': f };
                return (0, c.jsx)('div', {
                    ref: P,
                    style: S,
                    className: x().root,
            ...
            let S = (0, s.PA)((e) => {
                ...
                ((e) => {
                    (0, l.useEffect)(() => {
                        ...
                        (0, p.M)(t, { fullUrl: null, locale: null, url: null, tld: '', host: '' }).then((e) => {
                            (0, P.jxB)(e);
                        });
                    }, [e]);
                })(s),
                t && s.isNeededToLoad && (0, l.use)(s.getData({ id: t, preloadedMeta: n })),
                          ...
                          children: (0, i.jsxs)(u.hO, {
                              ...
                              children: [
                                  (0, i.jsx)(g.Y9, {
                                      ...
                                      withForwardControl: !1,
                                      withBackwardControl: A.canBack,
                                      children: (0, i.jsx)(m.Heading, { variant: 'h2', weight: 'bold', size: 'xl', lineClamp: 1, children: s.fullTitle }),
                                  }),
                                  (0, i.jsx)(d.N, {
                                      className: N().root,
                                          ...
                                          children: [
                                              s.hasPlaylists &&
                                                  (0, i.jsx)(P.FoH, {
                                                      ...
                                                      children: (0, i.jsx)(b.EC, {
                                                          isShimmerVisible: s.isLoading,
                                                          isShimmerActive: !0,
                                                          headerClassName: (0, r.$)(N().carouselBlockHeader, N().carouselBlock),
                                              ...
                                              s.hasArtists &&
                                                  (0, i.jsx)(P.FoH, {
                                                      ...
                                                      children: (0, i.jsx)(g.OY, {
                                                          ...
                                                          children: s.artists.map((e) => (0, i.jsx)(v.ao, { artist: e, contentLinesCount: 3 }, e.id)),
                                                      }),
                                                  }),
                                          ],
                                      }),
