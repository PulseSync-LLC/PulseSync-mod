...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5897],
    {
        ...
        2257: (t, e, r) => {
            ...
            class y {
                openDB(t) {
                    let { onBlocked: e, onBlocking: r, onTerminated: a, onUpgrade: n } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                signal: null == e ? void 0 : e.signal,
                                searchParams: (0, n.P)({ childModEnabled: null == t ? void 0 : t.childModEnabled }),
                            }),
                        )
                    ).json();
                }
        ...
        85897: (t, e, r) => {
                ...
                onArtistImageReceived(t, e) {
                    ...
                    null == (r = this.fileStorage) ||
                        r.writeFile(i, e).catch((t) => {
                            this.hooks.afterError.promise(new _('Failed to write artist image', { cause: t, data: { path: i } }));
                        });
                }
                constructor(t) {
            ...
            let P = { name: a.ALBUMS, version: 1, restrictions: { attemptsCount: 3, count: 100 } },
                ...
                F = { name: a.ARTISTS, version: 1, restrictions: { attemptsCount: 3, count: 100 } },
            ...
            class G {
                async get(t, e, r) {
                    var i;
                    return (null == (i = this.repositoryContainer.responseCacheRepository) ? void 0 : i.get(t, e, r)) || null;
                }
                put(t) {
                    var e;
            ...
            class q {
                ...
                getRequestId(t) {
                    return (0, O.createHash)('sha256').update(JSON.stringify(t)).digest('hex');
                }
                async get(t, e) {
                    if ('number' == typeof this.variables.uid)
                        try {
                            ...
                            throw new x('Cache not found', { cause: e, data: { requestId: t, uid: this.variables.uid } });
                        }
                    throw new x('Cache not found', { data: { requestId: t, uid: String(this.variables.uid) } });
                }
                put(t) {
                    let { requestId: e, response: r, uid: i, priority: a } = t,
                        n = null != i ? i : this.variables.uid;
                    'number' == typeof n && this.cacheManager.put({ uid: n, requestId: e, priority: a, response: r });
                }
                async handleError(t, e, r) {
                    if (!(t instanceof D.GX) || W.includes(t.statusCode)) return this.get(e, r);
                    throw t;
                }
                constructor(t) {
            ...
            class z {
                apply(t) {
                    ...
                    e.afterError.tapPromise('LoggerPlugin', async (t) => {
                        let e;
                        return (
                            (e = t instanceof S.t ? t : new S.t('Error in Slam', { code: 'E_SLAM', cause: t })).cause instanceof Error && delete e.cause.stack,
            ...
            class Z {
                async getArtist(t) {
                    var e, r, i;
                    let a = await (null == (e = this.repositoryContainer.artistsRepository) ? void 0 : e.get(t));
                    if (!a) return null;
                    let n = {
                            available: !0,
                            decomposed: [],
                    ...
                    if (await (null == (r = this.fileStorage) ? void 0 : r.isFileExisting(s))) {
                        let t = await (null == (i = this.fileStorage) ? void 0 : i.createFileURL(s));
            ...
            class to {
                async getFileInfo(t, e) {
                    let r = (0, ta.T)(),
                        ...
                        a = ''.concat(r).concat(t).concat(e).concat(i).concat(this.transport),
                        n = await (0, ta.m)({ secretKey: this.secretKey, data: a });
                ...
                async getImage(t, e) {
                    try {
                        let r = (0, ti.createAvatarUrl)(t, this.variables.coverSize, !1),
                            i = await fetch(r, { cache: 'no-store' }),
                            a = await i.blob();
                        e(a);
                    } catch (e) {
                        this.hooks.afterError.promise(new ts('Error when downloading image', { cause: String(e), data: { src: t } }));
                    }
                }
                async start() {
                    try {
                        ...
                        let n = null,
                            ...
                            o = [],
                            c = a.urls[0];
                        if (!c) return void this.handleDownloadError('Src is not defined');
                        let l = async () => {
            ...
            class td {
                    ...
                    return (
                        ...
                        Promise.all(
                            r.map(async (t) => {
                                ...
                                return Promise.all([
                                    null == (e = this.repositoryContainer.artistsRepository) ? void 0 : e.put(i),
                                    null == (r = this.repositoryContainer.artistsTracksRepository) ? void 0 : r.put(a),
                                ]);
                            }),
                        )
                    );
                    ...
                    return t.albums
                        ? Promise.all(
                              t.albums.map(async (e) => {
                                  ...
                                  let { artists: a, ...n } = e;
                                  return Promise.all([
                                      null == (r = this.repositoryContainer.albumsRepository) ? void 0 : r.put(n),
                                      null == (i = this.repositoryContainer.albumsTracksRepository) ? void 0 : i.put(String(t.id), String(n.id)),
                                  ]);
                              }),
                          )
                        : Promise.resolve();
                ...
                async getTrackArtists(t) {
                    var e;
                    let r,
                        i = await (null == (e = this.repositoryContainer.artistsTracksRepository) ? void 0 : e.getArtistsByTrackId(t));
                ...
                async getTrackAlbums(t, e) {
                    ...
                    if (e) {
                        ...
                        let e = await (null == (i = this.repositoryContainer.albumsTracksRepository) ? void 0 : i.getAlbumsByTrackId(t));
                    ...
                    return (null == r ? void 0 : r.length)
                        ? Promise.all(
                              r.map(async (e) => {
                                  ...
                                  0 === (await (null == (i = this.repositoryContainer.artistsTracksRepository) ? void 0 : i.getCountByArtist(s))))
                                      ? Promise.all([
                                            null == (a = this.fileStorage) ? void 0 : a.deleteFile(A(s)),
                ...
                async deleteTrackAlbums(t) {
                    ...
                    return (null == r ? void 0 : r.length)
                        ? Promise.all(
                              r.map(async (e) => {
                                  var r, i, a;
                                  return (await (null == (r = this.repositoryContainer.albumsTracksRepository) ? void 0 : r.delete(t, e)),
                                  0 === (await (null == (i = this.repositoryContainer.albumsTracksRepository) ? void 0 : i.getCountByAlbum(e))))
                                      ? null == (a = this.repositoryContainer.albumsRepository)
                                          ? void 0
                                          : a.delete(e)
                                      : Promise.resolve();
                              }),
                ...
                async saveTrack(t) {
                    var e;
                    this.store.tracks.setEntityState(String(t.id), { loadingState: c.DOWNLOADING });
                    let r = (0, tr.A)(t);
                    return (
                        delete r.albums,
                        delete r.artists,
                ...
                async getTrack(t) {
                    ...
                    let [i, a] = (0, J.d)(t);
                    if (!i) return null;
                    let n = await (null == (e = this.repositoryContainer.tracksRepository) ? void 0 : e.get(i));
                    if (!n) return null;
                    let s = n.meta;
                    return (
                        s.coverUri && (s.coverUri = await (null == (r = this.fileStorage) ? void 0 : r.createFileURL(tc(t)))),
                ...
                async deleteTrack(t, e) {
                    ...
                    if (
                        ...
                        await this.usersTracksManager.delete(this.userConfig.uid, t),
                ...
                download(t) {
                    ...
                    let [r] = (0, J.d)(t);
                    if (!r) return;
                    let i = null == (e = this.store.tracks.state[r]) ? void 0 : e.loadingState;
                    (!this.store.tracks.state[r] || (i && th.includes(i))) &&
                        this.downloader.injectTask(new to(String(t), this.trackDownloadTaskParams, this.downloader.quality));
                }
                stopDownload(t) {
                    var e;
                    let [r] = (0, J.d)(t);
                    if (!r) return;
                    let i = null == (e = this.store.tracks.state[r]) ? void 0 : e.loadingState;
                    (!this.store.tracks.state[r] || (i && tu.includes(i))) && (this.changeState(r, { loadingState: c.IDLE }), this.downloader.removeTask(String(t)));
                }
                onTrackDownloadFinished(t) {
                    let [e, r] = (0, J.d)(t);
                    e &&
                        (this.usersTracksManager.put({ uid: this.userConfig.uid, downloadSource: s.TRACK, trackId: e, albumId: r }),
                        this.changeState(e, { loadingState: c.DOWNLOADED }));
                }
                onTrackDownloadStopped(t) {
                    let [e, r] = (0, J.d)(t);
                    e && (this.deleteTrack(e, r), this.changeState(e, { loadingState: c.IDLE }));
                }
                onTrackDownloadFailed(t) {
                    let [e, r] = (0, J.d)(t);
                    e && (this.deleteTrack(e, r), this.changeState(e, { loadingState: c.DOWNLOAD_FAILED }));
                }
                ...
                onChunkMediaFileReceived(t, e) {
                    ...
                    let [i] = (0, J.d)(t);
                    i &&
                        (null == (r = this.store.tracks.state[i]) ? void 0 : r.loadingState) !== c.IDLE &&
                        this.changeState(i, { loadingState: c.DOWNLOADING, progress: e });
                }
                onMediaFileReceived(t, e) {
                    var r, i;
                    let [a] = (0, J.d)(t);
                    if (!a || (null == (r = this.store.tracks.state[a]) ? void 0 : r.loadingState) === c.IDLE) return;
                    let n = tl(a);
            ...
            class tv {
                ...
                async validateTracks() {
                    try {
                        ...
                        this.hooks.afterError.promise(new ty('Failed to validate tracks', { cause: t }));
                    }
                }
                download(t) {
                    this.trackManager.download(t);
                ...
                async getTracks(t) {
                    let e = t;
                    return (t || (e = await this.usersTracksManager.getTracksByUid(this.userConfig.uid)), e)
                        ? (await Promise.all(null == e ? void 0 : e.map(async (t) => this.getTrack(t)))).filter((t) => null !== t)
                        : [];
                }
                async getTracksCount() {
                    let t = await this.usersTracksManager.getCountByUid(this.userConfig.uid);
                    return null != t ? t : 0;
                }
                async getTrack(t) {
                    try {
                ...
                async deleteTrack(t) {
                    try {
                        ...
                        this.hooks.afterError.promise(new ty('Failed to delete track', { cause: e, data: { id: t } }));
                    }
                }
                        ...
                        let e = async (t) => {
                                (await this.availabilityResource.getAvailabilityTracks({ trackIds: t })).availabilities.forEach((t) => {
                                    let { trackId: e, available: r } = t,
                                        [i] = (0, J.d)(e);
                                    i && this.trackManager.putTrackAvailable(i, r);
                                });
                            },
                            r = (0, tg.A)(t, this.variables.requestTrackChunkSize);
                        Promise.all(r.map(e));
                    } catch (t) {
                        this.hooks.afterError.promise(new ty('Failed to refresh tracks availability', { cause: t }));
                    }
                }
                async refreshTracksMeta() {
                    try {
                        ...
                        this.hooks.afterError.promise(new ty('Failed to refresh tracks meta', { cause: t }));
                    }
                }
                async updateTrackMeta(t) {
                    try {
                        var e, r;
                        let i = await this.usersTracksManager.get(this.userConfig.uid, String(t.id));
                        if (!i) return;
            ...
            class tp {
                async getTracksByUid(t) {
                    var e;
                    return null == (e = this.repositoryContainer.usersTracksRepository) ? void 0 : e.getTracksByUid(t);
                }
                async getCountByUid(t) {
                    var e;
                    return null == (e = this.repositoryContainer.usersTracksRepository) ? void 0 : e.getCountByUid(t);
                }
                ...
                async get(t, e) {
                    var r;
                    return null == (r = this.repositoryContainer.usersTracksRepository) ? void 0 : r.get(t, e);
                }
                async put(t) {
                    var e;
            ...
            class tT {
                ...
                async openIdb() {
                    return new N.h(''.concat('music_slam', '_').concat(this.config.name)).openDB(this.config.version, {
                        ...
                        onUpgrade: (t, e, r, i, a) => {
                            var n, s;
                            null == (s = this.handlers) || null == (n = s.onUpgrade) || n.call(s, t, e, r, i, a);
                        },
                    });
                }
                onError() {
            ...
            class tC extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        let i = await e.get(P.name, String(t.id)),
                            a = Date.now(),
                            n = null != (r = null == i ? void 0 : i.createdAt) ? r : a;
                        return e.put(P.name, { meta: t, updatedAt: a, createdAt: n }, String(t.id));
                    }).catch((e) => {
                ...
                async get(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        return null != (r = null == i ? void 0 : i.meta) ? r : null;
                    }).catch((e) => {
            ...
            class tA extends tT {
                async put(t, e) {
                    return this.executeTransaction(async (r) => r.put(L.name, { trackId: t, albumId: e }, t_(t, e))).catch((r) => {
                        throw this.generateError('Error when trying to put data', r, { trackId: t, albumId: e });
                    });
                }
                async get(t, e) {
                ...
                async getTracksByAlbumId(t) {
                    return this.executeTransaction(async (e) => (await e.getAllFromIndex(L.name, tI, t)).map((t) => t.trackId)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { albumId: t });
                    });
                }
                async getAlbumsByTrackId(t) {
                    return this.executeTransaction(async (e) => (await e.getAllFromIndex(L.name, tS, t)).map((t) => t.albumId)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { trackId: t });
                    });
                }
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(L.name, t_(t, e))).catch((r) => {
                        throw this.generateError('Error when trying to delete data', r, { trackId: t, albumId: e });
                    });
                }
                async getCountByAlbum(t) {
                    return this.executeTransaction(async (e) => e.countFromIndex(L.name, tI, t)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { albumId: t });
                    });
                }
                constructor() {
                ...
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        let i = await e.get(F.name, String(t.id)),
                            a = Date.now(),
                            n = null != (r = null == i ? void 0 : i.createdAt) ? r : a;
                        return e.put(F.name, { meta: t, updatedAt: a, createdAt: n }, String(t.id));
                    }).catch((e) => {
            ...
            class tN extends tT {
                async put(t) {
                    ...
                    return this.executeTransaction(async (i) => i.put(K.name, t, tx(e, r))).catch((t) => {
                ...
                async getArtistsByTrackId(t) {
                    return this.executeTransaction(async (e) => (await e.getAllFromIndex(K.name, tD, t)).sort((t, e) => t.artistIndex - e.artistIndex)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { trackId: t });
                    });
                }
                async getTracksByArtistId(t) {
                    return this.executeTransaction(async (e) => (await e.getAllFromIndex(K.name, tO, t)).sort((t, e) => t.artistIndex - e.artistIndex)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { artistId: t });
                    });
                }
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(K.name, tx(t, e))).catch((r) => {
                        throw this.generateError('Error when trying to delete data', r, { artistId: e, trackId: t });
                    });
                }
                async getCountByArtist(t) {
                    return this.executeTransaction(async (e) => e.countFromIndex(K.name, tO, t)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { artistId: t });
                    });
                }
                constructor() {
            ...
            class tF extends tT {
                ...
                async get(t, e, r) {
                    ...
                    return i && r && Date.now() - i.updatedAt > r ? (await this.delete(t, e), null) : null != i ? i : null;
                }
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(j.name, tL(t, e))).catch((r) => {
                ...
                async deleteResponseByLowPriority() {
                    return this.executeTransaction(async (t) => {
                        let e = t.transaction([j.name], 'readwrite').objectStore(j.name).index(tP),
                ...
                constructor() {
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                t.createObjectStore(j.name).createIndex(tP, ['priority', 'updatedAt']);
                            },
                        },
                    });
                }
            ...
            class tK extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        let i = await e.get(M.name, t.id),
                            a = Date.now(),
                            n = null != (r = null == i ? void 0 : i.createdAt) ? r : a;
                        return e.put(M.name, { ...i, meta: t, updatedAt: a, createdAt: n }, t.id);
                    }).catch((e) => {
                ...
                async getAllIds() {
                    return this.executeTransaction(async (t) => t.getAllKeys(M.name)).catch((t) => {
                ...
                async putDecryptKey(t, e) {
                    return this.executeTransaction(async (r) => {
                        ...
                        let n = Date.now(),
                            s = null != (i = null == a ? void 0 : a.createdAt) ? i : n;
                        return r.put(M.name, { meta: a.meta, decryptKey: e, updatedAt: n, createdAt: s }, t);
                    }).catch((e) => {
                ...
                async putTrackAvailable(t, e) {
                    return this.executeTransaction(async (r) => {
                        ...
                        let n = Date.now(),
                            s = null != (i = null == a ? void 0 : a.createdAt) ? i : n,
                            { meta: o } = a;
                        return r.put(M.name, { ...a, meta: { ...o, available: e }, updatedAt: n, createdAt: s }, t);
                    }).catch((e) => {
                        throw this.generateError('Error when trying to put data', e, { trackId: t });
                    });
                }
                async getDecryptKey(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        return null != (r = null == i ? void 0 : i.decryptKey) ? r : null;
                    }).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { trackId: t });
                    });
                }
                async delete(t) {
                    return this.executeTransaction(async (e) => e.delete(M.name, t)).catch((e) => {
                ...
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        let i = await e.get(U.name, t.uid),
                            a = Date.now(),
                            n = null != (r = null == i ? void 0 : i.createdAt) ? r : a;
                        return e.put(U.name, { ...t, updatedAt: a, createdAt: n }, t.uid);
                    }).catch((e) => {
            ...
            class tB extends tT {
                async put(t) {
                    ...
                    return this.executeTransaction(async (i) => {
                        ...
                        let n = tU(e, r),
                            ...
                            o = Date.now(),
                            c = null != (a = null == s ? void 0 : s.createdAt) ? a : o;
                        return i.put(B.name, { ...t, updatedAt: o, createdAt: c }, n);
                    }).catch((t) => {
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(B.name, tU(t, e))).catch((r) => {
                        throw this.generateError('Error when trying to delete data', r, { uid: t, trackId: e });
                    });
                }
                async getCountByTrackId(t) {
                    return this.executeTransaction(async (e) => e.countFromIndex(B.name, tM, t)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { trackId: t });
                    });
                }
                async getCountByUid(t) {
                    return this.executeTransaction(async (e) => e.countFromIndex(B.name, 'uid', t)).catch((e) => {
                        throw this.generateError('Error when trying to get data', e, { uid: t });
                    });
                }
                constructor() {
                        ...
                        (this.container = (function (t) {
                            ...
                            return new Q.Dt().registerMany({
                                ...
                                [f]: (0, Q.Gr)((t) => {
                                    ...
                                    return e ? new tv({ container: t, variables: s }) : null;
                                }),
                                [b]: (0, Q.Gr)((t) => {
                                    let { entities: e } = t.get(d);
                ...
                constructor({ config: t, plugins: e }) {
                    (0, h._)(this, 'hooks', $),
                        ...
                        (this.repositoryContainer = ((t) => {
                            let { useFileStorage: e, useResponseCacheStorage: r, useEntitiesStorage: i } = t,
                                a = {};
                            return (
            ...
            class tq extends tW.Q {
                async about(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: tW.Q.constructor.name, methodName: this.about.name, args: [t] });
                ...
                async settings(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: tW.Q.constructor.name, methodName: this.settings.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
                ...
                async experiments(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: tW.Q.constructor.name, methodName: this.experiments.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
                ...
                async experimentsDetails(t, e) {
                    let r = this.cacheController.getRequestId({ resourceName: tW.Q.constructor.name, methodName: this.experimentsDetails.name, args: [t] });
                    if (this.cacheController.shouldGetCache) return this.cacheController.get(r, 6048e5);
                    try {
                        ...
                        let a = t[e],
                            {
                                ...
                                return {
                                    enabled: null != (i = null == s ? void 0 : s.enabled) ? i : t.enabled,
                                    ttl: null != (a = null == s ? void 0 : s.ttl) ? a : t.ttl,
            ...
            let tz = [tX.e.PREVIEW, tX.e.SMART_PREVIEW],
                tQ = async (t) => {
                    let { key: e, data: r, loadedBytes: i } = t,
                        a = await crypto.subtle.importKey('raw', new Uint8Array(e.match(/.{1,2}/g).map((t) => parseInt(t, 16))), { name: 'AES-CTR' }, !1, [
                            'encrypt',
                            'decrypt',
                        ]),
                        n = new Uint8Array(16);
            ...
            class tJ extends tV.v {
                ...
                async getSign(t, e, r, i) {
                    let a = (0, ta.T)(),
                        n = t.join(','),
                        s = e.join(''),
                        o = ''.concat(a).concat(n).concat(r).concat(s).concat(i);
                    return (0, ta.m)({ secretKey: this.variables.secretKey, data: o });
                }
                async getFileInfoBatch(t, e) {
                    let r = t.trackIds.split(','),
                        i = await Promise.all(r.map(async (e) => this.isTrackDownloaded.bind(this)(e, t.quality))),
                        a = {},
                        n = [],
                        s = [];
                    r.forEach((t, e) => {
                    ...
                    o.forEach((t, e) => {
                        switch (t.status) {
                            ...
                            case 'rejected': {
                                let t = s[e];
                                t && (this.hooks.afterError.promise(new tY('Can not get a local file', { data: { trackId: t } })), n.push(t));
                            }
                        }
                    });
                    let l = null;
                    if (n.length > 0) {
                        ...
                        try {
                            l = (await super.getFileInfoBatch({ ...t, sign: i, trackIds: n.join(',') }, e)).downloadInfos;
                        } catch (t) {
                            this.hooks.afterError.promise(new tY('Can not get file info batch', { cause: String(t), data: { trackIds: n.join(',') } }));
                        }
                    }
                    return (
                        null == l ||
                    ...
                    new Proxy(t, {
                        get(t, r) {
                            ...
                            return 'function' == typeof i && a
                                ? function () {
                                      throw new D.GX('Offline mode enabled', { statusCode: tZ });
                                  }
                                : i;
                        },
                    });
            ...
            class t3 extends t0.G {
                ...
                async getBlock(t, e) {
                    return t.type === t1.t.COLLECTION_DOWNLOADED_TRACKS ? this.getCollectionDownloadedTracks() : super.getBlock(t, e);
                }
                async getSkeleton(t, e) {
                    if (!this.variables.cacheController) return super.getSkeleton(t, e);
                    if (t.id === t6.p.WEB_COLLECTION) {
                        let r = this.variables.cacheController.getRequestId({ resourceName: t0.G.constructor.name, methodName: this.getSkeleton.name, args: [t] });
        ...
        91628: (t, e, r) => {
            ...
            class s extends n.X {
                async getFileInfo(t, e) {
                    ...
                    return { ...(await i.json()), responseTime: null == (r = i.timings) ? void 0 : r.response, url: i.url };
                }
                async getFileInfoBatch(t, e) {
                    return (
                        await this.httpClient.get(
            ...
            class n extends a {
                createHttpOptions(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        { timeoutKey: r, params: i, headers: a, signal: n, ...s } = t,
                        { prefixUrl: o, ...c } = s,
                        { timeouts: l = this.config.timeouts, withoutPrefixUrl: h, withoutHeaders: u } = e,
                        d = null == l ? void 0 : l[r],
                        g = u ? void 0 : null != a ? a : this.createRequestHeaders({ params: i, timeout: d }),
                ...
                createRequestHeaders() {
                    ...
                    if (
                        (null != (e = null == i || null == (t = i.common) ? void 0 : t.sendRequestDeadline) ? e : this.config.params.common.sendRequestDeadline) &&
                        void 0 !== a
                    ) {
                        let t = Date.now() + a;
                ...
                createRequestHeadersFromParams(t) {
                    ...
                    let f = (null == t || null == (e = t.common) ? void 0 : e.oauth) || this.config.params.common.oauth,
                        b = (null == t || null == (r = t.common) ? void 0 : r.client) || this.config.params.common.client,
                        k = (null == t || null == (i = t.common) ? void 0 : i.language) || this.config.params.common.language,
                        T = (null == t || null == (a = t.common) ? void 0 : a.device) || this.config.params.common.device,
                        ...
                        _ = null == (E = null == t || null == (d = t.common) ? void 0 : d.withoutInvocationInfo) || E,
                        A = (null == t || null == (g = t.common) ? void 0 : g.icookie) || this.config.params.common.icookie,
                        ...
                        D = (null == t || null == (p = t.common) ? void 0 : p.tracestate) || this.config.params.common.tracestate,
                        x = (null == t || null == (m = t.common) ? void 0 : m.traceparent) || this.config.params.common.traceparent,
                    ...
                    return (
                        ...
                        _ && (P['x-yandex-music-without-invocation-info'] = '1'),
