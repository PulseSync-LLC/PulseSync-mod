    ...
    [532, 7007],
    {
        ...
        17007: (e, t, n) => {
                    ...
                    return (
                        ...
                        (n.render = function () {
                            var e,
                                ...
                                l = r.status,
                                a = r.current,
                                s = { children: n, current: a, changeState: this.changeState, status: l };
                            switch (l) {
                                case u.ns:
                                    e = m[i](s);
                                    break;
                            ...
                            return o.createElement(c.A.Provider, { value: { isMounting: !this.appeared } }, e);
                        }),
                        t
                    );
                })(o.Component);
            ...
            let V = (0, a.PA)((e) => {
                                ...
                                (0, l.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, l.jsx)(A.Caption, {
                                            ...
                                            type: 'controls',
                                            size: 'm',
                                            children: (0, l.jsx)(y.A, { id: 'lite-version.notification-title' }),
                                        }),
                                        (0, l.jsx)(M.N_, {
                                            className: j().link,
                                            ...
                                            children: (0, l.jsx)(A.Caption, {
                                                ...
                                                type: 'controls',
                                                size: 'm',
                                                children: (0, l.jsx)(y.A, { id: 'lite-version.go-to-settings' }),
                                            }),
                                        }),
                                    ],
                                }),
                    ...
                    return (0, l.jsx)(M.$W, {
                        cover: (0, l.jsx)(k.Icon, { className: j().icon, size: 'xs', variant: 'liteVersion' }),
                        message: r,
                        closeToast: t,
                        coverRadius: 's',
                    });
            ...
            let H = (0, a.PA)((e) => {
                    var t, n, i, r, a, s, u, c;
                    let { vibeAnimationState: d, isIntersecting: f, forwardRef: v, className: m } = e,
                        [_, p] = (0, C.d)(),
                        [h, g] = (0, C.d)(),
                        [y, k] = (0, C.d)(),
                        [A, M] = (0, o.useState)(!1),
                        [computedHue, setComputedHue] = (0, o.useState)(null),
                        { user: P, sonataState: j, settings: V } = (0, E.Pjs)(),
                        L = (0, E.UlF)(),
                        { theme: N } = (0, E.DPo)(),
                        S = (0, E.iIU)(),
                        F = (0, b.c)((e) => {
                            if (e.data.type === x.iR.ERROR) {
                                M(!0);
                                L.error(e.data.payload);
                            } else if (e.data.type === x.iR.LOG) {
                                console.debug(
                                    '[WORKER]',
                                    e.data.payload
                                        .map((val, idx) => (val !== null && val !== undefined ? `[${idx}]: ${val}` : null))
                                        .filter(Boolean)
                                        .join(', '),
                                );
                            }
                    ...
                    let O = (0, b.c)(() => {
                        ...
                        const rmsAlt = S.analyser.getRMSAlt();

                        const energy = ((rms + rmsAlt) / 2) * (window.VIBE_ANIMATION_INTENSITY_COEFFICIENT?.() ?? 1) + 0.3;
                        const usedEnergy = window.VIBE_ANIMATION_USE_DYNAMIC_ENERGY?.() ? energy : (j?.entityMeta?.trackParameters?.energy ?? 1);
                        if (_ != null) _.updateEnergy(usedEnergy);
                        null == _ || _.updateAudioFrequencies({ low: null != e ? e : 0, middle: null != t ? t : 0, high: null != n ? n : 0 });
                        try {
                    ...
                    (0, o.useEffect)(() => {
                        const meta = j && j.entityMeta;
                        const params = meta && meta.trackParameters;
                        const rawHue = params && params.hue;
                        const providedHue = typeof rawHue === 'number' ? rawHue : typeof rawHue === 'string' && rawHue.trim() !== '' ? Number(rawHue) : null;
                        const avgColor =
                            (meta && meta.averageColor) ||
                            (meta && meta.derivedColors && typeof meta.derivedColors.average === 'string' ? meta.derivedColors.average : null);
                        const trackKey = (meta && (meta.id || meta.trackId)) || (j && j.id) || '';
                        ...
                        const rgbToHue = (r, g, b) => {
                            ...
                            return clamp360(h * 60);
                        };

                        const computeHue = () => {
                            if (providedHue !== null && !Number.isNaN(providedHue)) return clamp360(providedHue);
                            const rgb = parseColorToRgb(avgColor);
                            if (rgb) {
                                const { r, g, b } = rgb;
                                const gray = Math.abs(r - g) < 10 && Math.abs(r - b) < 10 && Math.abs(g - b) < 10;
                                if (!gray) return rgbToHue(r, g, b);
                                const brightness = (r + g + b) / 3;
                                const seed = hash360(String(trackKey));
                                const offset = seed % 20;
                                return brightness < 128 ? clamp360(220 + offset) : clamp360(offset);
                            }
                            const seeded = hash360(String(trackKey));
                            return clamp360(seeded);
                        };

                        const nextHue = computeHue();
                        if (computedHue !== nextHue) setComputedHue(nextHue);
                    }, [
                        j && j.entityMeta && j.entityMeta.trackParameters && j.entityMeta.trackParameters.hue,
                        j && j.entityMeta && j.entityMeta.derivedColors && j.entityMeta.derivedColors.average,
                        j && j.entityMeta && j.entityMeta.id,
                        j && j.entityMeta && j.entityMeta.trackId,
                        j && j.id,
                        computedHue,
                    ]),
                    (0, o.useEffect)(() => {
                        const meta = j && j.entityMeta;
                        const params = meta && meta.trackParameters;
                        const energy = params && params.energy;
                        const collectionHue = (params && params.userCollectionHue) || (P && P.collectionHue);

                        if (collectionHue) P.setUserCollectionHue(collectionHue);
                        if (K) {
                            _ && _.playAnimation({ hue: computedHue != null ? computedHue : 0, energy, collectionHue });
                        } else {
                            _ && _.idleAnimation();
                        }
                    }, [
                        K,
                        j && j.entityMeta && j.entityMeta.trackParameters && j.entityMeta.trackParameters.energy,
                        j && j.entityMeta && j.entityMeta.trackParameters && j.entityMeta.trackParameters.userCollectionHue,
                        computedHue,
                        P,
                        _,
                    ]),
                    ...
                    (0, o.useEffect)(() => {
                        d === x.IU.LITE && (null == _ || _.enableLiteAnimation());
                    }, [d, _]),
                    A)
                        ? (0, l.jsx)(T.VibeFallbackAnimation, { ref: v, className: m })
                        : (0, l.jsxs)(l.Fragment, {
                              children: [
                                  (0, l.jsx)('div', {
                                      ref: v,
                                      className: (0, w.$)(R().root, m),
                                      ...(0, I.Am)(I.Kq.vibeAnimation.VIBE_ANIMATION),
                                      children: (0, l.jsx)('canvas', { ref: g }),
                                  }),
                                  !1,
                              ],
                          });
                }),
                z = (0, o.forwardRef)((e, t) => (0, l.jsx)(H, { forwardRef: t, ...e })),
                q = { enter: R().enter, enterActive: R().enter_active, enterDone: R().enter_done, exit: R().exit, exitActive: R().exit_active, exitDone: R().exit_done },
                B = (0, a.PA)((e) => {
                    ...
                    let f = u.checkExperiment(E.zal.WebNextLiteVersion, 'on'),
                        ...
                        { isFallback: m, vibeAnimationState: y } = ((e) => {
                            let { isEnabled: t } = e,
                                ...
                                f = (0, o.useMemo)(() => (N || (N = new x.Qq()), N), []),
                                v = (0, b.c)((e) => {
                                    var t, o;
                                    if ((null == (o = window.Ya) || null == (t = o.Rum) || t.sendTimeMark('my-vibe-animation-fps', e.toFixed(1)), e >= 20)) {
                                        n.current = 0;
                                        return;
                                    }
                                    if ((n.current++, !(n.current < 3))) {
                                        ...
                                        s ||
                                            (u(!0),
                                            i.count('fallback', L),
                                            a.setLiteVersionMode(E.wv5.ENABLED, !0),
                                            r((0, l.jsx)(V, {}), { containerId: E.uQT.INFO, autoClose: !1 }));
                                    }
                                });
                            return (
                                (0, o.useEffect)(
                                    () => (
                                        a.isLiteVersionModeAvailableForToggle || !t || s ? (f.stopMeasuring(), (n.current = 0)) : f.startMeasuring(v),
                                        () => {
                                            f.stopMeasuring();
                                        }
                                    ),
                                    [f, v, t, s, a.isLiteVersionModeAvailableForToggle],
                                ),
                        ...
                        A = (0, h.L)(() =>
                            k
                                ? (0, l.jsx)(T.VibeFallbackAnimation, { ref: r, className: n })
                                : (0, l.jsx)(z, { ref: i, vibeAnimationState: y, isIntersecting: a && t, className: n }),
                        );
                    return (0, l.jsx)(_, {
                        mode: 'out-in',
                        children: (0, l.jsx)(p.A, { nodeRef: k ? r : i, timeout: 1e3, appear: !0, classNames: q, children: A }, k ? 'fallback' : 'shader'),
                    });
                });
        },
        94618: (e) => {
