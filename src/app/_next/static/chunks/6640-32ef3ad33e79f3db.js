                ...
                return (0, t.jsxs)('div', {
                    ...
                    children: [
                        ...
                        (0, t.jsxs)('div', {
                            ...
                            children: [
                                (0, t.jsx)(a.Icon, { className: c().icon, variant: 'attention', size: 'xxl' }),
                    ...
                    N = (0, l.useMemo)(
                        () =>
                            o.title
                                ...
                                : (0, t.jsx)(a.Shimmer, { className: g().shimmerTitle, radius: 'l' }),
                        [o.title],
                    );
                if (
        ...
        64143: (e, r, o) => {
            ...
            let h = (e) => {
                ...
                v = (0, l.PA)((e) => {
                    ...
                    let W = (0, t.useMemo)(() => (F ? { onScroll: (0, i.A)(A, 200) } : { onScroll: (0, i.A)(A, 200), elementRef: o }), [A, o, F]);
                    (0, d.L)(W);
                    let E = (0, t.useMemo)(
                        () => ({
                            title: b,
                ...
                P = (e) => {
                    let { children: r, child: o, className: n } = e,
                        { setChildElement: i, setChild: l } = (0, t.useContext)(a.B9),
                        d = (0, t.useRef)(null);
                    return (
                        (0, t.useEffect)(() => {
                ...
                b = (e) => {
                    let { children: r, title: o, className: n } = e,
                        { setTitleElement: i, setTitle: l } = (0, t.useContext)(a.B9),
                        d = (0, t.useRef)(null);
                    return (
                        (0, t.useEffect)(() => {
                            (null == d ? void 0 : d.current) && i(d), o && l(o);
                            ...
                            return o && !r.isLoading && r.playlistMeta
                                ? (0, t.jsx)(b.QB, {
                                      ...
                                      playContextParams: p(e, {
                                          contextData: { type: m.K.Playlist, meta: { id: ''.concat(r.playlistMeta.uid, ':').concat(r.playlistMeta.kind) }, from: x },
