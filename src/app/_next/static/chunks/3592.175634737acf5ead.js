        ...
        54540: (e, t, l) => {
            ...
            (Object.defineProperty(t, 'utils', {
                    ...
                    let l = (e, t) => {
                        ...
                        return 1 === t.length
                            ? null != o
                                ? o
                                : ''
                            : null == o || 'string' == typeof o || 'boolean' == typeof o || 'number' == typeof o || o instanceof Date
                              ? ''
                              : l(o, t.slice(1));
                    };
                    return l(e, t.split('.'));
                ...
                (t.getJsonSheetRow = (e, l) => {
                    ...
                    return (
                        l.forEach((l) => {
                            'function' == typeof l.value ? (o[l.label] = l.value(e)) : (o[l.label] = (0, t.getContentProperty)(e, l.value));
                        }),
                        o
                    );
                }));
                                            ...
                                            : 'number' == typeof e
                                              ...
                                              : 'boolean' == typeof e
                                                ...
                                                : e instanceof Date
                                                  ? e.toString().length
                                                  : 0)(o.v);
                                return o.z ? Math.max(t, Math.max(r, o.z.length)) : Math.max(t, r);
                            }, 0) + t,
                }))),
                (t.xlsx = (e, l = {}, n = () => {}) => {
                    ...
                    return (
                        e.forEach((e, n) => {
                            ...
                            let i = ((e, l) => {
                                    let n;
                                    n = e.content.length > 0 ? e.content.map((l) => (0, t.getJsonSheetRow)(l, e.columns)) : e.columns.map((e) => ({ [e.label]: '' }));
                                    ...
                                    return (
                                        ((e, t, l) => {
                                            ...
                                            for (let n = 0; n < t.length; n += 1) {
                                                let s = l[n];
                                                if (!s) continue;
                                                let u = o.utils.decode_col(t[n]),
                                                    i = o.utils.decode_range(null != (r = e['!ref']) ? r : '');
                                                for (let t = i.s.r + 1; t <= i.e.r; ++t) {
                                                    let l = o.utils.encode_cell({ r: t, c: u });
                                                    e[l] && ('hyperlink' === s ? (e[l].l = { Target: e[l].v }) : (e[l].z = s));
                                                }
                                            }
                                        })(
                                            s,
