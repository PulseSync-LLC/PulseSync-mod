    ...
    [3576],
    {
        43576: (t, e, r) => {
            ...
            var g = function (t, e, r, o, i) {
                    ...
                    if (Array.isArray(T) && 1 === T.length && T[0].type === s.TYPE.literal) return T[0].value;
                    if (!o && T && 'string' == typeof T && !h) return T.replace(/'\{(.*?)\}'/gi, '{$1}');
                    if (((o = (0, n.__assign)((0, n.__assign)({}, h), o || {})), (u = f(u, v)), (d = f(d, v)), !T)) {
                        if (!1 === p && '' === T) return T;
                        if (((!b || (l && l.toLowerCase() !== g.toLowerCase())) && y(new m.sb(r, l)), b))
                            try {
                                var F = e.getMessageFormat(b, g, d, i);
                                return F.format(o);
                            } catch (t) {
                                return (
                                    y(new m.Ho('Error formatting default message for: "'.concat(E, '", rendering default message verbatim'), l, r, t)),
                                    'string' == typeof b ? b : E
                                );
                            }
                        return E;
                    ...
                    try {
                        var F = e.getMessageFormat(T, l, u, (0, n.__assign)({ formatters: e }, i || {}));
                        return F.format(o);
                    } catch (t) {
                        y(new m.Ho('Error formatting message: "'.concat(E, '", using ').concat(b ? 'default message' : 'id', ' as fallback.'), l, r, t));
                    }
                    if (b)
                        try {
                            var F = e.getMessageFormat(b, g, d, i);
                            ...
                            y(new m.Ho('Error formatting the default message for: "'.concat(E, '", rendering message verbatim'), l, r, t));
                        }
            ...
            function p(t, e, r, o) {
                ...
                void 0 === o && (o = {});
                var u = o.format,
                    c = (0, n.__assign)((0, n.__assign)({}, m && { timeZone: m }), u && (0, a.F3)(s, e, u, l)),
                    f = (0, a.J9)(o, d, c);
                return (
                    'time' !== e ||
                        f.hour ||
            ...
            function h(t, e) {
                ...
                try {
                    return p(t, 'dateTimeRange', e, void 0 === i ? {} : i).formatRange(s, l);
                } catch (e) {
                    t.onError(new m.pg('Error formatting date time range.', t.locale, e));
                }
                return String(s);
            }
            function _(t, e) {
                ...
                var a = r[0],
                    ...
                    i = 'string' == typeof a ? new Date(a || 0) : a;
                try {
                    return p(t, 'date', e, void 0 === o ? {} : o).formatToParts(i);
                } catch (e) {
                    t.onError(new m.pg('Error formatting date.', t.locale, e));
                }
                return [];
            ...
            function b(t, e) {
                ...
                var a = r[0],
                    ...
                    i = 'string' == typeof a ? new Date(a || 0) : a;
                try {
                    return p(t, 'time', e, void 0 === o ? {} : o).formatToParts(i);
                } catch (e) {
                    t.onError(new m.pg('Error formatting time.', t.locale, e));
                }
                return [];
            ...
            function N(t, e, r, n) {
                ...
                try {
                    ...
                    t.onError(new m.pg('Error formatting number.', t.locale, e));
                }
                return String(r);
            }
            function R(t, e, r, n) {
            ...
            function x(t, e, r, n, o) {
                ...
                try {
                    ...
                    (u = t.onError),
                    void 0 === i && (i = {}),
                    (f = (!!(c = i.format) && (0, a.F3)(l, 'relative', c, u)) || {}),
                    e(s, (0, a.J9)(i, O, f))).format(r, n);
                } catch (e) {
                    t.onError(new m.pg('Error formatting relative time.', t.locale, e));
                }
                return String(r);
            }
            var M = r(12759);
            ...
            var A = function (t, e, r, a) {
                    ...
                    var l = C(a),
                        m = g.apply(void 0, (0, n.__spreadArray)([t, e, r, l], o, !1));
                ...
                Z = function (t, e) {
                    var r,
                        ...
                        E = C(d),
                        T =
                            ((r = (0, n.__assign)((0, n.__assign)((0, n.__assign)({}, i.JF), p), { defaultRichTextElements: E })),
                            (o = (0, a.GT)(e)),
                            (l = (s = (0, n.__assign)((0, n.__assign)({}, a.JF), r)).locale),
                            (u = s.defaultLocale),
                            (c = s.onError),
                            l
                                ? !Intl.NumberFormat.supportedLocalesOf(l).length && c
                                    ? c(
                                          new m.hr(
                            ...
                            (0, n.__assign)((0, n.__assign)({}, s), {
                                formatters: o,
                                formatNumber: N.bind(null, s, o.getNumberFormat),
                                formatNumberToParts: R.bind(null, s, o.getNumberFormat),
                                formatRelativeTime: x.bind(null, s, o.getRelativeTimeFormat),
                                formatDate: y.bind(null, s, o.getDateTimeFormat),
                                formatDateToParts: _.bind(null, s, o.getDateTimeFormat),
                                formatTime: v.bind(null, s, o.getDateTimeFormat),
                                formatDateTimeRange: h.bind(null, s, o.getDateTimeFormat),
                                formatTimeToParts: b.bind(null, s, o.getDateTimeFormat),
                                formatPlural: L.bind(null, s, o.getPluralRules),
                                formatMessage: g.bind(null, s, o),
                                $t: g.bind(null, s, o),
                                formatList: S.bind(null, s, o.getListFormat),
                                formatListToParts: D.bind(null, s, o.getListFormat),
                                formatDisplayName: F.bind(null, s, o.getDisplayNames),
                            })),
                        w = {
                            locale: T.locale,
                            timeZone: T.timeZone,
                    ...
                    return (0, n.__assign)((0, n.__assign)({}, T), { formatMessage: A.bind(null, w, T.formatters), $t: A.bind(null, w, T.formatters) });
                },
                J = r(26519);
            function G(t) {
                return {
