...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5428],
    {
        ...
        95428: (e, t, i) => {
                    ...
                    get isAvailable() {
                        ...
                        if (
                            ...
                            ((e) => {
                                ...
                                return !!(e.name && T.includes(e.name) && e.OSFamily && S.includes(e.OSFamily) && t && t < 18);
                            })(t.browserInfo)
                        )
                            return !1;
                        return e.available;
                    ...
                    .actions((e) => {
                        let t = {
                            ...
                            setItems: (s, l) => {
                                ...
                                if (((e.requestsCount = (null != (a = e.requestsCount) ? a : 0) + 1), g === P.F.ERROR || !s || !o))
                                ...
                                e.pager || (e.pager = { page: o.page, perPage: o.perPage, total: o.total }),
                                    ...
                                    i
                                        ...
                                        : (e.items || (e.items = (0, r.wg)(Array.from({ length: e.pager.total }, () => null))),
                                          e.items && (0, x.I)({ items: e.items, mappedRawItems: s, page: n, pageSize: e.pager.perPage }));
                            },
            ...
            var j = i(1531),
                V = i(46299);
            let B = [j.s.LIKED_ALBUMS, j.s.LIKED_ARTISTS, j.s.LIKED_PLAYLISTS, j.s.LIKED_TRACKS, j.s.LIKED_CLIPS],
                F = r.gK.optional(r.gK.map(r.gK.enumeration(Object.values(V.O))), {}),
                U = r.gK.model('LibraryRecord', { revision: r.gK.maybeNull(r.gK.number), items: F }),
                H = r.gK
                    ...
                    .actions((e) => {
                        let t = {
                            getData: (0, r.L3)(function* () {
                                let i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : B,
            ...
            let eo = r.gK.model({ amount: r.gK.number, currency: r.gK.string }),
                ...
                eL = r.gK.model({ offer: r.gK.maybeNull(ey), acqOffer: r.gK.maybeNull(eb) }).views((e) => {
                    let t = {
                        ...
                        get subscriptionName() {
                            var D, T;
                            return null == (T = e.acqOffer) || null == (D = T.offerTexts) ? void 0 : D.subscriptionName;
                        },
                        get offerText() {
                            var S, O;
                            return null == (O = e.acqOffer) || null == (S = O.offerTexts) ? void 0 : S.buttonTextWithDetails;
                        },
                        get buttonText() {
                            var h, k;
                ...
                eD = r.gK
                    ...
                    .volatile(() => ({ sessionId: (0, z.A)(), isFrontSessionStartSent: !1 }))
                    .views((e) => {
                        let t = {
            ...
            let eC = r.gK
                .model('Settings', {
                    layout: r.gK.maybeNull(r.gK.enumeration(Object.keys(eS.u))),
                    ...
                    .views((e) => ({
                        get isVisible() {
                            let {
                                ...
                                l = t.isAdvertDisabled(eN.f.SIDE_BANNER);
                    ...
                    .views((e) => {
                        let t = {
                            get isTouchTopAdvertEnabled() {
                                let { advert: t, experiments: i, settings: s } = (0, r.Zn)(e),
                                    l = t.isAdvertDisabled(eN.f.TOUCH_BANNER);
                                return (
                                    s.isMobile &&
                            ...
                            get isVisible() {
                                ...
                                let {
                                    ...
                                    o = s.isAdvertDisabled(eN.f.TOP_BANNER),
                                    g = a.isVisible || n.isVisible;
                                return !(null == (i = l.browserInfo) ? void 0 : i.isTouch) && !t.isTouchTopAdvertEnabled && !g && !o;
                            },
                        };
                        return t;
                    })
                    .named('TopAdvertBanner'),
                ew = r.gK.model('TrackIdModel', { id: r.gK.union(r.gK.string, r.gK.number), albumId: r.gK.maybe(r.gK.number), timestamp: r.gK.maybe(r.gK.string) });
        },
    },
]);
