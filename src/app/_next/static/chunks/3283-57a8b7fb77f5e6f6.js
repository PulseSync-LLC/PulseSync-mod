...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        63283: (e, t, n) => {
            n.d(t, { iv: () => o, bq: () => y, O5: () => h, p$: () => r, Jd: () => ea, gv: () => ed, qP: () => el, zT: () => eu, $P: () => O, F4: () => T, fD: () => E }),
                (function (e) {
            ...
            var r,
                ...
                _ = { NONE: 'NONE' },
                g = { DO_NOT_INTERCEPT_BY_DEFAULT: 'DO_NOT_INTERCEPT_BY_DEFAULT', INTERCEPT_EAGER: 'INTERCEPT_EAGER' },
                m = { BASED_ON_ENTITY_BY_DEFAULT: 'BASED_ON_ENTITY_BY_DEFAULT' },
                O = {
                    UNSPECIFIED: 'UNSPECIFIED',
                    ARTIST: 'ARTIST',
                    PLAYLIST: 'PLAYLIST',
                ...
                return {
                    player_state: {
                        player_queue: {
                            ...
                            entity_id: '',
                            entity_type: O.VARIOUS,
                            playable_list: [],
                            options: { repeat_mode: _.NONE },
                            shuffle_optional: null,
                            entity_context: m.BASED_ON_ENTITY_BY_DEFAULT,
                            version: t,
                            from_optional: '',
                ...
                j = (function () {
                    function e(e) {
                        Object.defineProperty(this, 'state', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            (this.options = e),
                            (this.state = P(e.deviceConfig.info.device_id)),
                            (this.prevState = P(e.deviceConfig.info.device_id)),
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'fullState', {
                            get: function () {
                                return C({ state: this.state, prevState: this.prevState, diff: this.diff, remoteControllerDevice: this.remoteControllerDevice });
                            },
                            enumerable: !1,
                            configurable: !0,
                        }),
                                ...
                                try {
                                    ...
                                    if ((void 0 === i || i) && c.length) {
                                        ...
                                        c.forEach(function (n) {
                                            ...
                                            (this.prevState = C(this.state)),
                                            (this.state = u);
                                    }
                                    this.updateLastRemoteControllerDevice();
                                    var p = A(A({}, this.fullState), { options: e });
                                    this.emitter.emit(r.UPDATED, p, { trigger: e.trigger });
                                } catch (e) {
                                    var f = new D.t('YnisonStateController. Parsing error', { cause: S(e) });
                            ...
                            value: function (e) {
                                var t = this,
                                    ...
                                    a = (function (e, t, n) {
                                        ...
                                        var r = t.volume_info,
                                            i = n.volume_info,
                                            o = I(e, r.version, i.version);
                                        return {
                                            isVolumeChanged: T(r.volume, t.capabilities.volume_granularity) !== T(i.volume, n.capabilities.volume_granularity),
                                            isNewVersion: o,
                                        };
                                    })(void 0 !== r && r, i, o),
                                    s = a.isVolumeChanged,
            ...
            var M = (function () {
                ...
                B = function (e) {
                    Object.defineProperty(this, 'redirectorResponse', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                        ...
                        (this.redirectorResponse = new V.cJ(e.redirectorResponse)),
                        (this.connectionState = new V.cJ(e.connectionState));
                };
            !(function (e) {
                ...
                x = (function (e) {
                    function t(n, r) {
                        ...
                        var i = this,
                            ...
                            a = G(r, ['code']);
                        return (
                            Object.defineProperty((i = e.call(this, n, q({ code: void 0 === o ? 'E_REDIRECTOR_EXCEPTION' : o }, a)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
            ...
            var F = function (e, t) {
                                                    ...
                                                    var b = new WebSocket(Object.values(t.connectionConfig).join(''), [
                                                        ...
                                                        h = function (e) {
                                                            try {
                                                                ...
                                                                'error' in t
                                                                    ? (b.close(), r(new x('Error message from redirector', { data: { redirectorResponse: t.error } })))
                                                                    : (b.close(), n(t));
                                                            } catch (e) {
                                                                new x('Error while processing message from redirector', {
                                                        ...
                                                        y = function () {
                                                            r(new x('Error in connection to redirector', { data: { redirectorResponse: {} } }));
                                                        },
                                                        _ = function () {
                ...
                X = function (e, t) {
                    ...
                    if (t) {
                        var i = t.player_action_timestamp_ms,
                            ...
                            s = void 0 === a ? g.DO_NOT_INTERCEPT_BY_DEFAULT : a;
                        (r.player_action_timestamp_ms = o), (r.activity_interception_type = s);
                    } else (r.player_action_timestamp_ms = Date.now()), (r.activity_interception_type = g.DO_NOT_INTERCEPT_BY_DEFAULT);
                ...
                ee = (function (e) {
                    function t(n, r) {
                        ...
                        var i = this,
                            ...
                            a = Z(r, ['code']);
                        return (
                            Object.defineProperty((i = e.call(this, n, Q({ code: void 0 === o ? 'E_HUB_CONNECTION_EXCEPTION' : o }, a)) || this), 'name', {
                                enumerable: !0,
                                configurable: !0,
                                writable: !0,
                ...
                er = (function () {
                    function e(e) {
                        Object.defineProperty(this, 'connectorConfig', { enumerable: !0, configurable: !0, writable: !0, value: void 0 }),
                            ...
                            (this.redirectorSocket = new W({ device: this.connectorConfig.device, connectionConfig: this.connectorConfig.redirectorConnectionConfig })),
                            (this.historyController = new z({ limit: this.connectorConfig.historyLimit }));
                    }
                    return (
                        Object.defineProperty(e.prototype, 'on', {
                            enumerable: !1,
                        ...
                        Object.defineProperty(e.prototype, 'updateFullState', {
                            ...
                            value: function (e, t) {
                                var n = et({}, e);
                                (n.player_state.player_queue.version = E(this.connectorConfig.device.device_id, 0)),
                                    (n.player_state.status.version = E(this.connectorConfig.device.device_id, 0));
                                var r = X({ update_full_state: n }, et({ player_action_timestamp_ms: 0 }, t)),
                                    i = r.request,
                                    o = r.rid;
                        ...
                        Object.defineProperty(e.prototype, 'updatePlayingStatus', {
                            ...
                            writable: !0,
                            value: function (e, t) {
                                var n = X({ update_playing_status: et({}, e) }, t),
                                    r = n.request,
                                    i = n.rid;
                        ...
                        Object.defineProperty(e.prototype, 'updateActiveDevice', {
                            ...
                            writable: !0,
                            value: function (e, t) {
                                var n = X({ update_active_device: e }, t),
                                    r = n.request,
                                    i = n.rid;
                                return this.sendRequest(r), this.historyController.onMessageSent(i, { ignoreResponse: !0 }), i;
                            },
                        ...
                        Object.defineProperty(e.prototype, 'updateSessionParams', {
                            ...
                            writable: !0,
                            value: function (e, t) {
                                var n = X({ update_session_params: e }, t),
                                    r = n.request,
                                    i = n.rid;
                                return this.sendRequest(r), this.historyController.onMessageSent(i, { ignoreResponse: !0 }), i;
                            },
                        ...
                        Object.defineProperty(e.prototype, 'updatePlayerState', {
                            ...
                            writable: !0,
                            value: function (e, t) {
                                var n = X({ update_player_state: et({}, e) }, t),
                                    r = n.request,
                                    i = n.rid;
                                return this.sendRequest(r), this.historyController.onMessageSent(i, { ignoreResponse: !0 }), i;
                            },
                        ...
                        Object.defineProperty(e.prototype, 'updateVolumeInfo', {
                            ...
                            writable: !0,
                            value: function (e, t) {
                                var n = X({ update_volume_info: et({}, e) }, t),
                                    r = n.request,
                                    i = n.rid;
                                return this.sendRequest(r), this.historyController.onMessageSent(i, { ignoreResponse: !0 }), i;
                            },
                                    ...
                                    [o.DISCONNECTED, o.READY_TO_RECONNECT].includes(this.state.connectionState.value) &&
                                        ...
                                        this.redirectorSocket
                                            ...
                                            .catch(function (e) {
                                                ...
                                                } else (t.state.connectionState.value = o.DISCONNECTED), (t.reconnectAttempts = 0);
                                            }));
                            },
                        }),
                        Object.defineProperty(e.prototype, 'disconnect', {
                            ...
                            value: function (e) {
                                this.reconnectTimeout && (clearTimeout(this.reconnectTimeout), (this.reconnectTimeout = null)),
                                    ...
                                    this.closeConnection(1e3, ''.concat(en).concat(e)),
                                ...
                                if (this.state.redirectorResponse.value) {
                                    var d,
                                        ...
                                        C =
                                            ...
                                            (v[u.ynisonRedirectTicket] = m),
                                            (v[u.ynisonSessionId] = g),
                                    ...
                                    (this.socket = new WebSocket(S, N)),
                                        ...
                                        this.socket.addEventListener('error', function () {
                                            var t = e.state.connectionState.value,
                                                ...
                                                r = new ee('Error in connection to hub', {
                                            ...
                                            e.emitter.emit(a.CONNECTION_ERROR, { destination: c.HUB, error: r, shouldReconnect: n }),
                                                n ? e.reconnect() : ((e.state.connectionState.value = o.DISCONNECTED), (e.reconnectAttempts = 0));
                                        }),
                            ...
                            value: function (e) {
                                try {
                                    ...
                                    if ('error' in t) {
                                        ...
                                        this.closeConnection(1e3, ''.concat(en, 'Error in message'));
                                        var r = new L('Error message from hub', {
                ...
                ea = (function () {
                    function e(e) {
                        ...
                        (this.stateController = new j({ deviceConfig: this.deviceConfig })),
                        ...
                        (this.metricsController = new ed({
                            ...
                            this.connector.on(a.CONNECTION_ERROR, function (e) {
                                t.logger.error('[Ynison] Connection error: '.concat(e.error.message), eo({}, e));
                            }),
                            this.connector.on(a.HUB_MESSAGE_PARSING_ERROR, function (e) {
                                t.logger.error('[Ynison] Hub message error: '.concat(e.error.message), eo({}, e));
                            }),
                            this.connector.on(a.HUB_ERROR, function (e) {
                                t.logger.error('[Ynison] Hub error: '.concat(e.error.message), eo({}, e));
                            });
                    }
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'onMessageReceived', {
                            ...
                            value: function (e) {
                                ...
                                if (!selfDedup) {
                                    ...
                                    window.desktopEvents?.send(ymConstants.EE.YNISON_STATE, { rawData: e.rawData });
                                }
                        ...
                        Object.defineProperty(e.prototype, 'createPausedStateUpdate', {
                            ...
                            value: function (e) {
                                ...
                                return (
                                    ...
                                    (t.player_state.status.version = E(this.deviceConfig.info.device_id, 0)),
                        ...
                        Object.defineProperty(e.prototype, 'createActiveDeviceStateUpdate', {
                            ...
                            value: function (e) {
                                var t = C(e);
                                return (
                                    (t.player_state = C(this.stateController.currentState.player_state)), { newState: t, skipVersionCompare: !0, trigger: 'WSConnector' }
                                );
                            },
                        }),
                        Object.defineProperty(e.prototype, 'processOutgoingPlayerState', {
                            ...
                            writable: !0,
                            value: function (e) {
                                return eo(eo({}, e), { status: this.processOutgoingPlayerStatus(e.status) });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'becomePassive', {
                            ...
                            value: function () {
                                ...
                                (e.active_device_id_optional = null),
                                    ...
                                    (e.player_state.status.version = E(this.deviceConfig.info.device_id)),
                    ...
                    return (
                        Object.defineProperty(e.prototype, 'onYnisonStateParsingError', {
                            ...
                            value: function (e) {
                                this.sendEvent({
                                    ...
                                    data: ef(ef({}, this.getBaseEventPayload()), { errorType: v.OTHER, errorDescription: e.error.message }),
                                });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'onConnected', {
                            ...
                            value: function () {
                                ...
                                this.state.connectionStartTimestamp &&
                                    ...
                                    this.sendEvent({ name: p.YNISON_CONNECTED, data: ef(ef({}, this.getBaseEventPayload()), { time: e }) });
                            },
                        }),
                            ...
                            value: function (e) {
                                ...
                                void 0 !== n && (o = v.WS),
                                    this.sendEvent({
                                        ...
                                        data: ef(ef({}, this.getBaseEventPayload()), {
                            ...
                            value: function (e) {
                                if (e.error.data.connectingState === o.CONNECTING)
                                    return void this.sendEvent({
                                        name: p.YNISON_CONNECTING_ERROR,
                                        data: ef(ef({}, this.getBaseEventPayload()), { destination: b.HUB, errorType: v.WS, errorDescription: e.error.message }),
                                    });
                                this.sendEvent({
                                    name: p.YNISON_CHANNEL_ERROR,
                                    data: ef(ef({}, this.getBaseEventPayload()), { errorType: v.WS, errorDescription: e.error.message }),
                                });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onHubError', {
                            ...
                            value: function (e) {
                                ...
                                this.sendEvent({
                                    name: p.YNISON_CHANNEL_ERROR,
                                    data: ef(ef({}, this.getBaseEventPayload()), { errorType: v.WS, code: n, errorDescription: ''.concat(r, ' ').concat(i) }),
                                });
                            },
                        }),
                        ...
                        Object.defineProperty(e.prototype, 'onDisconnectedByServer', {
                            ...
                            value: function (e) {
                                this.sendEvent({
                                    name: p.YNISON_CHANNEL_ERROR,
                                    data: ef(ef({}, this.getBaseEventPayload()), { errorType: v.SERVER, code: e.code, errorDescription: e.reason }),
                                });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onDisconnectedByClient', {
                            ...
                            writable: !0,
                            value: function (e) {
                                this.sendEvent({ name: p.YNISON_CLIENT_DISCONNECTED, data: ef(ef({}, this.getBaseEventPayload()), { reason: e.reason }) });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onMessageSent', {
                            enumerable: !1,
                            ...
                            value: function (e) {
                                ...
                                t && this.sendEvent({ name: p.YNISON_EVENT_SENDED, data: ef(ef({}, this.getBaseEventPayload()), { type: t }) });
                            },
                        }),
                        Object.defineProperty(e.prototype, 'onMessageLost', {
                            ...
                            value: function (e) {
                                var t = this.getMessageType(e);
                                t && this.sendEvent({ name: p.YNISON_EVENT_LOST, data: ef(ef({}, this.getBaseEventPayload()), { type: t }) });
                            },
                        }),
