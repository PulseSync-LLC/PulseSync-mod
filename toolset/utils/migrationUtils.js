...
const FEATURE_DEFINITIONS = [
    ...
    },
    {
        ...
        patterns: [
            ...
            'modSettings.playerBarEnhancement.showOldPlayerBarOnNewWave',
    ...
    },
    {
        ...
        patterns: [
            ...
            'window.SHOW_OLD_PLAYER_BAR_ON_NEW_WAVE?.()',
            'modSettings.r128Normalization',
            'r128Enabled',
            ' kbps`',
        ],
        candidatePatterns: [
            ...
            'ALWAYS_WIDE_BAR',
            'SHOW_OLD_PLAYER_BAR_ON_NEW_WAVE',
            'r128Normalization',
            'codecMap',
            'qualityMap',
        ],
    ...
    },
    {
        ...
        targetFileHints: {
            main: ['index.js', 'preload.js', 'events.js', 'lib/preload.js', 'lib/store.js', 'lib/miniplayer/miniplayer.js', 'lib/taskBarExtension/taskBarExtension.js'],
        },
