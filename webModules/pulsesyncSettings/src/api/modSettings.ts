...
export type ModSettingsApi = {
    ...
    onModSettingChange: (key: string, listener: (value: unknown) => void) => () => void;
};

export function getModSettingsApi(addonApi: PulseSyncAddonApi | undefined): ModSettingsApi | undefined {
