    ...
    items: [
        {
            ...
            options: (context) => [
                ...
                ...(context.getBoolean(SHOW_NON_MUSIC_PAGE_KEY) ? [{ value: '/non-music', label: 'Подкасты и книги' }] : []),
                { value: '/collection', label: 'Коллекция' },
                ...(context.getBoolean(SHOW_CONCERTS_TAB_KEY) ? [{ value: '/concerts', label: 'Концерты' }] : []),
            ],
        },
        {
            type: 'toggle',
