...
type StoredItemBase = {
    ...
    key: string;
    onApplied?: (value: StoredSettingValue, context: SettingsSchemaContext) => void | Promise<void>;
...
export type ToggleSettingSchema = StoredItemBase & {
    displayValue?: (value: boolean, context: SettingsSchemaContext) => boolean;
    invert?: boolean;
    type: 'toggle';
};
...
export function defineSettingsSection<const Schema extends SettingsSectionSchema>(schema: Schema) {
    return schema;
}
