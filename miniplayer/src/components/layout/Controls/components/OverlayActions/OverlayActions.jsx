...
export default function OverlayActions() {
    ...
    function LeftFeedbackButton() {
        if (settingsState.playerBarEnhancement.changeDislikeButtonPos) {
        ...
        <div className="OverlayPlayerActions">
            ...
            <div className="OverlayPlayerActions_sonata_row">
                <PlayerActionButton
                    type="overlay"
                    name="shuffle"
                    value={playerState.actionsStore?.shuffle}
                ...
                <PlayerActionButton
                    type={settingsState.playerBarEnhancement.whitePlayButton ? 'overlay_primary' : 'overlay_yellow'}
                    name="play"
                ...
                <PlayerActionButton
                    type="overlay"
                    name="repeat"
                    value={playerState.actionsStore?.repeat}
                    active={playerState.availableActions?.repeat}
                    size={38}
                />
            </div>
